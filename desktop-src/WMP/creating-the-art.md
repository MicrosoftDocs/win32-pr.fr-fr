---
title: Création de l’illustration
...
-   [Créer une esquisse](make-a-sketch.md)
-   [Définir les rectangles](define-the-rectangles.md)
-   [Création de l’arrière-plan](creating-the-background.md)
-   [Création du fichier de région](creating-the-region-file.md)
-   [Création du fichier ayant fait l’objet d’un push](creating-the-pushed-file.md)
-   [Création du fichier désactivé](creating-the-disabled-file.md)
-   [Création du fichier Super](creating-the-super-file.md)
-   [Création du fichier VolumeThumb](creating-the-volumethumb-file.md)
