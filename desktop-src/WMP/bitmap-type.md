...
| Valeur       | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Arrière-plan  | Obligatoire. Image sur laquelle toutes les images de bouton sont superposées. Les dimensions de l’image d’arrière-plan de base incluent la largeur et la hauteur complètes de l’écran. Il s’agit également du fichier dans lequel sont affichées les images pour les États naturels des boutons et des trackbars. (Les boutons enfoncés et désactivés ne font pas partie de cette image.)                                                                                                                                                                                                                                                                                           |
...
> [!Note]  
> Les types de zone et de Super bitmap sont déconseillés dans les habillages pour Windows Media Player 10 mobile ou version ultérieure.
