...
| [scriptFile](view-scriptfile.md)                               | spécifie les noms de fichiers des fichiers de JScript associés.                                                                 |
...
| [returnToMediaCenter](view-returntomediacenter.md) | retourne l’utilisateur au mode complet de Lecteur Windows Media. |
...
| [OnError](view-onerror.md) | gère un événement d’erreur si **Paramètres. enableErrorDialogs** est défini sur false. |
