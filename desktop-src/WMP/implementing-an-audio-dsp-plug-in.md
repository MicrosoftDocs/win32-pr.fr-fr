...
Les sections suivantes fournissent des détails sur la modification du code généré par l’Assistant de plug-in du lecteur Windows Media pour créer votre propre plug-in de DSP audio :
