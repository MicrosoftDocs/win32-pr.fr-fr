...
-   **Section Description.** La section Description est requise lors de la création d’habillages pour Windows Media Player 9 Series pour Windows Mobile. Il doit s’agir de la première section du fichier de définition d’apparence, et il doit spécifier des valeurs valides pour les dimensions. La spécification d’une valeur pour orientation est facultative.
