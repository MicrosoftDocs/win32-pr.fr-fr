...
Vous n’avez pas besoin d’effectuer cette opération, mais il peut être très utile de faire en sorte que votre conception ressemble à ce que vous souhaitez. En planifiant à l’avance, vous pouvez vous éviter d’avoir à déplacer des illustrations sur plusieurs fichiers bitmap.

Démarrez Photoshop et créez une image de la taille requise. Créez une nouvelle couche pour contenir l’esquisse approximative. Si vous avez une esquisse et un scanneur, vous souhaiterez peut-être scanner votre croquis dans Photoshop. L’illustration suivante montre un exemple d’ébauche.

![ébauche](images/ceswmskt.png)
