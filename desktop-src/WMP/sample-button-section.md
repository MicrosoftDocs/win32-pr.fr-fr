...
Les lignes suivantes affichent une section de boutons standard d’un fichier de définition d’apparence :
...
Ce code définit huit boutons utilisés pour fournir toutes les fonctions suivantes dans une apparence :

-   Lire, suspendre et arrêter des éléments multimédias.
-   Lecture aléatoire, répétition et déplacement dans la sélection.
