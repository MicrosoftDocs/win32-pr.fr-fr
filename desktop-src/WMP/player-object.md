---
title: Objet Player
description: l’objet lecteur est l’objet racine du contrôle Lecteur Windows Media. Il prend en charge les propriétés, les méthodes et les événements énumérés dans les tableaux suivants.
ms.assetid: 694bd6cc-c816-478a-87b9-1526e2d18869
keywords:
- Lecteur Windows Media de l’objet Player
topic_type:
- apiref
api_name:
- Player Object
...
l’objet lecteur est l’objet racine du contrôle Lecteur Windows Media. Il prend en charge les propriétés, les méthodes et les événements énumérés dans les tableaux suivants.
...
| [controls](player-controls.md)                      | Récupère l’objet [contrôles](controls-object.md) .                                                                                        |
...
| [activé](player-enabled.md)\*                     | spécifie ou récupère une valeur indiquant si le contrôle Lecteur Windows Media est activé.                                               |
...
| [isRemote](player-isremote.md)\*                   | récupère une valeur indiquant si le contrôle Lecteur Windows Media s’exécute en mode distant.                                             |
...
| [playerApplication](player-playerapplication.md)\* | récupère l’objet [PlayerApplication](playerapplication-object.md) lorsqu’un contrôle Lecteur Windows Media distant est en cours d’exécution.               |
| [playlistCollection](player-playlistcollection.md)  | Récupère l’objet [PlaylistCollection](playlistcollection-object.md) .                                                                    |
| [Lecture](player-playstate.md)                    | récupère une valeur indiquant l’état de l’opération de Lecteur Windows Media.                                                                |
| [settings](player-settings.md)                      | récupère l’objet [Paramètres](settings-object.md) .                                                                                        |
| [statut](player-status.md)                          | récupère une valeur indiquant l’état actuel de Lecteur Windows Media.                                                                     |
| [stretchToFit](player-stretchtofit.md)\*           | spécifie ou récupère une valeur indiquant si la vidéo est étirée pour s’ajuster à la taille de l’affichage vidéo du contrôle de Lecteur Windows Media.          |
| [UIMODE](player-uimode.md)\*                       | spécifie ou récupère une valeur indiquant les contrôles qui sont affichés dans l’interface utilisateur lorsque Lecteur Windows Media est incorporée dans une page web. |
...
| [windowlessVideo](player-windowlessvideo.md)\*     | spécifie ou récupère une valeur indiquant si le contrôle de Lecteur Windows Media restitue la vidéo en mode sans fenêtre.                         |
...
| Méthode                                | Description                                               |
|---------------------------------------|-----------------------------------------------------------|
| [close](player-close.md)             | libère Lecteur Windows Media ressources.                  |
...
| [openPlayer](player-openplayer.md)   | ouvre Lecteur Windows Media à l’aide de l’URL spécifiée.       |
...
| [ModeChange](player-player-modechange.md)                                                       | se produit lorsqu’un mode de Lecteur Windows Media est modifié.                           |
...
| [OpenStateChange](player-player-openstatechange.md)                                             | se produit lorsque le contrôle de Lecteur Windows Media change d’état.                      |
...
| [PlayStateChange](player-player-playstatechange.md)                                             | se produit lorsque l’état de lecture du contrôle Lecteur Windows Media change.          |
