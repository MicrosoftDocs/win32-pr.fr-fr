...
keywords:
- Lecteur Windows Media de l’attribut WM/TrackNumber
topic_type:
- apiref
api_name:
- WM/TrackNumber
...
la constante du kit de développement logiciel (SDK) du Format multimédia Windows pour cet attribut est g \_ wszWMTrackNumber.
