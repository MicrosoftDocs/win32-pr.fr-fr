...
keywords:
- Attribut WM/AlbumArtist lecteur Windows Media
topic_type:
- apiref
api_name:
- WM/AlbumArtist
...
La constante du kit de développement logiciel (SDK) du format Windows Media pour cet attribut est g \_ wszWMAlbumArtist.
