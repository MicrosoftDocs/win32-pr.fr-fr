...
|--------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------|
| [Fonctionnement des sources d’attributs](understanding-attribute-sources.md)                     | Décrit comment la source d’un élément multimédia affecte les attributs qui peuvent lui être associés. |
| [Lecture des valeurs d’attribut](reading-attribute-values.md)                                   | Montre les méthodes de récupération de la valeur d’un attribut.                                     |
| [Attributs avec plusieurs valeurs](attributes-with-multiple-values.md)                     | Montre les méthodes de récupération de la valeur d’un attribut à valeurs multiples.                         |
| [Lecture des valeurs d’attribut à partir d’un CD ou d’un DVD](reading-attribute-values-from-a-cd-or-dvd.md) | Fournit un exemple d’application qui lit tous les attributs d’un élément multimédia.                 |
| [Modification des valeurs d’attribut](changing-attribute-values.md)                                 | Affiche la méthode de modification de la valeur d’un attribut.                                        |
| [Valeurs d’attribut pour le contenu TV](attribute-values-for-tv-content.md)                     | Montre comment spécifier des attributs pour le contenu vidéo numérique qui contient des émissions TV.               |
