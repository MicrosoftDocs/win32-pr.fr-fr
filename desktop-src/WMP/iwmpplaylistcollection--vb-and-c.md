...
keywords:
- interface IWMPPlaylistCollection (VB et C) Lecteur Windows Media
- Lecteur Windows Media de l’interface IWMPPlaylistCollection (VB et C), description
topic_type:
- apiref
api_name:
