...
keywords:
- plug-ins Lecteur Windows Media, options
- plug-ins, options
...
un plug-in d’interface utilisateur peut être configuré pour être chargé automatiquement après l’installation au démarrage de Lecteur Windows Media. S’il n’est pas démarré automatiquement, l’utilisateur peut le charger en le sélectionnant dans la liste des **plug-ins** du menu **Outils** .
