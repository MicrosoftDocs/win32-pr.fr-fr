...
---
# <a name="reading-attribute-values-from-a-cd-or-dvd"></a><span data-ttu-id="54472-114">Lecture des valeurs d’attribut à partir d’un CD ou d’un DVD</span><span class="sxs-lookup"><span data-stu-id="54472-114">Reading Attribute Values from a CD or DVD</span></span>

<span data-ttu-id="54472-115">Tout au long de cette rubrique, l’objet **Player** a été défini de la manière suivante :</span><span class="sxs-lookup"><span data-stu-id="54472-115">Throughout this topic, the **Player** object was defined in the following manner:</span></span>
...
<span data-ttu-id="54472-116">L’exemple de code C# suivant récupère les valeurs de tous les attributs du disque actif qui se trouvent dans le lecteur et les écrit dans un fichier.</span><span class="sxs-lookup"><span data-stu-id="54472-116">The following C# example code retrieves the values of all attributes in the current disc that is in the drive and writes them to a file.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="54472-117">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="54472-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="54472-118">**Attributs d’élément multimédia**</span><span class="sxs-lookup"><span data-stu-id="54472-118">**Media Item Attributes**</span></span>](media-item-attributes.md)
</dt> <dt>

[<span data-ttu-id="54472-119">**Objet Media**</span><span class="sxs-lookup"><span data-stu-id="54472-119">**Media Object**</span></span>](media-object.md)
</dt> </dl>
