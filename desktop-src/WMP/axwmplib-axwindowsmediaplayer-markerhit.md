...
---
# <a name="markerhit-event-of-the-axwindowsmediaplayer-object"></a>Événement MarkerHit de l’objet AxWindowsMediaPlayer
...
Le gestionnaire associé à cet événement est de type **AxWMPLib. \_ WMPOCXEvents \_ MarkerHitEventHandler**. Ce gestionnaire reçoit un argument de type **AxWMPLib. \_ WMPOCXEvents \_ MarkerHitEvent**, qui contient la propriété suivante associée à cet événement.



| Propriété      | Description                                                             |
|---------------|-------------------------------------------------------------------------|
| **MarkerNum** | System. Int32Indicates numéro du marqueur qui a été atteint.<br/> |
