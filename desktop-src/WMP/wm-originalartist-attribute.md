...
keywords:
- Lecteur Windows Media de l’attribut WM/OriginalArtist
topic_type:
- apiref
api_name:
- WM/OriginalArtist
...
la constante du kit de développement logiciel (SDK) du Format multimédia Windows pour cet attribut est g \_ wszWMOriginalArtist.
