...
L’attribut **transparencyColor** spécifie ou récupère la couleur de transparence des images de curseur personnalisées.
...
Toute partie des images de curseur personnalisées contenant la valeur **transparencyColor** permettra l’affichage de l’arrière-plan.
