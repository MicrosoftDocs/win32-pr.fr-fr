...
Même si vous pouvez choisir parmi un large éventail de fonctionnalités pour contrôler les médias numériques, les sélections et les volumes, il vous revient de fournir à l’utilisateur de votre apparence un moyen d’interagir avec cette fonctionnalité. Par exemple, si vous souhaitez que l’utilisateur commence à lire un élément multimédia, vous devez fournir un élément de bouton de l’interface utilisateur qui déclenchera la lecture de l’élément multimédia lorsque l’utilisateur appuiera sur l’image de votre bouton.

Aucun élément n’est requis, mais si vous n’avez pas de boutons pour lire et arrêter l’élément multimédia, cela ne se produit pas très bien. Il est également judicieux de fournir un contrôle de volume.

Les éléments d’interface utilisateur correspondent aux types de fonctionnalités utilisées pour contrôler la sélection et la lecture de médias numériques.
...
| Élément                    | Description                                                                                                                                                                                                                                                             |
|----------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Boutons](buttons.md)     | De nombreux types de boutons sont fournis. Les boutons peuvent être utilisés pour activer ou désactiver des fonctions ou basculer entre deux fonctions.                                                                                                                                                        |
