---
title: Propriété mimeType IWMPMetadataPicture
...
La `mimeType` propriété obtient le type MIME de l’image représentée par l’attribut de métadonnées.
...
[**Interface IWMPMetadataPicture (VB et C#)**](iwmpmetadatapicture--vb-and-c.md)
</dt> </dl>
