...
- Lecteur Windows Media Mobile, référence de script
- Lecteur Windows Media modèle objet, référence de script
- modèle objet, référence de script
- Lecteur Windows Media ActiveX contrôle, référence de script
- Lecteur Windows Media contrôle Mobile ActiveX, référence de script
- contrôle de ActiveX, référence de script
...
la référence du modèle objet pour les scripts contient des informations détaillées sur l’Lecteur Windows Media ActiveX modèle objet de contrôle. Les informations de cette section sont présentées dans un style conçu pour être utilisé avec des langages de script tels que Microsoft JScript.

> [!Note]  
> toutes les méthodes, propriétés et événements sont entièrement pris en charge dans Lecteur Windows Media 10 Mobile ou version ultérieure, sauf indication contraire.
...
| [Contrôles](controls-object.md)                     | méthodes et propriétés représentant les contrôles de transport de Lecteur Windows Media, tels que lecture, arrêt et Pause.                                                                             |
...
| [Réseau](network-object.md)                       | propriétés relatives à la connexion réseau de Lecteur Windows Media.                                                                                                                         |
| [Lecteur](player-object.md)                         | méthodes, propriétés et événements qui Lecteur Windows Media peuvent être programmés pour répondre à.                                                                                                     |
| [PlayerApplication](playerapplication-object.md)   | méthodes et propriétés pour basculer entre un contrôle de Lecteur Windows Media distant et le mode complet du lecteur. Peut uniquement être utilisé avec les programmes C++ qui incorporent le contrôle en mode distant. |
| [Sélection](playlist-object.md)                     | Méthodes et propriétés de manipulation de listes d’éléments multimédias.                                                                                                                                  |
...
| [Paramètres](settings-object.md)                     | propriétés qui autorisent la spécification ou la récupération de paramètres de Lecteur Windows Media.                                                                                                         |
