...
Les attributs suivants sont disponibles pour les éléments multimédias récupérés à partir de la bibliothèque à l’aide de [**MediaCollection. getByAttribute (« MediaType », « playlist »)**](/windows/desktop/WMP/mediacollection-getbyattribute).

-   [**Attribut AcquisitionTime**](acquisitiontime-attribute.md)
-   [**Attribut AlternateSourceURL**](alternatesourceurl-attribute.md)
-   [**Attribut auteur**](author-attribute.md)
-   [**Attribut DLNAServerUDN**](dlnaserverudn-attribute.md)
-   [**Attribut DLNASourceURI**](dlnasourceuri-attribute.md)
-   [**Attribut DTCPIPHost**](dtcpiphost-attribute.md)
-   [**Attribut DTCPIPPort**](dtcpipport-attribute.md)
-   [**Attribut FileType**](filetype-attribute.md)
-   [**Id_bibliothèque (attribut)**](libraryid-attribute.md)
-   [**NomBibliothèque (attribut)**](libraryname-attribute.md)
-   [**Attribut MediaContentTypes**](mediacontenttypes-attribute.md)
