...
l’élément **Image** spécifie les images que Lecteur Windows Media affiche à l’utilisateur pour représenter le magasin en ligne.
...
URL du logo qui Lecteur Windows Media s’affiche dans la boîte de dialogue contrat de licence utilisateur final (cluf). Il doit s’agir d’une image PNG de 80 x 80 pixels.
...
URL de l’image que Lecteur Windows Media affiche dans le menu services. Cette image doit être de 15 x 15 pixels.
...
pour un magasin en ligne de type 1, il s’agit de l’URL de l’image que Lecteur Windows Media affiche dans l’onglet **magasins en ligne** . pour Lecteur Windows Media 11, cette image doit être de 45 pixels de large sur 13 pixels de haut. pour Lecteur Windows Media 12, cette image doit être de 45 pixels de large sur 30 pixels de haut. pour prendre en charge les versions 11 et 12 de Lecteur Windows Media, vous devez fournir deux documents ServiceInfo.xml distincts, chacun pointant vers l’image de taille appropriée pour ServiceLargeURL.

pour un magasin de type 2 en ligne, il s’agit de l’URL de l’image que Lecteur Windows Media affiche en regard de l’onglet **magasins en ligne** ou à côté des boutons du volet de tâches. Cette image doit être de 30 x 30 pixels.
...
si vous ne fournissez pas de valeur pour **MenuURL**, Lecteur Windows Media n’affiche aucun graphique dans le menu de votre magasin en ligne.
