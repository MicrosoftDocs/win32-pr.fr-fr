...
Un magasin en ligne de type 1 doit fournir un plug-in qui implémente l’interface [**IWMPContentPartner**](/previous-versions/windows/desktop/api/contentpartner/nn-contentpartner-iwmpcontentpartner) . le plug-in s’exécute dans un processus distinct de Lecteur Windows Media.
...
Vous n’avez pas besoin de créer de code proxy ou stub pour votre plug-in. l’ensemble de la prise en charge du marshaling est fourni par Lecteur Windows Media.
