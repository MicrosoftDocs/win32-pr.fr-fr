...
ms.locfileid: "106510014"
---
# <a name="example-serviceinfo-document-for-a-type-2-online-store"></a><span data-ttu-id="f04a5-114">Exemple de document ServiceInfo pour un magasin de type 2 en ligne</span><span class="sxs-lookup"><span data-stu-id="f04a5-114">Example ServiceInfo Document for a Type 2 Online Store</span></span>

<span data-ttu-id="f04a5-115">L’exemple de code suivant affiche un document ServiceInfo.xml complet.</span><span class="sxs-lookup"><span data-stu-id="f04a5-115">The following code example shows a complete ServiceInfo.xml document.</span></span> <span data-ttu-id="f04a5-116">Vous pouvez utiliser ce code XML comme point de départ pour votre propre document ServiceInfo.</span><span class="sxs-lookup"><span data-stu-id="f04a5-116">You can use this XML as a starting point for your own ServiceInfo document.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f04a5-117">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="f04a5-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f04a5-118">**Guide de programmation pour les magasins en ligne de type 2**</span><span class="sxs-lookup"><span data-stu-id="f04a5-118">**Programming Guide for Type 2 Online Stores**</span></span>](programming-guide-for-type-2-online-stores.md)
</dt> <dt>

[<span data-ttu-id="f04a5-119">**Document ServiceInfo pour un magasin de type 2 en ligne**</span><span class="sxs-lookup"><span data-stu-id="f04a5-119">**ServiceInfo Document for a Type 2 Online Store**</span></span>](serviceinfo-document-for-a-type-2-online-store.md)
</dt> <dt>

[<span data-ttu-id="f04a5-120">**Document ServiceInfo**</span><span class="sxs-lookup"><span data-stu-id="f04a5-120">**ServiceInfo Document**</span></span>](serviceinfo-document.md)
</dt> </dl>
