...
> [!NOTE]
> Cet article s’adresse aux développeurs. Si vous n’êtes pas un développeur et que vous recherchez de l’aide concernant une erreur d’installation d’une application Windows, consultez [prise en charge de Windows](https://support.microsoft.com/hub/4338813/windows-help?os=windows-10).
...
1. Effectuez l’une des opérations suivantes :
    ...
    * Dans le menu fenêtres, cliquez sur **Démarrer** , tapez **Observateur d’événements**, puis **Appuyez sur entrée**.
    * Exécutez **eventvwr. msc**.

2. Dans la page de gauche, développez **Observateur d’événements (local)**  >  **applications et services journaux**  >  **Microsoft**  >  **Windows**.
3. Recherchez les journaux disponibles dans les catégories suivantes :

    * **AppxPackagingOM**  >  **Microsoft-Windows-AppxPackaging/Operational**
    * **AppXDeployment-serveur**  >  **Microsoft-Windows-AppXDeploymentServer/Operational**
...
<ul>
<li>L’application est déployée à l’aide de la touche F5 dans Visual Studio sur un ordinateur doté d’une licence de développeur Windows.</li>
<li>Le package est signé avec une signature Microsoft et déployé dans le cadre de Windows ou de l’Microsoft Store.</li>
...
<td>0x80073D0A</td>
<td>Le package n’a pas pu être installé car le service pare-feu Windows n’est pas en cours d’exécution. Activez le service pare-feu Windows, puis réessayez.<br/></td>
</tr>
<tr class="odd">
...
> Mots clés :  
> Description :  
> Activation de l’application Microsoft.BingNews_8wekyb3d8bbwe ! AppexNews pour Windows. Le lancement du contrat a été bloqué avec l’erreur 0x80073CFC, car son package est dans l’État : modifié.  
...
- Le site du [support technique](https://developer.microsoft.com/windows/support) pour les développeurs de Windows explique d’autres options de support.
