...
ms.locfileid: "127230868"
---
# <a name="wpd_content_type_television"></a>\_télévision du \_ type de contenu wpd \_

Objet qui décrit son type de télévision de \_ type de contenu wpd \_ \_ représente un enregistrement de télévision.

Ce type d’objet doit héberger les propriétés suivantes.
...
| [l' \_ objet \_ wpd \_ est \_ protégé par DRM](object-properties.md)                                  | Obligatoire si l’objet est protégé par la technologie de Rights Management numérique. |
