...
| [\_catégorie d' \_ objet \_ fonctionnel wpd](miscellaneous-properties.md)                      | Obligatoire. reportez-vous au tableau suivant pour les catégories définies par Windows appareils mobiles. |
...
le tableau suivant décrit les catégories définies par Windows appareils mobiles. Consultez la description de la catégorie pour connaître les propriétés et ressources supplémentaires prises en charge par l’objet.
