---
description: Émission de la commande GetNumObjects
ms.assetid: d06690e4-f592-4b17-a5f1-baec2accc8dd
title: Émission de la commande GetNumObjects
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106518785"
---
# <a name="issuing-the-getnumobjects-command"></a><span data-ttu-id="19f84-103">Émission de la commande GetNumObjects</span><span class="sxs-lookup"><span data-stu-id="19f84-103">Issuing the GetNumObjects Command</span></span>

<span data-ttu-id="19f84-104">L’exemple de cette section appelle la commande MTP **GetNumObjects** .</span><span class="sxs-lookup"><span data-stu-id="19f84-104">The example in this section invokes the **GetNumObjects** MTP command.</span></span> <span data-ttu-id="19f84-105">(Pour obtenir une description complète de cette commande et de ses paramètres, consultez la [spécification MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span><span class="sxs-lookup"><span data-stu-id="19f84-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="19f84-106">Avant d’appeler cette commande, vous devez d’abord configurer les paramètres de la commande.</span><span class="sxs-lookup"><span data-stu-id="19f84-106">Before you invoke this command, you must first set up the command parameters.</span></span>
...
<span data-ttu-id="19f84-107">Une fois les paramètres configurés, l’application appelle la commande.</span><span class="sxs-lookup"><span data-stu-id="19f84-107">After the parameters are set up, the application invokes the command.</span></span>
...
<span data-ttu-id="19f84-108">Une fois que l’application a appelé la commande, elle traite la réponse du pilote MTP.</span><span class="sxs-lookup"><span data-stu-id="19f84-108">After the application invokes the command, it processes the response from the MTP driver.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="19f84-109">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="19f84-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="19f84-110">Prise en charge des extensions MTP</span><span class="sxs-lookup"><span data-stu-id="19f84-110">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
