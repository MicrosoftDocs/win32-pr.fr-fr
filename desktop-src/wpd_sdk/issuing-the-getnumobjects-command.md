...
ms.locfileid: "127411341"
---
# <a name="issuing-the-getnumobjects-command"></a>Émission de la commande GetNumObjects

L’exemple de cette section appelle la commande MTP **GetNumObjects** . (Pour obtenir une description complète de cette commande et de ses paramètres, consultez la [spécification MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)

Avant d’appeler cette commande, vous devez d’abord configurer les paramètres de la commande.
...
Une fois les paramètres configurés, l’application appelle la commande.
...
Une fois que l’application a appelé la commande, elle traite la réponse du pilote MTP.
