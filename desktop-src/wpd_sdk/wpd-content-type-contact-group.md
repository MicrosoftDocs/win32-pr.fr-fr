...
---
# <a name="wpd_content_type_contact_group"></a>\_groupe de \_ contacts du type de contenu wpd \_ \_

Objet qui décrit son type, le \_ \_ \_ groupe de contacts de type de contenu wpd \_ représente un groupe de contacts. Les références de l’objet WPD de cet objet \_ \_ contiennent une liste d’ID d’objet pour différents \_ objets de contact de type de contenu wpd \_ \_ .
