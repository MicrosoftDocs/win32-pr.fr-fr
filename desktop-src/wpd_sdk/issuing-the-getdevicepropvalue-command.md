---
description: Émission de la commande GetDevicePropValue
...
ms.locfileid: "106521274"
---
# <a name="issuing-the-getdevicepropvalue-command"></a><span data-ttu-id="927d5-103">Émission de la commande GetDevicePropValue</span><span class="sxs-lookup"><span data-stu-id="927d5-103">Issuing the GetDevicePropValue Command</span></span>

<span data-ttu-id="927d5-104">L’exemple de cette section appelle la commande **GetDevicePropValue** MTP pour récupérer la propriété de l’appareil **BatteryLevel** .</span><span class="sxs-lookup"><span data-stu-id="927d5-104">The example in this section invokes the **GetDevicePropValue** MTP command to retrieve the **BatteryLevel** device property.</span></span> <span data-ttu-id="927d5-105">(Pour obtenir une description complète de cette commande et de ses paramètres, consultez la [spécification MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span><span class="sxs-lookup"><span data-stu-id="927d5-105">(For a complete description of this command and its parameters, see the [MTP specification](https://www.usb.org/sites/default/files/MTPv1_1.zip).)</span></span>

<span data-ttu-id="927d5-106">Dans le cas de **GetDevicePropValue**, l’exemple de code utilise la séquence suivante :</span><span class="sxs-lookup"><span data-stu-id="927d5-106">In the case of **GetDevicePropValue**, the sample code uses the following sequence:</span></span>

1.  <span data-ttu-id="927d5-107">commande \_ wpd \_ MTP \_ ext \_ Execute Command Execute \_ \_ avec les \_ données \_ à \_ lire</span><span class="sxs-lookup"><span data-stu-id="927d5-107">WPD\_COMMAND\_MTP\_EXT\_EXECUTE\_COMMAND\_WITH\_DATA\_TO\_READ</span></span>
2.  <span data-ttu-id="927d5-108">\_commande wpd \_ MTP MTP de \_ lecture des \_ \_ données</span><span class="sxs-lookup"><span data-stu-id="927d5-108">WPD\_COMMAND\_MTP\_EXT\_READ\_DATA</span></span>
3.  <span data-ttu-id="927d5-109">\_transfert de \_ \_ données de \_ fin \_ MTP \_ MTP de commande wpd</span><span class="sxs-lookup"><span data-stu-id="927d5-109">WPD\_COMMAND\_MTP\_EXT\_END\_DATA\_TRANSFER</span></span>

<span data-ttu-id="927d5-110">L’exemple de code suivant montre comment l’application initates la séquence de commandes.</span><span class="sxs-lookup"><span data-stu-id="927d5-110">The following code example shows how the application initates the command sequence.</span></span>
...
<span data-ttu-id="927d5-111">L’exemple de code suivant montre comment l’application récupère les données de propriété.</span><span class="sxs-lookup"><span data-stu-id="927d5-111">The following code example shows how the application retrieves the property data.</span></span>
...
<span data-ttu-id="927d5-112">L’exemple de code suivant montre comment l’application récupère la réponse de l’appareil à la commande.</span><span class="sxs-lookup"><span data-stu-id="927d5-112">The following code example shows how the application retrieves the device response to the command.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="927d5-113">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="927d5-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="927d5-114">Prise en charge des extensions MTP</span><span class="sxs-lookup"><span data-stu-id="927d5-114">Supporting MTP Extensions</span></span>](supporting-mtp-extensions.md)
</dt> </dl>
