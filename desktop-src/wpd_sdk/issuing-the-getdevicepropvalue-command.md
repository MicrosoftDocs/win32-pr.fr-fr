...
L’exemple de cette section appelle la commande **GetDevicePropValue** MTP pour récupérer la propriété de l’appareil **BatteryLevel** . (Pour obtenir une description complète de cette commande et de ses paramètres, consultez la [spécification MTP](https://www.usb.org/sites/default/files/MTPv1_1.zip).)

Dans le cas de **GetDevicePropValue**, l’exemple de code utilise la séquence suivante :

1.  commande \_ wpd \_ MTP \_ ext \_ Execute Command Execute \_ \_ avec les \_ données \_ à \_ lire
2.  \_commande wpd \_ MTP MTP de \_ lecture des \_ \_ données
3.  \_transfert de \_ \_ données de \_ fin \_ MTP \_ MTP de commande wpd

L’exemple de code suivant montre comment l’application initates la séquence de commandes.
...
L’exemple de code suivant montre comment l’application récupère les données de propriété.
...
L’exemple de code suivant montre comment l’application récupère la réponse de l’appareil à la commande.
