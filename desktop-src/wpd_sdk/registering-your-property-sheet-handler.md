...
| **WPDContextMenu. Storage**     | L’inscription sous cette clé active votre gestionnaire de menu contextuel au niveau du stockage. (Cliquez avec le bouton droit sur un stockage.)                 |
