...
ms.locfileid: "119445089"
---
# <a name="wpd_content_type_wireless_profile"></a>\_profil de type de contenu wpd \_ \_ sans fil \_

Objet qui décrit son type de contenu WPD \_ le \_ \_ profil sans fil \_ représente les informations utilisées pour accéder à un réseau sans fil.
...
|--------------------------------------------------------|-------------------------------------------------------|---------------------------|
| [**\_ressource wpd \_ par défaut**](wpd-resource-default.md) | Obligatoire si l’objet est représenté par des données binaires. | Contient les données binaires. |
