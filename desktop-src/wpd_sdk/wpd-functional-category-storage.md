...
| [\_type de \_ système de fichiers de stockage wpd \_ \_](storage-properties.md)                               | Optionnel.                                                                                                                                              |
| [\_capacité de stockage wpd \_](storage-properties.md)                                                 | Obligatoire.                                                                                                                                              |
| [\_ \_ espace libre de stockage wpd \_ \_ en \_ octets](storage-properties.md)                        | Optionnel.                                                                                                                                              |
...
|--------------------------------------------------|----------------------|----------------------------------------------------|
| [**\_icône de ressource wpd \_**](wpd-resource-icon.md) | Optionnel.            | Contient la représentation d’icône pour ce stockage. |
