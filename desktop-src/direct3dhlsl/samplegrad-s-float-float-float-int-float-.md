...
ms.locfileid: "118510578"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture2d"></a>Fonction SampleGrad :: SampleGrad (S, float, float, float, int, float) pour Texture2D

Échantillonne un [**Texture2D**](sm5-object-texture2d.md)à l’aide d’un dégradé pour influencer la façon dont l’emplacement de l’échantillon est calculé, avec une valeur facultative pour fixer des valeurs d’exemple de niveau de détail (LOD) à.
...
[Méthodes SampleGrad](texture2d-samplegrad.md)
</dt> </dl>
