...
Min. de min signé atomique à la mémoire. Retourne la valeur en mémoire avant l’opération max.



| IMM \_ Atomic \_ Imin dst0 \[ . \_ \_ masque de composant unique \] , dst1, dstAddress \[ . Swizzle \] , src0 \[ . Sélectionner un \_ composant\] |
|--------------------------------------------------------------------------------------------------------------|
...
Cette instructioni effectue un composant unique signé 32 bits minimal d’opérande *src0* avec *dst1* à 32 bits par adresse de composant *dstAddress*.
