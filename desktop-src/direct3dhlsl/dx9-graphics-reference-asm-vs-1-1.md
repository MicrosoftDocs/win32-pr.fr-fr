...
-   [Instructions-vs \_ 1 \_ 1](dx9-graphics-reference-asm-vs-instructions-vs-1-1.md) contient une liste des instructions disponibles.
-   [Registres-vs \_ 1 \_ 1](dx9-graphics-reference-asm-vs-registers-vs-1-1.md) répertorie les différents types de registres utilisés par le nuanceur de sommets alu.
