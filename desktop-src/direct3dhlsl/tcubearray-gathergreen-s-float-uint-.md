...
---
# <a name="texturecubearraygathergreensfloatuint-function"></a>TextureCubeArray :: GatherGreen (S, float, uint), fonction
...
[Méthodes GatherGreen](texturecubearray-gathergreen.md)
</dt> <dt>
