...
ms.locfileid: "118789088"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture1d"></a>Fonction SampleGrad :: SampleGrad (S, float, float, float, int, float, uint) pour Texture1D
...
[Méthodes SampleGrad](texture1d-samplegrad.md)
</dt> </dl>
