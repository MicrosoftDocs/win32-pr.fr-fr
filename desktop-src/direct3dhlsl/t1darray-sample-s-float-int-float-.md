...
ms.locfileid: "126918144"
---
# <a name="texture1darraysamplesfloatintfloat-function"></a>Texture1DArray :: Sample (S, float, int, float), fonction
...
[Exemples de méthodes](texture1darray-sample.md)
</dt> </dl>
