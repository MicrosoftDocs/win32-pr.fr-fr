...
XOR au niveau du bit atomique immédiat vers la mémoire. Retourne la valeur en mémoire avant XOR.



| IMM \_ Atomic \_ Xor dst0 \[ . \_ \_ masque de composant unique \] , dst1, dstAddress \[ . Swizzle \] , src0 \[ . Select \_ Component\] |
|-------------------------------------------------------------------------------------------------------------|
...
| Élément                                                                                                           | Description                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| <span id="dst0"></span><span id="DST0"></span>*dst0*<br/>                                                | \[dans \] contient la valeur de *DST1* avant XOR.<br/>                                                                  |
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | Valeur à XOR avec *dst1*.<br/>                                                                                          |
...
Cette instruction effectue un composant unique de bits XOR 32 bits d’opérande *src0* avec *dst1* à 32 bits par adresse de composant *dstAddress*.
...
La valeur dans *dst1* Memory avant le XOR est retournée à *dst0*.
