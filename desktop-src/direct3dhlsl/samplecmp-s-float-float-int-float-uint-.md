...
ms.locfileid: "120095229"
---
# <a name="samplecmpsamplecmpsfloatfloatintfloatuint-function-for-texture2d"></a>Fonction SampleCmp :: SampleCmp (S, float, float, int, float, uint) pour Texture2D

Échantillonne un [**Texture2D**](sm5-object-texture2d.md), en utilisant une valeur de comparaison pour rejeter les exemples, avec une valeur facultative pour fixer des valeurs d’exemple de niveau de détail (LOD) à. Retourne l’état de l’opération.
