...
Déclarez le maxTessFactor pour le correctif.
...
| Élément                                                   | Description                          |
|--------------------------------------------------------|--------------------------------------|
| <span id="n"></span><span id="N"></span>*n*<br/> | \[dans \] le maxTessFactor.<br/> |
...
MaxTessFactor est une valeur float32 comprise dans la plage {1,0... 64,0}.
