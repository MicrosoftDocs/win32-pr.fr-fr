...
| dest \[ . Mask \] , src0 \[ . Swizzle \] , src1. Select ( \_ composant) |
|---------------------------------------------------------|
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/> | \[dans \] contient les valeurs à décaler.<br/>          |
