...
---
# <a name="samplegradsamplegradsfloatfloatfloatfloatuint-function-for-texturecubearray"></a>Fonction SampleGrad :: SampleGrad (S, float, float, float, float, uint) pour TextureCubeArray
