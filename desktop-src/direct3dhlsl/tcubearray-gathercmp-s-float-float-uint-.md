...
ms.locfileid: "127520732"
---
# <a name="texturecubearraygathercmpsfloatfloatuint-function"></a>TextureCubeArray :: GatherCmp (S, float, float, uint), fonction
...
[Méthodes GatherCmp](texturecubearray-gathercmp.md)
</dt> <dt>
