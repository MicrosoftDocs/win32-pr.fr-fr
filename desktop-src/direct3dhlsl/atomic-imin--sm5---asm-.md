...
ms.locfileid: "118287742"
---
# <a name="atomic_imin-sm5---asm"></a>Atomic \_ Imin (SM5-ASM)

Entier signé atomique minimal pour la mémoire.



| Atomic \_ Imin DST, dstAddress \[ . Swizzle \] , src0 \[ . Select, \_ composant\] |
|----------------------------------------------------------------------|
...
Cette instruction effectue un composant unique signé 32 bits d’opérande *src0* dans l' *heure d’été* à 32 bits par adresse de composant *dstAddress*, exécuté atomiquement.
