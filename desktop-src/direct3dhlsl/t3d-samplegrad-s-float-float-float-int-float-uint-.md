...
ms.locfileid: "120023139"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloatuint-function-for-texture3d"></a>Fonction SampleGrad :: SampleGrad (S, float, float, float, int, float, uint) pour Texture3D
...
[Méthodes SampleGrad](texture3d-samplegrad.md)
</dt> <dt>
