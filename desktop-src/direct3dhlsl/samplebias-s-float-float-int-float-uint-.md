...
ms.locfileid: "127292019"
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture2d"></a>Fonction SampleBias :: SampleBias (S, float, float, int, float, uint) pour Texture2D

Échantillonne un [**Texture2D**](sm5-object-texture2d.md), après avoir appliqué la valeur de biais au niveau du mipmap, avec une valeur facultative pour fixer des valeurs d’exemple de niveau de détail (LOD) à. Retourne l’état de l’opération.
