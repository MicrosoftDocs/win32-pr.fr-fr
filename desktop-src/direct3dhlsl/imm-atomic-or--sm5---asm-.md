...
ms.locfileid: "127518617"
---
# <a name="imm_atomic_or-sm5---asm"></a>IMM \_ Atomic \_ ou (SM5-ASM)

Au niveau du bit atomique immédiat ou en mémoire. Retourne la valeur en mémoire avant ou.



| IMM \_ Atomic \_ ou dst0 \[ . \_ \_ masque de composant unique \] , dst1, dstAddress \[ . Swizzle \] , src0 \[ . Select \_ Component\] |
|------------------------------------------------------------------------------------------------------------|
...
| Élément                                                                                                           | Description                                                                                                                       |
|----------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| <span id="dst0"></span><span id="DST0"></span>*dst0*<br/>                                                | \[dans \] contient la valeur de *DST1* avant ou.<br/>                                                                   |
...
| <span id="src0"></span><span id="SRC0"></span>*src0*<br/>                                                | Valeur à ou avec *dst1*.<br/>                                                                                           |
...
Cette instruction effectue un seul composant au niveau du bit 32 bits ou d’un opérande *src0* avec *dst1* à 32 bits par adresse de composant *dstAddress*.
...
La valeur dans *dst1* Memory avant ou est retournée à *dst0*.
