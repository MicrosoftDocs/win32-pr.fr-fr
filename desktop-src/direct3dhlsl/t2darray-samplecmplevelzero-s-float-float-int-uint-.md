...
ms.locfileid: "127236927"
---
# <a name="samplecmplevelzerosamplecmplevelzerosfloatfloatintuint-function-for-texture2darray"></a>Fonction SampleCmpLevelZero :: SampleCmpLevelZero (S, float, float, int, uint) pour Texture2DArray
...
[Méthodes SampleCmpLevelZero](texture2darray-samplecmplevelzero.md)
</dt> <dt>
