---
title: Break-vs
description: Sortir de la boucle actuelle à l’instruction ENDLOOP-vs ou endrep-vs.
...
Sortir de la boucle actuelle à l’instruction [ENDLOOP-vs](endloop---vs.md) ou [endrep-vs](endrep---vs.md).
