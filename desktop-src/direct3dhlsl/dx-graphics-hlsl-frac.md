...
ms.locfileid: "117726257"
---
# <a name="frac"></a>frac

Retourne la partie fractionnaire (ou décimale) de x ; qui est supérieur ou égal à 0 et inférieur à 1.

Voir aussi [trunc](./dx-graphics-hlsl-trunc.md).
...
Partie fractionnaire du paramètre *x* .
