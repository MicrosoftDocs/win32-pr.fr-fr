...
ms.locfileid: "127012673"
---
# <a name="samplecmpsamplecmpsfloatfloatfloatuint-function-for-texturecube"></a>Fonction SampleCmp :: SampleCmp (S, float, float, float, uint) pour TextureCube
...
[Méthodes SampleCmp](texturecube-samplecmp.md)
</dt> <dt>
