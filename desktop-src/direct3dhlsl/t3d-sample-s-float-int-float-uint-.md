...
ms.locfileid: "118788181"
---
# <a name="texture3dsamplesfloatintfloatuint-function"></a>Texture3D :: Sample (S, float, int, float, uint), fonction
...
[Exemples de méthodes](texture3d-sample.md)
</dt> <dt>
