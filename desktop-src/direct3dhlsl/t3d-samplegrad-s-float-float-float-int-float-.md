...
ms.locfileid: "127122441"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture3d"></a>Fonction SampleGrad :: SampleGrad (S, float, float, float, int, float) pour Texture3D
