...
-   Une expression
-   Un [bloc d’instructions](dx-graphics-hlsl-statement-blocks.md)
-   [Instruction return](dx-graphics-hlsl-return.md)
-   Une [instruction Flow-Control](dx-graphics-hlsl-flow-control.md)
