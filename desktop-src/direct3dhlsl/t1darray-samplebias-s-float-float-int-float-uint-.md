...
ms.locfileid: "117904646"
---
# <a name="samplebiassamplebiassfloatfloatintfloatuint-function-for-texture1darray"></a>Fonction SampleBias :: SampleBias (S, float, float, int, float, uint) pour Texture1DArray
...
[Méthodes SampleBias](texture1darray-samplebias.md)
</dt> </dl>
