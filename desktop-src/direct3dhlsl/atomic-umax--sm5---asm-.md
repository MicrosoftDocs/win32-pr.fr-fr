...
ms.locfileid: "118794857"
---
# <a name="atomic_umax-sm5---asm"></a>\_Umax atomique (SM5-ASM)

Entier non signé atomique maximal pour la mémoire.



| Atomic \_ Umax DST, dstAddress \[ . Swizzle \] , src0 \[ . Select, \_ composant\] |
|----------------------------------------------------------------------|
...
Cette instruction effectue un composant unique de l’opérande *src0* non signé 32 bits au niveau de l' *heure d’été* à 32 bits par adresse de composant *dstAddress*, exécuté atomiquement.
