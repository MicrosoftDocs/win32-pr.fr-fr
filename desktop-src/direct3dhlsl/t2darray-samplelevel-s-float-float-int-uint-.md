...
ms.locfileid: "127526056"
---
# <a name="samplelevelsamplelevelsfloatfloatintuint-function-for-texture2darray"></a>Fonction SampleLevel :: SampleLevel (S, float, float, int, uint) pour Texture2DArray
...
[Méthodes SampleLevel](texture2darray-samplelevel.md)
</dt> <dt>
