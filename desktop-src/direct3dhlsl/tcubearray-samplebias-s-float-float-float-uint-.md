...
---
# <a name="samplebiassamplebiassfloatfloatfloatuint-function"></a>SampleBias :: SampleBias (S, float, float, float, uint) (fonction)
...
[Méthodes SampleBias](texturecubearray-samplebias.md)
</dt> <dt>
