...
ms.locfileid: "126918119"
---
# <a name="samplegradsamplegradsfloatfloatfloatintfloat-function-for-texture1darray"></a>Fonction SampleGrad :: SampleGrad (S, float, float, float, int, float) pour Texture1DArray
