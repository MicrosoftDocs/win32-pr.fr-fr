---
description: développez des applications de bureau plus sécurisées à l’aide d’api et de services Windows.
...
ms.locfileid: "118226334"
---
# <a name="security-and-identity"></a>Sécurité et identité

développez des applications de bureau plus sécurisées à l’aide d’api et de services Windows. Ces API offrent les éléments suivants :
...
| [Control Flow Guard (CFG) ](./secbp/control-flow-guard.md) | Control Flow Guard (CFG) est une fonctionnalité de sécurité de plateforme hautement optimisée qui a été créée pour combattre les vulnérabilités d’altération de la mémoire. |
...
| [Contrôle parental](./parcon/parental-controls-portal.md) | la technologie de contrôle Parental dans Windows est destinée à aider les parents ou les gardiens de la diligence à garantir l’accès aux documents appropriés par âge ou par maturité pour ceux qui se trouvent dans leur tutelle. Il fournit une infrastructure extensible en plus des fonctionnalités intégrées. |
