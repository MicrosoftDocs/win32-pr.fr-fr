---
title: Propriétés SystemMonitor
description: 'La classe SystemMonitor a les propriétés suivantes :'
...
ms.locfileid: "118882982"
---
# <a name="systemmonitor-properties"></a>Propriétés SystemMonitor

La classe [**systemmonitor**](systemmonitor.md) a les propriétés suivantes :

-   [**Apparence**](systemmonitor-appearance.md)
...
-   [**Police**](systemmonitor-font.md)
-   [**CouleurTexte**](systemmonitor-forecolor.md)
-   [**GraphTitle**](systemmonitor-graphtitle.md)
-   [**GridColor**](systemmonitor-gridcolor.md)
-   [**Surlignage**](systemmonitor-highlight.md)
-   [**Nomdefichierjournal**](systemmonitor-logfilename.md)
...
-   [**Seulement**](systemmonitor-readonly.md)
