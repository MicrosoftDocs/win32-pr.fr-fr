...
---
# <a name="peap-ms-chapv2-user-properties"></a><span data-ttu-id="e44db-104">Propriétés de l’utilisateur MS-CHAPv2 PEAP</span><span class="sxs-lookup"><span data-stu-id="e44db-104">PEAP MS-CHAPv2 User Properties</span></span>

<span data-ttu-id="e44db-105">Cet exemple est une instance du schéma hérité [mschapv2userpropertiesv1](mschapv2userpropertiesv1schema-schema.md) .</span><span class="sxs-lookup"><span data-stu-id="e44db-105">This sample is an instance of the [mschapv2userpropertiesv1](mschapv2userpropertiesv1schema-schema.md) legacy schema.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e44db-106">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="e44db-106">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e44db-107">Propriétés de l’utilisateur</span><span class="sxs-lookup"><span data-stu-id="e44db-107">User Properties</span></span>](user-profiles.md)
</dt> <dt>

[<span data-ttu-id="e44db-108">EAPHost et schéma hérité</span><span class="sxs-lookup"><span data-stu-id="e44db-108">EAPHost and Legacy Schema</span></span>](eaphost-schemas.md)
</dt> </dl>
