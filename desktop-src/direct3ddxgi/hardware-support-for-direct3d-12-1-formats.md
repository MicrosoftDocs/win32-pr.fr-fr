---
description: Cette section spécifie les formats (valeurs [**DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) ) pris en charge dans le matériel 12,1 de niveau de fonctionnalité Direct3D.
ms.assetid: 0DC50FF3-3193-4F3B-9976-EE504C6FCC87
title: Prise en charge des formats du matériel Direct3D de niveau de fonctionnalité 12.1
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127295695"
---
# <a name="format-support-for-direct3d-feature-level-121-hardware"></a>Prise en charge des formats du matériel Direct3D de niveau de fonctionnalité 12.1

Cette section spécifie les formats (valeurs [**DXGI_FORMAT_** *](/windows/win32/api/dxgiformat/ne-dxgiformat-dxgi_format) ) pris en charge dans le matériel 12,1 de niveau de fonctionnalité Direct3D.
...
| Sample_c du nuanceur (filtre de comparaison) | \- |
| Exemple de nuanceur (mono 1_bit_filter) | \- |
| Nuanceur gather4 | \- |
| Gather4_c de nuanceur | \- |
| MIP | \- |
...
| Nuanceur LD | ![obligatoire](images/letter-r.jpg) |
| Exemple de nuanceur (n’importe quel filtre) | ![obligatoire](images/letter-r.jpg) |
| Sample_c du nuanceur (filtre de comparaison) | ![obligatoire](images/letter-r.jpg) |
| Exemple de nuanceur (mono 1_bit_filter) | \- |
| Nuanceur gather4 | ![obligatoire](images/letter-r.jpg) |
| Gather4_c de nuanceur | ![obligatoire](images/letter-r.jpg) |
| MIP | ![obligatoire](images/letter-r.jpg) |
| Génération automatique de mipmap | \- |
| RenderTarget | \- |
| RenderTarget Blendable | \- |
...
| Opérations de bits atomiques UAV | \- |
| UAV Atomic CMP&Store/CMP&Exch | \- |
| Exchange Atomic UAV | ![obligatoire](images/letter-r.jpg) |
| Min/max signé UAV | \- |
| UAV Atomic non signé min/max | \- |
| UC verrouillable | ![obligatoire](images/letter-r.jpg) |
| RenderTarget multiéchantillon 4x | ![obligatoire](images/letter-r.jpg) |
...
## <a name="dxgi_format_related-topics"></a>Rubriques DXGI_FORMAT_Related
