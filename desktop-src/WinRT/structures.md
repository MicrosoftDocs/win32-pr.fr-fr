...
-   [**\_paramètres de rendu PDF \_**](/windows/desktop/api/windows.data.pdf.interop/ns-windows-data-pdf-interop-pdf_render_params)
...
-   [**Taille**](/windows/win32/api/windows.foundation/ns-windows-foundation-size)
