...
Voici quelques rubriques clés. configuration de votre projet DirectX, en vous acclimatant pour Windows et des exemples d’applications.

| Rubrique | Description |
|-|-|
| [créer votre première Windows application à l’aide de DirectX](building-your-first-directx-app.md) | Utilisez ce didacticiel de base pour commencer à utiliser le développement d’applications DirectX, puis utilisez la feuille de route pour poursuivre l’exploration de DirectX. |
...
| [Télécharger Visual Studio 2013](https://msdn.microsoft.com/windows/apps/br229516.aspx) | vous devez avoir Visual Studio Express 2013 pour Windows Desktop pour créer des jeux Windows Store. pour une visite guidée des Visual Studio, consultez [Windows développer des applications du windows Store à l’aide de Visual Studio 2012](/previous-versions/windows/apps/br211384(v=win.10)). pour plus d’informations sur les nouvelles fonctionnalités de Visual Studio, consultez [les points importants pour les Visual Studio 2013](/previous-versions/visualstudio/visual-studio-2013/bb386063(v=vs.120)). |
...
si vous êtes un vieil en C++ sur des plateformes Windows, les choses peuvent être légèrement différentes. Voici quelques pointeurs vers des rubriques qui peuvent vous aider à obtenir un descripteur sur la différence.
...
| [**Espaces de noms (C++/CX)**](/cpp/cppcx/namespaces-reference-c-cx?view=vs-2019) | contenu de référence pour les espaces de noms qui contiennent des types spécifiques à C++ qui peuvent être utilisés dans Windows applications du windows Store. |
...
## <a name="additional-useful-libraries-for-windows-c-programming"></a>bibliothèques utiles supplémentaires pour la programmation en C++ Windows

| Rubrique | Description |
|-|-|
| [Bibliothèque STL (C++ Standard Template Library)](https://msdn.microsoft.com/library/c191tb28(v=VS.71).aspx) | Windows Les types au moment de l’exécution sont bien adaptés aux types standard de bibliothèques de modèles. la plupart des applications C++ Windows store utilisent des algorithmes et des collections stl (Standard Template Library), à l’exception de la limite ABI. |
...
| [Windows Blog du développeur DirectX](https://devblogs.microsoft.com/directx/) | blog officiel Windows DirectX. |
| [Blog DirectX de Shawn Hargreave](https://www.shawnhargreaves.com/blogindex.html)) | blog de développement d’un autre Windows bien respecté. |
