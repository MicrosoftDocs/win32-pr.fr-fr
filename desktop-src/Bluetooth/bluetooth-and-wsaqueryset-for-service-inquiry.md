...
---
# <a name="bluetooth-and-wsaqueryset-for-service-inquiry"></a>WSAQUERYSET pour la recherche de service et Bluetooth

Bluetooth utilise la structure [**WSAQUERYSET**](/windows/desktop/api/winsock2/ns-winsock2-wsaquerysetw) , avec différentes fonctions, pour faciliter la découverte des appareils et services dans l’espace de noms Bluetooth, NS \_ BTH.
...
<td>Obligatoire. Adresse de l’appareil Bluetooth avec laquelle établir une connexion SDP et demander des services. Cette valeur doit être une chaîne qui a été convertie à l’aide de l’appel de fonction <a href="/windows/desktop/api/winsock2/nf-winsock2-wsaaddresstostringa"><strong>WSAAddressToString</strong></a> . Si l’adresse du périphérique Bluetooth local est fournie, la base de données SDP locale est recherchée.</td>
<td>Non utilisé.</td>
</tr>
<tr class="even">
...
[Référence Bluetooth](bluetooth-reference.md)
</dt> <dt>
