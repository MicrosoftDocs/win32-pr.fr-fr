...
ms.locfileid: "127237762"
---
# <a name="cng-cryptographic-configuration-functions"></a>Fonctions de configuration de chiffrement CNG

API de chiffrement : Next Generation (CNG) définit les fonctions suivantes qui sont utilisées avec le système de configuration de chiffrement CNG.
