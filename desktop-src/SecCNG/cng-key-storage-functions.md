---
description: 'API de chiffrement : Next Generation (CNG) définit les fonctions suivantes qui sont utilisées pour effectuer des opérations de stockage de clé CNG.'
ms.assetid: b0fb174b-75d7-4203-88ab-8469fa85f208
title: fonctions de Stockage de clé CNG
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118908260"
---
# <a name="cng-key-storage-functions"></a>fonctions de Stockage de clé CNG

API de chiffrement : Next Generation (CNG) définit les fonctions suivantes qui sont utilisées pour effectuer des opérations de stockage de clé CNG.
