---
description: 'API de chiffrement : Next Generation (CNG) définit les fonctions suivantes qui sont utilisées pour effectuer des opérations de liaison de jeton CNG.'
ms.assetid: C8770299-60A7-40DE-A2B4-158DF6DFA3C6
title: Fonctions de liaison de jeton CNG
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127013672"
---
# <a name="cng-token-binding-functions"></a>Fonctions de liaison de jeton CNG

API de chiffrement : Next Generation (CNG) définit les fonctions suivantes qui sont utilisées pour effectuer des opérations de liaison de jeton CNG.
