...
---
# <a name="enumerating-process-objects"></a>Énumération des objets de processus

L’exemple suivant appelle la fonction [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) pour énumérer les instances et les compteurs des objets processus sur l’ordinateur local.
