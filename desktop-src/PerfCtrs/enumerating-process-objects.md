---
description: L’exemple suivant appelle la fonction PdhEnumObjectItems pour énumérer les instances et les compteurs des objets processus sur l’ordinateur local.
ms.assetid: d7518ba6-a0f1-4985-aa2c-1ca15a0ceb02
title: Énumération des objets de processus
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106518479"
---
# <a name="enumerating-process-objects"></a><span data-ttu-id="617c6-103">Énumération des objets de processus</span><span class="sxs-lookup"><span data-stu-id="617c6-103">Enumerating Process Objects</span></span>

<span data-ttu-id="617c6-104">L’exemple suivant appelle la fonction [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) pour énumérer les instances et les compteurs des objets processus sur l’ordinateur local.</span><span class="sxs-lookup"><span data-stu-id="617c6-104">The following example calls the [**PdhEnumObjectItems**](/windows/desktop/api/Pdh/nf-pdh-pdhenumobjectitemsa) function to enumerate the instances and counters of the process objects on the local computer.</span></span>
