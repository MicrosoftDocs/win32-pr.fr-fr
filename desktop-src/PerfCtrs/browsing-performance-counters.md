---
description: Exemple de code qui montre comment parcourir les compteurs de performance.
ms.assetid: 44c5cfa8-6449-45d8-ac30-979b99c086de
title: Exploration des compteurs de performances
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106527475"
---
# <a name="browsing-performance-counters"></a><span data-ttu-id="6b2a0-103">Exploration des compteurs de performances</span><span class="sxs-lookup"><span data-stu-id="6b2a0-103">Browsing Performance Counters</span></span>

<span data-ttu-id="6b2a0-104">L’exemple suivant montre comment appeler [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) pour parcourir les compteurs de performance.</span><span class="sxs-lookup"><span data-stu-id="6b2a0-104">The following example shows how to call [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) to browse performance counters.</span></span> <span data-ttu-id="6b2a0-105">L’exemple montre également comment collecter et mettre en forme des données de compteur brutes pour l’affichage.</span><span class="sxs-lookup"><span data-stu-id="6b2a0-105">The example also shows how to collect and format raw counter data for display.</span></span>
