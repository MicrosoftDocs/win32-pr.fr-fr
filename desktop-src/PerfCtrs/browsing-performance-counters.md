...
ms.locfileid: "127013905"
---
# <a name="browsing-performance-counters"></a>Exploration des compteurs de performances

L’exemple suivant montre comment appeler [**PdhBrowseCounters**](/windows/desktop/api/Pdh/nf-pdh-pdhbrowsecountersa) pour parcourir les compteurs de performance. L’exemple montre également comment collecter et mettre en forme des données de compteur brutes pour l’affichage.
