...
| **HKEY \_ performance \_ Text**    | Interroger les chaînes anglaises. Définissez le paramètre *lpValueName* sur « Counter » ou « Help » pour récupérer les noms ou le texte d’aide, respectivement.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
