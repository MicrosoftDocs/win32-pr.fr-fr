---
description: Cette rubrique fournit un exemple d’utilisation de dégradés dans un modèle d’objet XPS.
...
ms.locfileid: "106519831"
---
# <a name="xps-om-gradients"></a><span data-ttu-id="2b655-103">Dégradés du modèle d’objet XPS</span><span class="sxs-lookup"><span data-stu-id="2b655-103">XPS OM Gradients</span></span>

<span data-ttu-id="2b655-104">Cette rubrique fournit un exemple d’utilisation de dégradés dans un modèle d’objet XPS.</span><span class="sxs-lookup"><span data-stu-id="2b655-104">This topic provides an example of using gradients in an XPS OM.</span></span>

## <a name="add-a-new-stop-to-an-existing-gradient"></a><span data-ttu-id="2b655-105">Ajouter un nouvel arrêt à un dégradé existant</span><span class="sxs-lookup"><span data-stu-id="2b655-105">Add a new stop to an existing gradient</span></span>

<span data-ttu-id="2b655-106">L’exemple de code suivant ajoute un nouvel arrêt au dégradé d’un pinceau de dégradé linéaire.</span><span class="sxs-lookup"><span data-stu-id="2b655-106">The following code example adds a new stop to the gradient of a linear-gradient brush.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2b655-107">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="2b655-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2b655-108">**Interface IXpsOMGradientStop**</span><span class="sxs-lookup"><span data-stu-id="2b655-108">**IXpsOMGradientStop Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstop)
</dt> <dt>

[<span data-ttu-id="2b655-109">**Interface IXpsOMGradientStopCollection**</span><span class="sxs-lookup"><span data-stu-id="2b655-109">**IXpsOMGradientStopCollection Interface**</span></span>](/windows/desktop/api/xpsobjectmodel/nn-xpsobjectmodel-ixpsomgradientstopcollection)
</dt> </dl>
