...
Cette rubrique fournit un exemple d’utilisation de dégradés dans un modèle d’objet XPS.

## <a name="add-a-new-stop-to-an-existing-gradient"></a>Ajouter un nouvel arrêt à un dégradé existant

L’exemple de code suivant ajoute un nouvel arrêt au dégradé d’un pinceau de dégradé linéaire.
