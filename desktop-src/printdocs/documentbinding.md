...
Décrit la méthode de liaison. Chaque document est lié séparément. DocumentBinding et JobBindAllDocuments s’excluent mutuellement. Il revient au pilote de déterminer la gestion des contraintes entre les mots clés.
