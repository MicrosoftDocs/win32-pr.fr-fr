...
ms.locfileid: "107994516"
---
# <a name="pagemediatype"></a>PageMediaType

Cette rubrique n’est pas à jour. Pour obtenir les informations les plus récentes, consultez la [spécification du schéma d’impression](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Décrit les options de MediaType et les caractéristiques de chaque option.
...
| \_BackCoatingValue\_<br/>    | string<br/>  | n/a<br/>                    | Brillant, HighGloss, mat, aucun, satin, SemiGloss.<br/>                                                                                                                          | Spécifie le revêtement du côté arrière du média.<br/>              |
| \_FrontCoatingValue\_<br/>   | string<br/>  | n/a<br/>                    | Brillant, HighGloss, mat, aucun, satin, SemiGloss.<br/>                                                                                                                          | Spécifie le revêtement du côté frontal du média.<br/>             |
| \_MaterialValue\_<br/>       | string<br/>  | n/a<br/>                    | Aluminium, affichage, DryFilm, papier, polyester, transparence, WetFilm.<br/>                                                                                                       | Spécifie le matériau à partir duquel le média est établi.<br/>                  |
| \_PrePrintedValue\_<br/>     | string<br/>  | n/a<br/>                    | Aucun, préimprimé, en-tête.<br/>                                                                                                                                              | Spécifie les caractéristiques préimprimées des médias.<br/>                       |
| \_PrePunchedValue\_<br/>     | string<br/>  | n/a<br/>                    | Aucun, préperforé.<br/>                                                                                                                                                          | Spécifie les caractéristiques des médias préperforés.<br/>                       |
| \_RecycledValue\_<br/>       | string<br/>  | n/a<br/>                    | Aucun, standard.<br/>                                                                                                                                                            | Spécifie les caractéristiques du support recyclé.<br/>                         |
| \_WeightValue\_<br/>         | entier<br/> | grammes par mètre carré<br/> | Supérieur à 0.<br/>                                                                                                                                                            | Spécifie les caractéristiques de poids du média.<br/>                           |
