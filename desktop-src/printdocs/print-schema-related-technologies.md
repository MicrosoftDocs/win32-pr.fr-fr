...
Pour la .NET Framework 3,0, Windows Vista et les versions ultérieures, les technologies PrintCapabilities et PrintTicket étendent les fonctionnalités du schéma d’impression pour offrir une expérience d’impression plus riche.
