...
Décrit les caractéristiques duplex de la sortie. La fonctionnalité duplex permet l’impression des deux côtés du média. Tous les documents du travail sont duplexés de manière contiguë. JobDuplexAllDocumentsContiguously et DocumentDuplex s’excluent mutuellement. Il revient au pilote de déterminer la gestion des contraintes entre ces mots clés.
...
| \_DuplexModeValue\_<br/>     | string<br/> | n/a<br/>        | Automatique, manuel.<br/>                                                                                                                                                | Définit le mode duplex. Le duplex automatique est effectué par le matériel. Le duplex manuel est effectué par les logiciels et l’utilisateur.<br/> |
