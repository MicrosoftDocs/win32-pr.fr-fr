...
---
# <a name="pagemediasize"></a><span data-ttu-id="709d3-105">PageMediaSize</span><span class="sxs-lookup"><span data-stu-id="709d3-105">PageMediaSize</span></span>

<span data-ttu-id="709d3-106">Cette rubrique n’est pas à jour.</span><span class="sxs-lookup"><span data-stu-id="709d3-106">This topic is not current.</span></span> <span data-ttu-id="709d3-107">Pour obtenir les informations les plus récentes, consultez la [spécification du schéma d’impression](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span><span class="sxs-lookup"><span data-stu-id="709d3-107">For the most current information, see the [Print Schema Specification](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).</span></span>

<span data-ttu-id="709d3-108">Décrit les dimensions de support physique utilisées pour la sortie.</span><span class="sxs-lookup"><span data-stu-id="709d3-108">Describes the physical media dimensions used for the output.</span></span>

<span data-ttu-id="709d3-109">Le diagramme suivant illustre l’utilisation de la variable PageMediaSize (l’option ISOA4 est utilisée à titre d’exemple).</span><span class="sxs-lookup"><span data-stu-id="709d3-109">The following diagram illustrates the PageMediaSize variable usage (option ISOA4 is used as an example).</span></span>

![diagramme qui montre les dimensions de page](images/local-1594393517-pagemediasizepic.gif)

-   [<span data-ttu-id="709d3-111">Informations sur les éléments</span><span class="sxs-lookup"><span data-stu-id="709d3-111">Element Information</span></span>](#element-information)
-   [<span data-ttu-id="709d3-112">Contenu structurel</span><span class="sxs-lookup"><span data-stu-id="709d3-112">Structural Content</span></span>](#structural-content)
-   [<span data-ttu-id="709d3-113">Contenu Extensible Markup Language (XML)</span><span class="sxs-lookup"><span data-stu-id="709d3-113">Extensible Markup Language (XML) Content</span></span>](#extensible-markup-language-xml-content)

## <a name="element-information"></a><span data-ttu-id="709d3-114">Informations sur les éléments</span><span class="sxs-lookup"><span data-stu-id="709d3-114">Element Information</span></span>

| <span data-ttu-id="709d3-115">Nom</span><span class="sxs-lookup"><span data-stu-id="709d3-115">Name</span></span>                 | <span data-ttu-id="709d3-116">Valeur</span><span class="sxs-lookup"><span data-stu-id="709d3-116">Value</span></span>        |
|----------------------|--------------|
| <span data-ttu-id="709d3-117">Type d'élément</span><span class="sxs-lookup"><span data-stu-id="709d3-117">Element Type</span></span> <br/>   | <span data-ttu-id="709d3-118">Fonctionnalité</span><span class="sxs-lookup"><span data-stu-id="709d3-118">Feature</span></span><br/> |
| <span data-ttu-id="709d3-119">Préfixe d’étendue</span><span class="sxs-lookup"><span data-stu-id="709d3-119">Scoping Prefix</span></span> <br/> | <span data-ttu-id="709d3-120">Page</span><span class="sxs-lookup"><span data-stu-id="709d3-120">Page</span></span><br/>    |
| <span data-ttu-id="709d3-121">Notes</span><span class="sxs-lookup"><span data-stu-id="709d3-121">Notes</span></span> <br/>          | <span data-ttu-id="709d3-122">Aucun</span><span class="sxs-lookup"><span data-stu-id="709d3-122">None</span></span><br/>    |

## <a name="structural-content"></a><span data-ttu-id="709d3-123">Contenu structurel</span><span class="sxs-lookup"><span data-stu-id="709d3-123">Structural Content</span></span>

<span data-ttu-id="709d3-124">La structure XML de cet élément est :</span><span class="sxs-lookup"><span data-stu-id="709d3-124">The XML structure of this element is:</span></span>
...
## <a name="structure-variables"></a><span data-ttu-id="709d3-125">Variables de structure</span><span class="sxs-lookup"><span data-stu-id="709d3-125">Structure Variables</span></span>

<span data-ttu-id="709d3-126">Le tableau suivant présente les caractéristiques des variables définies dans la structure XML.</span><span class="sxs-lookup"><span data-stu-id="709d3-126">The following table outlines the characteristics of the variables defined in the XML structure.</span></span>



| <span data-ttu-id="709d3-127">Nom</span><span class="sxs-lookup"><span data-stu-id="709d3-127">Name</span></span>                                | <span data-ttu-id="709d3-128">Type de données</span><span class="sxs-lookup"><span data-stu-id="709d3-128">Data type</span></span>          | <span data-ttu-id="709d3-129">Unité</span><span class="sxs-lookup"><span data-stu-id="709d3-129">Unit</span></span>                  | <span data-ttu-id="709d3-130">Valeurs prises en charge</span><span class="sxs-lookup"><span data-stu-id="709d3-130">Supported values</span></span>                                                                                                                                                                      | <span data-ttu-id="709d3-131">Résumé</span><span class="sxs-lookup"><span data-stu-id="709d3-131">Summary</span></span>                                                                                                                                                                   |
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| <span data-ttu-id="709d3-132">\_OptionName\_</span><span class="sxs-lookup"><span data-stu-id="709d3-132">\_OptionName\_</span></span><br/>           | <span data-ttu-id="709d3-133">string</span><span class="sxs-lookup"><span data-stu-id="709d3-133">string</span></span><br/>  | <span data-ttu-id="709d3-134">caractères</span><span class="sxs-lookup"><span data-stu-id="709d3-134">characters</span></span><br/> | <span data-ttu-id="709d3-135">Nom complet valide tel que défini par les [espaces de noms dans XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="709d3-135">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="709d3-136">Si aucun espace de noms n’est spécifié, l’espace de noms par défaut est utilisé.</span><span class="sxs-lookup"><span data-stu-id="709d3-136">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="709d3-137">Spécifie le nom du support.</span><span class="sxs-lookup"><span data-stu-id="709d3-137">Specifies the name of the media.</span></span> <span data-ttu-id="709d3-138">Le nom doit utiliser la Convention suivante : " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ ".</span><span class="sxs-lookup"><span data-stu-id="709d3-138">The naming should use the following convention: "\_OptionNameStandard\_""\_OptionNameCommonName\_""\_OptionNameDescriptor\_".</span></span><br/> |
| <span data-ttu-id="709d3-139">\_IdentityOptionValue\_</span><span class="sxs-lookup"><span data-stu-id="709d3-139">\_IdentityOptionValue\_</span></span><br/>  | <span data-ttu-id="709d3-140">string</span><span class="sxs-lookup"><span data-stu-id="709d3-140">string</span></span><br/>  | <span data-ttu-id="709d3-141">n/a</span><span class="sxs-lookup"><span data-stu-id="709d3-141">n/a</span></span><br/>        | <span data-ttu-id="709d3-142">True, False.</span><span class="sxs-lookup"><span data-stu-id="709d3-142">True, False.</span></span><br/>                                                                                                                                                               | <span data-ttu-id="709d3-143">Définit une option qui, lorsqu’elle est sélectionnée, désactive cette fonctionnalité.</span><span class="sxs-lookup"><span data-stu-id="709d3-143">Defines an Option which when selected would disable this feature.</span></span><br/>                                                                                              |
| <span data-ttu-id="709d3-144">\_OptionNameStandard\_</span><span class="sxs-lookup"><span data-stu-id="709d3-144">\_OptionNameStandard\_</span></span><br/>   | <span data-ttu-id="709d3-145">string</span><span class="sxs-lookup"><span data-stu-id="709d3-145">string</span></span><br/>  | <span data-ttu-id="709d3-146">caractères</span><span class="sxs-lookup"><span data-stu-id="709d3-146">characters</span></span><br/> | <span data-ttu-id="709d3-147">« ISO », « JIS », « Japan », « AmeriqueduNord », « OtherMetric », « PRC », None.</span><span class="sxs-lookup"><span data-stu-id="709d3-147">'ISO', 'JIS', 'Japan', 'NorthAmerica', 'OtherMetric', 'PRC', none.</span></span><br/>                                                                                                         | <span data-ttu-id="709d3-148">Indique si la taille du média est définie par une norme particulière.</span><span class="sxs-lookup"><span data-stu-id="709d3-148">Indicates if the media size is defined by a particular standard.</span></span><br/>                                                                                               |
| <span data-ttu-id="709d3-149">\_OptionNameCommonName\_</span><span class="sxs-lookup"><span data-stu-id="709d3-149">\_OptionNameCommonName\_</span></span><br/> | <span data-ttu-id="709d3-150">string</span><span class="sxs-lookup"><span data-stu-id="709d3-150">string</span></span><br/>  | <span data-ttu-id="709d3-151">caractères</span><span class="sxs-lookup"><span data-stu-id="709d3-151">characters</span></span><br/> | <span data-ttu-id="709d3-152">Nom complet valide tel que défini par les [espaces de noms dans XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span><span class="sxs-lookup"><span data-stu-id="709d3-152">Valid fully qualified name as defined by [Namespaces in XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/).</span></span> <span data-ttu-id="709d3-153">Si aucun espace de noms n’est spécifié, l’espace de noms par défaut est utilisé.</span><span class="sxs-lookup"><span data-stu-id="709d3-153">If no namespace is specified, default namespace is assumed.</span></span><br/> | <span data-ttu-id="709d3-154">Nom commun de la taille du média.</span><span class="sxs-lookup"><span data-stu-id="709d3-154">Common Name for the media size.</span></span><br/>                                                                                                                                |
| <span data-ttu-id="709d3-155">\_OptionNameDescriptor\_</span><span class="sxs-lookup"><span data-stu-id="709d3-155">\_OptionNameDescriptor\_</span></span><br/> | <span data-ttu-id="709d3-156">string</span><span class="sxs-lookup"><span data-stu-id="709d3-156">string</span></span><br/>  | <span data-ttu-id="709d3-157">caractères</span><span class="sxs-lookup"><span data-stu-id="709d3-157">characters</span></span><br/> | <span data-ttu-id="709d3-158">Big, enveloppe, extra, plus, carte postale, pivoté, feuille, 'none'.</span><span class="sxs-lookup"><span data-stu-id="709d3-158">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                              | <span data-ttu-id="709d3-159">Big, enveloppe, extra, plus, carte postale, pivoté, feuille, 'none'.</span><span class="sxs-lookup"><span data-stu-id="709d3-159">Big, Envelope, Extra, Plus, Postcard, Rotated, Sheet, 'none'.</span></span><br/>                                                                                                  |
| <span data-ttu-id="709d3-160">\_MediaSizeWidth\_</span><span class="sxs-lookup"><span data-stu-id="709d3-160">\_MediaSizeWidth\_</span></span><br/>       | <span data-ttu-id="709d3-161">entier</span><span class="sxs-lookup"><span data-stu-id="709d3-161">integer</span></span><br/> | <span data-ttu-id="709d3-162">microns</span><span class="sxs-lookup"><span data-stu-id="709d3-162">microns</span></span><br/>    | <span data-ttu-id="709d3-163">Supérieur à 0, inférieur à la taille maximale du support de support pour l’appareil.</span><span class="sxs-lookup"><span data-stu-id="709d3-163">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="709d3-164">Spécifie la largeur du média physique.</span><span class="sxs-lookup"><span data-stu-id="709d3-164">Specifies the width of the physical media.</span></span><br/>                                                                                                                     |
| <span data-ttu-id="709d3-165">\_MediaSizeHeight\_</span><span class="sxs-lookup"><span data-stu-id="709d3-165">\_MediaSizeHeight\_</span></span><br/>      | <span data-ttu-id="709d3-166">entier</span><span class="sxs-lookup"><span data-stu-id="709d3-166">integer</span></span><br/> | <span data-ttu-id="709d3-167">microns</span><span class="sxs-lookup"><span data-stu-id="709d3-167">microns</span></span><br/>    | <span data-ttu-id="709d3-168">Supérieur à 0, inférieur à la taille maximale du support de support pour l’appareil.</span><span class="sxs-lookup"><span data-stu-id="709d3-168">Greater than 0, less than maximum support media size for device.</span></span><br/>                                                                                                           | <span data-ttu-id="709d3-169">Spécifie la hauteur du média physique.</span><span class="sxs-lookup"><span data-stu-id="709d3-169">Specifies the height of the physical media.</span></span><br/>                                                                                                                    |



 

## <a name="extensible-markup-language-xml-content"></a><span data-ttu-id="709d3-170">Contenu Extensible Markup Language (XML)</span><span class="sxs-lookup"><span data-stu-id="709d3-170">Extensible Markup Language (XML) Content</span></span>

<span data-ttu-id="709d3-171">Les mots clés de schéma d’impression publics sont définis dans l' `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` espace de noms.</span><span class="sxs-lookup"><span data-stu-id="709d3-171">The public Print Schema keywords are defined in the `https://schemas.microsoft.com/windows/2003/08/printing/printschemakeywords` namespace.</span></span> <span data-ttu-id="709d3-172">Le contenu de la Extensible Markup Language publique (XML) pour ce mot clé est défini ci-dessous :</span><span class="sxs-lookup"><span data-stu-id="709d3-172">The public Extensible Markup Language (XML) content for this keyword is defined below:</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="709d3-173">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="709d3-173">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="709d3-174">Spécification du schéma d’impression</span><span class="sxs-lookup"><span data-stu-id="709d3-174">Print Schema Specification</span></span>](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip)
</dt> </dl>
