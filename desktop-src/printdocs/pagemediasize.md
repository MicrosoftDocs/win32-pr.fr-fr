...
Décrit les dimensions de support physique utilisées pour la sortie.

Le diagramme suivant illustre l’utilisation de la variable PageMediaSize (l’option ISOA4 est utilisée à titre d’exemple).
...
|-------------------------------------|--------------------|-----------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| \_OptionName\_<br/>           | string<br/>  | caractères<br/> | Nom complet valide tel que défini par les [espaces de noms dans XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/). Si aucun espace de noms n’est spécifié, l’espace de noms par défaut est utilisé.<br/> | Spécifie le nom du support. Le nom doit utiliser la Convention suivante : " \_ OptionNameStandard \_ " " \_ OptionNameCommonName \_ " " \_ OptionNameDescriptor \_ ".<br/> |
...
| \_OptionNameStandard\_<br/>   | string<br/>  | caractères<br/> | « ISO », « JIS », « Japan », « AmeriqueduNord », « OtherMetric », « PRC », None.<br/>                                                                                                         | Indique si la taille du média est définie par une norme particulière.<br/>                                                                                               |
| \_OptionNameCommonName\_<br/> | string<br/>  | caractères<br/> | Nom complet valide tel que défini par les [espaces de noms dans XML](https://www.w3.org/TR/1999/REC-xml-names-19990114/). Si aucun espace de noms n’est spécifié, l’espace de noms par défaut est utilisé.<br/> | Nom commun de la taille du média.<br/>                                                                                                                                |
| \_OptionNameDescriptor\_<br/> | string<br/>  | caractères<br/> | Big, enveloppe, extra, plus, carte postale, pivoté, feuille, 'none'.<br/>                                                                                                              | Big, enveloppe, extra, plus, carte postale, pivoté, feuille, 'none'.<br/>                                                                                                  |
| \_MediaSizeWidth\_<br/>       | entier<br/> | microns<br/>    | Supérieur à 0, inférieur à la taille maximale du support de support pour l’appareil.<br/>                                                                                                           | Spécifie la largeur du média physique.<br/>                                                                                                                     |
| \_MediaSizeHeight\_<br/>      | entier<br/> | microns<br/>    | Supérieur à 0, inférieur à la taille maximale du support de support pour l’appareil.<br/>                                                                                                           | Spécifie la hauteur du média physique.<br/>                                                                                                                    |
