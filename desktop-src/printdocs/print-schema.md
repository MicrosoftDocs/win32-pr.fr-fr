...
Le schéma d’impression et les technologies associées sont disponibles dans le Microsoft .NET Framework 3,0, Microsoft Windows Vista et versions ultérieures.
