...
Décrit le bac de sortie installé sur un appareil ou la liste complète des emplacements pris en charge pour un appareil. Les mots clés JobOutputBin, DocumentOutputBin et PageOutputBin s’excluent mutuellement, un seul doit être spécifié dans un document PrintTicket ou des fonctionnalités d’impression.
