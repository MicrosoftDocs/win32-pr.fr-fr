...
Spécifie le décalage, parallèle à la direction de l’orientation du flux ( [spécification du format du fichier de description d’imprimante PostScript](https://www.adobe.com/products/postscript/pdfs/PLRM.pdf)de référence).
