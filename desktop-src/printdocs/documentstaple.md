...
ms.locfileid: "118235026"
---
# <a name="documentstaple"></a>DocumentStaple

Cette rubrique n’est pas à jour. Pour obtenir les informations les plus récentes, consultez la [spécification du schéma d’impression](https://download.microsoft.com/download/D/E/C/DECA6E6B-3E81-48E7-B7EF-6D92A547D03C/print-schema-spec-2-0.zip).

Décrit les caractéristiques de l’agrafage de la sortie. Chaque document est agrafé séparément. Les mots clés JobStapleAllDocuments et DocumentStaple s’excluent mutuellement. Il revient au pilote de déterminer la gestion des contraintes entre ces mots clés.
...
| \_AngleValue\_<br/>          | entier<br/> | degrés<br/>         | Supérieur à 0.<br/>                                                                                                                                                            | Spécifie l’angle de l’agrafage par rapport à la direction X du PageImageableSize. L’angle de l’agrafage est mesuré dans un sens dans le sens inverse des aiguilles d’une montre.<br/> |
