...
ms.locfileid: "119046917"
---
# <a name="id3dx10meshgetindexbuffer-method"></a>ID3DX10Mesh :: GetIndexBuffer, méthode
...
Adresse d’un pointeur vers une interface ID3DX10MeshBuffer, représentant la mémoire tampon d’index associée à la maille.
