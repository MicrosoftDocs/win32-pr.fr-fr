...
ms.locfileid: "119370789"
---
# <a name="d3dx10createasyncshaderpreprocessprocessor-function"></a>D3DX10CreateAsyncShaderPreprocessProcessor fonction)
...
Adresse d’un pointeur vers une mémoire tampon qui contient le texte ASCII du nuanceur (voir [**interface ID3D10Blob**](/windows/win32/api/D3DCommon/nn-d3dcommon-id3d10blob)).
