...
ms.locfileid: "117736008"
---
# <a name="d3dx10createeffectfromfile-function"></a>D3DX10CreateEffectFromFile fonction)

Créer un effet à partir d’un fichier.
...
Nom du fichier d’effet ASCII. Si les paramètres du compilateur requièrent Unicode, le type de données LPCTSTR est résolu en LPCWSTR. Dans le cas contraire, le type de données est résolu en LPCSTR.
