...
---
# <a name="math-functions-direct3d-10-graphics"></a>Fonctions mathématiques (graphiques Direct3D 10)

> [!Note]  
> Les fonctions mathématiques de la bibliothèque de l’utilitaire D3DX sont déconseillées pour Windows 8. Nous vous recommandons d’utiliser [DirectXMath](../dxmath/directxmath-portal.md) à la place.
...
## <a name="resolving-link-errors-with-d3dx-math-functions"></a>Résolution des erreurs de lien avec les fonctions mathématiques D3DX
