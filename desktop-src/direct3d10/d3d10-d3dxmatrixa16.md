...
ms.locfileid: "126855369"
---
# <a name="d3dxmatrixa16-structure-d3dx10mathh"></a>D3DXMATRIXA16, structure (D3DX10Math. h)
...
D’autres compilateurs interprètent **D3DXMATRIXA16** comme [**D3DXMATRIX**](d3d10-d3dxmatrix.md). L’utilisation de cette structure sur un compilateur qui n’aligne pas réellement la matrice peut être problématique, car elle n’expose pas les bogues qui ignorent l’alignement. Par exemple, si un objet **D3DXMATRIXA16** est à l’intérieur d’une structure ou d’une classe, une fonction [memcpy](https://msdn2.microsoft.com/library/dswaw1wk(vs.71).aspx) peut être effectuée avec un compactage étroit (en ignorant les limites de 16 octets). Cela entraînerait des arrêts de build si le compilateur devait parfois ajouter l’alignement de matrice.

### <a name="d3dxmatrixa16-extensions"></a>Extensions D3DXMATRIXA16
