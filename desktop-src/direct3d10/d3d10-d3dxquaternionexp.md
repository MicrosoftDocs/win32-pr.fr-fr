...
La méthode [**D3DXQuaternionSquadSetup**](d3d10-d3dxquaternionsquadsetup.md) peut également être utilisée pour configurer les points de contrôle d’un Quaternion.
