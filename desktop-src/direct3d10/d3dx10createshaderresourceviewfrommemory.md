...
ms.locfileid: "119634649"
---
# <a name="d3dx10createshaderresourceviewfrommemory-function"></a>D3DX10CreateShaderResourceViewFromMemory fonction)
...
Adresse d’un pointeur vers l’affichage des ressources de nuanceur nouvellement créé. Voir [**interface ID3D10ShaderResourceView**](/windows/desktop/api/d3d10/nn-d3d10-id3d10shaderresourceview).
