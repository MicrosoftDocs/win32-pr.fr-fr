...
La valeur de retour de cette fonction est la même que celle retournée dans le paramètre moue. De cette façon, la fonction [**D3DXVec3TransformCoord**](d3d10-d3dxvec3transformcoord.md) peut être utilisée comme paramètre pour une autre fonction.
