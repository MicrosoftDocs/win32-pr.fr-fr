...
---
# <a name="multilingual-user-interface-functions"></a>Fonctions de l’interface utilisateur multilingue

Les fonctions suivantes sont utilisées avec l’interface utilisateur multilingue (MUI).
