---
description: En savoir plus sur les interfaces de vérification orthographique
...
ms.locfileid: "127121853"
---
# <a name="spell-checking-interfaces"></a>Interfaces de vérification orthographique

L’API vérification orthographique contient les interfaces suivantes :
...
[**Des**](/windows/desktop/api/Spellcheck/nn-spellcheck-ispellchecker)  
...
[Énumérations de la vérification orthographique](spell-checker-enumerations.md)
</dt> </dl>
