...
si nécessaire, des ères supplémentaires peuvent être ajoutées à cette clé par le biais du processus de Windows Update normal. Cette clé peut être affichée à l’aide de l’éditeur du Registre (Regedit.exe). voici un exemple de la clé et des valeurs expédiées dans Windows 7 :
