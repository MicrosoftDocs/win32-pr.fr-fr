...
Cette rubrique décrit deux utilitaires utilisés pour créer des applications MUI. Bien que MUIRCT soit un outil spécifique à MUI, MUI utilise également l’utilitaire de compilation Windows RC standard. Les instructions relatives à l’utilisation de ces utilitaires sont fournies dans [localisation des ressources et génération de l’application](localizing-resources-and-building-the-application.md).
...
<tr class="even">
<td>-g</td>
<td>Spécifie l’identificateur de <a href="language-identifiers.md">langue de secours</a> ultime en notation hexadécimale.<br/></td>
</tr>
<tr class="odd">
<td>-G1</td>
<td>Crée un fichier MUI. res même si la ressource de VERSION est le seul contenu localisable. Par défaut, le compilateur RC ne produit pas de fichier. res si la VERSION est la seule ressource localisable.<br/></td>
</tr>
<tr class="even">
<td>-g2</td>
<td>Spécifie le numéro de version personnalisé à utiliser lors du calcul de la somme de contrôle.<br/></td>
</tr>
<tr class="odd">
<td>mui_res_name</td>
<td>Fichier de ressources pour les ressources spécifiques à une langue.<br/></td>
</tr>
<tr class="even">
<td>rc_config_file_name</td>
<td>Fichier de configuration de ressource.<br/></td>
</tr>
<tr class="odd">
<td>langid</td>
<td>Identificateur de langue.<br/></td>
</tr>
<tr class="even">
<td>version</td>
<td>Numéro de version personnalisé, dans un format tel que &quot; 6.2.0.0 &quot; .<br/></td>
</tr>
</tbody>
</table>
...
[Informations de référence sur l’interface utilisateur multilingue](multilingual-user-interface-reference.md)
</dt> <dt>
