---
description: 'MUI : exemple d’application de paramètres système'
ms.assetid: 34cfd3a8-20b2-4a57-bc43-8da410cf9ae9
title: 'MUI : exemple d’application de paramètres système'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106518358"
---
# <a name="mui-system-settings-application-sample"></a><span data-ttu-id="f5720-103">MUI : exemple d’application de paramètres système</span><span class="sxs-lookup"><span data-stu-id="f5720-103">MUI: System Settings Application Sample</span></span>

<span data-ttu-id="f5720-104">L’exemple d’application décrit dans cette rubrique est une simple application Hello MUI qui prend en charge les paramètres système pour ses langues d’interface utilisateur.</span><span class="sxs-lookup"><span data-stu-id="f5720-104">The sample application described in this topic is a simple Hello MUI application that supports system settings for its user interface languages.</span></span>
