---
description: Ces identificateurs sont utilisés avec la fonction ImmSimulateHotKey.
...
Ces identificateurs sont utilisés avec la fonction [**ImmSimulateHotKey**](/windows/desktop/api/Imm/nf-imm-immsimulatehotkey) .



| Identificateurs                       | Signification                                                                                                                                                                                                 |
|-----------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
...
| IME \_ KHOTKEY \_ HANJACONVERT        | Loyal Basculez vers la conversion hanja.                                                                                                                                                                    |
| \_Toggle IME THOTKEY \_ IME \_ NONIME \_ | (Chinois traditionnel) Basculez entre les opérations IME et non-IME lorsque la langue est le chinois traditionnel.                                                                                                |
| bascule de la \_ forme THOTKEY IME \_ \_       | (Chinois traditionnel) Basculer le mode de conversion de forme de l’IME.                                                                                                                                          |
| \_ \_ basculement de symbole THOTKEY IME \_      | (Chinois traditionnel) Basculer le mode de conversion de symbole de l’IME.                                                                                                                                         |
