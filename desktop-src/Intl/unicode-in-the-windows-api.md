...
Les fonctions API Windows qui manipulent des caractères sont généralement implémentées dans l’un des trois formats suivants :

-   Une version générique qui peut être compilée pour les pages de codes Windows ou Unicode
-   Une version de [page de codes Windows](code-pages.md) avec la lettre « A » utilisée pour indiquer « ANSI »
