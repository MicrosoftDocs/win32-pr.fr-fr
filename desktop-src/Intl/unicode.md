...
Pour la compatibilité avec les environnements 8 bits et 7 bits, Unicode peut également être encodé au format UTF-8 et UTF-7, respectivement. Alors que les fonctions compatibles Unicode dans Windows utilisent UTF-16, il est également possible d’utiliser des données encodées au format UTF-8 ou UTF-7, qui sont prises en charge dans Windows en tant que [pages de codes](code-pages.md)du jeu de caractères multioctets.
