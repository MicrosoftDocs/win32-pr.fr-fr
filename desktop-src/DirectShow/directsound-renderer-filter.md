...
<td>Type majeur : MEDIATYPE_AudioSubtypes :<br/>
<ul>
...
Type de format : FORMAT_WaveFormatEx<br/></td>
</tr>
<tr class="odd">
...
« Appareil DirectSound par défaut » est affecté d’un mérite de mérite \_ . Les autres ont des mérites à \_ ne \_ pas \_ utiliser. Par conséquent, la connexion intelligente choisit toujours l’appareil DirectSound par défaut.
