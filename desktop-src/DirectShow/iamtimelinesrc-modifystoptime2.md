...
La `ModifyStopTime2` méthode définit l’heure d’arrêt. Cette méthode est équivalente à [**IAMTimelineSrc :: ModifyStopTime**](iamtimelinesrc-modifystoptime.md), mais prend une valeur [**REFTIME**](reftime.md) .
...
Nouvelle heure d’arrêt, en secondes.

</dd> </dl>

## <a name="return-value"></a>Valeur de retour

Retourne S \_ OK en cas de réussite, ou E \_ INVALIDARG si l’heure spécifiée n’est pas valide.
