...
ms.locfileid: "119639409"
---
# <a name="idxtcompositorget_offsety-method"></a>IDxtCompositor :: obtient la \_ méthode OffsetY
...
La `get_OffsetY` méthode récupère le décalage vertical du rectangle cible.
...
Reçoit, en pixels, le décalage vertical du rectangle cible.
