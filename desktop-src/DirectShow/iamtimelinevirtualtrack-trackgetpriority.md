...
ms.locfileid: "127012175"
---
# <a name="iamtimelinevirtualtracktrackgetpriority-method"></a>IAMTimelineVirtualTrack :: TrackGetPriority, méthode
...
La `TrackGetPriority` méthode récupère le niveau de priorité de l’objet.
...
Pointeur vers une variable qui reçoit le niveau de priorité. Si l’objet ne fait pas partie d’une chronologie, la valeur est définie sur – 1.
