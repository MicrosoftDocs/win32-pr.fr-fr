...
ms.locfileid: "127219129"
---
# <a name="cbasecontrolvideoget_sourceleft-method"></a>Méthode CBaseControlVideo. obten \_ SourceLeft

La `get_SourceLeft` méthode récupère la coordonnée gauche du rectangle source actuel.
...
Pointeur vers la coordonnée gauche du rectangle source actuel.
