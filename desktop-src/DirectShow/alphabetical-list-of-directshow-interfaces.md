...
<td>Définit et récupère des informations sur le processus de conversion analogique-numérique dans un filtre de capture vidéo.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamaudioinputmixer"><strong>IAMAudioInputMixer</strong></a></td>
<td>Contrôle les propriétés de capture audio.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamaudiorendererstats"><strong>IAMAudioRendererStats</strong></a></td>
<td>Récupère des informations statistiques sur les performances à partir d’un filtre de convertisseur audio.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iambuffernegotiation"><strong>IAMBufferNegotiation</strong></a></td>
<td>Demande le nombre de mémoires tampons d’un filtre à créer et la taille de chaque mémoire tampon.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamcameracontrol"><strong>IAMCameraControl</strong></a></td>
<td>Contrôle les paramètres de l’appareil photo tels que le zoom, le panoramique, le réglage de l’ouverture ou la vitesse d’obturation.</td>
</tr>
<tr class="even">
...
<td>Envoie des messages de protocole de protection de sortie certifiés (COPP) au pilote Graphics.</td>
</tr>
<tr class="odd">
...
<td>Ajuste l’horloge de référence.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamclockslave"><strong>IAMClockSlave</strong></a></td>
<td>Contrôle la tolérance d’un convertisseur audio lorsqu’il correspond aux taux de correspondance avec une autre horloge.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamcopycapturefileprogress"><strong>IAMCopyCaptureFileProgress</strong></a></td>
<td>Interface de rappel pour la méthode <a href="/windows/desktop/api/Strmif/nf-strmif-icapturegraphbuilder2-copycapturefile"><strong>ICaptureGraphBuilder2 :: CopyCaptureFile</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamcrossbar"><strong>IAMCrossbar</strong></a></td>
<td>Achemine les signaux d’une source analogique ou numérique vers un filtre de capture vidéo.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamdecodercaps"><strong>IAMDecoderCaps</strong></a></td>
<td>Retourne des informations sur les fonctionnalités d’un filtre de décodage MPEG.</td>
</tr>
<tr class="odd">
...
<td>Spécifie la fenêtre qui a le focus pour contrôler la lecture audio DirectSound.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamdroppedframes"><strong>IAMDroppedFrames</strong></a></td>
<td>Récupère les informations de performances d’un filtre de capture vidéo.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamextdevice"><strong>IAMExtDevice</strong></a></td>
<td>Contrôle un périphérique externe, tel qu’une caméra DV ou un lecteur de bande vidéo (VTR).</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamexttransport"><strong>IAMExtTransport</strong></a></td>
<td>Contrôle le transport sur un magnétoscope ou un caméscope.</td>
</tr>
<tr class="even">
...
<td>Interface de rappel pour la génération de graphiques.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamfiltermiscflags"><strong>IAMFilterMiscFlags</strong></a></td>
<td>Interroge si un filtre est un filtre source ou un convertisseur.</td>
</tr>
<tr class="odd">
...
<td>Active un filtre de décodage vidéo pour accéder à la fonctionnalité 1,0 de l’accélération vidéo DirectX (DXVA).</td>
</tr>
<tr class="even">
...
<td>Interface de rappel pour DXVA 1,0.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamvideocompression"><strong>IAMVideoCompression</strong></a></td>
<td>Définit et récupère les propriétés de compression vidéo.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iamvideocontrol"><strong>IAMVideoControl</strong></a></td>
<td>Contrôle certaines opérations de capture vidéo, telles que l’énumération des taux d’images disponibles et l’orientation de l’image.</td>
</tr>
<tr class="odd">
...
<td>Ajuste les qualités d’un signal vidéo entrant.</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/dshowasf/nn-dshowasf-iamwmbufferpass"><strong>IAMWMBufferPass</strong></a></td>
<td>Obtient ou définit des propriétés sur des échantillons individuels dans un flux ASF.</td>
</tr>
<tr class="even">
...
<td>Interface de rappel utilisée avec l’interface <a href="/previous-versions/windows/desktop/api/dshowasf/nn-dshowasf-iamwmbufferpass"><strong>IAMWMBufferPass</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/Iwstdec/nn-iwstdec-iamwstdecoder"><strong>IAMWstDecoder</strong></a></td>
<td>Définit et récupère des informations sur le télétexte universel (WST)</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iasyncreader"><strong>IAsyncReader</strong></a></td>
<td>Exécute une demande de données asynchrones sur un filtre.</td>
</tr>
<tr class="odd">
...
<td>Configure le filtre de l' <a href="wm-asf-writer-filter.md">enregistreur ASF WM</a> .</td>
</tr>
<tr class="odd">
...
<td>Étend l’interface <a href="/previous-versions/windows/desktop/api/dshowasf/nn-dshowasf-iconfigasfwriter"><strong>IConfigAsfWriter</strong></a> .</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iconfigavimux"><strong>IConfigAviMux</strong></a></td>
<td>Configure le filtre <a href="avi-mux-filter.md">multiplex MUX</a> .</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iconfiginterleaving"><strong>IConfigInterleaving</strong></a></td>
<td>Contrôle la façon dont le multiplexeur de données AVI entrelace les échantillons audio et vidéo.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-icreatedevenum"><strong>ICreateDevEnum</strong></a></td>
<td>Crée un énumérateur pour une catégorie de filtres.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iddrawexclmodevideo"><strong>IDDrawExclModeVideo</strong></a></td>
<td>Active la lecture vidéo en mode plein écran en mode exclusif DirectDraw.</td>
</tr>
<tr class="even">
...
<td>Interface de rappel de l’interface <a href="/windows/desktop/api/Strmif/nn-strmif-iddrawexclmodevideocallback"><strong>IDDrawExclModeVideoCallback</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-idecimatevideoimage"><strong>IDecimateVideoImage</strong></a></td>
<td>Spécifie la décimalité sur un filtre de décodeur.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Control/nn-control-ideferredcommand"><strong>IDeferredCommand</strong></a></td>
<td>Annule ou modifie les commandes de contrôle de graphique qui ont été mises en file d’attente à l’aide de l’interface <a href="/windows/desktop/api/Control/nn-control-iqueuecommand"><strong>IQueueCommand</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/Amvideo/nn-amvideo-idirectdrawvideo"><strong>IDirectDrawVideo</strong></a></td>
<td>Interroge le filtre de <a href="video-renderer-filter.md">convertisseur vidéo</a> sur les surfaces DirectDraw et les capacités matérielles.</td>
</tr>
<tr class="even">
...
<td>Alloue des exemples qui contiennent des surfaces DirectDraw.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-idistributornotify"><strong>IDistributorNotify</strong></a></td>
<td>Permet à un serveur de distribution de plug-in d’être notifié lorsque le graphique de filtre change.</td>
</tr>
<tr class="odd">
...
<td>Exposé par le filtre de <a href="full-screen-renderer-filter.md">convertisseur plein écran</a> .</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-igetcapabilitieskey"><strong>IGetCapabilitiesKey</strong></a></td>
<td>Récupère les fonctionnalités d’un encodeur logiciel ou matériel à partir du Registre.</td>
</tr>
<tr class="odd">
...
<td>Reconfigure le graphique de filtre pendant que le graphique est en cours d’exécution.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-igraphconfigcallback"><strong>IGraphConfigCallback</strong></a></td>
<td>Interface de rappel de l’interface <a href="/windows/desktop/api/Strmif/nn-strmif-igraphconfig"><strong>IGraphConfig</strong></a> .</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-igraphversion"><strong>IGraphVersion</strong></a></td>
<td>Récupère le numéro de version actuel du graphique de filtre.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-iipdvdec"><strong>IIPDVDec</strong></a></td>
<td>Configure le filtre de <a href="dv-video-decoder-filter.md">décodage vidéo DV</a> .</td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/api/vidcap/nn-vidcap-iksnodecontrol"><strong>IKsNodeControl</strong></a></td>
<td>Exposée par les unités d’extension UVC (USB Video Class).</td>
</tr>
<tr class="odd">
<td><a href="ikspin.md"><strong>IKsPin</strong></a></td>
<td>Récupère les supports pris en charge par un code confidentiel en mode noyau.</td>
</tr>
<tr class="even">
<td><a href="ikspropertyset.md"><strong>IKsPropertySet</strong></a></td>
<td>Définit des propriétés sur un filtre en mode noyau.</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/vidcap/nn-vidcap-ikstopologyinfo"><strong>IKsTopologyInfo</strong></a></td>
<td>Énumère les nœuds dans un pilote de classe de flux.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Control/nn-control-imediacontrol"><strong>Appel</strong></a></td>
<td>Contrôle le workflow des données via le graphique de filtre.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Control/nn-control-imediaevent"><strong>IMediaEvent</strong></a></td>
<td>Récupère les notifications d’événements à partir du graphique de filtre.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Control/nn-control-imediaeventex"><strong>IMediaEventEx</strong></a></td>
<td>Étend l’interface <a href="/windows/desktop/api/Control/nn-control-imediaevent"><strong>IMediaEvent</strong></a> .</td>
</tr>
<tr class="odd">
...
<td>Contrôle l’état de diffusion en continu d’un filtre.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Control/nn-control-imediaposition"><strong>IMediaPosition</strong></a></td>
<td>Contrôles qui recherchent dans le graphique de filtre.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-imediapropertybag"><strong>IMediaPropertyBag</strong></a></td>
<td>Définit et récupère des blocs INFO et DISP dans des fichiers Audio-Video entrelacés (AVI).</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-imediasample"><strong>IMediaSample</strong></a></td>
<td>Définit et récupère des propriétés sur les exemples de supports.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-imediasample2"><strong>IMediaSample2</strong></a></td>
<td>Étend l’interface <a href="/windows/desktop/api/Strmif/nn-strmif-imediasample"><strong>IMediaSample</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-imediasample2config"><strong>IMediaSample2Config</strong></a></td>
<td>Retourne un pointeur vers une surface Direct3D représentant une mémoire tampon de capture VRAM.</td>
</tr>
<tr class="even">
...
<td>Interface de rappel de l’interface <a href="/windows/desktop/api/Strmif/nn-strmif-imemallocatorcallbacktemp"><strong>IMemAllocatorCallbackTemp</strong></a> .
<blockquote>
[!Note]<br />
Action déconseillée.
</blockquote>
...
<td>Remet les données multimédias à une broche d’entrée.</td>
</tr>
<tr class="odd">
...
<td>Interface de rappel de l’interface <a href="/previous-versions/windows/desktop/api/mixerocx/nn-mixerocx-imixerocx"><strong>IMixerOCX</strong></a> .</td>
</tr>
<tr class="odd">
...
<td>Étend l’interface <a href="/windows/desktop/api/Mpconfig/nn-mpconfig-imixerpinconfig"><strong>IMixerPinConfig</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-impeg2demultiplexer"><strong>IMpeg2Demultiplexer</strong></a></td>
<td>Configure le filtre de démultiplexage MPEG-2.</td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/api/bdaiface/nn-bdaiface-impeg2pidmap"><strong>IMPEG2PIDMap</strong></a></td>
<td>Associe une broche de sortie sur le filtre de démultiplexage MPEG-2 avec un ou plusieurs ID de paquet (PID).</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-impeg2streamidmap"><strong>IMPEG2StreamIdMap</strong></a></td>
<td>Associe une broche de sortie sur le filtre de démultiplexage MPEG-2 avec un ou plusieurs ID de flux.</td>
</tr>
<tr class="even">
...
<td>Configure le décodeur audio MPEG-1.</td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ioverlay"><strong>IOverlay</strong></a></td>
<td>Permet à un filtre d’écrire directement dans la mémoire vidéo.</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ioverlaynotify"><strong>IOverlayNotify</strong></a></td>
<td>Interface de rappel de l’interface <a href="/windows/desktop/api/Strmif/nn-strmif-ioverlay"><strong>IOverlay</strong></a> .</td>
</tr>
<tr class="odd">
...
<td>Modifie la période de minuterie utilisée par une horloge de référence.</td>
</tr>
<tr class="odd">
...
<td>Détermine si le <a href="video-mixing-renderer-filter-9.md">filtre de convertisseur de mixage vidéo 9</a> (VMR-9) conserve les proportions de la vidéo source</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ivmrdeinterlacecontrol"><strong>IVMRDeinterlaceControl</strong></a></td>
<td>Prend en charge l’entrelacement accéléré par matériel à l’aide de VMR-7.</td>
</tr>
<tr class="odd">
...
<td>Définit les préférences renderering sur le présentateur d’image utilisé par VMR-9.</td>
</tr>
<tr class="even">
...
<td>Alloue les surfaces Direct3D utilisées par l’allocateur VMR-9-presenter.</td>
</tr>
<tr class="odd">
...
<td>Étend l’interface <a href="/previous-versions/windows/desktop/api/vmr9/nn-vmr9-ivmrsurfaceallocator9"><strong>IVMRSurfaceAllocator9</strong></a> .</td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Strmif/nn-strmif-ivmrsurfaceallocatornotify"><strong>IVMRSurfaceAllocatorNotify</strong></a></td>
<td>Active l’Allocator-Presenter pour notifier VMR-7.</td>
</tr>
<tr class="odd">
...
<td>Contrôle la façon dont VMR-9 restitue un flux vidéo.</td>
</tr>
<tr class="even">
<td><a href="/previous-versions/windows/desktop/api/vpconfig/nn-vpconfig-ivpbaseconfig"><strong>IVPBaseConfig</strong></a></td>
<td>Interface de base pour l’interface <a href="/previous-versions/windows/desktop/api/vpconfig/nn-vpconfig-ivpconfig"><strong>IVPConfig</strong></a> .</td>
</tr>
<tr class="odd">
<td><a href="/previous-versions/windows/desktop/api/Vpnotify/nn-vpnotify-ivpbasenotify"><strong>IVPBaseNotify</strong></a></td>
<td>Interface de base pour l’interface <a href="/previous-versions/windows/desktop/api/Vpnotify/nn-vpnotify-ivpnotify"><strong>IVPNotify</strong></a> .</td>
</tr>
<tr class="even">
...
<td>Exposé par le filtre du gestionnaire de port vidéo.</td>
</tr>
<tr class="even">
...
<td>Étend l’interface <a href="/previous-versions/windows/desktop/api/Vpnotify/nn-vpnotify-ivpnotify"><strong>IVPNotify</strong></a> .</td>
</tr>
<tr class="even">
