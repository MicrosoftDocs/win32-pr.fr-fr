...
Les index de fréquence dans la table Australia ne conviennent pas pour une utilisation en tant que numéros de canaux. Notez également que les canaux 3, 4, 5 et 5A sont en phase de mise en attente pour d’autres utilisations.

### <a name="australia-broadcast-assignments"></a>Affectations de diffusion en Australie
...
### <a name="australia-cable-assignments"></a>Attributions de câbles pour l’Australie
