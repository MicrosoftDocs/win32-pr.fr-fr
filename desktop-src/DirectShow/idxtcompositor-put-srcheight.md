...
ms.locfileid: "119914919"
---
# <a name="idxtcompositorput_srcheight-method"></a>IDxtCompositor ::p ut \_ SrcHeight, méthode
...
La `put_SrcHeight` méthode spécifie la hauteur du rectangle source.
