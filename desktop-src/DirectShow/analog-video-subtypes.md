---
description: Les sous-types de vidéos analogiques suivants sont désormais obsolètes. Utilisez plutôt l’énumération AnalogVideoStandard.
...
ms.locfileid: "127112225"
---
# <a name="analog-video-subtypes"></a>Sous-types de vidéos analogiques

Les sous-types de vidéos analogiques suivants sont désormais obsolètes. Utilisez plutôt l’énumération [**AnalogVideoStandard**](/windows/win32/api/strmif/ne-strmif-analogvideostandard) .
...
| <span id="MEDIASUBTYPE_AnalogVideo_SECAM_K1"></span><span id="mediasubtype_analogvideo_secam_k1"></span><span id="MEDIASUBTYPE_ANALOGVIDEO_SECAM_K1"></span><dl> <dt>**MEDIASUBTYPE \_ AnalogVideo \_ SECAM \_ K1 K1**</dt> </dl> | KL SECAM<br/> |
