...
---
# <a name="hong-kong-sar-channel-assignments"></a>Affectations de canaux SAR de Hong Kong

Cette rubrique répertorie les tables de fréquence utilisées pour le réglage de la télévision analogique pour la RAS de Hong Kong.
