...
ms.locfileid: "126857764"
---
# <a name="iamtimelinegroupsetgroupname-method"></a>IAMTimelineGroup :: SetGroupName, méthode
...
La `SetGroupName` méthode définit le nom défini par l’application du groupe.
...
**BSTR** qui spécifie le nom du groupe. La longueur maximale du nom est de 256 caractères, incluant la marque de fin null.
