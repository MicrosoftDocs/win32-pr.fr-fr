...
ms.locfileid: "118401080"
---
# <a name="iamtimelinegetgroupcount-method"></a>IAMTimeline :: GetGroupCount, méthode
...
La `GetGroupCount` méthode récupère le nombre de groupes contenus dans la chronologie.
...
Reçoit le nombre de groupes dans la chronologie.
