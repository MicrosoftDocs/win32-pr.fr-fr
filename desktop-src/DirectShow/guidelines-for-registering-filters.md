...
ms.locfileid: "127119914"
---
# <a name="guidelines-for-registering-filters"></a>Instructions pour l’enregistrement des filtres

les informations de registre de filtre déterminent la façon dont le gestionnaire de Graph de filtre fonctionne au cours des [Connecter intelligentes](intelligent-connect.md). par conséquent, elle affecte toutes les applications écrites pour DirectShow, pas seulement celles qui utiliseront votre filtre. Vous devez vous assurer que votre filtre se comporte correctement, en suivant ces instructions.
...
5.  n’inscrivez pas un filtre dans la catégorie « filtres de DirectShow » qui accepte les couleurs rvb 24 bits. Votre filtre interfère avec le filtre de convertisseur d’espace de couleurs.
