...
Pour plus d’informations sur les filtres de wrapper et les périphériques de streaming WDM, voir [Comment les périphériques matériels participent au filtre Graph](how-hardware-devices-participate-in-the-filter-graph.md).
