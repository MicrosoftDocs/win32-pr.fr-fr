...
ms.locfileid: "126853695"
---
# <a name="irenderenginesetrenderrange2-method"></a>IRenderEngine :: SetRenderRange2, méthode
...
La `SetRenderRange2` méthode définit la plage de temps de la chronologie à restituer. Cette méthode est équivalente à [**IRenderEngine :: SetRenderRange**](irenderengine-setrenderrange.md), mais prend des valeurs de type **double**.
