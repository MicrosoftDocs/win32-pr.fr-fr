...
---
# <a name="idxtjpegget_replicatex-method"></a>IDxtJpeg :: \_ ReplicateX, méthode
...
La `get_ReplicateX` méthode récupère le nombre de fois où le modèle de réinitialisation est répliqué horizontalement.
...
Reçoit le nombre de fois que le modèle de réinitialisation est répliqué horizontalement.
