...
2.  Substituez la méthode [**CBasePin :: CheckConnect**](cbasepin-checkconnect.md) pour appeler [**CPullPin :: Connect**](cpullpin-connect.md). Cette méthode interroge l’autre code confidentiel pour **IAsyncReader**.
...
| [**Duration**](cpullpin-duration.md)               | Récupère la durée du flux.                                                 |
...
|--------------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| En-tête<br/>  | <dl> <dt>Pullpin. h (include streams. h)</dt> </dl>                                                                                   |
