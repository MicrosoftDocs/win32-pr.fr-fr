...
Les index de fréquence des tables en Irlande ne conviennent pas pour une utilisation en tant que numéros de canaux.

-   [Windows 7 et versions ultérieures](#windows-7-and-later)
    -   [Affectations de diffusion en Irlande](#ireland-broadcast-assignments)
    -   [Attributions de câbles pour l’Irlande](#ireland-cable-assignments)
...
### <a name="ireland-broadcast-assignments"></a>Affectations de diffusion en Irlande
...
### <a name="ireland-cable-assignments"></a>Attributions de câbles pour l’Irlande
