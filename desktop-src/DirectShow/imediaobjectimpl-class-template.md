...
|-------------------------------------------|----------------------------------------------|
| [**LockIt**](imediaobjectimpl-lockit.md) | Classe d’assistance qui verrouille et déverrouille la classe DMO. |
...
| [**Lock**](/previous-versions/ms809100(v=msdn.10))                                       | Verrouille la DMO                                                        |
...
| [**Bloquer**](/previous-versions/ms809101(v=msdn.10))                                   | Déverrouille le                                                      |
