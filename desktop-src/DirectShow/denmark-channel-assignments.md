...
---
# <a name="denmark-channel-assignments"></a>Affectations de canaux Danemark

Cette rubrique répertorie les tables de fréquence utilisées pour le réglage TV analogique pour le Danemark.
