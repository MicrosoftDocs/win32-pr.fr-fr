...
ms.locfileid: "119983709"
---
# <a name="cbasecontrolvideoput_destinationleft-method"></a>CBaseControlVideo. put \_ DestinationLeft, méthode

La `put_DestinationLeft` méthode définit la coordonnée gauche du rectangle de destination.
...
Nouvelle coordonnée gauche du rectangle de destination.
