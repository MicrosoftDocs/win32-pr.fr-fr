...
ms.locfileid: "126923439"
---
# <a name="idxtcompositorput_srcwidth-method"></a>IDxtCompositor ::p ut \_ SrcWidth, méthode
...
La `put_SrcWidth` méthode spécifie la largeur du rectangle source.
...
Largeur du rectangle source, en pixels.
