...
Cet article décrit la fusion alpha dans les [services d’édition DirectShow](directshow-editing-services.md) (des).
...
DirectShow définit deux types de médias pour la vidéo RGB 32 bits :
