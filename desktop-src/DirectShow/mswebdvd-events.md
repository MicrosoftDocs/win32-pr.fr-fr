...
Le contrôle de® Microsoft® ActiveX MSWebDVD avertit votre application lorsque divers types d’événements internes se produisent ou lorsque certaines informations sont rencontrées sur le disque.
...
| [**Sort**](resume.md)                                               | Envoyé lorsque la commande de **reprise** a été activée ou désactivée.                        |
