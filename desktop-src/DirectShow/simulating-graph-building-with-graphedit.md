...
---
# <a name="simulating-graph-building-with-graphedit"></a>Simulation de la génération de graphiques avec GraphEdit
...
-   [Chargement d’un graphique à partir d’un processus externe](loading-a-graph-from-an-external-process.md)
-   [Enregistrement d’un graphique de filtre dans un fichier baGraphEdit](saving-a-filter-graph-to-a-graphedit-file.md)
