...
ms.locfileid: "118155323"
---
# <a name="iamtimelineobjgetuserid-method"></a>IAMTimelineObj :: GetUserID, méthode
...
La `GetUserID` méthode récupère l’identificateur défini par l’application de l’objet.
...
Reçoit l’identificateur défini par l’application.
