...
Cette propriété est en lecture/écriture et sa valeur par défaut est true. Lorsque vous affichez un disque DVD-Video, un utilisateur n’utilise généralement pas la souris ou le clavier pendant des périodes prolongées. Par conséquent, le contrôle de® ActiveX MSWebDVD désactive l’économiseur d’écran système par défaut. Object
