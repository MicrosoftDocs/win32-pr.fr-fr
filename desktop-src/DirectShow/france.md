...
Les index de fréquence dans les tables françaises ne conviennent pas pour une utilisation en tant que numéros de canaux.

-   [Windows 7 et versions ultérieures](#windows-7-and-later)
    -   [Affectations Broadcast France](#france-broadcast-assignments)
    -   [Attributions de câble pour la France](#france-cable-assignments)
...
### <a name="france-broadcast-assignments"></a>Affectations Broadcast France
...
### <a name="france-cable-assignments"></a>Attributions de câble pour la France
