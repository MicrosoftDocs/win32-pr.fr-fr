...
La `Active` méthode notifie le code confidentiel que le filtre est maintenant actif. Cette méthode remplace la méthode [**CBasePin :: active**](cbasepin-active.md) .
