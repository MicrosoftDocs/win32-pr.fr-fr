...
ms.locfileid: "126857638"
---
# <a name="iamtimelinesrcsetmediatimes2-method"></a>IAMTimelineSrc :: SetMediaTimes2, méthode
...
La `SetMediaTimes2` méthode définit les heures de démarrage et d’arrêt du support. Cette méthode est équivalente à [**IAMTimelineSrc :: SetMediaTimes**](iamtimelinesrc-setmediatimes.md), mais prend des valeurs [**REFTIME**](reftime.md) .
...
Heure de début du média, en secondes.
...
Temps d’arrêt du support, en secondes.
