...
Utilisez cette fonction pour configurer vos filtres. pour plus d’informations, consultez [comment inscrire des filtres de DirectShow](how-to-register-directshow-filters.md).
