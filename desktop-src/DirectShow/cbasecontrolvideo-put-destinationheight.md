...
ms.locfileid: "119017427"
---
# <a name="cbasecontrolvideoput_destinationheight-method"></a>CBaseControlVideo. put \_ DestinationHeight, méthode

La `put_DestinationHeight` méthode définit la hauteur du rectangle de destination.
...
Nouvelle hauteur de destination.
