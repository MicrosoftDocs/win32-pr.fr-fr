...
ms.locfileid: "118399664"
---
# <a name="iamtimelineobjsetusername-method"></a>IAMTimelineObj :: SetUserName, méthode
...
La `SetUserName` méthode définit un nom défini par l’application pour l’objet.
...
Chaîne de caractères larges qui contient le nom. Les chaînes de plus de 256 caractères peuvent être tronquées.
