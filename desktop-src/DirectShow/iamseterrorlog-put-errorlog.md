...
ms.locfileid: "120102719"
---
# <a name="iamseterrorlogput_errorlog-method"></a>IAMSetErrorLog ::p ut \_ ErrorLog (méthode)
...
La `put_ErrorLog` méthode spécifie un journal des erreurs pour l’objet.
...
Pointeur vers l’interface [**IAMErrorLog**](iamerrorlog.md) du journal des erreurs.
