...
ms.locfileid: "119038297"
---
# <a name="alpha-blending-a-bitmap"></a>Fusion alpha d’une image bitmap

L’exemple de code suivant divise une fenêtre en trois zones horizontales. Ensuite, il dessine un bitmap à contrôle alpha dans chacune des zones de la fenêtre, comme suit :

-   Dans la zone supérieure, constante alpha = 50%, mais il n’y a pas d’alpha source.
-   Dans la zone centrale, constante Alpha = 100% (désactivé) et alpha source est 0 (transparent) au milieu de l’image bitmap et 0xFF (opaque) ailleurs.
-   Dans la zone inférieure, constante alpha = 75% et modification alpha source.
