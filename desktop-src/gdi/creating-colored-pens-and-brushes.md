...
---
# <a name="creating-colored-pens-and-brushes"></a>Création de stylets et de pinceaux de couleur

Bien que vous puissiez spécifier une couleur pour un stylet lors de sa création, le système utilise uniquement les couleurs disponibles sur l’appareil. Cela signifie que le système utilise la couleur de correspondance la plus proche lorsqu’il réalise le stylet pour dessiner. Lorsque vous créez des pinceaux, le système génère une couleur dégradée si vous spécifiez une couleur que l’appareil ne prend pas en charge. Dans les deux cas, vous pouvez utiliser la macro [**RGB**](/windows/desktop/api/Wingdi/nf-wingdi-rgb) pour spécifier une couleur lors de la création d’un stylet ou d’un pinceau.
