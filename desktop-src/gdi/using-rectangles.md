---
description: L’exemple de cette section montre comment utiliser les fonctions rectangle. Il se compose de la procédure de fenêtre principale d’une application qui permet à l’utilisateur de déplacer et de dimensionner une image bitmap.
ms.assetid: e8861240-9345-43e6-820d-d237247d1bd7
title: Utilisation de rectangles (Windows GDI)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103952966"
---
# <a name="using-rectangles-windows-gdi"></a><span data-ttu-id="d9880-104">Utilisation de rectangles (Windows GDI)</span><span class="sxs-lookup"><span data-stu-id="d9880-104">Using Rectangles (Windows GDI)</span></span>

<span data-ttu-id="d9880-105">L’exemple de cette section montre comment utiliser les fonctions rectangle.</span><span class="sxs-lookup"><span data-stu-id="d9880-105">The example in this section illustrates how to use the rectangle functions.</span></span> <span data-ttu-id="d9880-106">Il se compose de la procédure de fenêtre principale d’une application qui permet à l’utilisateur de déplacer et de dimensionner une image bitmap.</span><span class="sxs-lookup"><span data-stu-id="d9880-106">It consists of the main window procedure from an application that enables the user to move and size a bitmap.</span></span>

<span data-ttu-id="d9880-107">Lorsque l’application démarre, elle dessine une image bitmap de 32 pixels par 32 pixels dans le coin supérieur gauche de l’écran.</span><span class="sxs-lookup"><span data-stu-id="d9880-107">When the application starts, it draws a 32-pixel by 32-pixel bitmap in the upper left corner of the screen.</span></span> <span data-ttu-id="d9880-108">L’utilisateur peut déplacer la bitmap en la faisant glisser.</span><span class="sxs-lookup"><span data-stu-id="d9880-108">The user can move the bitmap by dragging it.</span></span> <span data-ttu-id="d9880-109">Pour dimensionner la bitmap, l’utilisateur crée un rectangle cible en faisant glisser la souris, puis fait glisser le bitmap et le « dépose » sur le rectangle cible.</span><span class="sxs-lookup"><span data-stu-id="d9880-109">To size the bitmap, the user creates a target rectangle by dragging the mouse, then drags the bitmap and "drops" it on the target rectangle.</span></span> <span data-ttu-id="d9880-110">L’application répond en copiant l’image bitmap dans le rectangle cible.</span><span class="sxs-lookup"><span data-stu-id="d9880-110">The application responds by copying the bitmap into the target rectangle.</span></span>

<span data-ttu-id="d9880-111">La procédure de fenêtre qui permet à l’utilisateur de déplacer et de dimensionner la bitmap est donnée dans l’exemple suivant.</span><span class="sxs-lookup"><span data-stu-id="d9880-111">The window procedure that allows the user to move and size the bitmap is given in the following example.</span></span>
