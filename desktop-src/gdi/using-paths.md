...
ms.locfileid: "127118282"
---
# <a name="using-paths"></a>Utilisation des chemins d’accès

Cette section contient un exemple de code qui permet à l’utilisateur de sélectionner une police d’une taille de point particulière (à l’aide de la boîte de dialogue Choisir la police), de sélectionner un tracé de clip (à l’aide du texte dessiné avec cette police), puis d’afficher le résultat du découpage dans le texte.

Cet exemple de code a été utilisé pour créer l’illustration qui apparaît dans les [tracés de clip](clip-paths.md).
