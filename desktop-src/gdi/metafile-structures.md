---
description: Les structures suivantes sont utilisées avec les sous-fichiers de format amélioré.
...
Les structures suivantes sont utilisées avec les sous-fichiers de format amélioré.
...
Notez que la structure [**le**](/windows/win32/api/wingdi/ns-wingdi-emr) est utilisée comme premier membre des structures restantes.  
