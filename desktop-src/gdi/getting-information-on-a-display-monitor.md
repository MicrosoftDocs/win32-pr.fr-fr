...
ms.locfileid: "117886722"
---
# <a name="getting-information-on-a-display-monitor"></a>Obtention d’informations sur un moniteur d’affichage

L’exemple de code suivant montre comment utiliser [**EnumDisplayDevices**](/windows/desktop/api/Winuser/nf-winuser-enumdisplaydevicesa) pour obtenir des informations sur un moniteur d’affichage.
