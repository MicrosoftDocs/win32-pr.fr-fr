...
ms.locfileid: "126914304"
---
# <a name="bitmap-structures"></a>Structures bitmap

Les structures suivantes sont utilisées avec les bitmaps :

-   [**PIXELS**](/windows/win32/api/wingdi/ns-wingdi-bitmap)
