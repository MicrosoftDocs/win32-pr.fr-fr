...
|---------------|----------------------------------------------------------------------------------------------------------------------------|
| Contexte    | Définit comment les couleurs d’arrière-plan sont mélangées avec des couleurs de fenêtre ou d’écran existantes pour les opérations de bitmap et de texte.              |
...
|---------------|------------------------------------------------|
| Contexte    | [**GetBkMode**](/windows/desktop/api/Wingdi/nf-wingdi-getbkmode)                 |
...
| Mode graphique | Fonction                                       |
|---------------|------------------------------------------------|
| Contexte    | [**SetBkMode**](/windows/desktop/api/Wingdi/nf-wingdi-setbkmode)                 |
