...
Les structures suivantes sont utilisées avec les polices et le texte.
...
[**DES**](/windows/desktop/api/Wingdi/ns-wingdi-fixed)  
[**résultats de GCP \_**](/windows/win32/api/wingdi/ns-wingdi-gcp_resultsa)  
...
[**État du RASTÉRISEUR \_**](/windows/desktop/api/Wingdi/ns-wingdi-rasterizer_status)  
[**CORPS**](/previous-versions//dd145106(v=vs.85))  
