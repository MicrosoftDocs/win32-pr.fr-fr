...
| 0     | Fin de ligne.                                                                                                                                                |
| 1     | Fin de bitmap.                                                                                                                                              |
| 2     | Set. Les 2 octets qui suivent l’échappement contiennent des valeurs non signées indiquant les décalages horizontal et vertical du pixel suivant à partir de la position actuelle. |
