...
Pour vous déconnecter d’un capteur logique, vous devez fournir le même ID logique que celui que vous avez utilisé lors de l’appel de [**connecter**](/previous-versions/windows/desktop/legacy/dd374029(v=vs.85)).
...
Pour désinstaller un capteur logique, vous devez fournir le même ID logique que celui que vous avez utilisé lors de l’appel de [**connecter**](/previous-versions/windows/desktop/legacy/dd374029(v=vs.85)).
