...
description: Windows 7 offre une plateforme puissante, hautement extensible et gérable pour la création et l’intégration des services web et des applications futures. Windows 7 offre des api à code managé et des api natives pour la création et l’exécution de services web.
...
pour plus d’informations, consultez [Windows l’api des services](../wsw/portal.md) web et [implémenter des services web avec l’api des services web Windows](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/web/WWSAPI).
