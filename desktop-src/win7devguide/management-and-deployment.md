...
Windows Installer a été mis à jour pour améliorer l’efficacité des développeurs en réduisant la quantité de code personnalisé nécessaire à la création d’un package d’installation et en créant de véritables installations logicielles par utilisateur.
