...
ms.locfileid: "118428432"
---
# <a name="example-code-for-using-a-vlv-search"></a>Exemple de code pour l’utilisation d’une recherche VLV

Les exemples de code suivants utilisent des recherches VLV pour obtenir des résultats de recherche.
...
Les exemples de code suivants sont utilisés par les exemples de fonctions de cette rubrique.
...
## <a name="getvlvitemcount-example-function"></a>GetVLVItemCount, exemple de fonction

L’exemple de code suivant montre comment utiliser une recherche VLV pour obtenir une estimation du nombre d’éléments qui résultent de la recherche.
...
## <a name="getvlvitemtext-example-function"></a>GetVLVItemText, exemple de fonction

L’exemple de code suivant montre comment utiliser une recherche VLV pour obtenir le texte d’un élément unique en fonction d’un index.
...
## <a name="getvlvitemsbystring-example-function"></a>GetVLVItemsByString, exemple de fonction

L’exemple de code suivant montre comment utiliser une recherche VLV pour obtenir le texte d’un nombre spécifié d’éléments en fonction d’une chaîne. Cet exemple ajoute les tris récupérés à une zone de liste.
