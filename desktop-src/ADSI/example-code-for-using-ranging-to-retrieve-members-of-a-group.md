...
---
# <a name="example-code-for-using-ranging-to-retrieve-members-of-a-group"></a>Exemple de code pour l’utilisation de permettant de récupérer des membres d’un groupe

L’exemple de code suivant utilise des objets d’annuaire ActiveX (ADO) pour récupérer les membres d’un groupe.

L’extrait de code suivant requiert une référence à la bibliothèque Microsoft ActiveX Data Objects 6,0.
