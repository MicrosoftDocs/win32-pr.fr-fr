...
description: l’exemple de code suivant utilise des objets ActiveX Directory (ADO) pour récupérer les membres d’un groupe.
...
l’exemple de code suivant utilise des objets ActiveX Directory (ADO) pour récupérer les membres d’un groupe.
