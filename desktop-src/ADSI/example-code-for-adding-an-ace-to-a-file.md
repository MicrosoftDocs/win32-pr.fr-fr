---
title: Exemple de code pour l’ajout d’une entrée du contrôle d’accès à un fichier
description: L’exemple de code suivant montre comment utiliser l’interface IADsSecurityUtility pour ajouter une entrée du contrôle d’accès à un fichier.
ms.assetid: d47d3ebe-cc14-412d-be27-841e25b43c3a
ms.tgt_platform: multiple
keywords:
- Exemple de code pour l’ajout d’une entrée du contrôle d’accès à un fichier ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106509977"
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a><span data-ttu-id="f1ebd-104">Exemple de code pour l’ajout d’une entrée du contrôle d’accès à un fichier</span><span class="sxs-lookup"><span data-stu-id="f1ebd-104">Example Code for Adding an ACE to a File</span></span>

<span data-ttu-id="f1ebd-105">L’exemple de code suivant montre comment utiliser l’interface [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) pour ajouter une entrée du contrôle d’accès à un fichier.</span><span class="sxs-lookup"><span data-stu-id="f1ebd-105">The following code example shows how to use the [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) interface to add an ACE to a file.</span></span>
