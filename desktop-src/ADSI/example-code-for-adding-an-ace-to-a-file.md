...
---
# <a name="example-code-for-adding-an-ace-to-a-file"></a>Exemple de code pour l’ajout d’une entrée du contrôle d’accès à un fichier

L’exemple de code suivant montre comment utiliser l’interface [**IADsSecurityUtility**](/windows/desktop/api/Iads/nn-iads-iadssecurityutility) pour ajouter une entrée du contrôle d’accès à un fichier.
