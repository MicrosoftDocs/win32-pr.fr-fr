...
les versions actuelles de VBScript et JScript ne prennent pas non plus en charge l’accès à vtable. par conséquent, une interface double dans un environnement VBScript ou JScript fonctionne comme une interface de dispatch.
