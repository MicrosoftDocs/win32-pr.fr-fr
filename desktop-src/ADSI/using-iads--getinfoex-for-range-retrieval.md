...
ms.locfileid: "103939570"
---
# <a name="using-iadsgetinfoex-for-range-retrieval"></a><span data-ttu-id="928c8-106">Utilisation de IADs :: GetInfoEx pour la récupération de plages</span><span class="sxs-lookup"><span data-stu-id="928c8-106">Using IADs::GetInfoEx for Range Retrieval</span></span>

<span data-ttu-id="928c8-107">La méthode [**IADs. GetInfoEx**](/windows/desktop/api/Iads/nf-iads-iads-getinfoex) peut être utilisée pour récupérer une plage de valeurs d’attribut.</span><span class="sxs-lookup"><span data-stu-id="928c8-107">The [**IADs.GetInfoEx**](/windows/desktop/api/Iads/nf-iads-iads-getinfoex) method can be used to retrieve a range of attribute values.</span></span> <span data-ttu-id="928c8-108">La plage de valeurs à récupérer est spécifiée dans le tableau de noms d’attributs passé à la méthode.</span><span class="sxs-lookup"><span data-stu-id="928c8-108">The range of values to retrieve is specified in the attribute name array passed to the method.</span></span>

<span data-ttu-id="928c8-109">Les spécificateurs de plage pour une requête de propriété requièrent la forme suivante :</span><span class="sxs-lookup"><span data-stu-id="928c8-109">The range specifiers for a property query require the following form:</span></span>
...
<span data-ttu-id="928c8-110">où « &lt; nom &gt; de la propriété » est le **ldapDisplayName** de l’attribut, « &lt; la plage basse &gt; » est l’index de base zéro de la première valeur d’attribut à récupérer et « &lt; la plage supérieure &gt; » est l’index de base zéro de la dernière valeur d’attribut à récupérer.</span><span class="sxs-lookup"><span data-stu-id="928c8-110">where "&lt;property name&gt;" is the **ldapDisplayName** of the attribute, "&lt;low range&gt;" is the zero-based index of the first attribute value to retrieve and "&lt;high range&gt;" is the zero-based index of the last attribute value to retrieve.</span></span> <span data-ttu-id="928c8-111">La valeur zéro est utilisée pour &lt; la « plage inférieure &gt; » pour spécifier la première entrée.</span><span class="sxs-lookup"><span data-stu-id="928c8-111">Zero is used for "&lt;low range&gt;" to specify the first entry.</span></span> <span data-ttu-id="928c8-112">Le caractère générique ( \* ) peut être utilisé pour la « &lt; plage supérieure &gt; » afin de spécifier toutes les entrées restantes.</span><span class="sxs-lookup"><span data-stu-id="928c8-112">The wildcard character (\*) can be used for "&lt;high range&gt;" to specify all remaining entries.</span></span>

<span data-ttu-id="928c8-113">L’exemple de code suivant contient une fonction qui montre comment utiliser la récupération de plages avec [**IADs :: GetInfoEx**](/windows/desktop/api/Iads/nf-iads-iads-getinfoex) pour énumérer les membres d’un groupe.</span><span class="sxs-lookup"><span data-stu-id="928c8-113">The following code example contains a function that shows how to use range retrieval with [**IADs::GetInfoEx**](/windows/desktop/api/Iads/nf-iads-iads-getinfoex) to enumerate the members of a group.</span></span>
...
<span data-ttu-id="928c8-114">L’exemple de code suivant contient une fonction qui montre comment utiliser la récupération de plages avec [**IADs. GetInfoEx**](/windows/desktop/api/Iads/nf-iads-iads-getinfoex) pour énumérer les membres d’un groupe.</span><span class="sxs-lookup"><span data-stu-id="928c8-114">The following code example contains a function that shows how to use range retrieval with [**IADs.GetInfoEx**](/windows/desktop/api/Iads/nf-iads-iads-getinfoex) to enumerate the members of a group.</span></span>
