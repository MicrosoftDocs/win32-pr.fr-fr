---
title: Exemple de code pour l’utilisation des messages d’erreur ADSI
description: L’exemple de code suivant montre comment récupérer un message d’erreur ADSI.
ms.assetid: c09fea2e-b6c1-4318-a7a6-b1c4c30ef4cb
ms.tgt_platform: multiple
keywords:
- messages d’erreur et exemple de code pour ADSI
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103839221"
---
# <a name="code-example-for-working-with-adsi-error-messages"></a><span data-ttu-id="5a61c-104">Exemple de code pour l’utilisation des messages d’erreur ADSI</span><span class="sxs-lookup"><span data-stu-id="5a61c-104">Code Example for Working with ADSI Error Messages</span></span>

<span data-ttu-id="5a61c-105">L’exemple de code suivant montre comment récupérer un message d’erreur ADSI.</span><span class="sxs-lookup"><span data-stu-id="5a61c-105">The following code example shows how to retrieve an ADSI error message.</span></span>
