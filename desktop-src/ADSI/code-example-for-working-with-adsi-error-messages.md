...
---
# <a name="code-example-for-working-with-adsi-error-messages"></a>Exemple de code pour l’utilisation des messages d’erreur ADSI

L’exemple de code suivant montre comment récupérer un message d’erreur ADSI.
