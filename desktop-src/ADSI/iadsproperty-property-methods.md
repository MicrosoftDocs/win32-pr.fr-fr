...
ms.locfileid: "118691058"
---
# <a name="iadsproperty-property-methods"></a>Méthodes de propriété IADsProperty

Les méthodes de propriété de l’interface [**IADsProperty**](/windows/desktop/api/Iads/nn-iads-iadsproperty) lisent et écrivent les propriétés décrites dans le tableau suivant. Pour plus d’informations sur les méthodes de propriété, consultez [méthodes de propriété d’interface](interface-property-methods.md).
...
Indique si la propriété prend en charge des valeurs uniques ou multiples.
...
Identificateur d’objet spécifique au répertoire.
...
Chemin d’accès relatif de l’objet de syntaxe.
...
L’exemple de code suivant examine l’attribut **OperatingSystem** d’un ordinateur sur un réseau par le biais du fournisseur Winnt.
...
L’exemple de code suivant examine l’attribut **OperatingSystem** d’un ordinateur sur un réseau par le biais du fournisseur Winnt. Par souci de concision, la vérification des erreurs est omise.
...
| IID<br/>                      | IID \_ IADsProperty est défini en tant que C8F93DD3-4AE0-11CF-9E73-00AA004A5691<br/>         |
