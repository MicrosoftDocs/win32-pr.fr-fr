...
---
# <a name="example-code-for-ranging-with-idirectoryobject"></a><span data-ttu-id="24709-105">Exemple de code pour IDirectoryObject</span><span class="sxs-lookup"><span data-stu-id="24709-105">Example Code for Ranging with IDirectoryObject</span></span>

<span data-ttu-id="24709-106">L’exemple de code suivant utilise pour récupérer les membres d’un groupe à l’aide de l’interface [**IDirectoryObject**](/windows/desktop/api/Iads/nn-iads-idirectoryobject) .</span><span class="sxs-lookup"><span data-stu-id="24709-106">The following code example uses ranging to retrieve the members of a group using the [**IDirectoryObject**](/windows/desktop/api/Iads/nn-iads-idirectoryobject) interface.</span></span>
