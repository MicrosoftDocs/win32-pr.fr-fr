...
| Méthodes [**IADsContainer**](/windows/desktop/api/Iads/nn-iads-iadscontainer) standard, y compris les implémentations de : | [](/windows/desktop/api/Iads/nf-iads-iadscontainer-getobject)[**Récupération \_ \_** de la fonction GetObject](/windows/desktop/api/Iads/nf-iads-iadscontainer-get__newenum)<br/> [**recevoir le \_ filtre**](iadscontainer-property-methods.md)<br/> [**Créer**](/windows/desktop/api/Iads/nf-iads-iadscontainer-create)<br/> [**Supprimer**](/windows/desktop/api/Iads/nf-iads-iadscontainer-delete)<br/>                                            |
