...
L’exemple de code suivant utilise pour récupérer les membres d’un groupe à l’aide de l’interface [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) .
