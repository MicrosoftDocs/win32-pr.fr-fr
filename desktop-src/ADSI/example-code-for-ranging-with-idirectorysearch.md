---
title: Exemple de code pour la fonction IDirectorySearch
description: L’exemple de code suivant utilise pour récupérer les membres d’un groupe à l’aide de l’interface IDirectorySearch.
ms.assetid: 13aba22f-c649-4dda-804f-01ba493cd6d7
ms.tgt_platform: multiple
keywords:
- Exemple de code pour la fonction avec l’ADSI IDirectorySearch
...
---
# <a name="example-code-for-ranging-with-idirectorysearch"></a><span data-ttu-id="4e4c7-105">Exemple de code pour la fonction IDirectorySearch</span><span class="sxs-lookup"><span data-stu-id="4e4c7-105">Example Code for Ranging with IDirectorySearch</span></span>

<span data-ttu-id="4e4c7-106">L’exemple de code suivant utilise pour récupérer les membres d’un groupe à l’aide de l’interface [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) .</span><span class="sxs-lookup"><span data-stu-id="4e4c7-106">The following code example uses ranging to retrieve the members of a group using the [**IDirectorySearch**](/windows/desktop/api/Iads/nn-iads-idirectorysearch) interface.</span></span>
