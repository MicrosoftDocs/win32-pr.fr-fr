...
---
# <a name="example-code-for-reading-a-constructed-attribute"></a><span data-ttu-id="8555b-104">Exemple de code pour la lecture d’un attribut construit</span><span class="sxs-lookup"><span data-stu-id="8555b-104">Example Code for Reading a Constructed Attribute</span></span>

<span data-ttu-id="8555b-105">L’exemple de code suivant montre une méthode qui peut être utilisée pour récupérer une valeur d’attribut qui fonctionne avec tous les types d’attributs.</span><span class="sxs-lookup"><span data-stu-id="8555b-105">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
...
<span data-ttu-id="8555b-106">L’exemple de code suivant montre une méthode qui peut être utilisée pour récupérer une valeur d’attribut qui fonctionne avec tous les types d’attributs.</span><span class="sxs-lookup"><span data-stu-id="8555b-106">The following code example shows a method that can be used to retrieve an attribute value that will work with all attributes types.</span></span>
