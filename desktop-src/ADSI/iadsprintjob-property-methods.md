...
ms.locfileid: "118427766"
---
# <a name="iadsprintjob-property-methods"></a>Méthodes de propriété IADsPrintJob

Les méthodes de propriété pour l’interface [**IADsPrintJob**](/windows/desktop/api/Iads/nn-iads-iadsprintjob) obtiennent ou définissent les propriétés décrites dans le tableau suivant. Pour plus d’informations, consultez [méthodes de propriété d’interface](interface-property-methods.md).
...
Chaîne ADsPath de la file d’attente à l’impression qui traite le travail d’impression.
...
Utilisateur à notifier lorsque la tâche est terminée.
...
Heure à laquelle le travail d’impression doit être démarré au plus tôt.
...
Heure à laquelle le travail d’impression doit être démarré pour la dernière fois.
...
| IID<br/>                      | IID \_ IADsPrintJob est défini en tant que 32FB6780-1ED0-11CF-A988-00AA006BC149<br/>         |
