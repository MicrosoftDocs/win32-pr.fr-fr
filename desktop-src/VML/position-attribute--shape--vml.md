...
| absolute | L’élément est positionné par rapport au parent, à l’aide des attributs **Top** et **Left** . Cette valeur est utilisée par les objets flottants Microsoft Word et Microsoft Excel, ainsi que par les diapositives Microsoft PowerPoint.                  |
