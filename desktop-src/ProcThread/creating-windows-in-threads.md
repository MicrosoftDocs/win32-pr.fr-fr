...
---
# <a name="creating-windows-in-threads"></a>Créer des fenêtres dans les threads
...
Pour plus d’informations sur la création de fenêtres, consultez [classes Windows](../winmsg/window-classes.md).
