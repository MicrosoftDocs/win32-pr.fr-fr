...
ms.locfileid: "127096541"
---
# <a name="cpu_set_information_type-enumeration"></a>\_ \_ Énumération des types d’informations de jeu d’UC \_

Représente le type d’informations dans la structure des informations de l' [**\_ ensemble d’UC \_ \_ système**](/windows/desktop/api/winnt/ns-winnt-system_cpu_set_information) .
...
La structure contient des informations sur le jeu d’UC.
...
| En-tête<br/>                   | <dl> <dt>Processthreadsapi. h (inclure Windows. h)</dt> </dl> |
