...
Cet exemple crée un pool de threads personnalisé, crée un élément de travail et un minuteur de pool de threads, et les associe à un groupe de nettoyage. Le pool se compose d’un seul thread persistant. Il illustre l’utilisation des fonctions de pool de threads suivantes :

-   [**CloseThreadpoolWork**](/windows/win32/api/threadpoolapiset/nf-threadpoolapiset-closethreadpool)
