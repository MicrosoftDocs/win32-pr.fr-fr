...
La taille de l’icône Windows standard est trop grande pour être utilisée à cet effet. Cela requiert des conteneurs de contrôle qui ont un mode création dans lequel l’un sélectionne des contrôles et les place sur un formulaire en cours de conception.
