---
title: Structures (OLE et Transfert de données)
description: Les structures suivantes sont utilisées pour implémenter des documents composés et effectuer un transfert de données entre des applications.
...
ms.locfileid: "104032202"
---
# <a name="structures-ole-and-data-transfer"></a>Structures (OLE et Transfert de données)

Les structures suivantes sont utilisées pour implémenter des documents composés et effectuer un transfert de données entre des applications.
...
-   [**FACULTATIVE**](/windows/desktop/api/ObjIdl/nn-objidl-ienumformatetc)
