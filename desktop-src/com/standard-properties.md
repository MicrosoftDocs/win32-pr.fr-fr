...
| Police<br/>                                                                                | **IDispatch \** _<br/>      | Police utilisée dans le contrôle, qui est un pointeur _ *IDispatch** vers un objet de police standard. Pour plus d’informations, consultez [objet de police standard](standard-font-object.md) .<br/>                                                         |
...
| MessageReflect<br/>                | **Boolean**<br/>         | spécifie si le conteneur souhaite recevoir des messages Windows tels que wm \_ CTLCOLOR, wm \_ DRAWITEM, wm \_ PARENTNOTIFY, etc. comme des événements.<br/>                                                                                                                                                                                                                                           |
