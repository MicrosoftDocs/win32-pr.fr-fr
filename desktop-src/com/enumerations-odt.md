---
title: Énumérations (OLE et Transfert de données)
description: Les énumérations suivantes permettent d’implémenter des documents composés et d’effectuer un transfert de données entre des applications.
...
ms.locfileid: "126923239"
---
# <a name="enumerations-ole-and-data-transfer"></a>Énumérations (OLE et Transfert de données)

Les énumérations suivantes permettent d’implémenter des documents composés et d’effectuer un transfert de données entre des applications.
...
-   [**\_indicateur WINDOWSTATE \_ OLECMDID**](/windows/desktop/api/DocObj/ne-docobj-olecmdid_windowstate_flag)
