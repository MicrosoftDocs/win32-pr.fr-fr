...
| [Contrôles et pages de propriétés](controls-and-property-pages.md)<br/> | décrit les contrôles de ActiveX et les pages de propriétés.<br/>                                                                                        |
...
| [Stockage structuré](/windows/desktop/Stg/structured-storage-start-page)<br/>                 | la Stockage structurée fournit la persistance des fichiers et des données dans COM en gérant un seul fichier comme une collection structurée d’objets appelés stockages et flux.<br/>                                                                                                                                                                                                                                                                                                                  |
