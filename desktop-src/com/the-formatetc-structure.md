...
| **PTD**<br/>      | Une structure [**DVTARGETDEVICE**](/windows/win32/api/objidl/ns-objidl-dvtargetdevice) , qui contient suffisamment d’informations sur un appareil cible Windows, tel qu’un écran ou une imprimante, afin qu’un handle vers son contexte de périphérique (HDC) puisse être créé à l’aide de la fonction [**CreateDC**](/windows/desktop/api/wingdi/nf-wingdi-createdca) . <br/> |
