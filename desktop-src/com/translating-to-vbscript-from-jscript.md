...
---
# <a name="translating-to-vbscript-from-jscript"></a>Conversion en VBScript à partir de JScript
...
Les tableaux JScript ne sont pas des tableaux du type de variable **Variant SAFEARRAY**. Un script JScript doit utiliser un objet VBArray pour accéder à la variable de **type SAFEARRAY**. Les scripts VBScript peuvent accéder directement à des variables de **type SAFEARRAY**.
