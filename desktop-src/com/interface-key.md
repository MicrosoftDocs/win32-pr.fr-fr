...
| [**ProxyStubClsid**](proxystubclsid.md)     | Mappe un IID à un CLSID dans des dll proxy 16 bits.                                                           |
| [**ProxyStubClsid32**](proxystubclsid32.md) | Mappe un IID à un CLSID dans des dll de proxy 32 bits.                                                           |
