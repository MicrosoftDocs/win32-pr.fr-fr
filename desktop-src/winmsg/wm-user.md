...
ms.locfileid: "119705729"
---
# <a name="wm_user"></a>\_utilisateur WM
...
| Plage                                                        | Signification                                                        |
|--------------------------------------------------------------|----------------------------------------------------------------|
| 0 à **\_ utilisateur WM** – 1<br/>                         | Messages réservés pour une utilisation par le système.<br/>            |
| **WM \_ UTILISATEUR** via 0x7FFF<br/>                       | Messages entiers à utiliser par les classes de fenêtre privées.<br/> |
| [**WM \_ APPLICATION**](wm-app.md) (0x8000) via 0xBFFF<br/> | Messages disponibles pour une utilisation par des applications.<br/>         |
