...
| [Points d’analyse et opérations sur les fichiers](reparse-points-and-file-operations.md)<br/> | décrit comment les points d’analyse activent le comportement du système de fichiers qui fait partie du comportement le plus Windows les développeurs s’attendent.<br/>                                                                                     |
