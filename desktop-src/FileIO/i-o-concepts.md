...
| [Mise en cache des fichiers](file-caching.md)<br/>                                         | Windows met en cache les données de fichier qui sont lues à partir des disques et écrites sur les disques.<br/>                                                                                   |
