...
ms.locfileid: "106539321"
---
# <a name="moving-directories"></a><span data-ttu-id="6d9cd-103">Déplacement de répertoires</span><span class="sxs-lookup"><span data-stu-id="6d9cd-103">Moving Directories</span></span>

<span data-ttu-id="6d9cd-104">Pour déplacer un répertoire vers un autre emplacement, ainsi que les fichiers et les sous-répertoires qu’il contient, appelez la fonction [**MoveFileEx**](/windows/desktop/api/WinBase/nf-winbase-movefileexa), [**MoveFileWithProgress**](/windows/desktop/api/WinBase/nf-winbase-movefilewithprogressa)ou [**MoveFileTransacted**](/windows/desktop/api/WinBase/nf-winbase-movefiletransacteda) .</span><span class="sxs-lookup"><span data-stu-id="6d9cd-104">To move a directory to another location, along with the files and subdirectories contained within it, call the [**MoveFileEx**](/windows/desktop/api/WinBase/nf-winbase-movefileexa), [**MoveFileWithProgress**](/windows/desktop/api/WinBase/nf-winbase-movefilewithprogressa), or [**MoveFileTransacted**](/windows/desktop/api/WinBase/nf-winbase-movefiletransacteda) function.</span></span> <span data-ttu-id="6d9cd-105">La fonction [**MoveFileWithProgress**](/windows/desktop/api/WinBase/nf-winbase-movefilewithprogressa) a les mêmes fonctionnalités que [**MoveFileEx**](/windows/desktop/api/WinBase/nf-winbase-movefileexa), à ceci près que **MoveFileWithProgress** vous permet de spécifier une routine de rappel qui reçoit des notifications sur la progression de l’opération.</span><span class="sxs-lookup"><span data-stu-id="6d9cd-105">The [**MoveFileWithProgress**](/windows/desktop/api/WinBase/nf-winbase-movefilewithprogressa) function has the same functionality as [**MoveFileEx**](/windows/desktop/api/WinBase/nf-winbase-movefileexa), except that **MoveFileWithProgress** enables you to specify a callback routine that receives notifications on the progress of the operation.</span></span> <span data-ttu-id="6d9cd-106">La fonction [**MoveFileTransacted**](/windows/desktop/api/WinBase/nf-winbase-movefiletransacteda) vous permet d’effectuer l’opération en tant qu’opération traitée.</span><span class="sxs-lookup"><span data-stu-id="6d9cd-106">The [**MoveFileTransacted**](/windows/desktop/api/WinBase/nf-winbase-movefiletransacteda) function enables you to perform the operation as a transacted operation.</span></span>

<span data-ttu-id="6d9cd-107">L’exemple suivant illustre l’utilisation de la fonction [**MoveFileEx**](/windows/desktop/api/WinBase/nf-winbase-movefileexa) avec un répertoire.</span><span class="sxs-lookup"><span data-stu-id="6d9cd-107">The following example demonstrates the use of the [**MoveFileEx**](/windows/desktop/api/WinBase/nf-winbase-movefileexa) function with a directory.</span></span>
