...
| [Cohérence des données](data-coherency.md)<br/>                                                                     | Si les données sont cohérentes, les données sur le serveur et tous les clients sont synchronisées. Un type de système logiciel qui fournit la cohérence des données est un système de contrôle de révision (RCS).<br/>                                                                                                              |
