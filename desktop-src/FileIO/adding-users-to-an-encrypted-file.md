---
description: Exemple de code qui montre comment ajouter un nouvel utilisateur à un fichier chiffré existant à l’aide de la fonction AddUsersToEncryptedFile.
ms.assetid: 39260882-dc02-4f08-9d9b-f170c1e391df
title: Ajout d’utilisateurs à un fichier chiffré
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106518134"
---
# <a name="adding-users-to-an-encrypted-file"></a><span data-ttu-id="07455-103">Ajout d’utilisateurs à un fichier chiffré</span><span class="sxs-lookup"><span data-stu-id="07455-103">Adding Users to an Encrypted File</span></span>

<span data-ttu-id="07455-104">L’exemple de code de cette rubrique ajoute un nouvel utilisateur à un fichier chiffré existant à l’aide de la fonction [**AddUsersToEncryptedFile**](/windows/desktop/api/Winefs/nf-winefs-adduserstoencryptedfile) .</span><span class="sxs-lookup"><span data-stu-id="07455-104">The code sample in this topic adds a new user to an existing encrypted file by using the [**AddUsersToEncryptedFile**](/windows/desktop/api/Winefs/nf-winefs-adduserstoencryptedfile) function.</span></span> <span data-ttu-id="07455-105">Elle nécessite que le certificat de l’utilisateur système de fichiers EFS (EFS) (provenant du Active Directory) existe dans le magasin de certificats utilisateurs de personnes autorisées.</span><span class="sxs-lookup"><span data-stu-id="07455-105">It requires the user's Encrypting File System (EFS) certificate (from the Active Directory) to exist in the Trusted People user certificate store.</span></span>

<span data-ttu-id="07455-106">Cet exemple ajoute un nouveau champ de récupération de données au fichier chiffré.</span><span class="sxs-lookup"><span data-stu-id="07455-106">This sample adds a new Data Recovery Field to the encrypted file.</span></span> <span data-ttu-id="07455-107">Par conséquent, l’utilisateur nouvellement ajouté peut déchiffrer le fichier chiffré.</span><span class="sxs-lookup"><span data-stu-id="07455-107">As a result, the newly added user can decrypt the encrypted file.</span></span> <span data-ttu-id="07455-108">L’appelant doit déjà avoir accès au fichier chiffré, que ce soit le propriétaire d’origine, l’agent de récupération de données ou en tant qu’utilisateur qui a été précédemment ajouté au fichier chiffré.</span><span class="sxs-lookup"><span data-stu-id="07455-108">The caller must already have access to the encrypted file, either as the original owner, the data recovery agent, or as a user who was previously added to the encrypted file.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="07455-109">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="07455-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="07455-110">**CertCloseStore**</span><span class="sxs-lookup"><span data-stu-id="07455-110">**CertCloseStore**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certclosestore)
</dt> <dt>

[<span data-ttu-id="07455-111">**CertFindCertificateInStore**</span><span class="sxs-lookup"><span data-stu-id="07455-111">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certfindcertificateinstore)
</dt> <dt>

[<span data-ttu-id="07455-112">**CertFreeCertificateContext**</span><span class="sxs-lookup"><span data-stu-id="07455-112">**CertFreeCertificateContext**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certfreecertificatecontext)
</dt> <dt>

[<span data-ttu-id="07455-113">**CertOpenSystemStore**</span><span class="sxs-lookup"><span data-stu-id="07455-113">**CertOpenSystemStore**</span></span>](/windows/desktop/api/wincrypt/nf-wincrypt-certopensystemstorea)
</dt> <dt>

[<span data-ttu-id="07455-114">Chiffrement de fichier</span><span class="sxs-lookup"><span data-stu-id="07455-114">File Encryption</span></span>](file-encryption.md)
</dt> <dt>

[<span data-ttu-id="07455-115">**LookupAccountName**</span><span class="sxs-lookup"><span data-stu-id="07455-115">**LookupAccountName**</span></span>](/windows/desktop/api/winbase/nf-winbase-lookupaccountnamea)
</dt> </dl>
