---
description: 'L’interface de programmation des services Web sur les appareils définit et utilise les fonctions suivantes :'
ms.assetid: d45c714a-4ac4-4a62-92a6-9460a2fffe6e
title: Fonctions des services Web sur les appareils
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104529205"
---
# <a name="web-services-on-devices-functions"></a>Fonctions des services Web sur les appareils

L’interface de programmation des services Web sur les appareils définit et utilise les fonctions suivantes :

-   [**\_Gestionnaire de \_ messages \_ SOAP PWSD**](/windows/win32/api/wsdtypes/nc-wsdtypes-pwsd_soap_message_handler)
-   [**\_fonction stub \_ WSD**](/windows/win32/api/wsdtypes/nc-wsdtypes-wsd_stub_function)
