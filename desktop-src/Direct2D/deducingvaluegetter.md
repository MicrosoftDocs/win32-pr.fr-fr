...
ms.locfileid: "119652949"
---
# <a name="deducingvaluegetter"></a>DeducingValueGetter

Déduire la classe et les arguments, puis appelle un rappel d’accesseur Get de propriété de fonction membre pour une propriété de type valeur.

> [!Note]  
> DeducingValueGetter ne doit pas être appelé directement.
