---
title: Méthodes GetBounds ID2D1Geometry (D2d1 \_ 1. h)
description: Récupère les limites de la géométrie.
ms.assetid: 3932189a-7c6b-4144-9d4a-32d2aba70835
keywords:
- Méthodes GetBounds Direct2D
topic_type:
- apiref
api_location:
- D2d1.dll
...
ms.locfileid: "106534778"
---
# <a name="id2d1geometrygetbounds-methods"></a><span data-ttu-id="31a39-104">ID2D1Geometry :: GetBounds, méthodes</span><span class="sxs-lookup"><span data-stu-id="31a39-104">ID2D1Geometry::GetBounds methods</span></span>

<span data-ttu-id="31a39-105">Récupère les limites de la géométrie.</span><span class="sxs-lookup"><span data-stu-id="31a39-105">Retrieves the bounds of the geometry.</span></span>

### <a name="overload-list"></a><span data-ttu-id="31a39-106">Liste de surcharge</span><span class="sxs-lookup"><span data-stu-id="31a39-106">Overload list</span></span>



| <span data-ttu-id="31a39-107">Méthode</span><span class="sxs-lookup"><span data-stu-id="31a39-107">Method</span></span>                                                                                                                   | <span data-ttu-id="31a39-108">Description</span><span class="sxs-lookup"><span data-stu-id="31a39-108">Description</span></span>                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| <span data-ttu-id="31a39-109">[**GetBounds (D2D1 \_ Matrix \_ matrice \_ f&, D2D \_ rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="31a39-109">[**GetBounds(D2D1\_MATRIX\_3X2\_F&,D2D\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))</span></span>   | <span data-ttu-id="31a39-110">Récupère les limites de la géométrie.</span><span class="sxs-lookup"><span data-stu-id="31a39-110">Retrieves the bounds of the geometry.</span></span><br/> |
| <span data-ttu-id="31a39-111">[**GetBounds (D2D1 \_ Matrix \_ matrice \_ f \* , d2d1 \_ rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span><span class="sxs-lookup"><span data-stu-id="31a39-111">[**GetBounds(D2D1\_MATRIX\_3X2\_F\*,D2D1\_RECT\_F\*)**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f))</span></span> | <span data-ttu-id="31a39-112">Récupère les limites de la géométrie.</span><span class="sxs-lookup"><span data-stu-id="31a39-112">Retrieves the bounds of the geometry.</span></span><br/> |



## <a name="examples"></a><span data-ttu-id="31a39-113">Exemples</span><span class="sxs-lookup"><span data-stu-id="31a39-113">Examples</span></span>

<span data-ttu-id="31a39-114">Le code suivant montre comment utiliser **GetBounds** pour récupérer les limites de la géométrie.</span><span class="sxs-lookup"><span data-stu-id="31a39-114">The following code shows how to use **GetBounds** to retrieve the bounds of the geometry.</span></span>
...
## <a name="requirements"></a><span data-ttu-id="31a39-115">Configuration requise</span><span class="sxs-lookup"><span data-stu-id="31a39-115">Requirements</span></span>



| <span data-ttu-id="31a39-116">Condition requise</span><span class="sxs-lookup"><span data-stu-id="31a39-116">Requirement</span></span> | <span data-ttu-id="31a39-117">Valeur</span><span class="sxs-lookup"><span data-stu-id="31a39-117">Value</span></span> |
|--------------------|--------------------------------------------------------------------------------------|
| <span data-ttu-id="31a39-118">En-tête</span><span class="sxs-lookup"><span data-stu-id="31a39-118">Header</span></span><br/>  | <dl> <span data-ttu-id="31a39-119"><dt>D2d1 \_ 1. h</dt></span><span class="sxs-lookup"><span data-stu-id="31a39-119"><dt>D2d1\_1.h</dt></span></span> </dl> |
| <span data-ttu-id="31a39-120">Bibliothèque</span><span class="sxs-lookup"><span data-stu-id="31a39-120">Library</span></span><br/> | <dl> <span data-ttu-id="31a39-121"><dt>D2d1. lib</dt></span><span class="sxs-lookup"><span data-stu-id="31a39-121"><dt>D2d1.lib</dt></span></span> </dl>  |
| <span data-ttu-id="31a39-122">DLL</span><span class="sxs-lookup"><span data-stu-id="31a39-122">DLL</span></span><br/>     | <dl> <span data-ttu-id="31a39-123"><dt>D2d1.dll</dt></span><span class="sxs-lookup"><span data-stu-id="31a39-123"><dt>D2d1.dll</dt></span></span> </dl>  |



## <a name="see-also"></a><span data-ttu-id="31a39-124">Voir aussi</span><span class="sxs-lookup"><span data-stu-id="31a39-124">See also</span></span>

<dl> <dt>

[<span data-ttu-id="31a39-125">**ID2D1Geometry**</span><span class="sxs-lookup"><span data-stu-id="31a39-125">**ID2D1Geometry**</span></span>](/windows/win32/api/d2d1/nn-d2d1-id2d1geometry)
</dt> </dl>
