...
ms.locfileid: "119214460"
---
# <a name="id2d1geometrygetbounds-methods"></a>ID2D1Geometry :: GetBounds, méthodes
...
| Méthode                                                                                                                   | Description                                      |
|:-------------------------------------------------------------------------------------------------------------------------|:-------------------------------------------------|
| [**GetBounds (D2D1 \_ Matrix \_ matrice \_ f&, D2D \_ rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f__d2d1_rect_f))   | Récupère les limites de la géométrie.<br/> |
| [**GetBounds (D2D1 \_ Matrix \_ matrice \_ f \* , d2d1 \_ rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getbounds(constd2d1_matrix_3x2_f_d2d1_rect_f)) | Récupère les limites de la géométrie.<br/> |



## <a name="examples"></a>Exemples

Le code suivant montre comment utiliser **GetBounds** pour récupérer les limites de la géométrie.
