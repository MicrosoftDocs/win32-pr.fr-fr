...
| Méthode                                                                                                                                                                                                 | Description                                                                                                                                           |
|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|:------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ matrice \_ F&, d2d1 \_ rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__d2d1_rect_f))              | Obtient les limites de la géométrie après qu’elle a été élargie par la largeur et le style de trait spécifiés et transformée par la matrice spécifiée.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ matrice \_ f \* , d2d1 \_ rect \_ f \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_d2d1_rect_f))             | Obtient les limites de la géométrie après qu’elle a été élargie par la largeur et le style de trait spécifiés et transformée par la matrice spécifiée.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ matrice \_ F&, float, d2d1 \_ rect \_ F \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f__float_d2d1_rect_f))  | Obtient les limites de la géométrie après qu’elle a été élargie par la largeur et le style de trait spécifiés et transformée par la matrice spécifiée.<br/> |
| [**GetWidenedBounds (FLOAT, ID2D1StrokeStyle \* , d2d1 \_ Matrix \_ matrice \_ f \* , float, d2d1 \_ rect \_ F \* )**](/windows/win32/api/d2d1/nf-d2d1-id2d1geometry-getwidenedbounds(float_id2d1strokestyle_constd2d1_matrix_3x2_f_float_d2d1_rect_f)) | Obtient les limites de la géométrie après qu’elle a été élargie par la largeur et le style de trait spécifiés et transformée par la matrice spécifiée.<br/> |



## <a name="examples"></a>Exemples

Le code suivant montre comment utiliser **GetWidenedBounds** pour récupérer les limites de la géométrie après qu’elle a été élargie par la largeur et le style de trait spécifiés et transformé par la matrice spécifiée.
