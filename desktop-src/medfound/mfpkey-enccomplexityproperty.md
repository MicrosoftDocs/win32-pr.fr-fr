...
|------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Windows Vista    | Les encodeurs Windows Media Audio 10, Windows Media Audio 10 Professional et Windows Media Audio 10 Lossless utilisent tous l’algorithme le plus complexe par défaut.                                                    |
