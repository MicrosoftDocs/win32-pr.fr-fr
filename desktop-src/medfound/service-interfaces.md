...
| \_ \_ service accélérateur vidéo \_ Mr            | [**IDirectXVideoMemoryConfiguration**](/windows/desktop/api/dxva2api/nn-dxva2api-idirectxvideomemoryconfiguration)                                                             | Broches d’entrée sur le filtre DirectShow EVR                                                                                                           |
...
| \_service de \_ mixage \_ vidéo Mr                   | Différentes interfaces exposées par le mélangeur EVR. Consultez [utilisation des contrôles de mixage vidéo](using-the-video-mixer-controls.md).                   | EVR                                                                                                                                               |
