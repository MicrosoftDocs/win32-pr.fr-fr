...
L’hôte PMP (Protected Media Path) utilise cet attribut pour stocker le descripteur de présentation de l’application sur le descripteur de présentation distant. La valeur de l’attribut est un pointeur vers l’interface [_ *IMFRemoteProxy* *](/windows/desktop/api/mfidl/nn-mfidl-imfremoteproxy) .
