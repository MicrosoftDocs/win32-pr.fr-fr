...
|-----------------------------|--------------|---------|---------------------------|
| Nombre de commandes              | **GRANDE**    | 4 octets | Nombre de commandes de script |
...
| Champ de l’objet de commande de script | Type de données     | Taille    | Description                                                              |
|-----------------------------|---------------|---------|--------------------------------------------------------------------------|
| Longueur du nom de la commande         | **GRANDE**     | 4 octets | Taille de la chaîne de commande en octets, y compris le caractère NULL.      |
| Nom de la commande                | **WCHAR**\[\] | Variable  | Chaîne terminée par le caractère null qui contient la commande de script.                 |
| Longueur du nom du type de commande    | **GRANDE**     | 4 octets | Taille de la chaîne de type de commande, en octets, y compris le caractère NULL. |
| Nom du type de commande           | **WCHAR**\[\] | Variable  | Chaîne terminée par le caractère null qui contient le type de commande.                   |
| Heure de présentation           | **GRANDE**     | 4 octets | Durée de présentation de la commande, en millisecondes.                        |
