...
Ce code est référencé par plusieurs rubriques :

-   [Didacticiel : écriture d’un fichier WMA à l’aide de l’encodage CBR](tutorial--writing-a-wma-file-by-using-cbr-encoding.md)

Dans Media Foundation, les encodeurs sont implémentés en tant que [Media Foundation transformations](media-foundation-transforms.md) (MFTS) et exposent l’interface [**IMFTransform**](/windows/desktop/api/mftransform/nn-mftransform-imftransform) .
...
La `Initialize` méthode crée une instance de l’encodeur WMA.
