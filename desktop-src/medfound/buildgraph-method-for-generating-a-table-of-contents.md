---
description: Fonction BuildGraph pour générer une table des matières
ms.assetid: f70740ef-4c58-4944-9be6-dd056e12ad93
title: Fonction BuildGraph pour générer une table des matières
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104318002"
---
# <a name="buildgraph-function-for-generating-a-table-of-contents"></a><span data-ttu-id="888c9-103">Fonction BuildGraph pour générer une table des matières</span><span class="sxs-lookup"><span data-stu-id="888c9-103">BuildGraph Function for Generating a Table of Contents</span></span>

<span data-ttu-id="888c9-104">La fonction suivante est une fonction d’assistance dans un exemple de programme présenté dans [génération automatique d’une table des matières](generating-a-table-of-contents-automatically.md).</span><span class="sxs-lookup"><span data-stu-id="888c9-104">The following function is a helper function in an example program that is discussed in [Generating a Table of Contents Automatically](generating-a-table-of-contents-automatically.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="888c9-105">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="888c9-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="888c9-106">Génération automatique d’une table des matières</span><span class="sxs-lookup"><span data-stu-id="888c9-106">Generating a Table of Contents Automatically</span></span>](generating-a-table-of-contents-automatically.md)
</dt> </dl>
