...
Contient la réponse à une requête [**D3DAUTHENTICATEDQUERY \_ OUTPUTIDCOUNT**](d3dauthenticatedquery-outputidcount.md) .
...
Nombre d’ID de sortie associés à l’appareil et à la session de chiffrement spécifiés.
