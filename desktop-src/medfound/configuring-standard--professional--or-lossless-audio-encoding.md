...
---
# <a name="configuring-standard-professional-or-lossless-audio-encoding"></a>Configuration de l’encodage audio standard, Professional ou Lossless

Lorsque l’encodeur Windows Media Audio énumère les types de sortie, il identifie chaque type énuméré comme standard, Professional ou Lossless. Vous pouvez déterminer si un type de sortie est standard, Professional ou Lossless en effectuant les étapes suivantes.
...
## <a name="professional-audio-encoding"></a>Encodage audio professionnel

Vous pouvez utiliser les étapes suivantes pour configurer l’encodage audio professionnel.
