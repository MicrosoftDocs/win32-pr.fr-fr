...
1.  définissez les propriétés sur l’encodeur DMO à l’aide de **IPropertyBag :: Write**. La liste suivante résume l’ensemble minimal des propriétés requises pour encoder un flux vidéo CBR (toutes ces valeurs ont des valeurs par défaut qui peuvent être utilisées) :
