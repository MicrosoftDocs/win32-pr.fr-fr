...
---
# <a name="meaudiosessiondeviceremoved-event"></a>Événement MEAudioSessionDeviceRemoved

Déclenché par le convertisseur audio lorsque le périphérique audio est supprimé. Le convertisseur audio n’est plus valide.
