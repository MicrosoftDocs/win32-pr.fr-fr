...
ms.locfileid: "118974188"
---
# <a name="media-type-debugging-code"></a>Code de débogage du type de média

Vous pouvez utiliser le code suivant pour afficher le contenu d’un type de média lors du débogage.
