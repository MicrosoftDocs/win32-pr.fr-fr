...
ms.locfileid: "118239231"
---
# <a name="playerrc"></a>Player. RC

Cette rubrique contient le fichier de ressources pour le didacticiel [sur la façon de lire des fichiers multimédias avec Media Foundation](how-to-play-unprotected-media-files.md).
