...
La méthode **CreateInstanceFromPropertyData** instancie un enregistrement de ressource de boîte aux lettres (MB).
...
Nom d’hôte de la boîte aux lettres pour le RR.
