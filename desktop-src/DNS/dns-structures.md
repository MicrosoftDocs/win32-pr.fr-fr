...
ms.locfileid: "119825319"
---
# <a name="dns-structures"></a>Structures DNS

Les structures suivantes sont définies pour une utilisation avec DNS :
...
Les structures d’enregistrement de ressource (RR) suivantes sont également incluses dans l’API DNS. Ces structures sont utilisées avec la structure **DNS_RECORD** pour gérer par programme les enregistrements de ressources DNS.
