...
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_mdtype-class"></a>Méthode CreateInstanceFromPropertyData de la \_ classe MicrosoftDNS MDType

La méthode **CreateInstanceFromPropertyData** instancie un enregistrement de ressource de l’agent de messagerie pour le domaine (MD).
...
Nom d’hôte de remise du courrier.
