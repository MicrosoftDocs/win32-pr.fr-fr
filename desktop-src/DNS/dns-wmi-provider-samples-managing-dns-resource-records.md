...
Cette section décrit les tâches de script associées à la gestion des enregistrements de ressources DNS. Les liens ci-dessous renvoient aux sous-routines du fichier de script.

-   [Répertorier les enregistrements de ressources](#list-resource-records)
...
1.  Une classe est créée pour chaque type d’enregistrement de ressource.
2.  Les données d’enregistrement de ressource sont fournies par le biais d’entrées de ligne de commande utilisateur et d’informations de fournisseur WMI DNS pour chaque classe de type d’enregistrement.
3.  Des fonctions courantes telles que la liste, la suppression et la modification sont créées et peuvent être utilisées sur des classes de type d’enregistrement de ressource individuelles.

Cet exemple de code montre les tâches associées à la gestion des enregistrements de ressources DNS.
...
## <a name="list-resource-records"></a>Répertorier les enregistrements de ressources

Cet exemple de code montre les tâches associées à l’affichage des enregistrements de ressources.
...
## <a name="add-a-resource-record"></a>Ajouter un enregistrement de ressource

Cet exemple de code montre les tâches associées à l’ajout d’enregistrements de ressources.
...
## <a name="delete-a-resource-record"></a>Supprimer un enregistrement de ressource

Cet exemple de code montre les tâches associées à la suppression d’enregistrements de ressources.
...
## <a name="modify-a-resource-record"></a>Modifier un enregistrement de ressource

Cet exemple de code montre les tâches associées à la modification des enregistrements de ressources.
