---
title: 'Exemples de fournisseur WMI DNS : gestion des enregistrements de ressources DNS'
description: 'Exemples de fournisseur WMI DNS : gestion des enregistrements de ressources DNS'
...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-resource-records"></a><span data-ttu-id="1bae8-103">Exemples de fournisseur WMI DNS : gestion des enregistrements de ressources DNS</span><span class="sxs-lookup"><span data-stu-id="1bae8-103">DNS WMI Provider Samples—Managing DNS Resource Records</span></span>

<span data-ttu-id="1bae8-104">Cette section décrit les tâches de script associées à la gestion des enregistrements de ressources DNS.</span><span class="sxs-lookup"><span data-stu-id="1bae8-104">This section demonstrates scripting tasks associated with managing DNS resource records.</span></span> <span data-ttu-id="1bae8-105">Les liens ci-dessous renvoient aux sous-routines du fichier de script.</span><span class="sxs-lookup"><span data-stu-id="1bae8-105">The links below jump to subroutines in the script file.</span></span>

-   [<span data-ttu-id="1bae8-106">Répertorier les enregistrements de ressources</span><span class="sxs-lookup"><span data-stu-id="1bae8-106">List resource records</span></span>](#list-resource-records)
-   [<span data-ttu-id="1bae8-107">Ajouter un enregistrement de ressource</span><span class="sxs-lookup"><span data-stu-id="1bae8-107">Add a resource record</span></span>](#add-a-resource-record)
-   [<span data-ttu-id="1bae8-108">Supprimer un enregistrement de ressource</span><span class="sxs-lookup"><span data-stu-id="1bae8-108">Delete a resource record</span></span>](#delete-a-resource-record)
-   [<span data-ttu-id="1bae8-109">Modifier un enregistrement de ressource</span><span class="sxs-lookup"><span data-stu-id="1bae8-109">Modify a resource record</span></span>](#modify-a-resource-record)
-   [<span data-ttu-id="1bae8-110">Se connecter au fournisseur WMI DNS</span><span class="sxs-lookup"><span data-stu-id="1bae8-110">Connect to the DNS WMI Provider</span></span>](#connect-to-the-dns-wmi-provider)

<span data-ttu-id="1bae8-111">L’implémentation générale du script est la suivante :</span><span class="sxs-lookup"><span data-stu-id="1bae8-111">The general implementation of the script is as follows:</span></span>

1.  <span data-ttu-id="1bae8-112">Une classe est créée pour chaque type d’enregistrement de ressource.</span><span class="sxs-lookup"><span data-stu-id="1bae8-112">A class is created for each resource record type.</span></span>
2.  <span data-ttu-id="1bae8-113">Les données d’enregistrement de ressource sont fournies par le biais d’entrées de ligne de commande utilisateur et d’informations de fournisseur WMI DNS pour chaque classe de type d’enregistrement.</span><span class="sxs-lookup"><span data-stu-id="1bae8-113">Resource record data is provided through user command-line inputs and DNS WMI Provider information for each record type class.</span></span>
3.  <span data-ttu-id="1bae8-114">Des fonctions courantes telles que la liste, la suppression et la modification sont créées et peuvent être utilisées sur des classes de type d’enregistrement de ressource individuelles.</span><span class="sxs-lookup"><span data-stu-id="1bae8-114">Common functions such as list, delete, and modify are created and can be used on individual resource record type classes.</span></span>

<span data-ttu-id="1bae8-115">Cet exemple de code montre les tâches associées à la gestion des enregistrements de ressources DNS.</span><span class="sxs-lookup"><span data-stu-id="1bae8-115">This code example shows tasks associated with Managing DNS resource records.</span></span>
...
## <a name="list-resource-records"></a><span data-ttu-id="1bae8-116">Répertorier les enregistrements de ressources</span><span class="sxs-lookup"><span data-stu-id="1bae8-116">List Resource Records</span></span>

<span data-ttu-id="1bae8-117">Cet exemple de code montre les tâches associées à l’affichage des enregistrements de ressources.</span><span class="sxs-lookup"><span data-stu-id="1bae8-117">This code example shows tasks associated with listing resource records.</span></span>
...
## <a name="add-a-resource-record"></a><span data-ttu-id="1bae8-118">Ajouter un enregistrement de ressource</span><span class="sxs-lookup"><span data-stu-id="1bae8-118">Add a Resource Record</span></span>

<span data-ttu-id="1bae8-119">Cet exemple de code montre les tâches associées à l’ajout d’enregistrements de ressources.</span><span class="sxs-lookup"><span data-stu-id="1bae8-119">This code example shows tasks associated with adding resource records.</span></span>
...
## <a name="delete-a-resource-record"></a><span data-ttu-id="1bae8-120">Supprimer un enregistrement de ressource</span><span class="sxs-lookup"><span data-stu-id="1bae8-120">Delete a Resource Record</span></span>

<span data-ttu-id="1bae8-121">Cet exemple de code montre les tâches associées à la suppression d’enregistrements de ressources.</span><span class="sxs-lookup"><span data-stu-id="1bae8-121">This code example shows tasks associated with deleting resource records.</span></span>
...
## <a name="modify-a-resource-record"></a><span data-ttu-id="1bae8-122">Modifier un enregistrement de ressource</span><span class="sxs-lookup"><span data-stu-id="1bae8-122">Modify a Resource Record</span></span>

<span data-ttu-id="1bae8-123">Cet exemple de code montre les tâches associées à la modification des enregistrements de ressources.</span><span class="sxs-lookup"><span data-stu-id="1bae8-123">This code example shows tasks associated with changing resource records.</span></span>
...
## <a name="connect-to-the-dns-wmi-provider"></a><span data-ttu-id="1bae8-124">Se connecter au fournisseur WMI DNS</span><span class="sxs-lookup"><span data-stu-id="1bae8-124">Connect to the DNS WMI Provider</span></span>

<span data-ttu-id="1bae8-125">Cet exemple de code montre les tâches associées à la connexion à un fournisseur WMI DNS.</span><span class="sxs-lookup"><span data-stu-id="1bae8-125">This code example shows tasks associated with connecting to a DNS WMI Provider.</span></span>
