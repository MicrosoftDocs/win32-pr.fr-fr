...
ms.locfileid: "119642208"
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_rptype-class"></a>Méthode CreateInstanceFromPropertyData de la \_ classe MicrosoftDNS RPType

La méthode **CreateInstanceFromPropertyData** instancie un enregistrement de ressource de personne responsable (RP).
