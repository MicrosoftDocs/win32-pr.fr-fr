...
ms.locfileid: "119984659"
---
# <a name="createinstancefrompropertydata-method-of-the-microsoftdns_atype-class"></a>Méthode CreateInstanceFromPropertyData de la \_ classe MicrosoftDNS aType

La méthode **CreateInstanceFromPropertyData** instancie un enregistrement de ressource d’adresse (A).
...
Nom de domaine complet (FQDN) ou adresse IP du serveur DNS qui contient ce RR.
...
Nom de domaine complet du propriétaire pour le RR.

> [!Note]  
> N’utilisez pas le nom NetBIOS du propriétaire.
