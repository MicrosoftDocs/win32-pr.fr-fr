...
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a>Exemples de fournisseur WMI DNS — gestion des Zones DNS

Cette section décrit les tâches de script associées à la gestion des zones DNS. Les liens suivants renvoient vers les sous-routines du fichier de script.

-   [Créer une zone DNS](#create-a-dns-zone)
-   [Modifier une zone DNS](#modify-a-dns-zone)
-   [Suppression d’une zone DNS](#delete-a-dns-zone)
-   [Ajouter une adresse IP de zone](#add-a-zone-ip-address)
-   [Supprimer une adresse IP de zone](#delete-a-zone-ip-address)
-   [Suspendre une zone](#pause-a-zone)
-   [Reprendre une zone](#resume-a-zone)
-   [Mettre à jour une zone](#update-a-zone)
-   [Recharger une zone](#reload-a-zone)
-   [Actualiser une zone](#refresh-a-zone)
...
## <a name="modify-a-dns-zone"></a>Modifier une zone DNS
...
## <a name="add-a-zone-ip-address"></a>Ajouter une adresse IP de zone
...
## <a name="delete-a-zone-ip-address"></a>Supprimer une adresse IP de zone
...
## <a name="pause-a-zone"></a>Suspendre une zone
...
## <a name="resume-a-zone"></a>Reprendre une zone
...
## <a name="update-a-zone"></a>Mettre à jour une zone
...
## <a name="reload-a-zone"></a>Recharger une zone
...
## <a name="refresh-a-zone"></a>Actualiser une zone
