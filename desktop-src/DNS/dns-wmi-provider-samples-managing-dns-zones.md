---
title: Exemples de fournisseur WMI DNS — gestion des Zones DNS
description: Exemples de fournisseur WMI DNS — gestion des Zones DNS
ms.assetid: 12958b71-b47d-4dd7-bd08-409ecd369e4f
keywords:
- Exemples de fournisseur WMI DNS 8212 ; Gestion des Zones DNS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104379867"
---
# <a name="dns-wmi-provider-samplesmanaging-dns-zones"></a><span data-ttu-id="7e8c2-104">Exemples de fournisseur WMI DNS — gestion des Zones DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-104">DNS WMI Provider Samples—Managing DNS Zones</span></span>

<span data-ttu-id="7e8c2-105">Cette section décrit les tâches de script associées à la gestion des zones DNS.</span><span class="sxs-lookup"><span data-stu-id="7e8c2-105">This section demonstrates scripting tasks associated with managing DNS zones.</span></span> <span data-ttu-id="7e8c2-106">Les liens suivants renvoient vers les sous-routines du fichier de script.</span><span class="sxs-lookup"><span data-stu-id="7e8c2-106">The following links link to subroutines in the script file.</span></span>

-   [<span data-ttu-id="7e8c2-107">Créer une zone DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-107">Create a DNS zone</span></span>](#create-a-dns-zone)
-   [<span data-ttu-id="7e8c2-108">Modifier une zone DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-108">Modify a DNS zone</span></span>](#modify-a-dns-zone)
-   [<span data-ttu-id="7e8c2-109">Suppression d’une zone DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-109">Delete a DNS zone</span></span>](#delete-a-dns-zone)
-   [<span data-ttu-id="7e8c2-110">Ajouter une adresse IP de zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-110">Add a zone IP address</span></span>](#add-a-zone-ip-address)
-   [<span data-ttu-id="7e8c2-111">Supprimer une adresse IP de zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-111">Delete a zone IP address</span></span>](#delete-a-zone-ip-address)
-   [<span data-ttu-id="7e8c2-112">Suspendre une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-112">Pause a zone</span></span>](#pause-a-zone)
-   [<span data-ttu-id="7e8c2-113">Reprendre une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-113">Resume a zone</span></span>](#resume-a-zone)
-   [<span data-ttu-id="7e8c2-114">Mettre à jour une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-114">Update a zone</span></span>](#update-a-zone)
-   [<span data-ttu-id="7e8c2-115">Recharger une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-115">Reload a zone</span></span>](#reload-a-zone)
-   [<span data-ttu-id="7e8c2-116">Actualiser une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-116">Refresh a zone</span></span>](#refresh-a-zone)
...
## <a name="create-a-dns-zone"></a><span data-ttu-id="7e8c2-117">Créer une zone DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-117">Create a DNS Zone</span></span>
...
## <a name="modify-a-dns-zone"></a><span data-ttu-id="7e8c2-118">Modifier une zone DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-118">Modify a DNS Zone</span></span>
...
## <a name="delete-a-dns-zone"></a><span data-ttu-id="7e8c2-119">Suppression d’une zone DNS</span><span class="sxs-lookup"><span data-stu-id="7e8c2-119">Delete a DNS Zone</span></span>
...
## <a name="add-a-zone-ip-address"></a><span data-ttu-id="7e8c2-120">Ajouter une adresse IP de zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-120">Add a Zone IP Address</span></span>
...
## <a name="delete-a-zone-ip-address"></a><span data-ttu-id="7e8c2-121">Supprimer une adresse IP de zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-121">Delete a Zone IP Address</span></span>
...
## <a name="pause-a-zone"></a><span data-ttu-id="7e8c2-122">Suspendre une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-122">Pause a Zone</span></span>
...
## <a name="resume-a-zone"></a><span data-ttu-id="7e8c2-123">Reprendre une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-123">Resume a Zone</span></span>
...
## <a name="update-a-zone"></a><span data-ttu-id="7e8c2-124">Mettre à jour une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-124">Update a Zone</span></span>
...
## <a name="reload-a-zone"></a><span data-ttu-id="7e8c2-125">Recharger une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-125">Reload a Zone</span></span>
...
## <a name="refresh-a-zone"></a><span data-ttu-id="7e8c2-126">Actualiser une zone</span><span class="sxs-lookup"><span data-stu-id="7e8c2-126">Refresh a Zone</span></span>
