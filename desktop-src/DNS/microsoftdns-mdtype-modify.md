...
ms.locfileid: "119527259"
---
# <a name="modify-method-of-the-microsoftdns_mdtype-class"></a>Modifier la méthode de la \_ classe MDType MicrosoftDNS

La méthode **Modify** met à jour un enregistrement de ressource de l’agent de messagerie pour le domaine (MD).
...
*MDHost* \[ dans, facultatif\]
</dt> <dd>

Chaîne représentant l’hôte de remise de courrier.
