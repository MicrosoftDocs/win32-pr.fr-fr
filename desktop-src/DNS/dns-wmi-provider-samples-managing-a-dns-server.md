---
title: 'Exemples de fournisseur WMI DNS : gestion d’un serveur DNS'
description: 'Exemples de fournisseur WMI DNS : gestion d’un serveur DNS'
...
ms.locfileid: "104520356"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a><span data-ttu-id="899f9-103">Exemples de fournisseur WMI DNS : gestion d’un serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-103">DNS WMI Provider Samples—Managing a DNS Server</span></span>

> [!NOTE]
> <span data-ttu-id="899f9-104">Cet article contient des références au terme esclave, un terme que Microsoft n’utilise plus.</span><span class="sxs-lookup"><span data-stu-id="899f9-104">This article contains references to the term slave, a term that Microsoft no longer uses.</span></span> <span data-ttu-id="899f9-105">Lorsque le terme sera supprimé du logiciel, nous le supprimerons de cet article.</span><span class="sxs-lookup"><span data-stu-id="899f9-105">When the term is removed from the software, we’ll remove it from this article.</span></span>

<span data-ttu-id="899f9-106">Cette section décrit les tâches de script associées à la gestion d’un serveur DNS.</span><span class="sxs-lookup"><span data-stu-id="899f9-106">This section demonstrates scripting tasks associated with managing a DNS Server.</span></span> <span data-ttu-id="899f9-107">Les liens ci-dessous renvoient aux sous-routines du fichier de script :</span><span class="sxs-lookup"><span data-stu-id="899f9-107">The links below jump to subroutines in the script file:</span></span>

-   [<span data-ttu-id="899f9-108">Répertorier les propriétés du serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-108">List DNS Server properties</span></span>](#list-dns-server-properties)
-   [<span data-ttu-id="899f9-109">Arrêter, démarrer ou redémarrer un serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-109">Stop, start, or restart a DNS Server</span></span>](#stop-start-or-restart-a-dns-server)
-   [<span data-ttu-id="899f9-110">Modifier les propriétés du serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-110">Modify DNS Server properties</span></span>](#modify-dns-server-properties)
-   [<span data-ttu-id="899f9-111">Ajouter une adresse IP</span><span class="sxs-lookup"><span data-stu-id="899f9-111">Add an IP address</span></span>](#add-an-ip-address)
-   [<span data-ttu-id="899f9-112">Supprimer une adresse IP</span><span class="sxs-lookup"><span data-stu-id="899f9-112">Delete an IP address</span></span>](#delete-an-ip-address)
-   [<span data-ttu-id="899f9-113">Énumérer des zones</span><span class="sxs-lookup"><span data-stu-id="899f9-113">List Zones</span></span>](#list-zones)
...
## <a name="list-dns-server-properties"></a><span data-ttu-id="899f9-114">Répertorier les propriétés du serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-114">List DNS Server properties</span></span>
...
## <a name="stop-start-or-restart-a-dns-server"></a><span data-ttu-id="899f9-115">Arrêter, démarrer ou redémarrer un serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-115">Stop, Start, or Restart a DNS Server</span></span>
...
## <a name="modify-dns-server-properties"></a><span data-ttu-id="899f9-116">Modifier les propriétés du serveur DNS</span><span class="sxs-lookup"><span data-stu-id="899f9-116">Modify DNS Server Properties</span></span>
...
## <a name="add-an-ip-address"></a><span data-ttu-id="899f9-117">Ajouter une adresse IP</span><span class="sxs-lookup"><span data-stu-id="899f9-117">Add an IP Address</span></span>
...
## <a name="delete-an-ip-address"></a><span data-ttu-id="899f9-118">Supprimer une adresse IP</span><span class="sxs-lookup"><span data-stu-id="899f9-118">Delete an IP Address</span></span>
...
## <a name="list-zones"></a><span data-ttu-id="899f9-119">Énumérer des zones</span><span class="sxs-lookup"><span data-stu-id="899f9-119">List Zones</span></span>
