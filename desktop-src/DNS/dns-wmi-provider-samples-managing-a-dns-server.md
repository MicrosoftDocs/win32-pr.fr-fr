...
ms.locfileid: "119795709"
---
# <a name="dns-wmi-provider-samplesmanaging-a-dns-server"></a>Exemples de fournisseur WMI DNS : gestion d’un serveur DNS

> [!NOTE]
> Cet article contient des références au terme esclave, un terme que Microsoft n’utilise plus. Lorsque le terme sera supprimé du logiciel, nous le supprimerons de cet article.

Cette section décrit les tâches de script associées à la gestion d’un serveur DNS. Les liens ci-dessous renvoient aux sous-routines du fichier de script :

-   [Répertorier les propriétés du serveur DNS](#list-dns-server-properties)
-   [Arrêter, démarrer ou redémarrer un serveur DNS](#stop-start-or-restart-a-dns-server)
-   [Modifier les propriétés du serveur DNS](#modify-dns-server-properties)
-   [Ajouter une adresse IP](#add-an-ip-address)
-   [Supprimer une adresse IP](#delete-an-ip-address)
-   [Énumérer des zones](#list-zones)
...
## <a name="list-dns-server-properties"></a>Répertorier les propriétés du serveur DNS
...
## <a name="stop-start-or-restart-a-dns-server"></a>Arrêter, démarrer ou redémarrer un serveur DNS
...
## <a name="modify-dns-server-properties"></a>Modifier les propriétés du serveur DNS
...
## <a name="add-an-ip-address"></a>Ajouter une adresse IP
...
## <a name="delete-an-ip-address"></a>Supprimer une adresse IP
...
## <a name="list-zones"></a>Énumérer des zones
