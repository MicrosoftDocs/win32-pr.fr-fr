...
-   Microsoft n’offre pas de nouvelles licences ou renouvellements
-   Microsoft ne mettra pas à jour les composants de l’agent Microsoft, notamment :
    -   Le runtime et les bibliothèques « msagent.exe »
    -   Les caractères Merlin, génie, Peedy et Robbo
    -   Éditeur de caractères de l’agent
    -   Tous les logiciels, outils et documentation Microsoft Agent associés
-   Windows 7 et les versions ultérieures ne prennent pas en charge le développement d’applications ou de caractères Microsoft Agent
...
-   [Fichier de caractères Robby](https://www.microsoft.com/downloads/details.aspx?FamilyID=fa36d1d5-d828-494a-ad0a-7b571db5bd2e)

## <a name="links-to-other-resources"></a>Liens vers d’autres ressources

<dl>

[Ressources Microsoft Agent](https://support.microsoft.com/kb/969168)  
</dl>
