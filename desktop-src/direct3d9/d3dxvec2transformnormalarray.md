...
---
# <a name="d3dxvec2transformnormalarray-function-d3dx9mathh"></a>D3DXVec2TransformNormalArray, fonction (D3dx9math. h)
...
Pointeur vers une structure [**D3DXVECTOR2**](d3dxvector2.md) qui est le tableau transformé.
