...
---
# <a name="direct3d-structures"></a>Structures Direct3D

Cette section contient des informations sur les structures utilisées avec Direct3D.
...
-   
    ...
    |                                                                                                                                                                          |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette structure est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DCOMPOSERECTDESC**](d3dcomposerectdesc.md) |
...
-   
    ...
    |                                                                                                                                                                                        |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette structure est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DCOMPOSERECTDESTINATION**](d3dcomposerectdestination.md) |
...
-   
    ...
    |                                                                                                                                                                      |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette structure est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DDISPLAYMODEEX**](d3ddisplaymodeex.md) |
...
-   
    ...
    |                                                                                                                                                                              |
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette structure est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DDISPLAYMODEFILTER**](d3ddisplaymodefilter.md) |
...
-   [**\_Zone D3DLOCKED**](d3dlocked-box.md)
...
-   
    ...
    |                                                                                                                                                                    |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette structure est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DPRESENTSTATS**](d3dpresentstats.md) |
...
-   [**État de D3DRASTER \_**](d3draster-status.md)
-   [**D3DRECT**](d3drect.md)
