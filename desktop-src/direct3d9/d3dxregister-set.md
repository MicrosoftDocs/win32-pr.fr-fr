...
ms.locfileid: "118524574"
---
# <a name="d3dxregister_set-enumeration"></a>D3DXREGISTER \_ Set, énumération

Type de données du Registre.
...
nombre à virgule flottante 4D.

</dd> <dt>

<span id="D3DXRS_SAMPLER"></span><span id="d3dxrs_sampler"></span>**\_Échantillonneur D3DXRS**
</dt> <dd>

Le registre contient des données d’échantillonneur 4D.

</dd> <dt>

<span id="D3DXRS_FORCE_DWORD"></span><span id="d3dxrs_force_dword"></span>**D3DXRS \_ forcer \_ DWORD**
</dt> <dd>
