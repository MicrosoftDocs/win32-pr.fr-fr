...
---
# <a name="d3dxvec2transformcoordarray-function-d3dx9mathh"></a>D3DXVec2TransformCoordArray, fonction (D3dx9math. h)
...
Pointeur vers le tableau [**D3DXVECTOR2**](d3dxvector2.md) source.
