...
---
# <a name="id3dxbaseeffectgetboolarray-method"></a>ID3DXBaseEffect :: GetBoolArray, méthode

Obtient un tableau de valeurs BOOL.
...
Retourne un tableau de valeurs booléennes.
