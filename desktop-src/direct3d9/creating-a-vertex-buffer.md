...
ms.locfileid: "118527673"
---
# <a name="creating-a-vertex-buffer-direct3d-9"></a>Création d’une mémoire tampon de vertex (Direct3D 9)

Vous créez un objet de mémoire tampon de vertex en appelant la méthode [**IDirect3DDevice9 :: CreateVertexBuffer**](/windows/win32/api/d3d9helper/nf-d3d9helper-idirect3ddevice9-createvertexbuffer) , qui accepte cinq paramètres. Le premier paramètre spécifie la longueur de la mémoire tampon du vertex, en octets. Utilisez l’opérateur sizeof pour déterminer la taille d’un format de vertex, en octets. Considérez le format de vertex personnalisé suivant.
