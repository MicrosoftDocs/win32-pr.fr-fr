...
ms.locfileid: "127124460"
---
# <a name="direct3d-enumerations"></a>Énumérations Direct3D

Cette section décrit les types énumérés Direct3D.

-   [**\_Type D3DBACKBUFFER**](./d3dbackbuffer-type.md)
...
-   
    ...
    |                                                                                                                                                                                |
    |--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette énumération est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DCOMPOSERECTSOP**](./d3dcomposerectsop.md) |

    

     

-   [**\_Visages D3DCUBEMAP**](./d3dcubemap-faces.md)
-   [**D3DCULL**](./d3dcull.md)
...
-   
    ...
    |                                                                                                                                                                                  |
    |----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette énumération est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DDISPLAYROTATION**](./d3ddisplayrotation.md) |
...
-   [**\_Type D3DMULTISAMPLE**](./d3dmultisample-type.md)
...
-   [**\_Type de texture D3DSAMPLER \_**](./d3dsampler-texture-type.md)
-   [**D3DSAMPLERSTATETYPE**](./d3dsamplerstatetype.md)
-   

    |                                                                                                                                                                                    |
    |------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
    | Différences entre Direct3D 9 et Direct3D 9Ex :<br/> Cette énumération est disponible uniquement dans Direct3D 9Ex.<br/>[**D3DSCANLINEORDERING**](./d3dscanlineordering.md) |
...
-   [**D3DXFERR les valeurs de retour**](./d3dxferr-return-values.md)
