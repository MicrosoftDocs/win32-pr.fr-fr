---
description: 'ID3DXCompressedAnimationSet :: GetPlaybackType, méthode-obtient le type de la boucle de lecture du jeu d’animations.'
ms.assetid: aa18b572-5fd9-4a2b-b4c6-c5895ee65c62
title: 'ID3DXCompressedAnimationSet :: GetPlaybackType, méthode (D3dx9anim. h)'
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
