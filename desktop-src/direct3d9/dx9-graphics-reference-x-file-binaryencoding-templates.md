---
description: Un modèle a la définition de syntaxe suivante.
ms.assetid: 77eb739d-8da3-4481-8dd1-f9f2f0eda136
title: Modèles (format de fichier X)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106514086"
---
# <a name="templates-x-file-format-binary-encoding"></a><span data-ttu-id="f8e5c-103">Modèles (format de fichier X, encodage binaire)</span><span class="sxs-lookup"><span data-stu-id="f8e5c-103">Templates (X file format, binary encoding)</span></span>

<span data-ttu-id="f8e5c-104">Un modèle a la définition de syntaxe suivante.</span><span class="sxs-lookup"><span data-stu-id="f8e5c-104">A template has the following syntax definition.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f8e5c-105">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="f8e5c-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f8e5c-106">Encodage Binaire</span><span class="sxs-lookup"><span data-stu-id="f8e5c-106">Binary Encoding</span></span>](binary-encoding.md)
</dt> </dl>
