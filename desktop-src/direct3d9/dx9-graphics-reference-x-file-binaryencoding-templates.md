...
ms.locfileid: "118523400"
---
# <a name="templates-x-file-format-binary-encoding"></a>Modèles (format de fichier X, encodage binaire)

Un modèle a la définition de syntaxe suivante.
