...
Retourne un vecteur 4D composé des plus petits composants de deux vecteurs 4D.
...
Pointeur vers une structure [**D3DXVECTOR4**](d3dxvector4.md) composée des plus petits composants des deux vecteurs.
