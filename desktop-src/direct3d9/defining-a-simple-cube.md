...
ms.locfileid: "118988299"
---
# <a name="defining-a-simple-cube-direct3d-9"></a>Définition d’un cube simple (Direct3D 9)

Le fichier suivant définit un cube simple qui a quatre côtés rouges et deux côtés verts. Dans ce fichier, des informations facultatives sont utilisées pour ajouter des informations à l’objet de données défini par le modèle de [**maillage**](mesh.md) .
