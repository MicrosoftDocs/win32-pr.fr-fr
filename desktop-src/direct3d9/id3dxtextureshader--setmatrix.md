...
ms.locfileid: "126916368"
---
# <a name="id3dxtextureshadersetmatrix-method"></a>ID3DXTextureShader :: SetMatrix, méthode
...
Pointeur désignant une matrice non transposée. Consultez [**D3DXMATRIX**](d3dxmatrix.md).
