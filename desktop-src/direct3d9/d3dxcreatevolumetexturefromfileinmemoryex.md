...
ms.locfileid: "120119239"
---
# <a name="d3dxcreatevolumetexturefromfileinmemoryex-function"></a>D3DXCreateVolumeTextureFromFileInMemoryEx fonction)

Crée une texture de volume à partir d’un fichier. Il s’agit d’une fonction plus avancée que [**D3DXCreateVolumeTextureFromFileInMemory**](d3dxcreatevolumetexturefromfileinmemory.md).
