...
La valeur de retour de cette fonction est la même que celle retournée dans le paramètre *moue* . De cette façon, la fonction **D3DXVec3Cross** peut être utilisée comme paramètre pour une autre fonction.
