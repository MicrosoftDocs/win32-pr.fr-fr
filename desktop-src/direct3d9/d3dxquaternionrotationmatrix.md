...
---
# <a name="d3dxquaternionrotationmatrix-function-d3dx9mathh"></a>D3DXQuaternionRotationMatrix, fonction (D3dx9math. h)
...
Pointeur vers la structure [**D3DXQUATERNION**](d3dxquaternion.md) construite à partir d’une matrice de rotation.
