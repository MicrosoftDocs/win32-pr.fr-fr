...
ms.locfileid: "119676729"
---
# <a name="d3ddevinfo_d3d9stagetimings-structure"></a>D3DDEVINFO \_ D3D9STAGETIMINGS, structure

Pourcentage de temps de traitement des données de nuanceur.
...
Pourcentage de temps passé par le nuanceur aux accès mémoire.
...
Pourcentage de traitement du temps (déplacement des données dans les registres ou opérations mathématiques).
