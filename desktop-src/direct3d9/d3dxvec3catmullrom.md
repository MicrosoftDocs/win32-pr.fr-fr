...
---
# <a name="d3dxvec3catmullrom-function-d3dx9mathh"></a>D3DXVec3CatmullRom, fonction (D3dx9math. h)
...
Pointeur vers une structure [**D3DXVECTOR3**](d3dxvector3.md) qui est le résultat de l’interpolation Catmull-Rom.
