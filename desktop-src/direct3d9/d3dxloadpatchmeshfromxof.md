...
ms.locfileid: "127403421"
---
# <a name="d3dxloadpatchmeshfromxof-function"></a>D3DXLoadPatchMeshFromXof fonction)

Charge un maillage de correctif à partir d’un objet [**ID3DXFileData**](id3dxfiledata.md) .
...
Combinaison d’un ou de plusieurs indicateurs [**D3DXMESH**](./d3dxmesh.md) , en spécifiant les options de création du maillage.
...
Tableau de matières contenues dans la maille. Chaque matériau est indexé par une interface [**ID3DXBuffer**](id3dxbuffer.md) .
...
Adresse d’un pointeur vers une interface [**ID3DXPatchMesh**](id3dxpatchmesh.md) représentant le maillage chargé.
