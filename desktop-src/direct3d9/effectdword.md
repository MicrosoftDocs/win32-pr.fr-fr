---
description: Définit un DWORD d’effet hérité. Ce modèle a été remplacé par le modèle EffectParamDWord.
...
ms.locfileid: "118523086"
---
# <a name="effectdword"></a>EffectDWord

Définit un DWORD d’effet hérité. Ce modèle a été remplacé par le modèle [**EffectParamDWord**](effectparamdword.md) .
