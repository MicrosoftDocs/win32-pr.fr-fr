...
---
# <a name="exclusive-mode-streams"></a>Flux de Exclusive-Mode
...
Dans Windows Vista, les paramètres par défaut pour un périphérique de point de terminaison audio sont les suivants :
