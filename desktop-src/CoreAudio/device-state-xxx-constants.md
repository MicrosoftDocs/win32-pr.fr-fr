...
| <span id="DEVICE_STATE_DISABLED"></span><span id="device_state_disabled"></span><dl> <dt>**Appareil mobile \_ ÉTAT \_ désactivé**</dt> <dt>0x00000002</dt> </dl>       | L’appareil de point de terminaison audio est désactivé. l’utilisateur a désactivé l’appareil dans le panneau de configuration Windows multimédia, Mmsys.cpl. Pour plus d'informations, consultez la section Notes.<br/>                                                                                                                                                                                                        |
