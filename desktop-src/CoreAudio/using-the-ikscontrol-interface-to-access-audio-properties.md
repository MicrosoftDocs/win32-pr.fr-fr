...
6.  Envoyez la demande de propriété KS au pilote audio en appelant la méthode [**IKsControl :: KsProperty**](/windows-hardware/drivers/ddi/ksproxy/nf-ksproxy-ikscontrol-ksproperty) . pour plus d’informations sur cette méthode, consultez la documentation Windows DDK.
