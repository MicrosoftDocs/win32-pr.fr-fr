...
<span id="wmi.gloss_hosting_model"></span><span id="WMI.GLOSS_HOSTING_MODEL"></span>**modèle d’hébergement**
</dt> <dd>

Valeur de propriété dans l’instance [**\_ \_ Win32Provider**](--win32provider.md) qui spécifie le contexte de sécurité dans lequel le fournisseur s’exécute.
