---
description: SWbemServices. ExecQuery, méthode-exécute une requête pour récupérer des objets.
ms.assetid: 06b9d4c9-cd72-49b2-92b0-d18d94dfbd9f
ms.tgt_platform: multiple
title: SWbemServices. ExecQuery, méthode (wbemdisp. h)
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "126923335"
---
# <a name="swbemservicesexecquery-method"></a>SWbemServices. ExecQuery, méthode
