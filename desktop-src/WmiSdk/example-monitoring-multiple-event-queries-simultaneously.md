...
---
# <a name="example-monitoring-multiple-event-queries-simultaneously"></a>Exemple : analyse simultanée de plusieurs requêtes d’événements

L’exemple de script suivant illustre la notification d’événements asynchrones, en utilisantSWbemServices.Exela méthode [**cNotificationQueryAsync**](swbemservices-execnotificationqueryasync.md) et l’objet [**SWbemSink**](swbemsink.md) .
