...
ms.locfileid: "118317410"
---
# <a name="cimmofdeserializerdeserializeclasses-method-byteuint32"></a>Méthode CimMofDeserializer. DeserializeClasses (Byte \[ \] , UInt32)

Désérialise les classes CIM en fonction des données sérialisées.
