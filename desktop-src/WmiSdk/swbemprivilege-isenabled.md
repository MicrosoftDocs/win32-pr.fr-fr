...
La propriété **IsEnabled** d’un objet [**SWbemPrivilege**](swbemprivilege.md) est une valeur booléenne que vous utilisez pour activer ou désactiver ce privilège. Pour plus d’informations sur les conséquences de l’activation de privilèges spécifiques, consultez [**exécution avec des privilèges spéciaux**](swbemsecurity-privileges.md).
