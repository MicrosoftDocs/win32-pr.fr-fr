...
| [**Clone**](swbemnamedvalueset-clone.md)         | Effectue une copie de cette collection **SWbemNamedValueSet** .<br/>                                                                       |
...
| [**Remove**](swbemnamedvalueset-remove.md)       | Supprime un objet [**SWbemNamedValue**](swbemnamedvalue.md) de la collection.<br/>                                             |
