...
<span id="wmi.gloss_key_property"></span><span id="WMI.GLOSS_KEY_PROPERTY"></span>**propriété de clé**
</dt> <dd>

Propriété qui fournit un identificateur unique pour une instance d’une classe. Les propriétés de clé sont marquées avec le [*qualificateur*](gloss-q.md)de clé.
