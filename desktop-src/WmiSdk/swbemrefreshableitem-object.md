...
La propriété **SWbemRefreshableItem. Object** représente une instance [**SWbemObject**](swbemobject.md) unique qui est actualisée. L’élément est contenu dans un objet [**SWbemRefresher**](swbemrefresher.md) .
