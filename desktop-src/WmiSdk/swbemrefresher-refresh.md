...
---
# <a name="swbemrefresherrefresh-method"></a>SWbemRefresher. Refresh, méthode

La méthode **SWbemRefresher. Refresh** met à jour tous les éléments contenus dans l’objet [**SWbemRefresher**](swbemrefresher.md) .
...
Les indicateurs doivent avoir la valeur 0 (zéro).
