...
| <strong>Guid</strong> | <strong>REG_SZ</strong> | Chaîne qui contient un GUID qui identifie de façon unique la session. Cette valeur est requise. | 
...
| <strong>État</strong> | <strong>REG_DWORD</strong> | État de démarrage de l’enregistreur automatique. Si le journal automatique n’a pas pu démarrer, la valeur de cette clé est le code d’erreur Win32 approprié. Si le journal automatique a démarré, la valeur de cette clé est <strong>ERROR_SUCCESS</strong> (0).<br /> | 
