...
Pour récupérer une liste des fournisseurs qui ont installé leur manifeste ou leurs classes MOF sur l’ordinateur, appelez la fonction [**TdhEnumerateProviders**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviders) .

L’exemple suivant montre comment énumérer des fournisseurs.
