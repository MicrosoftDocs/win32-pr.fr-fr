...
ms.locfileid: "120075229"
---
# <a name="tcpip_typegroup1-class"></a>TcpIp \_ TypeGroup1, classe

Cette classe est la classe de type d’événement pour les événements TCP/IP IPv4.
...
La classe **TcpIp \_ TypeGroup1** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **TcpIp \_ TypeGroup1** possède les propriétés suivantes.
