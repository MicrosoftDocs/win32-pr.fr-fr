...
ms.locfileid: "119766539"
---
# <a name="retrieving-event-metadata"></a>Récupération des métadonnées d’événement

L’exemple suivant montre comment utiliser les fonctions d’assistance des données de trace pour récupérer des métadonnées pour chaque événement. Consultez également les exemples inclus avec les fonctions [**TdhQueryProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhqueryproviderfieldinformation) et [**TdhEnumerateProviderFieldInformation**](/windows/desktop/api/Tdh/nf-tdh-tdhenumerateproviderfieldinformation) .
