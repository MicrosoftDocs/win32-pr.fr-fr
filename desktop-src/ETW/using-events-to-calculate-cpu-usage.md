...
---
# <a name="using-events-to-calculate-cpu-usage"></a>Utilisation d’événements pour calculer l’utilisation de l’UC

L’exemple suivant montre comment utiliser des événements pour calculer l’utilisation de l’UC pour un ensemble d’instructions. Cet exemple suppose que le fournisseur encapsule le jeu d’instructions avec un type d’événement de début et un type d’événement de fin.
