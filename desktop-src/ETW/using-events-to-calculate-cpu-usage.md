---
description: L’exemple suivant montre comment utiliser des événements pour calculer l’utilisation de l’UC pour un ensemble d’instructions. Cet exemple suppose que le fournisseur encapsule le jeu d’instructions avec un type d’événement de début et un type d’événement de fin.
ms.assetid: 7bc15ed3-d299-40dd-9838-520f896921e3
title: Utilisation d’événements pour calculer l’utilisation de l’UC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104972266"
---
# <a name="using-events-to-calculate-cpu-usage"></a><span data-ttu-id="ca912-104">Utilisation d’événements pour calculer l’utilisation de l’UC</span><span class="sxs-lookup"><span data-stu-id="ca912-104">Using Events to Calculate CPU Usage</span></span>

<span data-ttu-id="ca912-105">L’exemple suivant montre comment utiliser des événements pour calculer l’utilisation de l’UC pour un ensemble d’instructions.</span><span class="sxs-lookup"><span data-stu-id="ca912-105">The following example shows you how to use events to calculate the CPU usage for a set of instructions.</span></span> <span data-ttu-id="ca912-106">Cet exemple suppose que le fournisseur encapsule le jeu d’instructions avec un type d’événement de début et un type d’événement de fin.</span><span class="sxs-lookup"><span data-stu-id="ca912-106">This example assumes the provider wraps the instruction set with a start event type and an end event type.</span></span>
