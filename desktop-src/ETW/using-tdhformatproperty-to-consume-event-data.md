---
description: L’exemple suivant montre comment consommer des données d’événement à l’aide de la fonction TdhFormatProperty.
ms.assetid: 5ebd500c-420e-4979-a03a-49b687464b0e
title: Utilisation de TdhFormatProperty pour consommer des données d’événement
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104972263"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a><span data-ttu-id="3d5e1-103">Utilisation de TdhFormatProperty pour consommer des données d’événement</span><span class="sxs-lookup"><span data-stu-id="3d5e1-103">Using TdhFormatProperty to Consume Event Data</span></span>

<span data-ttu-id="3d5e1-104">L’exemple suivant montre comment consommer des données d’événement à l’aide de la fonction [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) .</span><span class="sxs-lookup"><span data-stu-id="3d5e1-104">The following example shows how to consume event data using the [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) function.</span></span>
