...
ms.locfileid: "118951228"
---
# <a name="using-tdhformatproperty-to-consume-event-data"></a>Utilisation de TdhFormatProperty pour consommer des données d’événement

L’exemple suivant montre comment consommer des données d’événement à l’aide de la fonction [**TdhFormatProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhformatproperty) .
