---
description: L’exemple suivant montre comment consommer des données d’événement à l’aide de la fonction TdhGetProperty.
ms.assetid: 16b36718-087f-4be9-9ca2-fc083358017b
title: Utilisation de TdhGetProperty pour consommer des données d’événement
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103753036"
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a><span data-ttu-id="88fe9-103">Utilisation de TdhGetProperty pour consommer des données d’événement</span><span class="sxs-lookup"><span data-stu-id="88fe9-103">Using TdhGetProperty to Consume Event Data</span></span>

<span data-ttu-id="88fe9-104">L’exemple suivant montre comment consommer des données d’événement à l’aide de la fonction [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) .</span><span class="sxs-lookup"><span data-stu-id="88fe9-104">The following example shows how to consume event data using the [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) function.</span></span>
