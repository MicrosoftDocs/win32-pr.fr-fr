...
---
# <a name="using-tdhgetproperty-to-consume-event-data"></a>Utilisation de TdhGetProperty pour consommer des données d’événement

L’exemple suivant montre comment consommer des données d’événement à l’aide de la fonction [**TdhGetProperty**](/windows/desktop/api/Tdh/nf-tdh-tdhgetproperty) .
