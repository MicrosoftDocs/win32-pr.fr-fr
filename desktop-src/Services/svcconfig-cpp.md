...
ms.locfileid: "118888411"
---
# <a name="svcconfigcpp"></a>SvcConfig.cpp

Voici un exemple de [programme de configuration de service](service-configuration-programs.md).

Lors de la génération de l’exemple, assurez-vous de créer un lien avec Kernel32. lib et advapi32. lib.
