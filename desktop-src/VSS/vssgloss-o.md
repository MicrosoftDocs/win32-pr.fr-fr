...
---
# <a name="o-volume-shadow-copy-service"></a>O (Service VSS)
...
<span id="base.vssgloss_original_volume"></span><span id="BASE.VSSGLOSS_ORIGINAL_VOLUME"></span>**volume d’origine**
</dt> <dd>

Volume à partir duquel un cliché instantané est dérivé.
