...
1. Ouvrez l’Explorateur Windows et accédez au répertoire du projet **StructuredQuerySample** .
...
2. À l’invite de commandes, entrez `StructuredQuerySample.exe` , ou à partir de l’Explorateur Windows, double-cliquez sur l’icône de StructuredQuerySample.exe.
