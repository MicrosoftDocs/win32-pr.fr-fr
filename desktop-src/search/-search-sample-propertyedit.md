...
1.  ouvrez Windows Explorer et accédez au répertoire du projet **PropertyEdit** .
...
2.  à l’invite de commandes, entrez `PropertyEdit.exe` ou dans Windows Explorer, double-cliquez sur l’icône de PropertyEdit.exe.
