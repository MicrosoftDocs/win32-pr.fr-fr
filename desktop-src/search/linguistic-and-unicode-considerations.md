---
description: Considérations linguistiques et Unicode
...
Cette section contient une liste de considérations linguistiques et Unicode qui peuvent affecter l’analyseur lexical et l’implémentation du générateur de formes dérivées. La liste n’est pas exhaustive.

Cette section comprend les rubriques suivantes :

-   [Normalisation des formes de surface](surface-form-normalization.md)
-   [Considérations linguistiques et Unicode diverses](miscellaneous-linguistic-and-unicode-considerations.md)
