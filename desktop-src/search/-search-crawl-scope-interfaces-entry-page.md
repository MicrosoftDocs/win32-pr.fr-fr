...
ms.locfileid: "118463124"
---
# <a name="crawl-scope-interfaces"></a>Interfaces d’étendue d’analyse


cette section de référence de recherche Windows se compose des interfaces d’étendue d’analyse suivantes :
