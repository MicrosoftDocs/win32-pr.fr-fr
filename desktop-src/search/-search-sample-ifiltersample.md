...
1. Ouvrez l’Explorateur Windows et accédez au répertoire du projet **FilterBase** .
...
2. À l’invite de commandes, entrez `FilterBase.exe` , ou à partir de l’Explorateur Windows, double-cliquez sur l’icône de FilterBase.exe.
