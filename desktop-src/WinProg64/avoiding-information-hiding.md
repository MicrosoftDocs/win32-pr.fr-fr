...
keywords:
- compatibilité descendante de la Windows 64 bits
- problèmes de compatibilité 64-programmation de Windows bits
ms.topic: article
ms.date: 05/31/2018
...
Il est presque garanti que ces techniques introduisent des problèmes de compatibilité avant de porter votre application au Windows 64 bits.
