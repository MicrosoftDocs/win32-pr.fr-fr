...
---
# <a name="graphics-methods"></a>Méthodes Graphics

Cette rubrique répertorie les méthodes de la classe [**Graphics**](/windows/win32/api/gdiplusgraphics/nl-gdiplusgraphics-graphics) . Pour obtenir une liste complète des classes, consultez **Graphics, classe**.
...
-   [**BeginContainer (RectF&, RectF&, unité)**](/previous-versions//ms536157(v=vs.85))
-   [**BeginContainer (Rect&, Rect&, unité)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-begincontainer(inconstrect__inconstrect__inunit))
-   [**Effacé**](/windows/win32/api/Gdiplusgraphics/nf-gdiplusgraphics-graphics-clear)
-   [**DrawArc (Pen \* , Rect&, réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawarc(inconstpen_inconstrect__inreal_inreal))
-   [**DrawArc (stylet \* , RectF&, réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawarc(inconstpen_inconstrectf__inreal_inreal))
-   [**DrawArc (stylet, réel, réel, réel, réel, réel, réel \* )**](/previous-versions//ms536154(v=vs.85))
-   [**DrawArc (stylet \* , entier, entier, entier, entier, réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawarc(inconstpen_inint_inint_inint_inint_inreal_inreal))
...
-   [**DrawBezier (stylet, réel, réel, réel, réel, réel, réel, réel, réel \* )**](/previous-versions//ms536150(v=vs.85))
...
-   [**DrawClosedCurve (stylet \* , point \* , entier, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawclosedcurve(inconstpen_inconstpoint_inint_inreal))
...
-   [**DrawCurve (stylet \* , point \* , INT, INT, int, Real)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawcurve(inconstpen_inconstpoint_inint_inint_inint_inreal))
...
-   [**DrawCurve (stylet \* , point \* , entier, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawcurve(inconstpen_inconstpoint_inint_inreal))
...
-   [**DrawEllipse (stylet, réel, réel, réel, réel \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawellipse(inconstpen_inreal_inreal_inreal_inreal))
...
-   [**DrawImage (image \* , réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawimage(inimage_inreal_inreal))
...
-   [**DrawImage (image, réelle, réelle, réelle, réelle, réelle, réelle \* , unité)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawimage(inimage_inreal_inreal_inreal_inreal_inreal_inreal_inunit))
...
-   [**DrawImage (image \* , PointF \* , entier, réel, réel, réel, réel, unité, ImageAttributes \* , DrawImageAbort, void \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawimage(inimage_inconstpointf_inint_inreal_inreal_inreal_inreal_inunit_inconstimageattributes_indrawimageabort_invoid))
...
-   [**DrawImage (image, réel, réel, réel, réel \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawimage(inimage_inreal_inreal_inreal_inreal))
...
-   [**DrawImage (image \* , RectF&, réel, réel, réel, réel, unité, ImageAttributes \* , DRAWIMAGEABORT, void \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawimage(inimage_inconstrectf__inreal_inreal_inreal_inreal_inunit_inconstimageattributes_indrawimageabort_invoid))
...
-   [**DrawLine (stylet, réel, réel, réel, réel \* )**](/previous-versions//ms536024(v=vs.85))
...
-   [**DrawPie (Pen \* , Rect&, réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawpie(inconstpen_inconstrect__inreal_inreal))
...
-   [**DrawPie (stylet, réel, réel, réel, réel, réel, réel \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawpie(inconstpen_inreal_inreal_inreal_inreal_inreal_inreal))
-   [**DrawPie (plume \* , RectF&, réel, réel)**](/previous-versions//ms536016(v=vs.85))
...
-   [**DrawRectangle (stylet, réel, réel, réel, réel \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawrectangle(inconstpen_inreal_inreal_inreal_inreal))
...
-   [**DrawString (WCHAR \* , int, police \* , RectF&, StringFormat \* , Brush \* )**](/previous-versions//ms535991(v=vs.85))
-   [**DrawString (WCHAR \* , int, police \* , PointF&, Brush \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawstring(constwchar_int_constfont_constpointf__constbrush))
-   [**DrawString (WCHAR \* , int, police \* , PointF&, StringFormat \* , Brush \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-drawstring(constwchar_int_constfont_constpointf__conststringformat_constbrush))
...
-   [**ExcludeClip (région \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-excludeclip(inconstregion))
...
-   [**FillClosedCurve (pinceau \* , point \* , entier, FillMode, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillclosedcurve(inconstbrush_inconstpoint_inint_infillmode_inreal))
...
-   [**FillEllipse (pinceau, réel, réel, réel, réel \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillellipse(inconstbrush_inreal_inreal_inreal_inreal))
...
-   [**FillPie (Brush \* , Rect&, réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillpie(inconstbrush_inconstrect__inreal_inreal))
...
-   [**FillPie (Brush, réel, réel, réel, réel, réel, réel \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-fillpie(inconstbrush_inreal_inreal_inreal_inreal_inreal_inreal))
-   [**FillPie (Brush \* , RectF&, réel, réel)**](/previous-versions//ms535965(v=vs.85))
...
-   [**Purge**](/windows/win32/api/Gdiplusgraphics/nf-gdiplusgraphics-graphics-flush)
...
-   [**IntersectClip (région \* )**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-intersectclip(inconstregion))
...
-   [**IsVisible (réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-isvisible(inreal_inreal))
...
-   [**IsVisible (réel, réel, réel, réel)**](/windows/win32/api/gdiplusgraphics/nf-gdiplusgraphics-graphics-isvisible(inreal_inreal_inreal_inreal))
...
-   [**Tabli**](/windows/win32/api/Gdiplusgraphics/nf-gdiplusgraphics-graphics-restore)
-   [**RotateTransform**](/windows/win32/api/Gdiplusgraphics/nf-gdiplusgraphics-graphics-rotatetransform)
-   [**Enregistrer**](/windows/win32/api/Gdiplusgraphics/nf-gdiplusgraphics-graphics-save)
...
-   [**TranslateClip (réel, réel)**](/previous-versions//ms535822(v=vs.85))
