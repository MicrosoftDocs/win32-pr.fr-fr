---
description: 'La méthode image :: GetRawFormat retourne un GUID qui indique le format de fichier d’une image. Les constantes suivantes, définies dans Gdiplusimaging. h, représentent les GUID qui identifient ces formats de fichier.'
...
La méthode [**image :: GetRawFormat**](/windows/desktop/api/Gdiplusheaders/nf-gdiplusheaders-image-getrawformat) retourne un GUID qui indique le format de fichier d’une image. Les constantes suivantes, définies dans Gdiplusimaging. h, représentent les GUID qui identifient ces formats de fichier.
...
| <span id="ImageFormatHEIF"></span><span id="imageformatheif"></span><span id="IMAGEFORMATHEIF"></span><dl> <dt>**ImageFormatHEIF**</dt> </dl>                     | Indique le format HEIF (High EFFICACITE image format).<br/>      |
| <span id="ImageFormatIcon"></span><span id="imageformaticon"></span><span id="IMAGEFORMATICON"></span><dl> <dt>**ImageFormatIcon**</dt> </dl>                     | Indique le format de l’icône.<br/>                                     |
| <span id="ImageFormatJPEG"></span><span id="imageformatjpeg"></span><span id="IMAGEFORMATJPEG"></span><dl> <dt>**ImageFormatJPEG**</dt> </dl>                     | Indique le format JPEG.<br/>                                     |
