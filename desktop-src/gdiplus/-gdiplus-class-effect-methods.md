---
description: Cette rubrique répertorie les méthodes de la classe Effect. Pour obtenir une liste complète des classes, consultez Effect.
ms.assetid: e9ae4589-700d-4277-81b4-73f6b7023852
title: Méthodes Effect
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104991436"
---
# <a name="effect-methods"></a>Méthodes Effect

Cette rubrique répertorie les méthodes de la classe [**Effect**](/windows/desktop/api/gdipluseffects/nl-gdipluseffects-effect) . Pour obtenir une liste complète des classes, consultez **Effect**.
