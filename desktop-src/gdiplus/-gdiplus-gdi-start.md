...
GDI+ peut être utilisé dans toutes les applications basées sur Windows. GDI+ a été introduite dans Windows XP et Windows Server 2003. Pour plus d’informations sur les systèmes d’exploitation requis pour utiliser une classe ou une méthode particulière, consultez la section plus d’informations de la documentation relative à la classe ou à la méthode.
...
| [À](-gdiplus-using-gdi--use.md)<br/>          | Tâches et exemples à l’aide de GDI+.<br/>             |
| [Référence](-gdiplus-class-gdi-reference.md)<br/> | Documentation de GDI+ API basée sur une classe C++.<br/> |
...
[Windows Media](../multimedia/windows-multimedia-start-page.md)
</dt> </dl>
