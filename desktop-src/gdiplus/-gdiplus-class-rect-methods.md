---
description: Cette rubrique répertorie les méthodes de la classe Rect. Pour obtenir une liste complète des classes, consultez Rect, classe.
...
-   [**Décalage (point&)**](/previous-versions//ms534979(v=vs.85))
-   [**UE**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rect-union)
