---
description: Cette rubrique répertorie les méthodes de la classe StringFormat. Pour obtenir une liste complète des classes, consultez StringFormat, classe.
ms.assetid: 5a24308a-b899-469b-b9e2-703f1f171e63
title: StringFormat (méthodes)
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "120115239"
---
# <a name="stringformat-methods"></a>StringFormat (méthodes)

Cette rubrique répertorie les méthodes de la classe [**StringFormat**](/windows/desktop/api/gdiplusstringformat/nl-gdiplusstringformat-stringformat) . Pour obtenir une liste complète des classes, consultez **StringFormat, classe**.

-   [**Répliqué**](/windows/desktop/api/Gdiplusstringformat/nf-gdiplusstringformat-stringformat-clone)
