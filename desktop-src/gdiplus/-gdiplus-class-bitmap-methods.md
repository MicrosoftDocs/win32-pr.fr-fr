...
---
# <a name="bitmap-methods"></a>Méthodes bitmap

Cette rubrique répertorie les méthodes de la classe [**bitmap**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-bitmap) . Pour obtenir une liste complète des classes, consultez **bitmap, classe**.
...
-   [**Clone (réel, réel, réel, réel, PixelFormat)**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-bitmap-clone(inreal_inreal_inreal_inreal_inpixelformat))
...
-   [**Enregistrer (WCHAR \* , CLSID \* , EncoderParameters \* )**](/previous-versions//ms535407(v=vs.85))
