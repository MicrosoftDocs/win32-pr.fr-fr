---
description: Cette rubrique répertorie les méthodes de la classe GraphicsPathIterator. Pour obtenir une liste complète des classes, consultez GraphicsPathIterator, classe.
ms.assetid: dd0a4908-642b-4af1-80f5-0af606aee990
title: Méthodes GraphicsPathIterator
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "104972974"
---
# <a name="graphicspathiterator-methods"></a>Méthodes GraphicsPathIterator

Cette rubrique répertorie les méthodes de la classe [**GraphicsPathIterator**](/windows/desktop/api/gdipluspath/nl-gdipluspath-graphicspathiterator) . Pour obtenir une liste complète des classes, consultez **GraphicsPathIterator, classe**.

-   [**CopyData**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspathiterator-copydata)
-   [**Énumérer**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspathiterator-enumerate)
