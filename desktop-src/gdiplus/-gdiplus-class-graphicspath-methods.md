---
description: Cette rubrique répertorie les méthodes de la classe GraphicsPath. Pour obtenir une liste complète des classes, consultez GraphicsPath, classe.
ms.assetid: 440d1193-e1ca-4e11-872e-86da81360886
title: Méthodes GraphicsPath
ms.topic: reference
ms.date: 05/31/2018
...
Cette rubrique répertorie les méthodes de la classe [**GraphicsPath**](/windows/desktop/api/gdipluspath/nl-gdipluspath-graphicspath) . Pour obtenir une liste complète des classes, consultez **GraphicsPath, classe**.

-   [**AddArc (Rect&, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addarc(inconstrect__inreal_inreal))
-   [**AddArc (RectF&, réel, réel)**](/previous-versions//ms535626(v=vs.85))
...
-   [**AddArc (réel, réel, réel, réel, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addarc(inreal_inreal_inreal_inreal_inreal_inreal))
...
-   [**AddBezier (réel, réel, réel, réel, réel, réel, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addbezier(inreal_inreal_inreal_inreal_inreal_inreal_inreal_inreal))
...
-   [**AddClosedCurve (point \* , entier, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addclosedcurve(inconstpoint_inint_inreal))
...
-   [**AddCurve (point \* , entier, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addcurve(inconstpoint_inint_inreal))
...
-   [**AddEllipse (réel, réel, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addellipse(inreal_inreal_inreal_inreal))
...
-   [**AddLine (réel, réel, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addline(inreal_inreal_inreal_inreal))
...
-   [**AddPie (Rect&, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addpie(inconstrect__inreal_inreal))
...
-   [**AddPie (réel, réel, réel, réel, réel, réel)**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-addpie(inreal_inreal_inreal_inreal_inreal_inreal))
-   [**AddPie (RectF&, réel, réel)**](/previous-versions//ms535598(v=vs.85))
...
-   [**IsOutlineVisible (réel, réel, plume \* , graphiques \* )**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-isoutlinevisible(inreal_inreal_inconstpen_inconstgraphics))
...
-   [**IsVisible (réel, réel, graphique \* )**](/windows/win32/api/gdipluspath/nf-gdipluspath-graphicspath-isvisible(inreal_inreal_inconstgraphics))
...
-   [**Torsion**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-warp)
-   [**Élargi**](/windows/desktop/api/Gdipluspath/nf-gdipluspath-graphicspath-widen)
