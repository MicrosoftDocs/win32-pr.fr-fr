---
description: Cette rubrique répertorie les méthodes de la classe font. Pour obtenir une liste complète des classes, consultez font Class.
...
ms.locfileid: "104991433"
---
# <a name="font-methods"></a>Méthodes font

Cette rubrique répertorie les méthodes de la classe [**font**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-font) . Pour obtenir une liste complète des classes, consultez **font Class**.
...
-   [**GetHeight (graphiques \* )**](/previous-versions//ms536201(v=vs.85))
-   [**GetHeight (réel)**](/windows/win32/api/gdiplusheaders/nf-gdiplusheaders-font-getheight(inreal))
