...
Windows GDI+ définit des constantes dans les catégories suivantes :

-   [**Constantes de format de fichier image**](-gdiplus-constant-image-file-format-constants.md)
-   [Constantes de dimension Frame image](-gdiplus-constant-image-frame-dimension-constants.md)
-   [Constantes d’encodeur d’image](-gdiplus-constant-image-encoder-constants.md)
-   [**Constantes de format de pixel d’image**](-gdiplus-constant-image-pixel-format-constants.md)
