---
description: les sections suivantes décrivent différentes façons de programmer avec Windows GDI+ est différente de la programmation avec les Graphics Device Interface de Windows (GDI).
