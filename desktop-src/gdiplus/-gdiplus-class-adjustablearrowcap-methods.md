---
description: Cette rubrique répertorie les méthodes de la classe AdjustableArrowCap. Pour obtenir une liste complète des classes, consultez AdjustableArrowCap.
ms.assetid: 9d5bf8a5-2de0-4dfc-9d8d-a8e1de64a346
title: Méthodes AdjustableArrowCap
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "119557469"
---
# <a name="adjustablearrowcap-methods"></a>Méthodes AdjustableArrowCap

Cette rubrique répertorie les méthodes de la classe [**AdjustableArrowCap**](/windows/desktop/api/gdipluslinecaps/nl-gdipluslinecaps-adjustablearrowcap) . Pour obtenir une liste complète des classes, consultez **AdjustableArrowCap**.
