...
---
# <a name="fontfamily-methods"></a>Méthodes FontFamily

Cette rubrique répertorie les méthodes de la classe [**FontFamily**](/windows/desktop/api/gdiplusheaders/nl-gdiplusheaders-fontfamily) . Pour obtenir une liste complète des classes, consultez **FontFamilyClass**.
