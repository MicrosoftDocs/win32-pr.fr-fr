---
description: Cette rubrique répertorie les méthodes de la classe RectF. Pour obtenir une liste complète des classes, consultez RectF, classe.
ms.assetid: f14f1693-b0f3-4e68-8245-846aef1ed299
title: Méthodes RectF
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "119037007"
---
# <a name="rectf-methods"></a>Méthodes RectF

Cette rubrique répertorie les méthodes de la classe [**RectF**](/windows/desktop/api/gdiplustypes/nl-gdiplustypes-rectf) . Pour obtenir une liste complète des classes, consultez **RectF, classe**.

-   [**Répliqué**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-clone)
...
-   [**Contains (réel, réel)**](/previous-versions//ms534956(v=vs.85))
-   [**Est égal à**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-equals)
...
-   [**Gonflé (PointF&)**](/windows/win32/api/gdiplustypes/nf-gdiplustypes-rectf-inflate(inconstpointf_))
-   [**Gonflé (réel, réel)**](/previous-versions//ms534953(v=vs.85))
...
-   [**Décalage (réel, réel)**](/windows/win32/api/gdiplustypes/nf-gdiplustypes-rectf-offset(inreal_inreal))
-   [**UE**](/windows/desktop/api/Gdiplustypes/nf-gdiplustypes-rectf-union)
