...
ms.locfileid: "127519529"
---
# <a name="mobile-broadband-profile-schema-v1-elements"></a>Éléments v1 du schéma de profil haut débit mobile

Un profil mobile large bande v1 se compose des éléments suivants. Tous les éléments nommés se trouvent dans l’espace de noms `https://www.microsoft.com/networking/WWAN/profile/v1` .
...
-   [**MBNProfile**](schema-mbnprofile-element.md)
    ...
    -   [**Contexte (MBNProfile)**](schema-context-mbnprofile-element.md)
        ...
        -   [**UserLogonCred (contextType)**](schema-userlogoncred-contexttype-element.md)
            ...
            -   [**Mot de passe (UserLogonCred)**](schema-password-userlogoncred-element.md)
            -   [**Nom d’utilisateur (UserLogonCred)**](schema-username-userlogoncred-element.md)
    ...
    -   [**Nom (MBNProfile)**](schema-name-mbnprofile-element.md)
    ...
    -   [**Abonné (MBNProfile)**](schema-subscriberid-mbnprofile-element.md)
