...
Spécifie si l’appareil haut débit mobile se connecte automatiquement à un réseau.

Pour plus d’informations, consultez la documentation de l’élément [**AutoConnectOnInternet**](./schema-autoconnectoninternet-mbnprofile-element.md) v1.
