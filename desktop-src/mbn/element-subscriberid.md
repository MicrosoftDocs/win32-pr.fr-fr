...
Identifie l’identificateur unique du profil.
...
Pour plus d’informations, consultez la documentation de l’élément [**abonné**](./schema-subscriberid-mbnprofile-element.md) v1.
