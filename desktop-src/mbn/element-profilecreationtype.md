...
Spécifie le créateur du profil.

Pour plus d’informations sur cet élément, consultez la documentation de l’élément [**ProfileCreationType**](./schema-profilecreationtype-mbnprofile-element.md) v1.
