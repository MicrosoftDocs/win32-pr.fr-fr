---
description: Éléments v4 du schéma de profil haut débit mobile
MS-HAID: WWAN\_profile\_v4.root\_elements
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: Éléments v4 du schéma de profil haut débit mobile
ms.topic: reference
ms.date: 05/31/2018
...
La liste suivante récapitule les hiérarchies autorisées pour ce schéma, en commençant par l’élément (document) le plus à l’extérieur en haut.
...
-   [MBNProfileExt](element-mbnprofileext.md)
    ...
    -   [Abonné](element-subscriberid.md)
    ...
    -   [DataRoamingPartners](element-dataroamingpartners.md)
        -   [Fournisseur](element-provider.md)
