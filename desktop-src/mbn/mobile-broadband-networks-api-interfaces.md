---
description: L’API haut débit mobile définit et utilise les interfaces suivantes.
ms.assetid: db6c9635-16f9-4266-9d0e-daeb58fac588
title: Interfaces d’API haut débit mobile
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "118975289"
---
# <a name="mobile-broadband-api-interfaces"></a>Interfaces d’API haut débit mobile

L’API haut débit mobile définit et utilise les interfaces suivantes.
