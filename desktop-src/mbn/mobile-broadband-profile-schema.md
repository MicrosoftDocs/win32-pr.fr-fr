---
description: Schéma de profil de haut débit mobile v1.
...
---
# <a name="mobile-broadband-profile-schema-v1"></a><span data-ttu-id="bf329-103">Schéma de profil de haut débit mobile v1</span><span class="sxs-lookup"><span data-stu-id="bf329-103">Mobile Broadband Profile Schema v1</span></span>

<span data-ttu-id="bf329-104">Le schéma de profil large bande 7Mobile Windows v1 est disponible dans l’espace de noms `https://www.microsoft.com/networking/WWAN/profile/v1` .</span><span class="sxs-lookup"><span data-stu-id="bf329-104">The Windows 7Mobile Broadband Profile Schema v1 is available in the namespace `https://www.microsoft.com/networking/WWAN/profile/v1`.</span></span>

-   [<span data-ttu-id="bf329-105">Éléments v1 du schéma de profil haut débit mobile</span><span class="sxs-lookup"><span data-stu-id="bf329-105">Mobile Broadband Profile Schema v1 Elements</span></span>](schema-elements.md)
-   [<span data-ttu-id="bf329-106">Types simples de schéma de profil haut débit v1</span><span class="sxs-lookup"><span data-stu-id="bf329-106">Mobile Broadband Profile Schema v1 Simple Types</span></span>](schema-simple-types.md)
-   [<span data-ttu-id="bf329-107">Types complexes de schéma de profil haut débit v1</span><span class="sxs-lookup"><span data-stu-id="bf329-107">Mobile Broadband Profile Schema v1 Complex Types</span></span>](schema-complex-types.md)
