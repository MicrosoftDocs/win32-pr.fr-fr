...
L’élément **IsPurchaseProfile** contient une valeur **booléenne** **true** s’il s’agit d’un profil acheté et **false**, dans le cas contraire. La valeur par défaut est **false**.
