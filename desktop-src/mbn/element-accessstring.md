...
Identifie l’APN ou la chaîne de numérotation à utiliser pour établir une connexion de données.

Pour plus d’informations, consultez la documentation de l’élément [**AccessString**](./schema-accessstring-contexttype-element.md) v1.
