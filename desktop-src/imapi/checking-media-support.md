---
title: Vérification de la prise en charge des supports
description: Le script suivant examine les caractéristiques du support chargé sur le périphérique de disque.
...
---
# <a name="checking-media-support"></a><span data-ttu-id="29df1-103">Vérification de la prise en charge des supports</span><span class="sxs-lookup"><span data-stu-id="29df1-103">Checking Media Support</span></span>

<span data-ttu-id="29df1-104">Le script suivant examine les caractéristiques du support chargé sur le périphérique de disque.</span><span class="sxs-lookup"><span data-stu-id="29df1-104">The following script examines characteristics of the media loaded in the disc device.</span></span> <span data-ttu-id="29df1-105">Plus spécifiquement, il vérifie le type de média et l’état actuel du support, ainsi que la compatibilité des enregistreurs et des supports.</span><span class="sxs-lookup"><span data-stu-id="29df1-105">More specifically, it checks the media type and the current state of the media, as well as recorder and media compatibility.</span></span> <span data-ttu-id="29df1-106">Ce script peut être adapté pour vérifier la compatibilité et les problèmes d’État avant d’utiliser le média.</span><span class="sxs-lookup"><span data-stu-id="29df1-106">This script can be adapted to verify compatibility and state issues before using the media.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="29df1-107">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="29df1-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="29df1-108">Utilisation d’IMAPi</span><span class="sxs-lookup"><span data-stu-id="29df1-108">Using IMAPI</span></span>](using-imapi.md)
</dt> <dt>

[<span data-ttu-id="29df1-109">**\_type physique de média IMAPI \_ \_**</span><span class="sxs-lookup"><span data-stu-id="29df1-109">**IMAPI\_MEDIA\_PHYSICAL\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_media_physical_type)
</dt> <dt>

[<span data-ttu-id="29df1-110">**IDiscMaster2**</span><span class="sxs-lookup"><span data-stu-id="29df1-110">**IDiscMaster2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscmaster2)
</dt> <dt>

[<span data-ttu-id="29df1-111">**IDiscRecorder2**</span><span class="sxs-lookup"><span data-stu-id="29df1-111">**IDiscRecorder2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscrecorder2)
</dt> <dt>

[<span data-ttu-id="29df1-112">**IDiscFormat2Data**</span><span class="sxs-lookup"><span data-stu-id="29df1-112">**IDiscFormat2Data**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscformat2data)
</dt> </dl>
