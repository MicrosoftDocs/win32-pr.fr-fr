...
Le script suivant examine les caractéristiques du support chargé sur le périphérique de disque. Plus spécifiquement, il vérifie le type de média et l’état actuel du support, ainsi que la compatibilité des enregistreurs et des supports. Ce script peut être adapté pour vérifier la compatibilité et les problèmes d’État avant d’utiliser le média.
