...
ms.locfileid: "104380396"
---
# <a name="checking-drive-support"></a><span data-ttu-id="8900e-103">Vérification de la prise en charge du lecteur</span><span class="sxs-lookup"><span data-stu-id="8900e-103">Checking Drive Support</span></span>

<span data-ttu-id="8900e-104">L’exemple suivant examine les caractéristiques du périphérique de disque qui sont indépendantes des médias insérés dans l’appareil.</span><span class="sxs-lookup"><span data-stu-id="8900e-104">The following example examines disc device characteristics that are independent of media inserted in the device.</span></span> <span data-ttu-id="8900e-105">Plus précisément, il récupère les listes des fonctionnalités prises en charge, les profils pris en charge et les pages en mode pris en charge, ainsi que les paramètres et le profil de fonctionnalités actuels.</span><span class="sxs-lookup"><span data-stu-id="8900e-105">More specifically, it retrieves lists of supported features, supported profiles, and supported mode pages, as well as the current feature settings and profile.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="8900e-106">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="8900e-106">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="8900e-107">Utilisation d’IMAPi</span><span class="sxs-lookup"><span data-stu-id="8900e-107">Using IMAPI</span></span>](using-imapi.md)
</dt> <dt>

[<span data-ttu-id="8900e-108">**IDiscMaster2**</span><span class="sxs-lookup"><span data-stu-id="8900e-108">**IDiscMaster2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscmaster2)
</dt> <dt>

[<span data-ttu-id="8900e-109">**IDiscRecorder2**</span><span class="sxs-lookup"><span data-stu-id="8900e-109">**IDiscRecorder2**</span></span>](/windows/desktop/api/imapi2/nn-imapi2-idiscrecorder2)
</dt> <dt>

[<span data-ttu-id="8900e-110">**TYPE de \_ page de fonctionnalité IMAPI \_ \_**</span><span class="sxs-lookup"><span data-stu-id="8900e-110">**IMAPI\_FEATURE\_PAGE\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_feature_page_type)
</dt> <dt>

[<span data-ttu-id="8900e-111">**TYPE de \_ page du mode IMAPI \_ \_**</span><span class="sxs-lookup"><span data-stu-id="8900e-111">**IMAPI\_MODE\_PAGE\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_mode_page_type)
</dt> <dt>

[<span data-ttu-id="8900e-112">**TYPE de \_ Profil IMAPI \_**</span><span class="sxs-lookup"><span data-stu-id="8900e-112">**IMAPI\_PROFILE\_TYPE**</span></span>](/windows/desktop/api/imapi2/ne-imapi2-imapi_profile_type)
</dt> </dl>
