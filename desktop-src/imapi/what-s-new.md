...
-   sur Windows Vista, les interfaces de la version 1,0 appellent désormais les interfaces 2,0.
-   inclus dans Windows Vista avec SP1 et Windows Server 2008, imapi requise 2,0 offre une prise en charge du démarrage multiple via l’interface [**IFileSystemImage2**](/windows/desktop/api/imapi2fs/nn-imapi2fs-ifilesystemimage2) .
