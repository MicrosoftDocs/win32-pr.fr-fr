...
---
# <a name="create-content-key-example"></a><span data-ttu-id="d6906-119">Exemple de création d’une clé de contenu</span><span class="sxs-lookup"><span data-stu-id="d6906-119">Create Content Key Example</span></span>

<span data-ttu-id="d6906-120">La clé de contenu est utilisée pour chiffrer les exemples de média pour l’importation de DRM Windows Media.</span><span class="sxs-lookup"><span data-stu-id="d6906-120">The content key is used to encrypt media samples for Windows Media DRM Import.</span></span> <span data-ttu-id="d6906-121">L’exemple de code suivant montre comment créer et initialiser une structure de clé de contenu.</span><span class="sxs-lookup"><span data-stu-id="d6906-121">The following code example demonstrates how to create and initialize a content key structure.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d6906-122">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="d6906-122">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d6906-123">**Exemples d’importation DRM**</span><span class="sxs-lookup"><span data-stu-id="d6906-123">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
