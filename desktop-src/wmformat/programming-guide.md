...
| Section                                                                            | Description                                                                                                       |
|------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------|
| [Prise en main](getting-started.md)                                             | Fournit des informations générales sur la préparation à l’utilisation de ce kit de développement logiciel (SDK).                                                 |
| [Utilisation des méthodes de rappel](using-the-callback-methods.md)                       | Décrit les méthodes de rappel utilisées dans de nombreuses tâches différentes.                                                      |
| [Utilisation des profils](working-with-profiles.md)                                 | Décrit comment utiliser, modifier et créer des profils.                                                                  |
| [Écriture de fichiers ASF](writing-asf-files.md)                                         | Décrit comment utiliser l’objet Writer pour créer des fichiers ASF.                                                       |
| [Lecture des fichiers ASF](reading-asf-files.md)                                         | Décrit comment recevoir du contenu à partir de fichiers ASF.                                                                  |
| [Utilisation des métadonnées](working-with-metadata.md)                                 | Décrit comment gérer le contenu de la section d’en-tête d’un fichier ASF.                                        |
| [Utilisation des index](working-with-indexes.md)                                   | Décrit comment utiliser des index.                                                                               |
| [Utilisation des profils](working-with-profiles.md)                                 | Décrit comment utiliser, modifier et créer des profils.                                                                  |
| [Utilisation des commandes de script](using-script-commands.md)                                 | Décrit comment utiliser des commandes de script dans vos fichiers ASF.                                                           |
| [Copie de données d’un fichier vers un autre](copying-data-from-one-file-to-another.md) | Décrit comment copier des données d’un fichier ASF vers un autre, sans décodage ni encodage.                      |
