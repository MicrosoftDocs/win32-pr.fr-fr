...
| [Protection DRM et distribution des licences de contenu](drm-protection-and-content-license-distribution.md)                         | Compare les fonctionnalités DRM du kit de développement logiciel (SDK) Windows Media format au kit de développement logiciel (SDK) Windows Media Rights Manager.                                                                                        |
