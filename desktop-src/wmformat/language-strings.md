...
| Chaîne de langue | Description                  |
|-----------------|------------------------------|
| af              | Afrikaans                    |
| AR-AE           | Arabe (E.A.U.)              |
| AR-BH           | Arabe (Royaume de Bahreïn)  |
| ar-DZ           | Arabe (Algérie)             |
| AR-EG           | Arabe (Égypte)               |
| AR-IQ           | Arabe (Irak)                |
...
| lt              | Lituanien                   |
| lv              | Letton                      |
| MK              | Macédonien du Nord             |
| ml              | Malayalam                    |
| portable              | Mongole (cyrillique)         |
| mr              | Marathi                      |
| ms              | Malais                        |
| mt              | Maltais                      |
...
| nn-non           | Norvégien (nynorsk)          |
| non              | Norvégien (bokmål)           |
| ou              | Odia                         |
| pa              | Pendjabi                      |
| pl              | Polonais                       |
