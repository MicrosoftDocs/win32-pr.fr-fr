...
tout comme les objets du kit de développement logiciel (SDK) du Format de média Windows différencient les numéros d’entrée, les numéros de flux et les numéros de sortie (consultez [entrées, Flux et sorties](inputs-streams-and-outputs.md)), il existe des différences importantes entre les formats d’entrée, les formats de flux et les formats de sortie. Ces différences sont décrites ici :
