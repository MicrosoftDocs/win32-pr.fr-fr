...
Le code suivant est un exemple d’individualisation forcée et montre également comment utiliser le modèle de gestion des événements synchrones avec des événements associés à des interfaces d’État.
