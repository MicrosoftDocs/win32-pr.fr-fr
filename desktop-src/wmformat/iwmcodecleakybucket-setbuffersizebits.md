...
description: pour obtenir la documentation actuelle sur Windows les codecs multimédias et les processeurs de signaux numériques, consultez Windows Media Audio et les api de codec vidéo et DSP. | SetBufferSizeBits
ms.assetid: f5993947-c75a-4783-8ec9-6026f9f3e1a8
keywords:
- Format Windows Media SetBufferSizeBits
topic_type:
- apiref
api_name:
- SetBufferSizeBits
