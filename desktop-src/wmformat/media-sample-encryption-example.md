...
---
# <a name="media-sample-encryption-example"></a><span data-ttu-id="f7bef-118">Exemple de chiffrement d’échantillon de média</span><span class="sxs-lookup"><span data-stu-id="f7bef-118">Media Sample Encryption Example</span></span>

<span data-ttu-id="f7bef-119">L’exemple complet suivant montre comment chiffrer un exemple de support à l’aide du chiffrement DRM.</span><span class="sxs-lookup"><span data-stu-id="f7bef-119">The following incomplete example demonstrates how to encrypt a media sample using DRM encryption.</span></span> <span data-ttu-id="f7bef-120">L’algorithme de chiffrement RC4 a été omis de l’exemple en raison de restrictions d’espace.</span><span class="sxs-lookup"><span data-stu-id="f7bef-120">The RC4 encryption algorithm has been left out of the example due to space restrictions.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f7bef-121">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="f7bef-121">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f7bef-122">**Exemples d’importation DRM**</span><span class="sxs-lookup"><span data-stu-id="f7bef-122">**DRM Import Examples**</span></span>](drm-import-examples.md)
</dt> </dl>
