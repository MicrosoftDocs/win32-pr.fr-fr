...
En outre, les fichiers image vidéo compressés sans flux audio peuvent contenir plusieurs images vidéo très petites et très compressées dans un paquet ASF unique, ce qui peut entraîner une mauvaise expérience de lecture sur les versions précédentes du lecteur Windows Media. Pour éviter ce problème, la meilleure solution consiste à insérer un flux audio silencieux dans le fichier, bien que cela augmente également la taille du fichier.
