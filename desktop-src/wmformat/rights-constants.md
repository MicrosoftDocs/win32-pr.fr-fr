...
Les constantes répertoriées dans le tableau suivant sont utilisées pour identifier les actions DRM et pour créer des listes d’actions.



| Constante                                        | Description                                                                                                                                                                                                                                                    |
|-------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| g \_ wszWMDRM \_ ActionList \_                    | Définit le nom d’élément XML pour une liste d’actions.                                                                                                                                                                                                               |
| g \_ ( \_ balise d’action wszWMDRM) \_                        | Définit le nom d’élément XML pour une entrée dans une liste d’actions.                                                                                                                                                                                                   |
| \_ \_ lecture droite g \_ wszWMDRM                    | Définit la chaîne pour le droit de lire le contenu.                                                                                                                                                                                                              |
| \_wszWMDRM g \_ droit de \_ copie                        | Définit la chaîne du droit de copie du contenu.                                                                                                                                                                                                              |
