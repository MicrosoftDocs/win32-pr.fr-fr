...
cette structure, y compris la mémoire tampon contenant la clé de session, doit être chiffrée à l’aide de la clé publique de l’ordinateur Media DRM Windows et incluse dans le membre **pbEncryptedSessionKeyMessage** de la structure d' [**importation/ \_ exportation \_ \_ WMDRM**](/previous-versions/windows/desktop/api/wmsdkidl/ns-wmsdkidl-wmdrm_import_init_struct) .
