...
| [Types énumération](enumeration-types.md)                                           | Décrit les types d’énumération pris en charge par ce kit de développement logiciel (SDK).                                                       |
| [Attributs](attributes.md)                                                         | Décrit les attributs qui peuvent être spécifiés dans les en-têtes des fichiers ASF.                                  |
| [Types de médias](media-types.md)                                                       | Décrit les identificateurs de type de média utilisés par ce kit de développement logiciel (SDK).                                                       |
| [Paramètres de sortie](output-settings.md)                                               | Décrit les constantes globales utilisées pour identifier les paramètres de sortie du lecteur.                                      |
| [Chaînes de langue](language-strings.md)                                             | Décrit les identificateurs de langage conformes RFC 1766 couramment utilisés.                                         |
| [Paramètres du modèle de conformité des appareils](device-conformance-template-parameters.md) | Décrit les modèles de conformité des appareils, qui décrivent les plages de valeurs appropriées pour différents appareils. |
| [Profils système](system-profiles.md)                                               | Répertorie tous les profils système pris en charge.                                                                         |
| [Profils système localisés](localized-system-profiles.md)                           | Répertorie les fichiers de profil système localisés inclus avec le kit de développement logiciel (SDK) et les langues associées à chacun d’eux.       |
| [Valeurs GUID](guid-values.md)                                                       | Décrit les valeurs GUID utilisées par ce kit de développement logiciel (SDK).                                                                  |
| [Codes d’erreur](error-codes.md)                                                       | Décrit les codes d’erreur courants retournés par les méthodes et les fonctions du kit de développement logiciel (SDK).                                   |
| [Plug-ins sources](source-plug-ins.md)                                               | Décrit la configuration requise pour les sources implémentées par l’utilisateur.                                                     |
