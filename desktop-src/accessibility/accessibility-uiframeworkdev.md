...
- [Respecter contraste élevé](/windows/desktop/w8cookbook/high-contrast-mode)
- [Paramètres utilisateur](/windows/desktop/api/winuser/nf-winuser-systemparametersinfoa)
- [Billet de blog des paramètres utilisateur](https://devblogs.microsoft.com/oldnewthing/?p=36243)

Exemples

- [Exemple d’implémentation de l’infrastructure WPF UI Automation](https://github.com/Microsoft/WPF-Samples/tree/master/Accessibility)
