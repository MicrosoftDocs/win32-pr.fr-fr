...
ms.locfileid: "117983916"
---
# <a name="wpa2-personal-profile-sample"></a>Exemple de profil de WPA2-Personal

Cet exemple de profil utilise une clé prépartagée pour l’authentification réseau. La clé est partagée avec le client et le point d’accès. Cet exemple de profil est configuré pour utiliser Wi-Fi la sécurité Access 2 protégée s’exécutant en mode personnel (WPA2-Personal). Le type de chiffrement Advanced Encryption Standard (AES) est utilisé pour le chiffrement.
