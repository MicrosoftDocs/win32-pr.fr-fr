...
Cette rubrique montre comment utiliser Wi-Fi fonctions directes dans les applications de bureau. À compter de Windows 8 et de Windows Server 2012, Wi-Fi fonctions directes ont été ajoutées à l’API WiFi native.
