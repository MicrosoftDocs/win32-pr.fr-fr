...
L’API WiFi Native contient un ensemble de fonctions qui prennent en charge l’utilisation de Wi-Fi directe pour les applications de bureau. à partir de Windows 8 et Windows Server 2012, Wi-Fi fonctions directes ont été ajoutées à l’API Wifi Native.
