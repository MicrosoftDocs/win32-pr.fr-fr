...
---
# <a name="installlayoutortipuserreg-function"></a>InstallLayoutOrTipUserReg fonction)

Active les dispositions de clavier ou les services de texte spécifiés pour l’utilisateur spécifié.
...
| <dl> <dt>**FASE**</dt> </dl> | Une erreur non spécifiée s'est produite.<br/> |
