...
---
# <a name="prototypes"></a><span data-ttu-id="e154a-110">Prototypes</span><span class="sxs-lookup"><span data-stu-id="e154a-110">Prototypes</span></span>

<span data-ttu-id="e154a-111">[ITfContextRenderingMarkup](/windows/desktop/TSF/itfcontextrenderingmarkup), [IEnumTfRenderingMarkup](/windows/desktop/TSF/ienumtfrenderingmarkup)et [tf \_ RENDERINGMARKUP](/windows/desktop/TSF/tf-renderingmarkup) décrits dans cette référence ne sont pas définis dans des fichiers IDL ou d’en-tête.</span><span class="sxs-lookup"><span data-stu-id="e154a-111">[ITfContextRenderingMarkup](/windows/desktop/TSF/itfcontextrenderingmarkup), [IEnumTfRenderingMarkup](/windows/desktop/TSF/ienumtfrenderingmarkup), and [TF\_RENDERINGMARKUP](/windows/desktop/TSF/tf-renderingmarkup) described in this reference are not defined in IDL or header files.</span></span> <span data-ttu-id="e154a-112">Les prototypes suivants doivent être respectés par le compilateur MIDL pour recevoir le fichier d’en-tête.</span><span class="sxs-lookup"><span data-stu-id="e154a-112">The following prototypes are needed to be complied by MIDL compiler to get the header file..</span></span>
