...
Voici les types complexes définis par le schéma d’événement.



| Type complexe                                                                       | Description                                                                                                                                                                                               |
|------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**ComplexDataType**](eventschema-complexdatatype-complextype.md)                 | Définit une structure qui contient un ou plusieurs éléments de données.<br/>                                                                                                                                      |
...
| [**UserDataType**](eventschema-userdatatype-complextype.md)                       | Définit un fragment XML qui spécifie la disposition des données d’événement.<br/>                                                                                                                           |
