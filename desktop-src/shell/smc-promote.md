...
ms.locfileid: "127220372"
---
# <a name="smc_promote-message"></a>\_Message de promotion SMC

Promouvoir l’élément spécifié par la structure [**SMDATA**](/windows/win32/api/shobjidl_core/ns-shobjidl_core-smdata) jointe.
