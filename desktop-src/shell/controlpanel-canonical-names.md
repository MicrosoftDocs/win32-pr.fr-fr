---
description: à partir de Windows Vista, les éléments du panneau de configuration inclus avec Windows reçoivent un nom canonique qui peut être utilisé dans un appel d’API ou une instruction de ligne de commande pour lancer par programmation cet élément.
...
-   [Clavier](#keyboard)
-   [emplacement Paramètres](#location-settings)
-   [Souris](#mouse)
...
-   **Pages**
    ...
    | pageSettings        | Paramètres des rapports de problèmes |
...
-   **Pages**
    ...
    | Nom de la page                   | Opens               |
    |-----------------------------|---------------------|
    | ? SelectedVault = CredmanVault | Windows Informations d’identification |
...
### <a name="location-settings"></a>emplacement Paramètres
...
-   la fenêtre que cette valeur lance est intitulée « informations relatives à l’emplacement » dans les versions de Windows antérieures à Windows 8. L’interface utilisateur de l’élément est considérablement modifiée à partir de Windows 8.
...
-   **Pages**
    ...
    | pagePlanSettings   | modifier le Plan Paramètres |
...
| Microsoft. CardSpace                                         | Windows CardSpace                 | {78CB147A-98EA-4AA6-B0DF-C8681F69341C} | Suppression à partir de Windows 8.                                                                                                                                                                                                                                                                                                                                  |
| Microsoft. DesktopGadgets                                    | Gadgets du Bureau                   | {37efd44d-ef8d-41b1-940d-96973a50e9e0} | Suppression à partir de Windows 8.                                                                                                                                                                                                                                                                                                                                  |
| Microsoft. GetProgramsOnline                                 | Place de marché Microsoft Azure               | {3e7efb4c-faf1-453d-89eb-56026875ef90} | suppression à partir de Windows 7.                                                                                                                                                                                                                                                                                                                                  |
| Microsoft. InfraredOptions                                   | Infrarouge                          | {A0275511-0E86-4ECA-97C2-ECD8F1221D08} | Cartes à [Microsoft. infrarouge](#infrared) à partir de Windows 7.                                                                                                                                                                                                                                                                                                  |
| Microsoft. langue                                          | Langage                          | {BF782CC9-5A52-4A17-806C-2A894FFEEAC5} | supprimé à partir de Windows 10, version 1803                                                                                                                                                                                                                                                                                                                    |
| Microsoft. LocationAndOtherSensors                           | Emplacement et autres capteurs        | {E9950154-C418-419e-A90A-20C5287AE24B} | Cartes à [Microsoft. LocationSettings](#infrared) à partir de Windows 8.                                                                                                                                                                                                                                                                                          |
| Microsoft. PenAndInputDevices                                | Stylet et périphériques d’entrée             | {F82DF8F7-8B9F-442E-A48C-818EA735FF9B} | Cartes à [Microsoft. PenAndTouch](#pen-and-touch) à partir de Windows 7.                                                                                                                                                                                                                                                                                          |
| Microsoft. PeopleNearMe                                      | Voisinage immédiat                    | {5224F545-A443-4859-BA23-7B5A95BDC8EF} | Suppression à partir de Windows 8.                                                                                                                                                                                                                                                                                                                                  |
...
| Microsoft. PhoneAndModemOptions                              | Téléphone et Modem                   | {40419485-C444-4567-851A-2DD7BFA1684D} | Cartes à [Microsoft. PhoneAndModem](#phone-and-modem) à partir de Windows 7.                                                                                                                                                                                                                                                                                      |
| Microsoft. Printers                                          | Imprimantes                          | {2227A280-3AEA-1069-A2DE-08002B30309D} | Cartes à [Microsoft. DevicesAndPrinters](#devices-and-printers) à partir de Windows 7.                                                                                                                                                                                                                                                                            |
| Microsoft. ProblemReportsAndSolutions                        | Rapports et solutions aux problèmes     | {FCFEECAE-EE1B-4849-AE50-685DCF7717EC} | Cartes à [Microsoft. ActionCenter](#action-center) à partir de Windows 7.                                                                                                                                                                                                                                                                                         |
| Microsoft. RegionalAndLanguageOptions                        | Options régionales et linguistiques     | {62D8ED13-C9D0-4CE8-A914-47DD628FB1B0} | Cartes à [Microsoft. RegionAndLanguage](#region) à partir de Windows 7. notez que à partir de Windows 8, la région et la langue ont chacune leur propre élément du panneau de configuration. Microsoft. RegionalAndLanguageOptions et Microsoft. RegionAndLanguage ouvrent actuellement l’élément Region. Vous devez utiliser [Microsoft. Language](#location-settings) pour accéder à l’élément de langue. |
| Microsoft. SecurityCenter                                    | Sécurité Windows Gestionnaire           | {087DA31B-0DD3-4537-8E23-64A18591F88B} | Cartes à [Microsoft. ActionCenter](#action-center) à partir de Windows 7.                                                                                                                                                                                                                                                                                         |
| Microsoft. SpeechRecognitionOptions                          | Options de reconnaissance vocale        | {58E3C745-D971-4081-9034-86E34B30836A} | Cartes à [Microsoft. SpeechRecognition](#speech-recognition) à partir de Windows 7.                                                                                                                                                                                                                                                                               |
| Microsoft. TaskbarAndStartMenu                               | Barre des tâches et menu Démarrer            | {0DF44EAA-FF21-4412-828E-260A8728E7F1} | Cartes à [Microsoft. Taskbar](#speech-recognition) à partir de Windows 8.                                                                                                                                                                                                                                                                                         |
| Microsoft. WelcomeCenter                                     | Centre d’accueil                    | {CB1B7F8C-C50A-4176-B604-9E24DEE8D4D1} | Cartes à Microsoft. GettingStarted dans Windows 7. Ouvre la page d’hébergement du panneau de configuration à partir de Windows 8.                                                                                                                                                                                                                                                      |
| Microsoft. WindowsSidebarProperties                          | Windows Propriétés du volet        | {37efd44d-ef8d-41b1-940d-96973a50e9e0} | Cartes à Microsoft. DesktopGadgets dans Windows 7. Suppression à partir de Windows 8.                                                                                                                                                                                                                                                                                   |
