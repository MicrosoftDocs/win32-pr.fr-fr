...
1.  ouvrez Windows Explorer et accédez au répertoire du projet de **groupe résidentiel** .
...
2.  Sur la ligne de commande, entrez `HomeGroup.exe` . vous pouvez également, à partir de Windows Explorer, double-cliquer sur l’icône de HomeGroup.exe.
