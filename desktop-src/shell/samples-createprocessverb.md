...
1.  Ouvrez l’Explorateur Windows et accédez au répertoire du projet **CreateProcessVerb** .
...
2.  Sur la ligne de commande, entrez `CreateProcessVerb.exe` . Vous pouvez également, à partir de l’Explorateur Windows, double-cliquer sur l’icône de CreateProcessVerb.exe.
