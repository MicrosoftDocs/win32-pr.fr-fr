---
description: Prise en charge des applications Shell
title: Prise en charge des applications Shell
ms.topic: article
ms.date: 05/31/2018
...
-   [Transfert d’objets Shell avec glisser-déplacer et le presse-papiers](dragdrop.md)
-   [Objets Shell scriptable](scriptable-shell-objects-roadmap.md)
-   [Profils utilisateur](user-profiles.md)
-   [Navigation dans l’espace de noms Shell](navigating-the-shell-namespace-bumper.md)
