...
1.  Ouvrez l’Explorateur Windows et accédez au répertoire du projet **AppUserModelIDWindowProperty** .
...
2.  Sur la ligne de commande, entrez `AppUserModelIDWindowProperty.exe` . Vous pouvez également, à partir de l’Explorateur Windows, double-cliquer sur l’icône de AppUserModelIDWindowProperty.exe.
