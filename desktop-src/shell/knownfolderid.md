...
<td>Aucun, valeur introduite dans Windows 8</td>
</tr>
<tr class="even">
...
<tr class="even">
<td>Default Path</td>
<td>Non applicable — dossier virtuel</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>None</td>
...
<tr class="even">
<td>Nom complet hérité</td>
<td>Ajouter de nouveaux programmes (situés dans l’élément <strong>Ajout/suppression de programmes</strong> du panneau de configuration)</td>
</tr>
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Non applicable — dossier virtuel</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Outils \ outils d'%USERPROFILE%\Start</td>
</tr>
</tbody>
</table>
...
<p> </p>
<p>Ce FOLDERID est utilisé en interne par les applications .NET pour activer les fonctionnalités d’application multiplateforme. Elle n’est pas destinée à être utilisée directement à partir d’une application.</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td>Effet de CSIDL</td>
<td>Aucun, valeur introduite dans Windows 8.1</td>
</tr>
<tr class="even">
<td>Nom complet hérité</td>
<td>Non applicable</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Outils \ outils d'%ALLUSERSPROFILE%\Start</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Default Path</td>
<td>Liens%ALLUSERSPROFILE%\OEM</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Documents%USERPROFILE%\My</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Default Path</td>
<td>%windir%\resources\0409 (page de codes)</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
...
<tr class="even">
<td>Default Path</td>
<td>%USERPROFILE%\Pictures\Slide affiche</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>aucun, valeur introduite dans Windows Vista</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>%USERPROFILE%\My Documents\mes images</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Nom complet hérité</td>
<td>Imprimantes et télécopieurs</td>
</tr>
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Non applicable — dossier virtuel</td>
...
<tr class="even">
<td>Default Path</td>
<td>% USERPROFILE% (%SystemDrive%\Users \% nom_utilisateur%)</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>CSIDL_PROFILE</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Données%ALLUSERSPROFILE%\Application</td>
</tr>
</tbody>
</table>
...
<td ><p>Pour plus d'informations, consultez la section Notes.</p>
...
<td ><p>Cette valeur n’est pas prise en charge sur les systèmes d’exploitation 32 bits. Il n’est pas non plus pris en charge pour les applications 32 bits s’exécutant sur des systèmes d’exploitation 64 bits. Toute tentative d’utilisation d’FOLDERID_ProgramFilesX64 dans les deux cas génère une erreur. Pour plus d'informations, consultez la section Notes.</p>
...
<tr class="even">
<td>Default Path</td>
<td>Fichiers%ProgramFiles%\Common</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
...
<tr class="even">
<td>Nom complet hérité</td>
<td>Images partagées</td>
</tr>
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Images%ALLUSERSPROFILE%\Documents\My</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Nom complet hérité</td>
<td>Vidéo partagée</td>
</tr>
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Vidéos%ALLUSERSPROFILE%\Documents\My</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Default Path</td>
<td>Lancement de%APPDATA%\Microsoft\Internet Explorer\Quick</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>None</td>
...
<td ><p>Non utilisé. cette valeur n’est pas définie à partir de Windows 7.</p></td>
</tr>
<tr class="odd">
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>% APPDATA% (%USERPROFILE%\Application données)</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Default Path</td>
<td>Images%PUBLIC%\Pictures\Sample</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>None</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>Images \ échantillons%ALLUSERSPROFILE%\Documents\My</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td>Default Path</td>
<td>Vidéos%PUBLIC%\Videos\Sample</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>None</td>
...
<tr class="even">
<td>Default Path</td>
<td>Images%USERPROFILE%\Pictures\Saved</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>None</td>
...
<td ><p>non utilisé dans Windows Vista. non pris en charge à partir de Windows 7.</p></td>
</tr>
<tr class="even">
...
<tr class="even">
<td>Default Path</td>
<td>%APPDATA%\Microsoft\Internet Explorer\Quick Launch\User épinglé</td>
</tr>
<tr class="odd">
<td>Effet de CSIDL</td>
<td>aucun, valeur introduite dans Windows 7</td>
...
<tr class="odd">
<td>Chemin d’accès par défaut hérité</td>
<td>%USERPROFILE%\My Documents\mes vidéos</td>
</tr>
</tbody>
</table>
...
Les tableaux suivants résument l’utilisation de **KNOWNFOLDERID** dans ces cas.
...
| 64 bits | 64 bits | \_Système FOLDERID | % windir% \\ system32 | \_système CSIDL |
| 64 bits | 64 bits | FOLDERID \_ SystemX86 | % windir% \\ SysWOW64 | CSIDL \_ SYSTEMX86 |
| 64 bits | 32 bit | \_Système FOLDERID | % windir% \\ system32 | \_système CSIDL |
...
| %APPDATA% | C : \\ utilisateurs \\ *nom_utilisateur* \\ AppData \\ itinérance |
| LocalAppData | C : \\ utilisateurs \\ *nom_utilisateur* \\ AppData \\ local |
| %ProgramData% | C : \\ ProgramData |
| %ProgramFiles% | C : \\ Program Files |
| %ProgramFiles(x86)% | C : \\ Program Files (x86) |
| PUBLIQUE | C : \\ utilisateurs \\ publics |
| %SystemDrive% | C : |
| PROFILS | C : \\ utilisateurs \\ *nom_utilisateur* |
| %windir% | C : \\ Windows |
...
|-------------------|-------------------------------------------------------------------------------------------|
| En-tête<br/> | <dl> <dt>Fichier KnownFolders. h</dt> </dl> |
