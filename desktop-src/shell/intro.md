...
le Guide des développeurs de Shell suit les conventions de document du kit de développement logiciel (SDK) Windows habituelles. Deux conventions en particulier doivent être indiquées :
