...
ms.locfileid: "127231239"
---
# <a name="folderitems3verbs-property"></a>FolderItems3. Verbs, propriété

Obtient la liste des verbes communs à tous les éléments de dossier.
...
Adresse d’un pointeur vers la collection de verbes. Consultez [**FolderItemVerbs**](folderitemverbs.md).
