...
1.  pendant l’installation de Windows. la conversion est gérée par le processus d’installation Windows via l’utilitaire MTSTOCOM.
    > [!Note]  
...
2.  après le dernier redémarrage, avant l’affichage de la boîte de dialogue Windows logon. L’étape 2 gère ces actions de conversion qui requièrent l’accès au réseau (principalement la création de membres de rôle).
    > [!Note]  
