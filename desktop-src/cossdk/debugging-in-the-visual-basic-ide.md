...
4.  Dans le menu **projet** , cliquez sur **Propriétés**, puis entrez le programme Démarrer sous l’onglet **débogage** . Le programme de démarrage est l’exécutable client qui appelle ce composant.
