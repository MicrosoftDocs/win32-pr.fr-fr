...
-   Intégration des transactions COM (COMTI). COMTI peut être utilisé pour intégrer des systèmes de macroordinateurs dans des systèmes Windows, y compris des applications COM+. COMTI utilise les protocoles de communication standard (par exemple, LU 6,2) pour la communication entre les ordinateurs de Windows et les ordinateurs centraux et les mini-ordinateurs.
