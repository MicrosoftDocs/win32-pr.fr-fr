...
Les applications qui sont utilisées en interne par COM+ et qui sont installées via le programme d’installation de COM+ ne sont pas répliquées. Ces options en question sont les suivantes :
