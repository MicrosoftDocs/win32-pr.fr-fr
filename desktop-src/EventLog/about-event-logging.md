...
> [!Note]  
> L’API de journalisation des événements a été conçue pour les applications qui s’exécutent sur le système d’exploitation Windows Server 2003, Windows XP ou Windows 2000. Dans Windows Vista, l’infrastructure de journalisation des événements a été repensée. Les applications conçues pour s’exécuter sur les systèmes d’exploitation Windows Vista ou version ultérieure doivent désormais utiliser le [Journal des événements Windows](/windows/desktop/WES/windows-event-log) pour consigner les événements.
...
> [!Note]  
> Les applications qui publient des événements d’une taille supérieure à 64 kilo-octets sur un ordinateur Windows Server 2003, Windows XP ou Windows 2000 ne seront pas en mesure de publier des événements sur un ordinateur Windows Vista ou version ultérieure.
