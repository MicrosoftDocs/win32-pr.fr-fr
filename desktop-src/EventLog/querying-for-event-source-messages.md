...
---
# <a name="querying-for-event-information"></a>Interrogation des informations sur les événements

L’exemple suivant montre comment ouvrir un journal des événements, lire des événements dans le journal, imprimer des informations sur les événements, puis fermer le journal des événements. Cet exemple filtre les événements écrits par l’exemple pour [signaler un événement](reporting-an-event.md).
