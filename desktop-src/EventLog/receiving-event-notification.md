...
ms.locfileid: "118951358"
---
# <a name="receiving-event-notification"></a>Réception des notifications d’événements

L’exemple suivant montre comment utiliser la fonction [**NotifyChangeEventLog**](/windows/desktop/api/Winbase/nf-winbase-notifychangeeventlog) pour recevoir une notification lorsqu’un événement est enregistré. Cet exemple filtre les événements écrits par l’exemple pour [signaler un événement](reporting-an-event.md).
