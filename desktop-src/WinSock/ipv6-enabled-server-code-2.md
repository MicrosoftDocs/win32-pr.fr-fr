...
ms.locfileid: "119132102"
---
# <a name="ipv6-enabled-server-code"></a>Code serveur IPv6-Enabled

Le code suivant est le fichier Server. c agnostique à l’adresse IP, qui est une version IPv6 du fichier simple. c.
