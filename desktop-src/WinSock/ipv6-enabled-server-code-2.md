---
description: Le code suivant est le fichier Server. c agnostique à l’adresse IP, qui est une version IPv6 du fichier simple. c.
ms.assetid: 5e27c731-c9c7-4c49-91bd-6f4dee60460b
title: Code serveur IPv6-Enabled
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104113055"
---
# <a name="ipv6-enabled-server-code"></a><span data-ttu-id="3d8af-103">Code serveur IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="3d8af-103">IPv6-Enabled Server Code</span></span>

<span data-ttu-id="3d8af-104">Le code suivant est le fichier Server. c agnostique à l’adresse IP, qui est une version IPv6 du fichier simple. c.</span><span class="sxs-lookup"><span data-stu-id="3d8af-104">The following code is the IP-agnostic Server.c file, which is an IPv6-enabled version of the Simples.c file.</span></span>
