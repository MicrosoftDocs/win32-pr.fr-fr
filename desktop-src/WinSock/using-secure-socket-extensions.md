...
L’exemple de code suivant illustre l’utilisation des fonctions d’extension de socket sécurisé Winsock.

## <a name="securing-a-socket"></a>Sécurisation d’un socket
...
## <a name="querying-the-security-on-a-socket"></a>Interrogation de la sécurité sur un socket
