---
description: Cette section contient un exemple de code source qui montre comment implémenter les fonctions GetXbyY à l’aide des nouvelles fonctions RNR indépendantes des protocoles.
...
---
# <a name="sample-code-for-a-service-provider"></a><span data-ttu-id="0f300-103">Exemple de code pour un fournisseur de services</span><span class="sxs-lookup"><span data-stu-id="0f300-103">Sample Code for a Service Provider</span></span>

<span data-ttu-id="0f300-104">Cette section contient un exemple de code source qui montre comment implémenter les fonctions **GetXbyY** à l’aide des nouvelles fonctions RNR indépendantes des protocoles.</span><span class="sxs-lookup"><span data-stu-id="0f300-104">This section contains a source code sample that demonstrates how to implement the **GetXbyY** functions using the new, protocol-independent RNR functions.</span></span> <span data-ttu-id="0f300-105">Un développeur doit implémenter ces fonctions comme point de départ.</span><span class="sxs-lookup"><span data-stu-id="0f300-105">A developer should implement these functions as a starting point.</span></span> <span data-ttu-id="0f300-106">Pour se conformer à la spécification de Windows Sockets, de nombreuses fonctions supplémentaires sont nécessaires.</span><span class="sxs-lookup"><span data-stu-id="0f300-106">To comply with the Windows Sockets specification, many more functions are needed.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="0f300-107">La compilation du code suivant n’est pas garantie.</span><span class="sxs-lookup"><span data-stu-id="0f300-107">The following code is not guaranteed to compile.</span></span>
