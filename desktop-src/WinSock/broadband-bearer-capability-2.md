---
description: Cette section répertorie les valeurs utilisées pour la fonctionnalité de support large bande.
ms.assetid: 9e45ca17-2aec-42e5-88a5-5ef1dc4238d9
title: Capacité du porteur large bande
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104526200"
---
# <a name="broadband-bearer-capability"></a><span data-ttu-id="4e716-103">Capacité du porteur large bande</span><span class="sxs-lookup"><span data-stu-id="4e716-103">Broadband Bearer Capability</span></span>

<span data-ttu-id="4e716-104">Cette section répertorie les valeurs utilisées pour la fonctionnalité de support large bande.</span><span class="sxs-lookup"><span data-stu-id="4e716-104">This section lists the values used for the broadband bearer capability.</span></span>
