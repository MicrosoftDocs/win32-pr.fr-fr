...
---
# <a name="broadband-bearer-capability"></a>Capacité du porteur large bande

Cette section répertorie les valeurs utilisées pour la fonctionnalité de support large bande.
