---
description: Le code suivant est le fichier client indépendant IP. c, qui est une version IPv6 du fichier Simplec. c.
...
---
# <a name="ipv6-enabled-client-code"></a><span data-ttu-id="80ba4-103">Code client IPv6-Enabled</span><span class="sxs-lookup"><span data-stu-id="80ba4-103">IPv6-Enabled Client Code</span></span>

<span data-ttu-id="80ba4-104">Le code suivant est le fichier client indépendant IP. c, qui est une version IPv6 du fichier Simplec. c.</span><span class="sxs-lookup"><span data-stu-id="80ba4-104">The following code is the IP agnostic Client.c file, which is an IPv6-enabled version of the Simplec.c file.</span></span>
