---
description: Cette section répertorie la définition de type pour les informations de couche inférieure à haut débit.
ms.assetid: b987dd6b-a611-4297-abaa-fd080cc94f6f
title: Informations sur la couche inférieure haut débit
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103751477"
---
# <a name="broadband-lower-layer-information"></a><span data-ttu-id="6dc0b-103">Informations sur la couche inférieure haut débit</span><span class="sxs-lookup"><span data-stu-id="6dc0b-103">Broadband Lower Layer Information</span></span>

<span data-ttu-id="6dc0b-104">Cette section répertorie la définition de type pour les informations de couche inférieure à haut débit.</span><span class="sxs-lookup"><span data-stu-id="6dc0b-104">This section lists the type definition for the broadband lower-layer information.</span></span>
