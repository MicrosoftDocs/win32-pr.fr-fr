---
description: Exemple de programmation de multidiffusion
ms.assetid: 87a6d3bb-3827-4a84-ba2d-c7bd2dd73eb2
title: Exemple de programmation de multidiffusion
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106545786"
---
# <a name="multicast-programming-sample"></a><span data-ttu-id="df89e-103">Exemple de programmation de multidiffusion</span><span class="sxs-lookup"><span data-stu-id="df89e-103">Multicast Programming Sample</span></span>

<span data-ttu-id="df89e-104">L’exemple de code suivant montre comment inclure des fonctionnalités de multidiffusion à une application Windows Sockets à l’aide des options de Socket.</span><span class="sxs-lookup"><span data-stu-id="df89e-104">The following sample code illustrates how to include multicast functionality to a Windows Sockets application using socket options.</span></span>
