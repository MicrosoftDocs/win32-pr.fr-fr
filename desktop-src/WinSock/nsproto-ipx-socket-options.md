...
</dt> </dl> </dd> <dt><span id="Windows_Support_for_NSPROTO_IPX_options"></span><span id="windows_support_for_nsproto_ipx_options"></span><span id="WINDOWS_SUPPORT_FOR_NSPROTO_IPX_OPTIONS"></span>**Prise en charge Windows pour les \_ options IPX NSPROTO**</dt> <dd> <dl> <dt> 
...
Les options de socket **NSPROTO \_ SPX** suivantes ont été définies dans Windows sockets 2 Protocol-Specific annexe, mais ne sont pas implémentées sur Windows par le protocole IPX/SPX Windows.
