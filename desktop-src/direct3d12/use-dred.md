...
ORDINATEUR 1,0 a été disponible pour la première fois dans Windows 10, version 1809 (mise à jour de Windows 10 octobre 2018) et il a exposé des plans de navigation automatiques rudimentaires. Toutefois, il n’y avait pas d’API pour celle-ci, et la seule façon d’activer ordinateur 1,0 consistait à utiliser le **Hub de commentaires** pour capturer une reproduction TDR (repro) pour les **applications &** les \> **performances et la compatibilité du jeu** de jeux. L’objectif principal de ordinateur 1,0 était d’aider à analyser les défaillances de jeu à l’aide des commentaires des clients.
