...
description: Classe d’assistance pour la création d’un état de signature racine locale suboject.
keywords:
- Classe CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT
topic_type:
- apiref
api_name:
...
ms.locfileid: "121813065"
---
# <a name="cd3dx12_local_root_signature_subobject-class"></a>Classe CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT

Classe d’assistance pour la création d’un état de signature racine locale suboject.
...
Constructeur par défaut. Crée une nouvelle instance, initialisée par défaut, d’un **CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT**.

`CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT(CD3DX12_STATE_OBJECT_DESC&)`

Constructeur qui crée une nouvelle instance d’un **CD3DX12_LOCAL_ROOT_SIGNATURE_SUBOBJECT** initialisé avec le contenu d’un objet [**CD3DX12_STATE_OBJECT_DESC**](cd3dx12-state-object-desc.md) .
...
Récupère le type du sous-objet, représenté par la constante [D3D12_STATE_SUBOBJECT_TYPE_LOCAL_ROOT_SIGNATURE](/windows/win32/api/d3d12/ne-d3d12-d3d12_state_subobject_type) .
