...
| [Comprendre Direct3D 12](directx-12-getting-started.md) | Pour écrire des jeux et des applications en 3D pour Windows 10 et Windows 10 mobile, vous devez comprendre les principes fondamentaux de la technologie Direct3D 12 et comment vous préparer à l’utiliser dans vos jeux et vos applications. |
