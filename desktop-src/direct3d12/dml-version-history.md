...
|-|-|-|-|-|
|1.6.0|DML_FEATURE_LEVEL_4_0|`0x4000`|NON APPLICABLE|[DirectML-1.6.0](https://www.nuget.org/packages/Microsoft.AI.DirectML/1.6.0)|
|1.5.0|DML_FEATURE_LEVEL_3_1|`0x3100`|NON APPLICABLE|[DirectML-1.5.0](https://www.nuget.org/packages/Microsoft.AI.DirectML/1.5.0)|
|1.4.0<sup>1</sup>|DML_FEATURE_LEVEL_3_0|`0x3000`|NON APPLICABLE|[DirectML-1.4.0](https://www.nuget.org/packages/Microsoft.AI.DirectML/1.4.0)|
|1.1.0|DML_FEATURE_LEVEL_2_0|`0x2000`|Windows 10, version 2004 (10,0 ; Build 19041) (Windows 10 mai 2020 mise à jour). Alias « 20H1 ».|NON APPLICABLE|
|1.0.0|DML_FEATURE_LEVEL_1_0|`0x1000`|Windows 10, version 1903 (10,0 ; Build 18362) (Mise à jour de mai 2019 de Windows 10). Alias « 19H1 ».|NON APPLICABLE|
...
|-|-|
|`0x4000`|Toutes les fonctionnalités qui requièrent une version de DirectML plus récente que **1.6.0** sont exclues de `DirectML.h` .|
...
* Dans le cas contraire, la version cible est sélectionnée en fonction de la valeur de la `NTDDI_VERSION` macro.
  *  `NTDDI_WIN10_CO` produit une version cible de `0x4000` .
  *  `NTDDI_WIN10_FE` produit une version cible de `0x3000` .
