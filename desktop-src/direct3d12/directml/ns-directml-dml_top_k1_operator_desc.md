...
* *OutputIndexTensor* et *OutputValueTensor* doivent avoir la même *taille*.
...
| ------ | ---- | ---------- | -------------------------- | -------------------- |
| InputTensor | Entrée | { In0, In1, In2, In3 } | 4 | FLOAT32, FLOAT16, INT32, INT16, INT8, UINT32, UINT16, UINT8 |
