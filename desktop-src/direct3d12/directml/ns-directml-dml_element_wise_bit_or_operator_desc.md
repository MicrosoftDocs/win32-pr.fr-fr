...
---
# <a name="dml_element_wise_bit_or_operator_desc-structure-directmlh"></a>Structure DML_ELEMENT_WISE_BIT_OR_OPERATOR_DESC (directml. h)

Calcule l’opération de bits or entre chaque élément correspondant des dizaines d’entrée et écrit le résultat dans le tenseur de sortie.
