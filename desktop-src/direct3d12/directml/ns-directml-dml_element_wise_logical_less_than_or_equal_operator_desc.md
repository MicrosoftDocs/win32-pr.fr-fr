...
---
# <a name="dml_element_wise_logical_less_than_or_equal_operator_desc-structure-directmlh"></a>Structure DML_ELEMENT_WISE_LOGICAL_LESS_THAN_OR_EQUAL_OPERATOR_DESC (directml. h)

Effectue une logique *inférieur ou égal à* sur chaque paire d’éléments correspondants des dizaines d’entrée, en plaçant le résultat (1 pour true, 0 pour false) dans l’élément correspondant de *OutputTensor*.
