...
---
# <a name="dml_element_wise_bit_not_operator_desc-structure-directmlh"></a>Structure DML_ELEMENT_WISE_BIT_NOT_OPERATOR_DESC (directml. h)

Calcule l’opération NOT au niveau du bit pour chaque élément du tenseur d’entrée, puis écrit le résultat dans le tenseur de sortie.
