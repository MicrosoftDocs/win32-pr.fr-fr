...
---
# <a name="dml_element_wise_bit_shift_right_operator_desc-structure-directmlh"></a>Structure DML_ELEMENT_WISE_BIT_SHIFT_RIGHT_OPERATOR_DESC (directml. h)

Effectue un décalage logique vers la droite de chaque élément de *ATensor* par un nombre de bits donné par l’élément correspondant de *BTensor*, en plaçant le résultat dans l’élément correspondant de *OutputTensor*.
