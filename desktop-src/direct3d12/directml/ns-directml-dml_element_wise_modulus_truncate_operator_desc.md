...
---
# <a name="dml_element_wise_modulus_truncate_operator_desc-structure-directmlh"></a>Structure DML_ELEMENT_WISE_MODULUS_TRUNCATE_OPERATOR_DESC (directml. h)

Calcule l’opérateur de modulo C pour chaque paire d’éléments correspondants des dizaines d’entrée, en plaçant le résultat dans l’élément correspondant de *OutputTensor*.

Étant donné que le quotient est arrondi vers 0, le résultat aura le même signe que le dividende.
