...
---
# <a name="tapirequestmediacall"></a>tapiRequestMediaCall

La fonction **tapiRequestMediaCall** n’a jamais été implémentée dans une version TAPI. Cette fonction est obsolète et ne doit pas être utilisée.

## <a name="related-topics"></a>Rubriques connexes

<dl> <dt>

[Vue d’ensemble de la référence TAPI 2,2](tapi-2-2-reference.md)
</dt> </dl>
