...
| [**recevoir \_ Flux**](itparticipant-get-streams.md)                           | Crée une collection de flux associés au participant actuel. Fourni pour les applications clientes Automation, telles que celles écrites en Visual Basic.<br/> |
