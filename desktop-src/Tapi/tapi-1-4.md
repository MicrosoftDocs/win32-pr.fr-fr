...
TAPI 1,4 a ajouté plusieurs API, messages, constantes et éléments de structure à la spécification 1,3. TAPI 1,4 prend en charge uniquement les TSPs 16 bits. Toutefois, il permet de développer des applications 32 bits sans avoir à se préoccuper des limitations des Windows 16 bits.
