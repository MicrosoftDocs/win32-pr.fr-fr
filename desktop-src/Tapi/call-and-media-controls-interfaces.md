...
---
# <a name="call-and-media-controls-interfaces"></a>Interfaces d’appel et de contrôles multimédias

Voici les interfaces TAPI 3. x et les interfaces de contrôles multimédias. Pour obtenir la liste de ces interfaces par fonctionnalité, consultez la page de [référence rapide sur les contrôles Call et Media](call-and-media-controls-quick-reference.md).
...
Les interfaces suivantes sont disponibles si un MSP est associé à l’appel. Les interfaces MSP contrôlent la diffusion multimédia en continu et les terminaux pour l’appel.
