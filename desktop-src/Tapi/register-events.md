...
ms.locfileid: "117761176"
---
# <a name="register-events"></a>Inscrire des événements

Les exemples de code suivants illustrent l’implémentation d’un gestionnaire d’événements simple, l’inscription de l’interface d’événement TAPI principale, la définition du filtre d’événements et l’inscription pour les notifications d’appel.

Le gestionnaire d’événements présenté est un exemple plutôt qu’une exigence. L’objectif principal est de s’assurer que le thread qui reçoit les événements effectue un traitement minimal avant de passer le travail à un autre thread. Cela empêche le gestionnaire d’événements de devenir un problème de performances en cas de charge élevée des événements.
