...
| [**Définissez**](/windows/desktop/api/tapi3if/nf-tapi3if-itasrterminalevent-get_error)         | Définit la valeur d’une [propriété de périphérique audio](audiodeviceproperty.md)donnée.<br/>                  |
