...
Ce document décrit la conception et l’utilisation des classes de base MSP. L’utilisation de ces classes n’est pas obligatoire, mais la plupart des développeurs trouvent qu’ils simplifient la création d’un MSP basé sur DirectShow pour le nouveau MSPI de l’interface TAPI 3.
...
ATL 2,1 est requis pour Windows 2000. À compter de Windows XP, ATL 2,1 et 3,0 se compilent à la fois.
