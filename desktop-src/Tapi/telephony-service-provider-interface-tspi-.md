...
-   Les [appareils téléphoniques](/previous-versions/windows/desktop/legacy/ms725257(v=vs.85)) couvrent les informations supplémentaires et les opérations exposées si un TSP gère le contrôle de l’ensemble de téléphones. Ces opérations sont facultatives.
