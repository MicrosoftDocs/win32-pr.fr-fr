...
---
# <a name="phone-and-address-device-specific-events"></a><span data-ttu-id="0b39d-104">Événements spécifiques au téléphone et à l’appareil</span><span class="sxs-lookup"><span data-stu-id="0b39d-104">Phone and Address Device-specific Events</span></span>

<span data-ttu-id="0b39d-105">L’exemple de code suivant illustre un gestionnaire d’événements pour les événements d’adresse et d’appareil téléphonique.</span><span class="sxs-lookup"><span data-stu-id="0b39d-105">The following code example illustrates an event handler for address and phone device events.</span></span> <span data-ttu-id="0b39d-106">Le code pour chaque événement montre comment créer l’interface d’événement et comment récupérer les données d’événement.</span><span class="sxs-lookup"><span data-stu-id="0b39d-106">The code for each event shows how to create the event interface and how to retrieve the event data.</span></span>
