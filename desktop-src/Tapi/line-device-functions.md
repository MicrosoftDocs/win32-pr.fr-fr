---
description: L’interface TAPI prend en charge les fonctions de périphérique en ligne pour configurer des périphériques de ligne et exécuter des fonctions de téléphonie, telles que la conservation et la transmission.
ms.assetid: 74e6300f-0d72-4b0f-8b95-fc1c8d0d0293
title: Fonctions du périphérique de ligne
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127217769"
---
# <a name="line-device-functions"></a>Fonctions du périphérique de ligne

L’interface TAPI prend en charge les fonctions de périphérique en ligne suivantes :
...
Pour obtenir une catégorisation des fonctions TAPI par niveau de service et tâche, consultez Référence des fonctions [rapides TAPI](tapi-quick-function-reference.md).
