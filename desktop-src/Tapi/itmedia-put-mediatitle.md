...
| <dl> <dt>**\_pointeur E**</dt> </dl>     | Le paramètre *pMediaTitle* n’est pas un pointeur valide.<br/>  |
| <dl> <dt>**E \_ INVALIDARG**</dt> </dl>  | Le paramètre *pMediaTitle* n’est pas valide.<br/>            |
...
[**ITMedia :: obtient \_ MediaTitle**](itmedia-get-mediatitle.md)
</dt> </dl>
