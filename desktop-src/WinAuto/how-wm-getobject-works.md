...
Microsoft Active Accessibility envoie le message [**WM \_ GETOBJECT**](wm-getobject.md) à l’application serveur appropriée lorsqu’un client appelle l’une des fonctions **AccessibleObjectFrom * * * X* . La liste suivante décrit les différents scénarios qui se produisent :
