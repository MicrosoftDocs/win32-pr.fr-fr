...
---
# <a name="enabling-a-built-in-accessibility-feature"></a><span data-ttu-id="21dc7-103">Activation d’une fonctionnalité d’accessibilité intégrée</span><span class="sxs-lookup"><span data-stu-id="21dc7-103">Enabling a Built-in Accessibility Feature</span></span>

<span data-ttu-id="21dc7-104">Le fragment de code suivant utilise la fonction [**SystemParametersInfo**](/windows/desktop/api/winuser/nf-winuser-systemparametersinfoa) pour activer la fonctionnalité Touches filtres :</span><span class="sxs-lookup"><span data-stu-id="21dc7-104">The following code fragment uses the [**SystemParametersInfo**](/windows/desktop/api/winuser/nf-winuser-systemparametersinfoa) function to enable the FilterKeys feature:</span></span>
