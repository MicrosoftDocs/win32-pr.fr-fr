...
| --- | --- | --- |
| Objets incorporés non-TextPattern | Dans Microsoft Edge<br>Table de données dans Microsoft Edge | Dans RichTextBlock dans l’infrastructure XAML de Microsoft<br>Images avec texte alt dans Microsoft Edge<br>ListView avec ListItems dans RichTextBlock dans l’infrastructure XAML de Microsoft |
