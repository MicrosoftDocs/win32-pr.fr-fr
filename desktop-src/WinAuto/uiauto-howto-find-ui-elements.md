...
ms.locfileid: "127010510"
---
# <a name="how-to-find-ui-elements"></a>Comment rechercher des éléments d’interface utilisateur

Cette rubrique contient un exemple de code qui montre comment rechercher des éléments d’interface utilisateur dans l’arborescence UI Automation.

-   [Recherche d’un élément par nom](#finding-an-element-by-name)
-   [Rechercher des éléments associés](#finding-related-elements)
-   [Rubriques connexes](#related-topics)

## <a name="finding-an-element-by-name"></a>Recherche d’un élément par nom

L’exemple suivant recherche l’élément Microsoft UI Automation qui porte le nom spécifié et est un enfant de la fenêtre du bureau.
...
## <a name="finding-related-elements"></a>Rechercher des éléments associés

L’exemple de fonction suivant retourne une collection de tous les boutons activés qui sont des enfants de l’élément spécifié.
