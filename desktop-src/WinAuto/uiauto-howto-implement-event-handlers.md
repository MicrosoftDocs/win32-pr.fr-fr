...
ms.locfileid: "127010509"
---
# <a name="how-to-implement-event-handlers"></a>Comment implémenter des gestionnaires d’événements

Cette rubrique contient un exemple de code qui montre comment implémenter des interfaces qui permettent aux clients de recevoir et de gérer des événements Microsoft UI Automation. Il aborde les sujets suivants :

-   [Gestion des événements d’Automation d’interface utilisateur généraux](#handling-general-ui-automation-events)
-   [Gestion des événements de Focus-Changed](#handling-focus-changed-events)
-   [Gestion des événements de Property-Changed](#handling-property-changed-events)
-   [Gestion des événements de Structure-Changed](#handling-structure-changed-events)
