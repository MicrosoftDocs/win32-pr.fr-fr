...
---
# <a name="verification-log-messages"></a>Messages du journal de vérification

Cette section décrit les messages du journal de vérification pour l’outil de vérification de l’accessibilité de l’interface utilisateur (AccChecker).
...
-   [Erreur de table de données ARIA](aria-table-name-and-header.md)
-   [Avertissement de la table de données ARIA](aria-data-table-description.md)
-   [Erreur de structure de grille ARIA](aria-grid-structure.md)
-   [Erreur d’étiquette ARIA](aria-label.md)
-   [Erreur de table de présentation ARIA](aria-layout-table.md)
...
-   [Erreur de rôle ARIA pour les éléments avec gestionnaires d’événements](aria-role-missing.md)
-   [Erreur de la TabIndex ARIA](aria-click-tabindex.md)
...
-   [Les éléments DragPattern/DragDropPattern requièrent un nom](dragpattern-dragdroppattern-elements-requires-name-.md)
-   [Les éléments DragPattern/DragDropPattern requièrent un DropEffect valide](dragpattern-dragdroppattern-elements-requires-valid-dropeffect.md)
