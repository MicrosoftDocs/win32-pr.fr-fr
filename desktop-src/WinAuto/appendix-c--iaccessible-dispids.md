...
ms.locfileid: "104196810"
---
# <a name="appendix-c-iaccessible-dispids"></a><span data-ttu-id="8c270-103">Annexe C : DISPID de IAccessible</span><span class="sxs-lookup"><span data-stu-id="8c270-103">Appendix C: IAccessible DISPIDs</span></span>

<span data-ttu-id="8c270-104">Un DISPID permet à l’implémentation de [**IDispatch**](idispatch-interface.md) de rechercher les différentes méthodes et propriétés d’une interface double.</span><span class="sxs-lookup"><span data-stu-id="8c270-104">A DISPID allows the implementation of the [**IDispatch**](idispatch-interface.md) to look up the various methods and properties of a dual interface.</span></span>
