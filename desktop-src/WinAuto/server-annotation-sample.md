---
title: Exemple d’annotation de serveur
description: Exemple d’annotation de serveur
...
ms.locfileid: "106511004"
---
# <a name="server-annotation-sample"></a><span data-ttu-id="1e7ac-103">Exemple d’annotation de serveur</span><span class="sxs-lookup"><span data-stu-id="1e7ac-103">Server Annotation Sample</span></span>

<span data-ttu-id="1e7ac-104">Voici un exemple d’annotation de serveur.</span><span class="sxs-lookup"><span data-stu-id="1e7ac-104">The following is an example of server annotation.</span></span> <span data-ttu-id="1e7ac-105">Suivez les instructions des commentaires marqués avec/ \* TODO \* /.</span><span class="sxs-lookup"><span data-stu-id="1e7ac-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
