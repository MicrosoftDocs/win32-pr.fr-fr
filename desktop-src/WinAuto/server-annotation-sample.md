...
---
# <a name="server-annotation-sample"></a>Exemple d’annotation de serveur

Voici un exemple d’annotation de serveur. Suivez les instructions des commentaires marqués avec/ \* TODO \* /.
