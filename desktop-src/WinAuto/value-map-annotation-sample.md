---
title: Exemple d’annotation Map value
description: Exemple d’annotation Map value
...
ms.locfileid: "106511007"
---
# <a name="value-map-annotation-sample"></a><span data-ttu-id="607b1-103">Exemple d’annotation Map value</span><span class="sxs-lookup"><span data-stu-id="607b1-103">Value Map Annotation Sample</span></span>

<span data-ttu-id="607b1-104">Coupez, collez et modifiez l’exemple de code suivant pour votre propre usage.</span><span class="sxs-lookup"><span data-stu-id="607b1-104">Cut, paste, and modify the following code sample for your own use.</span></span> <span data-ttu-id="607b1-105">Suivez les instructions des commentaires marqués avec/ \* TODO \* /.</span><span class="sxs-lookup"><span data-stu-id="607b1-105">Follow instructions in comments marked with /\* TODO \*/.</span></span>
