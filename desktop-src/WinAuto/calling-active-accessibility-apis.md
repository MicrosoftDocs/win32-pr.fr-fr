...
les ordinateurs qui exécutent Windows 95 ou Microsoft Windows NT 4,0 n’ont pas Oleacc.dll et la version appropriée de user32.dll installée, car Microsoft Active Accessibility a été intégré à des versions ultérieures de Windows. Par conséquent, les applications qui s’exécutent sur ces plateformes sont explicitement liées à Oleacc.dll au moment de l’exécution à l’aide de la fonction [**LoadLibrary**](/windows/desktop/api/libloaderapi/nf-libloaderapi-loadlibrarya) au lieu de s’appuyer sur les bibliothèques d’importation. Active Accessibility 1,3 prend en charge Windows 95 et Microsoft Windows NT 4,0. les versions antérieures de Windows ne sont pas prises en charge par Microsoft Active Accessibility.
