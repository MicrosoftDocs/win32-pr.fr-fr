---
title: Structures déconseillées
description: Notez que les structures décrites dans cette section sont utilisées avec les fonctions de nœud UI Automation, qui ont été dépréciées.
...
ms.locfileid: "103839498"
---
# <a name="deprecated-structures"></a>Structures déconseillées

> [!Note]  
> Les structures décrites dans cette section sont utilisées avec les fonctions de nœud UI Automation, qui ont été dépréciées. Les applications clientes doivent utiliser les interfaces COM (Component Object Model) et les structures associées décrites dans les sections suivantes :
>
...
> -   [Structures UI Automation](uiauto-entry-structures.md)
