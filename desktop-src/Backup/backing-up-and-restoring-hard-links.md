...
## <a name="pseudocode-algorithm-for-restoring-hard-links"></a><span data-ttu-id="c4784-107">Algorithme de pseudocode pour la restauration des liens physiques</span><span class="sxs-lookup"><span data-stu-id="c4784-107">Pseudocode Algorithm for Restoring Hard Links</span></span>
...
<span data-ttu-id="c4784-108">**Windows Server 2003 et Windows XP :** Les fonctions [**FindFirstFileNameW**](/windows/desktop/api/fileapi/nf-fileapi-findfirstfilenamew) et [**FindNextFileNameW**](/windows/desktop/api/fileapi/nf-fileapi-findnextfilenamew) ne sont pas prises en charge.</span><span class="sxs-lookup"><span data-stu-id="c4784-108">**Windows Server 2003 and Windows XP:** The [**FindFirstFileNameW**](/windows/desktop/api/fileapi/nf-fileapi-findfirstfilenamew) and [**FindNextFileNameW**](/windows/desktop/api/fileapi/nf-fileapi-findnextfilenamew) functions are not supported.</span></span> <span data-ttu-id="c4784-109">Vous pouvez utiliser à la place la procédure décrite dans l’exemple de pseudo-code suivant.</span><span class="sxs-lookup"><span data-stu-id="c4784-109">You can instead use the procedure outlined in the following pseudocode example.</span></span>

## <a name="alternate-pseudocode-algorithm-for-backing-up-hard-links"></a><span data-ttu-id="c4784-110">Autre algorithme de pseudo-code pour la sauvegarde des liens physiques</span><span class="sxs-lookup"><span data-stu-id="c4784-110">Alternate Pseudocode Algorithm for Backing Up Hard Links</span></span>
