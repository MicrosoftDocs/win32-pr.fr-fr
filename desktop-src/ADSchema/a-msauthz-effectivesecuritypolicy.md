...
Pour une règle d’accès centralisée, cet attribut définit l’autorisation qui s’applique aux ressources cibles sur la règle d’accès central.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | MS-auth-efficace-sécurité-stratégie          |
...
| Classes utilisées dans        | [**MS-auth-central-Access-Rule**](c-msauthz-centralaccessrule.md)<br/> |
