...
---
# <a name="msmq-in-routing-servers-attribute"></a>Attribut MSMQ-in-Routing-Servers

Les liens DN vers les serveurs de routage MSMQ par le biais desquels tout le trafic entrant vers cet ordinateur doit être routé.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | MSMQ-in-Routing-serveurs                 |
...
| Classes utilisées dans        | [**Configuration MSMQ**](c-msmqconfiguration.md)<br/> |
