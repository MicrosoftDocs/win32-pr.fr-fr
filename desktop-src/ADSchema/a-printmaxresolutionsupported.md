...
ms.locfileid: "120065677"
---
# <a name="print-max-resolution-supported-attribute"></a>Attribut Print-Max-Resolution-pris en charge

Résolution maximale de l’imprimante.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Print-Max-Resolution-pris en charge       |
