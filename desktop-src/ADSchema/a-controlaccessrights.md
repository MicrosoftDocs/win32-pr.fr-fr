...
Utilisé par la sécurité DS pour déterminer quels utilisateurs peuvent effectuer des opérations spécifiques sur l’objet hôte.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Droits de contrôle-accès                                 |
...
| Classes utilisées dans        | [**Groupe**](c-group.md)<br/> [**Sam-domaine**](c-samdomain.md)<br/> [**Utilisateur**](c-user.md)<br/> |
