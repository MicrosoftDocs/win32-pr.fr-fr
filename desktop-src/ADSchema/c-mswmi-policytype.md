...
ms.locfileid: "118422210"
---
# <a name="ms-wmi-policytype-class"></a>classe ms-WMI-PolicyType

Communiquer le schéma pour les objets de stratégie.
...
| [**MS-WMI-auteur**](a-mswmi-author.md)                                     | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-modifier**](a-mswmi-changedate.md)                             | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-CreationDate**](a-mswmi-creationdate.md)                         | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-ID**](a-mswmi-id.md)                                             | Vrai      | **MS-WMI-PolicyType**           |
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-parm1**](a-mswmi-parm1.md)                                       | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-SourceOrganization**](a-mswmi-sourceorganization.md)             | Faux     | **MS-WMI-PolicyType**           |
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Vrai      | **MS-WMI-PolicyType**           |
