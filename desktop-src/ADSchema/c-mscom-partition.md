...
ms.locfileid: "119643189"
---
# <a name="ms-com-partition-class"></a>classe ms-COM-partition

Espace de noms utilisé par COM+ pour autoriser plusieurs versions de la même application COM+ à exister sur le même ordinateur physique.
...
| [**MS-COM-ObjectId**](a-mscom-objectid.md)                                 | Faux     | **Partition MS-COM**            |
