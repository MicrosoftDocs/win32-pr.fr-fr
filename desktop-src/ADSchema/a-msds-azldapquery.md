...
Chaîne qui définit la requête LDAP (longueur maximale 4096) qui détermine l’appartenance d’un objet utilisateur au groupe.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | ms-DS-AZ-LDAP-requête                         |
| LDAP-Display-Name | msDS-AzLDAPQuery                            |
| Taille              | 4096 caractères                             |
