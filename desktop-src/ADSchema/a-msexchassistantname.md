...
ms.locfileid: "119763139"
---
# <a name="ms-exch-assistant-name-attribute"></a>ms-Exch-Assistant-Name (attribut)

Contient le nom de l’Assistant d’un compte.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | ms-Exch-Assistant-nom                      |
...
| Classes utilisées dans        | [**E-mail-destinataire**](c-mailrecipient.md)<br/> |
