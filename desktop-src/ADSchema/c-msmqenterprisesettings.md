...
---
# <a name="msmq-enterprise-settings-class"></a>MSMQ-Enterprise-classe de paramètres

Objet avec des informations MSMQ générales. Il est placé sous \\ services de configuration \\ . Il ne peut y avoir qu’un seul d’entre eux dans une forêt. Cet objet contient des informations sur la configuration de l’Organisation pour Message Queuing.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MSMQ-Enterprise-paramètres             |
...
| [**Nom de fournisseur de services de chiffrement**](a-msmqcspname.md)                                    | Faux     | **MSMQ-Enterprise-paramètres**    |
| [**Interval1 MSMQ**](a-msmqinterval1.md)                                 | Faux     | **MSMQ-Enterprise-paramètres**    |
| [**Interval2 MSMQ**](a-msmqinterval2.md)                                 | Faux     | **MSMQ-Enterprise-paramètres**    |
| [**MSMQ-durée de vie longue**](a-msmqlonglived.md)                                | Faux     | **MSMQ-Enterprise-paramètres**    |
| [**Nom-MSMQ-style**](a-msmqnamestyle.md)                                | Faux     | **MSMQ-Enterprise-paramètres**    |
| [**Version MSMQ**](a-msmqversion.md)                                     | Faux     | **MSMQ-Enterprise-paramètres**    |
