...
ms.locfileid: "118959858"
---
# <a name="ms-dfsr-topology-class"></a>MS-DFSR-Topology (classe)

Contient les objets qui forment la topologie de réplication.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-topologie                     |
| LDAP-Display-Name | msDFSR-topologie                      |
...
| Supérieurs possibles          | [**MS-DFSR-le groupe**](c-msdfsr-replicationgroup.md)                                                                    |
| Classes auxiliaires           | \-                                                                                                                               |
...
| [**MS-DFSR-extension**](a-msdfsr-extension.md)                             | Faux     | **MS-DFSR-topologie**            |
| [**MS-DFSR-indicateurs**](a-msdfsr-flags.md)                                     | Faux     | **MS-DFSR-topologie**            |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                 | Faux     | **MS-DFSR-topologie**            |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                    | Faux     | **MS-DFSR-topologie**            |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Faux     | **MS-DFSR-topologie**            |
| [**ms-DS-approx-immed-subordonnés**](a-msds-approx-immed-subordinates.md)    | Faux     | [**Retour au début**](c-top.md)<br/> |
...
La classe **MS-DFSR-Topology** fait partie de la prise en charge du service de réplication système de fichiers DFS (DFS).
