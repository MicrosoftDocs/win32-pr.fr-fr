...
ms.locfileid: "118422200"
---
# <a name="ms-wmi-realrangeparam-class"></a>classe ms-WMI-RealRangeParam

Objet de paramètre de plage de nombres réels.
...
| [**MS-WMI-int8Default**](a-mswmi-int8default.md)                           | Vrai      | **MS-WMI-RealRangeParam**                                  |
| [**MS-WMI-int8Max**](a-mswmi-int8max.md)                                   | Faux     | **MS-WMI-RealRangeParam**                                  |
| [**MS-WMI-int8Min**](a-mswmi-int8min.md)                                   | Faux     | **MS-WMI-RealRangeParam**                                  |
