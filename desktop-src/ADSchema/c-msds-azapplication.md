...
ms.locfileid: "119880389"
---
# <a name="ms-ds-az-application-class"></a>classe ms-DS-AZ-application

Définit une instance installée d’une application liée à un magasin de stratégies particulier.
...
| Supérieurs possibles          | [**ms-DS-AZ-admin-Manager**](c-msds-azadminmanager.md)                                                                          |
| Classes auxiliaires           | \-                                                                                                                               |
...
| [**Description**](a-description.md)                                        | Faux     | **ms-DS-AZ-application en** [ **haut**](c-top.md)<br/> |
...
| [**ms-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)               | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-application-name**](a-msds-azapplicationname.md)               | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-application-version**](a-msds-azapplicationversion.md)         | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-Class-ID**](a-msds-azclassid.md)                               | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-Generate-audites**](a-msds-azgenerateaudits.md)                 | Faux     | **ms-DS-AZ-application**                                 |
...
| [**ms-DS-AZ-Class-ID**](a-msds-azclassid.md)                                  | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-Generate-audites**](a-msds-azgenerateaudits.md)                    | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-Generic-Data**](a-msds-azgenericdata.md)                          | Faux     | **ms-DS-AZ-application**                                 |
| [**ms-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                            | Faux     | **ms-DS-AZ-application**                                 |
| [**MS-DS-Consistency-enfant-nombre**](a-ms-ds-consistencychildcount.md)         | Faux     | [**Retour au début**](c-top.md)<br/>                          |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Faux     | [**Retour au début**](c-top.md)<br/>                          |
