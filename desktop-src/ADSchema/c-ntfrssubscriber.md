...
ms.locfileid: "118959738"
---
# <a name="ntfrs-subscriber-class"></a>Classe NTFRS-Subscriber

Identifie un abonné à un jeu de réplicas.
...
| Supérieurs possibles          | [**NTFRS-abonnements**](c-ntfrssubscriptions.md)                                                                              |
| Classes auxiliaires           | \-                                                                                                                               |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                                                     |
| Descripteur de sécurité par défaut | D : (A ;; RPLCLORC;;; AU) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; PROPRIÉTAIRE |
...
| [**Extensions FRS**](a-frsextensions.md)                                 | Faux     | **NTFRS-abonné**            |
| [**FRS-erreur-condition**](a-frsfaultcondition.md)                        | Faux     | **NTFRS-abonné**            |
| [**Indicateurs FRS**](a-frsflags.md)                                           | Faux     | **NTFRS-abonné**            |
| [**Référence de membre FRS**](a-frsmemberreference.md)                      | Faux     | **NTFRS-abonné**            |
| [**FRS-Member-Reference-BL**](a-frsmemberreferencebl.md)                 | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**FRS-root-Path**](a-frsrootpath.md)                                    | Vrai      | **NTFRS-abonné**            |
| [**FRS-Service-Command**](a-frsservicecommand.md)                        | Faux     | **NTFRS-abonné**            |
| [**FRS-Service-Command-Status**](a-frsservicecommandstatus.md)           | Faux     | **NTFRS-abonné**            |
| [**Staging-Staging-chemin**](a-frsstagingpath.md)                              | Vrai      | **NTFRS-abonné**            |
| [**FRS-heure-dernière commande**](a-frstimelastcommand.md)                     | Faux     | **NTFRS-abonné**            |
| [**FRS-heure-dernière-config-modification**](a-frstimelastconfigchange.md)          | Faux     | **NTFRS-abonné**            |
| [**FRS-Update-Timeout**](a-frsupdatetimeout.md)                          | Faux     | **NTFRS-abonné**            |
...
| [**Planifier**](a-schedule.md)                                            | Faux     | **NTFRS-abonné**            |
