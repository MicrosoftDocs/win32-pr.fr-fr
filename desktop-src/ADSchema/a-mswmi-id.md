...
---
# <a name="ms-wmi-id-attribute"></a>attribut ms-WMI-ID

ID unique d’une instance d’objet. Index dans le catalogue global.
...
| Classes utilisées dans        | [**MS-WMI-ObjectEncoding**](c-mswmi-objectencoding.md)<br/> [**MS-WMI-modèle policytemplate**](c-mswmi-policytemplate.md)<br/> [**MS-WMI-PolicyType**](c-mswmi-policytype.md)<br/> [**MS-WMI-som**](c-mswmi-som.md)<br/> |
