...
GUID de la classe de service.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | ID de classe de service                                      |
...
| Classes utilisées dans        | [**Classe de service**](c-serviceclass.md)<br/> [**Instance de service**](c-serviceinstance.md)<br/> |
