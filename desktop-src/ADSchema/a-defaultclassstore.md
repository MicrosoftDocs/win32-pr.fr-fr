...
ms.locfileid: "119509169"
---
# <a name="default-class-store-attribute"></a>Default-Class-Store (attribut)

Magasin de classes par défaut pour un utilisateur donné.
...
| Classes utilisées dans        | [**Conteneur**](c-container.md)<br/> [**Utilisateur**](c-user.md)<br/> |
