...
---
# <a name="poss-superiors-attribute"></a>Attribut Poss-Superiors

Liste des objets qui peuvent contenir cette classe.
...
| Fréquence des mises à jour  | Lorsque la classe est définie.                                      |
