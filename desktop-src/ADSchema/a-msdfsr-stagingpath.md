---
title: attribut ms-DFSR-StagingPath
description: Contient le chemin d’accès complet du répertoire intermédiaire.
ms.assetid: c297472f-9db7-4a91-840d-08ff64c01a7a
ms.tgt_platform: multiple
keywords:
- Schéma AD de l’attribut ms-DFSR-StagingPath
- Schéma AD de l’attribut msDFSR-StagingPath
topic_type:
- apiref
api_name:
- ms-DFSR-StagingPath
...
Contient le chemin d’accès complet du répertoire intermédiaire.
...
| Classes utilisées dans        | [**MS-DFSR-abonnement**](c-msdfsr-subscription.md)<br/> |
