...
---
# <a name="netboot-mirror-data-file-attribute"></a>Attribut de fichier de données de mise en miroir de netboot

L’attribut **netboot-Mirror-file-file** est réservé à un usage interne.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | Netboot-miroir-fichier de données                    |
