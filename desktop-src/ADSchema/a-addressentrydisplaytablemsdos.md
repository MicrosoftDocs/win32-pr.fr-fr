...
ms.locfileid: "118688689"
---
# <a name="address-entry-display-table-msdos-attribute"></a>Adresse-entrée-Affichage-table-MSDOS attribut

Table d’affichage MAPI pour une entrée d’adresse pour le client MSDOS.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Adresse-entrée-Affichage-table-MSDOS                     |
...
| Classes utilisées dans        | [**Modèle d’affichage**](c-displaytemplate.md)<br/> |
