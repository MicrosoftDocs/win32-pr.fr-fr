...
Droit étendu nécessaire à la réplication des modifications à partir d’un contexte de nommage donné.



| Entrée | Valeur |
|--------------|--------------------------------------|
| CN           | DS-réplication--récupération           |
| Display-Name | Réplication des modifications de l’annuaire        |
