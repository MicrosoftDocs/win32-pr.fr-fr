...
Bande passante maximale pouvant être réservée.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ACS-Max-pic-bande passante               |
...
| Classes utilisées dans        | [**ACS-limites de ressources**](c-acsresourcelimits.md)<br/> [**ACS-sous-réseau**](c-acssubnet.md)<br/> |
