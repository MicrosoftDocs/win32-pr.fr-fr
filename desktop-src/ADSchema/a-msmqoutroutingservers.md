...
Les liens DN vers les serveurs de routage MSMQ par le biais desquels tout le trafic sortant de cet ordinateur doit être routé.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | MSMQ-out-Routing-serveurs                |
