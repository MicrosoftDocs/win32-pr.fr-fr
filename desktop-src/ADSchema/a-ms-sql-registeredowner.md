...
---
# <a name="ms-sql-registeredowner-attribute"></a>Attribut MS-SQL-RegisteredOwner

Propriétaire inscrit pour l’instance actuelle de SQL Server.
...
| Classes utilisées dans        | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)<br/> [**MS-SQL-OLAPServer**](c-ms-sql-olapserver.md)<br/> |
