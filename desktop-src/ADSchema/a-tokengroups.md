...
---
# <a name="token-groups-attribute"></a>Attribut Token-Groups

Attribut calculé qui contient la liste des SID en raison d’une opération d’expansion d’appartenance de groupe transitive sur un utilisateur ou un ordinateur donné. Les groupes de jetons ne peuvent pas être récupérés si aucun catalogue global n’est présent pour récupérer les appartenances de contrepassation transitives.
