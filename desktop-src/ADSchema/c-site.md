...
ms.locfileid: "119548919"
---
# <a name="site-class"></a>Classe de site

Conteneur pour le stockage des objets serveur. Représente un emplacement physique qui contient des ordinateurs. Servent à gérer la réplication.
...
| Fréquence des mises à jour  | Chaque fois qu’un nouveau site est nécessaire.       |
...
| Supérieurs possibles          | [**Sites-conteneur**](c-sitescontainer.md)              |
| Classes auxiliaires           | \-                                                       |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                             |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA |
...
| [**Lien GP**](a-gplink.md)                                               | Faux     | **Site**                        |
| [**Options GP**](a-gpoptions.md)                                         | Faux     | **Site**                        |
...
| [**Emplacement**](a-location.md)                                            | Faux     | **Site**                        |
| [**Géré par**](a-managedby.md)                                         | Faux     | **Site**                        |
...
| [**Interval1 MSMQ**](a-msmqinterval1.md)                                 | Faux     | **Site**                        |
| [**Interval2 MSMQ**](a-msmqinterval2.md)                                 | Faux     | **Site**                        |
| [**MSMQ-NT4-stub**](a-msmqnt4stub.md)                                    | Faux     | **Site**                        |
| [**MSMQ-site-étranger**](a-msmqsiteforeign.md)                            | Faux     | **Site**                        |
| [**MSMQ-site-ID**](a-msmqsiteid.md)                                      | Faux     | **Site**                        |
...
| [**Notification-liste**](a-notificationlist.md)                           | Faux     | **Site**                        |
...
| Classes auxiliaires           | \-                                                                         |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                               |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; AU) (A ;; LCRPLORC;;; Ed |
| System-Flags                | 0x00000010                                                                 |
...
| [**ms-DS-pont-serveurs-utilisé**](a-msds-bridgeheadserversused.md)          | Faux     | **Site**                        |
| [**MS-DS-Consistency-enfant-nombre**](a-ms-ds-consistencychildcount.md)         | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Faux     | [**Retour au début**](c-top.md)<br/> |
