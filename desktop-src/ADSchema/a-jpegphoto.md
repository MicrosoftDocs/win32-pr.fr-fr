...
Utilisé pour stocker une ou plusieurs images d’une personne à l’aide du format d’échange de fichiers JPEG \[ JFIF \] .
...
| Classes utilisées dans        | [**inetOrgPerson**](c-inetorgperson.md)<br/> [**Utilisateur**](c-user.md)<br/> |
