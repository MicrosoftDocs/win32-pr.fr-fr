...
ms.locfileid: "119880219"
---
# <a name="ms-ds-claims-transformation-policy-type-class"></a>classe ms-DS-claims-transformation-Policy-type

Un objet de cette classe contient le jeu de stratégies de transformation de revendications pour la transformation de revendications inter-forêts.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | ms-DS-revendications-transformation-stratégie-type |
...
| Supérieurs possibles          | [**ms-DS-revendications-transformation-stratégies**](c-msds-claimstransformationpolicies.md) |
| Classes auxiliaires           | \-                                                                                  |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                        |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; Sy          |
...
| [**ms-DS-transformation-règles**](a-msds-transformationrules.md)                             | Faux     | **ms-DS-revendications-transformation-stratégie-type** |
| [**ms-DS-transformation-règles-compilées**](a-msds-transformationrulescompiled.md)            | Faux     | **ms-DS-revendications-transformation-stratégie-type** |
