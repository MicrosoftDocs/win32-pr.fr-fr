...
ms.locfileid: "118422540"
---
# <a name="ms-ds-resource-property-class"></a>ms-DS-Resource-Property (classe)

Une instance de cette classe contient la définition d’une propriété sur les ressources.
...
| Supérieurs possibles          | [**ms-DS-Resource-Properties**](c-msds-resourceproperties.md)                                   |
| Classes auxiliaires           | \-                                                                                               |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                     |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLOLORCWOWDSDDTDTSW;;; EA) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA |
...
| [**ms-DS-application-to-Resource-types**](a-msds-appliestoresourcetypes.md)                         | Faux     | **ms-DS-Resource-Property**                                                       |
...
| [**ms-DS-is-used-as-Resource-Security-Attribute**](a-msds-isusedasresourcesecurityattribute.md) | Faux     | **ms-DS-Resource-Property**                                                       |
...
| [**ms-DS-value-type-référence**](a-msds-valuetypereference.md)                                  | Vrai      | **ms-DS-Resource-Property**                                                       |
