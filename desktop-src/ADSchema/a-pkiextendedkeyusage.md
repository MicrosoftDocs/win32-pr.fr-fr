...
---
# <a name="pki-extended-key-usage-attribute"></a>PKI-attribut d’utilisation de clé étendue

OID de l’utilisation améliorée de la clé pour le modèle de certificat.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | Infrastructure à clé publique-étendue-utilisation                      |
