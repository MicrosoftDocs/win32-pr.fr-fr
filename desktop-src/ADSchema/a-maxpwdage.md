...
ms.locfileid: "119301039"
---
# <a name="max-pwd-age-attribute"></a>Attribut Max-pwd-Age

Durée maximale, en intervalles de 100 nanosecondes, un mot de passe est valide. Cette valeur est stockée sous la forme d’un grand entier qui représente le nombre d’intervalles de 100 nanosecondes à partir du moment où le mot de passe a été défini avant l’expiration du mot de passe.
