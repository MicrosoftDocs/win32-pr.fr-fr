...
ms.locfileid: "119837069"
---
# <a name="rpc-ns-interface-id-attribute"></a>attribut RPC-NS-interface-ID

ID d’interface pris en charge par un serveur donné.
...
| Classes utilisées dans        | [**Élément de profil RPC**](c-rpcprofileelement.md)<br/> [**Élément serveur RPC**](c-rpcserverelement.md)<br/> |
