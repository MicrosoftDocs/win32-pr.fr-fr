...
---
# <a name="default-hiding-value-attribute"></a>Attribut-masquage-valeur par défaut

Valeur booléenne qui spécifie le paramètre par défaut de la propriété showInAdvancedViewOnly des nouvelles instances de cette classe.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Valeur de masquage par défaut                 |
