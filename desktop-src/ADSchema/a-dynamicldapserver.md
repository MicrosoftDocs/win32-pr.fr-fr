...
---
# <a name="dynamic-ldap-server-attribute"></a>Attribut Dynamic-LDAP-Server

Nom DNS des propriétés dynamiques de gestion de serveur pour ce compte.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | Serveur LDAP dynamique                     |
