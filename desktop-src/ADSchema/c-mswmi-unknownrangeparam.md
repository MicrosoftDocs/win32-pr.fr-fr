...
ms.locfileid: "119753615"
---
# <a name="ms-wmi-unknownrangeparam-class"></a>classe ms-WMI-UnknownRangeParam

Prend en charge les types de paramètres dont nous savons rien, afin qu’ils soient transportés en tant qu’objets WMI compilés.
...
| [**MS-WMI-NormalizedClass**](a-mswmi-normalizedclass.md)                   | Vrai      | **MS-WMI-UnknownRangeParam**                               |
...
| [**MS-WMI-TargetObject**](a-mswmi-targetobject.md)                         | Vrai      | **MS-WMI-UnknownRangeParam**                               |
