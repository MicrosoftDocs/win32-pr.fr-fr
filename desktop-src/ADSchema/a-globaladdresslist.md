...
| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | Liste d’adresses globale                     |
| LDAP-Display-Name | globalAddressList                       |
| Taille              | \-                                      |
...
| Classes utilisées dans        | [**ms-Exch-configuration-conteneur**](c-msexchconfigurationcontainer.md)<br/> |
