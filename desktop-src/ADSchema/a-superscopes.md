...
ms.locfileid: "119923129"
---
# <a name="super-scopes-attribute"></a>Attribut Super-Scopes

Cet attribut est utilisé pour regrouper toutes les différentes étendues utilisées dans la classe DHCP dans une entité unique.
...
|-------------------|--------------------------------------|
| CN                | Super-Scopes                         |
| LDAP-Display-Name | Étendues globales                          |
| Taille              | \-                                   |
