...
ms.locfileid: "119323709"
---
# <a name="ms-authz-central-access-rule-class"></a>MS-auth-central-Access-Class (classe)

Classe qui définit les règles d’accès centralisées utilisées pour construire une stratégie d’accès centralisée.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-auth-central-Access-Rule         |
...
| Supérieurs possibles          | [**MS-auth-central-Access-Rules**](c-msauthz-centralaccessrules.md)                        |
| Classes auxiliaires           | \-                                                                                           |
...
| [**Activé**](a-enabled.md)                                                                 | Faux     | **MS-auth-central-Access-Rule** |
...
| [**MS-auth-efficace-sécurité-stratégie**](a-msauthz-effectivesecuritypolicy.md)              | Faux     | **MS-auth-central-Access-Rule** |
| [**MS-auth-dernier-effectif-stratégie de sécurité**](a-msauthz-lasteffectivesecuritypolicy.md)     | Faux     | **MS-auth-central-Access-Rule** |
| [**MS-auth-proposed-Security-Policy**](a-msauthz-proposedsecuritypolicy.md)                | Faux     | **MS-auth-central-Access-Rule** |
| [**MS-auth-Resource-condition**](a-msauthz-resourcecondition.md)                           | Faux     | **MS-auth-central-Access-Rule** |
