...
ms.locfileid: "119548979"
---
# <a name="service-administration-point-class"></a>Classe de point d’administration de service

Contient des informations de liaison pour la connexion à un service afin de l’administrer.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Point d’administration de service         |
