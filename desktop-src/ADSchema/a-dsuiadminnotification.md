...
Il s’agit d’une liste des GUID des objets COM qui prennent en charge une interface de rappel que DSAdmin appelle lorsqu’une action a eu lieu sur un objet par le biais de l’interface utilisateur.
