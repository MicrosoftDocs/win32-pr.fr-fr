...
ms.locfileid: "118175213"
---
# <a name="msmq-migrated-user-class"></a>MSMQ-migrated-User (classe)

Dans MSMQ 1,0, nous avions notre propre DS, dans lequel nous avons conservé certaines informations par utilisateur. dans le cadre de l’intégration de msmq avec Windows 2000 DS, msmq fournit un outil de migration. pendant la migration, pour chaque utilisateur qui ne se trouve pas dans le domaine Windows 2000, nous créons un utilisateur migré.
...
| Fréquence des mises à jour  | Cet objet est créé par l’Assistant Mise à niveau de Message Queuing dans un environnement de domaine en mode mixte. |
...
| Supérieurs possibles          | Domaine [**BuiltIn**](c-builtindomain.md)-domaine [**-**](c-domaindns.md)[**unité d’organisation**](c-organizationalunit.md) DNS |
| Classes auxiliaires           | \-                                                                                                                            |
...
| [**MSMQ-Digests**](a-msmqdigests.md)                                     | Faux     | **MSMQ-migrated-User**          |
| [**MSMQ-Digests-MIG**](a-msmqdigestsmig.md)                              | Faux     | **MSMQ-migrated-User**          |
| [**Certificats de signature MSMQ**](a-msmqsigncertificates.md)                  | Faux     | **MSMQ-migrated-User**          |
| [**MSMQ-Sign-Certificates-MIG**](a-msmqsigncertificatesmig.md)           | Faux     | **MSMQ-migrated-User**          |
| [**MSMQ-SID utilisateur**](a-msmqusersid.md)                                    | Faux     | **MSMQ-migrated-User**          |
...
| [**SID de l’objet**](a-objectsid.md)                                         | Faux     | **MSMQ-migrated-User**          |
