...
ms.locfileid: "119879889"
---
# <a name="ms-ds-quota-control-class"></a>classe ms-DS-quota-Control

Classe utilisée pour représenter les spécifications de quota pour la base de données d’annuaire.
...
| Supérieurs possibles          | [**ms-DS-quota-Container**](c-msds-quotacontainer.md)   |
| Classes auxiliaires           | \-                                                       |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                             |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPLCLORC;;; Planning |
...
| [**Nom commun**](a-cn.md)                                                 | Vrai      | **ms-DS-quota-contrôle** [ **supérieur**](c-top.md)<br/> |
...
| [**ms-DS-quota-amount**](a-msds-quotaamount.md)                            | Vrai      | **ms-DS-quota-Control**                                 |
| [**ms-DS-quota-tiers de confiance**](a-msds-quotatrustee.md)                          | Vrai      | **ms-DS-quota-Control**                                 |
