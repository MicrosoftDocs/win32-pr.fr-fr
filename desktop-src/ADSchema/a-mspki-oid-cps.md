---
title: attribut ms-PKI-OID-CPS
description: Déclaration CPS (Certificate Policy) pour l’OID de stratégie de l’émetteur d’entreprise.
ms.assetid: 94c5115e-a8d2-49d1-9fd2-f362e95550dc
ms.tgt_platform: multiple
keywords:
- Schéma AD d’attribut ms-PKI-OID-CPS
- Schéma AD d’attribut attribut mspki-OID-CPS
topic_type:
- apiref
api_name:
- ms-PKI-OID-CPS
...
ms.locfileid: "103845065"
---
# <a name="ms-pki-oid-cps-attribute"></a>attribut ms-PKI-OID-CPS

Déclaration CPS (Certificate Policy) pour l’OID de stratégie de l’émetteur d’entreprise.
...
|-------------------|--------------------------------------------------------------------------------------------|
| CN                | MS-PKI-OID-CPS                                                                             |
| LDAP-Display-Name | Attribut mspki-OID-CPS                                                                              |
| Taille              | \-                                                                                         |
