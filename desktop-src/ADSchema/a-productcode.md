...
ms.locfileid: "118681747"
---
# <a name="product-code-attribute"></a>Attribut Product-Code

Cet attribut contient un identificateur unique pour une application pour une version de produit particulière, représentée sous la forme d’un GUID de chaîne, par exemple « {12345678-1234-1234-1234-123456789012} ». Les lettres utilisées dans ce GUID doivent être en majuscules. Cet ID doit varier en fonction des versions et des langues.
