...
ms.locfileid: "119703759"
---
# <a name="file-link-tracking-entry-class"></a>Classe d’entrée de suivi des liaisons de fichiers

Contient les informations relatives au GUID et à l’ordinateur actuel pour un fichier avec suivi de lien.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Suivi des liaisons de fichiers-entrée             |
