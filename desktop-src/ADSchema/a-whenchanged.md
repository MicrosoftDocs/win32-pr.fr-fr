...
---
# <a name="when-changed-attribute"></a>Attribut When-Changed

Date à laquelle cet objet a été modifié pour la dernière fois. Cette valeur n’est pas répliquée et existe dans le catalogue global.
...
| Fréquence des mises à jour  | Chaque fois que l’objet est modifié.                              |
