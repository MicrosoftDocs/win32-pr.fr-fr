...
ms.locfileid: "119922559"
---
# <a name="ipsec-base-class"></a>Classe Ipsec-Base

Classe de base IPSEC à partir de laquelle toutes les classes IPSEC sont dérivées.
...
| [**IPSec-données**](a-ipsecdata.md)                                         | Faux     | **IPSec-de base**                  |
| [**Type de données IPSec**](a-ipsecdatatype.md)                                | Faux     | **IPSec-de base**                  |
| [**ID IPSec**](a-ipsecid.md)                                             | Faux     | **IPSec-de base**                  |
| [**Nom d’IPSec**](a-ipsecname.md)                                         | Faux     | **IPSec-de base**                  |
| [**IPSec-propriétaires-référence**](a-ipsecownersreference.md)                  | Faux     | **IPSec-de base**                  |
