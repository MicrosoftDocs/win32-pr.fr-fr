...
L’objectif de ces objets est de permettre une interrogation rapide des serveurs MSMQ dans un site spécifique. Cet objet contient des informations telles que les services Message Queuing fournis par le serveur.
...
| Fréquence des mises à jour  | Cet objet est créé pour chaque serveur Message Queuing installé sur un contrôleur de domaine Windows 2000 et pour chaque serveur de Message Queuing avec les services de routage. |
...
| Supérieurs possibles          | [**Serveur**](c-server.md)                                                                   |
| Classes auxiliaires           | \-                                                                                           |
...
| [**MSMQ-dependent-client-service**](a-msmqdependentclientservice.md)     | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-DS-service**](a-msmqdsservice.md)                                | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-migré**](a-msmqmigrated.md)                                   | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-NT4-indicateurs**](a-msmqnt4flags.md)                                  | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-owner-ID**](a-msmqownerid.md)                                    | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-QM-ID**](a-msmqqmid.md)                                          | Faux     | **Paramètres MSMQ**               |
| [**Service de routage MSMQ**](a-msmqroutingservice.md)                      | Faux     | **Paramètres MSMQ**               |
| [**Services MSMQ**](a-msmqservices.md)                                   | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-Site-Name**](a-msmqsitename.md)                                  | Faux     | **Paramètres MSMQ**               |
| [**MSMQ-Site-Name-ex**](a-msmqsitenameex.md)                             | Faux     | **Paramètres MSMQ**               |
