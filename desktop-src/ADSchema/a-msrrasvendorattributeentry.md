...
---
# <a name="ms-rras-vendor-attribute-entry-attribute"></a>attribut-attribut-Entry MS-RRAS-Vendor

Chaîne qui permet aux fournisseurs d’ajouter des attributs de routeur au service d’annuaire pour les utiliser dans des requêtes, sous la forme AttributeName : ID fournisseur : AttributeType.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | MS-RRAS-Vendor-attribute-entrée              |
...
| Classes utilisées dans        | [**RRAS-administration-dictionnaire**](c-rrasadministrationdictionary.md)<br/> |
