...
Objet d’activation utilisé dans l’activation basée sur Active Directory



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-SPP-activation-objet             |
...
| Supérieurs possibles          | [**MS-SPP-activation-objets-conteneur**](c-msspp-activationobjectscontainer.md) |
| Classes auxiliaires           | \-                                                                                |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                      |
| Descripteur de sécurité par défaut | O :BAG : BAD : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPLCLORC;;; UA                 |
...
| [**MS-SPP-config-licence**](a-msspp-configlicense.md)                                       | Faux     | **MS-SPP-activation-objet**    |
| [**MS-SPP-confirmation-ID**](a-msspp-confirmationid.md)                                     | Faux     | **MS-SPP-activation-objet**    |
| [**MS-SPP-CSVLK-partiel-clé de produit**](a-msspp-csvlkpartialproductkey.md)                   | Vrai      | **MS-SPP-activation-objet**    |
| [**MS-SPP-CSVLK-PID**](a-msspp-csvlkpid.md)                                                 | Vrai      | **MS-SPP-activation-objet**    |
