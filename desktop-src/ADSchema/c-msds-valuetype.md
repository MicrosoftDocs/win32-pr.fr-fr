...
ms.locfileid: "119879789"
---
# <a name="ms-ds-value-type-class"></a>classe ms-DS-value-type

Un objet de type valeur contient les informations de type valeur pour une propriété de ressource.
...
| [**ms-DS-revendication-is-Single-Valued**](a-msds-claimissinglevalued.md)                           | Vrai      | **ms-DS-value-type**            |
| [**ms-DS-revendication-is-value-Space-Restricted**](a-msds-claimisvaluespacerestricted.md)          | Vrai      | **ms-DS-value-type**            |
| [**ms-DS-claim-shares-possibles-values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**ms-DS-claim-value-type**](a-msds-claimvaluetype.md)                                      | Vrai      | **ms-DS-value-type**            |
...
| [**ms-DS-is-possibles-values-present**](a-msds-ispossiblevaluespresent.md)                   | Vrai      | **ms-DS-value-type**            |
