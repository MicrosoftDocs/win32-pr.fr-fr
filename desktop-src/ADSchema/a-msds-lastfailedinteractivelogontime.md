...
Heure à laquelle un mot de passe incorrect a été présenté lors d’une ouverture de session Ctrl + Alt + Suppr.



| Entrée | Valeur |
|-------------------|------------------------------------------|
| CN                | ms-DS-dernier-échec-interactif-heure d’ouverture de session |
| LDAP-Display-Name | msDS-LastFailedInteractiveLogonTime      |
| Taille              | \-                                       |
