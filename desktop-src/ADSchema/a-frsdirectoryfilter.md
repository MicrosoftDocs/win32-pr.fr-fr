...
ms.locfileid: "119925649"
---
# <a name="frs-directory-filter-attribute"></a>Attribut de filtre de répertoire FRS

Liste des répertoires exclus de la réplication de fichiers, par exemple, TEMP ou obj.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | FRS-filtre de répertoire                        |
