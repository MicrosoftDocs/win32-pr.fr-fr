...
ms.locfileid: "119022627"
---
# <a name="mssfu-30-max-gid-number-attribute"></a>attribut msSFU-30-max-GID-Number

Contient le nombre maximal de groupes migrés vers un domaine NIS.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | msSFU-30-max-GID-numéro              |
