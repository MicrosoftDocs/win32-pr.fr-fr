...
---
# <a name="mssfu-30-master-server-name-attribute"></a>msSFU-30-Master-Server-Name, attribut

Contient la valeur qui est retournée lorsque le serveur NIS traite un appel d’API **\_ maître YP** .
