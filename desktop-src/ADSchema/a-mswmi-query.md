...
---
# <a name="ms-wmi-query-attribute"></a>MS-WMI-attribut de requête

Une seule requête WQL.
...
|-------------------|---------------------------------------------|
| CN                | MS-WMI-requête                                |
| LDAP-Display-Name | msWMI-requête                                 |
| Taille              | Moins de 250 caractères.                   |
...
| Classes utilisées dans        | [**MS-WMI-règle**](c-mswmi-rule.md)<br/> |
