...
ms.locfileid: "119834569"
---
# <a name="ms-authz-central-access-policy-class"></a>MS-auth-central-Access-Policy (classe)

Classe qui définit les objets de stratégie d’accès centralisée.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-auth-central-Access-Policy       |
...
| Supérieurs possibles          | [**MS-auth-central-Access-stratégies**](c-msauthz-centralaccesspolicies.md)                  |
| Classes auxiliaires           | \-                                                                                           |
...
| [**MS-auth-central-Access-Policy-ID**](a-msauthz-centralaccesspolicyid.md)                         | Faux     | **MS-auth-central-Access-Policy** |
| [**MS-auth-Member-Rules-in-central-Access-Policy**](a-msauthz-memberrulesincentralaccesspolicy.md) | Faux     | **MS-auth-central-Access-Policy** |
