...
ms.locfileid: "118689185"
---
# <a name="acs-total-no-of-flows-attribute"></a>Attribut ACS-total-no-of-Flow

Nombre total de flux qu’un utilisateur donné peut avoir.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ACS-total des flux                |
