...
ms.locfileid: "120005429"
---
# <a name="rpc-profile-element-class"></a>classe de l’élément RPC-Profile

Contient une entrée dans un profil RPC.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Élément de profil RPC                  |
...
| Supérieurs possibles          | [**Profil RPC**](c-rpcprofile.md)                                                          |
| Classes auxiliaires           | \-                                                                                           |
...
| [**RPC-NS-annotation**](a-rpcnsannotation.md)                            | Faux     | **Élément de profil RPC**                                                                  |
| [**RPC-NS-interface-ID**](a-rpcnsinterfaceid.md)                         | Vrai      | **Élément de profil RPC**                                                                  |
| [**RPC-NS-Priority**](a-rpcnspriority.md)                                | Vrai      | **Élément de profil RPC**                                                                  |
| [**RPC-NS-Profile-entrée**](a-rpcnsprofileentry.md)                       | Faux     | **Élément de profil RPC**                                                                  |
