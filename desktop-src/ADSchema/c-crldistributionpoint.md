...
ms.locfileid: "119701948"
---
# <a name="crl-distribution-point-class"></a>Classe de point de distribution de liste de révocation de certificats

Objet contenant les listes de révocation de certificats, d’autorité et Delta.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Point de distribution de liste de révocation de certificats               |
...
| [**Autorité-révocation-liste**](a-authorityrevocationlist.md)            | Faux     | **Point de distribution de liste de révocation de certificats**                                 |
...
| [**Certificate-Authority-Object**](a-certificateauthorityobject.md)      | Faux     | **Point de distribution de liste de révocation de certificats**                                 |
| [**Certificat-révocation-liste**](a-certificaterevocationlist.md)        | Faux     | **Point de distribution de liste de révocation de certificats**                                 |
| [**Nom commun**](a-cn.md)                                               | Vrai      | **CRL-point de distribution** - [ **haut**](c-top.md)<br/> |
| [**Date et heure de création**](a-createtimestamp.md)                            | Faux     | [**Retour au début**](c-top.md)<br/>                            |
| [**Liste de révocation de certificats partitionnés-révocation**](a-crlpartitionedrevocationlist.md) | Faux     | **Point de distribution de liste de révocation de certificats**                                 |
| [**Delta-Revocation-List**](a-deltarevocationlist.md)                    | Faux     | **Point de distribution de liste de révocation de certificats**                                 |
