...
ms.locfileid: "119643719"
---
# <a name="country-class"></a>Classe Country

Pays/région de l’adresse de l’utilisateur. Il s’agit du nom complet.
...
| Mettre à jour le privilège  | Le propriétaire du compte ou l’administrateur du domaine définit cette valeur. |
...
| RDN-att-ID                  | [**Country-Name**](a-c.md)<br/>                                                       |
...
| [**Rechercher-Guide**](a-searchguide.md)                                     | Faux     | **Pays**                     |
...
| RDN-att-ID                  | [**Country-Name**](a-c.md)<br/>                                                       |
| Sous-classe de                 | [**Retour au début**](c-top.md)<br/>                                                              |
| Supérieurs possibles          | [](c-organization.md)[**Domaine de l’organisation-DNS**](c-domaindns.md)                      |
| Classes auxiliaires           | \-                                                                                           |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                 |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA |
| System-Flags                | 0x00000010                                                                                   |
