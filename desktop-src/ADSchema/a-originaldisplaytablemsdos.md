...
---
# <a name="original-display-table-msdos-attribute"></a>Attribut original-Display-table-MSDOS

Table d’affichage MAPI (original) pour une entrée d’adresse MSDOS.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Original-affichage-table-MSDOS                          |
