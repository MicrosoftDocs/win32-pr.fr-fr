...
ms.locfileid: "118423585"
---
# <a name="rid-available-pool-attribute"></a>RID-available-attribut de pool

Espace à partir duquel les pools RID sont alloués.
...
| Classes utilisées dans        | [**Gestionnaire RID**](c-ridmanager.md)<br/> |
