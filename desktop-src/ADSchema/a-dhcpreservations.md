...
ms.locfileid: "120049949"
---
# <a name="dhcp-reservations-attribute"></a>attribut DHCP-reservations

L’attribut **DHCP-reservations** n’est pas utilisé actuellement.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | DHCP-Réservations                    |
