...
---
# <a name="msmq-sites-attribute"></a>Attribut MSMQ-Sites

Liste des sites auxquels l’ordinateur appartient (un tableau des ObjectGUID de sites, généralement pas plus d’un GUID).
