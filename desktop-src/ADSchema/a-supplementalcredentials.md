...
Informations d’identification stockées pour une utilisation lors de l’authentification. Version chiffrée du mot de passe de l’utilisateur. Cet attribut n’est ni lisible ni accessible en écriture.
...
| Fréquence des mises à jour  | Lorsque le mot de passe de l’utilisateur change.                     |
