...
ms.locfileid: "118423199"
---
# <a name="control-access-right-class"></a>Classe Control-Access-Right

Identifie un droit étendu qui peut être accordé ou révoqué à l’aide d’une liste de contrôle d’accès.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Accès au contrôle-droit                 |
...
| [**S’applique à**](a-appliesto.md)                                         | Faux     | **Accès au contrôle-droit**        |
...
| [**Localisation-Display-ID**](a-localizationdisplayid.md)                | Faux     | **Accès au contrôle-droit**        |
...
| [**Rights-GUID**](a-rightsguid.md)                                       | Faux     | **Accès au contrôle-droit**        |
...
| [**Accès valide**](a-validaccesses.md)                                 | Faux     | **Accès au contrôle-droit**        |
