...
---
# <a name="ms-wmi-genus-attribute"></a>attribut de genre MS-WMI

Identifie le type d’objet d’un encodage.
...
|-------------------|-----------------------------------------------------------------|
| CN                | MS-WMI-genre                                                    |
| LDAP-Display-Name | msWMI-genre                                                     |
| Taille              | 4 octets. 1 indique une classe. 2 indique une instance.          |
