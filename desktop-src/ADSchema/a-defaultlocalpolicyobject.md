...
Référence à un objet de stratégie qui définit la stratégie locale pour l’objet hôte.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | Objet de stratégie locale par défaut             |
...
| Classes utilisées dans        | [**Computer**](c-computer.md)<br/> [**Stratégie de domaine**](c-domainpolicy.md)<br/> [**Sam-domaine**](c-samdomain.md)<br/> |
