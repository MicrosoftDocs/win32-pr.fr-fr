...
ms.locfileid: "119879799"
---
# <a name="ms-pki-private-key-recovery-agent-class"></a>classe ms-PKI-Private-Key-Recovery-agent

Utilisé pour publier le certificat de l’agent de récupération de clé dans le conteneur KRA.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-PKI-privé-clé-Recovery-agent    |
| LDAP-Display-Name | Attribut mspki-PrivateKeyRecoveryAgent        |
...
| [**X509-CERT**](a-usercertificate.md)                                      | Vrai      | **MS-PKI-privé-clé-Recovery-agent** |
