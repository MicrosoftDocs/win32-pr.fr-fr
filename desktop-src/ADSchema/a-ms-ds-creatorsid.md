...
---
# <a name="ms-ds-creator-sid-attribute"></a>Attribut MS-DS-Creator-SID

ID de sécurité du créateur de l’objet qui contient cet attribut.
...
| Fréquence des mises à jour  | Chaque fois qu’un nouvel objet est créé.    |
