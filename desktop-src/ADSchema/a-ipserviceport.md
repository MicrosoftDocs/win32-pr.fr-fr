...
ms.locfileid: "119924899"
---
# <a name="ipserviceport-attribute"></a>attribut ipServicePort

contient la section de la carte des services qui spécifie le port sur lequel le service UNIX est disponible.
...
| Classes utilisées dans        | [**ipService**](c-ipservice.md)<br/> |
