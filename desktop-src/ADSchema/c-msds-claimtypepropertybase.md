...
Classe abstraite qui définit la classe de base pour les classes de type de revendication ou de propriété de ressource.
...
| [**Enabled**](a-enabled.md)                                                                 | Faux     | **ms-DS-claim-type-Property-base** |
...
| [**ms-DS-claim-possibles-valeurs**](a-msds-claimpossiblevalues.md)                            | Faux     | **ms-DS-claim-type-Property-base** |
| [**ms-DS-claim-parts-possibles-values-with**](a-msds-claimsharespossiblevalueswith.md)      | Faux     | **ms-DS-claim-type-Property-base** |
