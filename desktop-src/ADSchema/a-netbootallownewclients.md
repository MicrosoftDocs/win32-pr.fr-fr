...
---
# <a name="netboot-allow-new-clients-attribute"></a>attribut netboot-allow-New-clients

L’attribut **netboot-allow-New-clients** est réservé à un usage interne.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | netboot-autoriser-New-clients            |
