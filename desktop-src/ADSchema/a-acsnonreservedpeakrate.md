...
ms.locfileid: "118178443"
---
# <a name="acs-non-reserved-peak-rate-attribute"></a>ACS-non réservé-attribut de taux de pics

L’attribut **ACS-non réservé-pic-rate** est destiné à un usage interne uniquement. Basé sur RFC2814.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ACS-non réservé-taux de pointe           |
