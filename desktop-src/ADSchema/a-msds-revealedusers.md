...
Utilisé avec les contrôleurs de domaine en lecture seule pour identifier les objets utilisateur dont les secrets ont été divulgués à ce RODC.



| Entrée | Valeur |
|-------------------|-------------------------------------------------|
| CN                | ms-DS-dévoilé-utilisateurs                            |
