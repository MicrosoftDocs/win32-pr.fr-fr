...
ms.locfileid: "119324109"
---
# <a name="lost-and-found-class"></a>Classe perdue et trouvée

Conteneur pour les objets orphelins.
...
| Mettre à jour le privilège  | Ce conteneur est géré par le système.                  |
| Fréquence des mises à jour  | À chaque fois que l’emplacement d’un objet ne peut pas être concilié. |
...
| Supérieurs possibles          | [**DMD**](c-dmd.md)[**domaine-**](c-domaindns.md)[**configuration**](c-configuration.md) DNS |
| Classes auxiliaires           | \-                                                                                            |
...
| [**Déplacer-arborescence-État**](a-movetreestate.md)                                | Faux     | **Perdu-et-trouvé**              |
