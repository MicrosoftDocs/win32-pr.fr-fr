...
ms.locfileid: "119324229"
---
# <a name="ipsec-isakmp-policy-class"></a>IPsec-ISAKMP-classe de stratégie

La classe **IPsec-ISAKMP-Policy** est réservée à un usage interne.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | IPsec-ISAKMP-stratégie                  |
