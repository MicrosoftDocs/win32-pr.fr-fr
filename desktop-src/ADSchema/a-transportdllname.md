...
---
# <a name="transport-dll-name-attribute"></a>Attribut de nom de la DLL de transport

Nom de la DLL qui gérera un transport.
...
| Classes utilisées dans        | [**Transport inter-sites**](c-intersitetransport.md)<br/> |
