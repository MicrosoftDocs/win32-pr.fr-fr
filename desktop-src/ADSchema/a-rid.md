...
ms.locfileid: "119646739"
---
# <a name="rid-attribute"></a>RID (attribut)

Identificateur relatif d’un objet.
...
| Fréquence des mises à jour  | Lorsqu’un objet qui a besoin d’un RID est créé. |
