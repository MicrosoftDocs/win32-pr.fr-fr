...
ms.locfileid: "119706739"
---
# <a name="crl-partitioned-revocation-list-attribute"></a>Liste de révocation de certificats-révocation-révocation

Listes de révocation de l’infrastructure à clé publique.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Liste de révocation de certificats partitionnés-révocation                       |
...
| Classes utilisées dans        | [**Point de distribution de liste de révocation de certificats**](c-crldistributionpoint.md)<br/> |
