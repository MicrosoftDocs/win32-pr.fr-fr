...
---
# <a name="group-of-names-class"></a>Classe de noms de groupe

Utilisé pour définir des entrées qui représentent un ensemble non ordonné de noms qui représentent des objets individuels ou d’autres groupes de noms.
...
| [**Catégorie d’entreprise**](a-businesscategory.md)                           | Faux     | **Groupes de noms**                                 |
| [**Nom canonique**](a-canonicalname.md)                                 | Faux     | [**Retour au début**](c-top.md)<br/>                    |
| [**Nom commun**](a-cn.md)                                               | Vrai      | **Groupe de noms** [ **haut**](c-top.md)<br/> |
...
| [**Membre**](a-member.md)                                                | Vrai      | **Groupes de noms**                                 |
...
| [**Nom de l’unité d’organisation**](a-ou.md)                                  | Faux     | **Groupes de noms**                                 |
| [**Nom de l’Organisation**](a-o.md)                                          | Faux     | **Groupes de noms**                                 |
| [**Autres objets bien connus**](a-otherwellknownobjects.md)               | Faux     | [**Retour au début**](c-top.md)<br/>                    |
| [**Propriétaire**](a-owner.md)                                                  | Faux     | **Groupes de noms**                                 |
...
| [**Voir aussi**](a-seealso.md)                                             | Faux     | **Groupes de noms**                                 |
...
| RDN-att-ID                  | [**Nom commun**](a-cn.md)<br/>                                                                                                                  |
| Sous-classe de                 | [**Retour au début**](c-top.md)<br/>                                                                                                                         |
| Supérieurs possibles          | [**Unité d’organisation de**](c-organizationalunit.md) la [**localité**](c-locality.md)de l'[**organisation**](c-organization.md) [**conteneur**](c-container.md) |
| Classes auxiliaires           | \-                                                                                                                                                      |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                                                                            |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA                                                            |
| System-Flags                | 0x00000010                                                                                                                                              |
