...
ms.locfileid: "118681548"
---
# <a name="rpc-ns-transfer-syntax-attribute"></a>attribut RPC-NS-Transfer-Syntax

UUID de la syntaxe de transfert prise en charge par l’entrée actuelle.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | RPC-NS-Transfer-syntaxe                      |
...
| Classes utilisées dans        | [**Élément serveur RPC**](c-rpcserverelement.md)<br/> |
