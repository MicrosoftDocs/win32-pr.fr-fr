...
---
# <a name="service-binding-information-attribute"></a>Attribut d’informations de liaison de service

Informations de liaison spécifiques au service dans un format de chaîne.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | Liaison de service-informations                 |
...
| Classes utilisées dans        | [**Point de connexion de service**](c-serviceconnectionpoint.md)<br/> |
