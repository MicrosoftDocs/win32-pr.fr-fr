...
ms.locfileid: "119922809"
---
# <a name="dynamic-object-class"></a>Classe Dynamic-Object

Cette classe, si elle est présente dans une entrée, indique que cette entrée a une durée de vie limitée et peut disparaître automatiquement lorsque sa durée de vie a atteint 0. Si le client n’a pas fourni de valeur pour l’attribut entryTtl, le serveur en fournit un.
...
| [**TTL d’entrée**](a-entryttl.md)                                             | Faux     | **Objet dynamique**              |
...
| [**ms-DS-Entry-Time-to-Die**](a-msds-entry-time-to-die.md)                 | Faux     | **Objet dynamique**              |
