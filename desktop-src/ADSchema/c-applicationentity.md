...
ms.locfileid: "119643969"
---
# <a name="application-entity-class"></a>Classe Application-Entity

Classe de base X. 500 pour les applications : le service d’annuaire utilise uniquement la sous-classe MSFT-DSA.
...
| [**Nom commun**](a-cn.md)                                               | Vrai      | **Application-entité** [ **supérieure**](c-top.md)<br/> |
...
| [**Localité-Name**](a-l.md)                                              | Faux     | **Entité d’application**                                 |
...
| [**Nom de l’unité d’organisation**](a-ou.md)                                  | Faux     | **Entité d’application**                                 |
| [**Nom de l’Organisation**](a-o.md)                                          | Faux     | **Entité d’application**                                 |
...
| [**Adresse de présentation**](a-presentationaddress.md)                     | Vrai      | **Entité d’application**                                 |
...
| [**Voir aussi**](a-seealso.md)                                             | Faux     | **Entité d’application**                                 |
...
| [**Pris en charge-application-Context**](a-supportedapplicationcontext.md)    | Faux     | **Entité d’application**                                 |
...
| RDN-att-ID                  | [**Nom commun**](a-cn.md)<br/>                                                                                                 |
| Sous-classe de                 | [**Retour au début**](c-top.md)<br/>                                                                                                        |
| Supérieurs possibles          | Application [**d’unité d’organisation**](c-organizationalunit.md)[**de conteneur-processus**](c-applicationprocess.md) [](c-container.md) |
| Classes auxiliaires           | \-                                                                                                                                     |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                                                           |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA                                           |
| System-Flags                | 0x00000010                                                                                                                             |
