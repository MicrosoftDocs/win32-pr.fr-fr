...
ms.locfileid: "118959888"
---
# <a name="ms-dfsr-subscriber-class"></a>MS-DFSR-abonné (classe)

Contient l’appartenance d’un groupe de réplication à l’ordinateur local.
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-abonné                   |
| LDAP-Display-Name | msDFSR-abonné                    |
...
| Supérieurs possibles          | [**MS-DFSR-LocalSettings**](c-msdfsr-localsettings.md)                                                                          |
| Classes auxiliaires           | \-                                                                                                                               |
...
| [**MS-DFSR-extension**](a-msdfsr-extension.md)                             | Faux     | **MS-DFSR-abonné**          |
| [**MS-DFSR-indicateurs**](a-msdfsr-flags.md)                                     | Faux     | **MS-DFSR-abonné**          |
| [**MS-DFSR-MemberReference**](a-msdfsr-memberreference.md)                 | Vrai      | **MS-DFSR-abonné**          |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                 | Faux     | **MS-DFSR-abonné**          |
| [**MS-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)       | Vrai      | **MS-DFSR-abonné**          |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                    | Faux     | **MS-DFSR-abonné**          |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Faux     | **MS-DFSR-abonné**          |
| [**MS-DFSR-ReplicationGroupGuid**](a-msdfsr-replicationgroupguid.md)          | Vrai      | **MS-DFSR-abonné**          |
| [**ms-DS-approx-immed-subordonnés**](a-msds-approx-immed-subordinates.md)    | Faux     | [**Retour au début**](c-top.md)<br/> |
...
La classe **MS-DFSR-Subscriber** fait partie de la prise en charge du service de réplication système de fichiers DFS (DFS).
