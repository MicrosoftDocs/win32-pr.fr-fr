...
ms.locfileid: "119509689"
---
# <a name="com-classid-attribute"></a>Attribut COM-ClassID

Cet attribut stocke la liste des ClassID qui sont implémentés dans ce package d’application.
...
| Classes utilisées dans        | [**Inscription de packages**](c-packageregistration.md)<br/> [**Bibliothèque de types**](c-typelibrary.md)<br/> |
