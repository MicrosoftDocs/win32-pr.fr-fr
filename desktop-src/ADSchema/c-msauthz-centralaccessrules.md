...
ms.locfileid: "119801779"
---
# <a name="ms-authz-central-access-rules-class"></a>MS-auth-central-Access-Rules, classe

Un conteneur de cette classe peut contenir des objets d’entrée de stratégie d’accès centralisée.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-auth-central-Access-Rules        |
