...
ms.locfileid: "119081243"
---
# <a name="display-template-class"></a>Classe Display-Template

Spécifie des informations pour un modèle d’adresse.
...
|------------------------------------------------------------------------------|-----------|------------------------------------------------------|
| [**Adresse-entrée-Affichage-table**](a-addressentrydisplaytable.md)            | Faux     | **Modèle d’affichage**                                 |
| [**Adresse-entrée-Affichage-table-MSDOS**](a-addressentrydisplaytablemsdos.md) | Faux     | **Modèle d’affichage**                                 |
...
| [**Nom commun**](a-cn.md)                                                  | Vrai      | **Modèle d’affichage-** [ **haut**](c-top.md)<br/> |
...
| [**Aide-Data16**](a-helpdata16.md)                                          | Faux     | **Modèle d’affichage**                                 |
| [**Aide-Data32**](a-helpdata32.md)                                          | Faux     | **Modèle d’affichage**                                 |
| [**Help-nom-fichier**](a-helpfilename.md)                                     | Faux     | **Modèle d’affichage**                                 |
...
| [**Original-affichage-table**](a-originaldisplaytable.md)                     | Faux     | **Modèle d’affichage**                                 |
| [**Original-affichage-table-MSDOS**](a-originaldisplaytablemsdos.md)          | Faux     | **Modèle d’affichage**                                 |
