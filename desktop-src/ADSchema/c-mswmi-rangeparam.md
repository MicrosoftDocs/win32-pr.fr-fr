...
Classe de paramètres de plage qui est la base du modèle policytemplate. Il décrit une propriété fusionnable de la cible. Chaque sous-classe implémente un type spécifique. Implémente la méthode Merge pour prendre en charge la fusion. Implémente une méthode Resolve pour générer la propriété cible finale.
...
| [**MS-WMI-PropertyName**](a-mswmi-propertyname.md)                         | Vrai      | **MS-WMI-RangeParam**           |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Vrai      | **MS-WMI-RangeParam**           |
| [**MS-WMI-TargetType**](a-mswmi-targettype.md)                             | Vrai      | **MS-WMI-RangeParam**           |
