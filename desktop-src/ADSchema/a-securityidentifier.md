...
ms.locfileid: "119836869"
---
# <a name="security-identifier-attribute"></a>Attribut Security-Identifier

Valeur unique de longueur variable utilisée pour identifier un compte d’utilisateur, un compte de groupe ou une ouverture de session à laquelle une entrée du contrôle d’accès s’applique.
...
| Classes utilisées dans        | [**Sécurité-principal**](c-securityprincipal.md)<br/> [**Domaine approuvé**](c-trusteddomain.md)<br/> |
