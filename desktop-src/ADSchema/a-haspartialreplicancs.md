...
---
# <a name="has-partial-replica-ncs-attribute"></a>A-attribut-partiel-réplica-NC

Frère vers a-Master-NC. Contient-partial-Replica-NC reflète le nom unique de tous les autres NC de domaine qui ont été répliqués dans un catalogue global.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | Contient-partiel-conplica-NC                 |
