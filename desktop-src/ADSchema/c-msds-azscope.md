...
ms.locfileid: "119880329"
---
# <a name="ms-ds-az-scope-class"></a>ms-DS-AZ-Scope (classe)

Décrit un ensemble d’objets gérés par une application.
...
| Supérieurs possibles          | [**ms-DS-AZ-application**](c-msds-azapplication.md)                                                                             |
| Classes auxiliaires           | \-                                                                                                                               |
...
| [**Description**](a-description.md)                                        | Faux     | **ms-DS-AZ-Scope** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)               | Faux     | **ms-DS-AZ-Scope**                                 |
| [**ms-DS-AZ-Scope-Name**](a-msds-azscopename.md)                           | Vrai      | **ms-DS-AZ-Scope**                                 |
...
| [**ms-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)                  | Faux     | **ms-DS-AZ-Scope**                                 |
| [**ms-DS-AZ-Generic-Data**](a-msds-azgenericdata.md)                          | Faux     | **ms-DS-AZ-Scope**                                 |
| [**ms-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                            | Faux     | **ms-DS-AZ-Scope**                                 |
| [**ms-DS-AZ-Scope-Name**](a-msds-azscopename.md)                              | Vrai      | **ms-DS-AZ-Scope**                                 |
| [**MS-DS-Consistency-enfant-nombre**](a-ms-ds-consistencychildcount.md)         | Faux     | [**Retour au début**](c-top.md)<br/>                    |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Faux     | [**Retour au début**](c-top.md)<br/>                    |
