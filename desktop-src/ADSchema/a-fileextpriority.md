...
ms.locfileid: "118961528"
---
# <a name="file-ext-priority-attribute"></a>Fichier-ext-Priority (attribut)

Cet attribut contient une liste d’extensions de nom de fichier dans un package d’application et leurs priorités associées.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | Fichier-poste-priorité                           |
