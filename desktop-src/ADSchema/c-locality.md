...
ms.locfileid: "119834919"
---
# <a name="locality-class"></a>Classe de localité

Contient une localité, telle qu’une rue, une ville et un État.
...
|-------------------|--------------------------------------------------------------------------|
| CN                | Localité                                                                 |
| LDAP-Display-Name | localité                                                                 |
| Mettre à jour le privilège  | Cette valeur est définie par l’administrateur de domaine ou le propriétaire du compte.          |
| Fréquence des mises à jour  | Lorsqu’un enregistrement d’utilisateur est créé et chaque fois que la localité doit être modifiée. |
...
| RDN-att-ID                  | [**Localité-Name**](a-l.md)<br/>                                                                                           |
| Sous-classe de                 | [**Retour au début**](c-top.md)<br/>                                                                                                   |
| Supérieurs possibles          | [**Pays**](c-country.md) [**de l’unité d’organisation de**](c-organizationalunit.md) **localité**[](c-organization.md) |
| Classes auxiliaires           | \-                                                                                                                                |
...
| [**Localité-Name**](a-l.md)                                              | Vrai      | **Localité**                    |
...
| [**Rechercher-Guide**](a-searchguide.md)                                     | Faux     | **Localité**                    |
| [**Voir aussi**](a-seealso.md)                                             | Faux     | **Localité**                    |
...
| [**Nom de l’État ou de la province**](a-st.md)                                    | Faux     | **Localité**                    |
| [**Rue-adresse**](a-street.md)                                        | Faux     | **Localité**                    |
...
| RDN-att-ID                  | [**Localité-Name**](a-l.md)<br/>                                                                                                                            |
| Sous-classe de                 | [**Retour au début**](c-top.md)<br/>                                                                                                                                    |
| Supérieurs possibles          | Domaine de l'[**organisation**](c-organization.md)de **localité région** de l'[**unité d'**](c-organizationalunit.md)[](c-country.md)organisation [**-DNS**](c-domaindns.md) |
| Classes auxiliaires           | \-                                                                                                                                                                 |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                                                                                       |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA                                                                       |
| System-Flags                | 0x00000010                                                                                                                                                         |
