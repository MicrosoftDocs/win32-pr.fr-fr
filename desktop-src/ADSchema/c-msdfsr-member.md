...
---
# <a name="ms-dfsr-member-class"></a>MS-DFSR-classe Member

Représente un membre du groupe de réplication.
...
|-------------------|--------------------------------------|
| CN                | MS-DFSR-membre                       |
| LDAP-Display-Name | msDFSR-membre                        |
...
| Supérieurs possibles          | [**MS-DFSR-topologie**](c-msdfsr-topology.md)                                                                                    |
| Classes auxiliaires           | \-                                                                                                                               |
...
| [**MS-DFSR-ComputerReference**](a-msdfsr-computerreference.md)             | Vrai      | **MS-DFSR-membre**              |
| [**MS-DFSR-ComputerReferenceBL**](a-msdfsr-computerreferencebl.md)         | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-extension**](a-msdfsr-extension.md)                             | Faux     | **MS-DFSR-membre**              |
| [**MS-DFSR-indicateurs**](a-msdfsr-flags.md)                                     | Faux     | **MS-DFSR-membre**              |
| [**MS-DFSR-Mots clés**](a-msdfsr-keywords.md)                               | Faux     | **MS-DFSR-membre**              |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                 | Faux     | **MS-DFSR-membre**              |
...
| [**Référence serveur**](a-serverreference.md)                               | Faux     | **MS-DFSR-membre**              |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                    | Faux     | **MS-DFSR-membre**              |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | Faux     | **MS-DFSR-membre**              |
| [**ms-DS-approx-immed-subordonnés**](a-msds-approx-immed-subordinates.md)    | Faux     | [**Retour au début**](c-top.md)<br/> |
...
La classe **MS-DFSR-Member** fait partie de la prise en charge du service de réplication système de fichiers DFS (DFS).
