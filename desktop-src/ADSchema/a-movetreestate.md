...
Cet attribut contient des informations d’État pour une arborescence de répertoires qui est déplacée.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Déplacer-arborescence-État                                       |
...
| Classes utilisées dans        | [**Perdu-et-trouvé**](c-lostandfound.md)<br/> |
