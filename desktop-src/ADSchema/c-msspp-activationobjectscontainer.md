...
---
# <a name="ms-spp-activation-objects-container-class"></a>MS-SPP-activation-objets-classe de conteneur

Conteneur pour les objets d’activation utilisés par l’activation basée sur Active Directory



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-SPP-activation-objets-conteneur  |
