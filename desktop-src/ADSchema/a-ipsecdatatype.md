...
---
# <a name="ipsec-data-type-attribute"></a>Attribut de type de données IPSec

L’attribut **IPSec-Data-type** est destiné à un usage interne uniquement.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Type de données IPSec                      |
...
| Classes utilisées dans        | [**IPSec-de base**](c-ipsecbase.md)<br/> |
