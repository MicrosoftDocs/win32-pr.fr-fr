...
---
# <a name="link-id-attribute"></a>Attribut de l’ID de lien

Entier qui indique que l’attribut est un attribut lié. Un entier pair est un lien suivant et un entier impair est un lien vers l’arrière.
