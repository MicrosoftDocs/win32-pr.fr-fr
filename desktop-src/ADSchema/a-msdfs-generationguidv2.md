...
ms.locfileid: "119705129"
---
# <a name="ms-dfs-generation-guid-v2-attribute"></a>attribut ms-DFS-Generation-GUID-v2

Mise à jour chaque fois que l’entrée contenant cet attribut est modifiée.
...
| Classes utilisées dans        | [**MS-DFS-Link-v2**](c-msdfs-linkv2.md)<br/> [**MS-DFS-namespace-v2**](c-msdfs-namespacev2.md)<br/> |
