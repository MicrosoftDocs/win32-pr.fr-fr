...
Cet attribut détermine le délai, en jours, pendant lequel le ticket TGT (Ticket-Granting Ticket) d’un utilisateur peut être renouvelé à des fins d’authentification Kerberos. Le paramètre par défaut est de 7 jours dans le domaine par défaut stratégie de groupe objet (GPO).
