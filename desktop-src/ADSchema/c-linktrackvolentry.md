...
ms.locfileid: "119834929"
---
# <a name="link-track-vol-entry-class"></a>Classe lien-Track-vol-Entry

Entrée d’un lien vers un fichier sur un volume.



| Entrée | Valeur |
|-------------------|---------------------------------------|
| CN                | Lien-Track-vol-entrée                  |
| LDAP-Display-Name | linkTrackVolEntry                     |
| Mettre à jour le privilège  | Cette valeur est définie par le système.      |
| Fréquence des mises à jour  | Chaque fois qu’un lien vers un fichier est créé. |
...
| Supérieurs possibles          | [**Link-Track-volume-table**](c-linktrackvolumetable.md)                  |
| Classes auxiliaires           | \-                                                                         |
...
| [**ID d’ordinateur**](a-currmachineid.md)                                | Faux     | **Lien-Track-vol-entrée**        |
...
| [**Lien-Track-secret**](a-linktracksecret.md)                            | Faux     | **Lien-Track-vol-entrée**        |
...
| [**Nombre d’objets**](a-objectcount.md)                                     | Faux     | **Lien-Track-vol-entrée**        |
...
| [**Seq-notification**](a-seqnotification.md)                             | Faux     | **Lien-Track-vol-entrée**        |
...
| [**Heure d’actualisation**](a-timerefresh.md)                                     | Faux     | **Lien-Track-vol-entrée**        |
| [**Temps-vol-modification**](a-timevolchange.md)                                | Faux     | **Lien-Track-vol-entrée**        |
...
| [**Volume-table-GUID**](a-voltableguid.md)                                  | Faux     | **Lien-Track-vol-entrée**        |
| [**Vol-table-idx-GUID**](a-voltableidxguid.md)                           | Faux     | **Lien-Track-vol-entrée**        |
