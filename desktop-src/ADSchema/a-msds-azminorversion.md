---
title: attribut ms-DS-AZ-minor-version
description: Numéro de version mineure pour AzRoles.
ms.assetid: 90e12e89-62cf-4e69-b497-d283d21ccb2c
ms.tgt_platform: multiple
keywords:
- Schéma AD de l’attribut ms-DS-AZ-minor-version
- Schéma Active Directory de l’attribut msDS-AzMinorVersion
topic_type:
- apiref
api_name:
...
Numéro de version mineure pour AzRoles.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ms-DS-AZ-mineur-version               |
...
| Classes utilisées dans        | [**ms-DS-AZ-admin-Manager**](c-msds-azadminmanager.md)<br/> |
