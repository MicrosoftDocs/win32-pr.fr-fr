...
Délai maximal de déconnexion de la session des services Terminal Server est la durée maximale, en minutes, pendant laquelle une session des services Terminal Server déconnectée reste active sur le serveur Terminal Server.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-TS-Max-déconnexion-temps         |
