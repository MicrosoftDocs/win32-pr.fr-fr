...
ms.locfileid: "119922739"
---
# <a name="file-link-tracking-class"></a>Classe de suivi des liaisons de fichiers

Conteneur pour les objets d’entrée de suivi de lien de fichier.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Suivi des liens de fichiers                   |
