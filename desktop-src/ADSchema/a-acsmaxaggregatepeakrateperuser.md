...
---
# <a name="acs-max-aggregate-peak-rate-per-user-attribute"></a>Attribut ACS-Max-Aggregate-pics-taux-per-User

Taux de pic maximal que tout utilisateur peut avoir pour tous les flux.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ACS-Max-Aggregate-pic-Rate-Per-User |
