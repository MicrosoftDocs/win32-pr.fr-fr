...
---
# <a name="ms-sql-gpslatitude-attribute"></a>Attribut MS-SQL-GPSLatitude

L’attribut **MS-SQL-gpslatitude** n’est pas utilisé actuellement.
...
| Classes utilisées dans        | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)<br/> |
