...
ms.locfileid: "119879379"
---
# <a name="ms-tapi-rt-person-class"></a>classe ms-TAPI-RT-person

Utilisé pour mapper un utilisateur à l’adresse IP de l’ordinateur auquel l’utilisateur est connecté pour une utilisation par les conférences de multidiffusion TAPI.
...
| Fréquence des mises à jour  | Chaque fois qu’un client TAPI démarre après avoir été inscrit auprès du répertoire TAPI. |
...
| Supérieurs possibles          | [**Organisation de l’unité d’organisation**](c-organizationalunit.md)[](c-organization.md)    |
| Classes auxiliaires           | \-                                                                                           |
...
| [**MS-TAPI-IP-adresse**](a-mstapi-ipaddress.md)                            | Faux     | **MS-TAPI-RT-person**           |
| [**MS-TAPI-unique-identifier**](a-mstapi-uid.md)                           | Faux     | **MS-TAPI-RT-person**           |
