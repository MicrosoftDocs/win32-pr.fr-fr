...
ms.locfileid: "118961088"
---
# <a name="ms-com-userpartitionsetlink-attribute"></a>attribut ms-COM-UserPartitionSetLink

Lien utilisé pour associer un utilisateur à un PartitionSet COM+.
...
| Classes utilisées dans        | [**Unité d’organisation**](c-organizationalunit.md)<br/> [**Utilisateur**](c-user.md)<br/> |
