...
ms.locfileid: "118959542"
---
# <a name="rid-set-class"></a>Classe RID-Set

Il y en a un pour chaque contrôleur de domaine. Il contient les pools RID qui ont été alloués par le contrôleur de service.
...
| Supérieurs possibles          | [**Utilisateur**](c-user.md) du [**conteneur**](c-container.md)d' [**ordinateurs**](c-computer.md)         |
| Classes auxiliaires           | \-                                                                                           |
...
| [**RID-allocation-pool**](a-ridallocationpool.md)                        | Vrai      | **RID-définir**                     |
| [**RID-Next-RID**](a-ridnextrid.md)                                      | Vrai      | **RID-définir**                     |
| [**RID-précédent-allocation-pool**](a-ridpreviousallocationpool.md)       | Vrai      | **RID-définir**                     |
| [**RID-used-pool**](a-ridusedpool.md)                                    | Vrai      | **RID-définir**                     |
