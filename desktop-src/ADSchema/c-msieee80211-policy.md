...
ms.locfileid: "118175753"
---
# <a name="ms-ieee-80211-policy-class"></a>classe ms-IEEE-80211-Policy

Classe pour stocker l’objet stratégie de réseau sans fil.



| Entrée | Valeur |
|-------------------|----------------------------------------------------------------------------------|
| CN                | MS-IEEE-80211-stratégie                                                             |
| LDAP-Display-Name | msieee80211-stratégie                                                               |
| Mettre à jour le privilège  | Administrateur de domaine                                                             |
| Fréquence des mises à jour  | Chaque fois qu’un administrateur de domaine modifie la stratégie de réseau sans fil pour un domaine ou une unité d’organisation. |
...
| [**MS-IEEE-80211-données**](a-msieee80211-data.md)                            | Faux     | **MS-IEEE-80211-stratégie**        |
| [**MS-IEEE-80211-type de données**](a-msieee80211-datatype.md)                   | Faux     | **MS-IEEE-80211-stratégie**        |
| [**MS-IEEE-80211-ID**](a-msieee80211-id.md)                                | Faux     | **MS-IEEE-80211-stratégie**        |
