...
Affine l’étendue de gestion d’un objet stratégie de groupe. Ajoute une liste de règles, exprimée sous la forme de requêtes WQL qui sont exécutées sur l’ordinateur cible. Toutes les requêtes doivent retourner des résultats pour que ce SOM s’applique à la cible.
...
| Mettre à jour le privilège  | Administrateur stratégie de groupe           |
...
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | Faux     | **MS-WMI-som**                  |
