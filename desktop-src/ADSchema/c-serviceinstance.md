...
description: objet de point de connexion utilisé par le service de nom d’inscription et de résolution de Windows sockets (RnR), accessible via les api Windowss WSA \ des sockets.
...
ms.locfileid: "118959528"
---
# <a name="service-instance-class"></a>Classe Service-Instance

objet de point de connexion utilisé par le service de nom d’inscription et de résolution de Windows sockets (RnR), accessible via les api WSA Windows sockets \* .
...
| [**Nom complet**](a-displayname.md)                                     | Vrai      | **Service-instance** [ **supérieure**](c-top.md)<br/>                                     |
...
| [**ID de classe de service**](a-serviceclassid.md)                              | Vrai      | **Instance de service**                                                                     |
| [**Version de l’instance de service**](a-serviceinstanceversion.md)              | Faux     | **Instance de service**                                                                     |
...
| [**Adresses Winsock**](a-winsockaddresses.md)                           | Faux     | **Instance de service**                                                                     |
