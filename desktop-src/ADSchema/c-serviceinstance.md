...
Objet de point de connexion utilisé par le service de nom RnR (Registration and Resolution) Windows Sockets, accessible via les API de Windows Sockets WSA \* .
