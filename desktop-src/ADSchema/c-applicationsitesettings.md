...
keywords:
- schéma AD de la classe de Paramètres de Site d’Application
...
ms.locfileid: "119703909"
---
# <a name="application-site-settings-class"></a>classe de Paramètres de Site d’Application

Contient tous les paramètres spécifiques au site.



| Entrée | Valeur |
|-------------------|------------------------------------------------------|
| CN                | Application-Site-Paramètres                            |
| LDAP-Display-Name | applicationSiteSettings                              |
| Mettre à jour le privilège  | Le système définit cette valeur.                          |
| Fréquence des mises à jour  | Chaque fois que ce droit étendu s’applique à une nouvelle classe. |
...
| [**Nom de l’application**](a-applicationname.md)                             | Faux     | **Application-Site-Paramètres**   |
...
| [**Notification-liste**](a-notificationlist.md)                           | Faux     | **Application-Site-Paramètres**   |
