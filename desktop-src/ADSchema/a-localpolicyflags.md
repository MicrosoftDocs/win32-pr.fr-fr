...
ms.locfileid: "119301849"
---
# <a name="local-policy-flags-attribute"></a>Attribut local-Policy-Flags

Indicateurs qui déterminent où un ordinateur obtient sa stratégie. Local-Policy-Reference.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Indicateurs de stratégie locale                   |
