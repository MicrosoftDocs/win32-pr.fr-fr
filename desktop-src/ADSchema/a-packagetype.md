...
ms.locfileid: "119081503"
---
# <a name="package-type-attribute"></a>Attribut Package-Type

Cet attribut décrit le type d’installation requis pour un package d’application, par exemple, MSI, EXE, CAB.
