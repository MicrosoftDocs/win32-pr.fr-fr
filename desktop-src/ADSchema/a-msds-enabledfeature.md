...
---
# <a name="ms-ds-enabled-feature-attribute"></a>ms-DS-Enabled-Feature (attribut)

Fonctionnalités facultatives activées.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | Fonctionnalité ms-DS-Enabled                   |
...
| Classes utilisées dans        | [**Cross-Ref-Container**](c-crossrefcontainer.md)<br/> [**Domain-DNS**](c-domaindns.md)<br/> [**NTDS-DSA**](c-ntdsdsa.md)<br/> |
