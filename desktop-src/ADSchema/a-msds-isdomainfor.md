...
ms.locfileid: "118685109"
---
# <a name="ms-ds-is-domain-for-attribute"></a>attribut ms-DS-is-Domain-pour

Lien vers l’arrière pour [**ms-DS-has-Domain-NC**](a-msds-hasdomainncs.md). Identifie les contrôleurs de domaine qui détiennent cette partition en tant que domaine principal.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | ms-DS-est-domain-pour                     |
