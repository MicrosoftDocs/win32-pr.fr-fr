...
---
# <a name="trust-auth-incoming-attribute"></a>Trust-auth-attribute entrante

Informations d’authentification pour la partie entrante d’une approbation.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Trust-auth-entrant                                   |
