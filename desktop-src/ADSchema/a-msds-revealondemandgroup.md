...
ms.locfileid: "119925419"
---
# <a name="ms-ds-reveal-ondemand-group-attribute"></a>attribut ms-DS-Reveal-OnDemand-Group

Utilisé avec les contrôleurs de domaine en lecture seule pour définir les utilisateurs, les ordinateurs et les groupes qui sont autorisés à mettre en cache leurs mots de passe sur un RODC.
...
| Classes utilisées dans        | [**Computer**](c-computer.md)<br/> [**NTDS-DSA**](c-ntdsdsa.md)<br/> |
