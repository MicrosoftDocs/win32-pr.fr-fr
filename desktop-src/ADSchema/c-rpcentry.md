...
ms.locfileid: "119801549"
---
# <a name="rpc-entry-class"></a>classe d’entrée RPC

Classe abstraite dont les sous-classes sont utilisées par le service de noms RPC (NS), accessible à l’aide des \* fonctions RpcNs dans l’API Win32.
