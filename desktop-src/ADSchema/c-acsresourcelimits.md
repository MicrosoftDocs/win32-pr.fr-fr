...
Contient les limites de ressources réservables pour un sous-réseau. Ces limites peuvent être pour chaque type de service ACS ou pour tous les types de service.



| Entrée | Valeur |
|-------------------|------------------------------------------------|
| CN                | ACS-limites de ressources                            |
