...
ms.locfileid: "119922449"
---
# <a name="ms-ds-claim-type-class"></a>classe ms-DS-claim-type

Une instance de cette classe contient la définition d’un type de revendication qui peut être défini sur les principaux de sécurité.
...
|-------------------|--------------------------------------|
| CN                | ms-DS-claim-type                     |
| LDAP-Display-Name | MSDSM-ClaimType                       |
...
| Sous-classe de                 | [**ms-DS-claim-type-Property-base**](c-msds-claimtypepropertybase.md)<br/>            |
| Supérieurs possibles          | [**ms-DS-claim-types**](c-msds-claimtypes.md)                                               |
| Classes auxiliaires           | \-                                                                                           |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                 |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; EA) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA |
...
| [**Activé**](a-enabled.md)                                                                 | Faux     | [**ms-DS-claim-type-Property-base**](c-msds-claimtypepropertybase.md)<br/> |
...
| [**ms-DS-claim-attribute-source**](a-msds-claimattributesource.md)                          | Faux     | **ms-DS-claim-type**                                                              |
| [**ms-DS-revendication-is-Single-Valued**](a-msds-claimissinglevalued.md)                           | Faux     | **ms-DS-claim-type**                                                              |
| [**ms-DS-revendication-is-value-Space-Restricted**](a-msds-claimisvaluespacerestricted.md)          | Faux     | **ms-DS-claim-type**                                                              |
| [**ms-DS-claim-possibles-valeurs**](a-msds-claimpossiblevalues.md)                            | Faux     | [**ms-DS-claim-type-Property-base**](c-msds-claimtypepropertybase.md)<br/> |
| [**ms-DS-claim-parts-possibles-values-with**](a-msds-claimsharespossiblevalueswith.md)      | Faux     | [**ms-DS-claim-type-Property-base**](c-msds-claimtypepropertybase.md)<br/> |
| [**ms-DS-claim-shares-possibles-values-with-BL**](a-msds-claimsharespossiblevalueswithbl.md) | Faux     | [**Retour au début**](c-top.md)<br/>                                                   |
| [**ms-DS-revendication-source**](a-msds-claimsource.md)                                             | Faux     | **ms-DS-claim-type**                                                              |
| [**ms-DS-claim-source-type**](a-msds-claimsourcetype.md)                                    | Faux     | **ms-DS-claim-type**                                                              |
| [**ms-DS-claim-type-s’applique à classe**](a-msds-claimtypeappliestoclass.md)                  | Faux     | **ms-DS-claim-type**                                                              |
| [**ms-DS-claim-value-type**](a-msds-claimvaluetype.md)                                      | Faux     | **ms-DS-claim-type**                                                              |
