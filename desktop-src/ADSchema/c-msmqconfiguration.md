...
Cet objet contient des paramètres de configuration MSMQ pour un ordinateur spécifique. Les attributs de cette classe sont spécifiques à MSMQ et sont utilisés pour les décisions de routage MSMQ.
...
| Fréquence des mises à jour  | Une instance de cette classe est créée pour chaque ordinateur qui installe MSMQ, sous l’objet ordinateur. |
...
| Supérieurs possibles          | [**Computer**](c-computer.md)                                                               |
| Classes auxiliaires           | \-                                                                                           |
...
| [**MSMQ-Computer-type**](a-msmqcomputertype.md)                          | Faux     | **Configuration MSMQ**          |
| [**MSMQ-Computer-type-ex**](a-msmqcomputertypeex.md)                     | Faux     | **Configuration MSMQ**          |
| [**MSMQ-dependent-client-services**](a-msmqdependentclientservices.md)   | Faux     | **Configuration MSMQ**          |
| [**MSMQ-DS-services**](a-msmqdsservices.md)                              | Faux     | **Configuration MSMQ**          |
| [**Clé de chiffrement MSMQ**](a-msmqencryptkey.md)                              | Faux     | **Configuration MSMQ**          |
| [**MSMQ-étranger**](a-msmqforeign.md)                                     | Faux     | **Configuration MSMQ**          |
| [**MSMQ-in-Routing-serveurs**](a-msmqinroutingservers.md)                 | Faux     | **Configuration MSMQ**          |
| [**MSMQ-journal-quota**](a-msmqjournalquota.md)                          | Faux     | **Configuration MSMQ**          |
| [**Type de système d’exploitation MSMQ-**](a-msmqostype.md)                                      | Faux     | **Configuration MSMQ**          |
| [**MSMQ-out-Routing-serveurs**](a-msmqoutroutingservers.md)               | Faux     | **Configuration MSMQ**          |
| [**MSMQ-owner-ID**](a-msmqownerid.md)                                    | Faux     | **Configuration MSMQ**          |
| [**MSMQ-quota**](a-msmqquota.md)                                         | Faux     | **Configuration MSMQ**          |
| [**Services de routage MSMQ**](a-msmqroutingservices.md)                    | Faux     | **Configuration MSMQ**          |
| [**Type de service MSMQ**](a-msmqservicetype.md)                            | Faux     | **Configuration MSMQ**          |
| [**Clé de signature MSMQ**](a-msmqsignkey.md)                                    | Faux     | **Configuration MSMQ**          |
| [**Sites MSMQ**](a-msmqsites.md)                                         | Faux     | **Configuration MSMQ**          |
