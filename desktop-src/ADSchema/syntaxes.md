...
---
# <a name="syntaxes"></a>Syntaxes

Les syntaxes suivantes sont définies par Active Directory.

<dl>

[**Boolean**](s-boolean.md)  
[**Enumeration**](s-enumeration.md)  
[**Énumération (mécanisme de remise)**](s-enumeration-delivery-mechanism.md)  
[**Énumération (export-information-Level)**](s-enumeration-export-information-level.md)  
[**Énumération (par défaut-Delivery-Method)**](s-enumeration-preferred-delivery-method.md)  
[**Entière**](s-integer.md)  
[**Défini**](s-interval.md)  
...
[**Chaîne (respect de la casse)**](s-string-case-sensitive.md)  
