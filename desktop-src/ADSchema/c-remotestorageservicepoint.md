---
title: classe de Point de Service Stockage à distance
...
keywords:
- schéma AD de la classe de Point de Service Stockage à distance
...
ms.locfileid: "118959688"
---
# <a name="remote-storage-service-point-class"></a>classe de Point de Service Stockage à distance

Cette classe contient des informations sur l’emplacement de stockage distant pour les fichiers qui sont stockés hors connexion.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Point de Service Stockage à distance         |
...
| [**GUID Stockage à distance**](a-remotestorageguid.md)                        | Faux     | **Point de Service Stockage à distance**                                                         |
