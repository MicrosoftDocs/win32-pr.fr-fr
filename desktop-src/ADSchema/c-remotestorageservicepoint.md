...
---
# <a name="remote-storage-service-point-class"></a>Classe de point de service de stockage distant
...
| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Point de service de stockage distant         |
...
| [**Remote-Storage-GUID**](a-remotestorageguid.md)                        | Faux     | **Point de service de stockage distant**                                                         |
