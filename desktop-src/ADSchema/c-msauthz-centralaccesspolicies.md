...
ms.locfileid: "118959898"
---
# <a name="ms-authz-central-access-policies-class"></a>MS-auth-central-Access-Class (classe)

Un conteneur de cette classe peut contenir des objets de stratégie d’accès centralisée.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-auth-central-Access-stratégies     |
