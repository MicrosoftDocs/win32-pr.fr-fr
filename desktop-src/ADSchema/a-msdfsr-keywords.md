...
Contient les mots clés définis par l’utilisateur.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | MS-DFSR-Mots clés                            |
| LDAP-Display-Name | msDFSR-Mots clés                             |
| Taille              | \-                                          |
...
| Classes utilisées dans        | [**MS-DFSR-membre**](c-msdfsr-member.md)<br/> [**MS-DFSR-connexion**](c-msdfsr-connection.md)<br/> |
