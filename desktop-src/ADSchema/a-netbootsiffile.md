...
ms.locfileid: "119648479"
---
# <a name="netboot-sif-file-attribute"></a>Attribut netboot-SIF-file

L’attribut **netboot-SIF-file** est réservé à un usage interne.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | Netboot-SIF-fichier                            |
