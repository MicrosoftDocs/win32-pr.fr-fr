...
ms.locfileid: "119549119"
---
# <a name="security-principal-class"></a>Classe Security-Principal

Contient les informations de sécurité pour un objet.
...
|------------------------------------------------------------------------------|-----------|--------------------------------------------------------|
| [**Nom-compte-historique**](a-accountnamehistory.md)                         | Faux     | **Sécurité-principal**                                 |
...
| [**Alt-sécurité-identités**](a-altsecurityidentities.md)                   | Faux     | **Sécurité-principal**                                 |
...
| [**Descripteur de sécurité NT**](a-ntsecuritydescriptor.md)                     | Vrai      | **Sécurité-principal** [ **supérieur**](c-top.md)<br/> |
...
| [**SID de l’objet**](a-objectsid.md)                                            | Vrai      | **Sécurité-principal**                                 |
...
| [**RID**](a-rid.md)                                                         | Faux     | **Sécurité-principal**                                 |
| [**Nom de compte SAM**](a-samaccountname.md)                                 | Vrai      | **Sécurité-principal**                                 |
| [**Type de compte SAM**](a-samaccounttype.md)                                 | Faux     | **Sécurité-principal**                                 |
| [**SD-droits-effectifs**](a-sdrightseffective.md)                           | Faux     | [**Retour au début**](c-top.md)<br/>                        |
| [**Identificateur de sécurité**](a-securityidentifier.md)                          | Faux     | **Sécurité-principal**                                 |
...
| [**SID-historique**](a-sidhistory.md)                                          | Faux     | **Sécurité-principal**                                 |
...
| [**Informations d’identification supplémentaires**](a-supplementalcredentials.md)                | Faux     | **Sécurité-principal**                                 |
| [**Indicateurs système**](a-systemflags.md)                                        | Faux     | [**Retour au début**](c-top.md)<br/>                        |
| [**Jetons-groupes**](a-tokengroups.md)                                        | Faux     | **Sécurité-principal**                                 |
| [**Token-Groups-global-et-Universal**](a-tokengroupsglobalanduniversal.md) | Faux     | **Sécurité-principal**                                 |
| [**Token-Groups-non-GC-acceptable**](a-tokengroupsnogcacceptable.md)         | Faux     | **Sécurité-principal**                                 |
...
| [**MS-DS-Consistency-enfant-nombre**](a-ms-ds-consistencychildcount.md)       | Faux     | [**Retour au début**](c-top.md)<br/>                        |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                    | Faux     | [**Retour au début**](c-top.md)<br/>                        |
| [**ms-DS-KeyVersionNumber**](a-msds-keyversionnumber.md)                    | Faux     | **Sécurité-principal**                                 |
