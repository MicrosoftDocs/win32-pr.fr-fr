...
---
# <a name="msmq-routing-service-attribute"></a>Attribut MSMQ-Routing-service

Indique si ce serveur fournit des services de routage.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Service de routage MSMQ                 |
...
| Classes utilisées dans        | [**Paramètres MSMQ**](c-msmqsettings.md)<br/> |
