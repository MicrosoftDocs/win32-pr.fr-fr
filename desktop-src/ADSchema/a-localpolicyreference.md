...
ms.locfileid: "119301819"
---
# <a name="local-policy-reference-attribute"></a>Attribut de référence de stratégie locale

Nom unique d’un objet stratégie local à partir duquel un objet de stratégie est copié.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | Informations de référence sur la stratégie locale                  |
