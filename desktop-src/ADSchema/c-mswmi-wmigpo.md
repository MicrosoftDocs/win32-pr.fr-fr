...
ms.locfileid: "119753629"
---
# <a name="ms-wmi-wmigpo-class"></a>classe ms-WMI-WMIGPO

Cette valeur est écrite dans le Active Directory dans le chemin d’accès vers lequel pointe l’objet stratégie de groupe correspondant. Il a pour but de relier les différents objets utilisés pour exprimer les extensions WMI à l’infrastructure stratégie de groupe.
...
| [**MS-WMI-intFlags1**](a-mswmi-intflags1.md)                               | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-intFlags2**](a-mswmi-intflags2.md)                               | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-intFlags3**](a-mswmi-intflags3.md)                               | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-intFlags4**](a-mswmi-intflags4.md)                               | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-parm1**](a-mswmi-parm1.md)                                       | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm2**](a-mswmi-parm2.md)                                       | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm3**](a-mswmi-parm3.md)                                       | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-Parm4**](a-mswmi-parm4.md)                                       | Faux     | **MS-WMI-WMIGPO**               |
| [**MS-WMI-TargetClass**](a-mswmi-targetclass.md)                           | Vrai      | **MS-WMI-WMIGPO**               |
