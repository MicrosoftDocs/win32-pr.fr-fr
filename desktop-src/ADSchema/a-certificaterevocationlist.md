...
---
# <a name="certificate-revocation-list-attribute"></a>Attribut de liste de révocation de certificats

Représente une liste de certificats qui ont été révoqués.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Certificat-révocation-liste                           |
...
| Classes utilisées dans        | [**Autorité de certification**](c-certificationauthority.md)<br/> [**Point de distribution de liste de révocation de certificats**](c-crldistributionpoint.md)<br/> |
