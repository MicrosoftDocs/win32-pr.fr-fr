...
ms.locfileid: "119925499"
---
# <a name="ms-ds-revealed-dsas-attribute"></a>attribut ms-DS-Reveal-DSA

Lien vers l’arrière pour [**ms-DS-Revealed-Users**](a-msds-revealedusers.md). Identifie le contrôleur de domaine en lecture seule qui détient le secret de cet utilisateur.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | ms-DS-dévoilé-DSA                     |
