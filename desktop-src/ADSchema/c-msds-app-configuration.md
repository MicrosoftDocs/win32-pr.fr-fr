...
Utilisé pour stocker les informations de paramètres pour une application. L’attribut [**ms-DS-Settings**](a-msds-settings.md) doit être utilisé pour stocker les valeurs réelles.
...
| [**Mots clés**](a-keywords.md)                                              | Faux     | **ms-DS-App-configuration**                                      |
