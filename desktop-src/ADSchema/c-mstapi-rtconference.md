...
ms.locfileid: "119879409"
---
# <a name="ms-tapi-rt-conference-class"></a>MS-TAPI-RT-classe Conference

Utilisé pour publier une conférence de multidiffusion TAPI en temps réel.



| Entrée | Valeur |
|-------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CN                | MS-TAPI-RT-Conférence                                                                                                                                                                                    |
| LDAP-Display-Name | msTAPI-RtConference                                                                                                                                                                                      |
| Mettre à jour le privilège  | Aucun privilège spécial n’est requis.                                                                                                                                                                          |
| Fréquence des mises à jour  | La fréquence de création est laissée à la discrétion de l’utilisateur chaque fois qu’une conférence TAPI doit être publiée. Une fois créé, la durée de vie standard d’un objet de conférence TAPI peut être comprise entre 30 minutes et 1 an. |
...
| Supérieurs possibles          | [**Unité d’organisation**](c-organizationalunit.md)                                          |
| Classes auxiliaires           | \-                                                                                           |
...
| [**MS-TAPI-Conference-BLOB**](a-mstapi-conferenceblob.md)                  | Faux     | **MS-TAPI-RT-Conférence**       |
| [**MS-TAPI-Protocol-ID**](a-mstapi-protocolid.md)                          | Faux     | **MS-TAPI-RT-Conférence**       |
| [**MS-TAPI-unique-identifier**](a-mstapi-uid.md)                           | Vrai      | **MS-TAPI-RT-Conférence**       |
