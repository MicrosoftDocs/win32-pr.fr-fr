...
---
# <a name="content-indexing-allowed-attribute"></a>Content-Indexing-attribut allowed

Indique si le contenu de l’objet de volume peut être indexé.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Indexation de contenu-autorisée             |
...
| Classes utilisées dans        | [**Volume**](c-volume.md)<br/> |
