...
---
# <a name="per-msg-dialog-display-table-attribute"></a>Attribut de table d’affichage de boîte de dialogue par MSG

Table d’affichage MAPI des options par message.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Par MSG-boîte de dialogue-Affichage-table                          |
