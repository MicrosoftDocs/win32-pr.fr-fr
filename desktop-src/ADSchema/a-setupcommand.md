...
---
# <a name="setup-command-attribute"></a>Attribut Setup-Command

Cet attribut indique si une commande d’installation est requise pour configurer cette application.
