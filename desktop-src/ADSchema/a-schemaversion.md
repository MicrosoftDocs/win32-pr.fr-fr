...
---
# <a name="schema-version-attribute"></a>Attribut Schema-Version
...
| Fréquence des mises à jour  | Chaque fois que le schéma est libéré.    |
...
| Classes utilisées dans        | [**Conteneur**](c-container.md)<br/> |
