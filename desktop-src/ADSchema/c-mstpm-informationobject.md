...
---
# <a name="ms-tpm-information-object-class"></a>ms-TPM-information-classe d’objets

Cette classe contient les informations de récupération d’un appareil de Module de plateforme sécurisée (TPM) (TPM).



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ms-TPM-information-objet            |
...
| Supérieurs possibles          | [**ms-TPM-information-Objects-Container**](c-mstpm-informationobjectscontainer.md)                  |
| Classes auxiliaires           | \-                                                                                                   |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                         |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLO ;;;D C) (A ;; WP ;;; PROPRIÉTAIRE |
...
| [**ms-TPM-OwnerInformation**](a-mstpm-ownerinformation.md)                                  | Vrai      | **ms-TPM-information-objet**   |
| [**ms-TPM-owner-information-Temp**](a-mstpm-ownerinformationtemp.md)                        | Faux     | **ms-TPM-information-objet**   |
| [**ms-TPM-SRK-pub-empreinte**](a-mstpm-srkpubthumbprint.md)                                | Faux     | **ms-TPM-information-objet**   |
