...
ms.locfileid: "119835860"
---
# <a name="system-only-attribute"></a>Attribut System-Only

Valeur booléenne qui spécifie si seul Active Directory peut modifier la classe. Les classes uniquement du système peuvent être créées ou supprimées par l’agent de système d’annuaire.
...
| Classes utilisées dans        | [**Attribut-schéma**](c-attributeschema.md)<br/> [**Classe-schéma**](c-classschema.md)<br/> |
