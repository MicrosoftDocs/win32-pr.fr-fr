...
ms.locfileid: "119880319"
---
# <a name="ms-ds-az-role-class"></a>ms-DS-AZ-Role Class

Définit un ensemble d’opérations qui peuvent être effectuées par un ensemble particulier d’utilisateurs dans une étendue particulière.
...
|-------------------|-----------------------------------------|
| CN                | ms-DS-AZ-Role                           |
| LDAP-Display-Name | msDS-balise azrole                             |
...
| [**Description**](a-description.md)                                        | Faux     | **ms-DS-AZ-Role** [ **Top**](c-top.md)<br/> |
...
| [**ms-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)               | Faux     | **ms-DS-AZ-Role**                                 |
...
| [**ms-DS-Members-for-AZ-Role**](a-msds-membersforazrole.md)                | Faux     | **ms-DS-AZ-Role**                                 |
...
| [**ms-DS-Operations-for-AZ-Role**](a-msds-operationsforazrole.md)          | Faux     | **ms-DS-AZ-Role**                                 |
...
| [**ms-DS-tâches-for-AZ-Role**](a-msds-tasksforazrole.md)                    | Faux     | **ms-DS-AZ-Role**                                 |
...
| [**ms-DS-AZ-Application-Data**](a-msds-azapplicationdata.md)                  | Faux     | **ms-DS-AZ-Role**                                 |
| [**ms-DS-AZ-Generic-Data**](a-msds-azgenericdata.md)                          | Faux     | **ms-DS-AZ-Role**                                 |
| [**ms-DS-AZ-Object-GUID**](a-msds-azobjectguid.md)                            | Faux     | **ms-DS-AZ-Role**                                 |
| [**MS-DS-Consistency-enfant-nombre**](a-ms-ds-consistencychildcount.md)         | Faux     | [**Retour au début**](c-top.md)<br/>                   |
| [**MS-DS-Consistency-Guid**](a-ms-ds-consistencyguid.md)                      | Faux     | [**Retour au début**](c-top.md)<br/>                   |
