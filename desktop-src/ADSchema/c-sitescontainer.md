...
ms.locfileid: "119548869"
---
# <a name="sites-container-class"></a>Classe Sites-Container

Conteneur pour le stockage des objets de site. Situé dans le contexte d’appellation de configuration.
...
| Mettre à jour le privilège  | Cet objet est géré par le système. |
| Fréquence des mises à jour  | Lors de la création du service d’annuaire.   |
...
| Supérieurs possibles          | [**Configuration**](c-configuration.md)                                                     |
| Classes auxiliaires           | \-                                                                                           |
