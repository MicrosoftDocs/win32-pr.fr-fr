...
ms.locfileid: "119753069"
---
# <a name="pki-enrollment-service-class"></a>Classe de service d’infrastructure à clé publique

Serveur de certificats qui peut traiter les demandes de certificat et émettre des certificats.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Infrastructure à clé publique-service d’inscription               |
...
| [**Certificat d’autorité de certification**](a-cacertificate.md)                                 | Faux     | **Infrastructure à clé publique-service d’inscription**      |
| [**CA-Certificate-DN**](a-cacertificatedn.md)                            | Faux     | **Infrastructure à clé publique-service d’inscription**      |
| [**Nom canonique**](a-canonicalname.md)                                 | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**Certificat-modèles**](a-certificatetemplates.md)                   | Faux     | **Infrastructure à clé publique-service d’inscription**      |
...
| [**Nom d’hôte DNS**](a-dnshostname.md)                                    | Faux     | **Infrastructure à clé publique-service d’inscription**      |
...
| [**Inscription-fournisseurs**](a-enrollmentproviders.md)                     | Faux     | **Infrastructure à clé publique-service d’inscription**      |
...
| [**Signatures-algorithmes**](a-signaturealgorithms.md)                     | Faux     | **Infrastructure à clé publique-service d’inscription**      |
...
| [**ms-DS-tâches-pour-AZ-Task-BL**](a-msds-tasksforaztaskbl.md)                    | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**ms-Exch-owner-BL**](a-ownerbl.md)                                            | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**MS-PKI-inscription-serveurs**](a-mspki-enrollment-servers.md)                  | Faux     | **Infrastructure à clé publique-service d’inscription**      |
| [**MS-PKI-Site-Name**](a-mspki-site-name.md)                                    | Faux     | **Infrastructure à clé publique-service d’inscription**      |
| [**msSFU-30-POSIX-Member-of**](a-mssfu30posixmemberof.md)                       | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                         | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**Non-sécurité-membre-BL**](a-nonsecuritymemberbl.md)                          | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**Descripteur de sécurité NT**](a-ntsecuritydescriptor.md)                         | Vrai      | [**Retour au début**](c-top.md)<br/> |
