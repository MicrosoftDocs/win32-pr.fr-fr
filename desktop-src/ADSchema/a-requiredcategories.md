...
Cet attribut contient une liste d’ID de catégorie de composant qu’un objet (par exemple, une application) requiert pour s’exécuter.
...
| Classes utilisées dans        | [**Inscription de classe**](c-classregistration.md)<br/> |
