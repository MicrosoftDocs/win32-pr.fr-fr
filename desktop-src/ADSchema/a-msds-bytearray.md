...
---
# <a name="ms-ds-byte-array-attribute"></a>attribut ms-DS-Byte-array

Attribut permettant de stocker des données binaires.
...
| Classes utilisées dans        | [**ms-DS-App-configuration**](c-msds-app-configuration.md)<br/> [**ms-DS-App-données**](c-msds-appdata.md)<br/> |
