...
---
# <a name="ms-ds-has-domain-ncs-attribute"></a>attribut ms-DS-has-domaine-NC

Informations de réplication du service d’annuaire qui détaillent les contextes d’attribution de noms de domaine présents sur un serveur particulier.



| Entrée | Valeur |
|-------------------|-----------------------------------------------------|
| CN                | ms-DS-a-Domain-NC                                |
| LDAP-Display-Name | msDS-HasDomainNCs                                   |
| Taille              | \-                                                  |
| Mettre à jour le privilège  | Cette valeur est définie par le système.                     |
| Fréquence des mises à jour  | Il est défini par DCPromo et n’est jamais modifié par la suite. |
| Attribute-Id      | 1.2.840.113556.1.4.1820                             |
| System-ID-GUID    | 6f17e347-a842-4498-b8b3-15e007da4fed                |
