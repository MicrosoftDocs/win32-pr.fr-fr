...
Utilisé pour définir un groupe de files d’attente MSMQ (également appelé liste de distribution).
...
|-------------------|---------------------------------------------------------|
| CN                | MSMQ-Group                                              |
| LDAP-Display-Name | Groupe msMQ                                              |
| Mettre à jour le privilège  | Propriétaire de la file d’attente.                                        |
| Fréquence des mises à jour  | Chaque fois qu’un membre est ajouté à un groupe ou en est supprimé. |
...
| [**Membre**](a-member.md)                                                  | Vrai      | **Groupe MSMQ**                  |
