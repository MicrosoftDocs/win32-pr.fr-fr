...
---
# <a name="create-wizard-ext-attribute"></a>Créer-Assistant-attribut ext

GUID des extensions d’Assistant pour la création de l’objet associé.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | Créer-Assistant-ext                           |
