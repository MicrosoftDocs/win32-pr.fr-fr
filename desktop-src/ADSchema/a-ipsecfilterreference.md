...
---
# <a name="ipsec-filter-reference-attribute"></a>IPSec-Filter-Reference (attribut)

L’attribut **IPSec-Filter-Reference** est destiné à un usage interne uniquement.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | IPSec-filtre-référence                  |
...
| Classes utilisées dans        | [**IPSec-NFA**](c-ipsecnfa.md)<br/> |
