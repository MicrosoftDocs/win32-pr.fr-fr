...
ms.locfileid: "119322519"
---
# <a name="ipsec-nfa-reference-attribute"></a>IPSec-NFA-attribut de référence

L’attribut de **référence IPSec-NFA** est destiné à un usage interne uniquement.



| Entrée | Valeur |
|-------------------|-----------------------------------------|
| CN                | IPSec-NFA-référence                     |
...
| Classes utilisées dans        | [**Stratégie IPSec**](c-ipsecpolicy.md)<br/> |
