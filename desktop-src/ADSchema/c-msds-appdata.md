...
ms.locfileid: "119880559"
---
# <a name="ms-ds-app-data-class"></a>classe ms-DS-App-Data

Stocke les données qui doivent être utilisées par un objet. Par exemple, les informations de profil d’un objet utilisateur.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ms-DS-App-données                       |
...
| [**Mot**](a-keywords.md)                                              | Faux     | **ms-DS-App-données**                                               |
| [**Dernier-parent connu**](a-lastknownparent.md)                              | Faux     | [**Retour au début**](c-top.md)<br/>                                  |
| [**Géré par**](a-managedby.md)                                           | Faux     | **ms-DS-App-données**                                               |
...
| [**ms-DS-Byte-array**](a-msds-bytearray.md)                                | Faux     | **ms-DS-App-données**                                               |
...
| [**ms-DS-date-heure**](a-msds-datetime.md)                                  | Faux     | **ms-DS-App-données**                                               |
| [**ms-DS-entier**](a-msds-integer.md)                                     | Faux     | **ms-DS-App-données**                                               |
...
| [**ms-DS-objet-référence**](a-msds-objectreference.md)                    | Faux     | **ms-DS-App-données**                                               |
...
| [**Propriétaire**](a-owner.md)                                                    | Faux     | **ms-DS-App-données**                                               |
