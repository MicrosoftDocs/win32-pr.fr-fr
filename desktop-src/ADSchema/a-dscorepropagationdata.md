...
ms.locfileid: "119706199"
---
# <a name="ds-core-propagation-data-attribute"></a>Active Directory-Core-Propagate-attribut de données

L’attribut **DS-Core-Propagate-Data** est destiné à un usage interne uniquement.



| Entrée | Valeur |
|-------------------|---------------------------------------------------------------|
| CN                | DS-Core-propagation-données                                      |
