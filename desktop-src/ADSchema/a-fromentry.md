...
Il s’agit d’un attribut construit qui a la **valeur true** si l’objet est accessible en écriture et **false** s’il est en lecture seule, par exemple, une instance de réplica gc.
