...
ms.locfileid: "119022957"
---
# <a name="acs-cache-timeout-attribute"></a>Attribut ACS-cache-Timeout

Durée avant l’expiration des objets ACS mis en cache par le service ACS.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ACS-cache-délai d’expiration                    |
