...
Action de reconnexion de session des services Terminal Server spécifie s’il faut autoriser la reconnexion à une session des services Terminal Server déconnectée à partir de n’importe quel ordinateur client.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-TS-reconnexion-action            |
