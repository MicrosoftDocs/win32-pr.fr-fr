...
ms.locfileid: "119835019"
---
# <a name="ipsec-policy-class"></a>Classe Ipsec-Policy

La classe de **stratégie IPSec** est destinée à un usage interne uniquement.
...
| [**IPsec-ISAKMP-référence**](a-ipsecisakmpreference.md)                  | Faux     | **Stratégie IPSec**                             |
| [**Nom d’IPSec**](a-ipsecname.md)                                         | Faux     | [**IPSec-de base**](c-ipsecbase.md)<br/> |
| [**IPSec-NFA-référence**](a-ipsecnfareference.md)                        | Faux     | **Stratégie IPSec**                             |
