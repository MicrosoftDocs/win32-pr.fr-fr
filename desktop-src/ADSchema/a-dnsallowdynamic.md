...
ms.locfileid: "119706289"
---
# <a name="dns-allow-dynamic-attribute"></a>Attribut DNS-autoriser-Dynamic

L’attribut **DNS-allow-Dynamic** n’est pas utilisé actuellement.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | DNS-autoriser-dynamique                    |
