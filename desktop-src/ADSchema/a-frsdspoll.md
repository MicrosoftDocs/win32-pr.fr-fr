...
---
# <a name="frs-ds-poll-attribute"></a>Attribut FRS-DS-Poll

Intervalle d’interrogation du service d’annuaire pour le moteur de réplication de fichiers.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Interrogation FRS-DS                          |
