...
---
# <a name="trust-auth-outgoing-attribute"></a>Trust-auth-attribute sortante

Informations d’authentification pour la partie sortante d’une approbation.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Trust-auth-sortante                                   |
