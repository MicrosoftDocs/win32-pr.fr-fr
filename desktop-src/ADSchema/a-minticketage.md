...
ms.locfileid: "118687531"
---
# <a name="min-ticket-age-attribute"></a>Attribut min-ticket-Age

Cet attribut détermine la période minimale, en heures, pendant laquelle le ticket TGT (Ticket-Granting Ticket) d’un utilisateur peut être utilisé pour l’authentification Kerberos avant qu’une demande puisse être renouvelée pour renouveler le ticket.
