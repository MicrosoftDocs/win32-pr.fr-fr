---
title: MSMQ-attribut de durée de vie longue
description: Durée de vie par défaut des messages MSMQ.
ms.assetid: e47bcb0e-6e30-4300-9cfa-c553c2842416
ms.tgt_platform: multiple
keywords:
- MSMQ-schéma AD d’attribut à durée de vie longue
- Schéma AD de l’attribut mSMQLongLived
topic_type:
- apiref
api_name:
- MSMQ-Long-Lived
...
Durée de vie par défaut des messages MSMQ.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MSMQ-durée de vie longue                      |
