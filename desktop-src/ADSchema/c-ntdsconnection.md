...
ms.locfileid: "119081193"
---
# <a name="ntds-connection-class"></a>Classe NTDS-Connection

Connexion à partir d’un contrôleur de périphérique distant.
...
| Supérieurs possibles          | [**NTDS-DSA**](c-ntdsdsa.md)[**NTFRS-réplica-Set**](c-ntfrsreplicaset.md)[**NTFRS-Member**](c-ntfrsmember.md) |
| Classes auxiliaires           | \-                                                                                                               |
...
| [**Activé-connexion**](a-enabledconnection.md)                         | Vrai      | **NTDS-connexion**             |
...
| [**À partir du serveur**](a-fromserver.md)                                       | Vrai      | **NTDS-connexion**             |
...
| [**Générée-connexion**](a-generatedconnection.md)                     | Faux     | **NTDS-connexion**             |
...
| [**MS-DS-répliques-NC-raison**](a-ms-ds-replicatesncreason.md)          | Faux     | **NTDS-connexion**             |
...
| [**Options**](a-options.md)                                              | Vrai      | **NTDS-connexion**             |
...
| [**Planifier**](a-schedule.md)                                            | Faux     | **NTDS-connexion**             |
...
| [**Type de transport**](a-transporttype.md)                                 | Faux     | **NTDS-connexion**             |
...
| RDN-att-ID                  | [**Nom commun**](a-cn.md)<br/> |
| Sous-classe de                 | [**Feuille**](c-leaf.md)<br/>      |
| Supérieurs possibles          | [**NTDS-DSA**](c-ntdsdsa.md)          |
| Classes auxiliaires           | \-                                     |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                           |
