...
ms.locfileid: "119548899"
---
# <a name="site-link-bridge-class"></a>Classe site-Link-Bridge

Objet pour le suivi des liens de sites qui sont connectés de manière transitive.
...
| Fréquence des mises à jour  | À chaque fois qu’une liaison de site doit être ajoutée ou supprimée du pont. |
...
| [**Site-lien-liste**](a-sitelinklist.md)                                  | Vrai      | **Site-lien-pont**            |
