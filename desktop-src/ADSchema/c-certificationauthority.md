...
ms.locfileid: "119701959"
---
# <a name="certification-authority-class"></a>Classe Certification-Authority

Représente un processus qui émet des certificats de clé publique, par exemple un serveur de certificats.
...
| [**Autorité-révocation-liste**](a-authorityrevocationlist.md)            | Vrai      | **Autorité de certification**                                 |
| [**Tête de pont-serveur-liste-BL**](a-bridgeheadserverlistbl.md)             | Faux     | [**Retour au début**](c-top.md)<br/>                             |
| [**Certificat d’autorité de certification**](a-cacertificate.md)                                 | Vrai      | **Autorité de certification**                                 |
| [**CA-Certificate-DN**](a-cacertificatedn.md)                            | Faux     | **Autorité de certification**                                 |
| [**Connecter de l’autorité de certification**](a-caconnect.md)                                         | Faux     | **Autorité de certification**                                 |
| [**Nom canonique**](a-canonicalname.md)                                 | Faux     | [**Retour au début**](c-top.md)<br/>                             |
| [**CA-utilisations**](a-causages.md)                                           | Faux     | **Autorité de certification**                                 |
| [**AUTORITÉ DE CERTIFICATION-WEB-URL**](a-caweburl.md)                                          | Faux     | **Autorité de certification**                                 |
| [**Certificat-révocation-liste**](a-certificaterevocationlist.md)        | Vrai      | **Autorité de certification**                                 |
| [**Certificat-modèles**](a-certificatetemplates.md)                   | Faux     | **Autorité de certification**                                 |
| [**Nom commun**](a-cn.md)                                               | Vrai      | **Certification-autorité** [ **supérieure**](c-top.md)<br/> |
| [**Date et heure de création**](a-createtimestamp.md)                            | Faux     | [**Retour au début**](c-top.md)<br/>                             |
| [**Objet de liste de révocation de certificats**](a-crlobject.md)                                         | Faux     | **Autorité de certification**                                 |
| [**Paire de certificats croisés**](a-crosscertificatepair.md)                  | Faux     | **Autorité de certification**                                 |
| [**En cours-parent-CA**](a-currentparentca.md)                            | Faux     | **Autorité de certification**                                 |
| [**Delta-Revocation-List**](a-deltarevocationlist.md)                    | Faux     | **Autorité de certification**                                 |
...
| [**Nom d’hôte DNS**](a-dnshostname.md)                                    | Faux     | **Autorité de certification**                                 |
| [**ID de domaine**](a-domainid.md)                                           | Faux     | **Autorité de certification**                                 |
| [**Objet de stratégie de domaine**](a-domainpolicyobject.md)                      | Faux     | **Autorité de certification**                                 |
...
| [**Inscription-fournisseurs**](a-enrollmentproviders.md)                     | Faux     | **Autorité de certification**                                 |
...
| [**Parent-CA**](a-parentca.md)                                           | Faux     | **Autorité de certification**                                 |
| [**La chaîne de certificats parent-CA**](a-parentcacertificatechain.md)         | Faux     | **Autorité de certification**                                 |
...
| [**En attente-certificats d’autorité de certification**](a-pendingcacertificates.md)                | Faux     | **Autorité de certification**                                 |
| [**En attente-parent-CA**](a-pendingparentca.md)                            | Faux     | **Autorité de certification**                                 |
| [**Possible-inférieur**](a-possibleinferiors.md)                         | Faux     | [**Retour au début**](c-top.md)<br/>                             |
| [**Précédents-certificats d’autorité de certification**](a-previouscacertificates.md)              | Faux     | **Autorité de certification**                                 |
| [**Previous-parent-CA**](a-previousparentca.md)                          | Faux     | **Autorité de certification**                                 |
...
| [**Rechercher-Guide**](a-searchguide.md)                                     | Faux     | **Autorité de certification**                                 |
...
| [**Signatures-algorithmes**](a-signaturealgorithms.md)                     | Faux     | **Autorité de certification**                                 |
...
| [**Pris en charge-application-Context**](a-supportedapplicationcontext.md)    | Faux     | **Autorité de certification**                                 |
| [**Indicateurs système**](a-systemflags.md)                                     | Faux     | [**Retour au début**](c-top.md)<br/>                             |
| [**TELETEX-identificateur de terminal**](a-teletexterminalidentifier.md)        | Faux     | **Autorité de certification**                                 |
