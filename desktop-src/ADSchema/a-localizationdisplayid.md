...
Permet d’indexer dans le fichier Extrts.mc pour obtenir le displayName localisé pour les objets à des fins d’interface utilisateur.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Localisation-Display-ID              |
