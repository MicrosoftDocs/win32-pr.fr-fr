---
title: classe de conteneur ms-DS-Password-Paramètres
description: Conteneur pour les objets de paramètres de mot de passe.
ms.assetid: 45e55a1d-63a9-41e5-ac54-3ed467251d3d
ms.tgt_platform: multiple
keywords:
- schéma AD de la classe de conteneur ms-DS-Password-Paramètres-Container
...
ms.locfileid: "119879939"
---
# <a name="ms-ds-password-settings-container-class"></a>classe de conteneur ms-DS-Password-Paramètres

Conteneur pour les objets de paramètres de mot de passe.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | ms-DS-Password-Paramètres-Container    |
