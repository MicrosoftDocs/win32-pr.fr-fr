...
---
# <a name="allowed-attributes-effective-attribute"></a>Attribute allowed-Attributes

Liste des attributs qui peuvent être modifiés sur l’objet.



| Entrée | Valeur |
|-------------------|-----------------------------------------------------------------|
| CN                | Autorisé-attributs-effectif                                    |
| LDAP-Display-Name | allowedAttributesEffective                                      |
| Taille              | \-                                                              |
