...
ms.locfileid: "119835029"
---
# <a name="ipsec-negotiation-policy-class"></a>Classe de stratégie de négociation IPSec

La classe **IPSec-Negotiation-Policy** est réservée à un usage interne.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | IPSec-négociation-stratégie             |
...
| Sous-classe de                 | [**IPSec-de base**](c-ipsecbase.md)<br/>                                                                      |
| Supérieurs possibles          | [**Unité d’organisation de**](c-organizationalunit.md) l'[**ordinateur**](c-computer.md) [**conteneur**](c-container.md) |
| Classes auxiliaires           | \-                                                                                                                |
...
| [**IPSec-données**](a-ipsecdata.md)                                         | Faux     | [**IPSec-de base**](c-ipsecbase.md)<br/> |
| [**Type de données IPSec**](a-ipsecdatatype.md)                                | Faux     | [**IPSec-de base**](c-ipsecbase.md)<br/> |
| [**ID IPSec**](a-ipsecid.md)                                             | Faux     | [**IPSec-de base**](c-ipsecbase.md)<br/> |
| [**Nom d’IPSec**](a-ipsecname.md)                                         | Faux     | [**IPSec-de base**](c-ipsecbase.md)<br/> |
| [**IPSEC-négociation-stratégie-action**](a-ipsecnegotiationpolicyaction.md) | Faux     | **IPSec-négociation-stratégie**                 |
| [**IPSEC-Negotiation-Policy-type**](a-ipsecnegotiationpolicytype.md)     | Faux     | **IPSec-négociation-stratégie**                 |
| [**IPSec-propriétaires-référence**](a-ipsecownersreference.md)                  | Faux     | [**IPSec-de base**](c-ipsecbase.md)<br/> |
...
| Classes auxiliaires           | \-                                                                                                                |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                                      |
| Descripteur de sécurité par défaut | D :                                                                                                                |
| System-Flags                | 0x00000010                                                                                                        |
