---
title: attribut ms-FVE-VolumeGuid
description: Contient le GUID associé à un volume de disque pris en charge par BitLocker.
ms.assetid: fe54beb4-8352-4ec5-9c9a-22ac19ee3cab
ms.tgt_platform: multiple
keywords:
- Schéma AD de l’attribut ms-FVE-VolumeGuid
- Schéma AD de l’attribut msFVE-VolumeGuid
topic_type:
- apiref
api_name:
- ms-FVE-VolumeGuid
...
Contient le GUID associé à un volume de disque pris en charge par BitLocker.
