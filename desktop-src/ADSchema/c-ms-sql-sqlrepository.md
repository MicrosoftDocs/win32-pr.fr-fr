...
---
# <a name="ms-sql-sqlrepository-class"></a>MS-SQL-SQLRepository, classe

Classe pour le stockage des propriétés de l’espace de stockage SQL Server.
...
| [**MS-SQL-Build**](a-ms-sql-build.md)                                    | Faux     | **MS-SQL-SQLRepository**        |
| [**Contact MS-SQL**](a-ms-sql-contact.md)                                | Faux     | **MS-SQL-SQLRepository**        |
| [**Description de MS-SQL**](a-ms-sql-description.md)                        | Faux     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-InformationDirectory**](a-ms-sql-informationdirectory.md)      | Faux     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-nom**](a-ms-sql-name.md)                                      | Faux     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-État**](a-ms-sql-status.md)                                  | Faux     | **MS-SQL-SQLRepository**        |
| [**MS-SQL-version**](a-ms-sql-version.md)                                | Faux     | **MS-SQL-SQLRepository**        |
