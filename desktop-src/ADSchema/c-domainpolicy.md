...
ms.locfileid: "119643459"
---
# <a name="domain-policy-class"></a>Classe Domain-Policy

Définit la stratégie de l’autorité de sécurité locale pour un ou plusieurs domaines.
...
| Supérieurs possibles          | [](c-container.md)[**Domaine de conteneur-**](c-domaindns.md)[**unité d’organisation**](c-organizationalunit.md) DNS |
| Classes auxiliaires           | \-                                                                                                                   |
...
| [**Authentification-options**](a-authenticationoptions.md)                 | Faux     | **Stratégie de domaine**               |
...
| [**Objet de stratégie locale par défaut**](a-defaultlocalpolicyobject.md)         | Faux     | **Stratégie de domaine**               |
...
| [**Autorités de certification de domaine**](a-domaincas.md)                     | Faux     | **Stratégie de domaine**               |
| [**Informations de référence sur la stratégie de domaine**](a-domainpolicyreference.md)                | Faux     | **Stratégie de domaine**               |
| [**Stratégie à l’ensemble du domaine**](a-domainwidepolicy.md)                          | Faux     | **Stratégie de domaine**               |
...
| [**EFSPolicy**](a-efspolicy.md)                                          | Faux     | **Stratégie de domaine**               |
...
| [**Forcer la fermeture de session**](a-forcelogoff.md)                                     | Faux     | **Stratégie de domaine**               |
...
| [**Informations de référence sur la stratégie IPSec**](a-ipsecpolicyreference.md)                  | Faux     | **Stratégie de domaine**               |
...
| [**Verrouillage-durée**](a-lockoutduration.md)                             | Faux     | **Stratégie de domaine**               |
| [**Verrouillage-sortie-observation-fenêtre**](a-lockoutobservationwindow.md)         | Faux     | **Stratégie de domaine**               |
| [**Seuil de verrouillage**](a-lockoutthreshold.md)                           | Faux     | **Stratégie de domaine**               |
| [**Géré par**](a-managedby.md)                                         | Faux     | **Stratégie de domaine**               |
...
| [**Max-pwd-âge**](a-maxpwdage.md)                                        | Faux     | **Stratégie de domaine**               |
| [**Max-Renew-Age**](a-maxrenewage.md)                                    | Faux     | **Stratégie de domaine**               |
| [**Max-ticket-Age**](a-maxticketage.md)                                  | Faux     | **Stratégie de domaine**               |
| [**Min-pwd-Age**](a-minpwdage.md)                                        | Faux     | **Stratégie de domaine**               |
| [**Min-pwd-longueur**](a-minpwdlength.md)                                  | Faux     | **Stratégie de domaine**               |
| [**Min-ticket-Age**](a-minticketage.md)                                  | Faux     | **Stratégie de domaine**               |
...
| [**Durée de vie du proxy**](a-proxylifetime.md)                                 | Faux     | **Stratégie de domaine**               |
| [**Clé publique-stratégie**](a-publickeypolicy.md)                            | Faux     | **Stratégie de domaine**               |
| [**Pwd-historique-longueur**](a-pwdhistorylength.md)                          | Faux     | **Stratégie de domaine**               |
| [**Pwd-propriétés**](a-pwdproperties.md)                                 | Faux     | **Stratégie de domaine**               |
| [**Qualité de service**](a-qualityofservice.md)                          | Faux     | **Stratégie de domaine**               |
