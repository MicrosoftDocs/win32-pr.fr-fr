...
Cet attribut sera utilisé pour prendre en charge le basculement pour l’ordinateur désigné comme celui qui exécute le vérificateur de cohérence des connaissances génération de topologie inter-site dans un site donné.
