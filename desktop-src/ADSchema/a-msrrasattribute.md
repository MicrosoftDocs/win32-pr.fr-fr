...
ms.locfileid: "119582089"
---
# <a name="ms-rras-attribute-attribute"></a>attribut ms-RRAS-Attribute

Chaîne qui contient le ID de type ID installé sur un routeur. Le ID de fournisseur est le fournisseur SMI et le numéro est MS-RRAS-attribute Number défini dans l’objet de dictionnaire d’identité de routeur.
...
| Classes utilisées dans        | [**RRAS-administration-point de connexion**](c-rrasadministrationconnectionpoint.md)<br/> |
