...
ms.locfileid: "119022317"
---
# <a name="schema-flags-ex-attribute"></a>Schema-Flags-attribut ex

L’attribut **Schema-Flags-ex** n’est pas utilisé actuellement.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Indicateurs de schéma-ex                      |
