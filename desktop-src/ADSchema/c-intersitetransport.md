...
ms.locfileid: "119703679"
---
# <a name="inter-site-transport-class"></a>Inter-site-classe de transport

Attribut facultatif des objets ntdsConnection. S’il est présent, contient le DN d’un objet interSiteTransport dans le CN = Transports inter-sites, CN = sites, CN = Configuration,... conteneur.



| Entrée | Valeur |
|-------------------|------------------------------------------------------------------------------------------------------------------------------------|
| CN                | Transport inter-sites                                                                                                               |
| LDAP-Display-Name | interSiteTransport                                                                                                                 |
| Mettre à jour le privilège  | Cette valeur est définie par le KCC ou l’administrateur d’entreprise.                                                                          |
| Fréquence des mises à jour  | Créé/géré par le vérificateur de cohérence des connaissances en réponse aux modifications de la topologie du réseau (y compris les pannes temporaires). |
...
| Supérieurs possibles          | [**Inter-site-transport-Container**](c-intersitetransportcontainer.md)                      |
| Classes auxiliaires           | \-                                                                                           |
...
| [**Options**](a-options.md)                                              | Faux     | **Transport inter-sites**        |
...
| [**Intervalle repl**](a-replinterval.md)                                   | Faux     | **Transport inter-sites**        |
...
| [**Transport-Address-Attribute**](a-transportaddressattribute.md)        | Vrai      | **Transport inter-sites**        |
| [**Transport-DLL-Name**](a-transportdllname.md)                          | Vrai      | **Transport inter-sites**        |
