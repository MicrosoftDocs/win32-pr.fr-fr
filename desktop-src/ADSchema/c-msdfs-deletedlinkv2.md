...
ms.locfileid: "117836444"
---
# <a name="ms-dfs-deleted-link-v2-class"></a>classe ms-DFS-Deleted-Link-v2

Lien DFS supprimé dans l’espace de noms DFS.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-DFS-supprimé-Link-v2               |
...
| [**MS-DFS-comment-v2**](a-msdfs-commentv2.md)                                 | Faux     | **MS-DFS-supprimé-Link-v2**      |
| [**MS-DFS-Last-modified-v2**](a-msdfs-lastmodifiedv2.md)                      | Vrai      | **MS-DFS-supprimé-Link-v2**      |
| [**MS-DFS-Link-Identity-GUID-v2**](a-msdfs-linkidentityguidv2.md)             | Vrai      | **MS-DFS-supprimé-Link-v2**      |
| [**MS-DFS-Link-Path-v2**](a-msdfs-linkpathv2.md)                              | Vrai      | **MS-DFS-supprimé-Link-v2**      |
| [**MS-DFS-namespace-Identity-GUID-v2**](a-msdfs-namespaceidentityguidv2.md)   | Vrai      | **MS-DFS-supprimé-Link-v2**      |
...
| [**MS-DFS-Short-Name-Link-Path-v2**](a-msdfs-shortnamelinkpathv2.md)          | Faux     | **MS-DFS-supprimé-Link-v2**      |
