...
---
# <a name="preferred-delivery-method-attribute"></a>Préféré-attribut de méthode de remise

La méthode X. 500-recommandée pour remettre à l’adresse du destinataire.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Méthode de remise par défaut            |
