...
Cet attribut est utilisé pour vérifier la cohérence entre le répertoire et un autre objet, base de données ou application, en comparant le nombre d’objets enfants.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-DS-Consistency-enfant-nombre        |
