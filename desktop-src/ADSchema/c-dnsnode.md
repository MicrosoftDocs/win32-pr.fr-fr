...
Contient les enregistrements de ressources DNS pour un seul hôte.
...
| Supérieurs possibles          | [**Zone DNS**](c-dnszone.md)                                                                                                                                        |
| Classes auxiliaires           | \-                                                                                                                                                                   |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                                                                                         |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; ED) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; CO) (A ;; RPLCLORC;;; WD |
...
| [**Propriété DNS**](a-dnsproperty.md)                                     | Faux     | **Nœud DNS**                    |
| [**Enregistrement DNS**](a-dnsrecord.md)                                         | Faux     | **Nœud DNS**                    |
| [**DNS-désactivé**](a-dnstombstoned.md)                                 | Faux     | **Nœud DNS**                    |
| [**Composant de domaine**](a-dc.md)                                          | Vrai      | **Nœud DNS**                    |
