...
ms.locfileid: "118175223"
---
# <a name="msmq-queue-class"></a>Classe MSMQ-Queue

Les utilisateurs MSMQ créent des files d’attente (par MMC ou par l’API MSMQ) en fonction de leurs besoins. Une file d’attente est associée à un ordinateur spécifique et est placée sous le MSMQ-Configuration de cet ordinateur. Le nombre de files d’attente par ordinateur n’est pas limité.
...
| Supérieurs possibles          | [**Configuration MSMQ**](c-msmqconfiguration.md)                                            |
| Classes auxiliaires           | \-                                                                                           |
...
| [**Authentification MSMQ**](a-msmqauthenticate.md)                           | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-priorité de base**](a-msmqbasepriority.md)                          | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-Journal**](a-msmqjournal.md)                                     | Faux     | **MSMQ-file d’attente**                  |
| [**Étiquette MSMQ**](a-msmqlabel.md)                                         | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-label-ex**](a-msmqlabelex.md)                                    | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-owner-ID**](a-msmqownerid.md)                                    | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-niveau de confidentialité**](a-msmqprivacylevel.md)                          | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-queue-journal-quota**](a-msmqqueuejournalquota.md)               | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-queue-Name-ext**](a-msmqqueuenameext.md)                         | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-file d’attente-quota**](a-msmqqueuequota.md)                              | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-type de file d’attente**](a-msmqqueuetype.md)                                | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-transactionnel**](a-msmqtransactional.md)                         | Faux     | **MSMQ-file d’attente**                  |
...
| [**Étiquette MSMQ**](a-msmqlabel.md)                                           | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-label-ex**](a-msmqlabelex.md)                                      | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-Multicast-Address**](a-msmq-multicastaddress.md)                   | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-owner-ID**](a-msmqownerid.md)                                      | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-niveau de confidentialité**](a-msmqprivacylevel.md)                            | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-queue-journal-quota**](a-msmqqueuejournalquota.md)                 | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-queue-Name-ext**](a-msmqqueuenameext.md)                           | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-file d’attente-quota**](a-msmqqueuequota.md)                                | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-type de file d’attente**](a-msmqqueuetype.md)                                  | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-sécurisé-source**](a-msmq-securedsource.md)                         | Faux     | **MSMQ-file d’attente**                  |
| [**MSMQ-transactionnel**](a-msmqtransactional.md)                           | Faux     | **MSMQ-file d’attente**                  |
| [**netboot-SCP-BL**](a-netbootscpbl.md)                                    | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**Non-sécurité-membre-BL**](a-nonsecuritymemberbl.md)                     | Faux     | [**Retour au début**](c-top.md)<br/> |
| [**Descripteur de sécurité NT**](a-ntsecuritydescriptor.md)                    | Vrai      | [**Retour au début**](c-top.md)<br/> |
