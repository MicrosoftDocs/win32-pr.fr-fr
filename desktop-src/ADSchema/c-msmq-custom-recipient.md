...
ms.locfileid: "118175635"
---
# <a name="msmq-custom-recipient-class"></a>MSMQ-Custom-classe de destinataire

Utilisé pour définir un destinataire MSMQ personnalisé (également appelé « file d’attente d’alias »). Définit un alias pour une file d’attente hors entreprise. Contient le nom de format de cette file d’attente.



| Entrée | Valeur |
|-------------------|------------------------------------------|
| CN                | MSMQ-personnalisé-destinataire                    |
| LDAP-Display-Name | msMQ-personnalisé-destinataire                    |
| Mettre à jour le privilège  | Propriétaire de la file d’attente.                         |
| Fréquence des mises à jour  | Uniquement après le déplacement de la file d’attente externe. |
...
| [**MSMQ-Recipient-FormatName**](a-msmq-recipient-formatname.md)            | Faux     | **MSMQ-personnalisé-destinataire**       |
