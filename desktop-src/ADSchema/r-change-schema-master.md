...
---
# <a name="change-schema-master-extended-right"></a>Modifier-schéma-principal droit étendu

Droit étendu nécessaire pour modifier le propriétaire du rôle FSMO du contrôleur de schéma.



| Entrée | Valeur |
|--------------|--------------------------------------|
| CN           | Modifier-schéma-maître                 |
| Display-Name | Modifier le contrôleur de schéma                 |
