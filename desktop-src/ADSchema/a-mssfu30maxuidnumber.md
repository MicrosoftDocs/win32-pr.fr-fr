...
ms.locfileid: "118682495"
---
# <a name="mssfu-30-max-uid-number-attribute"></a>attribut msSFU-30-max-Uid-Number

Contient le nombre maximal d’utilisateurs qui peuvent être migrés vers un domaine NIS.
