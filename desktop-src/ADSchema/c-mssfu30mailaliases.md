...
description: représente UNIX données de fichier de messagerie.
...
ms.locfileid: "119879569"
---
# <a name="mssfu-30-mail-aliases-class"></a>classe msSFU-30-mail-aliases

représente UNIX données de fichier de messagerie.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | msSFU-30-alias de messagerie                |
...
| [**msSFU-30-alias**](a-mssfu30aliases.md)                                | Faux     | **msSFU-30-alias de messagerie**       |
| [**msSFU-30-nom**](a-mssfu30name.md)                                      | Faux     | **msSFU-30-alias de messagerie**       |
| [**msSFU-30-NIS-domaine**](a-mssfu30nisdomain.md)                           | Faux     | **msSFU-30-alias de messagerie**       |
...
| [**nisMapName**](a-nismapname.md)                                          | Faux     | **msSFU-30-alias de messagerie**       |
...
| RDN-att-ID                  | [**Nom commun**](a-cn.md)<br/>                                                       |
| Sous-classe de                 | [**Retour au début**](c-top.md)<br/>                                                              |
| Supérieurs possibles          | Domaine de [**conteneur**](c-container.md)[**nisMap**](c-nismap.md)[**-DNS**](c-domaindns.md)  |
| Classes auxiliaires           | \-                                                                                           |
| Descripteur de sécurité NT      | O :BAG : BAD : S :                                                                                 |
| Descripteur de sécurité par défaut | D : (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW ;;;D A) (A ;; RPWPCRCCDCLCLORCWOWDSDDTSW;;; SY) (A ;; RPLCLORC;;; UA |
| System-Flags                | 0x00000000                                                                                   |
