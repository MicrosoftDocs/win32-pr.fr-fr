...
ms.locfileid: "119021747"
---
# <a name="simplesecurityobject-class"></a>simpleSecurityObject, classe

Permet à une entrée d’avoir un attribut userPassword lorsque les classes d’objets principal d’une entrée n’autorisent pas userPassword comme type d’attribut.
...
| [**Utilisateur-mot de passe**](a-userpassword.md)                                     | Faux     | **simpleSecurityObject**        |
