...
---
# <a name="ms-sql-sqldatabase-class"></a>MS-SQL-SQLDatabase, classe

Classe pour le stockage des propriétés de base de données SQL Server.
...
| Supérieurs possibles          | [**MS-SQL-SQLServer**](c-ms-sql-sqlserver.md)                                               |
| Classes auxiliaires           | \-                                                                                           |
...
| [**Alias MS-SQL**](a-ms-sql-alias.md)                                    | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-applications**](a-ms-sql-applications.md)                      | Faux     | **MS-SQL-SQLDatabase**          |
| [**Contact MS-SQL**](a-ms-sql-contact.md)                                | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-CreationDate**](a-ms-sql-creationdate.md)                      | Faux     | **MS-SQL-SQLDatabase**          |
| [**Description de MS-SQL**](a-ms-sql-description.md)                        | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-Mots clés**](a-ms-sql-keywords.md)                              | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastBackupDate**](a-ms-sql-lastbackupdate.md)                  | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-LastDiagnosticDate**](a-ms-sql-lastdiagnosticdate.md)          | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-nom**](a-ms-sql-name.md)                                      | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-taille**](a-ms-sql-size.md)                                      | Faux     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-État**](a-ms-sql-status.md)                                  | Faux     | **MS-SQL-SQLDatabase**          |
