...
| [**Description de MS-SQL**](a-ms-sql-description.md)                        | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-InformationURL**](a-ms-sql-informationurl.md)                  | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-mots clés**](a-ms-sql-keywords.md)                              | False     | **MS-SQL-SQLDatabase**          |
...
| [**MS-SQL-nom**](a-ms-sql-name.md)                                      | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-taille**](a-ms-sql-size.md)                                      | False     | **MS-SQL-SQLDatabase**          |
| [**MS-SQL-état**](a-ms-sql-status.md)                                  | False     | **MS-SQL-SQLDatabase**          |
