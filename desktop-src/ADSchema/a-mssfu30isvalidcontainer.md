...
Contient des données internes utilisées par le serveur pour NIS, qui stocke si la racine de recherche actuelle est valide.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | msSFU-30-is-valide-Container          |
