...
---
# <a name="com-interfaceid-attribute"></a>Attribut COM-InterfaceID

Cet attribut stocke la liste des interfaces implémentées dans ce package d’application.
...
| Classes utilisées dans        | [**Inscription de classe**](c-classregistration.md)<br/> [**Inscription de packages**](c-packageregistration.md)<br/> [**Bibliothèque de types**](c-typelibrary.md)<br/> |
