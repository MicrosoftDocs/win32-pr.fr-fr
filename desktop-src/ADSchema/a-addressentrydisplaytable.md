...
ms.locfileid: "118688853"
---
# <a name="address-entry-display-table-attribute"></a>Adresse-entrée-Affichage-attribut de table

Table d’affichage pour une entrée d’adresse.



| Entrée | Valeur |
|-------------------|-------------------------------------------------------|
| CN                | Adresse-entrée-Affichage-table                           |
