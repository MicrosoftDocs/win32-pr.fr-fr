...
ms.locfileid: "119580629"
---
# <a name="foreign-security-principal-class"></a>Classe de principal de sécurité étrangère

Principal de sécurité d’une source externe.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Étranger-sécurité-principal           |
...
| [**Identificateur étranger**](a-foreignidentifier.md)                         | Faux     | **Étranger-sécurité-principal**  |
...
| [**SID de l’objet**](a-objectsid.md)                                         | Vrai      | **Étranger-sécurité-principal**  |
