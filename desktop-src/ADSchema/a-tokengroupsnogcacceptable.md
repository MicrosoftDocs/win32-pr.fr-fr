...
ms.locfileid: "119835829"
---
# <a name="token-groups-no-gc-acceptable-attribute"></a>Token-Groups-no-GC-attribut acceptable

Cet attribut contient la liste des SID en raison d’une opération d’extension d’appartenance de groupe transitive sur un utilisateur ou un ordinateur donné. Les groupes de jetons ne peuvent pas être récupérés si aucun catalogue global n’est présent pour récupérer les appartenances indirectes transitives.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | Token-Groups-non-GC-acceptable        |
