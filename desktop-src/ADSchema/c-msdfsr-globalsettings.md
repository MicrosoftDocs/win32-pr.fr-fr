...
ms.locfileid: "118680789"
---
# <a name="ms-dfsr-globalsettings-class"></a>MS-DFSR-récupération, classe

Contient les paramètres globaux qui s’appliquent à tous les membres du groupe de réplication.



| Entrée | Valeur |
|-------------------|--------------------------------------|
| CN                | MS-DFSR-récupération               |
| LDAP-Display-Name | msDFSR-récupération                |
...
| [**MS-DFSR-extension**](a-msdfsr-extension.md)                             | False     | **MS-DFSR-récupération**      |
| [**MS-DFSR-indicateurs**](a-msdfsr-flags.md)                                     | False     | **MS-DFSR-récupération**      |
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)             | False     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                 | False     | **MS-DFSR-récupération**      |
...
| [**MS-DFSR-MemberReferenceBL**](a-msdfsr-memberreferencebl.md)                | False     | [**Retour au début**](c-top.md)<br/> |
| [**MS-DFSR-options**](a-msdfsr-options.md)                                    | False     | **MS-DFSR-récupération**      |
| [**MS-DFSR-Options2**](a-msdfsr-options2.md)                                  | False     | **MS-DFSR-récupération**      |
| [**ms-DS-approx-immed-subordonnés**](a-msds-approx-immed-subordinates.md)    | False     | [**Retour au début**](c-top.md)<br/> |
...
La classe **MS-DFSR-récupération** fait partie de la prise en charge du service de réplication système de fichiers DFS (DFS).
