...
ms.locfileid: "118683256"
---
# <a name="ms-ds-top-quota-usage-attribute"></a>attribut ms-DS-Top-quota-usage

Liste des premiers utilisateurs du quota actuellement dans la base de données d’annuaire, classés en diminuant l’utilisation du quota.



| Entrée | Valeur |
|-------------------|---------------------------------------------|
| CN                | ms-DS-Top-quota-utilisation                       |
...
| Classes utilisées dans        | [**ms-DS-quota-Container**](c-msds-quotacontainer.md)<br/> |
