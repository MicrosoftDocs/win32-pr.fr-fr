...
---
# <a name="graphing-reference-links"></a>Liens de référence sur les graphiques

Voici quelques références utiles sur les graphiques :
...
-   [Adresses lien-local et Site-Local](/windows/desktop/WinSock/link-local-and-site-local-addresses-2)
-   [Attribution d’un nom à un fichier](/windows/desktop/FileIO/naming-a-file)
