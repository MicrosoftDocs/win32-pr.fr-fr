...
## <a name="peer-distribution-api"></a>API de distribution d’homologue



| Section                                                                | Description                                                 |
|------------------------------------------------------------------------|-------------------------------------------------------------|
| [À propos de la distribution d’homologue](about-peer-distribution.md)                 | Informations sur l’API de distribution d’homologue.                |
| [Informations de référence sur l’API de distribution d’homologue](peer-distribution-api-reference.md) | Vue d’ensemble et pages de référence pour l’API de distribution d’homologue. |
