...
| [**Tbsi \_ récupérer \_ le \_ Journal TCG**](/windows/desktop/api/Tbs/nf-tbs-tbsi_get_tcg_log)<br/>                                  | Récupère le journal de configuration de démarrage Windows le plus récent (WBCL), également appelé journal TCG.<br/>                                                  |
| [**Tbsi \_ récupérer \_ le \_ Journal TCG \_ ex**](/windows/desktop/api/Tbs/nf-tbs-tbsi_get_tcg_log_ex)<br/>                           | Obtient le journal de configuration de démarrage Windows (WBCL), également appelé journal TCG, du type spécifié.<br/>                                          |
| [**Tbsi \_ récupérer \_ les \_ journaux TCG**](/previous-versions/windows/desktop/legacy/dn455156(v=vs.85))<br/>                                | Récupérez un ou plusieurs journaux de configuration de démarrage Windows (WBCL), également appelés journaux TCG.<br/>                                                        |
