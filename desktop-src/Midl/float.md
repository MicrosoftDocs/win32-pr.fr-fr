...
description: Le mot clé float désigne un nombre à virgule flottante 32 bits.
...
Le mot clé **float** désigne un nombre à virgule flottante 32 bits.
...
Le type **float** ne peut pas apparaître dans les déclarations [**const**](const.md) .
