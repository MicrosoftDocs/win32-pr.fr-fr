...
Par Convention, le fichier qui contient les définitions d’interface et de bibliothèque de types est appelé fichier IDL et a une extension de nom de fichier. idl. En réalité, le compilateur MIDL analyse un fichier de définition d’interface indépendamment de son extension. Une interface est identifiée par l' [**interface**](interface.md)de mot clé.
