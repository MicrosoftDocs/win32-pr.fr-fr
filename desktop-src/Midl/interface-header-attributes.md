...
| [**uuid**](uuid.md)                        | Désigne une valeur 128 bits qui distingue une interface particulière des autres. La valeur réelle peut représenter un GUID, un CLSID ou un IID.                                                                                                 |
