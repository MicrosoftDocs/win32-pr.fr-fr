---
description: 'Le message suivant est utilisé dans la gestion des périphériques :'
...
ms.locfileid: "104033661"
---
# <a name="device-management-messages"></a>Messages de gestion des appareils

Le message suivant est utilisé dans la gestion des périphériques :
