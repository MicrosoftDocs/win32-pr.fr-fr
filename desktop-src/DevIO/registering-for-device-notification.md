...
Le système diffuse un ensemble d’événements de changement d’appareil par défaut à l’ensemble des applications et services. Vous n’avez pas besoin de vous inscrire pour recevoir ces événements par défaut. Pour plus d’informations, consultez la section **Notes** dans [**RegisterDeviceNotification**](/windows/win32/api/winuser/nf-winuser-registerdevicenotificationw).

## <a name="related-topics"></a>Rubriques connexes

* [Notifications de l’appareil](./device-notifications.md)