---
title: archiver les exigences de Certification pour les applications de bureau Windows v 1.2
...
pour qu’une application soit éligible pour la Certification Windows 8 des applications de bureau, elle doit répondre aux critères suivants et à toutes les exigences techniques répertoriées dans ce document.
...
1,3 votre application ne doit pas charger de dll arbitraires pour intercepter les appels d’API Win32 à l’aide des \\ dll HKLM Software \\ Microsoft \\ Windows NT \\ CurrentVersion \\ Windows AppInit \_ .  
</dl>
...
| test en mode Coffre                                                          | Réussite/échec               |
| test de Windows x64 pris en charge                                                | Réussite/échec               |
| tester les modifications apportées aux fonctionnalités de sécurité de Windows (analyseur de Surface d’attaque) | Réussite/échec/AVERTISSEMENT     |
| tester les modifications apportées aux fonctionnalités de sécurité de Windows (analyseur binaire BinScope) | Avertissement                   |
