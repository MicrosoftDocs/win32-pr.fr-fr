...
Cette section contient des exemples de code pour les raisons suivantes :

-   [Inscription pour une entrée brute](#registering-for-raw-input)
    -   [Exemple 1](#example-1)
    -   [Exemple 2](#example-2)
-   [Exécution d’une lecture standard d’une entrée brute](#performing-a-standard-read-of-raw-input)
-   [Exécution d’une lecture en mémoire tampon d’une entrée brute](#performing-a-buffered-read-of-raw-input)

## <a name="registering-for-raw-input"></a>Inscription pour une entrée brute

### <a name="example-1"></a>Exemple 1

Dans cet exemple, une application spécifie l’entrée brute à partir de contrôleurs de jeu (panneaux de jeu et joysticks) et tous les appareils de la page utilisation de la téléphonie, à l’exception des répondants.
...
Dans cet exemple, une application souhaite une entrée brute à partir du clavier et de la souris, mais elle souhaite ignorer les messages  [hérités du clavier](keyboard-input-notifications.md) et de [la fenêtre de la souris](mouse-input-notifications.md) (qui seraient issus du même clavier et de la même souris).
...
## <a name="performing-a-standard-read-of-raw-input"></a>Exécution d’une lecture standard d’une entrée brute

Cet exemple montre comment une application effectue une lecture non mise en mémoire tampon (ou standard) d’une entrée brute à partir d’un clavier ou d’un périphérique d’interface utilisateur (HID) de souris, puis imprime différentes informations à partir de l’appareil.
...
## <a name="performing-a-buffered-read-of-raw-input"></a>Exécution d’une lecture en mémoire tampon d’une entrée brute

Cet exemple montre comment une application effectue une lecture en mémoire tampon d’une entrée brute à partir d’un HID générique.
