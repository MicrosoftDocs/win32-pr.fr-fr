...
| <span id="MOD_WIN"></span><span id="mod_win"></span><dl> <dt>**Mod \_ WIN**</dt> <dt>0x0008</dt> </dl>             | La touche WINDOWS était maintenue enfoncée. Ces clés sont étiquetées avec le logo Windows. Les raccourcis clavier qui impliquent la touche Windows sont réservés à une utilisation par le système d’exploitation.<br/> |
