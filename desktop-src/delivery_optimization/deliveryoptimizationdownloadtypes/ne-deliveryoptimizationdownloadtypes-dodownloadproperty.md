...
description: Spécifie l’ID des propriétés de l’opération de téléchargement de l’optimisation de la remise.
keywords:
...
ms.locfileid: "128520841"
---
# <a name="dodownloadproperty-enumeration"></a>Énumération DODownloadProperty

L’énumération **DODownloadProperty** spécifie l’ID des propriétés de l’opération de téléchargement de l’optimisation de la remise. Cette énumération est utilisée par l’interface **IDODownload** et est exécutée par une valeur de type Variant, où le type de la valeur est contenu.
...
| DODownloadProperty_IntegrityCheckInfo | Facultatif en écriture seule. Définit l’emplacement du fichier de hachage de l’élément (PHF), qui est utilisé par l’optimisation de la distribution pour effectuer des vérifications de l’intégrité du Runtime sur le contenu téléchargé. Le type VARIANT est VT_BSTR. |
