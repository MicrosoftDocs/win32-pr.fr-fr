...
l’autorisation d’accès complet pour modifier les ressources protégées par WRP sur Windows Vista et Windows Server 2008 est limitée à TrustedInstaller avec le service d’installation des Modules Windows à l’aide des mécanismes suivants :

-   Windows Service packs installés par TrustedInstaller.
-   Correctifs installés par TrustedInstaller.
-   Mises à niveau du système d’exploitation installées par TrustedInstaller.
-   Windows Mise à jour installée par TrustedInstaller.
...
-   Windows Installation du Service Pack à l’aide de Update.exe
