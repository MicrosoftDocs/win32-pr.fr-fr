...
---
# <a name="esentobsoleteexception-constructor-serializationinfo-streamingcontext"></a>Constructeur EsentObsoleteException (SerializationInfo, StreamingContext)

Initialise une nouvelle instance de la classe EsentObsoleteException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.
