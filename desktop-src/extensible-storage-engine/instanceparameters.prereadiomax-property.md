...
---
# <a name="instanceparametersprereadiomax-property"></a>InstanceParameters. PrereadIOMax, propriété

Obtient ou définit le nombre maximal d’opérations d’e/s distribuées pour un usage donné.
