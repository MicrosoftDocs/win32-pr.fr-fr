---
description: 'En savoir plus sur : JET_DBINFOMISC. Equals, méthode (Object)'
title: JET_DBINFOMISC. Equals, méthode (Object)
...
Détermine si l' [objet](/dotnet/api/system.object) spécifié est égal à l' [objet](/dotnet/api/system.object)actuel.
