...
ms.locfileid: "118979199"
---
# <a name="jet_tableidtostring-method-string-iformatprovider"></a>JET_TABLEID. ToString, méthode (String, IFormatProvider)
...
[ToString, surcharge](./jet-tableid.tostring-method.md)
