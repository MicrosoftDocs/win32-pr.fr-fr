---
description: 'En savoir plus sur les éléments suivants : DurableCommitCallback'
title: Membres DurableCommitCallback (Microsoft. ISAM. esent. Interop. Windows8)
...
Encapsule le rappel concernant les validations durables.

Le type [DurableCommitCallback](./durablecommitcallback-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe <a href="dn335323(v=exchg.10).md">DurableCommitCallback</a> .</td>
</tr>
</tbody>
</table>
...
<td>Libère la session de validation durable. (Substitue <a href="dn350545(v=exchg.10).md">EsentResource. ReleaseResource ()</a>.)</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
