...
| Étiquette | Valeur |
|--------|-------|
| <p>Valeur par défaut :</p> | <p>JET_ExceptionMsgBox</p> | 
| <p>Tapez :</p> | <p>Entier</p> | 
| <p>Plage valide :</p> | <p>JET_ExceptionMsgBox, JET_ExceptionNone</p> | 
| <p>Étendue :</p> | <p>Global</p> | 
| <p>Définir après <a href="gg269354(v=exchg.10).md">JetCreateInstance</a>:</p> | <p><strong>Windows 2000, Windows XP et Windows Server 2003 :</strong>  º</p><p><strong>Windows Vista :</strong>  Oui</p> | 
| <p>Définir après <a href="gg294068(v=exchg.10).md">JetInit</a>:</p> | <p><strong>Windows 2000, Windows XP et Windows Server 2003 :</strong>  º</p><p><strong>Windows Vista :</strong>  Oui</p> | 
| <p>Affecte la disposition physique :</p> | <p>No</p> | 
