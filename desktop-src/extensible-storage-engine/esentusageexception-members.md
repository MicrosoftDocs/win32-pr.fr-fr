---
description: 'En savoir plus sur les éléments suivants : EsentUsageException'
title: Membres EsentUsageException
...
ms.locfileid: "103953222"
---
# <a name="esentusageexception-members"></a>Membres EsentUsageException

Inclure les membres protégés  
Inclure les membres hérités  

Classe de base pour les exceptions d’utilisation.

Le type [EsentUsageException](./esentusageexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentUsageException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn350872(v=exchg.10).md">EsentUsageException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentUsageException.</td>
</tr>
</tbody>
</table>
