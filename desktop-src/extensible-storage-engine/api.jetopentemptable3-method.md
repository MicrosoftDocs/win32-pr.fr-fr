...
ms.locfileid: "119948039"
---
# <a name="apijetopentemptable3-method"></a>Méthode Api.JetOpenTempTable3
...
<!-- end list -->
  ...
  - unicodeindex  
    ...
    ID de paramètres régionaux et indicateurs de normalisation qui seront utilisés pour comparer les données de colonne de clé Unicode dans la table temporaire. Si ce n’est pas le cas, les options par défaut sont utilisées.
