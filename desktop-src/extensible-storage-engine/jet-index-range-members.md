---
description: 'En savoir plus sur les membres suivants : JET_INDEX_RANGE'
title: Membres JET_INDEX_RANGE (Microsoft. ISAM. esent. Interop. Windows8)
...
ms.locfileid: "119039147"
---
# <a name="jet_index_range-members"></a>Membres JET_INDEX_RANGE

Inclure les membres protégés  
Inclure les membres hérités  

Contient la définition de [JetPrereadIndexRanges (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32, Int32, \[ \] , PrereadIndexRangesGrbit)](./windows8api.jetprereadindexranges-method.md).

Le type de [JET_INDEX_RANGE](./jet-index-range-class.md) expose les membres suivants.
...
<td>Obtient ou définit les valeurs de colonne pour la fin de l’index.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335485(v=exchg.10).md">startColumns</a></td>
<td>Obtient ou définit les valeurs de colonne pour le début de l’index.</td>
</tr>
</tbody>
</table>
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn335481(v=exchg.10).md">JET_INDEX_RANGE</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
