...
ms.locfileid: "119732399"
---
# <a name="esentstopwatch-members"></a>Membres EsentStopwatch

Inclure les membres protégés  
Inclure les membres hérités  

Fournit un ensemble de méthodes et de propriétés que vous pouvez utiliser pour mesurer les statistiques de travail ESENT d’un thread. Si la version actuelle de ESENT ne prend pas en charge [JetGetThreadStats (JET_THREADSTATS)](./vistaapi.jetgetthreadstats-method.md) , toutes les statistiques esent seront 0.

Le type [EsentStopwatch](./esentstopwatch-class.md) expose les membres suivants.
...
<td><a href="dn334934(v=exchg.10).md">Temps écoulé</a></td>
<td>Obtient le temps total écoulé mesuré par l'instance actuelle.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn334933(v=exchg.10).md">IsRunning</a></td>
<td>Obtient une valeur indiquant si le minuteur EsentStopwatch est en cours d’exécution.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn334930(v=exchg.10).md">ThreadStats</a></td>
<td>Obtient le nombre total de statistiques de travail ESENT mesurées par l’instance actuelle.</td>
</tr>
</tbody>
</table>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="dn334869(v=exchg.10).md">Réinitialiser</a></td>
<td>Arrête la mesure de l’intervalle de temps et réinitialise les statistiques des threads.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="dn334931(v=exchg.10).md">Start</a></td>
<td>Commence à mesurer le travail ESENT.</td>
</tr>
<tr class="even">
...
<td>Initialise une nouvelle instance EsentStopwatch et commence à mesurer le temps écoulé.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="dn334932(v=exchg.10).md">Stop</a></td>
<td>Arrête la mesure du travail ESENT.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="dn334873(v=exchg.10).md">ToString</a></td>
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="/dotnet/api/system.diagnostics.stopwatch">chronomètre</a>en cours. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
