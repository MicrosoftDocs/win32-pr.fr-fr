---
description: 'En savoir plus sur les éléments suivants : UInt64ColumnValue'
title: Membres UInt64ColumnValue
...
ms.locfileid: "104551919"
---
# <a name="uint64columnvalue-members"></a>Membres UInt64ColumnValue

Inclure les membres protégés  
Inclure les membres hérités  

Valeur de colonne [UInt64](/dotnet/api/system.uint64) .

Le type [UInt64ColumnValue](./uint64columnvalue-class.md) expose les membres suivants.
...
<td><a href="dn351260(v=exchg.10).md">Taille</a></td>
...
[UInt64ColumnValue, classe](./uint64columnvalue-class.md)
