...
---
# <a name="updatereleaseresource-method"></a>Update. ReleaseResource, méthode

Appelé lorsque la transaction est supprimée pendant qu’elle est active. La transaction doit être restaurée.
