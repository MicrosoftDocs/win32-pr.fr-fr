---
description: 'En savoir plus sur les éléments suivants : EsentFatalException'
title: Membres EsentFatalException
...
ms.locfileid: "118269758"
---
# <a name="esentfatalexception-members"></a>Membres EsentFatalException
...
Le type [EsentFatalException](./esentfatalexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentFatalException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn274274(v=exchg.10).md">EsentFatalException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentFatalException.</td>
</tr>
</tbody>
</table>
