---
description: 'En savoir plus sur les membres suivants : JET_SNPROG'
title: Membres JET_SNPROG
...
ms.locfileid: "119719789"
---
# <a name="jet_snprog-members"></a>Membres JET_SNPROG

Inclure les membres protégés  
Inclure les membres hérités  

Contient des informations sur la progression d’une opération de longue durée.

Le type de [JET_SNPROG](./jet-snprog-class.md) expose les membres suivants.
...
<td>Obtient le nombre d’unités de travail déjà terminées pendant l’opération de longue durée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn351094(v=exchg.10).md">cunitTotal</a></td>
<td>Obtient le nombre d’unités de travail qui doivent être terminées. Cette valeur sera toujours supérieure ou égale à cunitDone.</td>
</tr>
</tbody>
</table>
...
<tr class="odd">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="dn351052(v=exchg.10).md">Égal à (objet)</a></td>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="dn351091(v=exchg.10).md">Égal à (JET_SNPROG)</a></td>
