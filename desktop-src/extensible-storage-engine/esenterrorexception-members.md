---
description: 'En savoir plus sur les éléments suivants : EsentErrorException'
title: Membres EsentErrorException
...
ms.locfileid: "104553520"
---
# <a name="esenterrorexception-members"></a>Membres EsentErrorException

Inclure les membres protégés  
Inclure les membres hérités  

Classe de base pour les exceptions d’erreur ESENT.

Le type [EsentErrorException](./esenterrorexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentErrorException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
</tbody>
</table>
...
<td>Obtient l’erreur esent sous-jacente pour cette exception.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
