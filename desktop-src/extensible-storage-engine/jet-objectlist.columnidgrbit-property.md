...
ms.locfileid: "126850870"
---
# <a name="jet_objectlistcolumnidgrbit-property"></a>JET_OBJECTLIST. columnidgrbit, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke le grbits utilisé lors de la création de la table.
