...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetCreateInstance2W</strong> (Unicode) et <strong>JetCreateInstance2A</strong> (ANSI).</p> | 
