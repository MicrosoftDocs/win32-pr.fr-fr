---
description: 'En savoir plus sur les membres suivants : JET_UNICODEINDEX'
title: Membres JET_UNICODEINDEX
...
ms.locfileid: "119945529"
---
# <a name="jet_unicodeindex-members"></a>Membres JET_UNICODEINDEX

Inclure les membres protégés  
Inclure les membres hérités  

Personnalise la normalisation des données Unicode lorsqu’un index est créé sur une colonne Unicode. Personnalise la normalisation des données Unicode lorsqu’un index est créé sur une colonne Unicode.

Le type de [JET_UNICODEINDEX](./jet-unicodeindex-class.md) expose les membres suivants.
...
<td>Obtient ou définit les indicateurs à utiliser avec LCMapString lors de la normalisation des données Unicode.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn351144(v=exchg.10).md">lcid</a></td>
<td>Obtient ou définit le LCID à utiliser lors de la normalisation des données Unicode.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn351147(v=exchg.10).md">szLocaleName</a></td>
<td>Obtient ou définit le LocaleName à utiliser lors de la normalisation des données Unicode.</td>
</tr>
</tbody>
</table>
...
<td>En guise de solution de contournement pour les systèmes qui n’ont pas de prise en charge LCID, nous allons convertir un nombre très limité de LCID en noms de paramètres régionaux.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
