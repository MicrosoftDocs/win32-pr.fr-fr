---
description: 'En savoir plus sur : JET_RSTINFO. Méthode ToString'
title: JET_RSTINFO. Méthode ToString
...
ms.locfileid: "106515987"
---
# <a name="jet_rstinfotostring-method"></a>JET_RSTINFO. Méthode ToString

Retourne une [chaîne](/dotnet/api/system.string) qui représente le [JET_RSTINFO](./jet-rstinfo-class.md)actuel.
...
[Chaîne](/dotnet/api/system.string) qui représente le [JET_RSTINFO](./jet-rstinfo-class.md)actuel.  
