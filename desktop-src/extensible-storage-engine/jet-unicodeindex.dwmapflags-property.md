---
description: 'En savoir plus sur : propriété JET_UNICODEINDEX. dwMapFlags'
title: JET_UNICODEINDEX. dwMapFlags, propriété
...
ms.locfileid: "106521281"
---
# <a name="jet_unicodeindexdwmapflags-property"></a>JET_UNICODEINDEX. dwMapFlags, propriété

Obtient ou définit les indicateurs à utiliser avec LCMapString lors de la normalisation des données Unicode.
