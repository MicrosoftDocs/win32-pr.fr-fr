...
---
# <a name="esentresourceexception-members"></a>Membres EsentResourceException

Inclure les membres protégés  
Inclure les membres hérités  

Classe de base pour les exceptions de ressource.

Le type [EsentResourceException](./esentresourceexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentResourceException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn350558(v=exchg.10).md">EsentResourceException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentResourceException.</td>
</tr>
</tbody>
</table>
