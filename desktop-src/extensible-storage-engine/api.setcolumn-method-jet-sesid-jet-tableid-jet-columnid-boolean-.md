...
ms.locfileid: "120067019"
---
# <a name="apisetcolumn-method-jet_sesid-jet_tableid-jet_columnid-boolean"></a>Méthode API. SetColumn (JET_SESID, JET_TABLEID, JET_COLUMNID, Boolean)
