...
---
# <a name="jet_threadstatscpageredirtied-property"></a>JET_THREADSTATS. cPageRedirtied, propriété

Obtient le nombre total de pages de base de données, avec des modifications non écrites, qui ont été modifiées par le moteur de base de données sur le thread actuel.
