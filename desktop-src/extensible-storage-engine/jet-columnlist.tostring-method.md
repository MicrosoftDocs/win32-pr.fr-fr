---
description: 'En savoir plus sur : JET_COLUMNLIST. Méthode ToString'
title: JET_COLUMNLIST. Méthode ToString
...
ms.locfileid: "127297014"
---
# <a name="jet_columnlisttostring-method"></a>JET_COLUMNLIST. Méthode ToString

Retourne une [chaîne](/dotnet/api/system.string) qui représente le [JET_COLUMNLIST](./jet-columnlist-class.md)actuel.
...
[Chaîne](/dotnet/api/system.string) qui représente le [JET_COLUMNLIST](./jet-columnlist-class.md)actuel.  
