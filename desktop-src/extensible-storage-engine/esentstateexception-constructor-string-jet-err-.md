...
---
# <a name="esentstateexception-constructor-string-jet_err"></a>Constructeur EsentStateException (String, JET_err)

Initialise une nouvelle instance de la classe EsentStateException.
