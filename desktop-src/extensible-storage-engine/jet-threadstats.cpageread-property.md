---
description: 'En savoir plus sur : propriété JET_THREADSTATS. cPageRead'
title: JET_THREADSTATS. cPageRead, propriété (Microsoft. ISAM. esent. Interop. Vista)
...
ms.locfileid: "119832629"
---
# <a name="jet_threadstatscpageread-property"></a>JET_THREADSTATS. cPageRead, propriété

Obtient le nombre total de pages de base de données récupérées à partir du disque par le moteur de base de données sur le thread actuel.
