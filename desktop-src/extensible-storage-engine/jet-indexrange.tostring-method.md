...
---
# <a name="jet_indexrangetostring-method"></a>JET_INDEXRANGE. Méthode ToString
...
[Chaîne](/dotnet/api/system.string) qui représente le [JET_INDEXRANGE](./jet-indexrange-class.md)actuel.  
