...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetExternalRestore2W</strong> (Unicode) et <strong>JetExternalRestore2A</strong> (ANSI).</p> | 
