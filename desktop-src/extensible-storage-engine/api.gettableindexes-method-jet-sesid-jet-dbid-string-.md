...
ms.locfileid: "127012656"
---
# <a name="apigettableindexes-method-jet_sesid-jet_dbid-string"></a>Méthode API. GetTableIndexes (JET_SESID, JET_DBID, String)

Itère sur tous les index de la table, en retournant des informations sur chacune d’elles.
...
[Surcharge GetTableIndexes](./api.gettableindexes-method.md)
