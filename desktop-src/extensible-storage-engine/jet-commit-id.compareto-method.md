---
description: 'En savoir plus sur : méthode JET_COMMIT_ID. CompareTo'
title: JET_COMMIT_ID. CompareTo, méthode (Microsoft. ISAM. esent. Interop. Windows8)
...
ms.locfileid: "106532146"
---
# <a name="jet_commit_idcompareto-method"></a>JET_COMMIT_ID. CompareTo, méthode

Retourne une valeur comparant cette instance à une autre.
...
Valeur signée représentant les positions relatives des instances.  
