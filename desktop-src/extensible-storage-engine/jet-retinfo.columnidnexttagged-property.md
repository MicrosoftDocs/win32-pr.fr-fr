...
---
# <a name="jet_retinfocolumnidnexttagged-property"></a>JET_RETINFO. columnidNextTagged, propriété

Obtient le ColumnID de la colonne balisée, à valeurs multiples ou partiellement allouées Récupérée lorsque toutes les colonnes avec balises sont récupérées en passant 0 comme ColumnID à JetRetrieveColumn.
...
[Membres JET_RETINFO](./jet-retinfo-members.md)
