...
ms.locfileid: "127518521"
---
# <a name="instanceparametersnoinformationevent-property"></a>InstanceParameters. NoInformationEvent, propriété

Obtient ou définit une valeur indiquant si les messages du journal des événements d’information qui seraient normalement générés par le moteur de base de données seront supprimés.
