---
description: 'En savoir plus sur : énumération DupCursorGrbit'
title: Énumération DupCursorGrbit
...
Options pour [JetDupCursor (JET_SESID, JET_TABLEID, JET_TABLEID, DupCursorGrbit)](./api.jetdupcursor-method.md).
