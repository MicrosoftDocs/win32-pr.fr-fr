...
---
# <a name="esenttaskdroppedexception-members"></a>Membres EsentTaskDroppedException

Inclure les membres protégés  
Inclure les membres hérités  

Classe de base pour JET_err. Exceptions TaskDropped.

Le type [EsentTaskDroppedException](./esenttaskdroppedexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentTaskDroppedException.</td>
</tr>
</tbody>
</table>
