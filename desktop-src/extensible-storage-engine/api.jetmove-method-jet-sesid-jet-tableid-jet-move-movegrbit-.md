...
ms.locfileid: "117718717"
---
# <a name="apijetmove-method-jet_sesid-jet_tableid-jet_move-movegrbit"></a>Méthode API. JetMove (JET_SESID, JET_TABLEID, JET_Move, MoveGrbit)
