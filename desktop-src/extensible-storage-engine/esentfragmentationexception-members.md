---
description: 'En savoir plus sur les éléments suivants : EsentFragmentationException'
title: Membres EsentFragmentationException
...
ms.locfileid: "104201646"
---
# <a name="esentfragmentationexception-members"></a>Membres EsentFragmentationException
...
Le type [EsentFragmentationException](./esentfragmentationexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentFragmentationException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn350469(v=exchg.10).md">EsentFragmentationException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentFragmentationException.</td>
</tr>
</tbody>
</table>
