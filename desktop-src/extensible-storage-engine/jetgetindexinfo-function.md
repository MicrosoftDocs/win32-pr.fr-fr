...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetGetIndexInfoW</strong> (Unicode) et <strong>JetGetIndexInfoA</strong> (ANSI).</p> | 
