---
description: 'En savoir plus sur : énumération CloseDatabaseGrbit'
title: Énumération CloseDatabaseGrbit
...
Options pour [JetCloseDatabase (JET_SESID, JET_DBID, CloseDatabaseGrbit)](./api.jetclosedatabase-method.md).
