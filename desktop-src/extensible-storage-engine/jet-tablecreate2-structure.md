...
| <p><strong>Unicode</strong></p> | <p>Implémenté comme <strong>JET_TABLECREATE2_W</strong> (Unicode) et <strong>JET_TABLECREATE2_A</strong> (ANSI).</p> | 
