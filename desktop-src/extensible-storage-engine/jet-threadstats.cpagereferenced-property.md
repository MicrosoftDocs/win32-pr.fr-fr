---
description: 'En savoir plus sur : propriété JET_THREADSTATS. cPageReferenced'
title: JET_THREADSTATS. cPageReferenced, propriété (Microsoft. ISAM. esent. Interop. Vista)
...
ms.locfileid: "106526213"
---
# <a name="jet_threadstatscpagereferenced-property"></a>JET_THREADSTATS. cPageReferenced, propriété

Obtient le nombre total de pages de base de données visitées par le moteur de base de données sur le thread actuel.
