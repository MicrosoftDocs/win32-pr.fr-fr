...
ms.locfileid: "120065662"
---
# <a name="esentdiskexception-constructor-string-jet_err"></a>Constructeur EsentDiskException (String, JET_err)

Initialise une nouvelle instance de la classe EsentDiskException.
