...
ms.locfileid: "120093469"
---
# <a name="jet_recsizeadd-method"></a>JET_RECSIZE. Ajouter une méthode
...
Type : [Microsoft.ISAM.esent.Interop.Vista.JET_RECSIZE](./jet-recsize-structure2.md)  
JET_RECSIZE contenant le résultat de l’ajout de tailles dans S1 et S2.  
