...
---
# <a name="apijetossnapshotthaw-method"></a>API. JetOSSnapshotThaw, méthode

Notifie le moteur qu’il peut reprendre des opérations d’e/s normales après une période de blocage et une capture instantanée réussie.
