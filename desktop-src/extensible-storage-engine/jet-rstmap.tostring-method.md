---
description: 'En savoir plus sur : JET_RSTMAP. Méthode ToString'
title: JET_RSTMAP. Méthode ToString
...
ms.locfileid: "119945379"
---
# <a name="jet_rstmaptostring-method"></a>JET_RSTMAP. Méthode ToString

Retourne une [chaîne](/dotnet/api/system.string) qui représente le [JET_RSTMAP](./jet-rstmap-class.md)actuel.
...
[Chaîne](/dotnet/api/system.string) qui représente le [JET_RSTMAP](./jet-rstmap-class.md)actuel.  
