...
ms.locfileid: "126917331"
---
# <a name="jet_lstostring-method-string-iformatprovider"></a>JET_LS. ToString, méthode (String, IFormatProvider)
...
[ToString, surcharge](./jet-ls.tostring-method2.md)
