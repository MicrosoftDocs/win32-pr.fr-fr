...
ms.locfileid: "118784484"
---
# <a name="apijetdelete-method"></a>API. JetDelete, méthode

Supprime l’enregistrement en cours dans une table de base de données.
...
#### <a name="parameters"></a>Paramètres
  ...
  - sesid  
    ...
    Session qui a ouvert le curseur.
