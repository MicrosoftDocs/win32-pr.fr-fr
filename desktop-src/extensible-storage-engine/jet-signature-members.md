---
description: 'En savoir plus sur les membres suivants : JET_SIGNATURE'
title: Membres JET_SIGNATURE
...
ms.locfileid: "103951043"
---
# <a name="jet_signature-members"></a>Membres JET_SIGNATURE

Inclure les membres protégés  
Inclure les membres hérités  

La structure JET_SIGNATURE contient des informations qui identifient de façon unique une séquence de base de données ou de fichier journal.

Le type de [JET_SIGNATURE](./jet-signature-structure2.md) expose les membres suivants.
...
<td><a href="hh557517(v=exchg.10).md">Égal à (objet)</a></td>
...
<tr class="even">
<td><img src="../images/dn292146.pubmethod(exchg.10).gif" title="Méthode publique" alt="Public method" /></td>
<td><a href="hh564920(v=exchg.10).md">Égal à (JET_SIGNATURE)</a></td>
...
<td><a href="hh565133(v=exchg.10).md">Égalité</a></td>
<td>Détermine si deux instances spécifiées de JET_SIGNATURE sont égales.</td>
</tr>
<tr class="even">
<td><img src="../images/dn350944.puboperator(exchg.10).gif" title="Opérateur public" alt="Public operator" /><img src="../images/dn292146.static(exchg.10).gif" title="Membre statique" alt="Static member" /></td>
<td><a href="hh596753(v=exchg.10).md">Inégalité</a></td>
<td>Détermine si deux instances spécifiées de JET_SIGNATURE ne sont pas égales.</td>
</tr>
</tbody>
</table>
