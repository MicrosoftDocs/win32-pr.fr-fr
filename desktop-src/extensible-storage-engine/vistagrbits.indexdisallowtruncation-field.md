---
description: 'En savoir plus sur : champ VistaGrbits. IndexDisallowTruncation'
title: Champ VistaGrbits. IndexDisallowTruncation (Microsoft. ISAM. esent. Interop. Vista)
...
ms.locfileid: "117889851"
---
# <a name="vistagrbitsindexdisallowtruncation-field"></a>Champ VistaGrbits. IndexDisallowTruncation

Si vous spécifiez cet indicateur, toute mise à jour de l’index entraînant l’échec d’une clé tronquée avec [keytruncate](./jet-err-enumeration.md). Dans le cas contraire, les clés sont tronquées en mode silencieux.
