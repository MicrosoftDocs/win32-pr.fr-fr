---
description: 'En savoir plus sur les éléments suivants : EsentApiException'
title: Membres EsentApiException
...
ms.locfileid: "127012613"
---
# <a name="esentapiexception-members"></a>Membres EsentApiException
...
Le type [EsentApiException](./esentapiexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentApiException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn274002(v=exchg.10).md">EsentApiException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentApiException.</td>
</tr>
</tbody>
</table>
