...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetSetDatabaseSizeW</strong> (Unicode) et <strong>JetSetDatabaseSizeA</strong> (ANSI).</p> | 
