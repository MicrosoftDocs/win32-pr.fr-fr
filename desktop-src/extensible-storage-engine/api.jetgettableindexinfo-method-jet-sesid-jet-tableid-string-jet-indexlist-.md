...
ms.locfileid: "118272322"
---
# <a name="apijetgettableindexinfo-method-jet_sesid-jet_tableid-string-jet_indexlist"></a>Méthode API. JetGetTableIndexInfo (JET_SESID, JET_TABLEID, String, JET_INDEXLIST)
