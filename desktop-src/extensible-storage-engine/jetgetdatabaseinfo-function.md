...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetGetDatabaseInfoW</strong> (Unicode) et <strong>JetGetDatabaseInfoA</strong> (ANSI).</p> | 
