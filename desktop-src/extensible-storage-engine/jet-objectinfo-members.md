---
description: 'En savoir plus sur les membres suivants : JET_OBJECTINFO'
title: Membres JET_OBJECTINFO
...
ms.locfileid: "104556248"
---
# <a name="jet_objectinfo-members"></a>Membres JET_OBJECTINFO
...
Le type de [JET_OBJECTINFO](./jet-objectinfo-class.md) expose les membres suivants.
...
<td>Obtient le nombre de pages utilisées par la table.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335201(v=exchg.10).md">cRecord</a></td>
<td>Obtient le nombre d’enregistrements dans la table.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335202(v=exchg.10).md">flags</a></td>
<td>Obtient les indicateurs de type de table.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335203(v=exchg.10).md">grbit</a></td>
<td>Obtient les options de la table.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335205(v=exchg.10).md">objtyp</a></td>
<td>Obtient la JET_OBJTYP de la table. Actuellement, seules les tables sont retournées (autrement dit, <a href="hh565069(v=exchg.10).md">table</a>).</td>
</tr>
</tbody>
</table>
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn335219(v=exchg.10).md">JET_OBJECTINFO</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
