...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetCreateTableColumnIndexW</strong> (Unicode) et <strong>JetCreateTableColumnIndexA</strong> (ANSI).</p> | 
