...
---
# <a name="jet_indexlistcolumnidcolumnid-property"></a>JET_INDEXLIST. columnidcolumnid, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke la ColumnID de la colonne indexée. La colonne est de type [long](./jet-coltyp-enumeration.md).
