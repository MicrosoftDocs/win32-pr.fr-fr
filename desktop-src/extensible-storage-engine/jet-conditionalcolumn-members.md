---
description: 'En savoir plus sur les membres suivants : JET_CONDITIONALCOLUMN'
title: Membres JET_CONDITIONALCOLUMN
...
ms.locfileid: "127413166"
---
# <a name="jet_conditionalcolumn-members"></a>Membres JET_CONDITIONALCOLUMN
...
Le type de [JET_CONDITIONALCOLUMN](./jet-conditionalcolumn-class.md) expose les membres suivants.
...
<td>Obtient ou définit les options pour l’index conditionnel.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335113(v=exchg.10).md">szColumnName</a></td>
<td>Obtient ou définit le nom de la colonne conditionnelle.</td>
</tr>
</tbody>
</table>
