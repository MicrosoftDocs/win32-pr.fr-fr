...
ms.locfileid: "127012630"
---
# <a name="apimakekey-method-jet_sesid-jet_tableid-boolean-makekeygrbit"></a>Méthode API. MakeKey (JET_SESID, JET_TABLEID, Boolean, MakeKeyGrbit)
