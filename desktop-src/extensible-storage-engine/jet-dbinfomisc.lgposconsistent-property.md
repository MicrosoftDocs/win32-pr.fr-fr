...
ms.locfileid: "127012515"
---
# <a name="jet_dbinfomisclgposconsistent-property"></a>JET_DBINFOMISC. lgposConsistent, propriété

Obtient le lgpos lorsque la base de données a été rendue cohérente. Cette valeur est null si la base de données est incohérente.
