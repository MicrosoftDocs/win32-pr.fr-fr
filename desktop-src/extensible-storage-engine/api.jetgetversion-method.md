...
---
# <a name="apijetgetversion-method"></a>API. JetGetVersion, méthode

Récupère la version du moteur de base de données.
...
<!-- end list -->
  ...
  - version  
    ...
    Retourne le numéro de version du moteur de base de données.
