...
ms.locfileid: "127411538"
---
# <a name="esentquotaexception-constructor-string-jet_err"></a>Constructeur EsentQuotaException (String, JET_err)

Initialise une nouvelle instance de la classe EsentQuotaException.
