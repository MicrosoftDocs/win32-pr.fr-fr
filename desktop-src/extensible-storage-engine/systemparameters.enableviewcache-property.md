...
---
# <a name="systemparametersenableviewcache-property"></a>Propriété SystemParameters. EnableViewCache

Obtient ou définit une valeur indiquant si le moteur de base de données doit utiliser des e/s de fichier mappées en mémoire pour les fichiers de base de données.
