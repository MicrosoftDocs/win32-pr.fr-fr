...
ms.locfileid: "127413156"
---
# <a name="jet_tablecreatergcolumncreate-property"></a>JET_TABLECREATE. rgcolumncreate, propriété

Obtient ou définit un tableau d’informations de création de colonne, de type [JET_COLUMNCREATE](./jet-columncreate-class.md).
