...
ms.locfileid: "118486227"
---
# <a name="jet_dbinfomiscsignlog-property"></a>JET_DBINFOMISC. signLog, propriété

Obtient la signature du fichier journal des journaux utilisés pour modifier la base de données.
