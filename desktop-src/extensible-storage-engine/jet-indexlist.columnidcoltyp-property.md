...
---
# <a name="jet_indexlistcolumnidcoltyp-property"></a>JET_INDEXLIST. columnidcoltyp, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke le type de colonne de la colonne en cours d’indexation. La colonne est de type [long](./jet-coltyp-enumeration.md).
