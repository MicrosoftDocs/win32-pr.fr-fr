---
description: 'En savoir plus sur : constructeur InstanceParameters'
title: Constructeur InstanceParameters
...
ms.locfileid: "127291674"
---
# <a name="instanceparameters-constructor"></a>Constructeur InstanceParameters

Initialise une nouvelle instance de la classe InstanceParameters.
...
#### <a name="parameters"></a>Paramètres
  ...
  - instance  
    ...
    Instance sur laquelle définir des paramètres. Si ce n’est JET_INSTANCE. Nil, alors les paramètres affectent les paramètres par défaut des instances futures.
