...
---
# <a name="jet_objectlistcolumnidcrecord-property"></a>JET_OBJECTLIST. columnidcRecord, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke le nombre d’enregistrements dans la table.
