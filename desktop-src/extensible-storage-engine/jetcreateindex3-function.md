...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetCreateIndex3W</strong> (Unicode) et <strong>JetCreateIndex3A</strong> (ANSI).</p> | 
