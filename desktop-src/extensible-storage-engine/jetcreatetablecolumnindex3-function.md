...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetCreateTableColumnIndex3W</strong> (Unicode) et <strong>JetCreateTableColumnIndex3A</strong> (ANSI).</p> | 
