---
description: 'En savoir plus sur les membres suivants : JET_COLUMNDEF'
title: Membres JET_COLUMNDEF
...
ms.locfileid: "127404579"
---
# <a name="jet_columndef-members"></a>Membres JET_COLUMNDEF
...
Le type de [JET_COLUMNDEF](./jet-columndef-class.md) expose les membres suivants.
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn335038(v=exchg.10).md">JET_COLUMNDEF</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
