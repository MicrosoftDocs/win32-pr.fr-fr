...
ms.locfileid: "119945729"
---
# <a name="jet_opentemporarytableprgcolumndef-property"></a>JET_OPENTEMPORARYTABLE. prgcolumndef, propriété

Obtient ou définit les définitions de colonne pour les colonnes créées dans la table temporaire.
