...
Le type [EsentQuotaException](./esentquotaexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentQuotaException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn319867(v=exchg.10).md">EsentQuotaException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentQuotaException.</td>
</tr>
</tbody>
</table>
