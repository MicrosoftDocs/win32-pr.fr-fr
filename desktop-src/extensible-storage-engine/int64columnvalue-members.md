...
---
# <a name="int64columnvalue-members"></a>Membres Int64ColumnValue

Inclure les membres protégés  
Inclure les membres hérités  

Valeur de colonne [Int64](/dotnet/api/system.int64) .

Le type [Int64ColumnValue](./int64columnvalue-class.md) expose les membres suivants.
...
<td><a href="dn335027(v=exchg.10).md">Taille</a></td>
