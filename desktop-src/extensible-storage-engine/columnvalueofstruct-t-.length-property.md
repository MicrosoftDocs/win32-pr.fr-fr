...
---
# <a name="columnvalueofstructtlength-property"></a>ColumnValueOfStruct \<T\> . Length, propriété

Obtient la longueur d’octet d’une valeur de colonne, qui est égale à zéro si la colonne est NULL ; sinon, elle correspond à la taille de cette colonne de taille fixe.
