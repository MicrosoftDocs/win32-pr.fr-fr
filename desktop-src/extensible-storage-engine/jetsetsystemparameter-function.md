...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetSetSystemParameterW</strong> (Unicode) et <strong>JetSetSystemParameterA</strong> (ANSI).</p> | 
