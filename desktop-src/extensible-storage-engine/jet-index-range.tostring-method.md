---
description: 'En savoir plus sur : JET_INDEX_RANGE. Méthode ToString'
title: JET_INDEX_RANGE. ToString, méthode (Microsoft. ISAM. esent. Interop. Windows8)
...
ms.locfileid: "127295503"
---
# <a name="jet_index_rangetostring-method"></a>JET_INDEX_RANGE. Méthode ToString

Retourne une [chaîne](/dotnet/api/system.string) qui représente le [JET_INDEX_RANGE](./jet-index-range-class.md)actuel.
...
[Membres JET_INDEX_RANGE](./jet-index-range-members.md)
