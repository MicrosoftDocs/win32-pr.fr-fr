---
description: 'En savoir plus sur : JET_ENUMCOLUMN. Méthode ToString'
title: JET_ENUMCOLUMN. Méthode ToString
...
Retourne une [chaîne](/dotnet/api/system.string) qui représente le [JET_ENUMCOLUMN](./jet-enumcolumn-class.md)actuel.
