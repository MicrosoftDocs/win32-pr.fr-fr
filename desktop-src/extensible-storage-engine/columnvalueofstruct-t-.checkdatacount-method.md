---
description: 'En savoir plus sur : ColumnValueOfStruct <T> . Méthode CheckDataCount'
title: ColumnValueOfStruct (T). Méthode CheckDataCount
...
ms.locfileid: "127521661"
---
# <a name="columnvalueofstructtcheckdatacount-method"></a>ColumnValueOfStruct \<T\> . Méthode CheckDataCount

Assurez-vous que les données récupérées sont exactement la taille nécessaire pour la structure. Une exception est levée en cas d’incompatibilité.
