---
description: 'En savoir plus sur : JET_INDEXID. Equals, méthode (JET_INDEXID)'
title: JET_INDEXID. Equals, méthode (JET_INDEXID)
...
ms.locfileid: "106529430"
---
# <a name="jet_indexidequals-method-jet_indexid"></a>JET_INDEXID. Equals, méthode (JET_INDEXID)
...
[Est égal à la surcharge](./jet-indexid.equals-method.md)
