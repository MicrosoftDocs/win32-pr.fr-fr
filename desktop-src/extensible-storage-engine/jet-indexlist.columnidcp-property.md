...
ms.locfileid: "126920779"
---
# <a name="jet_indexlistcolumnidcp-property"></a>JET_INDEXLIST. columnidCp, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke la page de codes de la colonne indexée. La colonne est de type [short](./jet-coltyp-enumeration.md).
