---
description: 'En savoir plus sur : propriété JET_RETINFO. ibLongValue'
title: JET_RETINFO. ibLongValue, propriété
...
ms.locfileid: "106518950"
---
# <a name="jet_retinfoiblongvalue-property"></a>JET_RETINFO. ibLongValue, propriété

Obtient ou définit le décalage vers le premier octet à récupérer à partir d’une colonne de type [LONGBINARY](./jet-coltyp-enumeration.md), ou [LONGTEXT](./jet-coltyp-enumeration.md).
