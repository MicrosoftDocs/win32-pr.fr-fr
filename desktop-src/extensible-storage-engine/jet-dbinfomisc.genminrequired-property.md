---
description: 'En savoir plus sur : propriété JET_DBINFOMISC. genMinRequired'
title: JET_DBINFOMISC. genMinRequired, propriété
...
ms.locfileid: "106517491"
---
# <a name="jet_dbinfomiscgenminrequired-property"></a>JET_DBINFOMISC. genMinRequired, propriété

Obtient la génération de journal minimale requise pour relire les journaux. En général, la génération du point de contrôle.
