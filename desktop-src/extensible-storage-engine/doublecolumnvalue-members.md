...
Valeur de colonne [double](/dotnet/api/system.double) .

Le type [DoubleColumnValue](./doublecolumnvalue-class.md) expose les membres suivants.
...
<td><a href="dn273977(v=exchg.10).md">Taille</a></td>
