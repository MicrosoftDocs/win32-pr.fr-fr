...
ms.locfileid: "127415961"
---
# <a name="windows8apiprereadkeyranges-method"></a>Méthode Windows8Api. PrereadKeyRanges

Si les enregistrements avec les plages de clés spécifiées ne sont pas dans le cache des tampons, démarrez les lectures asynchrones pour placer les enregistrements dans le cache des tampons de la base de données.
...
<!-- end list -->
  ...
  - keysStart  
    ...
    Début des plages de clés à prélire.
...
<!-- end list -->
  ...
  - keyStartLengths  
    ...
    Longueurs des clés de début à prélire.
...
<!-- end list -->
  ...
  - keysend  
    ...
    Fin de la plage de clés à prélire.
...
<!-- end list -->
  ...
  - keyEndLengths  
    ...
    Longueurs des touches de fin à prélire.
