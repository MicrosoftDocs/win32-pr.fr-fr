---
description: 'En savoir plus sur : méthode table. ToString'
title: Table. ToString, méthode
...
ms.locfileid: "126920624"
---
# <a name="tabletostring-method"></a>Table. ToString, méthode

Retourne une [chaîne](/dotnet/api/system.string) qui représente la [table](./table-class.md)actuelle.
...
[Chaîne](/dotnet/api/system.string) qui représente la [table](./table-class.md)actuelle.  
