---
description: 'En savoir plus sur les membres suivants : JET_RSTINFO'
title: Membres JET_RSTINFO
...
ms.locfileid: "103750573"
---
# <a name="jet_rstinfo-members"></a>Membres JET_RSTINFO
...
Le type de [JET_RSTINFO](./jet-rstinfo-class.md) expose les membres suivants.
...
<td>Obtient ou définit le nombre d’éléments dans le tableau de mappage de restauration.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335245(v=exchg.10).md">lgposStop</a></td>
<td>Obtient ou définit la position du journal pour arrêter la récupération.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn351053(v=exchg.10).md">logtimeStop</a></td>
<td>Obtient ou définit l’heure à laquelle il s’est arrêté.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335247(v=exchg.10).md">pfnStatus</a></td>
<td>Obtient ou définit le rappel pour obtenir ou définir la fonction d’État.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn351045(v=exchg.10).md">rgrstmap</a></td>
<td>Obtient ou définit le tableau de structures de <a href="dn351048(v=exchg.10).md">JET_RSTMAP</a> .</td>
</tr>
</tbody>
</table>
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn335235(v=exchg.10).md">JET_RSTINFO</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
