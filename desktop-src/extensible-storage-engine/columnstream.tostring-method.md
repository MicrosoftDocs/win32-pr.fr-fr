---
description: 'En savoir plus sur : méthode ColumnStream. ToString'
title: ColumnStream. ToString, méthode
...
ms.locfileid: "119454969"
---
# <a name="columnstreamtostring-method"></a>ColumnStream. ToString, méthode

Retourne une [chaîne](/dotnet/api/system.string) qui représente le [ColumnStream](./columnstream-class.md)actuel.
...
[Chaîne](/dotnet/api/system.string) qui représente le [ColumnStream](./columnstream-class.md)actuel.  
