...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetGetSystemParameterW</strong> (Unicode) et <strong>JetGetSystemParameterA</strong> (ANSI).</p> | 
