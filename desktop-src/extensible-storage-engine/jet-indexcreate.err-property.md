---
description: 'En savoir plus sur : JET_INDEXCREATE. Err (propriété)'
title: JET_INDEXCREATE. Err (propriété)
...
ms.locfileid: "127196947"
---
# <a name="jet_indexcreateerr-property"></a>JET_INDEXCREATE. Err (propriété)

Obtient ou définit le code d’erreur de la création de cet index.
