---
description: 'En savoir plus sur : JET_TABLEID. Equals (méthode)'
title: JET_TABLEID. Equals (méthode)
...
ms.locfileid: "104204082"
---
# <a name="jet_tableidequals-method"></a>JET_TABLEID. Equals (méthode)
