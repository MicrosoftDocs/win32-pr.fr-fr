...
---
# <a name="esentspavailextcacheoutofmemoryexception-members"></a>Membres EsentSPAvailExtCacheOutOfMemoryException

Inclure les membres protégés  
Inclure les membres hérités  

Classe de base pour JET_err. Exceptions SPAvailExtCacheOutOfMemory.

Le type [EsentSPAvailExtCacheOutOfMemoryException](./esentspavailextcacheoutofmemoryexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentSPAvailExtCacheOutOfMemoryException.</td>
</tr>
</tbody>
</table>
