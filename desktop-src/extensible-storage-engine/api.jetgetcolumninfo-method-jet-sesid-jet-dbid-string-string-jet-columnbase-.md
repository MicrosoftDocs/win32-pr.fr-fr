...
ms.locfileid: "127517980"
---
# <a name="apijetgetcolumninfo-method-jet_sesid-jet_dbid-string-string-jet_columnbase"></a>Méthode API. JetGetColumnInfo (JET_SESID, JET_DBID, String, String, JET_COLUMNBASE)
