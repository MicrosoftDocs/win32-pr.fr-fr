...
ms.locfileid: "118084813"
---
# <a name="apijetsetdatabasesize-method"></a>API. JetSetDatabaseSize, méthode

Définit la taille d’un fichier de base de données non ouvert.
