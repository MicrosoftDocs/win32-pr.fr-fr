...
ms.locfileid: "127012503"
---
# <a name="jet_indexlistcolumnidicolumn-property"></a>JET_INDEXLIST. columnidiColumn, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke l’index de de cette colonne dans la clé d’index. La colonne est de type [long](./jet-coltyp-enumeration.md).
