...
| <p>JET_errSessionContextNotSetByThisThread</p> | <p>La session n’a pas pu être dissociée du thread actuel, car elle est associée à un thread différent.</p> | 
