...
Classe de base pour JET_err. Exceptions CallbackFailed.

Le type [EsentCallbackFailedException](./esentcallbackfailedexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentCallbackFailedException.</td>
</tr>
</tbody>
</table>
