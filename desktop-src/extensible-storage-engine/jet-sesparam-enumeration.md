...
ms.locfileid: "127010210"
---
# <a name="jet_sesparam-enumeration"></a>Énumération JET_sesparam

Paramètres de session ESENT.
...
<td></td>
<td>Base</td>
<td>Ce paramètre n’est pas destiné à être utilisé.</td>
</tr>
<tr class="even">
<td></td>
<td>CommitDefault</td>
<td>Ce paramètre définit grbits pour la validation. Il fonctionne de la même façon que le paramètre système JET_param. CommitDefault lorsqu’il est utilisé avec une instance et un sesid.</td>
</tr>
<tr class="odd">
<td></td>
<td>CommitGenericContext</td>
<td>Ce paramètre définit un contexte de validation spécifique à l’utilisateur qui sera placé dans le journal des transactions lors de la validation au niveau 0.</td>
</tr>
</tbody>
</table>
