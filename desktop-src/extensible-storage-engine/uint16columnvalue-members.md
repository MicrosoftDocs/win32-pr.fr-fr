...
---
# <a name="uint16columnvalue-members"></a>Membres UInt16ColumnValue

Inclure les membres protégés  
Inclure les membres hérités  

Valeur de colonne [UInt16](/dotnet/api/system.uint16) .

Le type [UInt16ColumnValue](./uint16columnvalue-class.md) expose les membres suivants.
...
<td><a href="dn351182(v=exchg.10).md">Taille</a></td>
