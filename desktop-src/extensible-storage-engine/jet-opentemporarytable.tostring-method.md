---
description: 'En savoir plus sur : JET_OPENTEMPORARYTABLE. Méthode ToString'
title: JET_OPENTEMPORARYTABLE. ToString, méthode (Microsoft. ISAM. esent. Interop. Vista)
...
ms.locfileid: "127007765"
---
# <a name="jet_opentemporarytabletostring-method"></a>JET_OPENTEMPORARYTABLE. Méthode ToString

Retourne une [chaîne](/dotnet/api/system.string) qui représente le [JET_OPENTEMPORARYTABLE](./jet-opentemporarytable-class.md)actuel.
...
[Chaîne](/dotnet/api/system.string) qui représente le [JET_OPENTEMPORARYTABLE](./jet-opentemporarytable-class.md)actuel.  
