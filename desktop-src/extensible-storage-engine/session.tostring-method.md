---
description: 'En savoir plus sur : session. ToString, méthode'
title: Session. ToString, méthode
...
ms.locfileid: "118485518"
---
# <a name="sessiontostring-method"></a>Session. ToString, méthode

Retourne une [chaîne](/dotnet/api/system.string) qui représente la [session](./session-class.md)active.
...
[Chaîne](/dotnet/api/system.string) qui représente la [session](./session-class.md)active.  
