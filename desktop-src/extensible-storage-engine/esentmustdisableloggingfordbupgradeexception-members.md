...
Classe de base pour JET_err. Exceptions MustDisableLoggingForDbUpgrade.

Le type [EsentMustDisableLoggingForDbUpgradeException](./esentmustdisableloggingfordbupgradeexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentMustDisableLoggingForDbUpgradeException.</td>
</tr>
</tbody>
</table>
