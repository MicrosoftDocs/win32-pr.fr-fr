...
ms.locfileid: "118978249"
---
# <a name="update-constructor"></a>Mettre à jour un constructeur

Initialise une nouvelle instance de la classe de mise à jour. Une mise à jour est automatiquement lancée. La mise à jour sera annulée si elle n’est pas explicitement enregistrée.
...
<!-- end list -->
  ...
  - TableID  
    ...
    TableID pour la préparation de la mise à jour.
