---
description: 'En savoir plus sur les méthodes suivantes : IContentEquatable <T>'
title: Méthodes IContentEquatable (T)
...
ms.locfileid: "103951493"
---
# <a name="icontentequatablet-methods"></a>\<T\>Méthodes IContentEquatable

Inclure les membres protégés  
Inclure les membres hérités  

Le [type \<T\> IContentEquatable](./icontentequatable-t-interface.md) expose les membres suivants.
