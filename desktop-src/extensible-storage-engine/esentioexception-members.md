---
description: 'En savoir plus sur les éléments suivants : EsentIOException'
title: Membres EsentIOException
...
ms.locfileid: "126917776"
---
# <a name="esentioexception-members"></a>Membres EsentIOException
...
Le type [EsentIOException](./esentioexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentIOException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn319596(v=exchg.10).md">EsentIOException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentIOException.</td>
</tr>
</tbody>
</table>
