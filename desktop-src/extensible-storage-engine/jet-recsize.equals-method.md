---
description: 'En savoir plus sur : JET_RECSIZE. Equals (méthode)'
title: JET_RECSIZE. Equals, méthode (Microsoft. ISAM. esent. Interop. Vista)
...
ms.locfileid: "104550599"
---
# <a name="jet_recsizeequals-method"></a>JET_RECSIZE. Equals (méthode)
