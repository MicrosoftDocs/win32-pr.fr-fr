...
---
# <a name="jet_enumcolumnvalueitagsequence-property"></a>JET_ENUMCOLUMNVALUE. itagSequence, propriété

Obtient la valeur de colonne (par index de base un) qui a été énumérée.
