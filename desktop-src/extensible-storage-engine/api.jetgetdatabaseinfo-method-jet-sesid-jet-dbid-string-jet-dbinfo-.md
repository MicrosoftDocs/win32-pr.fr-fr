...
ms.locfileid: "126917912"
---
# <a name="apijetgetdatabaseinfo-method-jet_sesid-jet_dbid-string-jet_dbinfo"></a>Méthode API. JetGetDatabaseInfo (JET_SESID, JET_DBID, String, JET_DbInfo)
