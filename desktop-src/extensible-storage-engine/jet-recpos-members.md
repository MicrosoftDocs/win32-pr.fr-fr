---
description: 'En savoir plus sur les membres suivants : JET_RECPOS'
title: Membres JET_RECPOS
...
ms.locfileid: "119107528"
---
# <a name="jet_recpos-members"></a>Membres JET_RECPOS

Inclure les membres protégés  
Inclure les membres hérités  

Représente une position fractionnaire dans un index. Utilisé par JetGotoPosition et JetGetRecordPosition.

Le type de [JET_RECPOS](./jet-recpos-class.md) expose les membres suivants.
...
<td>Obtient ou définit le nombre approximatif d’entrées d’index inférieures à la clé.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335278(v=exchg.10).md">centriesTotal</a></td>
<td>Obtient ou définit le nombre approximatif d’entrées dans l’index.</td>
</tr>
</tbody>
</table>
