---
description: 'En savoir plus sur : propriété JET_SETCOLUMN. Grbit'
title: JET_SETCOLUMN. Grbit, propriété
...
Obtient ou définit les options de l’opération de définition de colonne.
