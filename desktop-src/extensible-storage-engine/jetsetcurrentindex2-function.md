...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetSetCurrentIndex2W</strong> (Unicode) et <strong>JetSetCurrentIndex2A</strong> (ANSI).</p> | 
