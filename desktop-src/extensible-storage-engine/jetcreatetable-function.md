...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetCreateTableW</strong> (Unicode) et <strong>JetCreateTableA</strong> (ANSI).</p> | 
