---
description: 'En savoir plus sur : propriété JET_TABLECREATE. rgindexcreate'
title: JET_TABLECREATE. rgindexcreate, propriété
...
ms.locfileid: "119472789"
---
# <a name="jet_tablecreatergindexcreate-property"></a>JET_TABLECREATE. rgindexcreate, propriété

Obtient ou définit un tableau d’index à créer, de type [JET_INDEXCREATE](./jet-indexcreate-class.md).
