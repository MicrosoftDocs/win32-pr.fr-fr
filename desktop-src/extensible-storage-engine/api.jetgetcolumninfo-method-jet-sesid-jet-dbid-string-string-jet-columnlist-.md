...
ms.locfileid: "118085357"
---
# <a name="apijetgetcolumninfo-method-jet_sesid-jet_dbid-string-string-jet_columnlist"></a>Méthode API. JetGetColumnInfo (JET_SESID, JET_DBID, String, String, JET_COLUMNLIST)

Récupère des informations sur toutes les colonnes d’une table.
