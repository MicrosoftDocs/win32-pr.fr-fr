...
---
# <a name="apijetgettablecolumninfo-method-jet_sesid-jet_tableid-string-jet_columnlist"></a>Méthode API. JetGetTableColumnInfo (JET_SESID, JET_TABLEID, String, JET_COLUMNLIST)

Récupère des informations sur toutes les colonnes de la table.
