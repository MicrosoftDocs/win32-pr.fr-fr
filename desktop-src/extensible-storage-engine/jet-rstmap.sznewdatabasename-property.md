---
description: 'En savoir plus sur : propriété JET_RSTMAP. szNewDatabaseName'
title: JET_RSTMAP. szNewDatabaseName, propriété
...
Obtient ou définit le nom/chemin d’accès actuel de la base de données. Ne doit pas avoir la valeur Null.
