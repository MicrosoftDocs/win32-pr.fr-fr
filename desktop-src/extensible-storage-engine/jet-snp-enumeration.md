...
---
# <a name="jet_snp-enumeration"></a>Énumération JET_SNP

Type d’opération pour lequel la progression est signalée.
...
<td></td>
<td>Réparation</td>
<td>Le rappel est destiné à une option de réparation.</td>
</tr>
<tr class="even">
<td></td>
<td>Compact</td>
<td>Le rappel est destiné à la défragmentation de la base de données.</td>
</tr>
<tr class="odd">
<td></td>
<td>Restaurer</td>
<td>Le rappel concerne les options de restauration.</td>
</tr>
<tr class="even">
<td></td>
<td>Sauvegarde</td>
<td>Le rappel est destiné aux options de sauvegarde.</td>
</tr>
<tr class="odd">
<td></td>
<td>Balay</td>
<td>Le rappel est destiné à la mise en zéro de la base de données.</td>
</tr>
<tr class="even">
<td></td>
<td>UpgradeRecordFormat</td>
<td>Le rappel est destiné au processus de mise à niveau du format d’enregistrement de toutes les pages de la base de données.</td>
</tr>
</tbody>
</table>
