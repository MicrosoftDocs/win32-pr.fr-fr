---
description: 'En savoir plus sur les membres suivants : JET_OBJECTLIST'
title: Membres JET_OBJECTLIST
...
ms.locfileid: "118765995"
---
# <a name="jet_objectlist-members"></a>Membres JET_OBJECTLIST

Inclure les membres protégés  
Inclure les membres hérités  

Informations sur une table temporaire contenant des informations sur toutes les tables d’une base de données donnée.

Le type de [JET_OBJECTLIST](./jet-objectlist-class.md) expose les membres suivants.
...
<td>Obtient le ColumnID de la colonne dans la table temporaire qui stocke le nombre de pages utilisées par la table.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335209(v=exchg.10).md">columnidcRecord</a></td>
<td>Obtient le ColumnID de la colonne dans la table temporaire qui stocke le nombre d’enregistrements dans la table.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335210(v=exchg.10).md">columnidflags</a></td>
<td>Obtient le ColumnID de la colonne dans la table temporaire qui stocke les indicateurs de table (par exemple, l’indicateur de table système).</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335211(v=exchg.10).md">columnidgrbit</a></td>
<td>Obtient le ColumnID de la colonne dans la table temporaire qui stocke le grbits utilisé lors de la création de la table.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335213(v=exchg.10).md">columnidobjectname</a></td>
<td>Obtient le ColumnID de la colonne dans la table temporaire qui stocke le nom de la table.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335212(v=exchg.10).md">columnidobjtyp</a></td>
<td>Obtient le ColumnID de la colonne dans la table temporaire qui stocke le type de la table.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn335206(v=exchg.10).md">JET_OBJECTLIST</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
