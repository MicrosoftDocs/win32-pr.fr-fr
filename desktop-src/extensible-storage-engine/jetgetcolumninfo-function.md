...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetGetColumnInfoW</strong> (Unicode) et <strong>JetGetColumnInfoA</strong> (ANSI).</p> | 
