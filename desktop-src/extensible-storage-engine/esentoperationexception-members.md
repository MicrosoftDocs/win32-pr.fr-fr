---
description: 'En savoir plus sur les éléments suivants : EsentOperationException'
title: Membres EsentOperationException
...
ms.locfileid: "118493627"
---
# <a name="esentoperationexception-members"></a>Membres EsentOperationException
...
Le type [EsentOperationException](./esentoperationexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentOperationException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292116.protmethod(exchg.10).gif" title="Méthode protégée" alt="Protected method" /></td>
<td><a href="dn319686(v=exchg.10).md">EsentOperationException (String, JET_err)</a></td>
<td>Initialise une nouvelle instance de la classe EsentOperationException.</td>
</tr>
</tbody>
</table>
