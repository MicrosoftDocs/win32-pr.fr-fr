---
description: 'En savoir plus sur : SystemParameters. BookmarkMost, propriété'
title: Propriété SystemParameters. BookmarkMost
...
Obtient la taille maximale d’un signet. [JetGetBookmark (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32)](./api.jetgetbookmark-method.md).
