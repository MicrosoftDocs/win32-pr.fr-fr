...
ms.locfileid: "118983049"
---
# <a name="apimakekey-method-jet_sesid-jet_tableid-int32-makekeygrbit"></a>Méthode API. MakeKey (JET_SESID, JET_TABLEID, Int32, MakeKeyGrbit)
