...
---
# <a name="jet_indexcreatecconditionalcolumn-property"></a>JET_INDEXCREATE. cConditionalColumn, propriété

Obtient ou définit le nombre de colonnes conditionnelles.
