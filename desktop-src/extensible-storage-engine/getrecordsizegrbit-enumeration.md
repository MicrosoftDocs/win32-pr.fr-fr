...
Options pour [JetGetRecordSize (JET_SESID, JET_TABLEID, JET_RECSIZE, GetRecordSizeGrbit)](./vistaapi.jetgetrecordsize-method.md).
...
<td></td>
<td>InCopyBuffer</td>
<td>Récupérez la taille de l’enregistrement qui se trouve dans le tampon de copie préparé ou mis à jour. Dans le cas contraire, l’TableID doit être positionné sur un enregistrement et cet enregistrement sera utilisé.</td>
</tr>
<tr class="odd">
<td></td>
<td>RunningTotal</td>
<td>Le JET_RECSIZE n’est pas mis à zéro avant de remplir le contenu, ce qui agit efficacement comme une accumulation des statistiques pour plusieurs enregistrements visités ou mis à jour.</td>
</tr>
<tr class="even">
<td></td>
<td>Local</td>
<td>Ignore les valeurs longues non intrinsèques. Seul l’enregistrement local de la page sera utilisé.</td>
</tr>
</tbody>
</table>
