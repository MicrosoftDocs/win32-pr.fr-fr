...
ms.locfileid: "127518573"
---
# <a name="apijetcreateinstance-method"></a>API. JetCreateInstance, méthode

Alloue une nouvelle instance du moteur de base de données.
...
<!-- end list -->
  ...
  - name  
    ...
    Nom de l'instance. Les noms doivent être uniques.
