---
description: 'En savoir plus sur : méthode API. SetColumn'
title: API. SetColumn, méthode
...
ms.locfileid: "104555496"
---
# <a name="apisetcolumn-method"></a>API. SetColumn, méthode
