...
---
# <a name="jet_threadstatscblogrecord-property"></a>JET_THREADSTATS. cbLogRecord, propriété

Obtient la taille totale, en octets, des enregistrements du journal des transactions qui ont été générés par le moteur de base de données sur le thread actuel.
