---
description: 'En savoir plus sur les membres suivants : JET_INDEX_COLUMN'
title: Membres JET_INDEX_COLUMN (Microsoft. ISAM. esent. Interop. Windows8)
...
ms.locfileid: "119401699"
---
# <a name="jet_index_column-members"></a>Membres JET_INDEX_COLUMN

Inclure les membres protégés  
Inclure les membres hérités  

Contient la définition de filtre pour [JetPrereadIndexRanges (JET_SESID, JET_TABLEID, \[ \] , Int32, Int32, Int32, \[ \] , PrereadIndexRangesGrbit)](./windows8api.jetprereadindexranges-method.md) et [JetSetCursorFilter (JET_SESID, JET_TABLEID, \[ \] , CursorFilterGrbit)](./windows8api.jetsetcursorfilter-method.md).

Le type de [JET_INDEX_COLUMN](./jet-index-column-class.md) expose les membres suivants.
...
<td>Obtient ou définit l’option pour cette comparaison de colonnes.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335479(v=exchg.10).md">pvData</a></td>
<td>Obtient ou définit la valeur à laquelle la colonne doit être comjointe.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn335358(v=exchg.10).md">RelOp</a></td>
<td>Obtient ou définit l’opération de comparaison de filtre.</td>
</tr>
</tbody>
</table>
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn335349(v=exchg.10).md">JET_INDEX_COLUMN</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
