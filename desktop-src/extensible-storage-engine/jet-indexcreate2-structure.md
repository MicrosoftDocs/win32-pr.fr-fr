...
| <p><strong>Unicode</strong></p> | <p>Implémenté comme <strong>JET_ INDEXCREATE2_W</strong> (Unicode) et <strong>JET_ INDEXCREATE2_A</strong> (ANSI).</p> | 
