---
description: 'En savoir plus sur : JET_TABLEID. Equals, méthode (JET_TABLEID)'
title: JET_TABLEID. Equals, méthode (JET_TABLEID)
...
ms.locfileid: "104204083"
---
# <a name="jet_tableidequals-method-jet_tableid"></a>JET_TABLEID. Equals, méthode (JET_TABLEID)
...
[Est égal à la surcharge](./jet-tableid.equals-method.md)
