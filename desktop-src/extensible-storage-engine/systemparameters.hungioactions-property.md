---
description: 'En savoir plus sur : SystemParameters. HungIOActions, propriété'
title: Propriété SystemParameters. HungIOActions
...
Obtient ou définit l’ensemble des actions à effectuer sur IOs qui apparaissent bloquées.
