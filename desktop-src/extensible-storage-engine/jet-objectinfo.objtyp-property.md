---
description: 'En savoir plus sur : propriété JET_OBJECTINFO. objtyp'
title: JET_OBJECTINFO. objtyp, propriété
...
ms.locfileid: "118979789"
---
# <a name="jet_objectinfoobjtyp-property"></a>JET_OBJECTINFO. objtyp, propriété

Obtient la JET_OBJTYP de la table. Actuellement, seules les tables sont retournées (autrement dit, [table](./jet-objtyp-enumeration.md)).
