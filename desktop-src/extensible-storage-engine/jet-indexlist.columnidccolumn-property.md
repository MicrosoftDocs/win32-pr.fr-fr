---
description: 'En savoir plus sur : propriété JET_INDEXLIST. columnidcColumn'
title: JET_INDEXLIST. columnidcColumn, propriété
...
ms.locfileid: "127517841"
---
# <a name="jet_indexlistcolumnidccolumn-property"></a>JET_INDEXLIST. columnidcColumn, propriété

Obtient le ColumnID de la colonne dans la table temporaire qui stocke le nombre de colonnes dans la clé d’index. La colonne est de type [long](./jet-coltyp-enumeration.md).
