...
Classe qui encapsule une transaction sur un JET_SESID.
...
<td>Initialise une nouvelle instance de la classe transaction. Une transaction est alors automatiquement lancée. La transaction sera restaurée si elle n’est pas explicitement validée.</td>
</tr>
</tbody>
</table>
...
<td>Obtient une valeur indiquant si cet objet est actuellement dans une transaction.</td>
</tr>
</tbody>
</table>
