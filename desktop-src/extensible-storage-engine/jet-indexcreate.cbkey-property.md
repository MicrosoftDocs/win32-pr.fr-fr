...
---
# <a name="jet_indexcreatecbkey-property"></a>JET_INDEXCREATE. cbKey, propriété

Obtient ou définit la longueur, en caractères, de szKey, y compris les deux valeurs null de fin.
