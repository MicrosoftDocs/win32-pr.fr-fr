---
description: 'En savoir plus sur : SystemParameters. BaseNameLength Field'
title: Champ SystemParameters. BaseNameLength
...
Longueur du préfixe utilisé pour nommer les fichiers utilisés par le moteur de base de données.
