...
---
# <a name="instanceparametersmaxopentables-property"></a>InstanceParameters. MaxOpenTables, propriété

Obtient ou définit le nombre de ressources de l’arborescence B + réservées pour cette instance.
