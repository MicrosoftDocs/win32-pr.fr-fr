...
Classe de base pour JET_err. Exceptions InvalidBookmark.

Le type [EsentInvalidBookmarkException](./esentinvalidbookmarkexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentInvalidBookmarkException.</td>
</tr>
</tbody>
</table>
...
[EsentInvalidBookmarkException, classe](./esentinvalidbookmarkexception-class.md)
