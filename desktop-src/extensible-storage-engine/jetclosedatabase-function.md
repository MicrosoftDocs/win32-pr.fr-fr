...
<td><p>La base de données n’a pas été ouverte précédemment.</p></td>
</tr>
<tr class="even">
<td><p>JET_errInvalidDatabaseId</p></td>
<td><p>Le paramètre <em>dbid</em> n’était pas un identificateur de base de données valide.</p></td>
</tr>
<tr class="odd">
