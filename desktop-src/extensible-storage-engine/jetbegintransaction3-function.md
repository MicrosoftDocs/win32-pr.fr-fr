...
<td><p>La transaction ne modifie pas la base de données. Si une mise à jour est tentée, cette opération échoue avec JET_errTransReadOnly code de réponse. Cette option est ignorée sauf si elle est demandée lorsque la session donnée n’est pas déjà dans une transaction. Cette option est disponible dans les versions du système d’exploitation Windows à partir de Windows XP.</p></td>
</tr>
</tbody>
</table>
...
<p>Ce code de retour est retourné par les versions de Windows à partir de Windows XP.</p></td>
</tr>
<tr class="even">
...
<td><p>La même session ne peut pas être utilisée simultanément pour plusieurs threads. Cette erreur est retournée par les versions de Windows à partir de Windows XP.</p></td>
</tr>
<tr class="odd">
