...
ms.locfileid: "118071114"
---
# <a name="uint32columnvalue-members"></a>Membres UInt32ColumnValue

Inclure les membres protégés  
Inclure les membres hérités  

Valeur de colonne [UInt32](/dotnet/api/system.uint32) .

Le type [UInt32ColumnValue](./uint32columnvalue-class.md) expose les membres suivants.
...
<td><a href="dn351253(v=exchg.10).md">Taille</a></td>
