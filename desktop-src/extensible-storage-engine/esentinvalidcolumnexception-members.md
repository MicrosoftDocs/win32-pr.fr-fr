---
description: 'En savoir plus sur les éléments suivants : EsentInvalidColumnException'
title: Membres EsentInvalidColumnException
...
ms.locfileid: "127294991"
---
# <a name="esentinvalidcolumnexception-members"></a>Membres EsentInvalidColumnException

Inclure les membres protégés  
Inclure les membres hérités  

Exception levée en cas d’échec de la conversion d’une colonne.

Le type [EsentInvalidColumnException](./esentinvalidcolumnexception-class.md) expose les membres suivants.
...
<td>Initialise une nouvelle instance de la classe EsentInvalidColumnException.</td>
</tr>
<tr class="even">
...
<td>Initialise une nouvelle instance de la classe EsentInvalidColumnException. Ce constructeur est utilisé pour désérialiser une exception sérialisée.</td>
</tr>
</tbody>
</table>
...
<td>Obtient un message texte décrivant l’exception. (Substitue <a href="/dotnet/api/system.exception.message#System_Exception_Message">exception. message</a>.)</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
