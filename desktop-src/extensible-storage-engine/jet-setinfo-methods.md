---
description: En savoir plus sur les méthodes de JET_SETINFO
title: Méthodes JET_SETINFO
...
ms.locfileid: "119729522"
---
# <a name="jet_setinfo-methods"></a>Méthodes JET_SETINFO
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn351059(v=exchg.10).md">JET_SETINFO</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
