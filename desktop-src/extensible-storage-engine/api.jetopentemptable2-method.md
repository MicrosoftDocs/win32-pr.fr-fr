...
ms.locfileid: "127297099"
---
# <a name="apijetopentemptable2-method"></a>API. JetOpenTempTable2, méthode
...
<!-- end list -->
  ...
  - lcid  
    ...
    ID de paramètres régionaux à utiliser pour comparer les données de colonne de clé Unicode dans la table temporaire. Les paramètres régionaux peuvent être utilisés tant que le module linguistique approprié a été installé sur l’ordinateur.
