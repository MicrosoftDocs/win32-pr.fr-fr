...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetGetLogInfoInstanceW</strong> (Unicode) et <strong>JetGetLogInfoInstanceA</strong> (ANSI).</p> | 
