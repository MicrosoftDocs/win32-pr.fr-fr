---
description: 'En savoir plus sur : méthode API. JetGetTableColumnInfo'
title: API. JetGetTableColumnInfo, méthode
...
ms.locfileid: "126921111"
---
# <a name="apijetgettablecolumninfo-method"></a>API. JetGetTableColumnInfo, méthode
