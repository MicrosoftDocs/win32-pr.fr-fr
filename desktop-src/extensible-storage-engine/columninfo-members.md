---
description: 'En savoir plus sur les éléments suivants : ColumnInfo'
title: Membres ColumnInfo
...
ms.locfileid: "119455129"
---
# <a name="columninfo-members"></a>Membres ColumnInfo

Inclure les membres protégés  
Inclure les membres hérités  

Informations sur une colonne esent. Il ne s’agit pas d’une classe Interop, mais elle est utilisée par les méthodes d’assistance de méta-données.

Le type [COLUMNINFO](./columninfo-class.md) expose les membres suivants.
...
<td>Obtient l’ID de la colonne.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn334185(v=exchg.10).md">CP</a></td>
<td>Obtient la page de codes de la colonne.</td>
</tr>
<tr class="even">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn334137(v=exchg.10).md">DefaultValue</a></td>
<td>Obtient la valeur par défaut de la colonne.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
...
<td>Obtient la longueur maximale de la colonne.</td>
</tr>
<tr class="odd">
<td><img src="../images/dn292128.pubproperty(exchg.10).gif" title="Propriété publique" alt="Public property" /></td>
<td><a href="dn334188(v=exchg.10).md">Nom</a></td>
<td>Obtient le nom de la colonne.</td>
</tr>
</tbody>
</table>
...
<td>Retourne une <a href="/dotnet/api/system.string">chaîne</a> qui représente le <a href="dn334128(v=exchg.10).md">COLUMNINFO</a>actuel. (Substitue <a href="/dotnet/api/system.object.tostring#System_Object_ToString">Object. ToString ()</a>.)</td>
</tr>
</tbody>
</table>
