---
description: 'En savoir plus sur : énumération JET_InstanceMiscInfo'
title: Énumération JET_InstanceMiscInfo (Microsoft. ISAM. esent. Interop. Vista)
...
Niveaux d’informations pour [JetGetInstanceMiscInfo (JET_INSTANCE, JET_SIGNATURE, JET_InstanceMiscInfo)](./vistaapi.jetgetinstancemiscinfo-method.md).
...
<td></td>
<td>LogSignature</td>
<td>Obtient la signature du journal des transactions associé à cette séquence.</td>
</tr>
</tbody>
</table>
