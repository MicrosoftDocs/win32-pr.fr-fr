---
description: 'En savoir plus sur : champ Windows7Param. LVChunkSizeMost'
title: Champ Windows7Param. LVChunkSizeMost (Microsoft. ISAM. esent. Interop. d’un)
...
ms.locfileid: "127404792"
---
# <a name="windows7paramlvchunksizemost-field"></a>Champ Windows7Param. LVChunkSizeMost

Ce paramètre permet de récupérer la taille du segment des données de valeur longue (BLOB). La définition et la récupération de données par multiples de cette taille augmentent l’efficacité.
...
[Membres Windows7Param](./windows7param-members.md)
