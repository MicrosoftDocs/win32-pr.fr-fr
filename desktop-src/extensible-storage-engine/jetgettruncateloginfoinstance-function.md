...
| <p><strong>Unicode</strong></p> | <p>Implémenté en tant que <strong>JetGetTruncateLogInfoInstanceW</strong> (Unicode) et <strong>JetGetTruncateLogInfoInstanceA</strong> (ANSI).</p> | 
