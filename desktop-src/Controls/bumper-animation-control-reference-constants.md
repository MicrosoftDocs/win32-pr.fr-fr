---
title: Constantes de contrôle d’animation
description: Constantes de contrôle d’animation
...
ms.locfileid: "118674047"
---
# <a name="animation-control-constants"></a>Constantes de contrôle d’animation
