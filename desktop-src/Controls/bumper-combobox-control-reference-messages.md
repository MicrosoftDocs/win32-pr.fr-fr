---
title: Messages de contrôle ComboBox
description: Messages de contrôle ComboBox
...
ms.locfileid: "127219209"
---
# <a name="combobox-control-messages"></a>Messages de contrôle ComboBox
...
-   [**\_GETCOMBOBOXINFO CB**](cb-getcomboboxinfo.md)
-   [**CB \_ GETCOUNT**](cb-getcount.md)
-   [**\_GETCUEBANNER CB**](cb-getcuebanner.md)
...
-   [**- \_ INITSTORAGE**](cb-initstorage.md)
...
-   [**\_SETCUEBANNER CB**](cb-setcuebanner.md)
