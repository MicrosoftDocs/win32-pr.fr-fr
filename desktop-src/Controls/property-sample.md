...
|-------------|----------------------------------------------------------------------------------------------------------|
| Kit de développement logiciel (SDK) Windows | % Program Files% \\ Microsoft kits de développement logiciel (sdk) \\ Windows \\ \[ numéro de version \] \\ exemples de \\ \\ contrôle winui \\ \\ propriété commune |
