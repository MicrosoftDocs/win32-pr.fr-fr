---
title: Structures de contrôle d’en-tête
description: Structures de contrôle d’en-tête
...
ms.locfileid: "119916719"
---
# <a name="header-control-structures"></a>Structures de contrôle d’en-tête
