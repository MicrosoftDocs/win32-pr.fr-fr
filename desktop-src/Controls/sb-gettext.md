...
Les fenêtres normales affichent le texte de gauche à droite (LTR). Les fenêtres peuvent être *mises en miroir* pour afficher des langues telles que l’hébreu ou l’arabe, qui sont lues de droite à gauche (RTL). Si SBT \_ RTLREADING est défini, la chaîne *lParam* lit dans le sens opposé du texte dans la fenêtre parente.
