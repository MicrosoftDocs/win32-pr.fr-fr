---
title: Messages de la barre dՃtat
description: Messages de la barre dՃtat
...
ms.locfileid: "103869826"
---
# <a name="status-bar-messages"></a>Messages de la barre dՃtat

## <a name="in-this-section"></a>Dans cette section

-   [**\_GETBORDERS SB**](sb-getborders.md)
-   [**\_GETICON SB**](sb-geticon.md)
-   [**\_GETPARTS SB**](sb-getparts.md)
-   [**\_GETRECT SB**](sb-getrect.md)
