...
| Language                    | Nom de police de l’interface utilisateur  | Taille de police de l’interface utilisateur | nom de police non-IU | taille de police n’appartenant pas à l’interface utilisateur |
|-----------------------------|---------------|--------------|------------------|------------------|
