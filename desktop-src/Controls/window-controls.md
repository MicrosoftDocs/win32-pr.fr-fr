...
Les contrôles sont conçus pour être utilisés par les développeurs C/C++ et les concepteurs d’interface utilisateur. en général, les développeurs ont besoin d’un niveau modéré pour comprendre les concepts de programmation d’interface utilisateur, la programmation d’API Windows et Unicode.
