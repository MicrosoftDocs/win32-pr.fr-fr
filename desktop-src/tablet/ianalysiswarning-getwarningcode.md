...
ms.locfileid: "127523288"
---
# <a name="ianalysiswarninggetwarningcode-method"></a>IAnalysisWarning :: GetWarningCode, méthode

Retourne le type d’avertissement qui s’est produit à l’aide de l’énumération [**AnalysisWarningCode**](analysiswarningcode.md) .
...
Type d’avertissement qui s’est produit.
