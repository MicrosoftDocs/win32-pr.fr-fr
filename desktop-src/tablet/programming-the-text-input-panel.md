...
ms.locfileid: "118716123"
---
# <a name="programming-the-text-input-panel"></a>Programmation du panneau de saisie de texte

à partir de Windows Vista, [**TextInputPanel**](/windows/desktop/api/peninputpanel/nn-peninputpanel-itextinputpanel) remplace le [**PenInputPanel**](peninputpanel-class.md) pour contrôler l’apparence et le comportement à l’écran du panneau de saisie de tablette.
