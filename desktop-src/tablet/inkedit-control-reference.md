...
| [**Enabled**](/windows/desktop/api/inked/nf-inked-iinkedit-get_enabled)                       | Obtient ou définit une valeur qui détermine si le contrôle InkEdit peut répondre aux événements générés par l’utilisateur.<br/>                                                                     |
...
| [**Son**](/windows/desktop/api/inked/nf-inked-iinkedit-get_font)                             | Obtient ou définit la police du texte affiché par le contrôle InkEdit.<br/>                                                                                                       |
...
| [**Statu**](/windows/desktop/api/inked/nf-inked-iinkedit-get_status)                         | Obtient une valeur qui spécifie si le contrôle InkEdit est inactif, en collectant l’encre ou en reconnaissant l’encre (heure de l’exécution uniquement).<br/>                                                       |
