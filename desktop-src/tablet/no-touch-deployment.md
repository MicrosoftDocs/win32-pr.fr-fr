---
description: le .NET Framework Microsoft vous donne la possibilité de déployer des applications à partir d’un serveur Web ou de fichiers de fichiers.
