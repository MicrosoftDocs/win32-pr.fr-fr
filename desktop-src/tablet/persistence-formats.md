...
| RTF<br/>                              | Il est possible de générer un format de presse-papiers RTF et de coder l’encre dans le format RTF en tant qu’objets OLE. Cela permet le collage de l’encre dans un conteneur OLE, tel que Microsoft Word ou une application basée sur RichEdit.<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 |
