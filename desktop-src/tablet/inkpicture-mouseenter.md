---
description: Se produit lorsque le pointeur de la souris entre dans le contrôle InkPicture.
...
ms.locfileid: "106522716"
---
# <a name="inkpicturemouseenter-event"></a>InkPicture. MouseEnter (événement)

Se produit lorsque le pointeur de la souris entre dans le contrôle [InkPicture](inkpicture-control-reference.md) .
