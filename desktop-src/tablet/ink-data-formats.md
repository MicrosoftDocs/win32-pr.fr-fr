...
Il est également possible de stocker de l’encre dans d’autres formats. en utilisant le format RTF, vous pouvez coller l’encre dans des applications qui ne reconnaissent pas l’encre, par exemple Microsoft Word 2002. Pour ce faire, incorporez des objets OLE qui contiennent de l’encre dans le RTF. D’autres formats, tels que des formats binaires ou XML, peuvent être utilisés.
