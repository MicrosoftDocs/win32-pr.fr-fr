...
Les informations de protocole qui sont utilisées lors de la création d’une table de remise sont fournies dans un fichier de .ini fourni par l’application lorsque [**CreateHandoffTable**](createhandofftable.md) est appelé.
