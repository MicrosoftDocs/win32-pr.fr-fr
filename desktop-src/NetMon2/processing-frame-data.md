...
ms.locfileid: "119995429"
---
# <a name="processing-frame-data"></a>Traitement des données de trame

Dans l’exemple de code suivant, l’analyse définit un filtre de capture qui spécifie l' **adresse IP uniquement** et les données de protocole demandées.
