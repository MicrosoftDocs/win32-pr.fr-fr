---
description: Dans l’exemple de code suivant, l’analyse définit un filtre de capture qui spécifie l’adresse IP uniquement et les données de protocole demandées.
ms.assetid: 0945bceb-b5fe-4f07-866b-4e0468227610
title: Traitement des données de trame
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103951737"
---
# <a name="processing-frame-data"></a><span data-ttu-id="a18cc-103">Traitement des données de trame</span><span class="sxs-lookup"><span data-stu-id="a18cc-103">Processing Frame Data</span></span>

<span data-ttu-id="a18cc-104">Dans l’exemple de code suivant, l’analyse définit un filtre de capture qui spécifie l' **adresse IP uniquement** et les données de protocole demandées.</span><span class="sxs-lookup"><span data-stu-id="a18cc-104">In the following example code, the monitor sets a capture filter that specifies **IP only** and requested protocol data.</span></span>
