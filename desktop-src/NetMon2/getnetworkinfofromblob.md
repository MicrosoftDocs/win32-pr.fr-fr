...
La fonction **GetNetworkInfoFromBlob** récupère les informations réseau à partir d’un objet BLOB donné.
...
Pointeur vers la structure [NETWORKINFO](networkinfo.md) allouée par l’utilisateur qui est remplie.
