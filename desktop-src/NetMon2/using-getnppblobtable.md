...
ms.locfileid: "127229578"
---
# <a name="using-getnppblobtable"></a>Utilisation de GetNPPBlobTable

L’exemple suivant montre comment utiliser la fonction [**GetNPPBlobTable**](getnppblobtable.md) pour récupérer une table d’objets BLOB NPP qui représente les cartes d’interface réseau inscrites sur l’ordinateur local.
