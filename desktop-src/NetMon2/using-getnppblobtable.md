---
description: L’exemple suivant montre comment utiliser la fonction GetNPPBlobTable pour récupérer une table d’objets BLOB NPP qui représente les cartes d’interface réseau inscrites sur l’ordinateur local.
...
---
# <a name="using-getnppblobtable"></a><span data-ttu-id="e27ee-103">Utilisation de GetNPPBlobTable</span><span class="sxs-lookup"><span data-stu-id="e27ee-103">Using GetNPPBlobTable</span></span>

<span data-ttu-id="e27ee-104">L’exemple suivant montre comment utiliser la fonction [**GetNPPBlobTable**](getnppblobtable.md) pour récupérer une table d’objets BLOB NPP qui représente les cartes d’interface réseau inscrites sur l’ordinateur local.</span><span class="sxs-lookup"><span data-stu-id="e27ee-104">The following example shows how to use the [**GetNPPBlobTable**](getnppblobtable.md) function to retrieve a NPP BLOB table that represents the registered network interface cards on the local computer.</span></span>
