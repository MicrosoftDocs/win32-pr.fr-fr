---
description: la quantité maximale de mémoire physique prise en charge par Microsoft Windows est comprise entre 2 go et 2 to, selon la version de Windows.
