---
description: L’exemple de programme suivant illustre les extensions de fenêtrage d’adresse.
...
ms.locfileid: "106544228"
---
# <a name="awe-example"></a><span data-ttu-id="31ef3-103">Exemple AWE</span><span class="sxs-lookup"><span data-stu-id="31ef3-103">AWE Example</span></span>

<span data-ttu-id="31ef3-104">L’exemple de programme suivant illustre les [**extensions de fenêtrage d’adresse**](address-windowing-extensions.md).</span><span class="sxs-lookup"><span data-stu-id="31ef3-104">The following sample program illustrates the [**Address Windowing Extensions**](address-windowing-extensions.md).</span></span>
