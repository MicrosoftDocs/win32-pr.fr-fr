---
title: Affichage de l’état actuel
description: L’exemple de code suivant montre comment rechercher tous les filtres qui peuvent affecter une application serveur.
...
---
# <a name="viewing-current-state"></a><span data-ttu-id="7fb06-103">Affichage de l’état actuel</span><span class="sxs-lookup"><span data-stu-id="7fb06-103">Viewing Current State</span></span>

<span data-ttu-id="7fb06-104">L’exemple de code suivant montre comment rechercher tous les filtres qui peuvent affecter une application serveur.</span><span class="sxs-lookup"><span data-stu-id="7fb06-104">The following sample code demonstrates how to find all filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="7fb06-105">Les conditions de filtre sont les mêmes que celles prises en charge par l’API **IsPortAllowed** de niveau inférieur.</span><span class="sxs-lookup"><span data-stu-id="7fb06-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
