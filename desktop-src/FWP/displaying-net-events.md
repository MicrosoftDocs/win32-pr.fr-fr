---
title: Affichage des événements réseau
description: L’exemple de code suivant montre comment une application serveur peut localiser les événements réseau récents qui peuvent l’avoir affectés.
...
---
# <a name="displaying-net-events"></a><span data-ttu-id="c1f04-103">Affichage des événements réseau</span><span class="sxs-lookup"><span data-stu-id="c1f04-103">Displaying Net Events</span></span>

<span data-ttu-id="c1f04-104">L’exemple de code suivant montre comment une application serveur peut localiser les événements réseau récents qui peuvent l’avoir affectés.</span><span class="sxs-lookup"><span data-stu-id="c1f04-104">The following sample code demonstrates how a server application could locate recent net events that might have affected it.</span></span>

> [!Note]  
> <span data-ttu-id="c1f04-105">Les conditions de filtre sont les mêmes que celles prises en charge par l’API **IsPortAllowed** de niveau inférieur.</span><span class="sxs-lookup"><span data-stu-id="c1f04-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
