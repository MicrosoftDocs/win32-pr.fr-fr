...
---
# <a name="installing-a-provider"></a><span data-ttu-id="11829-103">Installation d’un fournisseur</span><span class="sxs-lookup"><span data-stu-id="11829-103">Installing a Provider</span></span>

<span data-ttu-id="11829-104">L’exemple de code suivant illustre l’opération d’installation du fournisseur de la plateforme de filtrage Windows.</span><span class="sxs-lookup"><span data-stu-id="11829-104">The following sample code demonstrates the provider installation operation of the Windows Filtering Platform.</span></span>
