---
title: Empêcher la suppression du filtre
description: L’exemple de code suivant montre comment rendre un filtre difficile à supprimer en définissant une liste DACL.
...
---
# <a name="hindering-filter-deletion"></a><span data-ttu-id="1ae54-103">Empêcher la suppression du filtre</span><span class="sxs-lookup"><span data-stu-id="1ae54-103">Hindering Filter Deletion</span></span>

<span data-ttu-id="1ae54-104">L’exemple de code suivant montre comment rendre un filtre difficile à supprimer en définissant une liste DACL.</span><span class="sxs-lookup"><span data-stu-id="1ae54-104">The following example code demonstrates how to make a filter difficult to delete by setting a DACL.</span></span>
