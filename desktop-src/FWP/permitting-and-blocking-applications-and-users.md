---
title: Autoriser et bloquer des applications et des utilisateurs
description: L’exemple de code suivant montre comment ajouter un filtre évalué par l’ID d’utilisateur ou d’application.
...
---
# <a name="permitting-and-blocking-applications-and-users"></a><span data-ttu-id="f0b45-103">Autoriser et bloquer des applications et des utilisateurs</span><span class="sxs-lookup"><span data-stu-id="f0b45-103">Permitting and Blocking Applications and Users</span></span>

<span data-ttu-id="f0b45-104">L’exemple de code suivant montre comment ajouter un filtre qui correspond à l’ID d’utilisateur ou d’application.</span><span class="sxs-lookup"><span data-stu-id="f0b45-104">The following sample code demonstrates how to add a filter that evaluates by user or application ID.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f0b45-105">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="f0b45-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f0b45-106">**Conditions de filtrage disponibles pour chaque couche de filtrage**</span><span class="sxs-lookup"><span data-stu-id="f0b45-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
