---
title: Fonctions de gestion
description: Les fonctions de gestion de la plateforme de filtrage Windows (WFP) pour le moteur de filtre sont les suivantes.
ms.assetid: 983eb1bb-af6b-42cf-8148-ed3a0e3102a9
keywords:
- Fonctions de gestion des API de la plateforme de filtrage Windows
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106511689"
---
# <a name="management-functions"></a>Fonctions de gestion

Les fonctions de gestion de la plateforme de filtrage Windows (WFP) pour le moteur de filtre sont les suivantes.

Gestion des légendes

-   [**Modification de la \_ légende FWPM \_ \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_callout_change_callback0)
...
Gestion des objets de connexion

-   [**FWPM de \_ connexion \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_connection_callback0)
...
-   \_rappel d' \_ événement net FWPM \_ :
    -   [**FWPM \_ \_ \_ CALLBACK0 d’événements .net**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_net_event_callback0) (Windows 7)
    -   [**FWPM \_ \_ \_ CALLBACK1 d’événements .net**](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback1) (Windows 8)
...
-   [**FWPM \_ modification du filtre \_ \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_filter_change_callback0)
...
Gestion du contexte du fournisseur

-   [**\_Modification du contexte du fournisseur FWPM \_ \_ \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_provider_context_change_callback0)
...
-   [**\_Modification du fournisseur FWPM \_ \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_provider_change_callback0)
...
Gestion des sous-couches

-   [**Modification de la sous- \_ couche FWPM \_ \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_sublayer_change_callback0)
...
Gestion des ports système

-   [**\_Ports système \_ FWPM \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_system_ports_callback0)
...
-   [**\_Événement FWPM \_ VSWITCH \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_vswitch_event_callback0)
