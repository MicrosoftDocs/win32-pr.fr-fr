...
---
# <a name="manual-sa-keying"></a><span data-ttu-id="b011a-103">Génération manuelle de la clé SA</span><span class="sxs-lookup"><span data-stu-id="b011a-103">Manual SA Keying</span></span>

<span data-ttu-id="b011a-104">L’exemple de code suivant montre comment créer des associations de sécurité (SA) à l’aide de la plateforme de filtrage Windows.</span><span class="sxs-lookup"><span data-stu-id="b011a-104">The following sample code demonstrates how to create Security Associations (SA) using Windows Filtering Platform.</span></span>
