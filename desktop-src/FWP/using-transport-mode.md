...
ms.locfileid: "119535359"
---
# <a name="using-transport-mode"></a>Utilisation du mode de transport

L’exemple de code suivant montre comment configurer le mode de transport IPsec à l’aide d’AuthIP avec l’authentification utilisateur et la découverte de la négociation.
