---
title: Utilisation du mode de transport
description: L’exemple de code suivant montre comment configurer le mode de transport IPsec à l’aide d’AuthIP avec l’authentification utilisateur et la découverte de la négociation.
...
ms.locfileid: "103940204"
---
# <a name="using-transport-mode"></a><span data-ttu-id="3d923-103">Utilisation du mode de transport</span><span class="sxs-lookup"><span data-stu-id="3d923-103">Using Transport Mode</span></span>

<span data-ttu-id="3d923-104">L’exemple de code suivant montre comment configurer le mode de transport IPsec à l’aide d’AuthIP avec l’authentification utilisateur et la découverte de la négociation.</span><span class="sxs-lookup"><span data-stu-id="3d923-104">The following sample code demonstrates how to configure IPsec transport mode using AuthIP with user authentication and negotiation discovery.</span></span>
