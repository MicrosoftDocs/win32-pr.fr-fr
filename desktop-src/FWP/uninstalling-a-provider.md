...
---
# <a name="uninstalling-a-provider"></a>Désinstallation d’un fournisseur

L’exemple de code suivant illustre le processus requis pour supprimer l’installation d’un fournisseur.
