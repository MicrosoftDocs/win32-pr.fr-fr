---
title: Désinstallation d’un fournisseur
description: L’exemple de code suivant illustre le processus requis pour supprimer l’installation d’un fournisseur.
...
ms.locfileid: "103674849"
---
# <a name="uninstalling-a-provider"></a><span data-ttu-id="72329-103">Désinstallation d’un fournisseur</span><span class="sxs-lookup"><span data-stu-id="72329-103">Uninstalling a Provider</span></span>

<span data-ttu-id="72329-104">L’exemple de code suivant illustre le processus requis pour supprimer l’installation d’un fournisseur.</span><span class="sxs-lookup"><span data-stu-id="72329-104">The following sample code demonstrates the process required to remove a provider installation.</span></span>
