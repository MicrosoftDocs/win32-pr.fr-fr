---
title: Réservation de ports
description: L’exemple de code suivant montre comment utiliser les couches d’affectation de ressources pour réserver une plage de ports pour les administrateurs.
...
---
# <a name="reserving-ports"></a><span data-ttu-id="1d787-103">Réservation de ports</span><span class="sxs-lookup"><span data-stu-id="1d787-103">Reserving Ports</span></span>

<span data-ttu-id="1d787-104">L’exemple de code suivant montre comment utiliser les couches d’affectation de ressources pour réserver une plage de ports pour les administrateurs.</span><span class="sxs-lookup"><span data-stu-id="1d787-104">The following sample code demonstrates how to use the resource assignment layers to reserve a range of ports for administrators.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="1d787-105">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="1d787-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="1d787-106">**Conditions de filtrage disponibles pour chaque couche de filtrage**</span><span class="sxs-lookup"><span data-stu-id="1d787-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
