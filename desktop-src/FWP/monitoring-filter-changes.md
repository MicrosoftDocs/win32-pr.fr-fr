---
title: Analyse des modifications de filtre
description: L’exemple de code suivant montre comment surveiller l’ajout et la suppression de filtres qui peuvent affecter une application serveur.
...
ms.locfileid: "104507319"
---
# <a name="monitoring-filter-changes"></a><span data-ttu-id="7b893-103">Analyse des modifications de filtre</span><span class="sxs-lookup"><span data-stu-id="7b893-103">Monitoring Filter Changes</span></span>

<span data-ttu-id="7b893-104">L’exemple de code suivant montre comment surveiller l’ajout et la suppression de filtres qui peuvent affecter une application serveur.</span><span class="sxs-lookup"><span data-stu-id="7b893-104">The following sample code demonstrates how to monitor the addition and deletion of filters that might affect a server application.</span></span>

> [!Note]  
> <span data-ttu-id="7b893-105">Les conditions de filtre sont les mêmes que celles prises en charge par l’API **IsPortAllowed** de niveau inférieur.</span><span class="sxs-lookup"><span data-stu-id="7b893-105">The filter conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
