...
---
# <a name="monitoring-filter-changes"></a>Analyse des modifications de filtre

L’exemple de code suivant montre comment surveiller l’ajout et la suppression de filtres qui peuvent affecter une application serveur.
