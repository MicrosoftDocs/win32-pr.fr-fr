---
title: Remplissage des conditions de filtre
description: L’exemple de code suivant montre comment remplir les conditions de filtre utilisées par une application serveur pour rechercher des filtres et des événements qui l’affectent.
...
ms.locfileid: "104102597"
---
# <a name="populating-filter-conditions"></a><span data-ttu-id="b6843-103">Remplissage des conditions de filtre</span><span class="sxs-lookup"><span data-stu-id="b6843-103">Populating Filter Conditions</span></span>

<span data-ttu-id="b6843-104">L’exemple de code suivant montre comment remplir les conditions de filtre utilisées par une application serveur pour rechercher des filtres et des événements qui l’affectent.</span><span class="sxs-lookup"><span data-stu-id="b6843-104">The following sample code demonstrates how to populate filter conditions used by a server application to find filters and events that affect it.</span></span>

> [!Note]  
> <span data-ttu-id="b6843-105">Ces conditions sont les mêmes que celles prises en charge par l’API **IsPortAllowed** de niveau inférieur.</span><span class="sxs-lookup"><span data-stu-id="b6843-105">These conditions are the same as those supported by the downlevel **IsPortAllowed** API.</span></span>
