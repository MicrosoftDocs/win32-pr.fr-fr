...
---
# <a name="using-tunnel-mode"></a><span data-ttu-id="989fb-103">Utilisation du mode de tunnel</span><span class="sxs-lookup"><span data-stu-id="989fb-103">Using Tunnel Mode</span></span>

<span data-ttu-id="989fb-104">L’exemple de code suivant montre comment configurer un tunnel IPsec point à point à l’aide de l’API WFP (Windows Filtering Platform).</span><span class="sxs-lookup"><span data-stu-id="989fb-104">The following sample code demonstrates how to configure a point-to-point IPsec tunnel using the Windows Filtering Platform (WFP) API.</span></span>
