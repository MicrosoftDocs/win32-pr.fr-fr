...
ms.locfileid: "103842869"
---
# <a name="shared-types"></a>Types partagés

## <a name="in-this-section"></a>Dans cette section

-   [**FWP \_ AF**](/windows/win32/api/fwptypes/ne-fwptypes-fwp_af)
-   [**\_type d' \_ option de classement fwp \_**](/windows/win32/api/fwptypes/ne-fwptypes-fwp_classify_option_type)
