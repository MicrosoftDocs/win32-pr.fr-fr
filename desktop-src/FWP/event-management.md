...
ms.locfileid: "118151172"
---
# <a name="event-management"></a>Gestion des événements

## <a name="in-this-section"></a>Dans cette section

-   [**FWPM \_ net, \_ événement \_ CALLBACK0**](/windows/win32/api/fwpmu/nc-fwpmu-fwpm_net_event_callback0)
-   [*FWPM \_ net, \_ événement \_ CALLBACK1*](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback1)
-   [*FWPM \_ net, \_ événement \_ CALLBACK2*](/windows/desktop/api/fwpmu/nc-fwpmu-fwpm_net_event_callback2)
