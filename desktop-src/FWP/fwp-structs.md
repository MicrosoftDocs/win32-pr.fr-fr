...
-   \_Suppression de \_ classification d’événement FWPM NET \_ \_ :
    ...
    -   [**FWPM \_ \_DROP2 de \_ classification \_ d’événement net**](/windows/win32/api/fwpmtypes/ns-fwpmtypes-fwpm_net_event_classify_drop2) (Windows 8)
...
-   \_contexte du fournisseur FWPM \_ :
    ...
    -   \_CONTEXT2 fournisseur FWPM \_ (Windows 8)
...
-   \_authentification du certificat IKEEXT \_ :
    -   [**IKEEXT \_ CERTIFICAT \_ AUTHENTICATION0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_authentication0) (Windows Vista)
    -   [**IKEEXT \_ \_AUTHENTICATION1 du certificat**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_authentication1) (Windows 7)
    -   [**IKEEXT \_ \_AUTHENTICATION2 du certificat**](/windows/win32/api/iketypes/ns-iketypes-ikeext_certificate_authentication2) (Windows 8)
-   \_ \_ informations d’identification du certificat IKEEXT :
    -   [**IKEEXT \_ CERTIFICAT \_ CREDENTIAL0**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_certificate_credential0) (Windows Vista)
...
-   \_ \_ \_ \_ statistiques courantes spécifiques \_ à la version d’IP IKEEXT :
    -   [**IKEEXT \_ \_ \_ \_ \_ STATISTICS0 courants spécifiques à la version IP**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_ip_version_specific_common_statistics0) (Windows Vista)
...
-   \_statistiques du \_ MODULE de module spécifique à la version IP de IKEEXT \_ \_ \_ :
    ...
    -   [**IKEEXT \_ \_ \_ \_ \_ STATISTICS1 spécifique à la version IP**](/windows/desktop/api/Iketypes/ns-iketypes-ikeext_ip_version_specific_keymodule_statistics1) (Windows 7 et versions ultérieures)
...
-   \_statistiques des \_ paquets Drop IPSec Aggregate \_ \_ :
    -   [**IPSec \_ \_ \_ \_ STATISTICS0 de suppression de paquets d’agrégats**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_aggregate_drop_packet_statistics0) (Windows Vista)
...
-   \_stratégie de génération de clés IPSec \_ :
    -   [**IPSec \_ \_POLICY0 de clés**](/windows/desktop/api/Ipsectypes/ns-ipsectypes-ipsec_keying_policy0) (Windows Vista et Windows 7)
