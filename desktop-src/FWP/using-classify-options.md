...
---
# <a name="using-classify-options"></a>Utilisation des options de classification

Les exemples de code suivants montrent comment utiliser les options de classification de filtre afin de modifier le processus de filtrage.

## <a name="enable-loose-source-mapping-for-a-remote-udp-port"></a>Activer le mappage de source libre pour un port UDP distant
...
## <a name="modify-the-idle-lifetimes-for-ale-flows"></a>Modifier les durées de vie d’inactivité des flux ALE
