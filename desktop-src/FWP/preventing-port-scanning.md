---
title: Empêcher l’analyse des ports
description: L’exemple de code suivant montre comment empêcher l’analyse de port à l’aide de suppressions furtives et de suppressions silencieuses.
...
ms.locfileid: "104029394"
---
# <a name="preventing-port-scanning"></a><span data-ttu-id="e2689-103">Empêcher l’analyse des ports</span><span class="sxs-lookup"><span data-stu-id="e2689-103">Preventing Port Scanning</span></span>

<span data-ttu-id="e2689-104">L’exemple de code suivant montre comment empêcher l’analyse de port à l’aide de suppressions furtives et de suppressions silencieuses.</span><span class="sxs-lookup"><span data-stu-id="e2689-104">The following sample code demonstrates how to prevent port scanning using stealth discards and silent drops.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="e2689-105">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="e2689-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="e2689-106">**Conditions de filtrage disponibles pour chaque couche de filtrage**</span><span class="sxs-lookup"><span data-stu-id="e2689-106">**Filtering Conditions Available at Each Filtering Layer**</span></span>](filtering-conditions-available-at-each-filtering-layer.md)
</dt> </dl>
