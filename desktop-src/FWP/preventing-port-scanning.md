...
ms.locfileid: "119900789"
---
# <a name="preventing-port-scanning"></a>Empêcher l’analyse des ports

L’exemple de code suivant montre comment empêcher l’analyse de port à l’aide de suppressions furtives et de suppressions silencieuses.
