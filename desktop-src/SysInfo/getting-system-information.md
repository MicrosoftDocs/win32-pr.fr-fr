---
description: L’exemple suivant utilise les fonctions GetComputerName, GetUserName, GetSystemDirectory, GetWindowsDirectory et ExpandEnvironmentStrings pour récupérer des informations qui décrivent la configuration du système.
ms.assetid: 965bd14b-be93-4084-bce8-642f5704cef1
title: Obtention d’informations système
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106535075"
---
# <a name="getting-system-information"></a><span data-ttu-id="abc14-103">Obtention d’informations système</span><span class="sxs-lookup"><span data-stu-id="abc14-103">Getting System Information</span></span>

<span data-ttu-id="abc14-104">L’exemple suivant utilise les fonctions [**GetComputerName**](/windows/desktop/api/Winbase/nf-winbase-getcomputernamea), [**getUserName**](/windows/desktop/api/Winbase/nf-winbase-getusernamea), [**GetSystemDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getsystemdirectorya), [**GetWindowsDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getwindowsdirectorya)et [**ExpandEnvironmentStrings**](/windows/win32/api/processenv/nf-processenv-expandenvironmentstringsa) pour récupérer des informations qui décrivent la configuration du système.</span><span class="sxs-lookup"><span data-stu-id="abc14-104">The following example uses the [**GetComputerName**](/windows/desktop/api/Winbase/nf-winbase-getcomputernamea), [**GetUserName**](/windows/desktop/api/Winbase/nf-winbase-getusernamea), [**GetSystemDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getsystemdirectorya), [**GetWindowsDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getwindowsdirectorya), and [**ExpandEnvironmentStrings**](/windows/win32/api/processenv/nf-processenv-expandenvironmentstringsa) functions to get information that describes the system configuration.</span></span>
