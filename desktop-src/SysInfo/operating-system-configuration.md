...
Le *répertoire Windows* est le répertoire qui contient des applications Windows, des fichiers d’initialisation et des fichiers d’aide. La fonction [**GetWindowsDirectory**](/windows/win32/api/sysinfoapi/nf-sysinfoapi-getwindowsdirectorya) récupère le chemin d’accès à ce répertoire.
