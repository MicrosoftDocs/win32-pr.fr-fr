---
description: L’exemple suivant montre comment structurer un fournisseur de temps. Dans cet exemple, la DLL prend en charge deux fournisseurs de temps matériel.
ms.assetid: 6be08c49-be68-4b75-b740-fc1d5a2ff592
title: Exemple de fournisseur de temps
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104529632"
---
# <a name="sample-time-provider"></a><span data-ttu-id="eba10-104">Exemple de fournisseur de temps</span><span class="sxs-lookup"><span data-stu-id="eba10-104">Sample Time Provider</span></span>

<span data-ttu-id="eba10-105">L’exemple suivant montre comment structurer un fournisseur de temps.</span><span class="sxs-lookup"><span data-stu-id="eba10-105">The following example demonstrates how to structure a time provider.</span></span> <span data-ttu-id="eba10-106">Dans cet exemple, la DLL prend en charge deux fournisseurs de temps matériel.</span><span class="sxs-lookup"><span data-stu-id="eba10-106">In this example, the DLL supports two hardware time providers.</span></span>
