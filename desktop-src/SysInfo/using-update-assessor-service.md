...
ms.locfileid: "118884227"
---
# <a name="using-the-waas-assessment-platform"></a>Utilisation de la plateforme d’évaluation WaaS

Pour utiliser l’API de la plateforme d’évaluation de WaaS, créez une instance de l’interface [**IWaaSAssessor**](/windows/desktop/api/waasapi/nn-waasapi-iwaasassessor) , puis appelez la méthode [**GetOSUpdateAssessment**](/windows/desktop/api/waasapi/nf-waasapi-iwaasassessor-getosupdateassessment) . En cas de réussite, le paramètre de *résultat* génère un objet [**OSUpdateAssessment**](/windows/win32/api/waasapitypes/ns-waasapitypes-osupdateassessment) , qui contient les informations pertinentes.

L’exemple de code suivant montre comment récupérer une évaluation du système d’exploitation à partir de votre système local, à l’aide de la méthode IWaaSAssessor. GetOSUpdateAssessment.
