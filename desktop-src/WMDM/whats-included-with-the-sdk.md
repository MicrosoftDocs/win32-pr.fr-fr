...
Le tableau suivant décrit le contenu du kit de développement logiciel (SDK) Gestionnaire de périphériques Windows Media. Tous les fichiers ou dossiers sont décrits par rapport au chemin d’installation du kit de développement logiciel (SDK) racine.
...
| WMDM \_ ver. h                | Informations de version facultatives sur les Gestionnaire de périphériques Windows Media.                                                                                                                                                                                                                                                                                                                                                                                    |
...
| mssachlp. lib               | Bibliothèque statique requise par tous les fournisseurs de services et d’applications Windows Media Gestionnaire de périphériques.                                                                                                                                                                                                                                                                                                                                                 |
| drmcrypto. lib              | Bibliothèque statique requise par tous les services Windows Media Gestionnaire de périphériques les applications et les fournisseurs de services qui utilisent DRM.                                                                                                                                                                                                                                                                                                                                    |
...
| DeviceKit \\ ....<br/> | Dossier qui contient une suite d’outils permettant de tester votre appareil portable à l’aide de Windows Media Gestionnaire de périphériques 11. Les tests incluent l’énumération et le transfert d’appareils et de fichiers, les fonctionnalités DRM et la conformité MTP. Ces outils ont leur propre fichier de documentation.                                                                                                                                                                                       |
