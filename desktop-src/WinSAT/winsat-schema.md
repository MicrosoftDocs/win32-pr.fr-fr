...
L’élément **WinSAT** peut avoir un élément **WinsatAssessments** en tant qu’élément parent lorsque vous appelez la méthode [**obtenir \_ AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) .

Voici le schéma WinSAT que vous pouvez utiliser pour déterminer le XPath.
