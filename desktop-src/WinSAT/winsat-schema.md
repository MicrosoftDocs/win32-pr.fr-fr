...
---
# <a name="winsat-schema"></a><span data-ttu-id="d156c-103">Schéma WinSAT</span><span class="sxs-lookup"><span data-stu-id="d156c-103">WinSAT Schema</span></span>

<span data-ttu-id="d156c-104">\[Les énumérations WinSAT peuvent être modifiées ou non disponibles pour les mises en production après Windows 8.1.\]</span><span class="sxs-lookup"><span data-stu-id="d156c-104">\[WinSAT enumerations may be altered or unavailable for releases after Windows 8.1.\]</span></span>

<span data-ttu-id="d156c-105">Vous pouvez utiliser le schéma Windows System Assessment Tool (WinSAT) pour déterminer les requêtes XPath valides à exécuter.</span><span class="sxs-lookup"><span data-stu-id="d156c-105">You can use the Windows System Assessment Tool (WinSAT) schema to determine valid XPath queries to run.</span></span> <span data-ttu-id="d156c-106">Pour exécuter une requête XPath, consultez l’une des méthodes suivantes :</span><span class="sxs-lookup"><span data-stu-id="d156c-106">To run an XPath query, see one of the following methods:</span></span>

-   [<span data-ttu-id="d156c-107">**IQueryAllWinSATAssessments :: obtient \_ AllXML**</span><span class="sxs-lookup"><span data-stu-id="d156c-107">**IQueryAllWinSATAssessments::get\_AllXML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml)
-   [<span data-ttu-id="d156c-108">**IQueryRecentWinSATAssessment :: obtient \_ XML**</span><span class="sxs-lookup"><span data-stu-id="d156c-108">**IQueryRecentWinSATAssessment::get\_XML**</span></span>](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryrecentwinsatassessment-get_xml)

<span data-ttu-id="d156c-109">L’élément **WinSAT** peut avoir un élément **WinsatAssessments** en tant qu’élément parent lorsque vous appelez la méthode [**obtenir \_ AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) .</span><span class="sxs-lookup"><span data-stu-id="d156c-109">The **WinSAT** element can have a **WinsatAssessments** element as a parent element when you call the [**get\_AllXML**](/windows/desktop/api/Winsatcominterfacei/nf-winsatcominterfacei-iqueryallwinsatassessments-get_allxml) method.</span></span>

<span data-ttu-id="d156c-110">Voici le schéma WinSAT que vous pouvez utiliser pour déterminer le XPath.</span><span class="sxs-lookup"><span data-stu-id="d156c-110">The following is the WinSAT schema that you can use to determine the XPath.</span></span>
