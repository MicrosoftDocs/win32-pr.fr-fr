...
ms.locfileid: "127239868"
---
# <a name="drawdib-reference"></a>Référence DrawDib

Cette section décrit les fonctions DrawDib et les structures associées. Ces éléments sont regroupés comme suit :

## <a name="drawdib-library-operations"></a>Opérations de la bibliothèque DrawDib
...
## <a name="timing-drawdib"></a>DrawDib temporelle
