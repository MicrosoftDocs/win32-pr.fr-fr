...
---
# <a name="icm_draw_window-message"></a>Message de fenêtre de \_ dessin ICM \_

Le message de **\_ \_ fenêtre de dessin ICM** indique à un pilote de rendu que la fenêtre spécifiée pour le message de [**\_ \_ début du dessin ICM**](icm-draw-begin.md) doit être redessinée. La fenêtre a été déplacée ou devenue temporairement masquée. Vous pouvez envoyer ce message explicitement ou à l’aide de la macro [**ICDrawWindow**](/windows/desktop/api/Vfw/nf-vfw-icdrawwindow) .
