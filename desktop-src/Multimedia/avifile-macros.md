...
keywords:
- Video for Windows (VFW), macros AVIFile
- VFW (vidéo pour Windows), macros AVIFile
- AVIFile, macros, référence
- Référence AVIFile, macros
- référence pour AVIFile, macros
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "118375616"
---
# <a name="avifile-macros"></a>AVIFile, macros

Les macros suivantes sont utilisées avec AVIFile.
