...
---
# <a name="installing-compressors-and-decompressors"></a><span data-ttu-id="d8717-106">Installation des compresseurs et des décompresseurs</span><span class="sxs-lookup"><span data-stu-id="d8717-106">Installing Compressors and Decompressors</span></span>

<span data-ttu-id="d8717-107">L’exemple suivant montre comment une application peut installer une fonction en tant que compresseur ou décompresseur à l’aide de la fonction [**ICInstall**](/windows/desktop/api/Vfw/nf-vfw-icinstall) .</span><span class="sxs-lookup"><span data-stu-id="d8717-107">The following example shows how an application can install a function as a compressor or decompressor using the [**ICInstall**](/windows/desktop/api/Vfw/nf-vfw-icinstall) function.</span></span>
