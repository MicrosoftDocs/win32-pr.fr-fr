...
ms.locfileid: "127195224"
---
# <a name="joystick-reference"></a>Référence de la manette de jeu

Cette section décrit les fonctions, les structures et les messages associés aux joysticks. Les éléments sont regroupés comme suit :
...
## <a name="querying-a-joystick"></a>Interrogation d’une manette de jeu
...
## <a name="capturing-a-joystick"></a>Capture d’une manette de jeu
