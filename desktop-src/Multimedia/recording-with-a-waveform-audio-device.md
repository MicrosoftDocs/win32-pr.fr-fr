...
ms.locfileid: "127121498"
---
# <a name="recording-with-a-waveform-audio-device"></a>Enregistrement avec un appareil Waveform-Audio

L’exemple suivant ouvre un périphérique Wave-audio avec un nouveau fichier, enregistre pour la durée spécifiée, lit l’enregistrement et invite l’utilisateur à enregistrer l’enregistrement, si nécessaire. Elle utilise la fonction [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .
