---
title: Référence MCIWnd
description: Référence MCIWnd
ms.assetid: 11fba6bb-17f1-4fbe-b148-4755a3c6216a
keywords:
- MCI (interface de contrôle multimédia), référence MCIWnd
- Classe de fenêtre MCIWnd, référence
- MCIWnd (fenêtre), référence
...
ms.locfileid: "127416823"
---
# <a name="mciwnd-reference"></a>Référence MCIWnd

Cette section décrit les fonctions, les messages et les macros associés à la classe de fenêtre MCIWnd. Ces éléments sont regroupés comme suit.
...
## <a name="file-and-device-management"></a>Gestion des fichiers et des périphériques
...
## <a name="playback-options"></a>Options de lecture
...
## <a name="pause-and-resume-playback"></a>Suspendre et reprendre la lecture
...
## <a name="image-and-palette-adjustments"></a>Réglage des images et des palettes
...
## <a name="event-and-error-notification"></a>Notification d’événement et d’erreur
...
## <a name="mci-command-string-interface"></a>Interface Command-String MCI
