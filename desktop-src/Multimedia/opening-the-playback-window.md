...
ms.locfileid: "104029821"
---
# <a name="opening-the-playback-window"></a><span data-ttu-id="a6ca7-104">Ouverture de la fenêtre de lecture</span><span class="sxs-lookup"><span data-stu-id="a6ca7-104">Opening the Playback Window</span></span>

<span data-ttu-id="a6ca7-105">L’exemple suivant montre comment utiliser la commande [**MCI \_ Open**](mci-open.md) pour définir une fenêtre parente et créer un enfant de cette fenêtre.</span><span class="sxs-lookup"><span data-stu-id="a6ca7-105">The following example shows how to use the [**MCI\_OPEN**](mci-open.md) command to set a parent window and create a child of that window.</span></span>
