---
title: Structures de forme d’onde
description: Structures de forme d’onde
ms.assetid: 4ae84ba8-f444-4d9e-adc8-343b4ee764cc
keywords:
- audio multimédia, structures de forme d’onde
- audio, structures de forme d’onde
- sons Waveform, structures
- Référence audio Waveform, structures
- référence pour wavefore audio, structures
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127011696"
---
# <a name="waveform-structures"></a>Structures de forme d’onde
