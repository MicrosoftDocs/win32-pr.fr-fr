...
keywords:
- vidéo pour Windows (VFW), messages VCM
- VFW (vidéo pour Windows), VCM messages
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "124364103"
---
# <a name="video-compression-messages"></a>Messages de compression vidéo

Les messages suivants sont utilisés avec la compression vidéo.
