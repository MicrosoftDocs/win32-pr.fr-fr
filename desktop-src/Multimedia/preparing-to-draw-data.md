...
ms.locfileid: "104196702"
---
# <a name="preparing-to-draw-data"></a><span data-ttu-id="7c557-107">Préparation du dessin des données</span><span class="sxs-lookup"><span data-stu-id="7c557-107">Preparing to Draw Data</span></span>

<span data-ttu-id="7c557-108">L’exemple suivant illustre la séquence d’initialisation qui indique au décompresseur de dessiner en mode plein écran.</span><span class="sxs-lookup"><span data-stu-id="7c557-108">The following example shows the initialization sequence that instructs the decompressor to draw full-screen.</span></span> <span data-ttu-id="7c557-109">Elle utilise les macros [**ICDrawBegin**](/windows/desktop/api/Vfw/nf-vfw-icdrawbegin) et [**ICDrawEnd**](/windows/desktop/api/Vfw/nf-vfw-icdrawend) .</span><span class="sxs-lookup"><span data-stu-id="7c557-109">It uses the [**ICDrawBegin**](/windows/desktop/api/Vfw/nf-vfw-icdrawbegin) and [**ICDrawEnd**](/windows/desktop/api/Vfw/nf-vfw-icdrawend) macros.</span></span>
