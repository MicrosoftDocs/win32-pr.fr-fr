...
Les gestionnaires de fichiers et de flux sont des pilotes qui fournissent des interfaces cohérentes à une application qui contrôle les données multimédias. Les gestionnaires de fichiers et de flux inclus dans le système d’exploitation utilisent des données vidéo et Waveform-Audio stockées dans des fichiers AVI (Audio-Video entrelacés) et des fichiers audio Waveform.

Vous pouvez écrire des gestionnaires pour permettre à votre application d’écrire ou d’accéder à des données multimédias à partir d’une autre source, telle qu’un fichier à l’aide d’un format propriétaire, un fichier AVI développé pour contenir des flux de données supplémentaires ou un gestionnaire qui génère ses propres données multimédias. Si vous disposez d’un format de fichier personnalisé pour les données AVI que vous souhaitez utiliser avec les [fonctions et macros avifile](avifile-functions-and-macros.md), vous devez écrire un gestionnaire personnalisé.

-   [À propos des gestionnaires de fichiers et de flux personnalisés](about-custom-file-and-stream-handlers.md)
-   [Utilisation de gestionnaires de fichiers et de flux personnalisés](using-custom-file-and-stream-handlers.md)
-   [Informations de référence sur les fichiers et les gestionnaires de flux personnalisés](custom-file-and-stream-handler-reference.md)
