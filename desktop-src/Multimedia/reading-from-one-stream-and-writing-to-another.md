---
title: Lire à partir d’un flux et écrire dans un autre
description: Lire à partir d’un flux et écrire dans un autre
...
ms.locfileid: "106511443"
---
# <a name="reading-from-one-stream-and-writing-to-another"></a><span data-ttu-id="10949-103">Lire à partir d’un flux et écrire dans un autre</span><span class="sxs-lookup"><span data-stu-id="10949-103">Reading from One Stream and Writing to Another</span></span>

<span data-ttu-id="10949-104">L’exemple suivant lit les données d’un flux, effectue une opération avec les données et écrit les données compressées dans un flux d’un nouveau fichier.</span><span class="sxs-lookup"><span data-stu-id="10949-104">The following example reads data from a stream, does something with the data, and writes the compressed data into a stream of a new file.</span></span>
