...
ms.locfileid: "127011741"
---
# <a name="using-the-editing-functions-and-putting-a-file-on-the-clipboard"></a>Utilisation des fonctions d’édition et ajout d’un fichier dans le presse-papiers

L’exemple suivant coupe, copie ou supprime des segments d’un tableau de flux. Les flux coupés et copiés sont fusionnés dans un nouveau fichier et placés dans le presse-papiers. Les fonctions utilisées incluent [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy)et [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).
