---
title: Utilisation des fonctions d’édition et ajout d’un fichier dans le presse-papiers
description: Utilisation des fonctions d’édition et ajout d’un fichier dans le presse-papiers
...
ms.locfileid: "103939763"
---
# <a name="using-the-editing-functions-and-putting-a-file-on-the-clipboard"></a><span data-ttu-id="afb76-106">Utilisation des fonctions d’édition et ajout d’un fichier dans le presse-papiers</span><span class="sxs-lookup"><span data-stu-id="afb76-106">Using the Editing Functions and Putting a File on the Clipboard</span></span>

<span data-ttu-id="afb76-107">L’exemple suivant coupe, copie ou supprime des segments d’un tableau de flux.</span><span class="sxs-lookup"><span data-stu-id="afb76-107">The following example cuts, copies, or deletes segments from an array of streams.</span></span> <span data-ttu-id="afb76-108">Les flux coupés et copiés sont fusionnés dans un nouveau fichier et placés dans le presse-papiers.</span><span class="sxs-lookup"><span data-stu-id="afb76-108">The cut and copied streams are merged into a new file and placed on the clipboard.</span></span> <span data-ttu-id="afb76-109">Les fonctions utilisées incluent [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy)et [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span><span class="sxs-lookup"><span data-stu-id="afb76-109">The functions used include [**EditStreamClone**](/windows/desktop/api/Vfw/nf-vfw-editstreamclone), [**EditStreamCopy**](/windows/desktop/api/Vfw/nf-vfw-editstreamcopy), and [**EditStreamCut**](/windows/desktop/api/Vfw/nf-vfw-editstreamcut).</span></span>
