...
Windows utilise la structure [**MMTIME**](/previous-versions//dd757347(v=vs.85)) pour représenter le temps dans un ou plusieurs formats différents, y compris les millisecondes, les échantillons, les formats de pointeurs de chansons SMPTE et midi. Le membre **wType** spécifie le format d’heure.
