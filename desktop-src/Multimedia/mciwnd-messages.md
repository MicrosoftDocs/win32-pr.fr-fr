---
title: Messages MCIWnd
description: Messages MCIWnd
ms.assetid: 03352b8f-7483-483f-a2bc-af323ab3b9e6
keywords:
- MCI (interface de contrôle multimédia), messages MCIWnd
- Classe de fenêtre MCIWnd, messages
- Fenêtre MCIWnd, messages
- Référence MCIWnd, messages
- Messages MCIWnd
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "124369159"
---
# <a name="mciwnd-messages"></a>Messages MCIWnd

Les messages suivants sont utilisés avec MCIWnd.
