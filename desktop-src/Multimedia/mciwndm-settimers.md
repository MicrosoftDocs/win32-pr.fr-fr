...
Période de mise à jour utilisée par MCIWnd lorsqu’il s’agit de la fenêtre active. La valeur par défaut est 500 millisecondes. Le stockage de cette valeur est limité à 16 bits.
...
Période de mise à jour utilisée par MCIWnd lorsqu’il s’agit de la fenêtre inactive. La valeur par défaut est 2000 millisecondes. Le stockage de cette valeur est limité à 16 bits.
