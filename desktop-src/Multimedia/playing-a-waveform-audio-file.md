...
L’exemple suivant ouvre un appareil Waveform-Audio et lit le fichier Waveform-Audio spécifié par le paramètre *lpszWAVEFileName* à l’aide de la fonction [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .
