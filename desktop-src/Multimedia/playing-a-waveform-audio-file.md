---
title: Exécution d’un fichier Waveform-Audio
description: Exécution d’un fichier Waveform-Audio
...
ms.locfileid: "104381787"
---
# <a name="playing-a-waveform-audio-file"></a><span data-ttu-id="efbf9-103">Exécution d’un fichier Waveform-Audio</span><span class="sxs-lookup"><span data-stu-id="efbf9-103">Playing a Waveform-Audio File</span></span>

<span data-ttu-id="efbf9-104">L’exemple suivant ouvre un appareil Waveform-Audio et lit le fichier Waveform-Audio spécifié par le paramètre *lpszWAVEFileName* à l’aide de la fonction [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="efbf9-104">The following example opens a waveform-audio device and plays the waveform-audio file specified by the *lpszWAVEFileName* parameter using the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
