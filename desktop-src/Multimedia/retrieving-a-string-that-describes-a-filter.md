...
Une application doit souvent afficher une chaîne qui décrit le format actuel. Cette tâche peut être accomplie facilement avec les fonctions [**acmFilterTagDetails**](/windows/desktop/api/Msacm/nf-msacm-acmfiltertagdetails) et [**acmFilterDetails**](/windows/desktop/api/Msacm/nf-msacm-acmfilterdetails) . Ces fonctions doivent être appelées à l’aide du filtre ou de la balise de filtre appropriés. L’exemple suivant montre comment utiliser ces fonctions.
