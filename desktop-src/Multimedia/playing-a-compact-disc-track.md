...
---
# <a name="playing-a-compact-disc-track"></a><span data-ttu-id="e4724-104">Diffusion d’une piste de disque compact</span><span class="sxs-lookup"><span data-stu-id="e4724-104">Playing a Compact Disc Track</span></span>

<span data-ttu-id="e4724-105">L’exemple suivant ouvre un périphérique CD audio, lit la piste spécifiée par le paramètre *bTrack* et ferme l’appareil une fois la lecture terminée.</span><span class="sxs-lookup"><span data-stu-id="e4724-105">The following example opens a CD audio device, plays the track specified by the *bTrack* parameter, and closes the device after playback is complete.</span></span> <span data-ttu-id="e4724-106">Elle utilise la fonction [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="e4724-106">It uses the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
...
<span data-ttu-id="e4724-107">Pour spécifier une position relative à une piste sur un CD-ROM, vous devez utiliser le format d’heure Track/minute/second/Frame (TMSF).</span><span class="sxs-lookup"><span data-stu-id="e4724-107">To specify a position relative to a track on a compact disc, you must use the track/minute/second/frame (TMSF) time format.</span></span>
