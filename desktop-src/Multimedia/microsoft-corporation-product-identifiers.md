...
ms.locfileid: "124369116"
---
# <a name="microsoft-corporation-product-identifiers"></a>Identificateurs de produit Microsoft Corporation



| Nom du produit                             | Identificateur                          |
|------------------------------------------|-------------------------------------|
| Synthétiseur compatible avec Adlib             | \_Adlib mm                           |
| Codec G. 711                              | MM \_ \_ G711 ACM \_ msft                 |
| Codec GSM 610                            | MM \_ \_ GSM610 ACM \_ msft               |
| Codec IMA ADPCM                          | MM \_ \_ imaadpcm ACM \_ msft             |
| Adaptateur de manette                         | manette de jeu MM \_ \_                    |
| Mappeur MIDI                              | \_ \_ Mappeur midi mm                    |
...
| MS vanille pilote MIDI externe      | MM \_ \_ MIDIOUT génériques \_ msft          |
| Pilote MIDI MS vanille dans                | MM \_ \_ midi générique de msft \_           |
| Synthétiseur MIDI du pilote vanille MS       | MM \_ \_ MIDISYNTH génériques \_ msft        |
| Entrée de forme d’onde du pilote vanille MS         | MM \_ d' \_ onde générique msft \_           |
| Sortie wavefrom du pilote MS vanille        | MM \_ \_ WAVEOUT génériques \_ msft          |
| Sortie de forme d’onde du PC               | MM \_ PCSPEAKER \_ WAVEOUT              |
| Convertisseur PCM                            | PCM à l' \_ ACM mm msft \_ \_                  |
| Synthétiseur interne Sound Blaster       | \_ \_ synthétiseur SNDBLST mm                  |
| Port d’entrée Sound Blaster MIDI            | MM \_ \_ midi SNDBLST                 |
| Port de sortie MIDI Sound Blaster           | MM \_ SNDBLST \_ MIDIOUT                |
| Entrée Wave Sound Blaster             | MM \_ SNDBLST \_ Wave                 |
| Sortie de forme d’onde Sound Blaster            | MM \_ SNDBLST \_ WAVEOUT                |
| Mappeur Wave                              | \_ \_ Mappeur Wave mm                    |
