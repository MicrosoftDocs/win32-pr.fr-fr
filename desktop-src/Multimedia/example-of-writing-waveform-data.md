...
ms.locfileid: "124367756"
---
# <a name="example-of-writing-waveform-data"></a>Exemple d’écriture de données de forme d’onde

L’exemple suivant illustre les étapes nécessaires à l’allocation et à la configuration d’une structure [**WAVEHDR**](/windows/win32/api/mmeapi/ns-mmeapi-wavehdr) et à l’écriture d’un bloc de données sur un périphérique de sortie de forme d’onde.
