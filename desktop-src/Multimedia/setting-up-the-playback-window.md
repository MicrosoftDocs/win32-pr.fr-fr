...
---
# <a name="setting-up-the-playback-window"></a>Configuration de la fenêtre de lecture

L’exemple suivant recherche les dimensions nécessaires à la lecture d’un fichier AVI, crée une fenêtre correspondant à cette taille et lit le fichier dans la fenêtre à l’aide du pilote MCIAVI. Elle utilise la fonction [**mciSendCommand**](/previous-versions//dd757160(v=vs.85))
