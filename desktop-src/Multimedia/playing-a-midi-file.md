...
ms.locfileid: "103940913"
---
# <a name="playing-a-midi-file"></a><span data-ttu-id="bda5b-103">Exécution d’un fichier MIDI</span><span class="sxs-lookup"><span data-stu-id="bda5b-103">Playing a MIDI File</span></span>

<span data-ttu-id="bda5b-104">L’exemple suivant ouvre un appareil de séquenceur MIDI, vérifie que le Mappeur MIDI a été sélectionné comme port de sortie, lit le fichier MIDI spécifié par le paramètre *lpszMIDIFileName* et ferme l’appareil une fois la lecture terminée.</span><span class="sxs-lookup"><span data-stu-id="bda5b-104">The following example opens a MIDI sequencer device, verifies that the MIDI mapper was selected as the output port, plays the MIDI file specified by the *lpszMIDIFileName* parameter, and closes the device after playback is complete.</span></span> <span data-ttu-id="bda5b-105">Elle utilise la fonction [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) .</span><span class="sxs-lookup"><span data-stu-id="bda5b-105">It uses the [**mciSendCommand**](/previous-versions//dd757160(v=vs.85)) function.</span></span>
