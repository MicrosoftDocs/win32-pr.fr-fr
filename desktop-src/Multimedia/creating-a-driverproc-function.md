...
---
# <a name="creating-a-driverproc-function"></a><span data-ttu-id="b2652-107">Création d’une fonction DriverProc</span><span class="sxs-lookup"><span data-stu-id="b2652-107">Creating a DriverProc Function</span></span>

<span data-ttu-id="b2652-108">Vous créez une fonction [DriverProc](/windows/win32/api/mmiscapi/nc-mmiscapi-driverproc) à peu près de la même façon que vous créez une procédure de fenêtre.</span><span class="sxs-lookup"><span data-stu-id="b2652-108">You create a [DriverProc](/windows/win32/api/mmiscapi/nc-mmiscapi-driverproc) function in much the same way as you create a window procedure.</span></span> <span data-ttu-id="b2652-109">La fonction se compose d’une instruction **switch** , et chaque cas traite un message de pilote donné, en retournant une valeur indiquant la réussite ou l’échec.</span><span class="sxs-lookup"><span data-stu-id="b2652-109">The function consists of a **switch** statement, and each case processes a given driver message, returning a value indicating success or failure.</span></span> <span data-ttu-id="b2652-110">La fonction **DriverProc** se présente sous la forme suivante :</span><span class="sxs-lookup"><span data-stu-id="b2652-110">The **DriverProc** function has the following form:</span></span>
