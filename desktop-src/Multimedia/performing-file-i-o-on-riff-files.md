...
ms.locfileid: "124368428"
---
# <a name="performing-file-io-on-riff-files"></a>Exécution d’e/s de fichier sur des fichiers RIFF

L’exemple suivant montre comment ouvrir un fichier RIFF pour les e/s mises en mémoire tampon, ainsi que la façon de découper, de Ascender et de lire des blocs « RIFF ».
