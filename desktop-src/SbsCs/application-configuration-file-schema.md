...
ms.locfileid: "127238157"
---
# <a name="application-configuration-file-schema"></a>Schéma du fichier de configuration de l’application

Voici la liste complète du schéma de fichier de configuration de l’application.
