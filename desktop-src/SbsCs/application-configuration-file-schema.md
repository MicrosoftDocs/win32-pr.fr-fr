---
description: Voici la liste complète du schéma de fichier de configuration de l’application.
ms.assetid: c673dbff-cb64-4e90-88a8-c5f2c259f1d3
title: Schéma du fichier de configuration de l’application
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104203183"
---
# <a name="application-configuration-file-schema"></a><span data-ttu-id="9ae2e-103">Schéma du fichier de configuration de l’application</span><span class="sxs-lookup"><span data-stu-id="9ae2e-103">Application Configuration File Schema</span></span>

<span data-ttu-id="9ae2e-104">Voici la liste complète du schéma de fichier de configuration de l’application.</span><span class="sxs-lookup"><span data-stu-id="9ae2e-104">The following is the complete listing of the application configuration file schema.</span></span>
