...
-   Les [fichiers de configuration](publisher-configuration-files.md)du serveur de publication, sont des manifestes utilisés pour rediriger la version d’un assembly côte à côte vers une autre version compatible. La version vers laquelle l’assembly est redirigé doit avoir les mêmes valeurs majeures. minor que la version d’origine.
