---
description: Voici la liste complète du schéma de fichier manifeste.
ms.assetid: 5a4040a4-66ed-44ea-a07f-6410f88d1446
title: Schéma de fichier manifeste
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106532180"
---
# <a name="manifest-file-schema"></a><span data-ttu-id="e6eb2-103">Schéma de fichier manifeste</span><span class="sxs-lookup"><span data-stu-id="e6eb2-103">Manifest File Schema</span></span>

<span data-ttu-id="e6eb2-104">Voici la liste complète du schéma de fichier manifeste.</span><span class="sxs-lookup"><span data-stu-id="e6eb2-104">The following is the complete listing of the manifest file schema.</span></span>
