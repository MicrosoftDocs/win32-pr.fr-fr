...
---
# <a name="publisher-configuration-file-schema"></a><span data-ttu-id="97eec-103">Schéma du fichier de configuration du serveur de publication</span><span class="sxs-lookup"><span data-stu-id="97eec-103">Publisher Configuration File Schema</span></span>

<span data-ttu-id="97eec-104">Voici la liste complète du schéma du fichier de configuration du serveur de publication.</span><span class="sxs-lookup"><span data-stu-id="97eec-104">The following is the complete listing of the publisher configuration file schema.</span></span>
