...
|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------|:----------------------------------------------------------|
| <span id="ASN_SEQUENCE"></span><span id="asn_sequence"></span><dl> <dt>**\_séquence ASN**</dt> </dl>       | Indique que le message est une séquence ASN.<br/> |
| <span id="ASN_SEQUENCEOF"></span><span id="asn_sequenceof"></span><dl> <dt>**\_SEQUENCEOF ASN**</dt> </dl> | Consultez la \_ séquence ASN.<br/>                             |
