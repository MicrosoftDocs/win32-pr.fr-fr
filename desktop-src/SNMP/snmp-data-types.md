---
title: Types de données SNMP (SNMP. h)
description: L’API SNMP définit les types de données suivants.
...
|--------------------------------|------------------------------------------------------------------------|
| **AsnObjectName**<br/>   | Consultez [**AsnObjectIdentifier**](/windows/desktop/api/Snmp/ns-snmp-asnobjectidentifier).<br/> |
| **AsnObjectSyntax**<br/> | Consultez [**AsnAny**](/windows/desktop/api/Snmp/ns-snmp-asnany).<br/>                           |
