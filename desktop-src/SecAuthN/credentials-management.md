...
-   [Types d’informations d’identification](kinds-of-credentials.md)
-   [Formats de nom d’utilisateur](user-name-formats.md)

Pour plus d’informations sur les fonctions de l’API de gestion des informations d’identification, consultez [référence de l’authentification](authentication-reference.md).
