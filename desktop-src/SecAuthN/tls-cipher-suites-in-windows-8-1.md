...
Windows 8.1 et Windows Server 2012 R2 sont mis à jour par Windows Update par la [mise à jour 2919355](https://support.microsoft.com/kb/2919355) appliquée, qui ajoute les nouvelles suites de chiffrement et modifie l’ordre de priorité. Les suites de chiffrement suivantes sont activées et, par défaut, dans cet ordre de priorité par le fournisseur Microsoft Schannel :
