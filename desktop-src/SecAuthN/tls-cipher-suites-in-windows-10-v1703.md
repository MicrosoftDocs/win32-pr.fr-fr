---
description: en savoir plus sur les suites de chiffrement TLS dans Windows 10 v1703. Les suites de chiffrement ne peuvent être négociées que pour les versions TLS qui les prennent en charge.
...
ms.locfileid: "127096293"
---
# <a name="tls-cipher-suites-in-windows-10-v1703"></a>Suites de chiffrement TLS dans Windows 10 v1703
...
pour Windows 10, la version 1703, les suites de chiffrement suivantes sont activées et, par défaut, dans cet ordre de priorité, utilisez le fournisseur Microsoft Schannel :
