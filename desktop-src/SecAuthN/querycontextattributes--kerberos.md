---
description: Permet à une application de transport d’interroger le [*package de sécurité*](../secgloss/s-gly.md) Kerberos pour certains attributs d’un [*contexte de sécurité*](../secgloss/s-gly.md).
...
ms.locfileid: "104484705"
---
# <a name="querycontextattributes-kerberos-function"></a>QueryContextAttributes (Kerberos) (fonction)

La fonction **QueryContextAttributes (Kerberos)** permet à une application de transport d’interroger le [*package de sécurité*](../secgloss/s-gly.md) Kerberos pour certains [*attributs*](../secgloss/a-gly.md#_security_attribute_gly) d’un [*contexte de sécurité*](../secgloss/s-gly.md).
