...
|------------------------------------------------------------------------------------------------------------------------|------------------------------------------|----------|
| Connecter à une carte à puce, implémenter des transactions, fermer les connexions, etc.                                         | [**ISCard**](iscard.md)                 | SCardSSP |
...
2.  Connecter à une carte à puce particulière à l’aide des méthodes de l’interface [**ISCard**](iscard.md) .
