...
ms.locfileid: "127123485"
---
# <a name="getting-a-certificate-for-schannel"></a>Obtention d’un certificat pour Schannel

L’exemple suivant montre les étapes permettant d’obtenir une structure de [**\_ contexte**](/windows/desktop/api/wincrypt/ns-wincrypt-cert_context) de certificat qui contient un certificat ; vous devez sélectionner un certificat et un magasin de certificats appropriés pour votre application.

Cet exemple illustre l’ouverture d’un [*magasin de certificats*](/windows/desktop/SecGloss/c-gly) et la localisation d’un certificat qui sera transmis à la fonction [**AcquireCredentialsHandle**](/windows/win32/api/sspi/nf-sspi-acquirecredentialshandlea) , au moyen de la structure [**Schannel \_ cred**](/windows/desktop/api/Schannel/ns-schannel-schannel_cred) .
