...
---
# <a name="using-sspi-with-a-windows-sockets-client"></a><span data-ttu-id="3a423-103">Utilisation de SSPI avec un client Windows Sockets</span><span class="sxs-lookup"><span data-stu-id="3a423-103">Using SSPI with a Windows Sockets Client</span></span>

<span data-ttu-id="3a423-104">Cet exemple de programme fonctionne avec le programme serveur [à l’aide de SSPI avec un serveur Windows Sockets](using-sspi-with-a-windows-sockets-server.md).</span><span class="sxs-lookup"><span data-stu-id="3a423-104">This sample program works with the server program [Using SSPI with a Windows Sockets Server](using-sspi-with-a-windows-sockets-server.md).</span></span> <span data-ttu-id="3a423-105">Les exemples de programmes client et serveur sont conçus pour fonctionner ensemble.</span><span class="sxs-lookup"><span data-stu-id="3a423-105">The client and server sample programs are designed to work together.</span></span> <span data-ttu-id="3a423-106">Les deux programmes utilisent le fichier d’en-tête SspiExample. h, qui se trouve dans le [fichier d’en-tête pour les exemples de serveur et de client SSPI](header-file-for-sspi-client-and-server.md).</span><span class="sxs-lookup"><span data-stu-id="3a423-106">Both programs use the header file SspiExample.h, which can be found in [Header File for SSPI Client and Server Samples](header-file-for-sspi-client-and-server.md).</span></span> <span data-ttu-id="3a423-107">Ce programme inclut des appels à des fonctions dans secur32. lib et Ws2 \_ 32. lib, qui doivent être inclus dans les bibliothèques de liens.</span><span class="sxs-lookup"><span data-stu-id="3a423-107">This program includes calls to functions in Secur32.lib and Ws2\_32.lib, which must be included among the link libraries.</span></span>

<span data-ttu-id="3a423-108">Ce programme montre les éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="3a423-108">This program demonstrates the following:</span></span>

-   <span data-ttu-id="3a423-109">Établissement d’une connexion Windows Sockets avec un serveur.</span><span class="sxs-lookup"><span data-stu-id="3a423-109">Establishing a Windows Sockets connection with a server.</span></span>
-   <span data-ttu-id="3a423-110">Initialisation d’une session SSPI authentifiée avec le SSP Negotiate.</span><span class="sxs-lookup"><span data-stu-id="3a423-110">Initializing an authenticated SSPI session with the Negotiate SSP.</span></span>
-   <span data-ttu-id="3a423-111">Connexion à un serveur et établissement d’une session de communication sécurisée.</span><span class="sxs-lookup"><span data-stu-id="3a423-111">Connecting with a server and establishing a secure communication session.</span></span>
-   <span data-ttu-id="3a423-112">Réception et déchiffrement d’un message à partir du serveur au sein de la session sécurisée.</span><span class="sxs-lookup"><span data-stu-id="3a423-112">Receiving and decrypt a message from the server within the secure session.</span></span>

<span data-ttu-id="3a423-113">Cet exemple de programme utilise une gestion limitée des erreurs.</span><span class="sxs-lookup"><span data-stu-id="3a423-113">This sample program uses limited error handling.</span></span>
