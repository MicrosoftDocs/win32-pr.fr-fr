...
---
# <a name="querycontextattributes-ntlm-function"></a>QueryContextAttributes (NTLM) (fonction)

La fonction **QueryContextAttributes (NTLM)** permet à une application de transport d’interroger le [*package de sécurité*](../secgloss/s-gly.md) NTLM pour certains [*attributs*](../secgloss/a-gly.md#_security_attribute_gly) d’un [contexte de sécurité](../secgloss/s-gly.md).
