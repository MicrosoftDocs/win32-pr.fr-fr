...
|-----------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------|
| [Expérience d’ouverture de session Windows dirigée par le fournisseur d’informations d’identification](https://go.microsoft.com/fwlink/?LinkId=717287)<br/> | Présentation de Winlogon et de l’architecture du fournisseur d’informations d’identification et d’un exemple de fournisseur d’informations d’identification.<br/> |
