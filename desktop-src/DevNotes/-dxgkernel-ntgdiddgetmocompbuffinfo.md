...
ms.locfileid: "118956328"
---
# <a name="ntgdiddgetmocompbuffinfo-function"></a>NtGdiDdGetMoCompBuffInfo fonction)
...
Permet au pilote de spécifier le nombre de surfaces intermédiaires requises pour prendre en charge le GUID spécifié, ainsi que la taille, l’emplacement et le format de chacune de ces surfaces.
...
Pointeur vers une [**structure \_ GETMOCOMPCOMPBUFFDATA DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompcompbuffdata) qui contient les informations de mémoire tampon compressées.

</dd> </dl>

## <a name="return-value"></a>Valeur retournée

**NtGdiDdGetMoCompBuffInfo** retourne l’un des codes de rappel suivants.
