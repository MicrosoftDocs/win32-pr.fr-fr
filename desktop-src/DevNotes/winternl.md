...
ms.locfileid: "119075733"
---
# <a name="winternl"></a>Winternl

## <a name="in-this-section"></a>Dans cette section

-   [Appel d’API internes](calling-internal-apis.md)
-   [Obtention de l’ID de session de la console active](getting-the-active-console-session-id.md)
-   [Obtention de l’ID de session du processus en cours](getting-the-session-id-of-the-current-process.md)
-   [**\_informations de \_ requête TCP IOCTL \_ \_ ex**](/windows/desktop/api/Tcpioctl/ni-tcpioctl-ioctl_tcp_query_information_ex)
