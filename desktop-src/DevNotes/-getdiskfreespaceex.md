...
\[Cette fonction est un wrapper sur la fonction **GetDiskFreeSpaceEx** . Cette fonction peut être modifiée ou non disponible à l’avenir. Les applications doivent appeler **GetDiskFreeSpaceEx** directement.\]

Obtient l’espace disque disponible. Consultez [**GetDiskFreeSpaceEx**](/windows/win32/api/fileapi/nf-fileapi-getdiskfreespaceexa).
