---
description: 'Les énumérations suivantes sont utilisées dans l’énumération des ressources :'
ms.assetid: fb43b8b4-04ed-4fcf-9df3-cdcad1a73fb5
title: Énumérations d’énumération de ressources
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104393080"
---
# <a name="resource-enumeration-enumerations"></a>Énumérations d’énumération de ressources

Les énumérations suivantes sont utilisées dans l’énumération des ressources :

-   [**eAvrfResourceTypes**](/windows/desktop/api/Avrfsdk/ne-avrfsdk-eavrfresourcetypes)
-   [**\_opérations de trace eHANDLE \_**](/windows/desktop/api/Avrfsdk/ne-avrfsdk-ehandle_trace_operations)
