---
description: L’exemple suivant montre comment utiliser la fonction VerifierEnumerateResource et les éléments de programmation associés pour abstraire et catégoriser les informations sur les ressources spécifiques au processus.
ms.assetid: e0c2c795-2960-44f9-8b63-2329f5b42e15
title: Utilisation de l’énumération des ressources
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103950413"
---
# <a name="using-resource-enumeration"></a><span data-ttu-id="6f552-103">Utilisation de l’énumération des ressources</span><span class="sxs-lookup"><span data-stu-id="6f552-103">Using Resource Enumeration</span></span>

<span data-ttu-id="6f552-104">L’exemple suivant montre comment utiliser la fonction [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) et les éléments de programmation associés pour abstraire et catégoriser les informations sur les ressources spécifiques au processus.</span><span class="sxs-lookup"><span data-stu-id="6f552-104">The following example shows how to use the [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) function and related programming elements to abstract and categorize process-specific resource information.</span></span>
