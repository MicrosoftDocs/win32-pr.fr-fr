...
---
# <a name="using-resource-enumeration"></a>Utilisation de l’énumération des ressources

L’exemple suivant montre comment utiliser la fonction [**VerifierEnumerateResource**](/windows/desktop/api/Avrfsdk/nf-avrfsdk-verifierenumerateresource) et les éléments de programmation associés pour abstraire et catégoriser les informations sur les ressources spécifiques au processus.
