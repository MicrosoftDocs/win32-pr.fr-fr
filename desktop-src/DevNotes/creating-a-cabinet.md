...
ms.locfileid: "118667972"
---
# <a name="creating-a-cabinet"></a>Création d’un fichier CAB

La syntaxe suivante illustre la création d’un fichier CAB.

> [!Note]  
> Ce code est fourni à titre d’illustration uniquement. Pour compiler, les fonctions de rappel doivent être définies.
...
[Macros de l’API Cabinet](cabinet-api-macros.md)
</dt> </dl>
