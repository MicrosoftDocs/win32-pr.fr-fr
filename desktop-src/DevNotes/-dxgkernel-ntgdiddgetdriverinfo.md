...
ms.locfileid: "118956348"
---
# <a name="ntgdiddgetdriverinfo-function"></a>NtGdiDdGetDriverInfo fonction)
...
Interroge le pilote pour obtenir d’autres fonctionnalités Microsoft DirectDraw et Microsoft Direct3D prises en charge par le pilote.
...
Pointeur vers une [structure \_ GETDRIVERINFODATA DD](https://msdn.microsoft.com/library/ms793868.aspx) qui contient les informations requises pour exécuter la requête.

</dd> </dl>

## <a name="return-value"></a>Valeur retournée

**NtGdiDdGetDriverInfo** retourne l’un des codes de rappel suivants.
