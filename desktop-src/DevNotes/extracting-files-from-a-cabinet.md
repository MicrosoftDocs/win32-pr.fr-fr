...
---
# <a name="extracting-files-from-a-cabinet"></a><span data-ttu-id="0dc84-103">Extraction de fichiers à partir d’un fichier CAB</span><span class="sxs-lookup"><span data-stu-id="0dc84-103">Extracting Files from a Cabinet</span></span>

<span data-ttu-id="0dc84-104">La syntaxe suivante illustre la création d’un fichier CAB.</span><span class="sxs-lookup"><span data-stu-id="0dc84-104">The following syntax illustrates the creation of a cabinet.</span></span>

> [!Note]  
> <span data-ttu-id="0dc84-105">Ce code est fourni à titre d’illustration uniquement.</span><span class="sxs-lookup"><span data-stu-id="0dc84-105">This code is for illustrative purposes only.</span></span> <span data-ttu-id="0dc84-106">Pour compiler, les fonctions de rappel doivent être définies.</span><span class="sxs-lookup"><span data-stu-id="0dc84-106">To compile, the callback functions must be defined.</span></span>

 

## <a name="example"></a><span data-ttu-id="0dc84-107">Exemple</span><span class="sxs-lookup"><span data-stu-id="0dc84-107">Example</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="0dc84-108">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="0dc84-108">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="0dc84-109">**FDICreate**</span><span class="sxs-lookup"><span data-stu-id="0dc84-109">**FDICreate**</span></span>](/windows/desktop/api/Fdi/nf-fdi-fdicreate)
</dt> <dt>

[<span data-ttu-id="0dc84-110">**FDICopy**</span><span class="sxs-lookup"><span data-stu-id="0dc84-110">**FDICopy**</span></span>](/windows/desktop/api/Fdi/nf-fdi-fdicopy)
</dt> <dt>

[<span data-ttu-id="0dc84-111">**FDIDestroy**</span><span class="sxs-lookup"><span data-stu-id="0dc84-111">**FDIDestroy**</span></span>](/windows/desktop/api/Fdi/nf-fdi-fdidestroy)
</dt> <dt>

[<span data-ttu-id="0dc84-112">Macros de l’API Cabinet</span><span class="sxs-lookup"><span data-stu-id="0dc84-112">Cabinet API Macros</span></span>](cabinet-api-macros.md)
</dt> </dl>
