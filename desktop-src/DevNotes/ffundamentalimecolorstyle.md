...
Spécifie si la couleur spécifiée est une couleur fondamentale.
...
Une structure **IMECOLORSTY** retournée par la fonction [**PColorStyleBackFromIMEStyle**](pcolorstylebackfromimestyle.md) ou [**PColorStyleTextFromIMEStyle**](pcolorstyletextfromimestyle.md) .
