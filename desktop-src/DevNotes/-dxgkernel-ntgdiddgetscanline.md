...
---
# <a name="ntgdiddgetscanline-function"></a>NtGdiDdGetScanLine fonction)
...
Retourne le numéro de la ligne d’analyse physique actuelle.
...
Handle vers une [**structure \_ \_ globale d’JJ DIRECTDRAW**](/windows/win32/api/ddrawint/ns-ddrawint-dd_directdraw_global) qui représente le pilote.
...
Pointeur vers une [**structure \_ GETSCANLINEDATA DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getscanlinedata) dans laquelle le pilote retourne le numéro de la ligne de numérisation actuelle.

</dd> </dl>

## <a name="return-value"></a>Valeur retournée

**NtGdiDdGetScanLine** retourne l’un des codes de rappel suivants.
