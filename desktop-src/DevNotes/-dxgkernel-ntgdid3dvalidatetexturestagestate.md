...
---
# <a name="ntgdid3dvalidatetexturestagestate-function"></a>NtGdiD3DValidateTextureStageState fonction)
...
Retourne le nombre de passes où le matériel peut effectuer les opérations de fusion spécifiées dans l’état actuel.
...
Pointeur vers une structure [**D3DNTHAL \_ VALIDATETEXTURESTAGESTATEDATA**](/windows-hardware/drivers/ddi/) qui contient les informations requises pour que le pilote détermine et retourne le nombre de passes requis pour effectuer les opérations de fusion.

</dd> </dl>

## <a name="return-value"></a>Valeur retournée

**NtGdiD3DValidateTextureStageState** retourne l’un des codes de rappel suivants.
