...
Spécifie les fonctions de rappel que le gestionnaire de composants facultatifs doit utiliser.
...
Fonction de rappel à remplir dans la structure des données d’installation qui fournit des informations sur l’environnement dans lequel le gestionnaire OC est en cours d’exécution.
...
Fonction de rappel qui indique s’il faut afficher ou masquer l’Assistant. Cela n’a d’effet que si le panneau s’affiche.
...
Fonction de rappel qui appelle les commentaires de progression vers le panneau.
