...
---
# <a name="sdbwriteqwordtag-function"></a>SdbWriteQWORDTag fonction)

Écrit une valeur **QWord** dans la base de données spécifiée.
...
BALIse pour l’entrée. Cette BALIse doit être de type de **balise \_ \_ QWord**.
