...
---
# <a name="ntgdiddunlock-function"></a>NtGdiDdUnlock fonction)
...
Libère le verrou maintenu sur la surface spécifiée.
...
Handle vers une structure de [**\_ surface \_ locale DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_surface_local) qui décrit la surface à déverrouiller.
...
**NtGdiDdUnlock** retourne l’un des codes de rappel suivants.
