...
ms.locfileid: "120053329"
---
# <a name="ntgdiddwaitforverticalblank-function"></a>NtGdiDdWaitForVerticalBlank fonction)
...
Retourne l’état vide vertical de l’appareil.
...
Pointeur vers une [**structure \_ WAITFORVERTICALBLANKDATA DD**](/windows/win32/api/ddrawi/ns-ddrawi-ddhal_waitforverticalblankdata) qui contient les informations requises pour obtenir l’état vide vertical.

</dd> </dl>

## <a name="return-value"></a>Valeur retournée

**NtGdiDdWaitForVerticalBlank** retourne l’un des codes de rappel suivants.
