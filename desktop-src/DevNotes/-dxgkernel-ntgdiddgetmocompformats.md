...
ms.locfileid: "118668818"
---
# <a name="ntgdiddgetmocompformats-function"></a>NtGdiDdGetMoCompFormats fonction)
...
Indique les formats non compressés auxquels le matériel peut décoder les données.
...
Pointeur vers une [**structure \_ GETMOCOMPFORMATSDATA DD**](/windows/win32/api/ddrawint/ns-ddrawint-dd_getmocompformatsdata) qui contient les informations de format non compressées pour le matériel.

</dd> </dl>

## <a name="return-value"></a>Valeur retournée

**NtGdiDdGetMoCompFormats** retourne l’un des codes de rappel suivants.
