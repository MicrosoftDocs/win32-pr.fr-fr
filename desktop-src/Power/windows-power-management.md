...
---
# <a name="windows-power-management"></a>Gestion de l’alimentation Windows

La gestion de l’alimentation Windows rend les ordinateurs accessibles instantanément aux utilisateurs en appuyant sur un bouton ou une touche. Il garantit également que tous les éléments du système (applications, périphériques et interface utilisateur) peuvent tirer parti des améliorations apportées à la technologie et aux fonctionnalités de gestion de l’alimentation.
