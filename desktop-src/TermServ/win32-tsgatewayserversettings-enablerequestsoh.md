...
ms.locfileid: "118349153"
---
# <a name="enablerequestsoh-method-of-the-win32_tsgatewayserversettings-class"></a>Méthode EnableRequestSOH de la \_ classe Win32 TSGatewayServerSettings

\[La méthode **EnableRequestSOH** n’est plus disponible à partir de Windows Server 2016.\]

Active ou désactive les demandes pour une déclaration d’intégrité (SoH).
...
Spécifiez **true** pour activer la fonctionnalité ou **false** pour la désactiver.
