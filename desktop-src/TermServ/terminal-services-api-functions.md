...
Libère de la mémoire qui contient les structures d’informations de [**\_ processus WTS \_ \_ ex**](/windows/desktop/api/Wtsapi32/ns-wtsapi32-wts_process_info_exa) ou WTS, qui sont allouées par une fonction services Bureau à distance. [**\_ \_ \_**](/windows/desktop/api/Wtsapi32/ns-wtsapi32-wts_session_info_1a)
