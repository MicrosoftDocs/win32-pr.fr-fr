---
title: MsRdpClient2a, classe
description: Contrôle client Microsoft RDP (redistribuable)-version 3A.
ms.assetid: 32B16F72-5321-4471-B9AD-244846E4C8D3
ms.tgt_platform: multiple
keywords:
- Services Bureau à distance de la classe MsRdpClient2a
- Services Bureau à distance de la classe MsRdpClient2a, Description
topic_type:
- apiref
api_name:
- MsRdpClient2a
...
ms.locfileid: "126919744"
---
# <a name="msrdpclient2a-class"></a>MsRdpClient2a, classe
...
**MsRdpClient2a** possède les types de membres suivants :
...
La classe **MsRdpClient2a** possède ces méthodes.
...
La classe **MsRdpClient2a** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient2a est défini en tant que 971127BB-259F-48C2-BD75-5F97A3331551<br/>     |
