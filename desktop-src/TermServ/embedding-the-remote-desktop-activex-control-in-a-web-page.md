...
---
# <a name="embedding-the-remote-desktop-activex-control-in-a-webpage"></a><span data-ttu-id="d88ed-103">Incorporation du contrôle Bureau à distance ActiveX dans une page Web</span><span class="sxs-lookup"><span data-stu-id="d88ed-103">Embedding the Remote Desktop ActiveX control in a webpage</span></span>

<span data-ttu-id="d88ed-104">Vous pouvez incorporer le contrôle ActiveX Bureau à distance dans une page Web à l’aide d’un code similaire à ce qui suit.</span><span class="sxs-lookup"><span data-stu-id="d88ed-104">You can embed the Remote Desktop ActiveX control in a web page by using code that is similar to the following.</span></span>
...
<span data-ttu-id="d88ed-105">Le CLSID est pour le contrôle ActiveX hébergé par Connexion Bureau à distance (RDP) 6,0.</span><span class="sxs-lookup"><span data-stu-id="d88ed-105">The CLSID is for the ActiveX control that is hosted by Remote Desktop Connection (RDP) 6.0.</span></span> <span data-ttu-id="d88ed-106">Ce contrôle ActiveX implémente [**IMsRdpClient**](imsrdpclient-interface.md).</span><span class="sxs-lookup"><span data-stu-id="d88ed-106">This ActiveX control implements [**IMsRdpClient**](imsrdpclient-interface.md).</span></span>

## <a name="related-topics"></a><span data-ttu-id="d88ed-107">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="d88ed-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d88ed-108">Utilisation du contrôle ActiveX Bureau à distance</span><span class="sxs-lookup"><span data-stu-id="d88ed-108">Using the Remote Desktop ActiveX control</span></span>](using-remote-desktop-web-connection.md)
</dt> </dl>
