...
ms.locfileid: "117756771"
---
# <a name="itsremoteprogram2remoteapplicationargs-property"></a>ITSRemoteProgram2 :: RemoteApplicationArgs, propriété

Arguments de ligne de commande pour le RemoteApp.
...
Arguments de ligne de commande RemoteApp.
