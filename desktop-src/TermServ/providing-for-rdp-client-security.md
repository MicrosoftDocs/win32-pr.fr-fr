...
-   [**KeyboardHookMode**](imsrdpclientsecuredsettings-keyboardhookmode.md). Cette propriété spécifie comment et quand appliquer les combinaisons de touches Windows. par exemple, ALT + TAB.

Le script suivant lance Microsoft Notepad.exe lors de la connexion. Exécutez ce script avant d’appeler la méthode [**IMsTscAx :: Connect**](imstscax-connect.md) .
