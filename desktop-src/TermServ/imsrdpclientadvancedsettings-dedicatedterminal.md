---
title: IMsRdpClientAdvancedSettings propriété DedicatedTerminal
description: Cette propriété n'est pas prise en charge. | IMsRdpClientAdvancedSettings propriété DedicatedTerminal
ms.assetid: 40d54c88-dcac-4e7d-b389-a65caeb6960e
ms.tgt_platform: multiple
keywords:
- Services Bureau à distance de la propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings2
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings2, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings3
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings3, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings4
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings4, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings5
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings5, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings6
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings6, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings7
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings7, propriété DedicatedTerminal
- Services Bureau à distance de la propriété DedicatedTerminal, interface IMsRdpClientAdvancedSettings8
- Services Bureau à distance de l’interface IMsRdpClientAdvancedSettings8, propriété DedicatedTerminal
topic_type:
- apiref
api_name:
