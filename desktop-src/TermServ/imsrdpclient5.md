...
L’interface **IMsRdpClient5** hérite de [**IMsRdpClient4**](imsrdpclient4.md). **IMsRdpClient5** a également les types de membres suivants :
...
L’interface **IMsRdpClient5** possède ces méthodes.
...
L’interface **IMsRdpClient5** possède les propriétés suivantes.



| Propriété                                                                | Type d’accès          | Description                                                                                         |
|:------------------------------------------------------------------------|:---------------------|:----------------------------------------------------------------------------------------------------|
| [**AdvancedSettings6**](imsrdpclient5-advancedsettings6.md)<br/> | Lecture seule<br/> | Interface à [**IMsRdpClientAdvancedSettings5**](imsrdpclientadvancedsettings5.md).<br/> |
| [**MsRdpClientShell**](imsrdpclient5-msrdpclientshell.md)<br/>   | Lecture seule<br/> | Paramètres client pour le lanceur du portail Web.<br/>                                         |
| [**RemoteProgram**](imsrdpclient5-remoteprogram.md)<br/>         | Lecture seule<br/> | Paramètre RemoteApp du client.<br/>                                                            |
...
L’interface **IMsRdpClient5** a été étendue par les interfaces suivantes, chaque nouvelle interface héritant de toutes les méthodes et propriétés des interfaces précédentes :
