...
ms.locfileid: "127221969"
---
# <a name="setpasswordallowed-method-of-the-win32_tsgatewayconnectionauthorizationpolicy-class"></a>Méthode SetPasswordAllowed de la \_ classe Win32 TSGatewayConnectionAuthorizationPolicy

Définit la propriété **PasswordAllowed** , qui active ou désactive la prise en charge de l’utilisation d’un mot de passe pour se connecter au serveur de passerelle Bureau à distance (passerelle des services Bureau à distance).
...
Nouvelle valeur **PasswordAllowed** .
