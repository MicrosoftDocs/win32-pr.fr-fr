...
Fournit les propriétés nécessaires pour contrôler la fonctionnalité du pointeur tactile du contrôle client du conteneur d’applications protocole RDP (Remote Desktop Protocol) (RDP).
