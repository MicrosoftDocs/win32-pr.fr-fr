...
La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ChangeStartMode** modifie le mode de démarrage d' [**un \_ TerminalService Win32**](win32-terminalservice.md).
