...
Indique si le compte utilisé pour exécuter le script ou .exe fichier qui utilise la classe **Win32 \_ TSDiscoveredLicenseServer** dispose d’un accès administrateur au serveur de licences.
