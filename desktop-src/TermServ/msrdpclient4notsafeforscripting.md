...
Contrôle client Microsoft RDP-version 5
...
**MsRdpClient4NotSafeForScripting** possède les types de membres suivants :
...
La classe **MsRdpClient4NotSafeForScripting** possède ces méthodes.
...
La classe **MsRdpClient4NotSafeForScripting** possède les propriétés suivantes.
...
| [**AdvancedSettings5**](imsrdpclient4-advancedsettings5.md)<br/>                    | Lecture seule<br/>  | Pointeur d’interface [**IMsRdpClientAdvancedSettings4**](imsrdpclientadvancedsettings4.md) .<br/>                                                                                                      |
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient4NotSafeForScripting est défini en tant que 6AE29350-321B-42BE-BBE5-12FB5270C0DE<br/> |
