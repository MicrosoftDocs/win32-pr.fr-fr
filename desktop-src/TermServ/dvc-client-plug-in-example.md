...
ms.locfileid: "119285599"
---
# <a name="dvc-client-plug-in-example"></a>Exemple de plug-in client DVC

L’exemple de code C++ suivant fournit un exemple de création d’un plug-in de canal virtuel dynamique (DVC) de client Connexion Bureau à distance (RDC).
