...
ms.locfileid: "127008552"
---
# <a name="win32_tssysteminfo-class"></a>\_Classe TSSystemInfo Win32

Représente le service d’informations du serveur de publication centralisé
...
La classe **Win32 \_ TSSystemInfo** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ TSSystemInfo** a ces propriétés.
...
Numéro de version de ce fournisseur WMI.
...
Le groupe d’utilisateurs Bureau à distance, au format SDDL (Security Descriptor Definition Language).
