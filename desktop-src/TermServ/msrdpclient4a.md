...
---
# <a name="msrdpclient4a-class"></a>MsRdpClient4a, classe
...
**MsRdpClient4a** possède les types de membres suivants :
...
La classe **MsRdpClient4a** possède ces méthodes.
...
La classe **MsRdpClient4a** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient4a est défini en tant que 54CE37E0-9834-41AE-9896-4DAB69DC022B<br/>     |
