...
ms.locfileid: "122475335"
---
# <a name="msrdpclient10notsafeforscripting-class"></a>MsRdpClient10NotSafeForScripting, classe

Contrôle client Microsoft RDP-version 11
...
**MsRdpClient10NotSafeForScripting** possède les types de membres suivants :
...
| [**Connexion**](imstscax-connect.md)                                                         | Établit une connexion à l’aide des propriétés actuellement définies sur le contrôle.<br/>                                                                                                                                                                                                          |
...
La classe **MsRdpClient10NotSafeForScripting** possède les propriétés suivantes.
...
| <a href="imsrdpclient8-advancedsettings9.md"><strong>AdvancedSettings9</strong></a><br /> | Lecture seule<br /> | Interface <a href="imsrdpclientadvancedsettings8.md"><strong>IMsRdpClientAdvancedSettings8</strong></a> qui représente l’objet de paramètres.<br /> | 
...
| <a href="imsrdpclient10-remoteprogram3.md"><strong>RemoteProgram3</strong></a><br /> | Lecture seule<br /> | Objet qui prend en charge l’interface <a href="itsremoteprogram3.md"><strong>ITSRemoteProgram3</strong></a> .<br /> | 
...
| <a href="imsrdpclient9-transportsettings4.md"><strong>TransportSettings4</strong></a><br /> | Lecture seule<br /> | Objet qui prend en charge l’interface <a href="imsrdpclienttransportsettings4.md"><strong>IMsRdpClientTransportSettings4</strong></a> .<br /> | 
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient10NotSafeForScripting est défini en tant que A0C63C30-F08D-4AB4-907C-34905D770C7D<br/> |
