...
| Méthode                                         | Description                                                                                               |
|:-----------------------------------------------|:----------------------------------------------------------------------------------------------------------|
| [**Supprimés**](revoke-win32-tsissuedlicense.md) | Révoque les licences d’accès client des services Bureau à distance qui sont représentées par l’objet **Win32 \_ TSIssuedLicense** .<br/> |
