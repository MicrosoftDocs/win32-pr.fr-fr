...
L’interface **IMsRdpClient4** hérite de [**IMsRdpClient3**](imsrdpclient3.md). **IMsRdpClient4** a également les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

L’interface **IMsRdpClient4** possède les propriétés suivantes.
...
L’interface **IMsRdpClient4** a été étendue par les interfaces suivantes, chaque nouvelle interface héritant de toutes les méthodes et propriétés des interfaces précédentes :
...
| IID<br/>                      | IID \_ IMsRdpClient4 est défini en tant que 095E0738-D97D-488b-B9F6-DD0E8D66C0DE<br/>                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
