...
ms.locfileid: "119137432"
---
# <a name="win32_tsvm-class"></a>\_Classe TSVm Win32

Représente une machine virtuelle Bureau à distance.
...
La classe **Win32 \_ TSVm** possède les types de membres suivants :
...
La classe **Win32 \_ TSVm** possède ces méthodes.



| Méthode                                                                | Description                                              |
|:----------------------------------------------------------------------|:---------------------------------------------------------|
| [**DumpVmInfo**](dumpvminfo-win32-tsvm.md)                           | À des fins de test uniquement.<br/>                       |
| [**Exporter**](export-win32-tsvm.md)                                   | Obtient les informations de surveillance de session de la machine virtuelle<br/> |
| [**QueryOfflineInformation**](queryofflineinformation-win32-tsvm.md) | Interroge les propriétés uniquement lorsqu’il est hors connexion.<br/>   |
...
La classe **Win32 \_ TSVm** a ces propriétés.
...
Objet BLOB XML qui contient les paramètres d’inversion de l’ordinateur virtuel.
