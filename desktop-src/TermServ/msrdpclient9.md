...
ms.locfileid: "122474545"
---
# <a name="msrdpclient9-class"></a>MsRdpClient9, classe

Contrôle client Microsoft RDP (redistribuable)-version 10
...
**MsRdpClient9** possède les types de membres suivants :
...
La classe **MsRdpClient9** possède ces méthodes.
...
La classe **MsRdpClient9** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient9 est défini en tant que 301B94BA-5D25-4A12-BFFE-3B6E7A616585<br/>      |
