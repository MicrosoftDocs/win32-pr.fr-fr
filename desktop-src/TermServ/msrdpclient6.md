...
---
# <a name="msrdpclient6-class"></a>MsRdpClient6, classe
...
**MsRdpClient6** possède les types de membres suivants :
...
La classe **MsRdpClient6** possède ces méthodes.
...
La classe **MsRdpClient6** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient6 est défini en tant que 7390F3D8-0439-4C05-91E3-CF5CB290C3D0<br/>      |
