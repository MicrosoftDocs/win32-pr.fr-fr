...
ms.locfileid: "119421689"
---
# <a name="win32_tsapplicationfileextensions-class"></a>\_Classe TSApplicationFileExtensions Win32

Décrit les extensions de nom de fichier qui sont gérées par une application sur un serveur hôte de session Bureau à distance (hôte de session Bureau à distance).
...
La classe **Win32 \_ TSApplicationFileExtensions** possède les types de membres suivants :
...
La classe **Win32 \_ TSApplicationFileExtensions** possède ces méthodes.



| Méthode                                                                         | Description                                                                                |
|:-------------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------|
| [**FileAssociations**](fileassociations-win32-tsapplicationfileextensions.md) | Analyse le registre pour obtenir les associations de fichiers actuelles pour une application.<br/>     |
| [**FileExtensions**](fileextensions-win32-tsapplicationfileextensions.md)     | Fournit une liste des extensions de nom de fichier qui sont gérées par une application.<br/> |
...
La classe **Win32 \_ TSApplicationFileExtensions** a ces propriétés.
