...
ms.locfileid: "122465466"
---
# <a name="msrdpclient10-class"></a>MsRdpClient10, classe

Contrôle client Microsoft RDP (redistribuable)-version 11
...
**MsRdpClient10** possède les types de membres suivants :
...
La classe **MsRdpClient10** possède ces méthodes.
...
La classe **MsRdpClient10** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient10 est défini en tant que C0EFA91A-EEB7-41C7-97FA-F0ED645EFB24<br/>     |
