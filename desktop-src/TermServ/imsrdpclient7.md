...
description: Fournit les méthodes et les propriétés nécessaires à la configuration et à l’utilisation du contrôle client. Dérive de l’interface IMsRdpClient6.
ms.assetid: f6bc5d50-f16a-44be-8244-5aec13c52066
ms.tgt_platform: multiple
keywords:
- Services Bureau à distance de l’interface IMsRdpClient7
- Services Bureau à distance de l’interface IMsRdpClient7, Description
topic_type:
- apiref
api_name:
- IMsRdpClient7
...
L’interface **IMsRdpClient7** hérite de [**IMsRdpClient6**](imsrdpclient6.md). **IMsRdpClient7** a également les types de membres suivants :
...
L’interface **IMsRdpClient7** possède ces méthodes.
...
L’interface **IMsRdpClient7** possède les propriétés suivantes.



| Propriété                                                                  | Type d’accès          | Description                                                                                                                |
|:--------------------------------------------------------------------------|:---------------------|:---------------------------------------------------------------------------------------------------------------------------|
| [**AdvancedSettings8**](imsrdpclient7-advancedsettings8.md)<br/>   | Lecture seule<br/> | Objet qui prend en charge l’interface [**IMsRdpClientAdvancedSettings7**](imsrdpclientadvancedsettings7.md) .<br/>   |
| [**RemoteProgram2**](imsrdpclient7-remoteprogram2.md)<br/>         | Lecture seule<br/> | Objet qui prend en charge l’interface [**ITSRemoteProgram2**](itsremoteprogram2.md) .<br/>                           |
| [**SecuredSettings3**](imsrdpclient7-securedsettings3.md)<br/>     | Lecture seule<br/> | Objet qui prend en charge l’interface [**IMsRdpClientSecuredSettings2**](imsrdpclientsecuredsettings2.md) .<br/>     |
| [**TransportSettings3**](imsrdpclient7-transportsettings3.md)<br/> | Lecture seule<br/> | Objet qui prend en charge l’interface [**IMsRdpClientTransportSettings3**](imsrdpclienttransportsettings3.md) .<br/> |
...
L’interface **IMsRdpClient7** a été étendue par les interfaces suivantes, chaque nouvelle interface héritant de toutes les méthodes et propriétés des interfaces précédentes :
