...
ms.locfileid: "126919692"
---
# <a name="msrdpclient7-class"></a>MsRdpClient7, classe
...
**MsRdpClient7** possède les types de membres suivants :
...
La classe **MsRdpClient7** possède ces méthodes.
...
La classe **MsRdpClient7** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient7 est défini en tant que A9D7038D-B5ED-472E-9C47-94BEA90A5910<br/>      |
