---
title: Exemple de module de serveur DVC
description: Exemple de code C++ qui montre comment créer le module de canal virtuel dynamique côté serveur (DVC).
...
ms.locfileid: "104196671"
---
# <a name="dvc-server-module-example"></a><span data-ttu-id="1eaa1-103">Exemple de module de serveur DVC</span><span class="sxs-lookup"><span data-stu-id="1eaa1-103">DVC Server Module Example</span></span>

<span data-ttu-id="1eaa1-104">L’exemple de code C++ suivant fournit un exemple de création du module de canal virtuel dynamique (DVC) côté serveur.</span><span class="sxs-lookup"><span data-stu-id="1eaa1-104">The following C++ code sample provides an example of how to create the server-side dynamic virtual channel (DVC) module.</span></span>
