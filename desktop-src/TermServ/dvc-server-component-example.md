...
---
# <a name="dvc-server-module-example"></a>Exemple de module de serveur DVC

L’exemple de code C++ suivant fournit un exemple de création du module de canal virtuel dynamique (DVC) côté serveur.
