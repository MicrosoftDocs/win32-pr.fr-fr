...
---
# <a name="imstscnonscriptablebinarysalt-property"></a>IMsTscNonScriptable :: BinarySalt, propriété
...
Nouvelle partie Salt binaire pour un mot de passe encodé binaire.
