...
La classe WMI de **\_ Terminal Win32** représente un terminal.
...
La classe de **\_ Terminal Win32** possède les types de membres suivants :
...
La classe de **\_ Terminal Win32** possède ces méthodes.
...
La classe de **\_ Terminal Win32** possède ces propriétés.
...
Spécifie si le terminal spécifié est désactivé ou activé.
...
Nombre de sessions de connexion pour le terminal.
...
Nom unique qui identifie l’instance du terminal.
