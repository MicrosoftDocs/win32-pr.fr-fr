---
title: MsRdpClient4, classe
description: Contrôle client Microsoft RDP (redistribuable)-version 5.
ms.assetid: 3F238C63-E860-4F27-B3D6-29F03B22E49E
ms.tgt_platform: multiple
keywords:
- Services Bureau à distance de la classe MsRdpClient4
- Services Bureau à distance de la classe MsRdpClient4, Description
topic_type:
- apiref
api_name:
- MsRdpClient4
...
ms.locfileid: "126919711"
---
# <a name="msrdpclient4-class"></a>MsRdpClient4, classe
...
**MsRdpClient4** possède les types de membres suivants :
...
La classe **MsRdpClient4** possède ces méthodes.
...
La classe **MsRdpClient4** possède les propriétés suivantes.
...
| CLSID<br/>                    | Le CLSID \_ MsRdpClient4 est défini en tant que 4EDCB26C-D24C-4E72-af07-B576699AC0DE<br/>      |
