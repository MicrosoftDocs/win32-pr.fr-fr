...
ms.locfileid: "120080039"
---
# <a name="imsrdpclient7remoteprogram2-property"></a>IMsRdpClient7 :: RemoteProgram2, propriété

Récupère un objet qui prend en charge l’interface [**ITSRemoteProgram2**](itsremoteprogram2.md) .
...
Adresse d’un pointeur d’interface [**ITSRemoteProgram2**](itsremoteprogram2.md) qui reçoit l’objet.
