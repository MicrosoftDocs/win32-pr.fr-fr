...
La classe **Win32 \_ RDCentralPublishedDeploymentSettings** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ RDCentralPublishedDeploymentSettings** a ces propriétés.
...
**true** pour autoriser le lissage des polices ; Sinon, **false**.
...
Certificat utilisé pour signer les fichiers RDP ; nécessairement uniquement si *HasCertificate* a la valeur true.
...
Contient la profondeur de bit de couleur :
...
Contient le contenu du fichier RDP correspondant aux paramètres RDP personnalisés.
...
Contient le contenu du fichier RDP correspondant aux paramètres de déploiement. Si ce paramètre est défini, le système utilise ce fichier RDP et ignore les autres paramètres RDP de cet appel.
...
Contient le mode d’authentification de la passerelle :

<dt>

<span id="Password_0_"></span><span id="password_0_"></span><span id="PASSWORD_0_"></span>

<span id="Password_0_"></span><span id="password_0_"></span><span id="PASSWORD_0_"></span>**Mot de passe (0)** (0)
...
<span id="Smartcard_1_"></span><span id="smartcard_1_"></span><span id="SMARTCARD_1_"></span>**Carte à puce (1)** (1)
...
<span id="Allow_User_to_Choose_4_"></span><span id="allow_user_to_choose_4_"></span><span id="ALLOW_USER_TO_CHOOSE_4_"></span>**Autoriser l’utilisateur à choisir (4)** (4)
...
Décrit l’utilisation de la passerelle :
...
Utilisez la passerelle Pass-the-local.
...
**true** pour utiliser les mêmes informations d’identification utilisateur pour la passerelle TS et le serveur TS dans la mesure du possible ; Sinon, **false**.
...
**true** pour utiliser un certificat pour signer les fichiers RDP ; Sinon, **false**.
...
Alias de la batterie de serveurs qui a publié l’application.
...
**true** pour activer multi-Monitor pour le bureau (et non rail); Sinon, **false**.
