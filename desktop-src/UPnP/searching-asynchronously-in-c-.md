...
---
# <a name="searching-asynchronously-in-c"></a>Recherche asynchrone en C++

Le code suivant peut être utilisé comme base pour une application C++ qui recherche des appareils de manière asynchrone. Le code implémente l’interface [**IUPnPDeviceFinderCallback**](/windows/desktop/api/Upnp/nn-upnp-iupnpdevicefindercallback) en créant une classe qui hérite de celle-ci.

Pour implémenter à la fois [**IUPnPDeviceFinderCallback**](/windows/desktop/api/Upnp/nn-upnp-iupnpdevicefindercallback) et [**IUPnPDeviceFinderAddCallbackWithInterface**](/windows/desktop/api/Upnp/nn-upnp-iupnpdevicefinderaddcallbackwithinterface), la classe doit hériter des deux interfaces. L’implémentation de **IUPnPDeviceFinderAddCallbackWithInterface** est facultative, mais si vous choisissez de l’implémenter, vous devez également implémenter **IUPnPDeviceFinderCallback**.
