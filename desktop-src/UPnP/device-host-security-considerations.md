...
Cela augmente le risque pour les particuliers, car les appareils tels qu’un lecteur multimédia ou un système de climatisation ou un appareil HVAC hébergé sur un ordinateur exécutant Windows XP sont visibles et peuvent être contrôlés à partir des points de contrôle en dehors de la famille.
...
-   L’inscription d’un appareil non en cours d’exécution nécessite la pré-inscription de l’appareil. dll auprès de COM, ce qui nécessite des privilèges d’administrateur.
