...
Par défaut, la journalisation est désactivée pour NPS. Pour l’activer, exécutez le composant logiciel enfichable du serveur de stratégie réseau (NPS. msc) ou le composant logiciel enfichable du service d’authentification Internet (IAS. msc) et suivez les instructions de la page comptabilité.
