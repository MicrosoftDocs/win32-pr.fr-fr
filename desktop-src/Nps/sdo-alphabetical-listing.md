...
ms.locfileid: "120074279"
---
# <a name="alphabetical-listing"></a>Liste alphabétique

Cette rubrique répertorie les types d’énumération SDO par ordre alphabétique.
...
-   [**TYPE d’authentification \_**](/windows/desktop/api/SdoIas/ne-sdoias-authentication_type)
-   [**Propriétés du client**](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
...
-   [**TYPE d’identité \_**](/windows/desktop/api/sdoias/ne-sdoias-identity_type)
...
-   [**nouvelle \_ \_ fréquence des fichiers journaux \_**](/windows/desktop/api/sdoias/ne-sdoias-new_log_file_frequency)
...
-   [**TYPE de SERVICE \_**](/windows/desktop/api/sdoias/ne-sdoias-service_type)
-   [**\_type de combinaison SHV \_**](/windows/desktop/api/sdoias/ne-sdoias-shv_combination_type)
