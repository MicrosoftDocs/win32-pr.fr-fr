---
title: Création d’une stratégie de demande de connexion
description: Création d’une stratégie de demande de connexion
...
---
# <a name="creating-a-connection-request-policy"></a><span data-ttu-id="f12d2-103">Création d’une stratégie de demande de connexion</span><span class="sxs-lookup"><span data-stu-id="f12d2-103">Creating a Connection Request Policy</span></span>

<span data-ttu-id="f12d2-104">Le code Visual Basic suivant crée une stratégie de demande de connexion.</span><span class="sxs-lookup"><span data-stu-id="f12d2-104">The following Visual Basic code creates a connection request policy.</span></span> <span data-ttu-id="f12d2-105">Elle ajoute une condition à la stratégie qui correspond au nom de l’utilisateur qui demande l’accès.</span><span class="sxs-lookup"><span data-stu-id="f12d2-105">It adds a condition to the policy that matches on the name of the user requesting access.</span></span> <span data-ttu-id="f12d2-106">Elle lie la stratégie à un profil.</span><span class="sxs-lookup"><span data-stu-id="f12d2-106">It links the policy to a profile.</span></span> <span data-ttu-id="f12d2-107">Il configure ce profil pour utiliser RADIUS pour l’authentification et la gestion des comptes, et spécifie les groupes de serveurs que le profil doit utiliser pour l’authentification et la gestion des comptes.</span><span class="sxs-lookup"><span data-stu-id="f12d2-107">It configures that profile to use RADIUS for both authentication and accounting, and specifies the server groups that the profile should use for authentication and accounting.</span></span>

> [!Note]  
> <span data-ttu-id="f12d2-108">Cet exemple de code en ligne a été créé sur des Visual Basic gérés.</span><span class="sxs-lookup"><span data-stu-id="f12d2-108">This in-line code sample has been built on managed Visual Basic.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="f12d2-109">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="f12d2-109">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="f12d2-110">Ordre dans lequel utiliser l’API SDO</span><span class="sxs-lookup"><span data-stu-id="f12d2-110">Order in Which to Use the SDO API</span></span>](/windows/desktop/Nps/sdo-order-in-which-to-use-the-sdo-api)
</dt> <dt>

[<span data-ttu-id="f12d2-111">Attributs pris en charge par SDO</span><span class="sxs-lookup"><span data-stu-id="f12d2-111">SDO Supported Attributes</span></span>](/windows/desktop/Nps/sdo-sdo-supported-attributes)
</dt> <dt>

[<span data-ttu-id="f12d2-112">**ISdo**</span><span class="sxs-lookup"><span data-stu-id="f12d2-112">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="f12d2-113">**ISdoCollection**</span><span class="sxs-lookup"><span data-stu-id="f12d2-113">**ISdoCollection**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdocollection)
</dt> <dt>

[<span data-ttu-id="f12d2-114">**ISdoDictionaryOld**</span><span class="sxs-lookup"><span data-stu-id="f12d2-114">**ISdoDictionaryOld**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdodictionaryold)
</dt> <dt>

[<span data-ttu-id="f12d2-115">**IASPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="f12d2-115">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="f12d2-116">**POLICYPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="f12d2-116">**POLICYPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-policyproperties)
</dt> <dt>

[<span data-ttu-id="f12d2-117">**PROFILEPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="f12d2-117">**PROFILEPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-profileproperties)
</dt> </dl>
