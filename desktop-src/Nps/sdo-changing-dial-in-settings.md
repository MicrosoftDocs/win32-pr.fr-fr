---
title: Modification des paramètres de numérotation
description: Modification des paramètres de numérotation
...
ms.locfileid: "106509659"
---
# <a name="changing-dial-in-settings"></a><span data-ttu-id="04fa9-103">Modification des paramètres de numérotation</span><span class="sxs-lookup"><span data-stu-id="04fa9-103">Changing Dial-In Settings</span></span>

<span data-ttu-id="04fa9-104">Le code VBScript suivant définit le bit de numérotation et le numéro de rappel pour un utilisateur.</span><span class="sxs-lookup"><span data-stu-id="04fa9-104">The following VBScript code sets the dial-in bit and callback number for a user.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="04fa9-105">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="04fa9-105">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="04fa9-106">**Propriétés du client**</span><span class="sxs-lookup"><span data-stu-id="04fa9-106">**CLIENTPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-clientproperties)
</dt> <dt>

[<span data-ttu-id="04fa9-107">Énumération d’objets dans une collection</span><span class="sxs-lookup"><span data-stu-id="04fa9-107">Enumerating Objects in a Collection</span></span>](/windows/desktop/Nps/sdo-enumerating-objects-in-a-collection)
</dt> <dt>

[<span data-ttu-id="04fa9-108">**IASPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="04fa9-108">**IASPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-iasproperties)
</dt> <dt>

[<span data-ttu-id="04fa9-109">**ISdo**</span><span class="sxs-lookup"><span data-stu-id="04fa9-109">**ISdo**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdo)
</dt> <dt>

[<span data-ttu-id="04fa9-110">**ISdoMachine**</span><span class="sxs-lookup"><span data-stu-id="04fa9-110">**ISdoMachine**</span></span>](/windows/desktop/api/sdoias/nn-sdoias-isdomachine)
</dt> <dt>

[<span data-ttu-id="04fa9-111">**RADIUSPROPERTIES**</span><span class="sxs-lookup"><span data-stu-id="04fa9-111">**RADIUSPROPERTIES**</span></span>](/windows/desktop/api/sdoias/ne-sdoias-radiusproperties)
</dt> </dl>
