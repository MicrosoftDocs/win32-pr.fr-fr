...
ms.locfileid: "119056807"
---
# <a name="ivmvirtualmachinenetworkadapters-property"></a>IVMVirtualMachine :: NetworkAdapters, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère une collection énumérable de cartes réseau attachées à la machine virtuelle.
...
Objet [**IVMNetworkAdapterCollection**](ivmnetworkadaptercollection.md) .
