...
ms.locfileid: "117752072"
---
# <a name="ivmvirtualmachineundoable-property"></a>IVMVirtualMachine :: Undoable, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Détermine si les disques d’annulations sont activés pour les disques durs connectés à la machine virtuelle.
...
Spécifie la **\_ valeur variant true** si les lecteurs d’annulations sont activés pour les disques durs connectés à la machine virtuelle et la **variante \_ false** dans le cas contraire.
...
| <dl> <dt>Ordinateur virtuel \_ E/r 0xA0040302 \_ \_ \_ active VM</dt> <dt></dt> </dl> | La machine virtuelle est en cours d’exécution ou enregistrée.<br/>       |



## <a name="remarks"></a>Remarques

Si les lecteurs d’annulations sont désactivés, tous les fichiers de lecteur d’annulation existants seront supprimés.

Vous ne pouvez pas définir cette propriété si la machine virtuelle est en cours d’exécution ou enregistrée.
