...
ms.locfileid: "118122629"
---
# <a name="ivmvirtualnetworknetworkadapters-property"></a>IVMVirtualNetwork :: NetworkAdapters, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère une collection énumérable de cartes réseau attachées au réseau virtuel.
...
Nouveau [**IVMNetworkAdapterCollection**](ivmnetworkadaptercollection.md) qui contient les cartes réseau virtuelles attachées à ce réseau virtuel.
