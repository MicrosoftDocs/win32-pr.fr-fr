...
ms.locfileid: "118123716"
---
# <a name="ivmhostinfophysicalprocessorcount-property"></a>IVMHostInfo ::P propriété hysicalProcessorCount

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère le nombre de processeurs physiques sur l’ordinateur hôte.
