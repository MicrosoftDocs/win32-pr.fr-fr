...
ms.locfileid: "119512129"
---
# <a name="ivmhostinfologicalprocessorcount-property"></a>IVMHostInfo :: LogicalProcessorCount, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère le nombre de processeurs logiques de l’ordinateur hôte.
