...
ms.locfileid: "118591749"
---
# <a name="ivmvirtualpcmaximumserialportspervm-property"></a>IVMVirtualPC :: MaximumSerialPortsPerVM, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère le nombre maximal de ports série par ordinateur virtuel.
...
Nombre maximal de ports série par ordinateur virtuel.
