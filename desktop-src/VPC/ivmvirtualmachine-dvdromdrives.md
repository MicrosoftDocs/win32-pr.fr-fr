...
ms.locfileid: "119471819"
---
# <a name="ivmvirtualmachinedvdromdrives-property"></a>IVMVirtualMachine ::D propriété VDROMDrives

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère une collection énumérable de lecteurs de CD et de DVD attachés à la machine virtuelle.
...
Objet [**IVMDVDDriveCollection**](ivmdvddrivecollection.md) .
