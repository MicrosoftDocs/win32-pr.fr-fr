...
---
# <a name="ivmvirtualmachinehassse-property"></a>IVMVirtualMachine :: HasSSE, propriété
...
**True** si le processeur prend en charge le jeu d’instructions SSE, sinon **false** .
