...
ms.locfileid: "117752231"
---
# <a name="ivmvirtualmachinesavedstatefilepath-property"></a>IVMVirtualMachine :: SavedStateFilePath, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère le chemin d’accès complet au fichier d’état enregistré.
...
Chemin d’accès complet au fichier d’état enregistré de l’ordinateur virtuel.
...
| <dl> <dt>Ordinateur virtuel \_ E \_ VM \_ sans \_ \_ état enregistré</dt> <dt>0xA00400501</dt> </dl> | Aucun fichier d’état enregistré n’est associé à l’ordinateur virtuel.<br/> |
