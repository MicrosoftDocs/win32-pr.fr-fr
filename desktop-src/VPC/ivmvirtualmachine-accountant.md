...
ms.locfileid: "118998699"
---
# <a name="ivmvirtualmachineaccountant-property"></a>IVMVirtualMachine :: comptable, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère un comptable pour cette machine virtuelle.
...
Objet [**IVMAccountant**](ivmaccountant.md) .
