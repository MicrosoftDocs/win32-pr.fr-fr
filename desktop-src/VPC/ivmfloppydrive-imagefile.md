...
ms.locfileid: "118595119"
---
# <a name="ivmfloppydriveimagefile-property"></a>IVMFloppyDrive :: image, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère le chemin d’accès complet du fichier image auquel le lecteur de disquette est attaché.
...
Chemin d’accès complet du fichier image.
