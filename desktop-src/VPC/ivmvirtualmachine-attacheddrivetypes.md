...
ms.locfileid: "118123208"
---
# <a name="ivmvirtualmachineattacheddrivetypes-property"></a>IVMVirtualMachine :: AttachedDriveTypes, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère un tableau indiquant le type de lecteur attaché à chaque emplacement de la machine virtuelle.
...
Variante de type VT **de \_ tableau** VT \| contenant des entrées de type **VT \_ UI1**. **\_** Le tableau contient la valeur [**VMDriveType**](vmdrivetype.md) de chaque appareil connecté à chaque emplacement de bus. Le tableau est trié par \[ *busNumber* \] \[ *deviceID* \] .
