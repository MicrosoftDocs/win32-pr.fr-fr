...
ms.locfileid: "117753291"
---
# <a name="ivmhostinfonetworkaddresses-property"></a>IVMHostInfo :: NetworkAddresses, propriété

\[Windows Virtual PC ne peut plus être utilisé à partir de Windows 8. Au lieu de cela, utilisez le [fournisseur WMI Hyper-V (v2)](/windows/desktop/HyperV_v2/windows-virtualization-portal).\]

Récupère une collection énumérable d’adresses TCP/IP sur l’ordinateur hôte.
...
Tableau d’adresses TCP/IP, en notation décimale séparée par des points.
