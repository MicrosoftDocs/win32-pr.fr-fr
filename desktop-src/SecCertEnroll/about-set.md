...
Un **jeu** contient une série non triée de champs d’un ou de plusieurs types. Elle est encodée dans un triplet TLV qui commence par un octet **tag** de 0x31. L’exemple suivant, adapté de la rubrique [ASN. 1 encodée par CMC](cmc-encoded-asn-1.md) , montre comment un attribut **ClientID** est encodé dans une structure de données **Set** . L’attribut peut être spécifié à l’aide de l’interface [**IX509AttributeClientId**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509attributeclientid) .
