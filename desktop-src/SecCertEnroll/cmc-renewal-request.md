...
---
# <a name="cmc-renewal-request"></a><span data-ttu-id="d06cb-105">Demande de renouvellement CMC</span><span class="sxs-lookup"><span data-stu-id="d06cb-105">CMC Renewal Request</span></span>

<span data-ttu-id="d06cb-106">L’exemple suivant contient une demande de renouvellement CMC.</span><span class="sxs-lookup"><span data-stu-id="d06cb-106">The following example contains a CMC renewal request.</span></span> <span data-ttu-id="d06cb-107">L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="d06cb-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="d06cb-108">Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.</span><span class="sxs-lookup"><span data-stu-id="d06cb-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="d06cb-109">La configuration spécifie le type de demande (CMC) et le numéro de série du certificat sur lequel la demande est basée.</span><span class="sxs-lookup"><span data-stu-id="d06cb-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="d06cb-110">Cela génère la sortie suivante.</span><span class="sxs-lookup"><span data-stu-id="d06cb-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="d06cb-111">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="d06cb-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="d06cb-112">Exemples de demandes</span><span class="sxs-lookup"><span data-stu-id="d06cb-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
