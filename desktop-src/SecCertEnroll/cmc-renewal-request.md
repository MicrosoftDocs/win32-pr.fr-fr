---
description: L’exemple suivant contient une demande de renouvellement CMC. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
ms.assetid: 45b8e5f1-93e0-4216-945a-221a22acfd68
title: Demande de renouvellement CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119670329"
---
# <a name="cmc-renewal-request"></a>Demande de renouvellement CMC

L’exemple suivant contient une demande de renouvellement CMC. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
