---
description: L’exemple suivant contient une \# demande d’inscription PKCS 7 pour le compte de (EOBO). L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
ms.assetid: e9e54f26-223d-493a-b4d5-ca7c2bd22756
title: '\#Demande EOBO PKCS 7'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "117774574"
---
# <a name="pkcs-7-eobo-request"></a>\#Demande EOBO PKCS 7

L’exemple suivant contient une \# demande d’inscription PKCS 7 pour le compte de (EOBO). L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
