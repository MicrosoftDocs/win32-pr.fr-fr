...
---
# <a name="cmc-request"></a><span data-ttu-id="8b7fd-105">Demande CMC</span><span class="sxs-lookup"><span data-stu-id="8b7fd-105">CMC Request</span></span>

<span data-ttu-id="8b7fd-106">L’exemple suivant contient une demande de certificat CMC.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-106">The following example contains a CMC certificate request.</span></span> <span data-ttu-id="8b7fd-107">L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="8b7fd-108">Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="8b7fd-109">Cette configuration génère l’exemple de sortie suivant.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-109">This configuration generates the following sample output.</span></span> <span data-ttu-id="8b7fd-110">La configuration spécifie l’objet, le type de demande (CMC) et le modèle de certificat (utilisateur).</span><span class="sxs-lookup"><span data-stu-id="8b7fd-110">The configuration specifies the subject, type of request (CMC), and certificate template (User).</span></span> <span data-ttu-id="8b7fd-111">Le modèle utilisateur spécifie que :</span><span class="sxs-lookup"><span data-stu-id="8b7fd-111">The User template specifies that:</span></span>

-   <span data-ttu-id="8b7fd-112">La demande doit utiliser le fournisseur de services de chiffrement de base Microsoft 1,0 ou le fournisseur de services de chiffrement amélioré Microsoft 1,0.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-112">The request must use either the Microsoft Base Cryptographic Provider 1.0 or the Microsoft Enhanced Cryptographic Provider 1.0.</span></span>
-   <span data-ttu-id="8b7fd-113">Le nom du sujet doit être généré à partir de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-113">The subject name must be built from Active Directory.</span></span>
-   <span data-ttu-id="8b7fd-114">La demande comprend le nom du modèle de certificat, l’utilisation améliorée de la clé (EKU) et les extensions d’utilisation de la clé.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-114">The request includes the Certificate Template Name, Enhanced Key Usage (EKU), and Key Usage extensions.</span></span> <span data-ttu-id="8b7fd-115">L’extension EKU spécifie que le certificat émis peut être utilisé pour le système de fichiers EFS (EFS), la messagerie sécurisée et l’authentification du client.</span><span class="sxs-lookup"><span data-stu-id="8b7fd-115">The EKU extension specifies that the issued certificate can be used for Encrypting File System (EFS), secure email, and client authentication.</span></span>

<span data-ttu-id="8b7fd-116">Une demande de certificat CMC est représentée par l’interface [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) .</span><span class="sxs-lookup"><span data-stu-id="8b7fd-116">A CMC certificate request is represented by the [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) interface.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="8b7fd-117">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="8b7fd-117">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="8b7fd-118">Exemples de demandes</span><span class="sxs-lookup"><span data-stu-id="8b7fd-118">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
