---
description: L’exemple suivant contient une demande de certificat CMC. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
...
ms.locfileid: "119670339"
---
# <a name="cmc-request"></a>Demande CMC

L’exemple suivant contient une demande de certificat CMC. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
...
Une demande de certificat CMC est représentée par l’interface [**IX509CertificateRequestCmc**](/windows/desktop/api/CertEnroll/nn-certenroll-ix509certificaterequestcmc) .
