---
description: L’exemple suivant contient une demande de renouvellement CMC présentée dans le format ASN. 1. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
ms.assetid: acb0fdeb-3d7b-4598-bb7a-df97e200984b
title: Renouvellement ASN encodé ASN. 1
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104203997"
---
# <a name="cmc-renewal-encoded-asn1"></a>Renouvellement ASN encodé ASN. 1

L’exemple suivant contient une demande de renouvellement CMC présentée dans le format ASN. 1. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
...
La configuration spécifie le type de demande (CMC) et le numéro de série du certificat sur lequel la demande est basée. Cela génère la sortie suivante.
