...
---
# <a name="cmc-renewal-encoded-asn1"></a><span data-ttu-id="3ff18-105">Renouvellement ASN encodé ASN. 1</span><span class="sxs-lookup"><span data-stu-id="3ff18-105">CMC Renewal Encoded ASN.1</span></span>

<span data-ttu-id="3ff18-106">L’exemple suivant contient une demande de renouvellement CMC présentée dans le format ASN. 1.</span><span class="sxs-lookup"><span data-stu-id="3ff18-106">The following example contains a CMC renewal request shown in ASN.1 format.</span></span> <span data-ttu-id="3ff18-107">L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe.</span><span class="sxs-lookup"><span data-stu-id="3ff18-107">The example was generated by using the Certreq.exe and Certutil.exe tools.</span></span> <span data-ttu-id="3ff18-108">Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.</span><span class="sxs-lookup"><span data-stu-id="3ff18-108">The .inf file used as input to Certreq.exe contains the following configuration.</span></span>
...
<span data-ttu-id="3ff18-109">La configuration spécifie le type de demande (CMC) et le numéro de série du certificat sur lequel la demande est basée.</span><span class="sxs-lookup"><span data-stu-id="3ff18-109">The configuration specifies the type of request (CMC) and the serial number of the certificate upon which the request is based.</span></span> <span data-ttu-id="3ff18-110">Cela génère la sortie suivante.</span><span class="sxs-lookup"><span data-stu-id="3ff18-110">This generates the following output.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="3ff18-111">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="3ff18-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="3ff18-112">Exemples de demandes</span><span class="sxs-lookup"><span data-stu-id="3ff18-112">Sample Requests</span></span>](sample-requests.md)
</dt> </dl>
