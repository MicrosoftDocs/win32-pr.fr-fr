---
description: L’exemple suivant contient une demande d’inscription CMC pour le compte de (EOBO). L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
ms.assetid: 05ec0b2c-56a5-4d9c-999b-23324134153b
title: Demande EOBO CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103758068"
---
# <a name="cmc-eobo-request"></a>Demande EOBO CMC

L’exemple suivant contient une demande d’inscription CMC pour le compte de (EOBO). L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
