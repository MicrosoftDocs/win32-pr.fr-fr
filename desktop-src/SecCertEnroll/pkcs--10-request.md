---
description: L’exemple suivant contient une \# demande PKCS 10. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
ms.assetid: a71cd259-e5b0-42ee-a26c-fd949386ff9d
title: '\#Demande PKCS 10'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "127121138"
---
# <a name="pkcs-10-request"></a>\#Demande PKCS 10

L’exemple suivant contient une \# demande PKCS 10. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
...
Cette configuration génère l’exemple de sortie suivant. La configuration spécifie l’objet, le type de demande (PKCS \# 10) et le modèle de certificat (utilisateur). Le modèle utilisateur spécifie que :
