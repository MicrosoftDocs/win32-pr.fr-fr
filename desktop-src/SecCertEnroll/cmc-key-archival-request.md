---
description: L’exemple suivant contient une demande d’archivage de clé CMC. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
ms.assetid: e418ef57-90de-4374-b607-52823bbdd429
title: Demande d’archivage de clé CMC
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106521863"
---
# <a name="cmc-key-archival-request"></a>Demande d’archivage de clé CMC

L’exemple suivant contient une demande d’archivage de clé CMC. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
