...
ms.locfileid: "119993589"
---
# <a name="key-generation-encoded-asn1"></a>Génération de clé ASN. 1

L’exemple suivant contient une demande de génération de clé indiquée dans le format ASN. 1.
