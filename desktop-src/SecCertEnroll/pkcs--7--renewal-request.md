---
description: L’exemple suivant contient une \# demande de renouvellement PKCS 7. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
...
ms.locfileid: "106523363"
---
# <a name="pkcs-7-renewal-request"></a>\#Demande de renouvellement PKCS 7

L’exemple suivant contient une \# demande de renouvellement PKCS 7. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
