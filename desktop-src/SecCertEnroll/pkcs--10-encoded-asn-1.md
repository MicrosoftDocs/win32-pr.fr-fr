---
description: L’exemple suivant contient une \# demande PKCS 10 indiquée dans le format ASN. 1. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
...
ms.locfileid: "104210911"
---
# <a name="pkcs-10-encoded-asn1"></a>\#ASN 10 codé ASN. 1

L’exemple suivant contient une \# demande PKCS 10 indiquée dans le format ASN. 1. L’exemple a été généré à l’aide des outils Certreq.exe et Certutil.exe. Le fichier. inf utilisé comme entrée pour Certreq.exe contient la configuration suivante.
