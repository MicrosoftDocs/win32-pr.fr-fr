...
---
# <a name="cc-tracelogging-examples"></a><span data-ttu-id="f8069-103">Exemples de Tracelogging C/C++</span><span class="sxs-lookup"><span data-stu-id="f8069-103">C/C++ Tracelogging Examples</span></span>

<span data-ttu-id="f8069-104">Cette rubrique contient des exemples Tracelogging C/C++.</span><span class="sxs-lookup"><span data-stu-id="f8069-104">This topic contains C/C++ Tracelogging examples.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="f8069-105">Liez advapi32. lib lors de la compilation de ces exemples.</span><span class="sxs-lookup"><span data-stu-id="f8069-105">Link advapi32.lib when compiling these examples.</span></span>

 

-   [<span data-ttu-id="f8069-106">Consigner les types de données intrinsèques</span><span class="sxs-lookup"><span data-stu-id="f8069-106">Log intrinsic data types</span></span>](#log-intrinsic-data-types)
-   [<span data-ttu-id="f8069-107">Champs d’événement de nom</span><span class="sxs-lookup"><span data-stu-id="f8069-107">Name event fields</span></span>](#name-event-fields)
-   [<span data-ttu-id="f8069-108">Niveau de détail des événements de journal</span><span class="sxs-lookup"><span data-stu-id="f8069-108">Log events verbosity level</span></span>](#log-event-verbosity-level)
-   [<span data-ttu-id="f8069-109">Mots clés des événements de journal</span><span class="sxs-lookup"><span data-stu-id="f8069-109">Log events keywords</span></span>](#log-event-keywords)
-   [<span data-ttu-id="f8069-110">Données d’événement de tableau de journaux</span><span class="sxs-lookup"><span data-stu-id="f8069-110">Log array event data</span></span>](#log-array-event-data)
-   [<span data-ttu-id="f8069-111">Données d’événement de structure de journal</span><span class="sxs-lookup"><span data-stu-id="f8069-111">Log structure event data</span></span>](#log-structure-event-data)

### <a name="log-intrinsic-data-types"></a><span data-ttu-id="f8069-112">Consigner les types de données intrinsèques</span><span class="sxs-lookup"><span data-stu-id="f8069-112">Log intrinsic data types</span></span>

<span data-ttu-id="f8069-113">Cet exemple montre comment enregistrer des types de données intrinsèques, tels que des entiers, des valeurs booléennes, etc.</span><span class="sxs-lookup"><span data-stu-id="f8069-113">This example shows how to log intrinsic data types such as integers, booleans, and so on.</span></span>
...
### <a name="name-event-fields"></a><span data-ttu-id="f8069-114">Champs d’événement de nom</span><span class="sxs-lookup"><span data-stu-id="f8069-114">Name event fields</span></span>

<span data-ttu-id="f8069-115">L’exemple montre comment nommer des champs d’événement.</span><span class="sxs-lookup"><span data-stu-id="f8069-115">The example shows how to name event fields.</span></span>
...
### <a name="log-event-verbosity-level"></a><span data-ttu-id="f8069-116">Niveau de détail des événements de journal</span><span class="sxs-lookup"><span data-stu-id="f8069-116">Log event verbosity level</span></span>

<span data-ttu-id="f8069-117">Cet exemple montre comment enregistrer des événements par niveau de détail.</span><span class="sxs-lookup"><span data-stu-id="f8069-117">This example shows how to log events by verbosity level.</span></span>
...
### <a name="log-event-keywords"></a><span data-ttu-id="f8069-118">Enregistrer les mots clés des événements</span><span class="sxs-lookup"><span data-stu-id="f8069-118">Log event keywords</span></span>

<span data-ttu-id="f8069-119">Cet exemple montre comment définir des mots clés d’événement.</span><span class="sxs-lookup"><span data-stu-id="f8069-119">This example illustrates how to set event keywords.</span></span> <span data-ttu-id="f8069-120">Le filtrage des événements peut être effectué par niveau et par mot clé.</span><span class="sxs-lookup"><span data-stu-id="f8069-120">Event filtering can be done by level and keyword.</span></span> <span data-ttu-id="f8069-121">Par exemple, les événements d’achèvement de scénario ou les événements d’échec peuvent être regroupés sous des mots clés séparés afin que vous puissiez filtrer facilement ces événements.</span><span class="sxs-lookup"><span data-stu-id="f8069-121">For example, scenario completion events or failure events might be grouped under separate keywords so that you can easily filter those events.</span></span>
...
### <a name="log-array-event-data"></a><span data-ttu-id="f8069-122">Données d’événement de tableau de journaux</span><span class="sxs-lookup"><span data-stu-id="f8069-122">Log array event data</span></span>

<span data-ttu-id="f8069-123">Cet exemple montre comment enregistrer des tableaux en tant que données d’événement.</span><span class="sxs-lookup"><span data-stu-id="f8069-123">This example shows how to log arrays as event data.</span></span>
...
### <a name="log-structure-event-data"></a><span data-ttu-id="f8069-124">Données d’événement de structure de journal</span><span class="sxs-lookup"><span data-stu-id="f8069-124">Log structure event data</span></span>

<span data-ttu-id="f8069-125">Cet exemple montre comment enregistrer des données d’événement de structure.</span><span class="sxs-lookup"><span data-stu-id="f8069-125">This example shows how to log structure event data.</span></span>
...
### <a name="how-to-fix-tracelogging-cc-build-errors"></a><span data-ttu-id="f8069-126">Comment corriger les erreurs de build TraceLogging C/C++</span><span class="sxs-lookup"><span data-stu-id="f8069-126">How to fix TraceLogging C/C++ build errors</span></span>

<span data-ttu-id="f8069-127">Erreur de build</span><span class="sxs-lookup"><span data-stu-id="f8069-127">Build Error</span></span>
...
<span data-ttu-id="f8069-128">Fix</span><span class="sxs-lookup"><span data-stu-id="f8069-128">Fix</span></span>

<span data-ttu-id="f8069-129">Corrigez cette erreur en liant advapi32. lib dans votre projet.</span><span class="sxs-lookup"><span data-stu-id="f8069-129">Fix this error by linking advapi32.lib in your project.</span></span>
