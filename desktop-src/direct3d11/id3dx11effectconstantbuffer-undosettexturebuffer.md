...
ms.locfileid: "118989849"
---
# <a name="id3dx11effectconstantbufferundosettexturebuffer-method"></a>ID3DX11EffectConstantBuffer :: UndoSetTextureBuffer, méthode

Restaure une mémoire tampon de texture précédemment définie.
