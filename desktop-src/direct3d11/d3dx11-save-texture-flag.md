...
description: 'remarque : la bibliothèque de l’utilitaire d3dx (d3dx 9, d3dx 10 et d3dx 11) est déconseillée pour Windows 8 et n’est pas prise en charge pour les applications Windows store. Options d’enregistrement de texture.'
...
ms.locfileid: "118989909"
---
# <a name="d3dx11_save_texture_flag-enumeration"></a>D3DX11 \_ l' \_ énumération de l’indicateur de texture Save \_
...
Options d’enregistrement de texture.
