...
Direct3D 11,1 garantit que vous pouvez partager des ressources Texture2D que vous avez créées avec des types de ressources et des formats particuliers. pour partager des ressources Texture2D, utilisez la ressource [**D3D11 \_ \_ misc \_**](/windows/desktop/api/D3D11/ne-d3d11-d3d11_resource_misc_flag)shared resource, [**D3D11 \_ resource \_ misc \_ shared \_ KEYEDMUTEX**](/windows/desktop/api/D3D11/ne-d3d11-d3d11_resource_misc_flag), ou une combinaison des indicateurs D3D11 resource misc **\_ \_ \_ shared \_ KEYEDMUTEX** et [**D3D11 \_ resource \_ misc \_ \_**](/windows/desktop/api/D3D11/ne-d3d11-d3d11_resource_misc_flag) shared NTHANDLE (nouveau pour Windows 8) lorsque vous créez ces ressources.
