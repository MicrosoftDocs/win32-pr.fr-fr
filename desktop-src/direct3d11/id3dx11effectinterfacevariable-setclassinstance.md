...
ms.locfileid: "119046217"
---
# <a name="id3dx11effectinterfacevariablesetclassinstance-method"></a>ID3DX11EffectInterfaceVariable :: SetClassInstance, méthode

Définit une instance de classe.
...
Pointeur vers une interface [**ID3DX11EffectClassInstanceVariable**](id3dx11effectclassinstancevariable.md) .
