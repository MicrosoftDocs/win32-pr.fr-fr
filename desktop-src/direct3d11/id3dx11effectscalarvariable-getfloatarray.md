...
ms.locfileid: "127291791"
---
# <a name="id3dx11effectscalarvariablegetfloatarray-method"></a>ID3DX11EffectScalarVariable :: GetFloatArray, méthode

Obtient un tableau de variables à virgule flottante.
