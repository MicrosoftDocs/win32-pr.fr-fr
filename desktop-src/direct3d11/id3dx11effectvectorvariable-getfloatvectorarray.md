...
ms.locfileid: "119124474"
---
# <a name="id3dx11effectvectorvariablegetfloatvectorarray-method"></a>ID3DX11EffectVectorVariable :: GetFloatVectorArray, méthode

Obtient un tableau de vecteurs à quatre composants qui contiennent des données à virgule flottante.
