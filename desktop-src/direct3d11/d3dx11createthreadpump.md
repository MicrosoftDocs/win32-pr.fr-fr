...
description: 'remarque : la bibliothèque de l’utilitaire d3dx (d3dx 9, d3dx 10 et d3dx 11) est déconseillée pour Windows 8 et n’est pas prise en charge pour les applications Windows store. Consultez la section Notes. Créer une pompe de thread.'
...
ms.locfileid: "118536100"
---
# <a name="d3dx11createthreadpump-function"></a>D3DX11CreateThreadPump fonction)
...
Pompe de thread créée. Voir [**interface ID3DX11ThreadPump**](id3dx11threadpump.md).
