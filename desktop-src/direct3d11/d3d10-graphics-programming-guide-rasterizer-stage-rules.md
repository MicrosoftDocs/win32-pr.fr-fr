...
---
# <a name="rasterization-rules"></a>Règles de pixellisation
...
-   [Règles de pixellisation des triangles (sans échantillonnage multiple)](#triangle-rasterization-rules-without-multisampling)
-   [Règles de pixellisation de ligne (avec alias, sans échantillonnage multiple)](#line-rasterization-rules-aliased-without-multisampling)
-   [Règles de pixellisation de ligne (avec anticrénelage, sans échantillonnage multiple)](#line-rasterization-rules-antialiased-without-multisampling)
-   [Règles de pixellisation des points (sans échantillonnage multiple)](#point-rasterization-rules-without-multisampling)
-   [Exemples de règles de pixellisation d’anticrénelage](#multisample-anti-aliasing-rasterization-rules)
    -   [Support matériel](#hardware-support)
    -   [Échantillonnage de centre de gravité des attributs lors de l’anticrénelage à échantillonnage multiple](#centroid-sampling-of-attributes-when-multisample-antialiasing)
    -   [Calculs de dérivés lors de l’échantillonnage multiple](#derivative-calculations-when-multisampling)
-   [Rubriques connexes](#related-topics)

## <a name="triangle-rasterization-rules-without-multisampling"></a>Règles de pixellisation des triangles (sans échantillonnage multiple)
...
## <a name="line-rasterization-rules-aliased-without-multisampling"></a>Règles de pixellisation de ligne (avec alias, sans échantillonnage multiple)

Les règles de pixellisation de ligne utilisent une zone de test Diamond pour déterminer si une ligne couvre un pixel. Pour les lignes x-major (lignes avec-1 <= pente <= + 1), la zone de test Diamond comprend (visible) le bord inférieur gauche, le bord inférieur droit et l’angle inférieur. le losange exclut (en pointillés) le bord supérieur gauche, le bord supérieur droit, le plus haut cordon, le coin gauche et le coin droit. Une ligne « y » est une ligne qui n’est pas une ligne x-major ; la zone de test Diamond est la même que celle qui est décrite pour la ligne principale x, sauf que l’angle droit est également inclus.
...
## <a name="line-rasterization-rules-antialiased-without-multisampling"></a>Règles de pixellisation de ligne (avec anticrénelage, sans échantillonnage multiple)
...
## <a name="point-rasterization-rules-without-multisampling"></a>Règles de pixellisation des points (sans échantillonnage multiple)
...
## <a name="multisample-anti-aliasing-rasterization-rules"></a>Exemples de règles de pixellisation d’anticrénelage
...
### <a name="centroid-sampling-of-attributes-when-multisample-antialiasing"></a>Échantillonnage de centre de gravité des attributs lors de l’anticrénelage à échantillonnage multiple
...
### <a name="derivative-calculations-when-multisampling"></a>Calculs de dérivés lors de l’échantillonnage multiple
