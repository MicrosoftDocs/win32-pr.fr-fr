...
---
# <a name="cc-code-example-retrieving-the-task-working-directory"></a>Exemple de code C/C++ : récupération du répertoire de travail des tâches

Cet exemple récupère le répertoire de travail associé à une tâche et affiche le chemin d’accès au répertoire de travail à l’écran. Cet exemple suppose que la tâche et la tâche de test existent déjà sur l’ordinateur local.
