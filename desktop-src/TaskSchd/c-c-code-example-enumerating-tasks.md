...
ms.locfileid: "119738899"
---
# <a name="cc-code-example-enumerating-tasks"></a>Exemple de code C/C++ : énumération de tâches

Cet exemple énumère toutes les tâches du dossier tâches planifiées de l’ordinateur local et imprime le nom de chaque tâche à l’écran.
