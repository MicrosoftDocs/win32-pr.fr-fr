...
---
# <a name="july-monthstype-element"></a>Élément juillet (monthsType)

Spécifie que la tâche s’exécute en juillet.
...
L’élément **juillet** est défini par le type complexe [**monthsType**](taskschedulerschema-monthstype-complextype.md) .
...
Le code XML suivant définit un calendrier de mois qui exécute la tâche en juillet.
