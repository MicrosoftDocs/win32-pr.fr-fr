...
ms.locfileid: "120011639"
---
# <a name="cc-code-example-setting-task-priority"></a>Exemple de code C/C++ : définition de la priorité de la tâche

Cet exemple définit la priorité d’une tâche de test, puis enregistre la tâche. Cet exemple suppose que la tâche de test existe déjà sur l’ordinateur local.
