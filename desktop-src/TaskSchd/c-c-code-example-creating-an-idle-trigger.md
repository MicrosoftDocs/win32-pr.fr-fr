...
---
# <a name="cc-code-example-creating-an-idle-trigger"></a><span data-ttu-id="2163c-104">Exemple de code C/C++ : création d’un déclencheur inactif</span><span class="sxs-lookup"><span data-stu-id="2163c-104">C/C++ Code Example: Creating an Idle Trigger</span></span>

<span data-ttu-id="2163c-105">Cet exemple crée un déclencheur inactif pour une tâche existante.</span><span class="sxs-lookup"><span data-stu-id="2163c-105">This example creates an idle trigger for an existing task.</span></span> <span data-ttu-id="2163c-106">Pour plus d’informations sur les conditions d’inactivité, consultez conditions d’inactivité de la [tâche](task-idle-conditions.md).</span><span class="sxs-lookup"><span data-stu-id="2163c-106">For information about idle conditions, see [Task Idle Conditions](task-idle-conditions.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="2163c-107">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="2163c-107">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="2163c-108">Exemples de Planificateur de tâches 1,0</span><span class="sxs-lookup"><span data-stu-id="2163c-108">Task Scheduler 1.0 Examples</span></span>](task-scheduler-1-0-examples.md)
</dt> </dl>
