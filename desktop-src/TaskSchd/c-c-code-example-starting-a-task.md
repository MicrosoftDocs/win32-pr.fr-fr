...
ms.locfileid: "119139622"
---
# <a name="cc-code-example-starting-a-task"></a>Exemple de code C/C++ : démarrage d’une tâche

Cet exemple tente d’exécuter une tâche existante. Cet exemple suppose que la tâche et la tâche de test existent déjà sur l’ordinateur local.
