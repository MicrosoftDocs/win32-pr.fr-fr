...
ms.locfileid: "119059847"
---
# <a name="task-scheduler-20-enumerated-types"></a>Types énumérés de Planificateur de tâches 2,0

Décrit les types énumérés qui définissent les constantes utilisées par les API Planificateur de tâches 2,0.
...
| [**\_type de PROCESSTOKENSID de la tâche \_**](/windows/win32/api/taskschd/ne-taskschd-task_processtokensid_type)             | Définit les types de SID de processus qui peuvent être utilisés par les tâches.                                                      |
