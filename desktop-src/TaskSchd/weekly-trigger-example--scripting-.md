...
Cet exemple de script montre comment créer une tâche qui exécute le bloc-notes à 8:00 AM le lundi de chaque semaine. La tâche contient un déclencheur quotidien qui spécifie le moment d’exécution de la tâche et une action exécutable qui exécute le bloc-notes.
...
**Pour planifier le démarrage du bloc-notes à 8:00 AM le lundi de chaque semaine**
...
6.  Inscrivez la tâche à l’aide de la méthode [**TaskFolder. RegisterTaskDefinition**](taskfolder-registertaskdefinition.md) . Pour cet exemple, la tâche démarre le bloc-notes à 8:00 AM le lundi de chaque semaine.
