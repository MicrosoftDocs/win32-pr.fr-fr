...
---
# <a name="cc-code-example-retrieving-a-task-page"></a>Exemple de code C/C++ : récupération d’une page de tâche

Cet exemple récupère et affiche la page de tâche d’une tâche connue. Notez que dans cet exemple, toutes les interfaces sont libérées lorsqu’elles ne sont plus nécessaires.
