...
Pour les scripts, obtient l’état opérationnel de la tâche inscrite.
...
Constante [**d' \_ État de tâche**](/windows/desktop/api/taskschd/ne-taskschd-task_state) qui définit l’état opérationnel de la tâche.
