...
description: le code XML de cet exemple définit une tâche qui démarre Bloc-notes lorsqu’un utilisateur ouvre une session.
...
## <a name="to-define-a-task-to-start-notepad-on-system-boot"></a>pour définir une tâche afin de démarrer Bloc-notes au démarrage du système
