...
ms.locfileid: "119738659"
---
# <a name="cc-code-example-retrieving-task-priority"></a>Exemple de code C/C++ : récupération de la priorité d’une tâche

Cet exemple récupère le niveau de priorité d’une tâche et affiche le chemin d’accès au répertoire de travail à l’écran. Cet exemple suppose que la tâche et la tâche de test existent déjà sur l’ordinateur local.
