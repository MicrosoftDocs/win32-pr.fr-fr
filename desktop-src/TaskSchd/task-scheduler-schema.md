---
title: Schéma Planificateur de tâches
description: Le schéma Planificateur de tâches définit un code XML valide utilisé pour inscrire des tâches auprès du service Planificateur de tâches. Les développeurs peuvent créer leur propre code XML, le valider par rapport à ce schéma et inscrire des tâches à l’aide de la méthode ITaskFolder RegisterTask.
ms.assetid: 9b1b8e34-c635-413a-a230-79a58017cf21
keywords:
- Planificateur de tâches Planificateur de tâches, référence, schéma XML
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104101181"
---
# <a name="task-scheduler-schema"></a><span data-ttu-id="cd82e-105">Schéma Planificateur de tâches</span><span class="sxs-lookup"><span data-stu-id="cd82e-105">Task Scheduler Schema</span></span>

<span data-ttu-id="cd82e-106">Le schéma Planificateur de tâches définit un code XML valide utilisé pour inscrire des tâches auprès du service Planificateur de tâches.</span><span class="sxs-lookup"><span data-stu-id="cd82e-106">The Task Scheduler schema defines valid XML used to register tasks with the Task Scheduler service.</span></span> <span data-ttu-id="cd82e-107">Les développeurs peuvent créer leur propre code XML, le valider par rapport à ce schéma et inscrire des tâches à l’aide de la méthode [**ITaskFolder :: RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .</span><span class="sxs-lookup"><span data-stu-id="cd82e-107">Developers can create their own XML, validate it against this schema, and register tasks using the [**ITaskFolder::RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) method.</span></span>

<span data-ttu-id="cd82e-108">Les types et les éléments du schéma Planificateur de tâches sont documentés individuellement dans les sections suivantes.</span><span class="sxs-lookup"><span data-stu-id="cd82e-108">The types and elements of the Task Scheduler schema are individually documented in the following sections.</span></span>

-   [<span data-ttu-id="cd82e-109">Éléments de schéma Planificateur de tâches</span><span class="sxs-lookup"><span data-stu-id="cd82e-109">Task Scheduler Schema Elements</span></span>](task-scheduler-schema-elements.md)
-   [<span data-ttu-id="cd82e-110">Types simples de schéma Planificateur de tâches</span><span class="sxs-lookup"><span data-stu-id="cd82e-110">Task Scheduler Schema Simple Types</span></span>](task-scheduler-schema-simple-types.md)
-   [<span data-ttu-id="cd82e-111">Types complexes de schéma Planificateur de tâches</span><span class="sxs-lookup"><span data-stu-id="cd82e-111">Task Scheduler Schema Complex Types</span></span>](task-scheduler-schema-complex-types.md)
-   [<span data-ttu-id="cd82e-112">Planificateur de tâches des groupes de schémas</span><span class="sxs-lookup"><span data-stu-id="cd82e-112">Task Scheduler Schema Groups</span></span>](task-scheduler-schema-groups.md)

<span data-ttu-id="cd82e-113">Le schéma Planificateur de tâches entier est défini par le fichier XSD suivant.</span><span class="sxs-lookup"><span data-stu-id="cd82e-113">The entire Task Scheduler schema is defined by the following XSD file.</span></span>
