...
ms.locfileid: "120080369"
---
# <a name="task-scheduler-schema"></a>Schéma Planificateur de tâches

Le schéma Planificateur de tâches définit un code XML valide utilisé pour inscrire des tâches auprès du service Planificateur de tâches. Les développeurs peuvent créer leur propre code XML, le valider par rapport à ce schéma et inscrire des tâches à l’aide de la méthode [**ITaskFolder :: RegisterTask**](/windows/desktop/api/taskschd/nf-taskschd-itaskfolder-registertask) .

Les types et les éléments du schéma Planificateur de tâches sont documentés individuellement dans les sections suivantes.

-   [Éléments de schéma Planificateur de tâches](task-scheduler-schema-elements.md)
-   [Types simples de schéma Planificateur de tâches](task-scheduler-schema-simple-types.md)
-   [Types complexes de schéma Planificateur de tâches](task-scheduler-schema-complex-types.md)
-   [Planificateur de tâches des groupes de schémas](task-scheduler-schema-groups.md)

Le schéma Planificateur de tâches entier est défini par le fichier XSD suivant.
