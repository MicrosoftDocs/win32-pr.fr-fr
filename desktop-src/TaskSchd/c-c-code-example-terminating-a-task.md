...
---
# <a name="cc-code-example-terminating-a-task"></a>Exemple de code C/C++ : fin d’une tâche

Cet exemple vérifie l’état d’une tâche connue et met fin à la tâche si elle est en cours d’exécution.
