---
description: cette rubrique explique l’utilisation de l’outil de configuration de proxy Microsoft Windows HTTP Services (WinHTTP), &\# 0034 ; ProxyCfg.exe&\# 0034 ;.
...
**HKEY \_ logiciel de l' \_ ordinateur LOCAL** \\  \\ **Microsoft** \\ **Windows** \\  \\ **connexions Internet Paramètres** CurrentVersion \\  \\ **WinHttpSettings**
