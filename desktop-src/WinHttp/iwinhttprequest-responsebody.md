...
> [!Note]  
> pour plus d’informations sur l’implémentation de Windows XP et Windows 2000, consultez la page [configuration requise](winhttp-start-page.md)pour l’exécution.
