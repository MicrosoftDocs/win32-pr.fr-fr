...
Valeur de **type Variant** qui contient la valeur de l’option.

Le paramètre *option* spécifie le [**WinHttpRequestOption**](winhttprequestoption.md) à définir ou à récupérer.
...
L’exemple suivant montre comment définir et afficher l’option de chaîne de l' [*agent utilisateur*](glossary.md) et afficher diverses autres options.
...
L’exemple de script suivant montre comment définir et afficher des options.
