...
WinHTTP 5,1 offre des améliorations par rapport à la version 5,0 ; Pour plus d’informations sur les nouvelles fonctionnalités, consultez [Nouveautés de WinHTTP 5,1](what-s-new-in-winhttp-5-1.md).

Avec la version 5,1, WinHTTP est un composant du système d’exploitation des systèmes d’exploitation suivants :
