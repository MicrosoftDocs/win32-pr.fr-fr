...
<span id="_security_ca_gly"></span><span id="_SECURITY_CA_GLY"></span>**DERNIÈRE**
</dt> <dd>
...
<span id="_security_ca_certificate_gly"></span><span id="_SECURITY_CA_CERTIFICATE_GLY"></span>**Certificat d’autorité de certification**
</dt> <dd>
...
<span id="_security_ca_hierarchy_gly"></span><span id="_SECURITY_CA_HIERARCHY_GLY"></span>**Hiérarchie d’autorité de certification**
</dt> <dd>
...
Voir aussi [*algorithme d’échange de clés Diffie-Hellman (éphémère)*](d-gly.md).

</dd> <dt>

<span id="_security_calg_dh_sf_gly"></span><span id="_SECURITY_CALG_DH_SF_GLY"></span>**CALG \_ DH \_ DF**
</dt> <dd>
...
Voir aussi [*algorithme d’échange de clés Diffie-Hellman (stockage et transfert)*](d-gly.md).
...
Voir aussi [*code d’Authentification de message basées sur le hachage*](h-gly.md).
...
Voir aussi [*algorithme MD2*](m-gly.md).
...
Voir aussi [*algorithme MD5*](m-gly.md).
...
Voir aussi [*algorithme de bloc RC2*](r-gly.md).
...
Voir aussi [*algorithme de flux RC4*](r-gly.md).
...
Voir aussi [*algorithme de clé publique RSA*](r-gly.md).
...
Voir aussi [*algorithme de hachage sécurisé*](s-gly.md).

</dd> <dt>

<span id="_security_cast_gly"></span><span id="_SECURITY_CAST_GLY"></span>**PROCÉDER**
</dt> <dd>
...
<span id="_security_certificate_gly"></span><span id="_SECURITY_CERTIFICATE_GLY"></span>**certificat**
</dt> <dd>
...
<span id="_security_certificate_blob_gly"></span><span id="_SECURITY_CERTIFICATE_BLOB_GLY"></span>**objet BLOB de certificat**
</dt> <dd>
...
<span id="_security_certificate_context_gly"></span><span id="_SECURITY_CERTIFICATE_CONTEXT_GLY"></span>**contexte du certificat**
</dt> <dd>
...
<span id="_security_certificate_encode_decode_functions_gly"></span><span id="_SECURITY_CERTIFICATE_ENCODE_DECODE_FUNCTIONS_GLY"></span>**fonctions de codage/décodage de certificat**
</dt> <dd>
...
<span id="_security_certificate_encoding_type_gly"></span><span id="_SECURITY_CERTIFICATE_ENCODING_TYPE_GLY"></span>**type d’encodage de certificat**
</dt> <dd>
...
<span id="_security_certificate_management_over_cms_gly"></span><span id="_SECURITY_CERTIFICATE_MANAGEMENT_OVER_CMS_GLY"></span>**Gestion des certificats via CMS**
</dt> <dd>

CMC. Gestion des certificats via CMS. CMC est un protocole de gestion de certificats qui utilise la syntaxe de message de chiffrement (CMS). Microsoft encapsule les demandes de certificat CMC dans un objet de requête [*PKCS \# 7*](p-gly.md) (CMS) avant d’envoyer la demande à un serveur d’inscription.

</dd> <dt>

<span id="_security_certificate_name_blob_gly"></span><span id="_SECURITY_CERTIFICATE_NAME_BLOB_GLY"></span>**nom du certificat BLOB**
</dt> <dd>
...
<span id="_security_certificate_policy_gly"></span><span id="_SECURITY_CERTIFICATE_POLICY_GLY"></span>**stratégie de certificat**
</dt> <dd>
...
<span id="_security_certificate_request_gly"></span><span id="_SECURITY_CERTIFICATE_REQUEST_GLY"></span>**demande de certificat**
</dt> <dd>
...
<span id="_security_certificate_revocation_list_gly"></span><span id="_SECURITY_CERTIFICATE_REVOCATION_LIST_GLY"></span>**liste de révocation de certificats**
</dt> <dd>
...
<span id="_security_certificate_server_gly"></span><span id="_SECURITY_CERTIFICATE_SERVER_GLY"></span>**serveur de certificats**
</dt> <dd>
...
<span id="_security_certificate_services_gly"></span><span id="_SECURITY_CERTIFICATE_SERVICES_GLY"></span>**Services de certificats**
</dt> <dd>
...
<span id="_security_certificate_store_gly"></span><span id="_SECURITY_CERTIFICATE_STORE_GLY"></span>**magasin de certificats**
</dt> <dd>
...
<span id="_security_certificate_store_functions_gly"></span><span id="_SECURITY_CERTIFICATE_STORE_FUNCTIONS_GLY"></span>**fonctions du magasin de certificats**
</dt> <dd>
...
<span id="_security_certificate_trust_list_gly"></span><span id="_SECURITY_CERTIFICATE_TRUST_LIST_GLY"></span>**liste de certificats de confiance**
</dt> <dd>
...
<span id="_security_certification_authority_gly"></span><span id="_SECURITY_CERTIFICATION_AUTHORITY_GLY"></span>**autorité de certification**
</dt> <dd>
...
<span id="_security_chaining_mode_gly"></span><span id="_SECURITY_CHAINING_MODE_GLY"></span>**mode chaînage**
</dt> <dd>
...
<span id="_security_cipher_gly"></span><span id="_SECURITY_CIPHER_GLY"></span>**préférée**
</dt> <dd>
...
<span id="_security_cipher_block_chaining_gly"></span><span id="_SECURITY_CIPHER_BLOCK_CHAINING_GLY"></span>**Chaînage de blocs de chiffrement**
</dt> <dd>
...
<span id="_security_cipher_block_chaining_mac_gly"></span><span id="_SECURITY_CIPHER_BLOCK_CHAINING_MAC_GLY"></span>**Chaînage de blocs de chiffrement MAC**
</dt> <dd>

Méthode de chiffrement par bloc qui chiffre les données de base avec un chiffrement par blocs, puis utilise le dernier bloc chiffré comme valeur de hachage. L’algorithme de chiffrement utilisé pour générer le [*code d’Authentification de message*](m-gly.md) (Mac) est celui qui a été spécifié lors de la création de la clé de session.

</dd> <dt>

<span id="_security_cipher_feedback_gly"></span><span id="_SECURITY_CIPHER_FEEDBACK_GLY"></span>**Commentaires sur le chiffrement**
</dt> <dd>
...
<span id="_security_cipher_mode_gly"></span><span id="_SECURITY_CIPHER_MODE_GLY"></span>**mode de chiffrement**
</dt> <dd>
...
<span id="_security_ciphertext_gly"></span><span id="_SECURITY_CIPHERTEXT_GLY"></span>**texte chiffré**
</dt> <dd>
...
<span id="_security_cleartext_gly"></span><span id="_SECURITY_CLEARTEXT_GLY"></span>**crypté**
</dt> <dd>

Voir [*texte en clair*](p-gly.md).
...
Comparer avec le [*serveur*](s-gly.md).

</dd> <dt>

<span id="_security_client_certificate_gly"></span><span id="_SECURITY_CLIENT_CERTIFICATE_GLY"></span>**certificat client**
</dt> <dd>
...
<span id="_security_cng_gly"></span><span id="_SECURITY_CNG_GLY"></span>**CHIFFRE**
</dt> <dd>
...
<span id="_security_communication_protocol_gly"></span><span id="_SECURITY_COMMUNICATION_PROTOCOL_GLY"></span>**Protocole de communication**
</dt> <dd>
...
<span id="_security_constrained_delegation_gly"></span><span id="_SECURITY_CONSTRAINED_DELEGATION_GLY"></span>**délégation avec restriction**
</dt> <dd>
...
<span id="_security_context_gly"></span><span id="_SECURITY_CONTEXT_GLY"></span>**contexte**
</dt> <dd>
...
<span id="_security_context_function_gly"></span><span id="_SECURITY_CONTEXT_FUNCTION_GLY"></span>**Context, fonction**
</dt> <dd>
...
<span id="_security_countersignature_gly"></span><span id="_SECURITY_COUNTERSIGNATURE_GLY"></span>**signature**
</dt> <dd>
...
<span id="_security_credentials_gly"></span><span id="_SECURITY_CREDENTIALS_GLY"></span>**informations d’identification**
</dt> <dd>

Données d’ouverture de session précédemment authentifiées utilisées par un [*principal de sécurité*](s-gly.md) pour établir sa propre identité, par exemple un mot de passe ou un ticket de protocole Kerberos.

</dd> <dt>

<span id="_security_crl_gly"></span><span id="_SECURITY_CRL_GLY"></span>**RÉVOCATION**
</dt> <dd>
...
<span id="_security_crypt_asn_encoding_gly"></span><span id="_SECURITY_CRYPT_ASN_ENCODING_GLY"></span>**CRYPTer l' \_ \_ encodage ASN**
</dt> <dd>
...
<span id="_security_cryptographic_algorithm_gly"></span><span id="_SECURITY_CRYPTOGRAPHIC_ALGORITHM_GLY"></span>**algorithme de chiffrement**
</dt> <dd>
...
<span id="_security_cryptographic_digest_gly"></span><span id="_SECURITY_CRYPTOGRAPHIC_DIGEST_GLY"></span>**Chiffrement du chiffrement**
</dt> <dd>
...
<span id="_security_cryptographic_key_gly"></span><span id="_SECURITY_CRYPTOGRAPHIC_KEY_GLY"></span>**clé de chiffrement**
</dt> <dd>
...
<span id="_security_cryptographic_service_provider_gly"></span><span id="_SECURITY_CRYPTOGRAPHIC_SERVICE_PROVIDER_GLY"></span>**fournisseur de services de chiffrement**
</dt> <dd>
...
<span id="_security_cryptography_gly"></span><span id="_SECURITY_CRYPTOGRAPHY_GLY"></span>**basée**
</dt> <dd>
...
<span id="_security_cryptography_api_gly"></span><span id="_SECURITY_CRYPTOGRAPHY_API_GLY"></span>**API de chiffrement**
</dt> <dd>
...
<span id="_security_cryptography_api__next_generation_gly"></span><span id="_SECURITY_CRYPTOGRAPHY_API__NEXT_GENERATION_GLY"></span>**API de chiffrement : nouvelle génération**
</dt> <dd>
...
<span id="_security_csp_gly"></span><span id="_SECURITY_CSP_GLY"></span>**Guard**
</dt> <dd>
...
<span id="_security_csp_family_gly"></span><span id="_SECURITY_CSP_FAMILY_GLY"></span>**Famille CSP**
</dt> <dd>
...
<span id="_security_csp_name_gly"></span><span id="_SECURITY_CSP_NAME_GLY"></span>**Nom CSP**
</dt> <dd>
...
<span id="_security_csp_type_gly"></span><span id="_SECURITY_CSP_TYPE_GLY"></span>**Type CSP**
</dt> <dd>
...
<span id="_security_ctl_gly"></span><span id="_SECURITY_CTL_GLY"></span>**CONFIANCE**
</dt> <dd>
