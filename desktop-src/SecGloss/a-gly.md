---
description: Contient les définitions des termes de sécurité qui commencent par la lettre A.
ROBOTS: NOINDEX, NOFOLLOW
ms.assetid: 0baaa937-f635-4500-8dcd-9dbbd6f4cd02
title: A (Glossaire de la sécurité)
ms.topic: article
ms.date: 05/31/2018
...
<span id="_security_absolute_security_descriptor_gly"></span><span id="_SECURITY_ABSOLUTE_SECURITY_DESCRIPTOR_GLY"></span>**descripteur de sécurité absolu**
</dt> <dd>

Structure de descripteur de sécurité qui contient des pointeurs vers les informations de sécurité associées à un objet.

Voir aussi [*descripteur de sécurité*](s-gly.md) et [*descripteur de sécurité auto-relatif*](s-gly.md).
...
<span id="_security_access_block_gly"></span><span id="_SECURITY_ACCESS_BLOCK_GLY"></span>**bloc d’accès**
</dt> <dd>
...
<span id="_security_access_control_entry_gly"></span><span id="_SECURITY_ACCESS_CONTROL_ENTRY_GLY"></span>**entrée de contrôle d’accès**
</dt> <dd>
...
Voir aussi *liste de contrôle d’accès*, [*identificateur de sécurité*](s-gly.md)et [*tiers de confiance*](t-gly.md).

</dd> <dt>

<span id="_security_access_control_list_gly"></span><span id="_SECURITY_ACCESS_CONTROL_LIST_GLY"></span>**liste de contrôle d’accès**
</dt> <dd>
...
Voir aussi *entrée de contrôle d’accès*, [*liste de contrôle d’accès discrétionnaire*](d-gly.md), [*descripteur de sécurité*](s-gly.md)et liste de contrôle d' [*accès système*](s-gly.md).

</dd> <dt>

<span id="_security_access_mask_gly"></span><span id="_SECURITY_ACCESS_MASK_GLY"></span>**masque d’accès**
</dt> <dd>
...
<span id="_security_access_token_gly"></span><span id="_SECURITY_ACCESS_TOKEN_GLY"></span>**jeton d’accès**
</dt> <dd>
...
Voir aussi [*jeton d’emprunt d’identité*](i-gly.md), [*jeton principal*](p-gly.md), [*privilège*](p-gly.md), [*processus*](p-gly.md)et [*identificateur de sécurité*](s-gly.md).

</dd> <dt>

<span id="_security_ace_gly"></span><span id="_SECURITY_ACE_GLY"></span>**MAILLOTS**
</dt> <dd>
...
<span id="_security_alg_class_data_encrypt_gly"></span><span id="_SECURITY_ALG_CLASS_DATA_ENCRYPT_GLY"></span>**ALG \_ - \_ données de classe \_ Encrypt**
</dt> <dd>
...
<span id="_security_alg_class_hash_gly"></span><span id="_SECURITY_ALG_CLASS_HASH_GLY"></span>**\_hachage de classe ALG \_**
</dt> <dd>
...
<span id="_security_alg_class_key_exchange_gly"></span><span id="_SECURITY_ALG_CLASS_KEY_EXCHANGE_GLY"></span>**échange de clés de la \_ classe ALG \_ \_**
</dt> <dd>
...
<span id="_security_alg_class_signature_gly"></span><span id="_SECURITY_ALG_CLASS_SIGNATURE_GLY"></span>**SIGNATURE de la \_ classe ALG \_**
</dt> <dd>
...
<span id="_security_application_protocol_data_unit_gly"></span><span id="_SECURITY_APPLICATION_PROTOCOL_DATA_UNIT_GLY"></span>**unité de données de protocole d’application**
</dt> <dd>
...
Consultez également les [*réponses APDU*](r-gly.md).

</dd> <dt>

<span id="_security_application_protocol_gly"></span><span id="_SECURITY_APPLICATION_PROTOCOL_GLY"></span>**protocole d’application**
</dt> <dd>
...
<span id="_security_ascii_gly"></span><span id="_SECURITY_ASCII_GLY"></span>**R**
</dt> <dd>
...
<span id="_security_attribute_gly"></span><span id="_SECURITY_ATTRIBUTE_GLY"></span>**attribut**
</dt> <dd>
...
<span id="_security_attribute_blob_gly"></span><span id="_SECURITY_ATTRIBUTE_BLOB_GLY"></span>**objet BLOB d’attribut**
</dt> <dd>
...
<span id="_security_audit_security_object_gly"></span><span id="_SECURITY_AUDIT_SECURITY_OBJECT_GLY"></span>**Auditer l’objet de sécurité**
</dt> <dd>
...
<span id="_security_authentication_gly"></span><span id="_SECURITY_AUTHENTICATION_GLY"></span>**identification**
</dt> <dd>
...
<span id="_security_authentication_package_gly"></span><span id="_SECURITY_AUTHENTICATION_PACKAGE_GLY"></span>**package d’authentification**
</dt> <dd>
