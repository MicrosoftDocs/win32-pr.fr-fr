---
title: Constantes de fournisseur NAP (NapMicrosoftVendorIds. h)
description: Les ID de composant NAP internes Microsoft suivants sont définis dans NapMicrosoftVendorIds. h.
...
Les ID de composant NAP internes Microsoft suivants sont définis dans NapMicrosoftVendorIds. h. Lorsque vous implémentez un SHA ou un SHV, n’utilisez pas ces valeurs d’ID qui sont déjà attribuées aux composants d’intégrité système Microsoft internes.
...
| En-tête<br/>                   | <dl> <dt>NapMicrosoftVendorIds. h</dt> </dl> |
