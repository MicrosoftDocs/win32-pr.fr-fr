...
---
# <a name="shv-module"></a><span data-ttu-id="e4e9e-103">Module SHV</span><span class="sxs-lookup"><span data-stu-id="e4e9e-103">SHV Module</span></span>

> [!Note]  
> <span data-ttu-id="e4e9e-104">La plate-forme de protection d’accès réseau n’est pas disponible à partir de Windows 10</span><span class="sxs-lookup"><span data-stu-id="e4e9e-104">The Network Access Protection platform is not available starting with Windows 10</span></span>

 

<span data-ttu-id="e4e9e-105">Configure un module du programme de validation d’intégrité système (SHV), y compris l’inscription et l’annulation de l’inscription avec le système NAP.</span><span class="sxs-lookup"><span data-stu-id="e4e9e-105">Sets up a system health validator (SHV) module including registration and unregistration with the NAP system.</span></span>

> [!Note]  
> <span data-ttu-id="e4e9e-106">Le kit de développement logiciel (SDK) NAP contient également un jeu complet d’exemples de code qui se trouve dans le... \\ Exemples de \\ NetDS \\ NAP... Répertoire de votre installation du kit de développement logiciel (SDK).</span><span class="sxs-lookup"><span data-stu-id="e4e9e-106">The NAP SDK also contains a full set of sample code that can be found in the ...\\Samples\\NetDS\\NAP... directory of your SDK installation.</span></span> <span data-ttu-id="e4e9e-107">Cet exemple de jeu comprend un agent d’intégrité système (SHA), un SHV et un client de contrainte (EC).</span><span class="sxs-lookup"><span data-stu-id="e4e9e-107">This sample set includes a system health agent (SHA), SHV, and enforcement client (EC).</span></span> <span data-ttu-id="e4e9e-108">Il dispose de scénarios de protection d’accès réseau complets qui configurent la communication entre SHA-SHV et SHA-EC.</span><span class="sxs-lookup"><span data-stu-id="e4e9e-108">It has full working NAP scenarios setting up communication between SHA-SHV and SHA-EC.</span></span>
