...
WriteRead. cpp crée un jeu de propriétés, écrit une propriété, ferme et ouvre à nouveau le jeu de propriétés, puis lit la propriété. Cet exemple d’application crée le fichier « WriteRead. STG » dans le répertoire actif. Il crée des jeux de propriétés dans un fichier de stockage de structure, mais une modification d’une seule ligne entraîne la création de jeux de propriétés du système de fichiers NTFS.
