...
keywords:
- structured Stockage Strctd Stg, samples, EnumAll
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "119683029"
---
# <a name="enumall-sample"></a>Exemple EnumAll

L’exemple d’application EnumAll. cpp place toutes les propriétés dans tous les jeux de propriétés d’un fichier de stockage.
