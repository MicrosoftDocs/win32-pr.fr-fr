---
title: Exemple EnumAll
description: Place toutes les propriétés dans tous les jeux de propriétés d’un fichier de stockage.
ms.assetid: 40dd62b8-f76a-4cd8-9a9f-6ac344389b6c
keywords:
- Stockage structuré Strctd STG, samples, EnumAll
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104309814"
---
# <a name="enumall-sample"></a><span data-ttu-id="dd9a1-104">Exemple EnumAll</span><span class="sxs-lookup"><span data-stu-id="dd9a1-104">EnumAll Sample</span></span>

<span data-ttu-id="dd9a1-105">L’exemple d’application EnumAll. cpp place toutes les propriétés dans tous les jeux de propriétés d’un fichier de stockage.</span><span class="sxs-lookup"><span data-stu-id="dd9a1-105">The EnumAll.cpp sample application puts all properties in all property sets of a storage file.</span></span>
