...
ms.locfileid: "119662709"
---
# <a name="ipaperredraw"></a>IPaper :: redessin

La méthode **IPaper :: Redraw** s’appuie sur la technologie de point de connexion.

L’exemple de code suivant est la méthode **Redraw** de Paper. cpp.
...
Pour plus d’informations, consultez méthode [**IPaperSink**](ipapersink-methods.md) .
