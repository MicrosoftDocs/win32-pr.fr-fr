...
Bien que les genres de propriétés d’exécution offertes par Automation et les contrôles ActiveX Microsoft soient importants, ils ne répondent pas directement à la nécessité de stocker des informations avec des objets stockés de manière permanente dans le système de fichiers. Ces entités peuvent inclure des fichiers (structurés, composés, etc.), des répertoires et des catalogues de résumé. COM fournit un format sérialisé standard pour ces propriétés persistantes, ainsi qu’un ensemble d’interfaces et de fonctions qui vous permettent de créer et de manipuler les jeux de propriétés et leurs propriétés.
