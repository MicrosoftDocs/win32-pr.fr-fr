---
title: Exemple StgCreatePropSetStg
description: Montre comment la fonction StgCreatePropSetStg peut être utilisée pour créer une interface IPropertySetStorage en plus d’une interface IStorage donnée.
ms.assetid: f0d0664a-2cfd-4eb0-b1d5-47d1545394fd
keywords:
- Stockage structuré Strctd STG, samples, StgCreatePropSetStg
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104380253"
---
# <a name="stgcreatepropsetstg-sample"></a><span data-ttu-id="02fa6-104">Exemple StgCreatePropSetStg</span><span class="sxs-lookup"><span data-stu-id="02fa6-104">StgCreatePropSetStg Sample</span></span>

<span data-ttu-id="02fa6-105">L’exemple StgCreatePropSetStg. cpp montre comment la fonction [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) peut être utilisée pour créer une interface [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) en plus d’une interface [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) donnée.</span><span class="sxs-lookup"><span data-stu-id="02fa6-105">The StgCreatePropSetStg.cpp sample shows how the [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) function can be used to create an [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) interface on top of any given [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) interface.</span></span>
