...
---
# <a name="stgcreatepropsetstg-sample"></a>Exemple StgCreatePropSetStg

L’exemple StgCreatePropSetStg. cpp montre comment la fonction [**StgCreatePropSetStg**](/windows/desktop/api/coml2api/nf-coml2api-stgcreatepropsetstg) peut être utilisée pour créer une interface [**IPropertySetStorage**](/windows/desktop/api/Propidl/nn-propidl-ipropertysetstorage) en plus d’une interface [**IStorage**](/windows/desktop/api/Objidl/nn-objidl-istorage) donnée.
