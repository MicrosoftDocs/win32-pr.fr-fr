...
[Stratégie de groupe](group-policy.md)
</dt> <dd>

Stratégie de groupe permet l’administration basée sur des stratégies à l’aide des services d’annuaire Microsoft Active Directory. Stratégie de groupe utilise les services d’annuaire et l’appartenance à un groupe de sécurité pour offrir la flexibilité et prendre en charge des informations de configuration complètes.
...
La console MMC (Microsoft Management Console) fournit une interface utilisateur et un modèle d’administration simples, cohérents et intégrés.

</dd> <dt>

[Fournisseur d’applications de gestion des appareils mobiles](/previous-versions/windows/desktop/mdmappprov/mobile-device-management-application-provider-portal)
</dt> <dd>

Le fournisseur d’applications de gestion des appareils mobiles (MDM) gère les applications sur les appareils qui sont abonnés à un service MDM.

</dd> <dt>

[Inscription de la gestion des périphériques mobiles](/windows/desktop/MDMReg/mobile-device-management-registration-portal)
</dt> <dd>

L’inscription MDM inscrit des appareils dans un service MDM.
...
NetShell est un outil en ligne de commande qui permet aux administrateurs d’administrer et de configurer à distance les services réseau critiques.
...
[Restauration du système](/windows/desktop/sr/system-restore-portal)
</dt> <dd>
...
[Arrêt du système](/windows/desktop/Shutdown/system-shutdown)
</dt> <dd>

Les fonctions et messages d’arrêt du système permettent aux applications de fermer la session de l’utilisateur actuel, d’arrêter le système ou de verrouiller la station de travail.
...
Le Planificateur de tâches vous permet d’effectuer automatiquement des tâches de routine sur un ordinateur choisi. Pour ce faire, les Planificateur de tâches analysent les critères que vous choisissez pour lancer les tâches (appelés déclencheurs), puis exécutent les tâches lorsque les critères sont satisfaits.
...
[Dossiers de travail](/previous-versions/windows/desktop/syncshareservermgmt/sync-share-server-management-portal)
</dt> <dd>

Dossiers de travail permet aux utilisateurs de stocker et d’accéder à des fichiers de travail sur des ordinateurs et des appareils personnels.
