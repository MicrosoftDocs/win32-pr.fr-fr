...
[Exemples de code et outils](rms-code-samples-and-tools.md)
</dt> <dd>

Collection d’exemples de code RMS fournis par Microsoft et d’outils de support pour les développeurs sur tous les systèmes d’exploitation pris en charge. Android, iOS/OS X, Windows Phone et Windows Desktop.

</dd> <dd>

Kit de développement logiciel (SDK) RMS 4,2 est un ensemble d’outils de nouvelle génération simplifié qui offre une expérience de développement légère dans l’activation de vos applications Android, iOS et Mac OS X pour appareils avec protection des informations via les services Microsoft Rights Management.
