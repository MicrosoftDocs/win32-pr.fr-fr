...
|--------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------|
| [**Signé**](/windows/desktop/api/Wuapi/nf-wuapi-iupdateinstallationresult-get_hresult)               | Obtient la valeur de l’exception **HRESULT** levée pendant l’opération sur une mise à jour.                                            |
