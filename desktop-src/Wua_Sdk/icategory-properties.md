---
description: L’interface ICategory définit les propriétés suivantes.
...
L’interface [**ICategory**](/windows/desktop/api/Wuapi/nn-wuapi-icategory) définit les propriétés suivantes.



| Propriété                                     | Description                                                                                       |
|----------------------------------------------|---------------------------------------------------------------------------------------------------|
| [**Catégorie**](/windows/desktop/api/Wuapi/nf-wuapi-icategory-get_categoryid)   | Obtient l’identificateur de la catégorie.                                                              |
