...
| [**HResult**](/windows/desktop/api/Wuapi/nf-wuapi-iupdatehistoryentry-get_hresult)                         | Obtient la valeur **HRESULT** retournée par l’opération sur une mise à jour.                                             |
...
| [**ServiceID**](/windows/desktop/api/Wuapi/nf-wuapi-iupdatehistoryentry-get_serviceid)                     | Obtient l’identificateur de service d’un service de mise à jour qui n’est pas une mise à jour de Windows.                                           |
...
| [**Intitulé**](/windows/desktop/api/Wuapi/nf-wuapi-iupdatehistoryentry-get_title)                             | Obtient le titre d’une mise à jour.                                                                                             |
