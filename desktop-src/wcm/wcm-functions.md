...
---
# <a name="windows-connection-manager-functions"></a>Fonctions du gestionnaire de connexions Windows

Les fonctions du gestionnaire de connexions Windows (WCM) sont les suivantes.
