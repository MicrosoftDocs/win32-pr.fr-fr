...
---
# <a name="wininet-functions"></a>Fonctions WinINet

La liste suivante comprend toutes les fonctions WinINet :
...
[**Getdcbrushcolor**](/windows/desktop/api/Wininet/nf-wininet-ftpcommanda)  
...
La liste suivante répertorie les fonctions de sécurité et de confidentialité WinInet :
