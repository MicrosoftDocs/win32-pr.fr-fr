---
title: En-tête d’exemple asynchrone
description: Le fichier d’en-tête de l’exemple d’application asynchrone est le suivant.
...
ms.locfileid: "104196514"
---
# <a name="asynchronous-example-header"></a><span data-ttu-id="00b34-103">En-tête d’exemple asynchrone</span><span class="sxs-lookup"><span data-stu-id="00b34-103">Asynchronous Example Header</span></span>

<span data-ttu-id="00b34-104">Le fichier d’en-tête de l' [exemple d’application asynchrone](asynchronous-example-application.md)est le suivant.</span><span class="sxs-lookup"><span data-stu-id="00b34-104">The following is the header file for the [asynchronous example application](asynchronous-example-application.md).</span></span>
