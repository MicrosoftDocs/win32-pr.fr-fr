...
ms.locfileid: "120121939"
---
# <a name="asynchronous-example-header"></a>En-tête d’exemple asynchrone

Le fichier d’en-tête de l' [exemple d’application asynchrone](asynchronous-example-application.md)est le suivant.
