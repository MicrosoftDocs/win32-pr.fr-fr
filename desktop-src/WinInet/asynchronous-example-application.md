---
title: Exemple d’application asynchrone
description: L’exemple suivant illustre l’envoi d’une demande de manière asynchrone.
...
ms.locfileid: "104196935"
---
# <a name="asynchronous-example-application"></a><span data-ttu-id="f9a85-103">Exemple d’application asynchrone</span><span class="sxs-lookup"><span data-stu-id="f9a85-103">Asynchronous Example Application</span></span>

<span data-ttu-id="f9a85-104">L’exemple suivant illustre l’envoi d’une demande de manière asynchrone.</span><span class="sxs-lookup"><span data-stu-id="f9a85-104">The following example demonstrated sending a request asynchronously.</span></span>
