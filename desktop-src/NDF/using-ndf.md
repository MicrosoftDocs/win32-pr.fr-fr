...
| Rubrique                                                                                                                      |
|----------------------------------------------------------------------------------------------------------------------------|
| [Utilisation des fonctionnalités NDF](using-ndf-functionality.md)                                                                     |
| [Conception des extensions de classe d’assistance NDF](designing-ndf-helper-class-extensions.md)                                         |
| [Instructions relatives à l’interface utilisateur pour les extensions de classe d’assistance NDF](user-interface-guidelines-for-ndf-helper-class-extensions.md) |
| [Inscription des extensions de classe d’assistance NDF](registering-ndf-helper-class-extensions.md)                                     |
| [Exemple de diagnostics NDF](ndf-diagnostics-example.md)                                                                     |
