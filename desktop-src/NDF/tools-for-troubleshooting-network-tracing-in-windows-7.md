...
Dans cette section, nous allons voir comment utiliser Netsh.exe et Moniteur réseau pour vous aider à résoudre les problèmes de traçage réseau.
...
| Rubrique                                                                                  |
|----------------------------------------------------------------------------------------|
| [Utilisation de netsh pour gérer les traces](using-netsh-to-manage-traces.md)                       |
| [Utilisation de Moniteur réseau pour afficher les fichiers ETL](/windows/desktop/NDF/using-network-monitor-to-view-etl-files) |
