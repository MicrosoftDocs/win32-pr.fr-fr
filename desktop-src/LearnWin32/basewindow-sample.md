---
title: Exemple BaseWindow
description: Cet exemple d’application montre comment passer des données d’état de l’application dans le \_ message WM NCCREATE.
...
ms.locfileid: "127094437"
---
# <a name="basewindow-sample"></a>Exemple BaseWindow

Cet exemple d’application montre comment passer des données d’état de l’application dans le message [**WM \_ NCCREATE**](/windows/desktop/winmsg/wm-nccreate) .
...
Cet exemple est disponible [ici](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Win7Samples/begin/LearnWin32/BaseWindow).
