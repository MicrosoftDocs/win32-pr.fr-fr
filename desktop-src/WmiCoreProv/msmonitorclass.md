...
ms.locfileid: "119732979"
---
# <a name="msmonitorclass-class"></a>MSMonitorClass, classe

Le **MSMonitorClass** est une classe de base WMI abstraite. Les classes qui décrivent les moniteurs d’affichage vidéo héritent de cette **MSMonitorClass**.

Les classes de moniteur d’affichage vidéo qui héritent de **MSMonitorClass** sont les suivantes :
...
La classe **MSMonitorClass** ne définit aucun membre.
