...
La classe **MSMCAInfo \_ RawCorrectedPlatformEvent** contient un événement de plateforme corrigé (CPE). Cette classe est disponible uniquement dans les systèmes Windows 64 bits.
