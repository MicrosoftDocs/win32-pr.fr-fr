...
La classe **MSMCAInfo \_ RawCMCEvent** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **MSMCAInfo \_ RawCMCEvent** possède les propriétés suivantes.
...
Tableau des enregistrements d’erreurs MCA (machine Check architecture). Le nombre d’enregistrements d’erreurs MCA dans le tableau est spécifié par la propriété **Count** .
