...
---
# <a name="windows-family-safety-solution"></a>Solution de sécurité des familles Windows
...
-   Exposez les fonctionnalités d’analyse d’activité par le biais d’interfaces de journalisation des événements Windows Vista standard et fournissez une solution de visionneuse intégrée. Définissez des événements d’activité standard et fournissez une extensibilité à la génération d’événements personnalisés par les éditeurs de logiciels indépendants.
