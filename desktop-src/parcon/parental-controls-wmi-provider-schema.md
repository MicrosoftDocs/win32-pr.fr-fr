---
description: Le fournisseur WMI de contrôle parental est un fournisseur d’instances et de méthodes. L’instanciation de nouvelles instances de classe, la lecture ou la modification de propriétés d’instance existantes et l’appel de méthodes sont contrôlés par le fichier Wpcsprov. mof.
ms.assetid: 28d46969-448e-4a67-bfb3-4240b5cebe57
title: Schéma du fournisseur WMI de contrôle parental
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104485648"
---
# <a name="parental-controls-wmi-provider-schema"></a><span data-ttu-id="f57da-104">Schéma du fournisseur WMI de contrôle parental</span><span class="sxs-lookup"><span data-stu-id="f57da-104">Parental Controls WMI Provider Schema</span></span>

<span data-ttu-id="f57da-105">Le fournisseur WMI de contrôle parental est un fournisseur d’instances et de méthodes.</span><span class="sxs-lookup"><span data-stu-id="f57da-105">The Parental Controls WMI Provider is an instance and method provider.</span></span> <span data-ttu-id="f57da-106">L’instanciation de nouvelles instances de classe, la lecture ou la modification de propriétés d’instance existantes et l’appel de méthodes sont contrôlés par le fichier Wpcsprov. mof.</span><span class="sxs-lookup"><span data-stu-id="f57da-106">Instantiation of new class instances, reading or modification of existing instance properties, and invocation of methods is controlled by the Wpcsprov.mof file.</span></span>

<span data-ttu-id="f57da-107">La syntaxe suivante provient de namespace. mof</span><span class="sxs-lookup"><span data-stu-id="f57da-107">The following syntax is from Namespace.mof</span></span>
...
<span data-ttu-id="f57da-108">La syntaxe suivante provient de Ratings. mof</span><span class="sxs-lookup"><span data-stu-id="f57da-108">The following syntax is from Ratings.mof</span></span>
...
<span data-ttu-id="f57da-109">La syntaxe suivante provient de WpcSettings. mof</span><span class="sxs-lookup"><span data-stu-id="f57da-109">The following syntax is from WpcSettings.mof</span></span>
...
<span data-ttu-id="f57da-110">La syntaxe suivante provient de WpcProvider. mof</span><span class="sxs-lookup"><span data-stu-id="f57da-110">The following syntax is from WpcProvider.mof</span></span>
