...
---
# <a name="parental-controls-wmi-provider-schema"></a>Schéma du fournisseur WMI de contrôle parental

Le fournisseur WMI de contrôle parental est un fournisseur d’instances et de méthodes. L’instanciation de nouvelles instances de classe, la lecture ou la modification de propriétés d’instance existantes et l’appel de méthodes sont contrôlés par le fichier Wpcsprov. mof.

La syntaxe suivante provient de namespace. mof
...
La syntaxe suivante provient de Ratings. mof
...
La syntaxe suivante provient de WpcSettings. mof
...
La syntaxe suivante provient de WpcProvider. mof
