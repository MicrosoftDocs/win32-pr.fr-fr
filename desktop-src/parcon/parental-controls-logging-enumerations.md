...
Le contrôle parental fournit les énumérations de journalisation suivantes.

Énumérations d’indicateur :

-   [**\_fonctionnalité de messagerie instantanée WPCFLAG \_**](/windows/win32/api/wpcevent/ne-wpcevent-wpcflag_im_feature)
-   [**\_indicateur de \_ sortie \_ im WPCFLAG**](/windows/win32/api/wpcevent/ne-wpcevent-wpcflag_im_leave)
...
-   [**\_type de média \_ explicite \_ WPC**](/windows/win32/api/wpcevent/ne-wpcevent-wpc_media_explicit)
-   [**\_type de média WPC \_**](/windows/win32/api/wpcevent/ne-wpcevent-wpc_media_type)
