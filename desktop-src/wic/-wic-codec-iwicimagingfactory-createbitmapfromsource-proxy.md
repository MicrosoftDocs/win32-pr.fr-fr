...
---
# <a name="iwicimagingfactory_createbitmapfromsource_proxy-function"></a>IWICImagingFactory \_ \_ fonction proxy CreateBitmapFromSource

Fonction proxy pour la méthode [**CreateBitmapFromSource**](/windows/desktop/api/Wincodec/nf-wincodec-iwicimagingfactory-createbitmapfromsource) .
...
_pIBitmapSource * \[ dans\]
</dt> <dd>

Tapez : **[**IWICBitmapSource**](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapsource) \** _

[_ *IWICBitmapSource* *](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapsource) à partir duquel créer l’image bitmap.
...
Options de cache de la nouvelle bitmap.
