...
---
# <a name="iwicbitmapframeencode_setsize_proxy-function"></a>IWICBitmapFrameEncode \_ définit la \_ fonction de proxy

Fonction proxy pour la méthode [**configure**](/windows/desktop/api/Wincodec/nf-wincodec-iwicbitmapframeencode-setsize) .
