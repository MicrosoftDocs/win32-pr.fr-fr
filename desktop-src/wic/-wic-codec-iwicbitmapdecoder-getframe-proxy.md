...
ms.locfileid: "118034118"
---
# <a name="iwicbitmapdecoder_getframe_proxy-function"></a>\_Fonction de \_ proxy IWICBitmapDecoder GetFrame

Fonction proxy pour la méthode [**GetFrame**](/windows/desktop/api/Wincodec/nf-wincodec-iwicbitmapdecoder-getframe) .
...
Pointeur qui reçoit un pointeur vers [**IWICBitmapFrameDecode**](/windows/desktop/api/Wincodec/nn-wincodec-iwicbitmapframedecode).
