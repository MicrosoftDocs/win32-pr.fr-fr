---
description: Le mode de balance blanc au moment de la capture de la photo, tel qu’il est issu des informations EXIF (Exchangeable Image File).
...
ms.locfileid: "118723167"
---
# <a name="systemphotowhitebalance"></a>System. photo. WhiteBalance

Le mode de balance blanc au moment de la capture de la photo, tel qu’il est issu des informations EXIF (Exchangeable Image File).
