---
description: Indique une référence pour donner la direction de l’image lors de sa capture, (par exemple, direction réelle, direction magnétique).
...
Indique une référence pour donner la direction de l’image lors de sa capture, (par exemple, direction réelle, direction magnétique).
