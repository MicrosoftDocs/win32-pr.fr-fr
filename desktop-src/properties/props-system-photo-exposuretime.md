...
ms.locfileid: "127412684"
---
# <a name="systemphotoexposuretime"></a>System. photo. ExposureTime

Temps d’exposition de la photo, en secondes, lu à partir des informations EXIF (Exchangeable Image File). Cette propriété est calculée à partir de [System. photo. ExposureTimeNumerator](./props-system-photo-exposuretimenumerator.md) et de [System. photo. ExposureTimeDenominator](./props-system-photo-exposuretimedenominator.md).

La liste suivante répertorie les valeurs possibles tirées de la spécification EXIF 2,2.
