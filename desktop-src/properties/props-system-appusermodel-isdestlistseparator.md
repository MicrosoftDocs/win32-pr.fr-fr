---
description: Insère un séparateur dans la section tâches d’une liste de raccourcis.
...
ms.locfileid: "118970868"
---
# <a name="systemappusermodelisdestlistseparator"></a>System. AppUserModel. IsDestListSeparator

Insère un séparateur dans la section **tâches** d’une liste de raccourcis. Définissez cette propriété sur un objet [**IShellLink**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishelllinka) et transmettez-le à [**ICustomDestinationList :: AddUserTasks**](/windows/win32/api/shobjidl_core/nf-shobjidl_core-icustomdestinationlist-addusertasks).
