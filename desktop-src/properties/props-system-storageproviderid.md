---
description: cette propriété représente la \[ partie Stockage ID \] de fournisseur de l’identificateur de fournisseur complet&\# 0034 ; \[ Stockage ID du fournisseur \] ! \[ Windows SID \] ! \[ ID de compte \] & \# 0034 ;.
...
ms.locfileid: "119774429"
---
# <a name="systemstorageproviderid"></a>System. StorageProviderId

cette propriété représente la \[ partie Stockage id \] de fournisseur de l’identificateur de fournisseur complet « \[ Stockage id de fournisseur \] ! \[ Windows SID \] ! \[ ID de compte \] ».
