---
description: Contenu de l’élément.
...
Contenu de l’élément. Cette propriété est réservée aux restrictions de requête. elle ne peut pas être récupérée dans un résultat de requête. Le nom convivial du service d’indexation est « contents ».
