...
ms.locfileid: "127296159"
---
# <a name="systemphotofnumber"></a>System. photo. FNumber

Valeur FNumber lors de la prise de la photo, lue à partir des informations EXIF (Exchangeable Image File). Cette propriété est calculée à partir de [System. photo. FNumberNumerator](./props-system-photo-fnumbernumerator.md) et de [System. photo. FNumberDenominator](./props-system-photo-fnumberdenominator.md).

Les valeurs possibles sont les suivantes, issues de la spécification EXIF 2,2.
