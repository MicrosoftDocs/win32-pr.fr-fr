...
ms.locfileid: "118727447"
---
# <a name="systemfileofflineavailabilitystatus"></a>System. FileOfflineAvailabilityStatus

Null indique le cas normal (le fichier est disponible hors connexion). La casse partielle est uniquement réservée aux dossiers dans lesquels du contenu peut être disponible hors connexion, et certains ne le peuvent pas.
