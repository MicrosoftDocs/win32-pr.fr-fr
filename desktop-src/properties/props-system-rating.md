...
Lorsqu’un utilisateur évalue un élément en choisissant une valeur d’évaluation en étoile dans l’interface utilisateur, les valeurs réelles de [System. Rating]() sont affectées comme indiqué dans le tableau suivant :



| Nombre d'étoiles | Valeur assignée via l’interface utilisateur |
|-------------|---------------------------|
| 1 étoile      | 1                         |
| 2 étoiles     | 25                        |
| 3 étoiles     | 50                        |
...
Si votre fichier a une valeur [System. SimpleRating](./props-system-simplerating.md) au lieu d’une valeur [System. Rating]() , utilisez le tableau ci-dessous pour convertir et spécifier des valeurs pour System. Rating.
...
Si votre fichier a des valeurs persistantes [System. Rating]() et [System. SimpleRating](./props-system-simplerating.md) , utilisez toujours la valeur System. Rating quand elle est demandée directement, sans référence à System. SimpleRating.
