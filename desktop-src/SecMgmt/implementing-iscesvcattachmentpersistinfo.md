...
ms.locfileid: "106520651"
---
# <a name="implementing-iscesvcattachmentpersistinfo"></a><span data-ttu-id="9fd35-103">Implémentation de ISceSvcAttachmentPersistInfo</span><span class="sxs-lookup"><span data-stu-id="9fd35-103">Implementing ISceSvcAttachmentPersistInfo</span></span>

<span data-ttu-id="9fd35-104">Les extensions de composant logiciel enfichable d’attachement doivent implémenter l’interface [**ISceSvcAttachmentPersistInfo**](/windows/desktop/api/Scesvc/nn-scesvc-iscesvcattachmentpersistinfo) .</span><span class="sxs-lookup"><span data-stu-id="9fd35-104">Attachment snap-in extensions must implement the [**ISceSvcAttachmentPersistInfo**](/windows/desktop/api/Scesvc/nn-scesvc-iscesvcattachmentpersistinfo) interface.</span></span> <span data-ttu-id="9fd35-105">Les composants logiciels enfichables de configuration de la sécurité interrogent cette interface régulièrement, par exemple lors de l’enregistrement de la configuration ou de la fermeture du composant logiciel enfichable.</span><span class="sxs-lookup"><span data-stu-id="9fd35-105">The Security Configuration snap-ins query this interface periodically, such as when saving the configuration or closing the snap-in.</span></span> <span data-ttu-id="9fd35-106">Cela permet à l’extension de composant logiciel enfichable d’enregistrer toutes les modifications apportées par l’utilisateur à la base de données d’inspection ou à la configuration associée.</span><span class="sxs-lookup"><span data-stu-id="9fd35-106">This allows the snap-in extension to save any modifications that the user may have made to the inspection database or to the associated configuration.</span></span>

<span data-ttu-id="9fd35-107">L’exemple suivant montre une façon d’implémenter [**ISceSvcAttachmentPersistInfo**](/windows/desktop/api/Scesvc/nn-scesvc-iscesvcattachmentpersistinfo).</span><span class="sxs-lookup"><span data-stu-id="9fd35-107">The following example shows one way to implement [**ISceSvcAttachmentPersistInfo**](/windows/desktop/api/Scesvc/nn-scesvc-iscesvcattachmentpersistinfo).</span></span>
