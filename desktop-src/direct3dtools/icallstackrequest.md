...
L’interface **ICallStackRequest** hérite de l’interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **ICallStackRequest** a également les types de membres suivants :
