---
description: Énumération utilisée pour indiquer une étape du pipeline Graphics.
MS-HAID: vspixengine.PIPELINESTAGES
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: Énumération PIPELINESTAGES
ms.topic: reference
ms.date: 05/31/2018
...
ms.locfileid: "119119402"
---
# <a name="span-idvspixenginepipelinestagesspanpipelinestages-enumeration"></a><span id="vspixengine.pipelinestages"></span>Énumération PIPELINESTAGES

Énumération utilisée pour indiquer une étape du pipeline Graphics.
...
Valeur qui correspond à l’étape de l’assembleur d’entrée.
...
Valeur qui correspond à l’étape du nuanceur de sommets.
...
Valeur qui correspond à l’étape du nuanceur de coque.
...
Valeur qui correspond à l’étape Tesselator.
...
Valeur qui correspond à l’étape du nuanceur de domaine.
...
Valeur qui correspond à l’étape de nuanceur Geometry.
...
Valeur qui correspond à l’étape de sortie de flux.

<span id="PipeLineStages_Rasterizer"></span><span id="pipelinestages_rasterizer"></span><span id="PIPELINESTAGES_RASTERIZER"></span>**\_Rastériseur PipeLineStages**  
Valeur qui correspond à l’étape de rastérisation.
...
Valeur qui correspond à l’étape du nuanceur de pixels.
...
Valeur qui correspond à l’étape de fusion de sortie.
...
Valeur qui correspond à l’étape du nuanceur de calcul.
