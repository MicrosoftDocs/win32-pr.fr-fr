---
description: Détermine si le moteur prend en charge ou non une instance singleton.
MS-HAID: vspixengine.IPixEngineSingleton
MSHAttr:
- PreferredSiteName:MSDN
- PreferredLib:/library/windows/desktop
title: Interface IPixEngineSingleton
ms.topic: reference
ms.date: 05/31/2018
...
L’interface **IPixEngineSingleton** hérite de l’interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) , mais n’a pas de membres supplémentaires.
