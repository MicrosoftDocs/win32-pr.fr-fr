...
ms.locfileid: "122624885"
---
# <a name="span-idvspixengineisummaryrequest_requestasync_isummarycallback_ptr_dword_dwordspanisummaryrequestrequestasync-method"></a><span id="vspixengine.isummaryrequest_requestasync_isummarycallback_ptr_dword_dword"></span>ISummaryRequest :: RequestAsync, méthode

Demande asynchrone pour obtenir des informations de synthèse sur un journal de graphisme.
