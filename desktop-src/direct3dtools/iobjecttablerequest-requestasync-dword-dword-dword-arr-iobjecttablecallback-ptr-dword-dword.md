...
Demande l’extraction des informations spécifiées à partir de la table des objets pour l’événement spécifié.
...
*numColumns*   
Nombre de colonnes (champs) d’informations à récupérer.
