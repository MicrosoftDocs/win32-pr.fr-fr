...
si vous souhaitez effectuer un débogage à distance sur un ordinateur sur lequel le kit de développement logiciel (SDK) Windows 8 n’est pas installé et que vous souhaitez cette fonctionnalité de débogage supplémentaire, vous devez installer le package de débogage distant approprié à l’architecture sur laquelle vous souhaitez effectuer le débogage. les Packages Windows Installer dans `C:\Program Files (x86)\Windows Kits\8.0\Remote\<arch>` installent la prise en charge appropriée.
