...
L’interface **IOfflineAnalysisCacheCallback** hérite de l’interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **IOfflineAnalysisCacheCallback** a également les types de membres suivants :
