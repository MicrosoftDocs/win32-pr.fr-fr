---
description: Demande de mémoire tampon contenant la maille d’une phase de pipeline.
...
L’interface **IMeshRequest** hérite de l’interface [**IUnknown**](/windows/desktop/api/unknwn/nn-unknwn-iunknown) . **IMeshRequest** a également les types de membres suivants :
