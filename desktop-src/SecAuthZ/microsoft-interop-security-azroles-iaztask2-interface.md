---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzTask2.
ms.assetid: d8119871-0ffe-4a84-92d8-e893b7dd82cb
title: Interface Microsoft. Interop. Security. AzRoles. IAzTask2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127416545"
---
# <a name="microsoftinteropsecurityazrolesiaztask2-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzTask2

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzTask2** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzTask2** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzTask2** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzTask2** possède ces propriétés.



| Propriété                                                                       | Type d’accès           | Description                                                                               |
|:-------------------------------------------------------------------------------|:----------------------|:------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzTask2. ApplicationData**<br/>     | Lecture/écriture<br/> | [**Propriété ApplicationData de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_applicationdata)<br/>         |
| **Microsoft. Interop. Security. azroles. IAzTask2. BizRule**<br/>             | Lecture/écriture<br/> | [**Propriété BizRule de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizrule)<br/>                         |
| **Microsoft. Interop. Security. azroles. IAzTask2. BizRuleImportedPath**<br/> | Lecture/écriture<br/> | [**Propriété BizRuleImportedPath de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizruleimportedpath)<br/> |
| **Microsoft. Interop. Security. azroles. IAzTask2. BizRuleLanguage**<br/>     | Lecture/écriture<br/> | [**Propriété BizRuleLanguage de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_bizrulelanguage)<br/>         |
| **Microsoft. Interop. Security. azroles. IAzTask2. Description**<br/>         | Lecture/écriture<br/> | [**Propriété Description de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_description)<br/>                 |
| **Microsoft. Interop. Security. azroles. IAzTask2. IsRoleDefinition**<br/>    | Lecture/écriture<br/> | [**Propriété IsRoleDefinition de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_isroledefinition)<br/>       |
| **Microsoft.Interop.Security.Azroles.IAzTask2.Name**<br/>                | Lecture/écriture<br/> | [**Propriété Name de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_name)<br/>                               |
| **Microsoft. Interop. Security. azroles. IAzTask2. Operations**<br/>          | Lecture seule<br/>  | [**Propriété Operations de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_operations)<br/>                   |
| **Microsoft. Interop. Security. azroles. IAzTask2. Tasks**<br/>               | Lecture seule<br/>  | [**Propriété Tasks de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_tasks)<br/>                             |
| **Microsoft. Interop. Security. azroles. IAzTask2. accessible en écriture**<br/>            | Lecture seule<br/>  | [**Propriété accessible en écriture de IAzTask**](/windows/desktop/api/Azroles/nf-azroles-iaztask-get_writable)<br/>                       |
