---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzRoles.
ms.assetid: 0952c79d-bf8d-45ca-82e5-cba0716d1e5f
title: Interface Microsoft. Interop. Security. AzRoles. IAzRoles
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "117780597"
---
# <a name="microsoftinteropsecurityazrolesiazroles-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzRoles

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzRoles** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzRoles** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzRoles** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzRoles** possède ces propriétés.



| Propriété                                                         | Type d’accès          | Description                                                     |
|:-----------------------------------------------------------------|:---------------------|:----------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzRoles. Count**<br/> | Lecture seule<br/> | [**Propriété Count de IAzRoles**](/windows/desktop/api/Azroles/nf-azroles-iazroles-get_count)<br/> |
| **Microsoft. Interop. Security. azroles. IAzRoles. Item**<br/>  | Lecture seule<br/> | [**Propriété Item de IAzRoles**](/windows/desktop/api/Azroles/nf-azroles-iazroles-get_item)<br/>   |
