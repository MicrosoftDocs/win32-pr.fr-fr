---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzRoleAssignments.
ms.assetid: 7aa691c9-0daa-4956-993f-973eaae081f6
title: Interface Microsoft. Interop. Security. AzRoles. IAzRoleAssignments
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzRoleAssignments** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzRoleAssignments** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzRoleAssignments** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzRoleAssignments** possède ces propriétés.



| Propriété                                                                   | Type d’accès          | Description                                                                         |
|:---------------------------------------------------------------------------|:---------------------|:------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzRoleAssignments. Count**<br/> | Lecture seule<br/> | [**Propriété Count de IAzRoleAssignments**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignments-get_count)<br/> |
| **Microsoft. Interop. Security. azroles. IAzRoleAssignments. Item**<br/>  | Lecture seule<br/> | [**Propriété Item de IAzRoleAssignments**](/windows/desktop/api/Azroles/nf-azroles-iazroleassignments-get_item)<br/>   |
