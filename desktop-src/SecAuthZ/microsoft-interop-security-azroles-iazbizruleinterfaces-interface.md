---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzBizRuleInterfaces.
ms.assetid: 2c9474e3-01d0-412d-9028-89a377d5592d
title: Interface Microsoft. Interop. Security. AzRoles. IAzBizRuleInterfaces
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127009080"
---
# <a name="microsoftinteropsecurityazrolesiazbizruleinterfaces-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzBizRuleInterfaces

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzBizRuleInterfaces** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzBizRuleInterfaces** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzBizRuleInterfaces** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzBizRuleInterfaces** possède ces propriétés.



| Propriété                                                                     | Type d’accès          | Description                                                                                    |
|:-----------------------------------------------------------------------------|:---------------------|:-----------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzBizRuleInterfaces. Count**<br/> | Lecture seule<br/> | [**Propriété Count de IAzBizRuleInterfaces**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleinterfaces-get_count)<br/> |
