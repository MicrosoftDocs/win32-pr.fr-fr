---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzBizRuleParameters.
...
Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzBizRuleParameters** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzBizRuleParameters** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzBizRuleParameters** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzBizRuleParameters** possède ces propriétés.



| Propriété                                                                     | Type d’accès          | Description                                                                                    |
|:-----------------------------------------------------------------------------|:---------------------|:-----------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzBizRuleParameters. Count**<br/> | Lecture seule<br/> | [**Propriété Count de IAzBizRuleParameters**](/windows/desktop/api/Azroles/nf-azroles-iazbizruleparameters-get_count)<br/> |
