...
Les constantes droites de compte précédentes sont définies en tant que chaînes dans Ntsecapi. h. Par exemple, la \_ constante de \_ nom d’ouverture de session interactive se \_ est définie comme « SeInteractiveLogonRight ».
