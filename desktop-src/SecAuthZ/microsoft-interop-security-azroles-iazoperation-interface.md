...
ms.locfileid: "118912878"
---
# <a name="microsoftinteropsecurityazrolesiazoperation-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzOperation

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzOperation** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzOperation** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzOperation** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzOperation** possède ces propriétés.



| Propriété                                                                       | Type d’accès           | Description                                                                                 |
|:-------------------------------------------------------------------------------|:----------------------|:--------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzOperation. ApplicationData**<br/> | Lecture/écriture<br/> | [**Propriété ApplicationData de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_applicationdata)<br/> |
| **Microsoft. Interop. Security. azroles. IAzOperation. Description**<br/>     | Lecture/écriture<br/> | [**Propriété Description de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_description)<br/>         |
| **Microsoft.Interop.Security.Azroles.IAzOperation.Name**<br/>            | Lecture/écriture<br/> | [**Propriété Name de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_name)<br/>                       |
| **Microsoft. Interop. Security. azroles. IAzOperation. OperationID**<br/>     | Lecture/écriture<br/> | [**Propriété OperationID de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_operationid)<br/>         |
| **Microsoft. Interop. Security. azroles. IAzOperation. accessible en écriture**<br/>        | Lecture seule<br/>  | [**Propriété accessible en écriture de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_writable)<br/>               |
