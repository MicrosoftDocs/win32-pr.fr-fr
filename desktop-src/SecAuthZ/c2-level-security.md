---
description: La liste suivante répertorie certaines des exigences les plus importantes de la sécurité de niveau C2, telles que définies par les États-Unis.
...
-   La mémoire doit être protégée afin que son contenu ne puisse pas être lu après qu’un [*processus*](/windows/desktop/SecGloss/p-gly) l’a libérée. De même, un système de fichiers sécurisé, tel que NTFS, doit protéger les fichiers supprimés de la lecture.
