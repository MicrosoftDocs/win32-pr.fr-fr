---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzScopes.
ms.assetid: 1b80b1c0-58a9-401b-9ddb-bd6eb146751e
title: Interface Microsoft. Interop. Security. AzRoles. IAzScopes
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "118912547"
---
# <a name="microsoftinteropsecurityazrolesiazscopes-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzScopes

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzScopes** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzScopes** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzScopes** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzScopes** possède ces propriétés.



| Propriété                                                          | Type d’accès          | Description                                                       |
|:------------------------------------------------------------------|:---------------------|:------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzScopes. Count**<br/> | Lecture seule<br/> | [**Propriété Count de IAzScopes**](/windows/desktop/api/Azroles/nf-azroles-iazscopes-get_count)<br/> |
| **Microsoft. Interop. Security. azroles. IAzScopes. Item**<br/>  | Lecture seule<br/> | [**Propriété Item de IAzScopes**](/windows/desktop/api/Azroles/nf-azroles-iazscopes-get_item)<br/>   |
