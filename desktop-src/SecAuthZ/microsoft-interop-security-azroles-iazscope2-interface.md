---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzScope2.
...
ms.locfileid: "127311325"
---
# <a name="microsoftinteropsecurityazrolesiazscope2-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzScope2

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzScope2** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzScope2** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzScope2** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzScope2** possède ces propriétés.



| Propriété                                                                             | Type d’accès           | Description                                                                                           |
|:-------------------------------------------------------------------------------------|:----------------------|:------------------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzScope2. ApplicationData**<br/>          | Lecture/écriture<br/> | [**Propriété ApplicationData de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_applicationdata)<br/>                   |
| **Microsoft. Interop. Security. azroles. IAzScope2. ApplicationGroups**<br/>        | Lecture seule<br/>  | [**Propriété ApplicationGroups de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_applicationgroups)<br/>               |
| **Microsoft. Interop. Security. azroles. IAzScope2. BizrulesWritable**<br/>         | Lecture seule<br/>  | [**Propriété BizrulesWritable de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_bizruleswritable)<br/>                 |
| **Microsoft. Interop. Security. azroles. IAzScope2. CanBeDelegated**<br/>           | Lecture seule<br/>  | [**Propriété CanBeDelegated de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_canbedelegated)<br/>                     |
| **Microsoft. Interop. Security. azroles. IAzScope2. Description**<br/>              | Lecture/écriture<br/> | [**Propriété Description de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_description)<br/>                           |
| **Microsoft.Interop.Security.Azroles.IAzScope2.Name**<br/>                     | Lecture/écriture<br/> | [**Propriété Name de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_name)<br/>                                         |
| **Microsoft. Interop. Security. azroles. IAzScope2. PolicyAdministrators**<br/>     | Lecture seule<br/>  | [**Propriété PolicyAdministrators de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyadministrators)<br/>         |
| **Microsoft. Interop. Security. azroles. IAzScope2. PolicyAdministratorsName**<br/> | Lecture seule<br/>  | [**Propriété PolicyAdministratorsName de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyadministratorsname)<br/> |
| **Microsoft. Interop. Security. azroles. IAzScope2. PolicyReaders**<br/>            | Lecture seule<br/>  | [**Propriété PolicyReaders de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyreaders)<br/>                       |
| **Microsoft. Interop. Security. azroles. IAzScope2. PolicyReadersName**<br/>        | Lecture seule<br/>  | [**Propriété PolicyReadersName de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_policyreadersname)<br/>               |
| **Microsoft. Interop. Security. azroles. IAzScope2. RoleAssignments**<br/>          | Lecture seule<br/>  | [**Propriété RoleAssignments de IAzScope2**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-get_roleassignments)<br/>                 |
| **Microsoft. Interop. Security. azroles. IAzScope2. RoleDefinitions**<br/>          | Lecture seule<br/>  | [**Propriété RoleDefinitions de IAzScope2**](/windows/desktop/api/Azroles/nf-azroles-iazscope2-get_roledefinitions)<br/>                 |
| **Microsoft. Interop. Security. azroles. IAzScope2. Roles**<br/>                    | Lecture seule<br/>  | [**Propriété Roles de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_roles)<br/>                                       |
| **Microsoft. Interop. Security. azroles. IAzScope2. Tasks**<br/>                    | Lecture seule<br/>  | [**Propriété Tasks de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_tasks)<br/>                                       |
| **Microsoft. Interop. Security. azroles. IAzScope2. accessible en écriture**<br/>                 | Lecture seule<br/>  | [**Propriété accessible en écriture de IAzScope**](/windows/desktop/api/Azroles/nf-azroles-iazscope-get_writable)<br/>                                 |
