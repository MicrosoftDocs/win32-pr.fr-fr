---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzOperation2.
ms.assetid: 4cd47dfe-5760-423a-ab6b-141be0a37f62
title: Interface Microsoft. Interop. Security. AzRoles. IAzOperation2
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "127009062"
---
# <a name="microsoftinteropsecurityazrolesiazoperation2-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzOperation2

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzOperation2** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzOperation2** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzOperation2** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzOperation2** possède ces propriétés.



| Propriété                                                                        | Type d’accès           | Description                                                                                 |
|:--------------------------------------------------------------------------------|:----------------------|:--------------------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzOperation2. ApplicationData**<br/> | Lecture/écriture<br/> | [**Propriété ApplicationData de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_applicationdata)<br/> |
| **Microsoft. Interop. Security. azroles. IAzOperation2. Description**<br/>     | Lecture/écriture<br/> | [**Propriété Description de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_description)<br/>         |
| **Microsoft.Interop.Security.Azroles.IAzOperation2.Name**<br/>            | Lecture/écriture<br/> | [**Propriété Name de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_name)<br/>                       |
| **Microsoft. Interop. Security. azroles. IAzOperation2. OperationID**<br/>     | Lecture/écriture<br/> | [**Propriété OperationID de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_operationid)<br/>         |
| **Microsoft. Interop. Security. azroles. IAzOperation2. accessible en écriture**<br/>        | Lecture seule<br/>  | [**Propriété accessible en écriture de IAzOperation**](/windows/desktop/api/Azroles/nf-azroles-iazoperation-get_writable)<br/>               |
