...
Un processus avec le \_ privilège Take \_ appropriation activé peut se définir comme propriétaire d’un objet. Un processus avec un privilège de nom de restauration de SE \_ \_ activé ou un accès de propriétaire en écriture \_ à l’objet peut définir un SID d’utilisateur ou de groupe valide comme propriétaire d’un objet.
