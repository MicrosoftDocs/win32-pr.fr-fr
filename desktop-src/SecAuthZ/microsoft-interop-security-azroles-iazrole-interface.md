---
description: Liens vers la documentation relative aux méthodes et propriétés du wrapper d’interopérabilité IAzRole.
ms.assetid: 657883c2-f43e-4a6f-b18b-d252a2841b36
title: Interface Microsoft. Interop. Security. AzRoles. IAzRole
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106530444"
---
# <a name="microsoftinteropsecurityazrolesiazrole-interface"></a>Interface Microsoft. Interop. Security. AzRoles. IAzRole

Les méthodes et propriétés du wrapper d’interopérabilité **Microsoft. Interop. Security. azroles. IAzRole** sont documentées sous la version com de la méthode ou de la propriété. Un lien vers la documentation COM de corrélation suit chaque nom de membre.

## <a name="members"></a>Membres

L’interface **Microsoft. Interop. Security. azroles. IAzRole** possède les types de membres suivants :
...
L’interface **Microsoft. Interop. Security. azroles. IAzRole** possède ces méthodes.
...
L’interface **Microsoft. Interop. Security. azroles. IAzRole** possède ces propriétés.



| Propriété                                                                  | Type d’accès           | Description                                                                       |
|:--------------------------------------------------------------------------|:----------------------|:----------------------------------------------------------------------------------|
| **Microsoft. Interop. Security. azroles. IAzRole. ApplicationData**<br/> | Lecture/écriture<br/> | [**Propriété ApplicationData de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_applicationdata)<br/> |
| **Microsoft. Interop. Security. azroles. IAzRole. AppMembers**<br/>      | Lecture seule<br/>  | [**Propriété AppMembers de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_appmembers)<br/>           |
| **Microsoft. Interop. Security. azroles. IAzRole. Description**<br/>     | Lecture/écriture<br/> | [**Propriété Description de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_description)<br/>         |
| **Microsoft. Interop. Security. azroles. IAzRole. Members**<br/>         | Lecture seule<br/>  | [**Propriété Members de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_members)<br/>                 |
| **Microsoft. Interop. Security. azroles. IAzRole. MembersName**<br/>     | Lecture seule<br/>  | [**Propriété MembersName de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_membersname)<br/>         |
| **Microsoft.Interop.Security.Azroles.IAzRole.Name**<br/>            | Lecture/écriture<br/> | [**Propriété Name de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_name)<br/>                       |
| **Microsoft. Interop. Security. azroles. IAzRole. Operations**<br/>      | Lecture seule<br/>  | [**Propriété Operations de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_operations)<br/>           |
| **Microsoft. Interop. Security. azroles. IAzRole. Tasks**<br/>           | Lecture seule<br/>  | [**Propriété Tasks de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_tasks)<br/>                     |
| **Microsoft. Interop. Security. azroles. IAzRole. accessible en écriture**<br/>        | Lecture seule<br/>  | [**Propriété accessible en écriture de IAzRole**](/windows/desktop/api/Azroles/nf-azroles-iazrole-get_writable)<br/>               |
