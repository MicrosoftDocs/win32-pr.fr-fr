...
| Méthode                                   | Description                                                                                                 |
|:-----------------------------------------|:------------------------------------------------------------------------------------------------------------|
| [**Déchiffrer**](envelopeddata-decrypt.md) | Déchiffre le contenu enveloppé.<br/>                                                                      |
| [**Encrypt (Chiffrer)**](envelopeddata-encrypt.md) | Chiffre le contenu, chiffre une clé de session pour chaque destinataire et retourne l’objet BLOB chiffré.<br/> |
