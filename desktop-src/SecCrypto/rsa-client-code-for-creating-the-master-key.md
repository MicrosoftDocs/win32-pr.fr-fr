---
description: L’exemple suivant montre le code standard RSA/SChannel côté client pour la création d’une clé principale.
ms.assetid: 9ce4877f-e6e6-4b94-9503-092d2702b31f
title: Code client RSA pour la création de la clé principale
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106515862"
---
# <a name="rsa-client-code-for-creating-the-master-key"></a><span data-ttu-id="ce96d-103">Code client RSA pour la création de la clé principale</span><span class="sxs-lookup"><span data-stu-id="ce96d-103">RSA Client Code for Creating the Master Key</span></span>

<span data-ttu-id="ce96d-104">L’exemple suivant montre le code standard RSA/SChannel côté client pour la création d’une [*clé principale*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="ce96d-104">The following example shows typical RSA/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
