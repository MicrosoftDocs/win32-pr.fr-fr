...
---
# <a name="rsa-client-code-for-creating-the-master-key"></a>Code client RSA pour la création de la clé principale

L’exemple suivant montre le code standard RSA/SChannel côté client pour la création d’une [*clé principale*](../secgloss/m-gly.md).
