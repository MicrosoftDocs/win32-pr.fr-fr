...
Du code supplémentaire peut être ajouté pour afficher les certificats ajoutés en tant que destinataires du message, pour vérifier ces certificats avant d’être ajoutés en tant que destinataires prévus, ou pour choisir ceux qui doivent être ajoutés.
