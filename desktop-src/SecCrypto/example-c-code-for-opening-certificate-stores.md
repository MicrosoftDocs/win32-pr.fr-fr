---
description: Les exemples suivants fournissent du code pour ouvrir un grand nombre de magasins de certificats courants. Ces exemples sont une série de fragments de code et ne sont pas des programmes autonomes.
...
ms.locfileid: "103862846"
---
# <a name="example-c-code-for-opening-certificate-stores"></a><span data-ttu-id="b5702-104">Exemple de code C pour ouvrir des magasins de certificats</span><span class="sxs-lookup"><span data-stu-id="b5702-104">Example C Code for Opening Certificate Stores</span></span>

<span data-ttu-id="b5702-105">Les exemples suivants fournissent du code pour ouvrir un grand nombre de magasins de certificats courants.</span><span class="sxs-lookup"><span data-stu-id="b5702-105">The following examples provide code to open a variety of common certificate stores.</span></span> <span data-ttu-id="b5702-106">Ces exemples sont une série de fragments de code et ne sont pas des programmes autonomes.</span><span class="sxs-lookup"><span data-stu-id="b5702-106">These examples are a series of code fragments and are not stand-alone programs.</span></span>

<span data-ttu-id="b5702-107">L’exemple suivant ouvre le magasin mon système.</span><span class="sxs-lookup"><span data-stu-id="b5702-107">The following example opens the My system store.</span></span>
...
<span data-ttu-id="b5702-108">L’exemple suivant ouvre un magasin de mémoire.</span><span class="sxs-lookup"><span data-stu-id="b5702-108">The following example opens a memory store.</span></span>
...
<span data-ttu-id="b5702-109">L’exemple suivant ouvre un magasin à partir du disque.</span><span class="sxs-lookup"><span data-stu-id="b5702-109">The following example opens a store from disk.</span></span> <span data-ttu-id="b5702-110">L’exemple utilise la fonction **CreateMyDACL** , définie dans la rubrique [création d’une liste DACL](../secbp/creating-a-dacl.md) , pour s’assurer que le fichier ouvert est créé avec une liste DACL appropriée.</span><span class="sxs-lookup"><span data-stu-id="b5702-110">The example uses the **CreateMyDACL** function, defined in the [Creating a DACL](../secbp/creating-a-dacl.md) topic, to ensure the open file is created with a proper DACL.</span></span>
...
<span data-ttu-id="b5702-111">L’exemple suivant ouvre un magasin basé sur des fichiers à l’aide du nom de fichier \_ du magasin de certificats \_ \_ .</span><span class="sxs-lookup"><span data-stu-id="b5702-111">The following example opens a file-based store using CERT\_STORE\_PROV\_FILENAME.</span></span>
...
<span data-ttu-id="b5702-112">L’exemple suivant ouvre un magasin de collections.</span><span class="sxs-lookup"><span data-stu-id="b5702-112">The following example opens a collection store.</span></span>
...
<span data-ttu-id="b5702-113">L’exemple suivant ouvre un magasin de registres.</span><span class="sxs-lookup"><span data-stu-id="b5702-113">The following example opens a register store.</span></span>
...
<span data-ttu-id="b5702-114">L’exemple suivant ouvre un magasin de certificats basé sur un \# message PKCS 7.</span><span class="sxs-lookup"><span data-stu-id="b5702-114">The following example opens a certificate store based on a PKCS \#7 message.</span></span>
