...
Les exemples suivants fournissent du code pour ouvrir un grand nombre de magasins de certificats courants. Ces exemples sont une série de fragments de code et ne sont pas des programmes autonomes.

L’exemple suivant ouvre le magasin mon système.
...
L’exemple suivant ouvre un magasin de mémoire.
...
L’exemple suivant ouvre un magasin à partir du disque. L’exemple utilise la fonction **CreateMyDACL** , définie dans la rubrique [création d’une liste DACL](../secbp/creating-a-dacl.md) , pour s’assurer que le fichier ouvert est créé avec une liste DACL appropriée.
...
L’exemple suivant ouvre un magasin basé sur des fichiers à l’aide du nom de fichier \_ du magasin de certificats \_ \_ .
...
L’exemple suivant ouvre un magasin de collections.
...
L’exemple suivant ouvre un magasin de registres.
...
L’exemple suivant ouvre un magasin de certificats basé sur un \# message PKCS 7.
