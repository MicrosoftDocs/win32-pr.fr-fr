...
ms.locfileid: "106540882"
---
# <a name="example-c-program-creating-a-certificate-chain"></a><span data-ttu-id="7dc91-104">Exemple de programme C : création d’une chaîne de certificats</span><span class="sxs-lookup"><span data-stu-id="7dc91-104">Example C Program: Creating a Certificate Chain</span></span>

<span data-ttu-id="7dc91-105">L’exemple suivant crée et installe un moteur de chaîne de certificats qui n’est pas un moteur par défaut.</span><span class="sxs-lookup"><span data-stu-id="7dc91-105">The following example creates and installs a nondefault certificate chain engine.</span></span> <span data-ttu-id="7dc91-106">Le moteur est utilisé pour créer des chaînes de certificats pour chacun des certificats dans un [*magasin de certificats*](../secgloss/c-gly.md).</span><span class="sxs-lookup"><span data-stu-id="7dc91-106">The engine is used to build certificate chains for each of the certificates in a [*certificate store*](../secgloss/c-gly.md).</span></span>

<span data-ttu-id="7dc91-107">Cet exemple illustre les tâches et les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :</span><span class="sxs-lookup"><span data-stu-id="7dc91-107">This example illustrates the following tasks and [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   <span data-ttu-id="7dc91-108">Préparation de la création d’un moteur de chaîne de certificats non par défaut en déclarant et en initialisant une structure de données de [**configuration du moteur de chaîne de certificats \_ \_ \_**](/windows/desktop/api/Wincrypt/ns-wincrypt-cert_chain_engine_config) .</span><span class="sxs-lookup"><span data-stu-id="7dc91-108">Preparing to create a nondefault certificate chain engine by declaring and initializing a [**CERT\_CHAIN\_ENGINE\_CONFIG**](/windows/desktop/api/Wincrypt/ns-wincrypt-cert_chain_engine_config) data structure.</span></span>
-   <span data-ttu-id="7dc91-109">Création du moteur de recherche à l’aide de [**CertCreateCertificateChainEngine**](/windows/desktop/api/Wincrypt/nf-wincrypt-certcreatecertificatechainengine).</span><span class="sxs-lookup"><span data-stu-id="7dc91-109">Creating the search engine using [**CertCreateCertificateChainEngine**](/windows/desktop/api/Wincrypt/nf-wincrypt-certcreatecertificatechainengine).</span></span>
-   <span data-ttu-id="7dc91-110">À l’aide de [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea) pour ouvrir le magasin mon système.</span><span class="sxs-lookup"><span data-stu-id="7dc91-110">Using [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea) to open the My system store.</span></span>
-   <span data-ttu-id="7dc91-111">Récupération de tous les certificats du magasin ouvert à l’aide de [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) dans une boucle.</span><span class="sxs-lookup"><span data-stu-id="7dc91-111">Retrieving all of the certificates from the open store using [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) in a loop.</span></span>
-   <span data-ttu-id="7dc91-112">Pour chaque certificat dans le magasin ouvert, récupérez le nom du sujet à partir du certificat à l’aide de [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span><span class="sxs-lookup"><span data-stu-id="7dc91-112">For each certificate in the open store, retrieving the subject name from the certificate using [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span></span>
-   <span data-ttu-id="7dc91-113">Création d’une chaîne de certificats pour chaque certificat à l’aide de [**CertGetCertificateChain**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatechain).</span><span class="sxs-lookup"><span data-stu-id="7dc91-113">Building a certificate chain for each certificate using [**CertGetCertificateChain**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatechain).</span></span>
-   <span data-ttu-id="7dc91-114">Création d’un doublon de la chaîne de certificats à l’aide de [**CertDuplicateCertificateChain**](/windows/desktop/api/Wincrypt/nf-wincrypt-certduplicatecertificatechain).</span><span class="sxs-lookup"><span data-stu-id="7dc91-114">Creating a duplicate of the certificate chain using [**CertDuplicateCertificateChain**](/windows/desktop/api/Wincrypt/nf-wincrypt-certduplicatecertificatechain).</span></span>
-   <span data-ttu-id="7dc91-115">Utilisation de [**CertFreeCertificateChain**](/windows/desktop/api/Wincrypt/nf-wincrypt-certfreecertificatechain) pour libérer chaque chaîne avant la génération de la chaîne suivante.</span><span class="sxs-lookup"><span data-stu-id="7dc91-115">Using [**CertFreeCertificateChain**](/windows/desktop/api/Wincrypt/nf-wincrypt-certfreecertificatechain) to release each chain before the next chain is built.</span></span>
