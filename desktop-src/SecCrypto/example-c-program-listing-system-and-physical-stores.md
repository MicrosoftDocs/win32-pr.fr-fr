---
description: Énumère les emplacements du magasin de certificats système, les magasins de certificats système et les magasins physiques associés à chaque magasin système.
ms.assetid: bc4268ea-f657-4789-9d0a-6e5354508f86
title: 'Exemple de programme C : liste des magasins système et physiques'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106522089"
---
# <a name="example-c-program-listing-system-and-physical-stores"></a><span data-ttu-id="93312-103">Exemple de programme C : liste des magasins système et physiques</span><span class="sxs-lookup"><span data-stu-id="93312-103">Example C Program: Listing System and Physical Stores</span></span>

<span data-ttu-id="93312-104">L’exemple suivant énumère les emplacements du [*magasin de certificats*](../secgloss/c-gly.md) système, les magasins de certificats système et les magasins physiques associés à chaque magasin système.</span><span class="sxs-lookup"><span data-stu-id="93312-104">The following example enumerates the system [*certificate store*](../secgloss/c-gly.md) locations, the system certificate stores, and the physical stores associated with each system store.</span></span> <span data-ttu-id="93312-105">Cet exemple illustre la création de fonctions de rappel et de fonctions de rappel qui appellent d’autres fonctions de rappel.</span><span class="sxs-lookup"><span data-stu-id="93312-105">This example demonstrates the creation of callback functions and callback functions that call other callback functions.</span></span>

<span data-ttu-id="93312-106">Cet exemple illustre les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :</span><span class="sxs-lookup"><span data-stu-id="93312-106">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="93312-107">**CertEnumSystemStoreLocation**</span><span class="sxs-lookup"><span data-stu-id="93312-107">**CertEnumSystemStoreLocation**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstorelocation)
-   [<span data-ttu-id="93312-108">**CertEnumSystemStore**</span><span class="sxs-lookup"><span data-stu-id="93312-108">**CertEnumSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumsystemstore)

<span data-ttu-id="93312-109">Cet exemple utilise également la fonction [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="93312-109">This example also uses the function [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="93312-110">Le code de cette fonction est inclus dans l’exemple.</span><span class="sxs-lookup"><span data-stu-id="93312-110">Code for this function is included with the sample.</span></span> <span data-ttu-id="93312-111">Le code pour cette fonction et d’autres fonctions auxiliaires est également listé sous [usage général Functions](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="93312-111">Code for this and other auxiliary functions is also listed under [General Purpose Functions](general-purpose-functions.md).</span></span>
