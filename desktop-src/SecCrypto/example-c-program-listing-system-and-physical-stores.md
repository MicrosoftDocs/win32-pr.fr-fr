...
ms.locfileid: "119007637"
---
# <a name="example-c-program-listing-system-and-physical-stores"></a>Exemple de programme C : liste des magasins système et physiques

L’exemple suivant énumère les emplacements du [*magasin de certificats*](../secgloss/c-gly.md) système, les magasins de certificats système et les magasins physiques associés à chaque magasin système. Cet exemple illustre la création de fonctions de rappel et de fonctions de rappel qui appellent d’autres fonctions de rappel.

Cet exemple illustre les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :
...
Cet exemple utilise également la fonction [**MyHandleError**](myhandleerror.md). Le code de cette fonction est inclus dans l’exemple. Le code pour cette fonction et d’autres fonctions auxiliaires est également listé sous [usage général Functions](general-purpose-functions.md).
