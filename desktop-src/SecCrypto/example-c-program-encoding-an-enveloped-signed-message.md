...
ms.locfileid: "127121069"
---
# <a name="example-c-program-encoding-an-enveloped-signed-message"></a>Exemple de programme C : encodage d’un message signé et enveloppé

L’exemple suivant crée, signe et enveloppe un message, et illustre les tâches et les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :

-   Acquisition du descripteur d’un CSP à l’aide de [**CryptAcquireContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta).
-   Ouverture d’un magasin système à l’aide de [**CertOpenStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopenstore).
-   Recherche d’un signataire et de certificats de destinataire à l’aide de [**CertFindCertificateInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore).
-   Initialisation des structures de données appropriées pour la signature d’un message enveloppé.
-   Recherche de la longueur du message enveloppé à l’aide de [**CryptMsgCalculateEncodedLength**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength).
-   Création et signature du message à l’aide de [**CryptMsgOpenToEncode**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode), [**CryptMsgUpdate**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)et [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam).
-   Enveloppe du message signé et encodé pour un récepteur à l’aide de [**CryptMsgOpenToEncode**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode), [**CryptMsgUpdate**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)et [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam).

Cet exemple échoue si une clé privée utilisable n’existe pas dans le conteneur de [*clé*](../secgloss/k-gly.md)par défaut. Si la clé privée requise n’est pas disponible, vous pouvez utiliser le code utilisant [**CryptAcquireCertificatePrivateKey**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecertificateprivatekey), comme illustré dans l’exemple de code [exemple de programme C : envoi et réception d’un message signé et chiffré](example-c-program-sending-and-receiving-a-signed-and-encrypted-message.md).
