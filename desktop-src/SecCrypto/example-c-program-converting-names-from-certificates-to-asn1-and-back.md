...
---
# <a name="example-c-program-converting-names-from-certificates-to-asn1-and-back"></a>Exemple de programme C : conversion de noms de certificats en ASN. 1 et back

L’exemple suivant énumère les certificats dans un [*magasin de certificats*](../secgloss/c-gly.md), affiche l’objet et l’utilisateur de chaque certificat, puis convertit le nom du sujet de chaque certificat en sa forme codée ASN. 1 ( [*Abstract Syntax Notation One*](../secgloss/a-gly.md) ), puis revient à sa forme décodée.

Cet exemple montre les tâches et les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :
...
-   Utilisation de [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) pour récupérer le premier certificat du magasin ouvert.
-   À l’aide de [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa) pour récupérer le nom d’objet et le nom d’utilisateur à partir du certificat.
-   À l’aide de [**CertNameToStr**](/windows/desktop/api/Wincrypt/nf-wincrypt-certnametostra) pour convertir le nom du sujet du certificat en sa forme encodée ASN. 1.
-   Utilisation de [**CertStrToName**](/windows/desktop/api/Wincrypt/nf-wincrypt-certstrtonamea) pour convertir une chaîne encodée ASN. 1 en sa forme décodée.
-   Fermeture d’un magasin de certificats à l’aide de [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) avec l’indicateur de fermeture de l’indicateur de **\_ \_ \_ validation \_ du magasin** de certificats.
