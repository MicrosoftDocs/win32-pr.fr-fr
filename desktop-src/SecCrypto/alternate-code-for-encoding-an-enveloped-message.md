---
description: L’exemple suivant illustre un autre processus d’encodage d’un message signé, en utilisant ce message signé comme contenu interne pour un message enveloppé. En préparation du décodage, le contenu interne est testé pour déterminer son type de contenu interne.
ms.assetid: ba174e3c-bc2f-48bd-a1bf-fec491dc0ce3
title: Autre code pour l’encodage d’un message enveloppé
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106522090"
---
# <a name="alternate-code-for-encoding-an-enveloped-message"></a><span data-ttu-id="84e41-104">Autre code pour l’encodage d’un message enveloppé</span><span class="sxs-lookup"><span data-stu-id="84e41-104">Alternate Code for Encoding an Enveloped Message</span></span>

<span data-ttu-id="84e41-105">L’exemple suivant illustre un autre processus d’encodage d’un message signé, en utilisant ce message signé comme [*contenu interne*](../secgloss/i-gly.md) pour un message enveloppé.</span><span class="sxs-lookup"><span data-stu-id="84e41-105">The following example demonstrates an alternate process of encoding a signed message, using that signed message as the [*inner content*](../secgloss/i-gly.md) for an enveloped message.</span></span> <span data-ttu-id="84e41-106">En préparation du décodage, le contenu interne est testé pour déterminer son type de contenu interne.</span><span class="sxs-lookup"><span data-stu-id="84e41-106">In preparation for decoding, the inner content is tested to determine its inner-content type.</span></span>

<span data-ttu-id="84e41-107">Cet exemple illustre les fonctions CryptoAPI suivantes :</span><span class="sxs-lookup"><span data-stu-id="84e41-107">This example illustrates the following CryptoAPI functions:</span></span>

-   [<span data-ttu-id="84e41-108">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="84e41-108">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="84e41-109">**CertOpenSystemStore**</span><span class="sxs-lookup"><span data-stu-id="84e41-109">**CertOpenSystemStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea)
-   [<span data-ttu-id="84e41-110">**CryptMsgCalculateEncodedLength**</span><span class="sxs-lookup"><span data-stu-id="84e41-110">**CryptMsgCalculateEncodedLength**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength)
-   [<span data-ttu-id="84e41-111">**CryptMsgOpenToEncode**</span><span class="sxs-lookup"><span data-stu-id="84e41-111">**CryptMsgOpenToEncode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode)
-   [<span data-ttu-id="84e41-112">**CryptMsgUpdate**</span><span class="sxs-lookup"><span data-stu-id="84e41-112">**CryptMsgUpdate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate)
-   [<span data-ttu-id="84e41-113">**CryptMsgGetParam**</span><span class="sxs-lookup"><span data-stu-id="84e41-113">**CryptMsgGetParam**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam)
-   [<span data-ttu-id="84e41-114">**CryptMsgOpenToDecode**</span><span class="sxs-lookup"><span data-stu-id="84e41-114">**CryptMsgOpenToDecode**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentodecode)
-   [<span data-ttu-id="84e41-115">**CertFindCertificateInStore**</span><span class="sxs-lookup"><span data-stu-id="84e41-115">**CertFindCertificateInStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certfindcertificateinstore)
-   [<span data-ttu-id="84e41-116">**CryptMsgClose**</span><span class="sxs-lookup"><span data-stu-id="84e41-116">**CryptMsgClose**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose)
-   [<span data-ttu-id="84e41-117">**CertCloseStore**</span><span class="sxs-lookup"><span data-stu-id="84e41-117">**CertCloseStore**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore)
-   [<span data-ttu-id="84e41-118">**CryptReleaseContext**</span><span class="sxs-lookup"><span data-stu-id="84e41-118">**CryptReleaseContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptreleasecontext)

<span data-ttu-id="84e41-119">Cet exemple utilise également les fonctions [**MyHandleError**](myhandleerror.md) et [**GetSignerCert**](getsignercert.md).</span><span class="sxs-lookup"><span data-stu-id="84e41-119">This example also uses the functions [**MyHandleError**](myhandleerror.md) and [**GetSignerCert**](getsignercert.md).</span></span> <span data-ttu-id="84e41-120">Le code C de ces fonctions est inclus dans l’exemple.</span><span class="sxs-lookup"><span data-stu-id="84e41-120">C code for these functions is included with the example.</span></span> <span data-ttu-id="84e41-121">Pour obtenir du code qui illustre ces fonctions et d’autres fonctions auxiliaires, consultez [usage général Functions](general-purpose-functions.md).</span><span class="sxs-lookup"><span data-stu-id="84e41-121">For code that demonstrates these and other auxiliary functions, see [General Purpose Functions](general-purpose-functions.md).</span></span>
