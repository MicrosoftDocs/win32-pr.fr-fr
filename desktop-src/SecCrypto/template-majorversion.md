...
---
# <a name="templatemajorversion-property"></a>Template. MajorVersion, propriété
...
La propriété **MajorVersion** récupère le numéro de version principale du modèle.
...
Numéro de version principale du modèle.
