...
---
# <a name="example-c-program-getting-and-setting-certificate-properties"></a>Exemple de programme C : obtention et définition des propriétés de certificat

L’exemple suivant obtient et définit les propriétés de certificat, et illustre les tâches et les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes.
...
-   Utilisation de [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) pour répertorier tous les certificats dans le magasin ouvert.
-   Récupération et impression du nom du sujet à partir du certificat à l’aide de [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).
-   Définition de la propriété [*utilisation améliorée*](../secgloss/e-gly.md) de la clé sur les certificats à l’aide de la fonction [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) .
-   Définition de la propriété nom complet sur le certificat à l’aide de [**CertSetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty).
-   Récupération des propriétés d’un certificat à l’aide de [**CertGetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty).
-   Fermeture d’un magasin de certificats à l’aide de [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) avec l’indicateur de fermeture de l’indicateur de validation du magasin de certificats \_ \_ \_ \_ .
