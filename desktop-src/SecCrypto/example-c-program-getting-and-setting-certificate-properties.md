---
description: Obtient et définit les propriétés du certificat, et illustre les tâches et les fonctions CryptoAPI suivantes.
ms.assetid: 4cc20a59-d8e9-4c9b-9438-21bccbbe4a64
title: 'Exemple de programme C : obtention et définition des propriétés de certificat'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104035206"
---
# <a name="example-c-program-getting-and-setting-certificate-properties"></a><span data-ttu-id="08378-103">Exemple de programme C : obtention et définition des propriétés de certificat</span><span class="sxs-lookup"><span data-stu-id="08378-103">Example C Program: Getting and Setting Certificate Properties</span></span>

<span data-ttu-id="08378-104">L’exemple suivant obtient et définit les propriétés de certificat, et illustre les tâches et les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes.</span><span class="sxs-lookup"><span data-stu-id="08378-104">The following example gets and sets certificate properties, and illustrates the following tasks and [*CryptoAPI*](../secgloss/c-gly.md) functions.</span></span>

-   <span data-ttu-id="08378-105">Ouverture d’un magasin système à l’aide de [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea).</span><span class="sxs-lookup"><span data-stu-id="08378-105">Opening a system store by using [**CertOpenSystemStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certopensystemstorea).</span></span>
-   <span data-ttu-id="08378-106">Utilisation de [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) pour répertorier tous les certificats dans le magasin ouvert.</span><span class="sxs-lookup"><span data-stu-id="08378-106">Using [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore) to list all of the certificates in the open store.</span></span>
-   <span data-ttu-id="08378-107">Récupération et impression du nom du sujet à partir du certificat à l’aide de [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span><span class="sxs-lookup"><span data-stu-id="08378-107">Retrieving and printing the subject name from the certificate by using [**CertGetNameString**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetnamestringa).</span></span>
-   <span data-ttu-id="08378-108">Définition de la propriété [*utilisation améliorée*](../secgloss/e-gly.md) de la clé sur les certificats à l’aide de la fonction [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) .</span><span class="sxs-lookup"><span data-stu-id="08378-108">Setting the [*enhanced key usage*](../secgloss/e-gly.md) property on certificates by using the [**CertAddEnhancedKeyUsageIdentifier**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddenhancedkeyusageidentifier) function.</span></span>
-   <span data-ttu-id="08378-109">Définition de la propriété nom complet sur le certificat à l’aide de [**CertSetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty).</span><span class="sxs-lookup"><span data-stu-id="08378-109">Setting the display name property on the certificate by using [**CertSetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certsetcertificatecontextproperty).</span></span>
-   <span data-ttu-id="08378-110">Récupération des propriétés d’un certificat à l’aide de [**CertGetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty).</span><span class="sxs-lookup"><span data-stu-id="08378-110">Retrieving a certificate's properties by using [**CertGetCertificateContextProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-certgetcertificatecontextproperty).</span></span>
-   <span data-ttu-id="08378-111">Fermeture d’un magasin de certificats à l’aide de [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) avec l’indicateur de fermeture de l’indicateur de validation du magasin de certificats \_ \_ \_ \_ .</span><span class="sxs-lookup"><span data-stu-id="08378-111">Closing a certificate store by using [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) with the CERT\_CLOSE\_STORE\_CHECK\_FLAG flag.</span></span>
