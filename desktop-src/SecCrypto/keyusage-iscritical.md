...
La propriété **IsCritical** récupère une valeur booléenne qui indique si l’extension KeyUsage est marquée comme critique.
...
Si la **valeur est true**, l’extension KeyUsage est marquée comme critique.
