---
description: Montre l’utilisation de CryptEncodeObjectEx et CryptDecodeObjectEx.
ms.assetid: 78108cd5-531e-4d0c-96cf-6f6264b7716c
title: 'Exemple de programme C : codage et décodage ASN. 1'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104034948"
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a><span data-ttu-id="796c5-103">Exemple de programme C : codage et décodage ASN. 1</span><span class="sxs-lookup"><span data-stu-id="796c5-103">Example C Program: ASN.1 Encoding and Decoding</span></span>

<span data-ttu-id="796c5-104">L’exemple suivant illustre l’utilisation de [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) et [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span><span class="sxs-lookup"><span data-stu-id="796c5-104">The following example shows using [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) and [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex).</span></span> <span data-ttu-id="796c5-105">Cet exemple peut être facilement modifié pour utiliser [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) et [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span><span class="sxs-lookup"><span data-stu-id="796c5-105">This example can easily be modified to use [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) and [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).</span></span>

<span data-ttu-id="796c5-106">Cet exemple utilise également une version modifiée de la fonction [**ByteToStr**](bytetostr.md) pour imprimer une série d’octets encodée ASN. 1 ( [*Abstract Syntax Notation One*](../secgloss/a-gly.md) ).</span><span class="sxs-lookup"><span data-stu-id="796c5-106">This example also uses a modified version of the function [**ByteToStr**](bytetostr.md) to print an [*Abstract Syntax Notation One*](../secgloss/a-gly.md) (ASN.1) encoded series of octets.</span></span> <span data-ttu-id="796c5-107">Il utilise également [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="796c5-107">It also uses [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="796c5-108">Le code de ces fonctions est inclus dans l’exemple.</span><span class="sxs-lookup"><span data-stu-id="796c5-108">Code for these functions is included with the sample.</span></span>
