...
ms.locfileid: "119874009"
---
# <a name="example-c-program-asn1-encoding-and-decoding"></a>Exemple de programme C : codage et décodage ASN. 1

L’exemple suivant illustre l’utilisation de [**CryptEncodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobjectex) et [**CryptDecodeObjectEx**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobjectex). Cet exemple peut être facilement modifié pour utiliser [**CryptEncodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject) et [**CryptDecodeObject**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptdecodeobject).

Cet exemple utilise également une version modifiée de la fonction [**ByteToStr**](bytetostr.md) pour imprimer une série d’octets encodée ASN. 1 ( [*Abstract Syntax Notation One*](../secgloss/a-gly.md) ). Il utilise également [**MyHandleError**](myhandleerror.md). Le code de ces fonctions est inclus dans l’exemple.
