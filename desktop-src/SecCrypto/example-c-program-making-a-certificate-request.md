...
ms.locfileid: "127121030"
---
# <a name="example-c-program-making-a-certificate-request"></a>Exemple de programme C : demande de certificat

L’exemple suivant illustre la procédure décrite dans la section précédente. Cet exemple crée une [*demande de certificat*](../secgloss/c-gly.md) simple avec un seul signataire, un seul [*attribut*](../secgloss/a-gly.md)de [*nom unique relatif*](../secgloss/r-gly.md) (RDN) et aucun attribut général.
...
Cet exemple utilise également les fonctions [**ByteToStr**](bytetostr.md) et [**MyHandleError**](myhandleerror.md). Le code de ces fonctions est inclus dans l’exemple. [Usage général fonctions](general-purpose-functions.md) répertorie le code pour ces fonctions auxiliaires et d’autres.
