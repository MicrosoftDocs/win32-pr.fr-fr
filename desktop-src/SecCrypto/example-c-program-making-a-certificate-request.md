---
description: L’exemple suivant illustre la procédure décrite dans la section précédente. Cet exemple crée une demande de certificat simple avec un seul signataire, un seul attribut de nom unique relatif (RDN) et aucun attribut général.
ms.assetid: bd3d0259-f0e8-460e-9f18-95d2492da3d8
title: 'Exemple de programme C : demande de certificat'
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104529572"
---
# <a name="example-c-program-making-a-certificate-request"></a><span data-ttu-id="5f0d3-104">Exemple de programme C : demande de certificat</span><span class="sxs-lookup"><span data-stu-id="5f0d3-104">Example C Program: Making a Certificate Request</span></span>

<span data-ttu-id="5f0d3-105">L’exemple suivant illustre la procédure décrite dans la section précédente.</span><span class="sxs-lookup"><span data-stu-id="5f0d3-105">The following example demonstrates the procedure outlined in the previous section.</span></span> <span data-ttu-id="5f0d3-106">Cet exemple crée une [*demande de certificat*](../secgloss/c-gly.md) simple avec un seul signataire, un seul [*attribut*](../secgloss/a-gly.md)de [*nom unique relatif*](../secgloss/r-gly.md) (RDN) et aucun attribut général.</span><span class="sxs-lookup"><span data-stu-id="5f0d3-106">This example creates a simple [*certificate request*](../secgloss/c-gly.md) with one signer, a single [*relative distinguished name*](../secgloss/r-gly.md) (RDN) [*attribute*](../secgloss/a-gly.md), and no general attributes.</span></span>

<span data-ttu-id="5f0d3-107">Cet exemple illustre les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :</span><span class="sxs-lookup"><span data-stu-id="5f0d3-107">This example illustrates the following [*CryptoAPI*](../secgloss/c-gly.md) functions:</span></span>

-   [<span data-ttu-id="5f0d3-108">**CryptEncodeObject**</span><span class="sxs-lookup"><span data-stu-id="5f0d3-108">**CryptEncodeObject**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptencodeobject)
-   [<span data-ttu-id="5f0d3-109">**CryptAcquireContext**</span><span class="sxs-lookup"><span data-stu-id="5f0d3-109">**CryptAcquireContext**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta)
-   [<span data-ttu-id="5f0d3-110">**CryptExportPublicKeyInfo**</span><span class="sxs-lookup"><span data-stu-id="5f0d3-110">**CryptExportPublicKeyInfo**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptexportpublickeyinfo)
-   [<span data-ttu-id="5f0d3-111">**CryptSignAndEncodeCertificate**</span><span class="sxs-lookup"><span data-stu-id="5f0d3-111">**CryptSignAndEncodeCertificate**</span></span>](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsignandencodecertificate)

<span data-ttu-id="5f0d3-112">Cet exemple utilise également les fonctions [**ByteToStr**](bytetostr.md) et [**MyHandleError**](myhandleerror.md).</span><span class="sxs-lookup"><span data-stu-id="5f0d3-112">This example also uses the functions [**ByteToStr**](bytetostr.md) and [**MyHandleError**](myhandleerror.md).</span></span> <span data-ttu-id="5f0d3-113">Le code de ces fonctions est inclus dans l’exemple.</span><span class="sxs-lookup"><span data-stu-id="5f0d3-113">Code for these functions is included with the sample.</span></span> <span data-ttu-id="5f0d3-114">[Usage général fonctions](general-purpose-functions.md) répertorie le code pour ces fonctions auxiliaires et d’autres.</span><span class="sxs-lookup"><span data-stu-id="5f0d3-114">[General Purpose Functions](general-purpose-functions.md) lists code for these and other auxiliary functions.</span></span>
