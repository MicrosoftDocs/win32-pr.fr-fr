...
---
# <a name="rsa-server-code-for-creating-the-master-key"></a><span data-ttu-id="f981a-103">Code du serveur RSA pour la création de la clé principale</span><span class="sxs-lookup"><span data-stu-id="f981a-103">RSA Server Code for Creating the Master Key</span></span>

<span data-ttu-id="f981a-104">L’exemple suivant montre le code standard RSA/SChannel côté serveur pour la création d’une [*clé principale*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="f981a-104">The following example shows typical RSA/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
