---
description: L’exemple suivant montre le code par défaut Diffie-Hellman/Schannel côté serveur pour la création d’une clé principale.
ms.assetid: 1ef0a2ea-8684-425c-abfe-9f65d8df7bbd
title: Diffie-Hellman du code serveur pour la création de la clé principale
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106531935"
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a><span data-ttu-id="9c62c-103">Diffie-Hellman du code serveur pour la création de la clé principale</span><span class="sxs-lookup"><span data-stu-id="9c62c-103">Diffie-Hellman Server Code for Creating the Master Key</span></span>

<span data-ttu-id="9c62c-104">L’exemple suivant illustre le code côté serveur/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)standard pour la création d’une [*clé principale*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="9c62c-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel server-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
