...
ms.locfileid: "117767622"
---
# <a name="diffie-hellman-server-code-for-creating-the-master-key"></a>Diffie-Hellman du code serveur pour la création de la clé principale

L’exemple suivant illustre le code côté serveur/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)standard pour la création d’une [*clé principale*](../secgloss/m-gly.md).
