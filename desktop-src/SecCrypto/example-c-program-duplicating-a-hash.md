...
ms.locfileid: "127228948"
---
# <a name="example-c-program-duplicating-a-hash"></a>Exemple de programme C : duplication d’un hachage

L’exemple suivant crée et duplique un [*hachage*](../secgloss/h-gly.md) d’un texte. Il ajoute ensuite du texte supplémentaire au hachage d’origine et à un autre texte dans le doublon.
...
Cet exemple utilise la fonction [**MyHandleError**](myhandleerror.md). Le code pour cette fonction est inclus à la fin de l’exemple. Le code pour cette fonction et d’autres fonctions auxiliaires est également listé sous [usage général Functions](general-purpose-functions.md).
