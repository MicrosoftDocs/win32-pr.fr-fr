...
-   Récupération d’un certificat à partir d’un magasin à l’aide de [**CertEnumCertificatesInStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certenumcertificatesinstore).
...
-   Création d’une forme sérialisée d’un [*contexte de certificat*](../secgloss/c-gly.md) et de ses propriétés à l’aide de [**CertSerializeCertificateStoreElement**](/windows/desktop/api/Wincrypt/nf-wincrypt-certserializecertificatestoreelement).
-   Création d’un nouveau certificat à partir d’une chaîne sérialisée et ajout de celui-ci dans un magasin de certificats à l’aide de [**CertAddSerializedElementToStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddserializedelementtostore).
-   Utilisation de [**CertAddEncodedCertificateToStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certaddencodedcertificatetostore) pour créer un nouveau certificat à partir de la partie encodée d’un certificat existant.
-   Utilisation de [**CertCloseStore**](/windows/desktop/api/Wincrypt/nf-wincrypt-certclosestore) pour fermer un magasin de certificats.
