---
description: L’exemple de code VBScript suivant montre comment le contrôle d’inscription de certificat peut être utilisé avec l’objet CCertRequest pour créer et envoyer une demande de certificat.
ms.assetid: be1bc66a-7bc5-4369-9344-168af53fdfb9
title: Exemple de demande dans VBScript
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "106535596"
---
# <a name="request-sample-in-vbscript"></a><span data-ttu-id="445b9-103">Exemple de demande dans VBScript</span><span class="sxs-lookup"><span data-stu-id="445b9-103">Request Sample in VBScript</span></span>

<span data-ttu-id="445b9-104">L’exemple de code VBScript suivant montre comment le contrôle d’inscription de certificat peut être utilisé avec l’objet CCertRequest pour créer et envoyer une [*demande de certificat*](../secgloss/c-gly.md).</span><span class="sxs-lookup"><span data-stu-id="445b9-104">The following VBScript sample code shows how the Certificate Enrollment Control can be used with the CCertRequest object to create and submit a [*certificate request*](../secgloss/c-gly.md).</span></span>
