...
L’exemple de code VBScript suivant montre comment le contrôle d’inscription de certificat peut être utilisé avec l’objet CCertRequest pour créer et envoyer une [*demande de certificat*](../secgloss/c-gly.md).
