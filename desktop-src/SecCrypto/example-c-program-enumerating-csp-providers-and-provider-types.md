...
ms.locfileid: "127121053"
---
# <a name="example-c-program-enumerating-csp-providers-and-provider-types"></a>Exemple de programme C : énumération des fournisseurs CSP et des types de fournisseurs

L’exemple suivant répertorie les fournisseurs de services de chiffrement disponibles sur un ordinateur et utilise les fonctions [*CryptoAPI*](../secgloss/c-gly.md) suivantes :
...
Cet exemple utilise la fonction [**MyHandleError**](myhandleerror.md). Le code de cette fonction est inclus dans cet exemple. Le code pour cette fonction et d’autres fonctions auxiliaires est également listé sous [usage général Functions](general-purpose-functions.md).

L’exemple suivant montre l’énumération des fournisseurs CSP et des types de fournisseurs.
