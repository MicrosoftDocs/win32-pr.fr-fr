...
L’exemple suivant montre comment utiliser les Visual Basic Scripting Edition (VBScript) et HTML dans une page Web pour recevoir et stocker les certificats renvoyés.
