...
L’exemple suivant illustre ces tâches et les fonctions CryptoAPI :

-   Ouverture et fermeture du magasin système.
-   Recherche d’un certificat par nom de sujet.
-   Utilisation de la fonction [**CertVerifyTimeValidity**](/windows/desktop/api/Wincrypt/nf-wincrypt-certverifytimevalidity) pour vérifier la validité de l’heure du certificat.
