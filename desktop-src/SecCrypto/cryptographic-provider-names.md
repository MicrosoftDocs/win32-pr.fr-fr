...
| <span id="MS_ENH_RSA_AES_PROV"></span><span id="ms_enh_rsa_aes_prov"></span><dl> <dt>**MS \_ ENH \_ RSA \_ AES \_ Prov**</dt> <dt>« Microsoft Enhanced RSA and AES Cryptographic Provider »</dt> </dl>         | [Fournisseur de services de chiffrement AES Microsoft](microsoft-aes-cryptographic-provider.md).<br/> * * Windows XP : * * « fournisseur de services de chiffrement RSA et AES Microsoft amélioré (Prototype) »<br/> |
