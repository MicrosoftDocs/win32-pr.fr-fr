...
| [**Affichage**](certificate-display.md)                       | Affiche un certificat.<br/> (Héritée de **CertificateICertificate2ICertificate**)                                                                                                                                                             |
...
| [**Port**](certificate-import.md)                         | Importe un certificat précédemment encodé à partir d’une chaîne dans l’objet **certificat** .<br/> (Héritée de **CertificateICertificate2ICertificate**)                                                                                             |
