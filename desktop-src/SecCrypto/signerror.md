...
ms.locfileid: "118898433"
---
# <a name="signerror-function"></a>SignError fonction)
...
La fonction **SignError** appelle la fonction [**GetLastError**](/windows/win32/api/errhandlingapi/nf-errhandlingapi-getlasterror) et convertit le code de retour en **HRESULT**.
