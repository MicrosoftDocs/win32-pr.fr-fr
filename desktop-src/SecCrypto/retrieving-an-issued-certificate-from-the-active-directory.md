...
ms.locfileid: "106518291"
---
# <a name="retrieving-an-issued-certificate-from-active-directory"></a><span data-ttu-id="9a359-103">Récupération d’un certificat émis à partir de Active Directory</span><span class="sxs-lookup"><span data-stu-id="9a359-103">Retrieving an Issued Certificate from Active Directory</span></span>

<span data-ttu-id="9a359-104">Une [*autorité de certification*](../secgloss/c-gly.md) d’entreprise publie des [*certificats*](../secgloss/c-gly.md) émis sur le Active Directory ; une autorité de certification autonome peut également publier des certificats émis sur le Active Directory.</span><span class="sxs-lookup"><span data-stu-id="9a359-104">An enterprise [*certification authority*](../secgloss/c-gly.md) (CA) publishes issued [*certificates*](../secgloss/c-gly.md) to the Active Directory; a stand-alone certification authority may also publish issued certificates to the Active Directory.</span></span> <span data-ttu-id="9a359-105">L’exemple suivant montre comment acquérir un [*contexte de certificat*](../secgloss/c-gly.md) pour un certificat stocké dans Active Directory.</span><span class="sxs-lookup"><span data-stu-id="9a359-105">The following example shows how to acquire a [*certificate context*](../secgloss/c-gly.md) for a certificate stored in Active Directory.</span></span> <span data-ttu-id="9a359-106">Une fois le contexte de certificat acquis, vous pouvez récupérer le contenu du certificat ou effectuer des opérations de certificat à l’aide des fonctions CryptoAPI.</span><span class="sxs-lookup"><span data-stu-id="9a359-106">After the certificate context is acquired, you can retrieve the contents of the certificate or perform certificate operations by using the CryptoAPI functions.</span></span>

<span data-ttu-id="9a359-107">L’exemple suivant montre comment récupérer un certificat à partir de Active Directory.</span><span class="sxs-lookup"><span data-stu-id="9a359-107">The following example shows retrieving a certificate from Active Directory.</span></span>
