...
L’exemple suivant illustre l’utilisation de CryptoAPI pour calculer le hachage [*MD5*](../secgloss/m-gly.md) du contenu d’un fichier. Cet exemple effectue le calcul sur le contenu d’un fichier spécifié au moment de l’exécution.
