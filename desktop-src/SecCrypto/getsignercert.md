...
ms.locfileid: "119006634"
---
# <a name="getsignercert"></a>GetSignerCert

La fonction **GetSignerCert** passe (énumère) les certificats dans un magasin de [*certificats*](../secgloss/c-gly.md) jusqu’à ce qu’un certificat avec une clé de signature soit trouvé. Si un certificat est trouvé, un pointeur vers le certificat est retourné. Ce code illustre les éléments suivants :

-   Recherche d’un certificat à l’aide d’une propriété de certificat.
-   Vérification de cette propriété.
-   Retour d’un pointeur vers [**le \_ contexte de certificat**](/windows/desktop/api/Wincrypt/ns-wincrypt-cert_context) où l’attribut a été trouvé.

Ce code utilise un gestionnaire d’erreurs appelé **MyHandleError**. Pour afficher l’implémentation de ce gestionnaire d’erreurs, consultez la rubrique [**MyHandleError**](myhandleerror.md) .
