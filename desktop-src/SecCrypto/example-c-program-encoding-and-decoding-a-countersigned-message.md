...
ms.locfileid: "119007727"
---
# <a name="example-c-program-encoding-and-decoding-a-countersigned-message"></a>Exemple de programme C : encodage et décodage d’un message contresigné

L’exemple suivant montre comment encoder et décoder un message contresigné. L’exemple suivant utilise la fonction [**MyHandleError**](myhandleerror.md) . Le code de la fonction **MyHandleError** et d’autres fonctions auxiliaires est également listé sous [usage général Functions](general-purpose-functions.md).
