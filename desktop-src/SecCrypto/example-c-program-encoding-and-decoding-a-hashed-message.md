...
---
# <a name="example-c-program-encoding-and-decoding-a-hashed-message"></a>Exemple de programme C : encodage et décodage d’un message haché

L’exemple ci-dessous [*hache*](../secgloss/h-gly.md) et encode un message texte, puis décode et vérifie le message.

Bien que, pour des raisons de simplicité, les deux fonctions différentes ont été combinées dans cet exemple, dans un paramétrage plus réaliste, les deux parties sont utilisées séparément.

Cet exemple illustre les tâches et les fonctions CryptoAPI suivantes :

-   Appel de [**CryptAcquireContext**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptacquirecontexta) pour acquérir un fournisseur CSP.
-   Utilisation de [**CryptMsgCalculateEncodedLength**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcalculateencodedlength) pour calculer la longueur du message encodé.
-   Allocation de mémoire pour qu’une mémoire tampon contienne les données encodées.
-   Ouverture d’un message à encoder à l’aide de [**CryptMsgOpenToEncode**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgopentoencode).
-   Ajout de contenu au message à encoder à l’aide de [**CryptMsgUpdate**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate).
-   Utilisation de [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam) pour copier le message encodé dans la mémoire tampon allouée.
...
-   Ajout du message encodé au message à décoder à l’aide de [**CryptMsgUpdate**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgupdate).
-   Création d’un pointeur dupliqué vers le message à l’aide de [**CryptMsgDuplicate**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgduplicate).
-   Vérification du type de message avec [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam).
-   Utilisation de [**CryptMsgGetParam**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsggetparam) pour décoder le message.
-   Vérification du hachage à l’aide de [**CryptMsgControl**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgcontrol).
-   Utilisation de [**CryptMsgClose**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptmsgclose) pour libérer le handle de message.
