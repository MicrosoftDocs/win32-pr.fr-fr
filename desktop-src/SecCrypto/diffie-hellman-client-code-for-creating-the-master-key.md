...
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a>Diffie-Hellman le code client pour la création de la clé principale

L’exemple suivant montre un code/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)standard pour la création d’une [*clé principale*](../secgloss/m-gly.md).
