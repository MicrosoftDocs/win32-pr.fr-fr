---
description: L’exemple suivant montre le code par défaut Diffie-Hellman/Schannel côté client pour la création d’une clé principale.
ms.assetid: 37b35cd6-b3c9-4a75-83a9-129bcf7a84a3
title: Diffie-Hellman le code client pour la création de la clé principale
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104321037"
---
# <a name="diffie-hellman-client-code-for-creating-the-master-key"></a><span data-ttu-id="f6d57-103">Diffie-Hellman le code client pour la création de la clé principale</span><span class="sxs-lookup"><span data-stu-id="f6d57-103">Diffie-Hellman Client Code for Creating the Master Key</span></span>

<span data-ttu-id="f6d57-104">L’exemple suivant montre un code/Schannel [*Diffie-Hellman*](../secgloss/d-gly.md)standard pour la création d’une [*clé principale*](../secgloss/m-gly.md).</span><span class="sxs-lookup"><span data-stu-id="f6d57-104">The following example shows typical [*Diffie-Hellman*](../secgloss/d-gly.md)/Schannel client-side code for creating a [*master key*](../secgloss/m-gly.md).</span></span>
