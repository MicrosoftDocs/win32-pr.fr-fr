...
ms.locfileid: "127123170"
---
# <a name="example-c-program-working-with-key-identifiers"></a>Exemple de programme C : utilisation d’identificateurs de clé

L’exemple suivant montre comment utiliser des identificateurs de clé. Cet exemple illustre les tâches et les fonctions CryptoAPI suivantes :

-   Création d’un identificateur de clé à l’aide de [**CryptCreateKeyIdentifierFromCSP**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptcreatekeyidentifierfromcsp).
-   Définition d’une propriété sur un identificateur de clé à l’aide de [**CryptSetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptsetkeyidentifierproperty).
-   Récupération du contenu d’une propriété d’identificateur de clé à l’aide de [**CryptGetKeyIdentifierProperty**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptgetkeyidentifierproperty).
-   Affichage des propriétés d’un identificateur de clé à l’aide de [**CryptEnumKeyIdentifierProperties**](/windows/desktop/api/Wincrypt/nf-wincrypt-cryptenumkeyidentifierproperties).
-   Déclaration, définition et utilisation d’une fonction de rappel.
