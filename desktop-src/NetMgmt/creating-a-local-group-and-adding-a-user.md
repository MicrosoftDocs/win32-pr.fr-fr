...
ms.locfileid: "127119306"
---
# <a name="creating-a-local-group-and-adding-a-user"></a>Création d’un groupe local et ajout d’un utilisateur

Pour créer un nouveau groupe local, appelez la fonction [**NetLocalGroupAdd**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupadd) . Pour ajouter un utilisateur à ce groupe, appelez la fonction [**NetLocalGroupAddMembers**](/windows/desktop/api/Lmaccess/nf-lmaccess-netlocalgroupaddmembers) .

Le programme suivant vous permet de créer un utilisateur et un groupe local, puis d’ajouter l’utilisateur au groupe local.
