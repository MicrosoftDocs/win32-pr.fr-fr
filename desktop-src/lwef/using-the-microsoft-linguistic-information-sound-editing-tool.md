...
l’outil de modification des informations linguistiques vous permet de générer des informations de phonème et de césure des mots pour améliorer Windows fichiers audio (. wav) afin de prendre en charge l’animation de caractères de synchronisation lip de haute qualité. Les sections suivantes décrivent comment utiliser l’outil.
