...
Lorsqu’une équipe est créée, les groupes dynamiques ont un effet puissant sur les membres du groupe. Tout d’abord, les personnes d’un groupe ou d’un contexte d’équipe ont tendance à identifier plus en plus les autres personnes de l’équipe qu’elles ne le ferait habituellement dans un paramètre de non-équipe. Par conséquent, ils peuvent également identifier plus en plus leurs coéquipiers que ceux qui se trouvent en dehors de l’équipe. Mais tout aussi important, les membres d’une équipe sont plus disposés à coopérer et à modifier leurs attitudes et leur comportement. Étant donné que la dynamique sociale d’une équipe affecte l’interaction de ses membres, il peut être utile de prendre en compte l’interaction avec des caractères.

La création d’un sens de l’équipe implique deux facteurs : l’identité et l’interdépendance. Vous pouvez créer une identité en créant un nom d’équipe, une couleur, un symbole ou tout autre identificateur que l’utilisateur et le partage de caractères. Par exemple, vous pouvez indiquer un autocollant que l’utilisateur peut apposer sur son ordinateur ou permettre à l’utilisateur de choisir un nom d’équipe ou une icône qui s’affiche avec le caractère. L’identité de l’équipe peut également être établie en fonction de ce que le caractère dit. Par exemple, vous pouvez faire en sorte que le caractère fasse référence à lui-même en tant que partenaire ou à l’utilisateur et lui-même en tant qu’équipe.
