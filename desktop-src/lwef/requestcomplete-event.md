...
Se produit lorsque le serveur termine une demande en file d’attente.
...
**Sous** - *agent * * * \_ RequestComplete* *  **(** *demande ByVal * * *)**
...
[**Événement RequestStart**](requeststart-event.md)
