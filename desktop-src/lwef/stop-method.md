...
---
# <a name="stop-method-legacy-windows-environment-features"></a>Méthode Stop (fonctionnalités héritées de l’environnement Windows)
...
| Partie      | Description                                                                                   |
|-----------|-----------------------------------------------------------------------------------------------|
| *Requête* | Optionnel. Objet de [**requête**](/windows/desktop/lwef/the-request-object) spécifiant un appel d’animation particulier. |
