...
keywords:
- fonctionnalités d’environnement de Windows héritées d’événements SelectionChanged
topic_type:
- apiref
api_name:
- SelectionChanged
...
l’exemple suivant illustre l’utilisation correcte de cet événement pour JScript incorporée en HTML.
