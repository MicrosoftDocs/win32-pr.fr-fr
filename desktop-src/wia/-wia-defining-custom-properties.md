...
Si le minipilote d’acquisition d’images Windows (WIA) est nécessaire pour définir des propriétés personnalisées, la \_ \_ propriété DEVPROP privée WIA doit être utilisée pour les propriétés d’élément racine personnalisées, et la \_ \_ propriété ITEMPROP privée WIA "doit être utilisée pour d’autres propriétés d’élément. Ces constantes sont définies dans *wiadef. h*.
