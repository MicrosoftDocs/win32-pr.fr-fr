---
description: une application parcourt une arborescence d’éléments de l’appareil WIA (Windows Image Acquisition) pour rechercher et sélectionner des images sur cet appareil. À l’aide de cette technique, une application sélectionne et acquiert une image sans présenter une boîte de dialogue à l’utilisateur.
...
ms.locfileid: "119593019"
---
# <a name="navigating-an-item-tree"></a>Navigation dans une arborescence d’éléments

une application parcourt une arborescence d’éléments de l’appareil WIA (Windows Image Acquisition) pour rechercher et sélectionner des images sur cet appareil. À l’aide de cette technique, une application sélectionne et acquiert une image sans présenter une boîte de dialogue à l’utilisateur.
