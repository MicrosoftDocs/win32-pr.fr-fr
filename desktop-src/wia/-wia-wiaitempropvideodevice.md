---
description: le pilote vidéo de l’Acquisition d’images standard Windows (WIA) (wiavusd.dll) prend en charge les propriétés suivantes pour la diffusion en continu de périphériques vidéo.
...
ms.locfileid: "118207367"
---
# <a name="video-wia-device-property-constants"></a>Constantes de propriété d’appareil vidéo WIA

le pilote vidéo de l’Acquisition d’images standard Windows (WIA) (wiavusd.dll) prend en charge les propriétés suivantes pour la diffusion en continu de périphériques vidéo.
