...
-   [Attributs de propriété](-wia-property-attributes.md)
-   [**Constantes d’intention d’image**](-wia-imageintentconstants.md)
-   [Identificateurs d’événements WIA](-wia-wia-event-identifiers.md)
