...
Les périphériques matériels WIA (Windows Image Acquisition) sont représentés sous forme d’arborescences hiérarchiques d’objets **Item** . L’élément racine de cette arborescence représente le périphérique lui-même, tandis que les éléments enfants représentent des images, des dossiers ou des lits d’analyse.
...
| [**Transfert**](-wia-iwiadispatchitem-transfer.md)             | La méthode de [**transfert**](-wia-iwiadispatchitem-transfer.md) de l’objet **Item** transfère les données d’un appareil vers un fichier. Cette méthode s’applique uniquement aux éléments de type périphérique.<br/>                                                                                         |
...
| [**Height**](-wia-iwiadispatchitem-height.md)<br/>                   | Lecture seule<br/> | Hauteur, en pixels, de l’élément. <br/>                                                                                                                                                                                                             |
...
| [**Temps**](-wia-iwiadispatchitem-time.md)<br/>                       | Lecture seule<br/> | L’heure actuelle. S’applique uniquement aux appareils. <br/>                                                                                                                                                                                                      |
| [**Width**](-wia-iwiadispatchitem-width.md)<br/>                     | Lecture seule<br/> | Largeur, en pixels, de l’élément. <br/>                                                                                                                                                                                                              |
...
[**Créés**](-wia-iwiadeviceinfo-create.md)
