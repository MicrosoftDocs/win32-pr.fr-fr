---
description: Affecte des données de composant vectoriels à l’instance actuelle de XMXDECN4.
ms.assetid: 'overload:microsoft.directx_sdk.reference.xmxdecn4.operator = '
title: Opérateurs XMXDECN4 =
ms.topic: reference
ms.date: 12/06/2018
topic_type:
- APIRef
...
ms.locfileid: "122624354"
---
# <a name="xmxdecn4-operator--operators"></a>Opérateurs XMXDECN4 =

Assigne des données de composant vectoriels à l’instance actuelle de `XMXDECN4` .

Affecte des données de composant vectoriels à l’instance actuelle de [**XMXDECN4**](/windows/win32/api/directxpackedvector/ns-directxpackedvector-xmxdecn4).
...
<td >Assigne les données du composant vectoriel d’une instance de <code>XMXDECN4</code> à l’instance actuelle de <code>XMXDECN4</code> . <br/>
<blockquote>
[!Note]<br />
Cet opérateur est uniquement disponible en C++.
</blockquote>
...
[XMXDECN4, opérateurs](ovw-xmxdecn4-operators.md)
</dt> <dt>
