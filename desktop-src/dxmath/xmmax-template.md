...
> [!Note]  
> Dans l’idéal, utilisez std :: Max au lieu de `XMMax` . Pour éviter les conflits avec les en-têtes Windows avec std :: Max, vous devez \# définir NOMINMAX avant d’inclure les en-têtes Windows.
