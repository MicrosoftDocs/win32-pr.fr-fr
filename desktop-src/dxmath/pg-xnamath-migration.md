...
-   [Modifications d’en-tête](#header-changes)
-   [Modifications de constante](#constant-changes)
-   [Espaces de noms](#namespaces)
-   [Charges partielles](#partial-loads)
-   [Suppression de types spécifiques de Xbox 360](#removal-of-xbox-360-specific-types)
-   [Intrinsèques ARM-néon](#arm-neon-intrinsics)
-   [Permute](#permute)
-   [Formulaires de modèle](#template-forms)
-   [Fonctions éliminées](#eliminated-functions)
...
Remplacez l’en-tête xnamath. h par DirectXMath. h et ajoutez DirectXPackedVector. h pour les types « processeurs GPU ».
...
Pour les en-têtes, il n’est pas considéré comme « meilleure pratique » pour ajouter des instructions using. Au lieu de cela, ajoutez des espaces de noms qualifiés complets :
