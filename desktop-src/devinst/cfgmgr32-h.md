...
<td>La fonction <strong>CM_Add_ID</strong> ajoute un ID de <a href="/windows-hardware/drivers/install/device-ids">périphérique</a> spécifié (s’il n’est pas déjà présent) à la liste d' <a href="/windows-hardware/drivers/install/hardware-ids">ID de matériel</a> ou à la liste d' <a href="/windows-hardware/drivers/install/compatible-ids">ID compatibles</a> <a href="/windows-hardware/drivers/">d’une instance d’appareil</a> .<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Add_Res_Des</strong> ajoute un <a href="/windows-hardware/drivers/">descripteur de ressource</a> à une <a href="/windows-hardware/drivers/kernel/hardware-resources">configuration logique</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Delete_Class_Key</strong> supprime la classe d' <a href="/windows-hardware/drivers/">appareil</a> installée spécifiée du système.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Delete_Device_Interface_Key</strong> supprime la sous-clé de Registre qui est utilisée par les applications et les pilotes pour stocker des informations spécifiques à l’interface.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Delete_DevNode_Key</strong> supprime les clés de Registre accessibles par l’utilisateur spécifiées qui sont associées à un appareil.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_disable_devnode"><strong>CM_Disable_DevNode</strong></a><br/></td>
<td>La fonction <strong>CM_Disable_DevNode</strong> désactive un appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Enable_DevNode</strong> active un appareil.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_enumerate_classes"><strong>CM_Enumerate_Classes</strong></a><br/></td>
<td>La fonction <strong>CM_Enumerate_Classes</strong> , quand elle est appelée à plusieurs reprises, énumère les classes de <a href="/windows-hardware/drivers/">périphérique</a> installées de l’ordinateur local en fournissant le GUID de chaque classe.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Enumerate_Enumerators</strong> énumère les énumérateurs d’appareils de l’ordinateur local en fournissant le nom de chaque énumérateur.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Free_Log_Conf</strong> supprime une <a href="/windows-hardware/drivers/kernel/hardware-resources">configuration logique</a> et tous les <a href="/windows-hardware/drivers/">descripteurs de ressources</a> associés de l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Free_Log_Conf_Handle</strong> invalide un handle de configuration logique et libère l’allocation de mémoire qui lui est associée.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_free_res_des"><strong>CM_Free_Res_Des</strong></a><br/></td>
<td>La fonction <strong>CM_Free_Res_Des</strong> supprime un <a href="/windows-hardware/drivers/">descripteur de ressource</a> d’une <a href="/windows-hardware/drivers/kernel/hardware-resources">configuration logique</a> sur l’ordinateur local.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Free_Res_Des_Handle</strong> invalide un handle de description de ressource et libère l’allocation de mémoire qui lui est associée.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Free_Resource_Conflict_Handle</strong> invalide un handle à une liste de conflits de ressources et libère l’allocation de mémoire associée au handle.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_child"><strong>CM_Get_Child</strong></a><br/></td>
<td>La fonction <strong>CM_Get_Child</strong> est utilisée pour récupérer un handle d’instance d’appareil vers le premier nœud enfant d’un nœud d’appareil spécifié (<a href="/windows-hardware/drivers/">devnode</a>) dans l' <a href="/windows-hardware/drivers/kernel/device-tree">arborescence de périphériques</a>de l’ordinateur local.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_Class_Property</strong> récupère une propriété d’appareil définie pour une classe d' <a href="/windows-hardware/drivers/install/device-interface-classes">interface de périphérique</a> ou une <a href="/windows-hardware/drivers/install/device-setup-classes">classe d’installation de périphérique</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_Class_Property_Keys</strong> récupère un tableau des clés de propriétés de périphérique qui représentent les propriétés de périphérique définies pour une classe d' <a href="/windows-hardware/drivers/install/device-interface-classes">interface de périphérique</a> ou une <a href="/windows-hardware/drivers/install/device-setup-classes">classe d’installation de périphérique</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_Class_Registry_Property</strong> récupère une propriété de la <a href="/windows-hardware/drivers/install/accessing-device-setup-class-properties">classe d’installation</a>de l’appareil.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_depth"><strong>CM_Get_Depth</strong></a><br/></td>
<td>La fonction <strong>CM_Get_Depth</strong> est utilisée pour obtenir la profondeur d’un nœud d’appareil spécifié (<a href="/windows-hardware/drivers/">devnode</a>) dans l’arborescence de <a href="/windows-hardware/drivers/kernel/device-tree">périphériques</a>de l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_ID</strong> récupère l' <a href="/windows-hardware/drivers/install/device-instance-ids">ID d’instance d’appareil</a> pour une <a href="/windows-hardware/drivers/">instance de périphérique</a> spécifiée sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_ID_List</strong> récupère une liste d' <a href="/windows-hardware/drivers/install/device-instance-ids">ID d’instance d’appareil</a> pour les instances d' <a href="/windows-hardware/drivers/">appareil</a>de l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_ID_List_Size</strong> récupère la taille de la mémoire tampon requise pour contenir une liste d' <a href="/windows-hardware/drivers/install/device-instance-ids">ID d’instance d’appareil</a> pour les instances d' <a href="/windows-hardware/drivers/">appareil</a>de l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_ID_Size</strong> récupère la taille de la mémoire tampon requise pour contenir un <a href="/windows-hardware/drivers/install/device-instance-ids">ID d’instance d’appareil</a> pour une instance d' <a href="/windows-hardware/drivers/">appareil</a> sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_Interface_Alias</strong> retourne l’alias de l’instance d’interface de périphérique spécifiée, si l’alias existe.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_Interface_List</strong> récupère une liste d’instances d’interface d’appareil qui appartiennent à une <a href="/windows-hardware/drivers/install/device-interface-classes">classe d’interface de périphérique</a>spécifiée.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_Device_Interface_List_Size</strong> récupère la taille de la mémoire tampon qui doit être passée à la fonction <a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_device_interface_lista"><strong>CM_Get_Device_Interface_List</strong></a> .<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Device_Interface_Property</strong> récupère une propriété d’appareil définie pour une interface d’appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_Device_Interface_Property_Keys</strong> récupère un tableau de clés de propriété d’appareil qui représentent les propriétés de périphérique définies pour une interface d’appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_DevNode_Property</strong> récupère une propriété d’instance d’appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_DevNode_Property_Keys</strong> récupère un tableau des clés de propriétés de périphérique qui représentent les propriétés de périphérique définies pour une instance d’appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_DevNode_Registry_Property</strong> récupère une propriété de périphérique spécifiée à partir du Registre.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_get_devnode_status"><strong>CM_Get_DevNode_Status</strong></a><br/></td>
<td>La fonction <strong>CM_Get_DevNode_Status</strong> obtient l’état d’une instance d’appareil à partir de son nœud d’appareil (<a href="/windows-hardware/drivers/">devnode</a>) dans l' <a href="/windows-hardware/drivers/kernel/device-tree">arborescence de périphériques</a>de l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<br/> La fonction <strong>CM_Get_HW_Prof_Flags_Ex</strong> récupère les indicateurs de configuration spécifiques au <a href="/windows-hardware/drivers/">Profil matériel</a>pour une <a href="/windows-hardware/drivers/">instance d’appareil</a> sur un ordinateur distant ou un ordinateur local.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Get_Log_Conf_Priority</strong> obtient la priorité de configuration d’une <a href="/windows-hardware/drivers/kernel/hardware-resources">configuration logique</a> spécifiée sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Next_Log_Conf</strong> obtient la <a href="/windows-hardware/drivers/kernel/hardware-resources">configuration logique</a> suivante associée à une instance d' <a href="/windows-hardware/drivers/">appareil</a> spécifique sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Next_Res_Des</strong> obtient un handle vers le <a href="/windows-hardware/drivers/">descripteur de ressource</a>suivant, d’un type de ressource spécifié, pour une <a href="/windows-hardware/drivers/kernel/hardware-resources">configuration logique</a> sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Parent</strong> obtient un handle d’instance d’appareil vers le nœud parent d’un nœud d’appareil spécifié (<a href="/windows-hardware/drivers/">devnode</a>) dans l’arborescence de périphériques de l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Res_Des_Data</strong> récupère les informations stockées dans un <a href="/windows-hardware/drivers/">descripteur de ressource</a> sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Res_Des_Data_Size</strong> obtient la taille de la mémoire tampon requise pour contenir les informations contenues dans un <a href="/windows-hardware/drivers/">descripteur de ressource</a> spécifié sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Get_Resource_Conflict_Count</strong> obtient le nombre de conflits contenus dans une liste de conflits de ressources spécifiée.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Is_Dock_Station_Present</strong> indique si une <a href="/windows-hardware/drivers/">station d’accueil</a> est présente dans un ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Locate_DevNode</strong> obtient un handle d’instance d’appareil vers le nœud de périphérique associé à un <a href="/windows-hardware/drivers/install/device-instance-ids">ID d’instance de périphérique</a> spécifié sur l’ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>Convertit un code <strong>CONFIGRET</strong> spécifié en son code d’erreur système équivalent.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_modify_res_des"><strong>CM_Modify_Res_Des</strong></a><br/></td>
<td>La fonction <strong>CM_Modify_Res_Des</strong> modifie un descripteur de ressource spécifié sur l’ordinateur local.<br/></td>
</tr>
<tr class="odd">
...
<td>Cette énumération identifie Plug-and-Play types d’événements d’appareil.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/ns-cfgmgr32-cm_notify_event_data"><strong>CM_NOTIFY_EVENT_DATA</strong></a><br/></td>
<td>Il s’agit d’une structure de données d’événement de notification d’appareil.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/ns-cfgmgr32-cm_notify_filter"><strong>CM_NOTIFY_FILTER</strong></a><br/></td>
<td>Structure du filtre de notification de l’appareil<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_open_class_keyw"><strong>CM_Open_Class_Key</strong></a><br/></td>
<td>La fonction <strong>CM_Open_Class_Key</strong> ouvre la clé de registre de la classe d’installation de l’appareil, la clé de registre de la classe d’interface de périphérique ou une sous-clé spécifique d’une classe.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Open_Device_Interface_Key</strong> ouvre la sous-clé de Registre qui est utilisée par les applications et les pilotes pour stocker des informations spécifiques à une interface d’appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Open_DevNode_Key</strong> ouvre une clé de Registre pour les informations de configuration spécifiques à l’appareil.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Query_And_Remove_SubTree</strong> vérifie si une instance d’appareil et ses enfants peuvent être supprimés et, le cas échéant, les supprime.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Query_Resource_Conflict_List</strong> identifie les instances d’appareil ayant des besoins en ressources qui sont en conflit avec la description de ressource d’une instance de périphérique spécifiée.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_reenumerate_devnode"><strong>CM_Reenumerate_DevNode</strong></a><br/></td>
<td>La fonction <strong>CM_Reenumerate_DevNode</strong> énumère les appareils identifiés par un nœud de périphérique spécifié et tous ses enfants.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Request_Device_Eject</strong> prépare une instance d’appareil local pour une suppression en toute sécurité, si l’appareil est amovible. Si l’appareil peut être éjecté physiquement, il sera.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Request_Eject_PC</strong> demande qu’un PC portable, inséré dans une <a href="/windows-hardware/drivers/">station d’accueil</a>locale, soit éjecté.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Set_Class_Property</strong> définit une propriété de classe pour une classe d’installation de périphérique ou une classe d’interface d’appareil.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Set_Class_Registry_Property</strong> définit ou supprime une propriété d’une <a href="/windows-hardware/drivers/install/device-setup-classes">classe d’installation de périphérique</a>.<br/></td>
</tr>
<tr class="odd">
...
<td>La fonction <strong>CM_Set_Device_Interface_Property</strong> définit une propriété d’appareil d’une interface d’appareil.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Set_DevNode_Problem</strong> définit un code de problème pour un appareil installé sur un ordinateur local.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Set_DevNode_Property</strong> définit une propriété d’instance d’appareil.<br/></td>
</tr>
<tr class="even">
...
<td>La fonction <strong>CM_Set_DevNode_Registry_Property</strong> définit une propriété de périphérique spécifiée dans le registre.<br/></td>
</tr>
<tr class="even">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_setup_devnode"><strong>CM_Setup_DevNode</strong></a><br/></td>
<td>La fonction <strong>CM_Setup_DevNode</strong> redémarre une instance d’appareil qui n’est pas en cours d’exécution en raison d’un problème de configuration de l’appareil.<br/></td>
</tr>
<tr class="odd">
<td><a href="/windows/desktop/api/Cfgmgr32/nf-cfgmgr32-cm_uninstall_devnode"><strong>CM_Uninstall_DevNode</strong></a><br/></td>
<td>La fonction <strong>CM_Uninstall_DevNode</strong> supprime tout état persistant associé à une instance d’appareil.<br/></td>
</tr>
<tr class="even">
