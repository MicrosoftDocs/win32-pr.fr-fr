...
ms.locfileid: "127238721"
---
# <a name="ip-helper-functions"></a>Fonctions d’assistance IP

Les fonctions suivantes récupèrent et modifient les paramètres de configuration pour le transport TCP/IP sur l’ordinateur local. La liste catégorique suivante peut aider à déterminer la collection de fonctions qui convient le mieux à une tâche donnée.
...
## <a name="adapter-management"></a>Gestion des adaptateurs
...
## <a name="address-resolution-protocol-arp-management"></a>Gestion ARP (Address Resolution Protocol)
...
## <a name="interface-conversion"></a>Conversion de l’interface
...
## <a name="ip-address-management"></a>Gestion des adresses IP
...
## <a name="ip-address-string-conversion"></a>Conversion de chaîne d’adresse IP
...
## <a name="ip-neighbor-address-management"></a>Gestion des adresses IP voisines
...
## <a name="ip-path-management"></a>Gestion des chemins d’accès IP
...
## <a name="ip-route-management"></a>Gestion des itinéraires IP
...
## <a name="ip-table-memory-management"></a>Gestion de la mémoire de la table IP

-   [**FreeMibTable**](/windows/win32/api/Netioapi/nf-netioapi-freemibtable)

## <a name="ip-utility"></a>Utilitaire IP
...
## <a name="security-health"></a>Intégrité de la sécurité
...
## <a name="transmission-control-protocol-tcp-and-user-datagram-protocol-udp"></a>Protocole TCP (Transmission Control Protocol) et UDP (User Datagram Protocol)
...
> [!Note]  
> Ces fonctions sont dépréciées et ne sont pas prises en charge par Microsoft.
