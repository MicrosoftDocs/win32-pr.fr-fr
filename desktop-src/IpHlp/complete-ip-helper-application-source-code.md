---
description: Voici le code source complet de l’application d’assistance IP. Des vérifications d’erreurs supplémentaires ont été ajoutées au code source.
ms.assetid: c0290660-8a18-4d5c-8f0a-df15da1a9167
title: Code source complet de l’application d’assistance IP
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106536424"
---
# <a name="complete-ip-helper-application-source-code"></a><span data-ttu-id="bb93a-104">Code source complet de l’application d’assistance IP</span><span class="sxs-lookup"><span data-stu-id="bb93a-104">Complete IP Helper Application Source Code</span></span>

<span data-ttu-id="bb93a-105">Voici le code source complet de l’application d’assistance IP.</span><span class="sxs-lookup"><span data-stu-id="bb93a-105">The following is the complete source code for the IP Helper application.</span></span> <span data-ttu-id="bb93a-106">Des vérifications d’erreurs supplémentaires ont été ajoutées au code source.</span><span class="sxs-lookup"><span data-stu-id="bb93a-106">Additional error checking has been added to source code.</span></span>
