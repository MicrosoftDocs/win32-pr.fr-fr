...
---
# <a name="complete-ip-helper-application-source-code"></a>Code source complet de l’application d’assistance IP

Voici le code source complet de l’application d’assistance IP. Des vérifications d’erreurs supplémentaires ont été ajoutées au code source.
