...
Fonction qui récupère les estimations historiques de la bande passante pour une connexion réseau. Pour plus d’informations, consultez :
...
Structure qui contient des informations sur les estimations de bande passante disponibles et la variance associée comme déterminé par la pile TCP/IP. Pour plus d’informations, consultez :
...
Fonctions qui convertissent une adresse Ethernet entre un format binaire et un format de chaîne pour l’adresse MAC Ethernet. Pour plus d’informations, consultez :
...
Fonction qui fonctionne avec IPv4 et le protocole ICMP (Internet Control Message Protocol). Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la conversion de l’interface. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la gestion des interfaces. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la gestion des adresses IP. Pour plus d’informations, consultez :
...
Fonction qui fonctionne avec les protocoles IPv6 et IPv4 pour la gestion de la mémoire de la table IP. Pour plus d’informations, consultez :

-   [**FreeMibTable**](/windows/desktop/api/Netioapi/nf-netioapi-freemibtable)

Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la gestion des adresses IP voisines. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la gestion des chemins d’accès IP. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la gestion des itinéraires IP. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec les protocoles IPv6 et IPv4 pour la notification. Pour plus d’informations, consultez :
...
Fonctions utilitaires qui fonctionnent avec des adresses IP. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec le protocole TCP (Transmission Control Protocol) et UDP (User Datagram Protocol) pour récupérer la table de connexion TCP ou IPv4 IPv4 ou la table de l’écouteur UDP. Pour plus d’informations, consultez :
...
Fonctions qui fonctionnent avec le protocole TCP (Transmission Control Protocol) pour récupérer des statistiques TCP étendues sur une connexion. Pour plus d’informations, consultez :
...
Nouvelles fonctions qui fonctionnent pour la gestion du client IPv6 Teredo. Pour plus d’informations, consultez :
...
Fonctions utilitaires qui fournissent des conversions entre des adresses IP et des représentations sous forme de chaîne d’adresses IP. Pour plus d’informations, consultez :
...
Fonctions qui fournissent des réservations persistantes pour un bloc consécutif de ports TCP ou UDP sur l’ordinateur local. Pour plus d’informations, consultez :
