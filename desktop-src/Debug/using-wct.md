...
L’exemple de code suivant illustre l’utilisation de l’API traversée de chaîne d’attente. Il énumère tous les threads du système et imprime la chaîne d’attente pour chaque thread.

Pour énumérer tous les threads du système, exécutez l’exemple sans paramètres. Pour énumérer uniquement les threads d’un processus spécifié, exécutez l’exemple et transmettez l’identificateur de processus en tant que paramètre. L’exemple effectue les étapes suivantes :
...
7. Appelle la fonction [CloseThreadWaitChainSession](/windows/desktop/api/Wct/nf-wct-closethreadwaitchainsession) pour nettoyer la chaîne d’attente.
