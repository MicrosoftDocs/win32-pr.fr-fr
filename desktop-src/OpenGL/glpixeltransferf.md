...
Les fonctions **glPixelTransferf** et [**glPixelTransferi**](glpixeltransferi.md) définissent les modes de transfert de pixels.
...
| décalage de l' \_ index GL \_  | integer | 0              | (8, 8)        |
| décalage de l' \_ index GL \_ | integer | 0              | (8, 8)        |
