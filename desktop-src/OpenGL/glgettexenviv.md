...
ms.locfileid: "127229469"
---
# <a name="glgettexenviv-function"></a>glGetTexEnviv fonction)

Les fonctions [**glGetTexEnvfv**](glgettexenvfv.md) et **glGetTexEnviv** retournent les paramètres d’environnement de texture.
