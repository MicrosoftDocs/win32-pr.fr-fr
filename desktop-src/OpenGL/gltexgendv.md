...
ms.locfileid: "119490399"
---
# <a name="gltexgendv-function"></a>glTexGendv fonction)
...
Tableau qui contient les coefficients pour la fonction de génération de texture correspondante.
...
et x ?, y ?, z ? et w ? les coordonnées oculaires du vertex, P1, P2, P3 et P4 sont les valeurs fournies dans *param*, et M est la matrice modelview quand vous **callglTexGen**. Si M est mal conditionné ou singulier, les coordonnées de texture générées par la fonction résultante peuvent être inexactes ou non définies.
