...
-   Le *Guide de programmation OpenGL* explique comment créer des programmes graphiques à l’aide de OpenGL. Il comprend des discussions sur les sujets majeurs suivants :

    -   Dessin de formes géométriques
    -   Pixels, bitmaps, polices et images
    -   Affichage et transformations de matrice
    -   Mappage de texture
    -   Afficher les listes
    -   Techniques composites avancées
    -   Couleur
    -   Évaluateurs et NURBS
    -   Éclairage
    -   Sélection et commentaires
    -   Fusion, anticrénelage et brouillard
    -   Techniques avancées
