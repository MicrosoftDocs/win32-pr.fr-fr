...
---
# <a name="glloadmatrixf-function"></a>glLoadMatrixf fonction)

Les fonctions [**glLoadMatrixd**](glloadmatrixd.md) et **glLoadMatrixf** remplacent la matrice actuelle par une matrice arbitraire.
