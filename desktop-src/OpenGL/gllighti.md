...
La fonction **glLighti** retourne des valeurs de paramètre de source lumineuse.
...
Les fonctions suivantes récupèrent les informations relatives à la fonction **glLighti** :
