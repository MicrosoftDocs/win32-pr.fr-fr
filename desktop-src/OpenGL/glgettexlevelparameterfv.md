...
ms.locfileid: "118359775"
---
# <a name="glgettexlevelparameterfv-function"></a>glGetTexLevelParameterfv fonction)

Les fonctions **glGetTexLevelParameterfv** et [**glGetTexLevelParameteriv**](glgettexlevelparameteriv.md) retournent des valeurs de paramètre de texture pour un niveau de détail spécifique.
