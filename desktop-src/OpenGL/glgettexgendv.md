...
---
# <a name="glgettexgendv-function"></a>glGetTexGendv fonction)

Les fonctions **glGetTexGendv**, [**glGetTexGenfv**](glgettexgenfv.md)et [**glGetTexGeniv**](glgettexgeniv.md) retournent des paramètres de génération de coordonnées de texture.
