...
ms.locfileid: "127229482"
---
# <a name="glgetpixelmapuiv-function"></a>glGetPixelMapuiv fonction)

Les fonctions [**glGetPixelMapfv**](glgetpixelmapfv.md), **glGetPixelMapuiv** et [**glGetPixelMapusv**](glgetpixelmapusv.md) retournent la carte de pixels spécifiée.
