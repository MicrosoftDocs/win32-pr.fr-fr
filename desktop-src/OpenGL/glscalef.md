...
---
# <a name="glscalef-function"></a>glScalef fonction)

Les fonctions [**glScaled**](glscaled.md) et **glScalef** multiplient la matrice actuelle par une matrice de mise à l’échelle générale.
...
Si le mode matriciel est GL \_ MODELVIEW ou GL \_ projection, tous les objets dessinés après l’appel de **glScalef** sont mis à l’échelle. Utilisez [**glPushMatrix**](glpushmatrix.md) et [**glPopMatrix**](glpopmatrix.md) pour enregistrer et restaurer le système de coordonnées non mis à l’échelle.
