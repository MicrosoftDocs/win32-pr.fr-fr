...
---
# <a name="glubegintrim-function"></a>gluBeginTrim fonction)

Les fonctions **gluBeginTrim** et [**gluEndTrim**](gluendtrim.md) délimitent une définition de boucle de découpage [NURBS](using-nurbs-curves-and-surfaces.md)B-spline (NURBS) non uniforme.
