...
ms.locfileid: "118615769"
---
# <a name="glgetcolortableparameterfvext-function"></a>glGetColorTableParameterfvEXT fonction)

Les fonctions **glGetColorTableParameterfvEXT** et [**glGetColorTableParameterivEXT**](glgetcolortableparameterivext.md) obtiennent des paramètres de palette à partir des tables de couleurs.
