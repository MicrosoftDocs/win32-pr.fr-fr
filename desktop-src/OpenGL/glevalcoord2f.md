...
La fonction [**glEvalCoord2f**](glevalcoord2d.md) évalue les mappages à deux dimensions activés.
...
Si la génération automatique normale est activée, [**glEvalCoord2f**](glevalcoord2d.md) appelle [**glEnable**](glenable.md) avec l’argument GL \_ auto \_ normal pour générer des normales de surface analytiques, quel que soit le contenu ou l’activation de la \_ \_ carte normale GL map2. Let
...
Les fonctions suivantes récupèrent les informations relatives à la fonction [**glEvalCoord2f**](glevalcoord2d.md) :
