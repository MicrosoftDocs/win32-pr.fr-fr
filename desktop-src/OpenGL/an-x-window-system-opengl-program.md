...
---
# <a name="an-x-window-system-opengl-program"></a><span data-ttu-id="27bd7-107">Un programme X Windows système OpenGL</span><span class="sxs-lookup"><span data-stu-id="27bd7-107">An X Window System OpenGL Program</span></span>

<span data-ttu-id="27bd7-108">Le programme suivant est un programme X Windows système OpenGL avec le même code OpenGL utilisé dans AUXEDEMO. Exemple de programme fourni avec le kit de développement logiciel (SDK) Microsoft Platform.</span><span class="sxs-lookup"><span data-stu-id="27bd7-108">The following program is an X Window System OpenGL program with the same OpenGL code used in the AUXEDEMO.C sample program supplied with the Microsoft Platform SDK.</span></span> <span data-ttu-id="27bd7-109">Comparez ce programme au programme Windows OpenGL dans [le programme porté à Windows](the-program-ported-to-win32.md).</span><span class="sxs-lookup"><span data-stu-id="27bd7-109">Compare this program with the Windows OpenGL program in [The Program Ported to Windows](the-program-ported-to-win32.md).</span></span>
