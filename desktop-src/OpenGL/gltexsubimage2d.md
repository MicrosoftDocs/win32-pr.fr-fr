...
Décalage de Texel dans l’axe *y* dans le tableau de texture.
...
Hauteur de la sous-image de texture.
...
Format des données de pixels. Elle peut prendre l’une des valeurs symboliques suivantes.
...
| <dl> <dt>**\_valeur non valide du GL \_**</dt> </dl>     | *xoffset* était inférieur à-*b*; ou la largeur de *xoffset*  +   était supérieure à *w*  -  *b*; ou *YOFFSET* était inférieur à-*b*; ou *YOFFSET*  +  *hauteur* était supérieure à *h*  -  *b*, où *w* est la largeur de la \_ texture GL \_ , *h* est la \_ hauteur de la texture GL \_ et *b* est la largeur de la bordure de \_ texture GL \_ de l’image de texture en cours de modification. <br/> Notez que *w* et *h* incluent deux fois la largeur de la bordure.<br/> |
...
| <dl> <dt>**\_opération non valide du GL \_**</dt> </dl> | Le tableau de texture n’a pas été défini par une opération **glTexImage2D** précédente.<br/>                                                                                                                                                                                                                                                                                                                       |
...
Les texels référencés par les *pixels* remplacent une région du tableau de texture existant par des index *x* de *xoffset* et *xoffset* + (*Width* 1) inclusifs et des index *y* de *YOFFSET* et *YOFFSET* + (*hauteur* 1). Cette région ne peut pas inclure de texels en dehors de la plage du tableau de texture spécifié à l’origine.
...
Les fonctions suivantes récupèrent les informations relatives à **glTexSubImage2D**:
