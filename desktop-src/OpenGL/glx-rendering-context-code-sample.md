...
ms.locfileid: "106510190"
---
# <a name="glx-rendering-context-code-sample"></a><span data-ttu-id="a012a-108">Exemple de code de contexte de rendu GLX</span><span class="sxs-lookup"><span data-stu-id="a012a-108">GLX Rendering Context Code Sample</span></span>

<span data-ttu-id="a012a-109">L’exemple de code suivant montre comment un programme X Window System OpenGL utilise des fonctions de contexte de rendu GLX.</span><span class="sxs-lookup"><span data-stu-id="a012a-109">The following code sample shows how an X Window System OpenGL program uses GLX rendering context functions.</span></span>
