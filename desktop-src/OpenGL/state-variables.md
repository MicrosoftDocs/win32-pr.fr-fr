...
-   [**Texturation**](texturing-state-variables.md)
-   [**Contrôle trame**](framebuffer-control-state-variables.md)
-   [**Pixel**](pixel-state-variables.md)
-   [**Évaluateur**](evaluator-state-variables.md)
-   [**Évit**](hint-state-variables.md)
-   [**Dépend de l’implémentation**](implementation-dependent-state-variables.md)
