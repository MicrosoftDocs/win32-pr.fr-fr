...
---
# <a name="glrasterpos3sv-function"></a>glRasterPos3sv fonction)
...
Pointeur vers un tableau de trois éléments, en spécifiant les coordonnées x, y et z pour la position de la trame actuelle.
