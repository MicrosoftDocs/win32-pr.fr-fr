...
---
# <a name="windows-rendering-context-code-sample"></a><span data-ttu-id="54157-106">Exemple de code de contexte de rendu Windows</span><span class="sxs-lookup"><span data-stu-id="54157-106">Windows Rendering Context Code Sample</span></span>

<span data-ttu-id="54157-107">L’exemple de code suivant montre comment le code de contexte de rendu GLX dans la section précédente se présente lorsqu’il a été porté vers Windows.</span><span class="sxs-lookup"><span data-stu-id="54157-107">The following code sample shows how the GLX rendering context code in the previous section looks when it has been ported to Windows.</span></span>
