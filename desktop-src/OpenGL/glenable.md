...
Les fonctions **glEnable** et [**glDisable**](gldisable.md) activent ou désactivent les fonctionnalités OpenGL.
...
**GlEnable** et **glDisable** prennent tous deux un seul argument, *Cap*, qui peut prendre l’une des valeurs suivantes :
