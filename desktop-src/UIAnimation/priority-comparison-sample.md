...
description: montre comment utiliser Windows Animation avec votre propre comparaison de priorité, à l’aide de Direct2D pour le rendu.
...
ms.locfileid: "120008189"
---
# <a name="priority-comparison-sample"></a>Exemple de comparaison de priorité

montre comment utiliser Windows Animation avec votre propre comparaison de priorité, à l’aide de Direct2D pour le rendu.
...
1.  ouvrez Windows Explorer et accédez au répertoire du projet PriorityComparison.
...
2.  exécutez **PriorityComparison.exe** à partir de l’invite de commandes, ou double-cliquez sur l’icône de PriorityComparison.exe dans Windows Explorer.
