---
title: Afficher les propriétés de l’abonnement du collecteur d’événements
description: Vous pouvez afficher des informations utiles sur un abonnement du collecteur d’événements et ses sources d’événement en extrayant et en affichant les propriétés de l’abonnement.
...
---
# <a name="display-event-collector-subscription-properties"></a><span data-ttu-id="9904c-103">Afficher les propriétés de l’abonnement du collecteur d’événements</span><span class="sxs-lookup"><span data-stu-id="9904c-103">Display event collector subscription properties</span></span>

<span data-ttu-id="9904c-104">Vous pouvez afficher des informations utiles sur un abonnement du collecteur d’événements et ses sources d’événement en extrayant et en affichant les propriétés de l’abonnement.</span><span class="sxs-lookup"><span data-stu-id="9904c-104">You can view useful information about an Event Collector subscription and its event sources by retrieving and displaying the properties of the subscription.</span></span>

> [!Note]
>
> <span data-ttu-id="9904c-105">Vous pouvez utiliser cet exemple pour afficher les valeurs de propriété d’un abonnement ou vous pouvez taper la commande suivante à l’invite de commandes :</span><span class="sxs-lookup"><span data-stu-id="9904c-105">You can use this example to display the property values of a subscription or you can type the following command at the command prompt:</span></span>
>
> <span data-ttu-id="9904c-106">**wecutil GS** *SubscriptionName*</span><span class="sxs-lookup"><span data-stu-id="9904c-106">**wecutil gs** *SubscriptionName*</span></span>

 

<span data-ttu-id="9904c-107">Pour afficher ses propriétés, spécifiez le nom d’un abonnement.</span><span class="sxs-lookup"><span data-stu-id="9904c-107">To display its properties, specify the name of a subscription.</span></span> <span data-ttu-id="9904c-108">Pour plus d’informations et pour obtenir un exemple de code C++ sur la manière de répertorier les noms des abonnements en cours sur un ordinateur local, consultez [liste des abonnements du collecteur d’événements](listing-event-collector-subscriptions.md)ou tapez la commande suivante à l’invite de commandes :</span><span class="sxs-lookup"><span data-stu-id="9904c-108">For more information and a C++ code example of how to list the names of current subscriptions on a local computer, see [Listing Event Collector Subscriptions](listing-event-collector-subscriptions.md), or you can type the following command at the command prompt:</span></span>

<span data-ttu-id="9904c-109">**wecutil es**</span><span class="sxs-lookup"><span data-stu-id="9904c-109">**wecutil es**</span></span>

<span data-ttu-id="9904c-110">L’exemple de code suivant suit une procédure pour afficher les propriétés d’un abonnement du collecteur d’événements et de ses sources d’événements associées.</span><span class="sxs-lookup"><span data-stu-id="9904c-110">The following code example follows a procedure to display the properties of an Event Collector subscription and its associated event sources.</span></span>

<span data-ttu-id="9904c-111">**Pour afficher les propriétés d’un abonnement Event Collector et de ses sources d’événement**</span><span class="sxs-lookup"><span data-stu-id="9904c-111">**To display the properties of an Event Collector subscription and its event sources**</span></span>

1.  <span data-ttu-id="9904c-112">Ouvrez l’abonnement en fournissant le nom de l’abonnement et les droits d’accès en tant que paramètres à la fonction [**EcOpenSubscription**](/windows/desktop/api/Evcoll/nf-evcoll-ecopensubscription) .</span><span class="sxs-lookup"><span data-stu-id="9904c-112">Open the subscription by providing the subscription name and access rights as parameters to the [**EcOpenSubscription**](/windows/desktop/api/Evcoll/nf-evcoll-ecopensubscription) function.</span></span> <span data-ttu-id="9904c-113">Pour plus d’informations sur les droits d’accès, consultez [**constantes du collecteur d’événements Windows**](windows-event-collector-constants.md).</span><span class="sxs-lookup"><span data-stu-id="9904c-113">For more information about access rights, see [**Windows Event Collector Constants**](windows-event-collector-constants.md).</span></span>
2.  <span data-ttu-id="9904c-114">Obtenir et afficher les propriétés de l’abonnement et des sources d’événements en appelant la fonction [**EcGetSubscriptionProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetsubscriptionproperty) et la fonction [**EcGetObjectArrayProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetobjectarrayproperty) .</span><span class="sxs-lookup"><span data-stu-id="9904c-114">Get and display the properties of the subscription and event sources by calling the [**EcGetSubscriptionProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetsubscriptionproperty) function and the [**EcGetObjectArrayProperty**](/windows/desktop/api/Evcoll/nf-evcoll-ecgetobjectarrayproperty) function.</span></span> <span data-ttu-id="9904c-115">Pour plus d’informations sur les propriétés d’abonnement et de source d’événements qui peuvent être affichées, consultez l’énumération de l' [**\_ ID de \_ propriété \_ d’abonnement EC**](/windows/desktop/api/Evcoll/ne-evcoll-ec_subscription_property_id) .</span><span class="sxs-lookup"><span data-stu-id="9904c-115">For more information about subscription and event source properties that can be displayed, see the [**EC\_SUBSCRIPTION\_PROPERTY\_ID**](/windows/desktop/api/Evcoll/ne-evcoll-ec_subscription_property_id) enumeration.</span></span>
3.  <span data-ttu-id="9904c-116">Fermez l’abonnement en appelant la fonction [**EcClose**](/windows/desktop/api/Evcoll/nf-evcoll-ecclose) .</span><span class="sxs-lookup"><span data-stu-id="9904c-116">Close the subscription by calling the [**EcClose**](/windows/desktop/api/Evcoll/nf-evcoll-ecclose) function.</span></span>

<span data-ttu-id="9904c-117">L’exemple de code C++ suivant montre comment afficher les propriétés d’un abonnement à un collecteur d’événements.</span><span class="sxs-lookup"><span data-stu-id="9904c-117">The following C++ code example shows how to display the properties of an Event Collector subscription.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="9904c-118">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="9904c-118">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="9904c-119">Liste des abonnements du collecteur d’événements</span><span class="sxs-lookup"><span data-stu-id="9904c-119">Listing Event Collector Subscriptions</span></span>](listing-event-collector-subscriptions.md)
</dt> <dt>

[<span data-ttu-id="9904c-120">Informations de référence sur le collecteur d’événements Windows</span><span class="sxs-lookup"><span data-stu-id="9904c-120">Windows Event Collector Reference</span></span>](windows-event-collector-reference.md)
</dt> </dl>
