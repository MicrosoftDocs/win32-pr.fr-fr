...
Vous pouvez afficher des informations utiles sur un abonnement du collecteur d’événements et ses sources d’événement en extrayant et en affichant les propriétés de l’abonnement.

> [!Note]
>
> Vous pouvez utiliser cet exemple pour afficher les valeurs de propriété d’un abonnement ou vous pouvez taper la commande suivante à l’invite de commandes :
>
...
L’exemple de code suivant suit une procédure pour afficher les propriétés d’un abonnement du collecteur d’événements et de ses sources d’événements associées.
...
L’exemple de code C++ suivant montre comment afficher les propriétés d’un abonnement à un collecteur d’événements.
