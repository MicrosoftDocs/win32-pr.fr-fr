...
Étant donné que Windows ne prend actuellement en charge que les lecteurs d’empreintes digitales, les valeurs suivantes doivent être utilisées dans la structure de **\_ \_ format inscrit WINBIO** .
