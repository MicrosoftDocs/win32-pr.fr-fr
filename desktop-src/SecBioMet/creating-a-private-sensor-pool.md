...
Les rubriques suivantes contiennent des exemples de code qui montrent comment créer un pool de capteurs privés.
...
|-------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------|
| [Pools de capteurs](sensor-pools.md)<br/>                                   | Décrit trois pools de capteurs possibles : système, privé et non assigné.<br/>                   |
| [Configuration du pool privé](private-pool-setup.md)<br/>                       | Contient le projet de console d’installation.<br/>                                                       |
