...
---
# <a name="storage-adapter-functions"></a>Fonctions des adaptateurs de stockage

Un adaptateur de stockage gère les bases de données de modèles. Les fonctions suivantes doivent être implémentées par le développeur de l’adaptateur. Elles sont appelées par le service de biométrie Windows.
...
|-----------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|
| [**StorageAdapterActivate**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_storage_activate_fn)<br/>                           | Donne à la carte de stockage la possibilité d’effectuer tout travail nécessaire pour rendre le composant de stockage inactif.<br/>         |
...
| [**StorageAdapterDeactivate**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_storage_deactivate_fn)<br/>                       | Permet à l’adaptateur de stockage d’effectuer les tâches nécessaires pour mettre le composant de stockage en état d’inactivité.<br/>             |
...
| [**StorageAdapterPipelineCleanup**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_storage_pipeline_cleanup_fn)<br/>             | Permet à l’adaptateur de stockage d’effectuer tout nettoyage en vue de la fermeture de la base de données de modèle.<br/>                |
| [**StorageAdapterPipelineInit**](/windows/desktop/api/Winbio_adapter/nc-winbio_adapter-pibio_storage_pipeline_init_fn)<br/>                   | Donne à l’adaptateur de stockage la possibilité d’effectuer toute initialisation qui reste incomplète.<br/>                                  |
