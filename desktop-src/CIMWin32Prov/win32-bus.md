...
ms.locfileid: "119020317"
---
# <a name="win32_bus-class"></a>\_Classe de bus Win32

la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ bus Win32** représente un bus physique tel qu’il est vu par un ordinateur exécutant un système d’exploitation Windows. toute instance d’un bus Windows est un descendant (ou membre) de cette classe.
...
La classe de **\_ bus Win32** possède les types de membres suivants :
...
La classe de **\_ bus Win32** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                                      |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ LogicalDevice**](cim-logicaldevice.md) pour obtenir de la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ LogicalDevice**](cim-logicaldevice.md) pour obtenir de la documentation.<br/> |
...
La classe de **\_ bus Win32** possède ces propriétés.
...
Nombre logique affecté au bus physique.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("win32api \| cHwRes \| interface \_ type")
</dt> </dl>

Type du bus physique. Cette valeur sera l’une des valeurs de l’énumération de **\_ type interface** définie dans bus. h.
...
Nom unique qui identifie le bus.
...
La classe de **\_ bus Win32** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
