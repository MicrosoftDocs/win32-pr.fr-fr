...
ms.locfileid: "127225108"
---
# <a name="win32_pnpentity-class"></a>\_Classe PnPEntity Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PnPEntity** WMI représente les propriétés d’un appareil plug-and-Play. Plug-and-Play entités sont affichées comme entrées dans le Gestionnaire de périphériques situé dans le panneau de configuration.
...
| Méthode                                                             | Description                                                                                                                                                                                    |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**Désactive**](disable-win32-pnpentity.md)                         | Désactive cet appareil Plug-and-Play.<br/>                                                                                                                                                 |
| [**Activer**](enable-win32-pnpentity.md)                           | Active cette Plug-and-Play appareil.<br/>                                                                                                                                                  |
| [**GetDeviceProperties**](getdeviceproperties-win32-pnpentity.md) | Obtient les propriétés spécifiées de cette Plug-and-Play appareil.<br/>                                                                                                                         |
...
La méthode **SetPowerState** est prise en charge. Cette méthode se trouve sur la classe parente du [**\_ LogicalDevice CIM**](cim-logicaldevice.md) et peut être implémentée. Pour plus d’informations, consultez [conception de Classes format MOF (MOF)](../wmisdk/designing-managed-object-format--mof--classes.md).
...
Nom du service qui prend en charge cet appareil Plug-and-Play. Pour plus d’informations, consultez [**Win32 \_ SystemDriverPnPEntity**](win32-systemdriverpnpentity.md).
...
L’exemple [Get-BrokenHardware.ps1](https://Gallery.TechNet.Microsoft.Com/dbb678f4-b95b-45c3-bc8b-2ae2d052448e) PowerShell de la Galerie TechNet utilise pour **Win32 \_ PnPEntity** pour récupérer une liste de matériel non opérationnel à l’aide de WMI.
...
[Connexion à WMI sur un ordinateur distant](../wmisdk/connecting-to-wmi-on-a-remote-computer.md)
</dt> <dt>
