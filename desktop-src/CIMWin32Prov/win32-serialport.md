---
description: La \_ classe WMI SerialPort Win32 représente un port série sur un système d’ordinateur exécutant Windows.
...
ms.locfileid: "127124227"
---
# <a name="win32_serialport-class"></a>\_Classe SerialPort Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ SerialPort Win32** représente un port série sur un système d’ordinateur exécutant Windows.
...
La **classe \_ SerialPort Win32** possède les types de membres suivants :
...
La **classe \_ SerialPort Win32** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ SerialController**](cim-serialcontroller.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ SerialController**](cim-serialcontroller.md).<br/> |
...
La **classe \_ SerialPort Win32** possède ces propriétés.
...
Si la **valeur est true**, le port série est configuré pour le transfert de données binaires. étant donné que l’API Windows ne prend pas en charge les transferts en mode non binaire, cette propriété doit avoir la **valeur TRUE**.
...
Qualificateurs : [**arrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Ports série DMTF \| 004,7 "), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ SerialController**](cim-serialcontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Tableau de compatibilité au niveau du processeur pour le contrôleur série. Cette propriété décrit la mise en mémoire tampon et d’autres fonctionnalités du contrôleur série qui peuvent être inhérentes au matériel de puce. La propriété est un entier énuméré.

Cette propriété est héritée de la [**\_ SerialController CIM**](cim-serialcontroller.md).
...
Qualificateurs : [**arrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ SerialController**](cim-serialcontroller.md).**Capacités**»)
</dt> </dl>

Tableau de chaînes de forme libre fournissant des explications plus détaillées sur les fonctionnalités du contrôleur série indiquées dans le tableau des **fonctionnalités** . Notez que chaque entrée de ce tableau est liée à l’entrée dans le tableau de **fonctionnalités** qui se trouve dans le même index.
...
Qualificateurs : [**clé**](../wmisdk/key-qualifier.md), [**override**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ SerialComm")
</dt> </dl>

Identificateur unique du port série avec d’autres périphériques sur le système.
...
Chaîne de forme libre fournissant plus d’informations sur l’erreur enregistrée dans **LastErrorCode**, ainsi que des informations sur les actions correctives qui peuvent être prises.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Ports série DMTF \| 004,6 "), [**unités**](../wmisdk/standard-qualifiers.md) (" bits par seconde ")
</dt> </dl>

Débit en bauds maximal (en bits par seconde) pris en charge par le contrôleur série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| des structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwMaxRxQueue"), [**unités**](../wmisdk/standard-qualifiers.md) ("bytes")
</dt> </dl>

Taille maximale de la mémoire tampon d’entrée interne du pilote du port série. La valeur 0 (zéro) indique qu’aucune valeur maximale n’est imposée par le fournisseur série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| des structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwMaxTxQueue"), [**unités**](../wmisdk/standard-qualifiers.md) ("bytes")
</dt> </dl>

Taille maximale de la mémoire tampon de sortie interne du pilote du port série. La valeur 0 (zéro) indique qu’aucune valeur maximale n’est imposée par le fournisseur série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Port de bus DMTF \| 001,9 ")
</dt> </dl>

Nombre maximal d’entités directement adressables qui sont prises en charge par ce contrôleur. La valeur 0 (zéro) doit être utilisée si le nombre est inconnu.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« Win32Registry \| Hardware \\ \\ description \\ \\ System \\ \\ MultifunctionAdapter »)
</dt> </dl>

Si la **valeur est true**, les instances de cette classe ont été détectées automatiquement par le système d’exploitation. Si, par exemple, le matériel a été ajouté par le biais du panneau de configuration, le système d’exploitation trouve les instances de cette classe en interrogeant le matériel à partir des instances de cette classe.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Port de bus DMTF \| 001,2 "," MIF. \|Disques DMTF \| 003,3 ")
</dt> </dl>

Protocole utilisé par le contrôleur pour accéder aux appareils « contrôlés ».

Cette propriété est héritée [**du \_ contrôleur CIM**](cim-controller.md). La liste suivante indique les valeurs possibles.
...
<span id="Flexible_Diskette"></span><span id="flexible_diskette"></span><span id="FLEXIBLE_DISKETTE"></span>**Disquette flexible** (7)
...
<span id="SCSI_Parallel_Interface"></span><span id="scsi_parallel_interface"></span><span id="SCSI_PARALLEL_INTERFACE"></span>**Interface parallèle SCSI** (9)
...
<span id="SCSI_Fibre_Channel_Protocol"></span><span id="scsi_fibre_channel_protocol"></span><span id="SCSI_FIBRE_CHANNEL_PROTOCOL"></span>**Protocole SCSI Fibre Channel** (10)
...
<span id="SCSI_Serial_Bus_Protocol"></span><span id="scsi_serial_bus_protocol"></span><span id="SCSI_SERIAL_BUS_PROTOCOL"></span>**Protocole de bus série SCSI** (11)
...
<span id="SCSI_Serial_Bus_Protocol-2__1394_"></span><span id="scsi_serial_bus_protocol-2__1394_"></span><span id="SCSI_SERIAL_BUS_PROTOCOL-2__1394_"></span>**Protocole serial bus SCSI-2 (1394)** (12)
...
<span id="SCSI_Serial_Storage_Architecture"></span><span id="scsi_serial_storage_architecture"></span><span id="SCSI_SERIAL_STORAGE_ARCHITECTURE"></span>**Architecture de Stockage de série SCSI** (13)
...
<span id="Universal_Serial_Bus"></span><span id="universal_serial_bus"></span><span id="UNIVERSAL_SERIAL_BUS"></span>**Bus série universel** (16)
...
<span id="Parallel_Protocol"></span><span id="parallel_protocol"></span><span id="PARALLEL_PROTOCOL"></span>**Protocole parallèle** (17)
...
<span id="Power"></span><span id="power"></span><span id="POWER"></span>**Puissance** (21)
...
<span id="HIPPI"></span><span id="hippi"></span>**HIPPA** (22)
...
<span id="Enhanced_ATA_IDE"></span><span id="enhanced_ata_ide"></span><span id="ENHANCED_ATA_IDE"></span>**ATA/IDE amélioré** (42)
...
<span id="TWIRP__two-way_infrared_"></span><span id="twirp__two-way_infrared_"></span><span id="TWIRP__TWO-WAY_INFRARED_"></span>**TWIRP (infrarouge bidirectionnel)** (44)
...
<span id="FIR__fast_infrared_"></span><span id="fir__fast_infrared_"></span><span id="FIR__FAST_INFRARED_"></span>**FIR (infrarouge rapide)** (45)
...
<span id="SIR__serial_infrared_"></span><span id="sir__serial_infrared_"></span><span id="SIR__SERIAL_INFRARED_"></span>**Sir (infrarouge série)** (46)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvSubType")
</dt> </dl>
...
<dl> <dd>« Périphérique de télécopie »</dd> <dd>« Protocole LAT »</dd> <dd>« Périphérique modem »</dd> <dd>« Pont réseau »</dd> <dd>« Port parallèle »</dd> <dd>« Port série RS232 »</dd> <dd>« Port RS422 »</dd> <dd>« Port RS423 »</dd> <dd>« Port RS449 »</dd> <dd>« Périphérique du scanneur »</dd> <dd>« TelNet TCP/IP »</dd> <dd>« X. 25 »</dd> <dd>Non spécifié</dd> </dl>

<dt>

<span id="FAX_Device"></span><span id="fax_device"></span><span id="FAX_DEVICE"></span>

**Périphérique de télécopie** (« périphérique de télécopie »)
...
**Périphérique modem** (« périphérique modem »)
...
**Port série RS232** (« port série RS232 »)
...
**Périphérique scanneur** (« périphérique scanneur »)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams \| SP \_ bauds")
</dt> </dl>

Si la **valeur est true**, la vitesse en bauds peut être modifiée pour ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams \| SP \_ DATABITS")
</dt> </dl>

Si la **valeur est true**, les bits de données peuvent être définis pour ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api de \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams de négociation de \| SP \_ ")
</dt> </dl>

Si la **valeur est true**, le contrôle de Flow peut être défini pour ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams \| SP \_ Parity")
</dt> </dl>

Si la **valeur est true**, la parité peut être définie pour ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams \| SP de contrôle de \_ parité \_ ")
</dt> </dl>

Si la **valeur est true**, la vérification de la parité peut être définie pour ce port série (si le contrôle de parité est pris en charge).
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams \| SP \_ RLSD")
</dt> </dl>

Si la **valeur est true**, la détection de signal de ligne reçue (RLSD) peut être définie pour ce port série (si RLSD est pris en charge).
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwSettableParams \| SP \_ arrêt")
</dt> </dl>

Si la **valeur est true**, les bits d’arrêt peuvent être définis pour ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ 16BITMODE")
</dt> </dl>

Si la **valeur est true**, le mode 16 bits est pris en charge sur ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ DTRDSR")
</dt> </dl>

Si la **valeur est true**, les signaux DTR (Data Terminal Ready) et DSR (Data Set Ready) sont pris en charge sur ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ TOTALTIMEOUTS")
</dt> </dl>

Si la **valeur est true**, les délais d’expiration écoulés sont pris en charge sur ce port série. Les délais d’expiration écoulés effectuent le suivi de la durée totale entre les transmissions de données.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ INTTIMEOUTS")
</dt> </dl>

Si la **valeur est true**, les délais d’expiration des intervalles sont pris en charge. Un délai d’expiration de l’intervalle est la durée autorisée à s’écouler entre l’arrivée de chaque élément de données.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api des \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| contrôle de parité PCF \_ \_ ")
</dt> </dl>

Si la **valeur est true**, le contrôle de parité est pris en charge sur ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ RLSD")
</dt> </dl>

Si la **valeur est true**, la détection de signal de ligne reçue (RLSD) est prise en charge sur ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ RTSCTS")
</dt> </dl>

Si la **valeur est true**, les signaux RTS (Ready to Send) et CTS (Clear to Send) sont pris en charge sur ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ SPECIALCHARS")
</dt> </dl>

Si la **valeur est true**, les caractères de contrôle de port série sont pris en charge. Ces caractères signalent des événements plutôt que des données. Ces caractères ne peuvent pas être lus et sont définis par le pilote. Elles incluent EofChar, ErrorChar, BreakChar, EventChar, XonChar et XoffChar.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ XONXOFF")
</dt> </dl>

Si la **valeur est true**, Xon ou XOFF Flow-Control est pris en charge sur ce port série.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , structures de communication \| [**COMMPROP**](/windows/win32/api/winbase/ns-winbase-commprop) \| dwProvCapabilities \| PCF \_ SETXCHAR")
</dt> </dl>

Si la **valeur est true**, le fournisseur de communications prend en charge la configuration du paramètre de contrôle de workflow XOFF XONor.
...
Date et heure de la dernière réinitialisation de ce contrôleur. Cela peut signifier que le contrôleur a été mis hors tension ou réinitialisé.
...
La **classe \_ SerialPort Win32** est dérivée de la [**\_ SerialController CIM**](cim-serialcontroller.md).

## <a name="examples"></a>Exemples

pour obtenir une autre méthode de récupération des informations du port série (à partir du registre), consultez l’exemple [énumérer les Ports](https://Gallery.TechNet.Microsoft.Com/scriptcenter/087b4d73-4a5e-4746-b365-ad682911360e) Visual Basic.

L’exemple PowerShell [list port série Properties](https://Gallery.TechNet.Microsoft.Com/42ff8eab-7d2b-4549-b178-835daecf4f12) retourne des informations sur les ports série installés sur un ordinateur.

L’exemple VBScript suivant retourne des informations sur les ports série installés sur un ordinateur.
