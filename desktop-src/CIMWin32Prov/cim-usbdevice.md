...
ms.locfileid: "119918799"
---
# <a name="cim_usbdevice-class-cimwin32-wmi-providers"></a>CIM_USBDevice, classe (fournisseurs WMI CIMWin32)

La classe **CIM \_ USBDevice** représente les caractéristiques de gestion d’un périphérique USB.
...
| Méthode                                                               | Description                                                                                                                              |
|:---------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**GetDescriptor**](getdescriptor-method-in-class-cim-usbdevice.md) | Retourne le descripteur de périphérique USB. Non implémenté par WMI.<br/>                                                                    |
| [**Initialisation**](reset-method-in-class-cim-usbdevice.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-usbdevice.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
Configuration actuellement sélectionnée pour l’appareil. Si la valeur est 0 (zéro), l’appareil n’est pas configuré.
...
La classe **CIM \_ USBDevice** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI n’implémente pas cette classe. Pour les classes WMI qui implémentent **CIM \_ USBDevice**, consultez [classes Win32](win32-provider.md).
