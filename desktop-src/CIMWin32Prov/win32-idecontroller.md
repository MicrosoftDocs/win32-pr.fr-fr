...
ms.locfileid: "120085779"
---
# <a name="win32_idecontroller-class"></a>\_Classe IDEController Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ IDEController** gère les fonctionnalités d’un appareil de contrôleur IDE (Integrated Device Electronics).
...
La classe **Win32 \_ IDEController** possède les types de membres suivants :
...
La classe **Win32 \_ IDEController** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                                |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans le [**\_ contrôleur CIM**](cim-controller.md) pour obtenir de la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans le [**\_ contrôleur CIM**](cim-controller.md) pour la documentation.<br/> |
...
La classe **Win32 \_ IDEController** a ces propriétés.
...
Identificateur unique du contrôleur IDE avec d’autres périphériques sur le système.
...
Informations supplémentaires sur l’erreur enregistrée dans la propriété **LastErrorCode** , et informations sur les actions correctives qui peuvent être prises.
...
Fabricant du périphérique contrôleur IDE.
...
Windows Plug-and-Play ID de périphérique de l’unité logique.
...
Si la **valeur est true**, l’appareil peut être géré par l’alimentation mis en mode veille, et ainsi de suite. La propriété n’indique pas que les fonctionnalités de gestion de l’alimentation sont actuellement activées, mais uniquement que l’appareil logique est capable de gérer l’alimentation.
...
La classe **Win32 \_ IDEController** est dérivée [**du \_ contrôleur CIM**](cim-controller.md).
