...
La méthode de classe **compresser** [WMI](/windows/desktop/WmiSdk/retrieving-a-class) compresse le fichier de codec logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet.
