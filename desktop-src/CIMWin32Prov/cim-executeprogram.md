...
La classe **CIM \_ ExecuteProgram** représente des fichiers qui peuvent être exécutés sur le système sur lequel l’élément logiciel est installé.
...
La classe **CIM \_ ExecuteProgram** possède les types de membres suivants :
...
La classe **CIM \_ ExecuteProgram** possède ces méthodes.



| Méthode                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-executeprogram.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ ExecuteProgram** possède les propriétés suivantes.
...
Chaîne qui peut être appelée sur une ligne de commande système.
