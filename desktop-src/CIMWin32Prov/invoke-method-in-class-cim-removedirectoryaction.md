...
ms.locfileid: "120064869"
---
# <a name="invoke-method-of-the-cim_removedirectoryaction-class"></a>Méthode Invoke de la \_ classe CIM RemoveDirectoryAction

La méthode **Invoke** de la classe [**CIM \_ RemoveDirectoryAction**](cim-removedirectoryaction.md) prend une mesure particulière. Les détails de la méthode d’exécution de l’action sont spécifiques à l’implémentation. Cette méthode est héritée de l' [**\_ action CIM**](cim-action.md).
