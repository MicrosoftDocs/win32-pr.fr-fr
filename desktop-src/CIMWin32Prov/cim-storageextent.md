...
ms.locfileid: "119919179"
---
# <a name="cim_storageextent-class-cimwin32-wmi-providers"></a>CIM_StorageExtent, classe (fournisseurs WMI CIMWin32)

La classe **CIM \_ StorageExtent** représente les fonctionnalités et la gestion des différents médias qui existent pour stocker des données et permettre la récupération des données. Cette classe parente peut représenter les différents composants de RAID (matériel ou logiciel) ou une extension logique brute sur les supports physiques.
...
La classe **CIM \_ StorageExtent** possède ces méthodes.



| Méthode                                                                   | Description                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-storageextent.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-storageextent.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ StorageExtent** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ StorageExtent**, consultez [classes Win32](win32-provider.md).
