...
Représente une propriété d’appareil PnP composée d’un tableau d’éléments **DateTime** .
...
La classe **Win32 \_ PnPDevicePropertyDateTimeArray** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PnPDevicePropertyDateTimeArray** a ces propriétés.
...
Type de données : tableau **DateTime**
</dt> <dt>
