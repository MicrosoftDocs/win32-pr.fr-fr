...
La classe **CIM \_ PhysicalComponent** représente un composant de base ou de bas niveau au sein d’un package. Un élément physique qui n’est pas un lien, un connecteur ou un package est un descendant (ou membre) de cette classe. Par exemple, le circuit microprogrammé UART sur une carte modem interne est une sous-classe (si des propriétés ou des associations supplémentaires sont définies) ou une instance de **\_ PhysicalComponent CIM**.
...
La classe **CIM \_ PhysicalComponent** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ PhysicalComponent** possède les propriétés suivantes.
...
WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ PhysicalComponent**, consultez [classes Win32](win32-provider.md).
