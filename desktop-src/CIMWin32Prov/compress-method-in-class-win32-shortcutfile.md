...
ms.locfileid: "126920512"
---
# <a name="compress-method-of-the-win32_shortcutfile-class"></a>Méthode Compress de la \_ classe ShortcutFile Win32

La méthode de classe **compresser** [WMI](/windows/desktop/WmiSdk/retrieving-a-class) compresse le fichier de raccourci logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet.
