...
ms.locfileid: "127010207"
---
# <a name="reset-method-of-the-cim_userdevice-class"></a>Méthode Reset de la \_ classe CIM UserDevice

La méthode **Reset** de la \_ classe CIM UserDevice demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
