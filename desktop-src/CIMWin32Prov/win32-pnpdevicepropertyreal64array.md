...
Représente une propriété d’appareil PnP composée d’un tableau d’éléments **real64** .
...
La classe **Win32 \_ PnPDevicePropertyReal64Array** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PnPDevicePropertyReal64Array** a ces propriétés.
...
Type de données : tableau **real64**
</dt> <dt>
