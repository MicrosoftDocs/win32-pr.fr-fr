...
ms.locfileid: "127225441"
---
# <a name="cim_chip-class"></a>\_Classe de puce CIM

La classe de **\_ puces CIM** représente le type de matériel de circuit intégré, y compris les ASIC, les processeurs, les puces de mémoire, et ainsi de suite.
...
La classe de **\_ puce CIM** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe de **\_ puce CIM** possède ces propriétés.
...
Facteur de forme d’implémentation pour la puce. Les valeurs suivantes peuvent être spécifiées.
...
La classe de **\_ puce CIM** est dérivée de la [**\_ PhysicalComponent CIM**](cim-physicalcomponent.md).

WMI n’implémente pas cette classe. Pour plus d’informations sur les classes dérivées de la **\_ puce CIM**, consultez [classes Win32](win32-provider.md).
