...
ms.locfileid: "126917100"
---
# <a name="compress-method-of-the-cim_directory-class"></a>Méthode Compress de la \_ classe de répertoire CIM

La méthode **Compress** compresse le fichier d’entrée de répertoire logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet. Cette méthode est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
[\_Répertoire CIM](compress-method-in-class-cim-directory.md)
</dt> <dt>
