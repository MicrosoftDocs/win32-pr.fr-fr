...
ms.locfileid: "126917156"
---
# <a name="cim_parallelcontroller-class"></a>\_Classe CIM ParallelController

L’Association **CIM \_ ParallelController** se réfère aux fonctionnalités et à la gestion de l’unité logique de port parallèle.
...
La classe **CIM \_ ParallelController** possède les types de membres suivants :
...
La classe **CIM \_ ParallelController** possède ces méthodes.
...
La classe **CIM \_ ParallelController** possède les propriétés suivantes.
...
Qualificateurs : [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Ports parallèles DMTF \| 003,8 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**CapabilityDescriptions**")
</dt> </dl>

Fonctionnalités du contrôleur parallèle.
...
Qualificateurs : [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ParallelController**.**Capacités**»)
</dt> </dl>

Chaînes de forme libre qui fournissent des explications détaillées sur les fonctionnalités du contrôleur parallèle indiquées dans le tableau des **fonctionnalités** .
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Ports parallèles DMTF \| 003,7 ")
</dt> </dl>

Si la **valeur est true**, l’accès direct à la mémoire (DMA) est pris en charge.
...
Nombre maximal d’entités directement adressables prises en charge par le contrôleur. La valeur 0 (zéro) doit être utilisée si le nombre est inconnu ou illimité.
...
WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ ParallelController**, consultez [classes Win32](win32-provider.md).
