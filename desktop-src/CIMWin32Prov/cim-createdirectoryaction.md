...
ms.locfileid: "119924719"
---
# <a name="cim_createdirectoryaction-class"></a>\_Classe CIM CreateDirectoryAction

La classe **CIM \_ CreateDirectoryAction** crée des répertoires vides pour les éléments logiciels à installer localement.
...
La classe **CIM \_ CreateDirectoryAction** possède les types de membres suivants :
...
La classe **CIM \_ CreateDirectoryAction** possède ces méthodes.



| Méthode                                                             | Description                                                                                                                                  |
|:-------------------------------------------------------------------|:---------------------------------------------------------------------------------------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-createdirectoryaction.md) | Effectue une action particulière. Les détails de la façon dont la méthode exécute l’action sont spécifiques à l’implémentation. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ CreateDirectoryAction** possède les propriétés suivantes.
...
WMI n’implémente pas cette classe. Pour les classes dérivées de **CIM \_ CreateDirectoryAction**, consultez [classes Win32](win32-provider.md).
