...
ms.locfileid: "119820329"
---
# <a name="cim_pointingdevice-class-cimwin32-wmi-providers"></a>CIM_PointingDevice, classe (fournisseurs WMI CIMWin32)

La classe **CIM \_ PointingDevice** représente un appareil qui pointe vers des régions sur l’écran. Tout appareil qui manipule un pointeur ou qui pointe vers des régions sur un affichage visuel, est un membre de cette classe. Par exemple, une souris, un stylet, un pavé tactile ou une tablette.
...
La classe **CIM \_ PointingDevice** possède ces méthodes.



| Méthode                                                                    | Description                                                                                                                              |
|:--------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-pointingdevice.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pointingdevice.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
Configuration du dispositif de pointage pour une opération à droite ou à gauche.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de pointage DMTF \| 001,1 ")
</dt> </dl>
...
Qualificateurs : [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (« nombres par pouce »)
</dt> </dl>
...
La classe **CIM \_ PointingDevice** est dérivée de [**CIM \_ UserDevice**](cim-userdevice.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ PointingDevice**, consultez [classes Win32](win32-provider.md).
