...
La classe **CIM \_ BinarySensor** possède les types de membres suivants :
...
La classe **CIM \_ BinarySensor** possède ces méthodes.



| Méthode                                                                  | Description                                                                                                                                |
|:------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-binarysensor.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-binarysensor.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et le moment où l’appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ BinarySensor** possède les propriétés suivantes.
...
Description d’une valeur’false’à partir du capteur binaire. Ces informations peuvent être affichées à un utilisateur.
...
Description d’une valeur « true » du capteur binaire. Ces informations peuvent être affichées à un utilisateur.
...
La classe **CIM \_ BinarySensor** est dérivée [**du \_ capteur CIM**](cim-sensor.md).
