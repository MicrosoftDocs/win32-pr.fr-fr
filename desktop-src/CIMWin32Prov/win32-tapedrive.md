...
ms.locfileid: "119020097"
---
# <a name="win32_tapedrive-class"></a>Classe Win32 de la \_ classe

La [classe WMI](../wmisdk/retrieving-a-class.md) de l’ordinateur **Win32 \_** représente un lecteur de bande sur un système informatique exécutant Windows. Les lecteurs de bande sont principalement distingués par le fait qu’ils ne peuvent être accessibles que de manière séquentielle.
...
La **classe \_ Win32** de la classe a ces types de membres :
...
La **classe \_ Win32** de la classe a ces méthodes.



| Méthode            | Description                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_**](cim-tapedrive.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_**](cim-tapedrive.md).<br/> |
...
La **classe \_ Win32** de la classe a ces propriétés.
...
Qualificateurs : [**arrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).**Capacités**»)
</dt> </dl>

Tableau de chaînes de forme libre fournissant des explications plus détaillées sur les fonctionnalités de l’appareil Access indiquées dans le tableau **fonctionnalités** . Notez que chaque entrée de ce tableau est liée à l’entrée dans le tableau de **fonctionnalités** qui se trouve dans le même index.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("structures de sauvegarde sur bande win32api structure de la bande d’accès aux \| \| [**\_ \_ \_ paramètres de lecteur**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| compression")
</dt> </dl>

Si la **valeur est true**, la compression des données matérielles est activée.
...
Chaîne de forme libre indiquant l’algorithme ou l’outil utilisé par l’appareil pour prendre en charge la compression. S’il n’est pas possible de décrire le schéma de compression (peut-être parce qu’il n’est pas connu), utilisez les mots suivants : « inconnu » pour indiquer qu’il n’est pas connu que l’appareil prend en charge les fonctionnalités de compression. « Compressed » pour représenter que l’appareil prend en charge les fonctionnalités de compression, mais que son schéma de compression n’est pas connu ou n’est pas divulgué ; et « non compressés » pour représenter que l’appareil ne prend pas en charge les fonctionnalités de compression.
...
Qualificateurs : [**clé**](../wmisdk/key-qualifier.md), [**remplacement**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("fonctions de \| fichier win32api \| CreateFile")
</dt> </dl>

Identificateur unique du lecteur de bande avec les autres périphériques du système.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| structures de sauvegarde sur bande win32api les \| [**\_ \_ \_ paramètres de lecteur bande**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters)d’accès \| ECC")
</dt> </dl>

Si la **valeur est true**, l’appareil prend en charge la correction des erreurs matérielles.
...
Taille de zone pour l’avertissement de fin de bande (EOT).

Cette propriété est héritée de la propriété [**CIM \_**](cim-tapedrive.md).
...
Chaîne de forme libre décrivant le type de détection d’erreurs et de correction pris en charge par cet appareil.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| structures de sauvegarde sur bande win32api \| ,[**\_ \_ \_ paramètres de lecteur de bande**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesHigh")
</dt> </dl>

Poids élevé 32 bits de l’indicateur de fonctionnalités de l’appareil.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| structures de sauvegarde sur bande win32api \| ,[**\_ \_ \_ paramètres de lecteur de bande**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| FeaturesLow")
</dt> </dl>

Poids faible 32 bits de l’indicateur de fonctionnalités de l’appareil.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« \| fonctions de fichier win32api »)
</dt> </dl>

nom identifiant le lecteur de CD-rom Windows du fabricant.

Exemple : « PLEXTOR CD-ROM PX-12CS 1,01 »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Appareils d’accès séquentiel DMTF \| 001,2 "), [**unités**](../wmisdk/standard-qualifiers.md) (" kilo-octets ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32 \_ \| MediaType \| Tape Drive)
</dt> </dl>

Type de média utilisé par cet appareil (ou auquel il est accessible). Dans ce cas, il est défini sur « lecteur de bande ».
...
Nombre maximal de médias individuels qui peuvent être pris en charge ou insérés dans l’appareil d’accès aux médias (en cas de prise en charge).
...
Nombre d’octets insérés entre les blocs sur un support de bande.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (" \| structures de sauvegarde sur bande win32api \| ,[**\_ \_ \_ paramètres de lecteur de bande**](/windows/win32/api/winnt/ns-winnt-tape_get_drive_parameters) \| ReportSetmarks")
</dt> </dl>

Si la **valeur est true**, SETMARK Reporting est activé. SETMARK Reporting utilise un élément enregistré spécialisé qui ne contient pas de données utilisateur. Cet élément enregistré est utilisé pour fournir un schéma de segmentation qui est hiérarchiquement supérieur aux marques de programme. Les Setmarks permettent de positionner plus rapidement les bandes de grande capacité.
...
La **classe \_ Win32** de la part est dérivée de [**CIM \_**](cim-tapedrive.md).
