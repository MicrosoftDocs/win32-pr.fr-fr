...
La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ SystemSlot** WMI représente des points de connexion physiques, y compris les ports, les emplacements de carte mère et les périphériques, ainsi que les points de connexion propriétaires.
...
La classe **Win32 \_ SystemSlot** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ SystemSlot** a ces propriétés.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| bus Number")
</dt> </dl>

Numéro de bus SMBIOS.
...
Qualificateurs : [**override**](../wmisdk/standard-qualifiers.md) ("ConnectorType"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("type d' \| emplacement SMBIOS type 9 \| ")
</dt> </dl>

Tableau d’attributs physiques du connecteur utilisé par cet emplacement.

Cette valeur provient du membre de **type d’emplacement** de la structure des **emplacements système** dans les informations SMBIOS.
...
**SCSI (A) High-Density (50 broches)** (6)
...
**SCSI (P) High-Density (68 broches)** (8)
...
**Fibre Channel SCSI (DB-9, cuivre)** (11)
...
**SCSI Fibre Channel SCA-II (40 broches)** (13)
...
**SCSI Fibre Channel SCA-II (20 broches)** (14)
...
**ATA 3-1/2 pouces (40 broches)** (16)
...
**ATA 2-1/2 pouces (44 broches)** (17)
...
**Emplacement de la carte de processeur propriétaire** (77)
...
**Emplacement de carte mémoire propriétaire** (78)
...
**Emplacement de la carte de montage des e/s propriétaire** (79)
...
**SBus IEEE 1396-1993 64 bits** (90)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| Current usage")
</dt> </dl>

État de l’utilisation de l’emplacement système.

Cette valeur provient du membre d' **utilisation actuel** de la structure des **emplacements système** dans les informations SMBIOS.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| Device Number")
</dt> </dl>

Numéro d’appareil SMBIOS.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| Function Number")
</dt> </dl>

Numéro de fonction SMBIOS.
...
Hauteur maximale d’une carte d’adaptateur pouvant être insérée dans l’emplacement, en pouces.

Cette propriété est héritée de l' [**\_ emplacement CIM**](cim-slot.md).
...
Longueur maximale d’une carte d’adaptateur pouvant être insérée dans l’emplacement, en pouces.
...
Qualificateurs : [**override**](../wmisdk/standard-qualifiers.md) ("MaxDataWidth"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Emplacement système DMTF \| 004,3 "), [**unités**](../wmisdk/standard-qualifiers.md) (" bits ")
</dt> </dl>

Largeur de bus maximale des cartes réseau qui peuvent être insérées dans cet emplacement, en bits. Il peut s’agir de l’une des valeurs suivantes.

Cette valeur provient du membre de la **largeur du bus de données** de l’emplacement de la structure des **emplacements système** dans les informations SMBIOS.
...
Largeur maximale des données (bits) : 8
...
Largeur maximale des données (bits) : 16
...
Largeur maximale des données (bits) : 32
...
Largeur maximale des données (bits) : 64
...
Largeur maximale des données (bits) : 128
...
Étiquette de l’objet. Lorsqu’elle est sous-classée, cette propriété peut être substituée pour être une propriété de clé.
...
Numéro d’emplacement physique qui peut être utilisé comme index dans une table d’emplacements système, que cet emplacement soit ou non physiquement vide.

Cette valeur provient du membre **ID d’emplacement** de la structure des **emplacements système** dans les informations SMBIOS.
...
Numéro de référence que le producteur ou le fabricant attribue à l’élément physique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| slot CARACTERISTIQUES 2")
</dt> </dl>

Si la **valeur est true**, le signal de gestion de l’alimentation du bus PCI activé (PME) est pris en charge par cet emplacement.

Cette valeur provient du membre des caractéristiques de l' **emplacement 2** de la structure des **emplacements système** dans les informations SMBIOS.
...
Qualificateurs : [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**\_ emplacement CIM**](cim-slot.md).**SpecialPurpose**")
</dt> </dl>

Chaîne de forme libre qui décrit comment cet emplacement est physiquement unique et peut contenir des types de matériel spécifiques. Cette propriété n’a de signification que lorsque la propriété correspondante **SpecialPurpose** a la **valeur true**.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| segment Group Number")
</dt> </dl>

Numéro de groupe de segments SMBIOS.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| slot characteristics 1")
</dt> </dl>

Si la **valeur est true**, deux ou plusieurs emplacements partagent un emplacement sur la carte de site, tel qu’un emplacement partagé PCI/EISA.

Cette valeur provient du membre des caractéristiques de l' **emplacement 1** de la structure des **emplacements système** dans les informations SMBIOS.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 9 \| slot désignation")
</dt> </dl>

Chaîne SMBIOS qui identifie la désignation de l’emplacement système de l’emplacement sur la carte mère.

Exemple : « PCI-1 »

Cette valeur provient du membre de **désignation d’emplacement** de la structure des **emplacements système** dans les informations SMBIOS.
...
Qualificateurs : [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**\_ emplacement CIM**](cim-slot.md).**PurposeDescription**")
</dt> </dl>

Si la **valeur est true**, cet emplacement est physiquement unique et peut contenir des types de matériel spéciaux, tels qu’un emplacement de processeur graphique. Si la **valeur est true**, **PurposeDescription** doit spécifier la nature de l’unicité ou de l’objectif de l’emplacement.
...
Emplacement système représenté par une instance de cette classe.

Cette propriété est héritée de la [**\_ PhysicalElement CIM**](cim-physicalelement.md).

Exemple : « emplacement système 1 »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Emplacement système DMTF \| 004,11 "), [**unités**](../wmisdk/standard-qualifiers.md) (" milliwatts ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Emplacement système DMTF \| 004,9 ")
</dt> </dl>

Tableau d’entiers énumérés indiquant la tension Vcc prise en charge par cet emplacement.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Emplacement système DMTF \| 004,10 ")
</dt> </dl>

Tableau d’entiers énumérés indiquant la tension VPP prise en charge par cet emplacement.
