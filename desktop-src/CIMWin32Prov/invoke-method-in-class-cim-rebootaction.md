...
ms.locfileid: "126999503"
---
# <a name="invoke-method-of-the-cim_rebootaction-class"></a>Méthode Invoke de la \_ classe CIM rebootaction

La méthode **Invoke** de la classe [**CIM \_ rebootaction**](cim-rebootaction.md) prend une mesure particulière. Les détails de la façon dont la méthode effectue l’action sont spécifiques à l’implémentation. Cette méthode est héritée de l' [**\_ action CIM**](cim-action.md).
