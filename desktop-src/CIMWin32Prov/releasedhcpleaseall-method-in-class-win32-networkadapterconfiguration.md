...
ms.locfileid: "120077499"
---
# <a name="releasedhcpleaseall-method-of-the-win32_networkadapterconfiguration-class"></a>Méthode ReleaseDHCPLeaseAll de la \_ classe Win32 NetworkAdapterConfiguration

La méthode statique de la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ReleaseDHCPLeaseAll** libère les adresses IP liées à toutes les cartes réseau compatibles DHCP.

> [!Note]  
> AVERTISSEMENT Si le protocole DHCP est activé sur le système de l’ordinateur local, l’option met fin à toutes les connexions TCP/IP DHCP.
...
L’exemple de code VBScript suivant libère tous les baux DHCP actuellement utilisés sur un ordinateur.
