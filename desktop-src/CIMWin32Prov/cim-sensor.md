...
ms.locfileid: "119919939"
---
# <a name="cim_sensor-class"></a>\_Classe de capteur CIM

La classe de **\_ capteur CIM** représente un périphérique matériel capable de mesurer les caractéristiques d’une propriété physique (par exemple, les caractéristiques de température ou de tension d’un système informatique unitaire).
...
La classe de **\_ capteur CIM** possède les types de membres suivants :
...
La classe de **\_ capteur CIM** présente ces méthodes.



| Méthode                                                            | Description                                                                                                                              |
|:------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-sensor.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-sensor.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe de **\_ capteur CIM** possède les propriétés suivantes.
...
La classe de **\_ capteur CIM** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées du **\_ capteur CIM**, consultez [classes Win32](win32-provider.md).
