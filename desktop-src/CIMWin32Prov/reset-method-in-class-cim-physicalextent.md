...
ms.locfileid: "119701509"
---
# <a name="reset-method-of-the-cim_physicalextent-class"></a>Méthode Reset de la \_ classe CIM PhysicalExtent

La méthode **Reset** de la \_ classe CIM PhysicalExtent demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
