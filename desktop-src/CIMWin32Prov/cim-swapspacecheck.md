...
ms.locfileid: "127225329"
---
# <a name="cim_swapspacecheck-class"></a>\_Classe CIM SwapSpaceCheck

La classe **CIM \_ SwapSpaceCheck** spécifie la quantité d’espace d’échange qui doit être disponible sur le système. La valeur amount est spécifiée dans la propriété **SwapSpaceSize** . Les détails de cette vérification sont comparés aux détails correspondants trouvés dans un objet [**CIM \_ OperatingSystem**](cim-operatingsystem.md) référencé par l’Association [**CIM \_ installed**](cim-installedos.md) pour l’objet [**\_ ComputerSystem CIM**](cim-computersystem.md) qui décrit l’environnement. Lorsque la valeur de la propriété **TotalSwapSpaceSize** est supérieure ou égale à la valeur spécifiée dans la propriété **SwapSpaceSize** , la condition est satisfaite.
...
La classe **CIM \_ SwapSpaceCheck** possède les types de membres suivants :
...
La classe **CIM \_ SwapSpaceCheck** possède ces méthodes.



| Méthode                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-swapspacecheck.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ SwapSpaceCheck** possède les propriétés suivantes.
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ OperatingSystem**](cim-operatingsystem.md).**TotalSwapSpaceSize**"), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilo-octets ")
</dt> </dl>

Taille minimale d’espace d’échange, en kilo-octets, qui doit être disponible sur le système cible.
