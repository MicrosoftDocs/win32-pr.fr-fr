...
---
# <a name="setpowerstate-method-of-the-cim_memory-class"></a>Méthode SetPowerState de la \_ classe de mémoire CIM
...
[\_Mémoire CIM](setpowerstate-method-in-class-cim-memory.md)
</dt> <dt>
