...
ms.locfileid: "127296902"
---
# <a name="copyex-method-of-the-cim_logicalfile-class"></a>Méthode CopyEx de la \_ classe CIM LogicalFile

La méthode **CopyEx** copie le fichier logique (ou le répertoire) spécifié dans le chemin de l’objet vers l’emplacement spécifié par le paramètre *filename* . Une copie n’est pas prise en charge si le remplacement d’un fichier logique existant est nécessaire. Cette méthode est une version étendue de la méthode de [**copie**](copy-method-in-class-cim-logicalfile.md) .
