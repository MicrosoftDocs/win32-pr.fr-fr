...
ms.locfileid: "118678643"
---
# <a name="cim_pcvideocontroller-class"></a>\_Classe CIM PCVideoController

Le **\_ PCVideoController CIM** représente les fonctionnalités et la gestion d’un contrôleur vidéo d’ordinateur personnel, un sous-type d’un contrôleur vidéo.
...
La classe **CIM \_ PCVideoController** possède les types de membres suivants :
...
La classe **CIM \_ PCVideoController** possède ces méthodes.



| Méthode                                                                       | Description                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-pcvideocontroller.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-pcvideocontroller.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ PCVideoController** possède les propriétés suivantes.
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Graphiques et fonctionnalités 3D du contrôleur vidéo.
...
Qualificateurs : [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Chaînes de forme libre qui fournissent des explications détaillées sur les fonctionnalités d’accélérateur vidéo indiquées dans le tableau **AcceleratorCapabilities** .

> [!Note]  
> Chaque entrée de tableau est liée à l’entrée dans le tableau **AcceleratorCapabilities** qui se trouve dans le même index.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,12 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" bits ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,11 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" pixels ")
</dt> </dl>
...
Nombre de couleurs prises en charge aux résolutions actuelles.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,14 ")
</dt> </dl>

En mode caractère, nombre de colonnes pour le contrôleur vidéo ; Sinon, entrez 0.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,13 ")
</dt> </dl>

En mode caractère, nombre de lignes pour ce contrôleur vidéo ; Sinon, entrez 0.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,15 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,8 ")
</dt> </dl>

Mode d’analyse en cours. Cette propriété est héritée de la [**\_ VideoController CIM**](cim-videocontroller.md).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,10 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" pixels ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,5 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,4 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>
...
Nombre actuel de plans de couleurs. Si cette valeur n’est pas applicable à la configuration vidéo actuelle, entrez 0.
...
Date et heure de la dernière réinitialisation de ce contrôleur, c’est-à-dire que le contrôleur a été mis hors tension ou réinitialisé.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,2 ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,6 ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Vidéo DMTF \| 003,3 ")
</dt> </dl>
...
Chaîne de forme libre qui décrit le processeur/contrôleur vidéo.
...
La classe **CIM \_ PCVideoController** est dérivée de [**CIM \_ VideoController**](cim-videocontroller.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées de [**CIM \_ PCVideoController**](cim-videocontroller.md), consultez [classes Win32](win32-provider.md).
