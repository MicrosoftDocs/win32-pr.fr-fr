...
ms.locfileid: "119920089"
---
# <a name="cim_scanner-class"></a>\_Classe de scanneur CIM

Le **\_ scanneur CIM** représente les fonctionnalités et la gestion de l’unité logique du scanneur.
...
La classe du **\_ scanneur CIM** possède les types de membres suivants :
...
La classe du **\_ scanneur CIM** possède les méthodes suivantes.



| Méthode                                                             | Description                                                                                                                              |
|:-------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-scanner.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-scanner.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe du **\_ scanneur CIM** possède les propriétés suivantes.
...
La classe du **\_ scanneur CIM** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
