...
ms.locfileid: "119547469"
---
# <a name="copy-method-of-the-cim_devicefile-class"></a>Méthode Copy de la \_ classe CIM DeviceFile

La méthode **Copy** copie le fichier logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet vers l’emplacement spécifié par le paramètre d’entrée. Une copie n’est pas prise en charge si elle nécessite le remplacement d’un fichier logique existant. Cette méthode est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
Nom complet de la copie du fichier de destination (ou du répertoire).
