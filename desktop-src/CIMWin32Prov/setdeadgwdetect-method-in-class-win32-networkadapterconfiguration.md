...
La méthode statique de la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetDeadGWDetect** est utilisée pour activer la détection de passerelle inactive.
...
*DeadGWDetectEnabled* \[ dans\]
</dt> <dd>

Si la **valeur est true**, la détection de passerelle inactive doit être activée.
