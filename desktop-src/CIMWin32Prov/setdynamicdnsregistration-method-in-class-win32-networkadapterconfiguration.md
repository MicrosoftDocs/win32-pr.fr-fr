...
ms.locfileid: "119759739"
---
# <a name="setdynamicdnsregistration-method-of-the-win32_networkadapterconfiguration-class"></a>Méthode SetDynamicDNSRegistration de la \_ classe Win32 NetworkAdapterConfiguration

La méthode **SetDynamicDNSRegistration** indique l’inscription DNS dynamique des adresses IP pour cette carte liée à IP.
...
*FullDNSRegistrationEnabled* \[ dans\]
</dt> <dd>

Si la **valeur est true**, les adresses IP de cette connexion sont inscrites dans DNS sous le nom DNS complet de l’ordinateur. Le nom DNS complet de l’ordinateur s’affiche sous l’onglet **identification réseau** du panneau de configuration du système.

</dd> <dt>

*DomainDNSRegistrationEnabled* \[ dans, facultatif\]
</dt> <dd>

Si la **valeur est true**, les adresses IP de cette connexion sont enregistrées sous le nom de domaine de cette connexion, en plus d’être inscrites sous le nom DNS complet de l’ordinateur. Le nom de domaine de cette connexion est défini à l’aide de la méthode [**SetDNSDomain**](setdnsdomain-method-in-class-win32-networkadapterconfiguration.md) ou attribuée par DHCP. Le nom inscrit est le nom d’hôte de l’ordinateur avec le nom de domaine ajouté. Ce paramètre a une signification uniquement lorsque *FullDNSRegistrationEnabled* est activé. La valeur par défaut est **false**.
...
L’exemple de [modification de l’inscription DNS dynamique pour une carte réseau](https://Gallery.TechNet.Microsoft.Com/6c72969c-16c8-4bb6-92e9-b9020001759f) configure l’inscription DNS dynamique pour une carte réseau.
