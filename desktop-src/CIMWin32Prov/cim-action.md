...
ms.locfileid: "119080993"
---
# <a name="cim_action-class"></a>\_Classe d’action CIM

Une classe d' **\_ action CIM** est une opération qui fait partie d’un processus de création d’un élément logiciel dans son état suivant ou d’élimination de l’élément logiciel dans l’état actuel.
...
La classe d' **\_ action CIM** possède les types de membres suivants :
...
La classe d' **\_ action CIM** possède ces méthodes.



| Méthode                                              | Description                                                   |
|:----------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-action.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe d' **\_ action CIM** possède ces propriétés.
