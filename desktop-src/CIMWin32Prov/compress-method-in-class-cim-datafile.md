...
ms.locfileid: "126920519"
---
# <a name="compress-method-of-the-cim_datafile-class"></a>Méthode Compress de la \_ classe de fichier de fichier CIM

La méthode **Compress** utilise la compression NTFS pour compresser le fichier logique (ou le répertoire) qui est spécifié dans le chemin d’accès de l’objet. Cette méthode est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
[**\_Fichier de fichier CIM**](compress-method-in-class-cim-datafile.md)
</dt> <dt>
