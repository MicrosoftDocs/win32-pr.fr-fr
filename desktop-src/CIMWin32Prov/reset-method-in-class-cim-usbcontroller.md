...
ms.locfileid: "119700749"
---
# <a name="reset-method-of-the-cim_usbcontroller-class"></a>Méthode Reset de la \_ classe CIM USBController

La méthode **Reset** de la \_ classe CIM USBController demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
