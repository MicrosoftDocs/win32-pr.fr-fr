...
ms.locfileid: "119918959"
---
# <a name="cim_temperaturesensor-class"></a>\_Classe CIM capteur

La classe **CIM \_ capteur** existe pour la compatibilité descendante avec les définitions de schéma CIM antérieures. Avec les ajouts [**au \_ capteur CIM**](cim-sensor.md) et aux classes [**\_ NumericSensor CIM**](cim-numericsensor.md) dans la version 2,2, il n’est plus nécessaire. Un capteur de température peut être défini en affectant à la propriété **SensorType** héritée du **\_ capteur CIM** la valeur 2 (« température »). Les autres propriétés de cette classe sont codées en dur en tant que valeurs constantes qui correspondent aux définitions dans la hiérarchie de capteur.
...
La classe **CIM \_ capteur** possède les types de membres suivants :
...
La classe **CIM \_ capteur** possède ces méthodes.



| Méthode                                                                       | Description                                                                                                                              |
|:-----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-temperaturesensor.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-temperaturesensor.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ capteur** possède les propriétés suivantes.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("précision"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,19 ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,5 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,13 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur de seuil qui spécifie les plages (valeurs minimales et maximales) pour déterminer si le capteur fonctionne dans des conditions normales, non critiques, critiques ou irrécupérables. Si la propriété **CurrentReading** est comprise entre **LowerThresholdCritical** et **LowerThresholdFatal**, l’état actuel est critique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,15 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur de seuil qui spécifie les plages (valeurs minimales et maximales) pour déterminer si le capteur fonctionne dans des conditions normales, non critiques, critiques ou irrécupérables. Si la propriété **CurrentReading** est en dessous de **LowerThresholdFatal**, l’état actuel est fatal.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,11 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur de seuil qui spécifie les plages (valeurs minimales et maximales) pour déterminer si le capteur fonctionne dans des conditions normales, non critiques, critiques ou irrécupérables. Si la propriété **CurrentReading** est comprise entre **LowerThresholdNonCritical** et **UpperThresholdNonCritical**, le capteur signale une valeur normale. Si la propriété **CurrentReading** est comprise entre **LowerThresholdNonCritical** et **LowerThresholdCritical**, l’état actuel n’est pas critique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,9 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,10 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,6 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur attendue ou normale pour le capteur numérique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,7 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,8 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Resolution"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,17 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" centièmes de degrés centigrade ")
</dt> </dl>

Capacité du capteur à résoudre les différences dans la propriété mesurée. Cette valeur peut varier selon que l’appareil est linéaire ou non sur sa plage dynamique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolerance"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,18 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,14 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur de seuil qui spécifie les plages (valeurs minimales et maximales) pour déterminer si le capteur fonctionne dans des conditions normales, non critiques, critiques ou irrécupérables. Si la propriété **CurrentReading** est comprise entre **UpperThresholdCritical** et **UpperthresholdFatal**, l’état actuel est critique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperthresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,16 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur de seuil qui spécifie les plages (valeurs minimales et maximales) pour déterminer si le capteur fonctionne dans des conditions normales, non critiques, critiques ou irrécupérables. Si la propriété **CurrentReading** est au-dessus de **UpperthresholdFatal**, l’état actuel est fatal.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de température DMTF \| 001,12 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
La classe **CIM \_ capteur** est dérivée de [**CIM \_ NumericSensor**](cim-numericsensor.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ capteur**, consultez [classes Win32](win32-provider.md).
