...
ms.locfileid: "127225281"
---
# <a name="uncompress-method-of-the-cim_datafile-class"></a>Méthode decompress de la \_ classe de fichier de fichier CIM

La méthode **decompress** décompresse le fichier de données logique (ou le répertoire) qui est spécifié dans le chemin d’accès de l’objet. Cette méthode est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
La méthode de **décompression** du [**fichier de \_ fichier CIM**](cim-datafile.md) est implémentée par WMI.
...
[**\_Fichier de fichier CIM**](uncompress-method-in-class-cim-datafile.md)
</dt> <dt>
