...
les Classes de la sous-catégorie masse Stockage représentent les périphériques de stockage tels que les lecteurs de disque dur, les lecteurs de CD-rom et les lecteurs de bande.
...
| [**\_CDROMDrive Win32**](win32-cdromdrive.md)             | Représente un lecteur de CD-ROM sur un système d’ordinateur exécutant Windows.                              |
...
| [**Win32 \_ de Win32**](win32-tapedrive.md)               | Représente un lecteur de bande sur un système d’ordinateur exécutant Windows.                                |
...
| [**\_DeviceMemoryAddress Win32**](win32-devicememoryaddress.md)             | représente une adresse mémoire de l’appareil sur un système de Windows.<br/>                                                                                                                                                        |
...
| [**\_Canal DMA Win32**](win32-dmachannel.md)                               | Représente un canal d’accès direct à la mémoire (DMA) sur un système d’ordinateur exécutant Windows.<br/>                                                                                                                          |
...
| [**\_IRQResource Win32**](win32-irqresource.md)                             | représente un numéro d’interruption (IRQ) sur un système Windows ordinateur.<br/>                                                                                                                                |
...
| [**\_PortResource Win32**](win32-portresource.md)                           | Représente un port d’e/s sur un système d’ordinateur exécutant Windows.<br/>                                                                                                                                                   |
| [**\_Processeur Win32**](win32-processor.md)                                 | Représente un appareil qui permet d’interpréter une séquence d’instructions d’ordinateur sur un système d’ordinateur exécutant Windows.<br/>                                                                                           |
...
| [**\_SerialPort Win32**](win32-serialport.md)                               | Représente un port série sur un système d’ordinateur exécutant Windows.<br/>                                                                                                                                                 |
...
| [**\_SystemDriverPNPEntity Win32**](win32-systemdriverpnpentity.md)         | met en relation un appareil Plug-and-Play sur le système d’Windows ordinateur et le pilote qui prend en charge l’appareil Plug-and-Play.<br/>                                                                                           |
| [**\_SystemEnclosure Win32**](win32-systemenclosure.md)                     | Représente les propriétés associées à un boîtier système physique.<br/>                                                                                                                                         |
| [**\_SystemMemoryResource Win32**](win32-systemmemoryresource.md)           | représente une ressource de mémoire système sur un système de Windows.<br/>                                                                                                                                                       |
...
| Classe                                                                           | Description                                                                                                                                                                                                            |
|---------------------------------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [**\_NetworkAdapter Win32**](win32-networkadapter.md)                           | Représente une carte réseau sur un système d’ordinateur exécutant Windows.<br/>                                                                                                                                          |
...
| [**\_Imprimante Win32**](win32-printer.md)                           | représente un appareil connecté à un système informatique exécutant Windows qui est capable de reproduire une image visuelle sur un support.<br/> |
...
| [**\_PrintJob Win32**](win32-printjob.md)                         | représente un travail d’impression généré par une application basée sur Windows.<br/>                                                              |
