...
ms.locfileid: "119547529"
---
# <a name="compressex-method-of-the-win32_codecfile-class"></a>Méthode CompressEx de la \_ classe Win32 CodecFile

La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **CompressEx** compresse le fichier de codec logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet (cette méthode est une version étendue de la méthode [**Compress**](compress-method-in-class-win32-directory.md) ).
