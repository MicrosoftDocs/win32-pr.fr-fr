...
ms.locfileid: "119020677"
---
# <a name="copy-method-of-the-cim_directory-class"></a>Méthode Copy de la \_ classe Directory CIM

La méthode **Copy** copie le fichier logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet vers l’emplacement spécifié par le paramètre d’entrée. Une copie n’est pas prise en charge si le remplacement d’un fichier logique existant est nécessaire. Cette méthode est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
[\_Répertoire CIM](copy-method-in-class-cim-directory.md)
</dt> <dt>
