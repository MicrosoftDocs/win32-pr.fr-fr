...
ms.locfileid: "127006902"
---
# <a name="reset-method-of-the-cim_display-class"></a>Méthode Reset de la \_ classe Display CIM

La méthode **Reset** de la \_ classe Display CIM demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
[\_Affichage CIM](reset-method-in-class-cim-display.md)
</dt> <dt>
