...
ms.locfileid: "126921875"
---
# <a name="win32_memoryarray-class"></a>\_Classe MemoryArray Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ MemoryArray** WMI représente les propriétés du tableau de la mémoire système de l’ordinateur et les adresses mappées.
...
La classe **Win32 \_ MemoryArray** possède les types de membres suivants :
...
La classe **Win32 \_ MemoryArray** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                                        |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md) pour obtenir de la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md) pour obtenir de la documentation.<br/> |
...
La classe **Win32 \_ MemoryArray** a ces propriétés.
...
Cette valeur provient de la structure d' **adresse mappée du tableau de mémoire** dans les informations de version SMBIOS. Pour les versions SMBIOS 2,1 à 2,6, la valeur provient du membre d' **adresse de fin** . Pour SMBIOS version 2.7 +, la valeur provient du membre de l' **adresse de fin étendue** .
...
**4** (niveau de la partition de mémoire)
...
Type d’erreur qui s’est produite le plus récemment. Les valeurs 12-14, qui indiquent si une erreur peut être corrigée, ne sont pas utilisées avec cette propriété, mais ces informations se trouvent dans la propriété **CorrectableError** .
...
Cette propriété est héritée de la [**\_ StorageExtent CIM**](cim-storageextent.md). Les valeurs sont :

<dl> <dd>Autres</dd> <dd>Connue</dd> <dd>"None"</dd> <dd>Parité</dd> <dd>« ECC sur un bit »</dd> <dd>« ECC multi-bits »</dd> <dd>Erreurs</dd> </dl>
...
Cette valeur provient de la structure d' **adresse mappée du tableau de mémoire** dans les informations de version SMBIOS. Pour les versions SMBIOS 2,1 à 2,6, la valeur provient du membre **adresse de départ** . Pour SMBIOS version 2.7 +, la valeur provient du membre de l' **adresse de départ étendue** .
...
La classe **Win32 \_ MemoryArray** est dérivée de [**Win32 \_ SMBIOSMemory**](win32-smbiosmemory.md).
