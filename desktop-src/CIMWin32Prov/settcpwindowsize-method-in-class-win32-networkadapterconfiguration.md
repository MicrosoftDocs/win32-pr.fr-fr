...
La méthode statique de la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetTcpWindowSize** permet de définir la taille maximale de la fenêtre de réception TCP offerte par le système.
...
Taille maximale de la fenêtre de réception TCP offerte par le système. La plage valide de valeurs en octets est 0-65535.
...
> [!Note]  
> Windows Vista : cette méthode accède à l' `"CurrentControlSet\\Services\\Tcpip\\Parameters|TcpWindowSize"` entrée de Registre, qui n’est pas utilisée dans l’implémentation actuelle du système d’exploitation.

 

## <a name="examples"></a>Exemples

L’exemple VBScript [de modification de la taille de fenêtre TCP pour toutes les cartes réseau](https://Gallery.TechNet.Microsoft.Com/74cf7be0-0044-4a88-85a3-9bc98490897b) définit la taille de fenêtre TCP pour toutes les cartes réseau d’un ordinateur.
