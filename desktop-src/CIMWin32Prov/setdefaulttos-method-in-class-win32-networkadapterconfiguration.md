...
Cette méthode est obsolète. Les applications doivent utiliser l’API de qualité de service (QoS) pour manipuler les bits de type de service (TOS). Pour plus d’informations, consultez [qualité de service](/previous-versions/windows/desktop/qos/qos-start-page).
...
Valeur du type de service (TOS) placée dans l’en-tête des paquets IP sortants. Pour obtenir une définition des valeurs, consultez RFC 791.
