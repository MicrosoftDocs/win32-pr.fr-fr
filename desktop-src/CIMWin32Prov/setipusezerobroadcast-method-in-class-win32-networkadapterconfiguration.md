...
La méthode statique de la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetIPUseZeroBroadcast** est utilisée pour définir l’utilisation de la diffusion à zéro IP.
...
*IPUseZeroBroadcast* \[ dans\]
</dt> <dd>

Si la **valeur est true**, la diffusion de zéro IP est utilisée. La valeur par défaut est **false**.
