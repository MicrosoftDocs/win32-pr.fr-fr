...
ms.locfileid: "119546589"
---
# <a name="win32_1394controller-class"></a>\_Classe 1394Controller Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ 1394Controller** représente les fonctionnalités et la gestion d’un contrôleur 1394. IEEE 1394 est une spécification pour un bus série à haut débit.
...
La classe **Win32 \_ 1394Controller** possède les types de membres suivants :
...
La classe **Win32 \_ 1394Controller** possède ces méthodes.
...
La classe **Win32 \_ 1394Controller** a ces propriétés.
...
Identificateur unique de ce contrôleur.
...
La classe **Win32 \_ 1394Controller** est dérivée [**du \_ contrôleur CIM**](cim-controller.md).

## <a name="examples"></a>Exemples

L’exemple de code PowerShell suivant récupère les informations du contrôleur.
