...
ms.locfileid: "126917047"
---
# <a name="reset-method-of-the-cim_networkadapter-class"></a>Méthode Reset de la \_ classe NETWORKADAPTER CIM

La méthode **Reset** de la \_ classe NetworkAdapter CIM demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
