...
ms.locfileid: "119701069"
---
# <a name="reset-method-of-the-cim_scsicontroller-class"></a>Méthode Reset de la \_ classe CIM SCSIController

La méthode **Reset** de la \_ classe CIM SCSIController demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
