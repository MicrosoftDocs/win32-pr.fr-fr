...
ms.locfileid: "119284549"
---
# <a name="cim_cachememory-class"></a>\_Classe CIM CacheMemory

La classe **CIM \_ CacheMemory** définit les fonctionnalités et la gestion de la mémoire cache.

La mémoire cache est la RAM dédiée ou allouée dans laquelle un processeur recherche d’abord des données. Les données de la mémoire cache sont rapidement remises au processeur et sont généralement décrites par la proximité du processeur (par exemple, le cache principal ou secondaire). Un lecteur de disque qui comprend la mémoire vive allouée pour le maintien de la dernière lecture ou des données adjacentes du disque (pour accélérer la récupération) est également modélisé comme mémoire cache.

> [!Note]  
> La mémoire cache n’est pas un système d’exploitation ou une mémoire tampon au niveau de l’application ; Il s’agit de la mémoire RAM qui a été allouée pour la mise en cache des données du processeur.
...
La classe **CIM \_ CacheMemory** possède les types de membres suivants :
...
La classe **CIM \_ CacheMemory** possède ces méthodes.



| Méthode                                                                 | Description                                                                                                                                |
|:-----------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-cachememory.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-cachememory.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et le moment où l’appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ CacheMemory** possède les propriétés suivantes.
...
Décrit les propriétés en lecture/écriture du média.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,15»)
</dt> </dl>

Énumération qui définit l’associativité du cache système.
...
**Set-associatif** bidirectionnel (4)
...
Taille, en octets, des blocs qui forment l’extension de stockage. Si vous spécifiez une taille de bloc variable, la taille maximale du bloc, en octets, doit être spécifiée. Si la taille de bloc est inconnue ou si un concept de bloc n’est pas valide (par exemple, pour les extensions d’agrégat, la mémoire ou les disques logiques), entrez 1 (un).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,9»)
</dt> </dl>

Spécifie la mise en cache des instructions, la mise en cache des données, ou les deux. « Other » et « Unknown » peuvent également être définis.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,12 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,8 ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Le \| groupe de mémoires DMTF mappe \| des adresses 001,4 "," MIF. \|Adresses mappées du périphérique de mémoire DMTF \| 001,5 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilo-octets ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,15 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,10 ")
</dt> </dl>

Opération d’accès à la mémoire qui a provoqué la dernière erreur. Le type d’erreur est décrit par la propriété **errorInfo** . Si la propriété **errorInfo** est égale à 3 (« OK »), cette propriété n’a aucune signification.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,19 "," MIF. \|Périphérique de mémoire DMTF \| 002,20 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,14 ")
</dt> </dl>

Adresse de la dernière erreur de mémoire. Le type d’erreur est décrit par la propriété **errorInfo** . Si la propriété **errorInfo** est égale à 3 (« OK »), cette propriété n’a aucune signification.
...
Qualificateurs : [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,17 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,12 "), [**Max**](/windows/desktop/WmiSdk/standard-qualifiers) (64)
</dt> </dl>

Données capturées au cours du dernier accès mémoire erroné. Les données occupent les *n* premiers octets du tableau qui sont nécessaires pour contenir le nombre de bits spécifié par la propriété **ErrorTransferSize** . Si **ErrorTransferSize** est égal à 0, cette propriété n’a aucune signification.
...
Ordre des données stockées dans la propriété **ErrorData** . Si **ErrorTransferSize** est égal à 0, cette propriété n’a aucune signification.
...
<span id="Least_Significant_Byte_First"></span><span id="least_significant_byte_first"></span><span id="LEAST_SIGNIFICANT_BYTE_FIRST"></span>**Octet le moins significatif en premier** (1)


</dt> <dd>

Octet le moins significatif en premier.

</dd> <dt>

<span id="Most_Significant_Byte_First"></span><span id="most_significant_byte_first"></span><span id="MOST_SIGNIFICANT_BYTE_FIRST"></span>

<span id="Most_Significant_Byte_First"></span><span id="most_significant_byte_first"></span><span id="MOST_SIGNIFICANT_BYTE_FIRST"></span>**Octet le plus significatif en premier** (2)


</dt> <dd>

Octet le plus significatif en premier.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,12 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,8 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ([**" \_ mémoire CIM**](cim-memory.md).**OtherErrorDescription**")
</dt> </dl>

Type d’erreur qui s’est produite le plus récemment. Les valeurs 12 à 14 ne sont pas définies dans le schéma CIM, car DMI mélange la sémantique du type d’erreur et indique si elle a été corrigée. La propriété **CorrectableError** indique si une erreur peut être corrigée.
...
<span id="Bad_Read"></span><span id="bad_read"></span><span id="BAD_READ"></span>**Lecture incorrecte** (4)
...
<span id="Parity_Error"></span><span id="parity_error"></span><span id="PARITY_ERROR"></span>**Erreur de parité** (5)
...
<span id="Single-Bit_Error"></span><span id="single-bit_error"></span><span id="SINGLE-BIT_ERROR"></span>**Erreur de bit unique** (6)
...
<span id="Double-Bit_Error"></span><span id="double-bit_error"></span><span id="DOUBLE-BIT_ERROR"></span>**Erreur double bit** (7)
...
<span id="Multi-Bit_Error"></span><span id="multi-bit_error"></span><span id="MULTI-BIT_ERROR"></span>**Erreur multibits** (8)
...
<span id="Nibble_Error"></span><span id="nibble_error"></span><span id="NIBBLE_ERROR"></span>**Erreur de grignotage** (9)
...
<span id="Checksum_Error"></span><span id="checksum_error"></span><span id="CHECKSUM_ERROR"></span>**Erreur de somme de contrôle** (10)
...
<span id="CRC_Error"></span><span id="crc_error"></span><span id="CRC_ERROR"></span>**Erreur CRC** (11)
...
<span id="Undefined"></span><span id="undefined"></span><span id="UNDEFINED"></span>**Non défini** (12)
...
<span id="Undefined"></span><span id="undefined"></span><span id="UNDEFINED"></span>**Non défini** (13)
...
<span id="Undefined"></span><span id="undefined"></span><span id="UNDEFINED"></span>**Non défini** (14)
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Groupe de mémoires physiques DMTF \| 001,7 ")
</dt> </dl>

Indique si la parité ou les algorithmes CRC, ECC ou d’autres mécanismes sont utilisés. Vous pouvez également fournir des détails sur l’algorithme.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,21 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,15 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" octets ")
</dt> </dl>

Spécifie la plage, en octets, à laquelle la dernière erreur peut être résolue. Par exemple, si les adresses d’erreurs sont résolues en bit 11 (c’est-à-dire, sur une base de page standard), les erreurs peuvent être résolues en limites de 4 Ko et cette propriété est définie sur 4000. Si la propriété **errorInfo** est égale à 3 (« OK »), cette propriété n’a aucune signification.
...
Date et heure auxquelles la dernière erreur de mémoire s’est produite. Le type d’erreur est décrit par la propriété **errorInfo** . Si la propriété **errorInfo** est égale à 3 (« OK »), cette propriété n’a aucune signification.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Périphérique de mémoire DMTF \| 002,16 "," MIF. \|Groupe de mémoires physiques DMTF \| 001,11 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" bits ")
</dt> </dl>

Taille du transfert de données, en bits, à l’origine de la dernière erreur. La valeur 0 indique qu’il n’y A pas d’erreur. Si la propriété **errorInfo** est égale à 3 (« OK »), cette propriété doit être définie sur 0.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,14 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" secondes ")
</dt> </dl>

Durée maximale, en secondes, pendant laquelle les lignes modifiées ou les compartiments peuvent demeurer dans le cache avant d’être vidés. La valeur 0 indique qu’un vidage du cache n’est pas contrôlé par un minuteur de vidage.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,2»)
</dt> </dl>

Spécifie s’il s’agit du cache principal, secondaire ou tertiaire. « Other », « Unknown » et « non applicable » peuvent également être définis.
...
<span id="Secondary"></span><span id="secondary"></span><span id="SECONDARY"></span>**Secondaire** (4)
...
<span id="Tertiary"></span><span id="tertiary"></span><span id="TERTIARY"></span>**Tertiaire** (5)
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,10 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" octets ")
</dt> </dl>

Taille, en octets, d’un compartiment ou d’une ligne de cache unique.
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ mémoire CIM**](cim-memory.md).**ErrorInfo**»)
</dt> </dl>

Chaîne de forme libre qui fournit des informations si la propriété **ErrorType** a la valeur 1 (« other »). Si elle n’a pas la valeur 1, cette chaîne n’a aucune signification.
...
La méthode **SetPowerState** est prise en charge. Cette méthode se trouve sur la classe parente du [**\_ LogicalDevice CIM**](cim-logicaldevice.md) et peut être implémentée. Pour plus d’informations, consultez [conception de Classes format MOF (MOF)](/windows/desktop/WmiSdk/designing-managed-object-format--mof--classes).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,13»)
</dt> </dl>

Stratégie utilisée par le cache pour gérer les demandes de lecture. Si la stratégie de lecture est déterminée individuellement, c’est-à-dire, pour chaque demande, la valeur 6 (« détermination par e/s ») doit être spécifiée. « Other » et « Unknown » sont également des valeurs valides.
...
<span id="Read"></span><span id="read"></span><span id="READ"></span>**Lecture** (3)
...
<span id="Read-Ahead"></span><span id="read-ahead"></span><span id="READ-AHEAD"></span>**Lecture anticipée** (4)
...
<span id="Read_and_Read-Ahead"></span><span id="read_and_read-ahead"></span><span id="READ_AND_READ-AHEAD"></span>**Lecture et lecture anticipée** (5)


</dt> <dd>

Lecture et lecture anticipée.

</dd> <dt>

<span id="Determination_Per_I_O"></span><span id="determination_per_i_o"></span><span id="DETERMINATION_PER_I_O"></span>

<span id="Determination_Per_I_O"></span><span id="determination_per_i_o"></span><span id="DETERMINATION_PER_I_O"></span>**Détermination par e/s** (6)


</dt> <dd>

Détermination par e/s.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,12»)
</dt> </dl>

Énumération entière décrivant l’algorithme qui détermine les lignes de cache ou les compartiments qui doivent être réutilisés.
...
<span id="Least_Recently_Used__LRU_"></span><span id="least_recently_used__lru_"></span><span id="LEAST_RECENTLY_USED__LRU_"></span>Le **moins récemment utilisé (LRU)** (3)
...
<span id="First_In_First_Out__FIFO_"></span><span id="first_in_first_out__fifo_"></span><span id="FIRST_IN_FIRST_OUT__FIFO_"></span>**Premier entré, premier sorti (FIFO)** (4)
...
<span id="Last_In_First_Out__LIFO_"></span><span id="last_in_first_out__lifo_"></span><span id="LAST_IN_FIRST_OUT__LIFO_"></span>**Dernier entré, premier sorti (LIFO)** (5)
...
<span id="Least_Frequently_Used__LFU_"></span><span id="least_frequently_used__lfu_"></span><span id="LEAST_FREQUENTLY_USED__LFU_"></span>Le **moins fréquemment utilisé (LFU)** (6)
...
<span id="Most_Frequently_Used__MFU_"></span><span id="most_frequently_used__mfu_"></span><span id="MOST_FREQUENTLY_USED__MFU_"></span>Le **plus fréquemment utilisé (MFU)** (7)


</dt> <dd>

Le plus fréquemment utilisé (MFU).
...
<span id="Data_Dependent_Multiple_Algorithms"></span><span id="data_dependent_multiple_algorithms"></span><span id="DATA_DEPENDENT_MULTIPLE_ALGORITHMS"></span>**Algorithmes multiples dépendants des données** (8)


</dt> <dd>

Algorithmes multiples dépendant des données.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Le \| groupe de mémoires DMTF mappe \| des adresses 001,3 "," MIF. \|Adresses mappées du périphérique de mémoire DMTF \| 001,4 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilo-octets ")
</dt> </dl>
...
Indique si les informations d’adresse dans la propriété **ErrorAddress** sont une adresse de niveau système (**true**) ou une adresse physique (**false**). Si la propriété **errorInfo** est égale à 3 (« OK »), cette propriété n’a aucune signification.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Cache système DMTF \| 003,5»)
</dt> </dl>

Définit si le cache est en écriture différée ou en écriture différée, ou si les informations « varient avec l’adresse » ou sont définies individuellement pour chaque entrée/sortie. « Other » et « Unknown » peuvent également être spécifiés.
...
<span id="Write_Back"></span><span id="write_back"></span><span id="WRITE_BACK"></span>**Écriture différée** (3)
...
<span id="Write_Through"></span><span id="write_through"></span><span id="WRITE_THROUGH"></span>**Écriture par écrit** (4)
...
<span id="Varies_with_Address"></span><span id="varies_with_address"></span><span id="VARIES_WITH_ADDRESS"></span>**Varie en fonction de l’adresse** (5)


</dt> <dd>

Varie en fonction de l’adresse.
...
La classe **CIM \_ CacheMemory** est dérivée de la [**\_ mémoire CIM**](cim-memory.md).

WMI n’implémente pas cette classe. Pour plus d’informations sur les classes dérivées de **CIM \_ CacheMemory**, consultez [classes Win32](win32-provider.md).
