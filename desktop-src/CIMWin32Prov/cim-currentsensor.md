...
ms.locfileid: "119924629"
---
# <a name="cim_currentsensor-class"></a>\_Classe CIM CurrentSensor

La classe **CIM \_ CurrentSensor** existe pour la compatibilité descendante avec les définitions de schéma CIM antérieures.

Les ajouts au [**\_ capteur CIM**](cim-sensor.md) et à [**CIM \_ NumericSensor**](cim-numericsensor.md) dans la version 2,2 ne sont plus nécessaires. Une classe **CIM \_ CurrentSensor** peut être définie en affectant à la propriété **SensorType** héritée de **\_ capteur CIM** la valeur 4 (« en cours »). Les autres propriétés de cette classe sont codées en dur vers des valeurs constantes, qui correspondent aux définitions dans la hiérarchie de capteur.
...
La classe **CIM \_ CurrentSensor** possède les types de membres suivants :
...
La classe **CIM \_ CurrentSensor** possède ces méthodes.



| Méthode                                                                   | Description                                                                                                                              |
|:-------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-currentsensor.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ CurrentSensor** possède les propriétés suivantes.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("précision"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,19 ")
</dt> </dl>

Précision du capteur pour la propriété mesurée. Sa valeur est enregistrée comme plus ou moins centièmes de pourcentage. Cette propriété, ainsi que les propriétés de **résolution** et de **tolérance** , sont utilisées pour calculer la valeur réelle de la propriété physique mesurée. La précision peut varier selon que l’appareil est linéaire ou non sur sa plage dynamique.

Cette propriété est héritée de la [**\_ NumericSensor CIM**](cim-numericsensor.md).
...
Économie d’énergie inconnue.

L’appareil est en mode économie d’énergie, mais son état exact est inconnu.
...
L’appareil est en mode économie d’énergie et continue de fonctionner, mais peut présenter des performances dégradées.
...
L’appareil ne fonctionne pas, mais il peut être mis à la pleine puissance rapidement.
...
Avertissement d’économie d’énergie.

L’appareil est dans un état d’avertissement et un mode d’économie d’énergie.
...
Le capteur actuel n’est pas disponible.
...
Indique si l’appareil utilise une configuration définie par l’utilisateur.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("CurrentReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,5 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur actuelle indiquée par le capteur.
...
Si la **valeur est true**, le capteur est linéaire sur sa plage dynamique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,13 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur de seuil qui spécifie si le capteur fonctionne dans des conditions critiques. Si la propriété **CurrentReading** est comprise entre **LowerThresholdCritical** et **LowerThresholdFatal**, l’état actuel est critique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,15 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur de seuil qui spécifie si le capteur fonctionne dans des conditions irrécupérables. Si la propriété **CurrentReading** est en dessous de **LowerThresholdFatal**, l’état actuel est fatal.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("LowerThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,11 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur de seuil qui spécifie si le capteur fonctionne dans des conditions normales ou non critiques. Si la propriété **CurrentReading** est comprise entre **LowerThresholdNonCritical** et **UpperThresholdNonCritical**, le capteur signale une valeur normale. Si, toutefois, la propriété **CurrentReading** est comprise entre **LowerThresholdNonCritical** et **LowerThresholdCritical**, l’état actuel n’est pas critique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MaxReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,9 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Plus grande valeur de la propriété mesurée qui peut être lue par le capteur numérique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("MinReadable"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,10 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Plus petite valeur de la propriété mesurée qui peut être lue par le capteur numérique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NominalReading"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,6 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur attendue pour le capteur numérique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMax"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,7 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Plage maximale normale pour le capteur numérique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("NormalMin"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,8 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Plage minimale normale pour le capteur numérique.
...
Win32 Plug-and-Play identificateur du périphérique logique.
...
La méthode [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) est prise en charge.
...
La méthode [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) peut être appelée avec le paramètre *PowerState* défini sur 5 (« Power cycle »).
...
La méthode [**SetPowerState**](setpowerstate-method-in-class-cim-currentsensor.md) peut être appelée avec le paramètre *PowerState* défini sur 5 (« Power cycle ») et le paramètre *Time* défini sur une date et une heure spécifiques, ou un intervalle, pour la mise sous tension.
...
Si la valeur est **false**, la valeur entière 1, pour la chaîne « non pris en charge », doit être la seule entrée dans le tableau **PowerManagementCapabilities** .
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Resolution"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,17 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" dixièmes de milliampères ")
</dt> </dl>

Capacité du capteur à résoudre les différences dans la propriété mesurée. Cette propriété, ainsi que les propriétés de **précision** et de **tolérance** , sont utilisées pour calculer la valeur réelle de la propriété physique mesurée. Cette valeur peut varier selon que l’appareil est linéaire ou non sur sa plage dynamique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Tolerance"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,18 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Tolérance du capteur pour la propriété mesurée. Cette propriété, ainsi que les propriétés de **résolution** et de **précision** , sont utilisées pour calculer la valeur réelle de la propriété physique mesurée. La tolérance peut varier selon que l’appareil est linéaire ou non sur sa plage dynamique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,14 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur de seuil qui spécifie si le capteur fonctionne dans des conditions critiques. Si la propriété **CurrentReading** est comprise entre **UpperThresholdCritical** et **UpperthresholdFatal**, l’état actuel est critique.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperthresholdFatal"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,16 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur de seuil qui spécifie si le capteur fonctionne dans des conditions irrécupérables. Si la propriété **CurrentReading** est au-dessus de **UpperthresholdFatal**, l’état actuel est fatal.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("UpperThresholdNonCritical"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Sonde de courant électrique DMTF \| 001,12 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliampères ")
</dt> </dl>

Valeur de seuil qui spécifie si le capteur fonctionne dans des conditions normales ou non critiques. Si la propriété **CurrentReading** est comprise entre **LowerThresholdNonCritical** et **UpperThresholdNonCritical**, le capteur signale une valeur normale. Si, toutefois, la propriété **CurrentReading** est comprise entre **UpperThresholdNonCritical** et **UpperThresholdCritical**, l’état actuel n’est pas critique.
...
La classe **CIM \_ CurrentSensor** est dérivée de [**CIM \_ NumericSensor**](cim-numericsensor.md).

WMI n’implémente pas cette classe. Pour plus d’informations sur les classes WMI dérivées de **CIM \_ CurrentSensor**, consultez [classes Win32](win32-provider.md).
