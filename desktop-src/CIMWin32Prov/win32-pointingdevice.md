...
ms.locfileid: "118417055"
---
# <a name="win32_pointingdevice-class"></a>\_Classe PointingDevice Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PointingDevice** WMI représente un périphérique d’entrée utilisé pour pointer vers et sélectionner des régions sur l’affichage d’un système informatique exécutant Windows. tout appareil utilisé pour manipuler un pointeur, ou pointer sur l’affichage sur un système d’ordinateur exécutant Windows est membre de cette classe.
...
La classe **Win32 \_ PointingDevice** possède les types de membres suivants :
...
La classe **Win32 \_ PointingDevice** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ PointingDevice**](cim-pointingdevice.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ PointingDevice**](cim-pointingdevice.md).<br/> |
...
La classe **Win32 \_ PointingDevice** a ces propriétés.
...
Identificateur unique du périphérique de pointage avec d’autres périphériques sur le système.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 21 \| interface")
</dt> </dl>

Type d’interface utilisé pour le dispositif de pointage.
...
qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32API \| System Information functions \| SystemParametersInfo"), [**units**](../wmisdk/standard-qualifiers.md) ("mickeys")
</dt> </dl>

Une des deux valeurs d’accélération. La sensibilité du dispositif de pointage double (bascule de la première à la deuxième valeur) lorsque le dispositif de pointage déplace une distance supérieure à cette valeur de seuil.
...
Configuration du dispositif de pointage pour une opération à gauche ou à droite.

Cette propriété est héritée de la [**\_ PointingDevice CIM**](cim-pointingdevice.md).
...
<span id="Not_Applicable"></span><span id="not_applicable"></span><span id="NOT_APPLICABLE"></span>**Non applicable** (1)
...
<span id="Right_Handed_Operation"></span><span id="right_handed_operation"></span><span id="RIGHT_HANDED_OPERATION"></span>**Bon fonctionnement** de la main (2)


</dt> <dd>

Opération de Right-Handed

</dd> <dt>

<span id="Left_Handed_Operation"></span><span id="left_handed_operation"></span><span id="LEFT_HANDED_OPERATION"></span>

<span id="Left_Handed_Operation"></span><span id="left_handed_operation"></span><span id="LEFT_HANDED_OPERATION"></span>**Opération gauche** de la main (3)


</dt> <dd>

Opération de Left-Handed
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ machine \\ \\ System \\ \\ ControlSet001 \\ \\ \\ \\ , classe de contrôle \| DriverDesc")
</dt> </dl>

Type de matériel utilisé pour le dispositif de pointage Windows.

Exemple : « souris PS2 MICROSOFT »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ machine \\ \\ System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| InfPath")
</dt> </dl>

nom du fichier. inf du dispositif de pointage Windows.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HKEY \_ local \_ machine \\ \\ System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| InfSection")
</dt> </dl>

Section du fichier. inf qui contient les informations de configuration du dispositif de pointage Windows.
...
Si la **valeur est true**, l’appareil est verrouillé, ce qui empêche l’entrée ou la sortie de l’utilisateur.

Cette propriété est héritée de la [**\_ UserDevice CIM**](cim-userdevice.md).
...
Nombre de boutons sur le dispositif de pointage.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Périphérique de pointage DMTF \| 001,1 ")
</dt> </dl>
...
<span id="Mouse"></span><span id="mouse"></span><span id="MOUSE"></span>**Souris** (3)
...
<span id="Track_Ball"></span><span id="track_ball"></span><span id="TRACK_BALL"></span>**Suivre la balle** (4)
...
<span id="Track_Point"></span><span id="track_point"></span><span id="TRACK_POINT"></span>**Point de suivi** (5)
...
<span id="Glide_Point"></span><span id="glide_point"></span><span id="GLIDE_POINT"></span>**Point coulissant** (6)
...
<span id="Touch_Pad"></span><span id="touch_pad"></span><span id="TOUCH_PAD"></span>**Pavé tactile** (7)
...
<span id="Touch_Screen"></span><span id="touch_screen"></span><span id="TOUCH_SCREEN"></span>**Écran tactile** (8)
...
<span id="Mouse_-_Optical_Sensor"></span><span id="mouse_-_optical_sensor"></span><span id="MOUSE_-_OPTICAL_SENSOR"></span>**Capteur de souris optique** (9)
...
Une des deux valeurs de seuil d’accélération. Le système double la vitesse du mouvement du pointeur lorsque l’appareil de pointeur déplace une distance supérieure à cette valeur. Étant donné que cette augmentation de la vitesse se produit après que la valeur **DoubleSpeedThreshold** a été remplie, le pointeur se déplace effectivement à quatre fois sa vitesse d’origine.
...
Qualificateurs : [**unités**](../wmisdk/standard-qualifiers.md) (« nombres par pouce »)
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| samplerate"), [**Units**](../wmisdk/standard-qualifiers.md) ("Hertz")
</dt> </dl>

Vitesse à laquelle le dispositif de pointage est interrogé pour obtenir des informations d’entrée.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| MouseSynchIn100ns"), [**unités**](../wmisdk/standard-qualifiers.md) ("100 nanosecondes")
</dt> </dl>

Durée après laquelle l’interruption suivante est supposée indiquer le début d’un nouveau paquet d’appareil (les paquets partiels sont ignorés). En cas de perte d’une interruption, cela permet au pilote de périphérique de pointage de synchroniser sa représentation interne de l’état du paquet avec l’état du matériel.
...
La classe **Win32 \_ PointingDevice** est dérivée de [**CIM \_ PointingDevice**](cim-pointingdevice.md).
