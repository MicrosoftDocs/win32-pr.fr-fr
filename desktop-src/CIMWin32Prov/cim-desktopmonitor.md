...
La classe **CIM \_ desktopmonitor** représente les fonctionnalités et la gestion de l’unité logique du moniteur Desktop (CRT).
...
La classe **CIM \_ desktopmonitor** possède ces méthodes.
...
Bande passante du moniteur en MHz. S’il est inconnu, utilisez 0 (zéro).
...
WMI n’implémente pas cette classe. Pour plus d’informations sur les classes dérivées de **CIM \_ desktopmonitor**, consultez [classes Win32](win32-provider.md).
