...
ms.locfileid: "127006922"
---
# <a name="reset-method-of-the-cim_cachememory-class"></a>Méthode Reset de la \_ classe CIM CacheMemory

La méthode **Reset** de la \_ classe CIM CacheMemory demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
