...
ms.locfileid: "119920419"
---
# <a name="cim_removedirectoryaction-class"></a>\_Classe CIM RemoveDirectoryAction

La classe **CIM \_ RemoveDirectoryAction** supprime les répertoires pour les éléments logiciels.
...
La classe **CIM \_ RemoveDirectoryAction** possède les types de membres suivants :
...
La classe **CIM \_ RemoveDirectoryAction** possède ces méthodes.



| Méthode                                                             | Description                                                   |
|:-------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-removedirectoryaction.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ RemoveDirectoryAction** possède les propriétés suivantes.
...
Nom du répertoire auquel s’applique l’action.

Cette propriété est héritée de la [**\_ DirectoryAction CIM**](cim-directoryaction.md).
...
Si la **valeur est true**, le répertoire doit être vide pour être supprimé.
...
La classe **CIM \_ RemoveDirectoryAction** est dérivée de [**CIM \_ DirectoryAction**](cim-directoryaction.md).
