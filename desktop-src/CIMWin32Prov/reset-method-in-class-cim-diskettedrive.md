...
ms.locfileid: "119878689"
---
# <a name="reset-method-of-the-cim_diskettedrive-class"></a>Méthode Reset de la \_ classe CIM DisketteDrive

La méthode **Reset** de la \_ classe CIM DisketteDrive demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
