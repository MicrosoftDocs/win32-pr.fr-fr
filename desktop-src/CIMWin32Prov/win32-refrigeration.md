...
ms.locfileid: "118958898"
---
# <a name="win32_refrigeration-class"></a>\_Classe de réfrigération Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) de **\_ réfrigération Win32** représente les propriétés d’un appareil de réfrigération.
...
La classe de **\_ réfrigération Win32** possède les types de membres suivants :
...
La classe de **\_ réfrigération Win32** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans la [**\_ réfrigération CIM**](cim-refrigeration.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans la [**\_ réfrigération CIM**](cim-refrigeration.md).<br/> |
...
La classe de **\_ réfrigération Win32** a ces propriétés.
...
Si la **valeur est true**, l’appareil de refroidissement fournit un refroidissement actif, et non un refroidissement passif.
...
Identificateur unique de l’appareil de réfrigération.
...
La classe de **\_ réfrigération Win32** est dérivée de la [**\_ réfrigération CIM**](cim-refrigeration.md).
