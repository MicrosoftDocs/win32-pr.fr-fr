...
ms.locfileid: "126920548"
---
# <a name="cim_alarmdevice-class"></a>\_Classe CIM AlarmDevice

La **classe \_ AlarmDevice CIM** est un appareil d’alarme qui émet des indications audibles ou visibles relatives à une situation problématique.
...
La classe **CIM \_ AlarmDevice** possède les types de membres suivants :
...
La classe **CIM \_ AlarmDevice** possède ces méthodes.



| Méthode                                                                 | Description                                                                                                                             |
|:-----------------------------------------------------------------------|:----------------------------------------------------------------------------------------------------------------------------------------|
| [**Réinitialiser**](reset-method-in-class-cim-alarmdevice.md)                 | Demande une réinitialisation d’appareil logique. Non implémenté par WMI.<br/>                                                                     |
| [**SetPowerState**](setpowerstate-method-in-class-cim-alarmdevice.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et le moment où l’appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
| [**SetUrgency**](seturgency-method-in-class-cim-alarmdevice.md)       | Définit le niveau d’urgence souhaité pour l’alarme. Non implémenté par WMI.<br/>                                                        |
...
La classe **CIM \_ AlarmDevice** possède les propriétés suivantes.
...
Si la **valeur est true**, l’alarme est audible.
...
Valeur énumérée qui indique la fréquence relative à laquelle l’alarme clignote, vibre ou émet des tonalités audibles.
...
<span id="Informational"></span><span id="informational"></span><span id="INFORMATIONAL"></span>**Informations** (3)
...
<span id="Non-Critical"></span><span id="non-critical"></span><span id="NON-CRITICAL"></span>**Non critique** (4)
...
<span id="Unrecoverable"></span><span id="unrecoverable"></span><span id="UNRECOVERABLE"></span>**Irrécupérable** (6)
...
Si la **valeur est true**, l’alarme est visible.

</dd> </dl>

## <a name="remarks"></a>Notes

La classe **CIM \_ AlarmDevice** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
