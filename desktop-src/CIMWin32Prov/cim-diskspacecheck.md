...
La classe **CIM \_ DiskSpaceCheck** possède les types de membres suivants :
...
La classe **CIM \_ DiskSpaceCheck** possède ces méthodes.



| Méthode                                                      | Description                                                   |
|:------------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-diskspacecheck.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ DiskSpaceCheck** possède les propriétés suivantes.
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**\_ système de fichiers CIM**](cim-filesystem.md).**AvailableSpace** "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" kilo-octets ")
</dt> </dl>
