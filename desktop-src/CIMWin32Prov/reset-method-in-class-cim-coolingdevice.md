...
ms.locfileid: "127006917"
---
# <a name="reset-method-of-the-cim_coolingdevice-class"></a>Méthode Reset de la \_ classe CIM CoolingDevice

La méthode **Reset** de la \_ classe CIM CoolingDevice demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
