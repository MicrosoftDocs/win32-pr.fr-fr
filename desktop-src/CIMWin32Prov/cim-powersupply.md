...
ms.locfileid: "118421886"
---
# <a name="cim_powersupply-class"></a>\_Classe d’alimentation CIM

La **classe \_ d’alimentation CIM** représente les fonctionnalités et la gestion de l’unité logique d’alimentation.
...
La classe d' **\_ alimentation CIM** possède les types de membres suivants :
...
La classe d' **\_ alimentation CIM** possède ces méthodes.



| Méthode                                                                 | Description                                                                                                                              |
|:-----------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-powersupply.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-powersupply.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe d' **\_ alimentation CIM** possède ces propriétés.
...
Plage de tensions en cours d’utilisation. Si l’approvisionnement ne dessine pas de puissance, la valeur 6 (« aucune ») peut être spécifiée. Ces informations sont nécessaires dans le cas d’un onduleur (UPS), une sous-classe de la **source \_ d’alimentation CIM**.
...
Si la **valeur est true**, l’alimentation est une alimentation de commutation (et linéaire).
...
Fréquence (en Hertz) à l’extrémité supérieure de la plage de fréquences d’entrée de l’alimentation 1. La valeur 0 signifie DC.
...
Fréquence (en Hertz) à l’extrémité inférieure de la plage de fréquences d’entrée de l’alimentation 1. La valeur 0 signifie DC.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,8 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolts ")
</dt> </dl>

Tension élevée de la plage de tension en entrée 1 pour la source d’alimentation, en millivolts. La valeur 0 indique « Unknown ».
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,7 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolts ")
</dt> </dl>

Tension basse de la plage de tension en entrée 1 pour la source d’alimentation, en millivolts. La valeur 0 indique « Unknown ».
...
Fréquence (en Hertz) à l’extrémité supérieure de la plage de fréquences d’entrée de l’alimentation 2. La valeur 0 signifie DC.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,12 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolts ")
</dt> </dl>

Tension élevée de la plage de tension en entrée 2 pour l’alimentation, en millivolts. La valeur 0 indique « Unknown ».
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,11 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolts ")
</dt> </dl>

Tension basse de la plage de tension en entrée 2 pour cette alimentation, en millivolts. La valeur 0 indique « Unknown ».
...
Puissance de sortie totale de l’alimentation, en milliwatts. La valeur 0 indique « Unknown ».
...
Type de basculement de plage de tension en entrée implémenté dans le bloc d’alimentation.
...
La classe d' **\_ alimentation CIM** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI n’implémente pas cette classe. Pour la classe WMI dérivée de la **\_ alimentation CIM**, consultez [classes Win32](win32-provider.md).
