...
ms.locfileid: "119438729"
---
# <a name="cim_infraredcontroller-class"></a>\_Classe CIM InfraredController

La classe **CIM \_ InfraredController** représente les fonctionnalités et la gestion d’un contrôleur infrarouge.
...
La classe **CIM \_ InfraredController** possède les types de membres suivants :
...
La classe **CIM \_ InfraredController** possède ces méthodes.



| Méthode                                                                        | Description                                                                                                                              |
|:------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-infraredcontroller.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-infraredcontroller.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ InfraredController** possède les propriétés suivantes.
...
Date et heure de la dernière réinitialisation du contrôleur, ce qui peut signifier que le contrôleur a été mis hors tension ou réinitialisé.
...
La classe **CIM \_ InfraredController** est dérivée [**du \_ contrôleur CIM**](cim-controller.md).

WMI n’implémente pas cette classe. Pour les classes dérivées de **CIM \_ InfraredController**, consultez [classes Win32](win32-provider.md).
