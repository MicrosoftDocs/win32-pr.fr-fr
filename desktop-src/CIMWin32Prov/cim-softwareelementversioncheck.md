...
ms.locfileid: "122882852"
---
# <a name="cim_softwareelementversioncheck-class"></a>\_Classe CIM SoftwareElementVersionCheck

La classe **CIM \_ SoftwareElementVersionCheck** représente un type d’élément logiciel qui doit exister dans l’environnement. Cette vérification peut être pour une plage de versions spécifique, minimale, maximale ou. Pour spécifier une version spécifique, les versions inférieure et supérieure doivent être identiques. Pour spécifier une version minimale, spécifiez uniquement la version inférieure. Pour spécifier une version maximale, spécifiez uniquement la version supérieure. Pour spécifier une plage, les versions supérieure et inférieure doivent être spécifiées. Les détails des vérifications sont comparés aux détails correspondants trouvés dans un objet [**CIM \_ SoftwareElement**](cim-softwareelement.md) référencé par une association [**CIM \_ InstalledSoftwareElement**](cim-installedsoftwareelement.md) pour l’objet [**\_ ComputerSystem CIM**](cim-computersystem.md) . Au moins un **\_ SoftwareElement CIM** doit satisfaire les détails de la condition pour que la vérification soit satisfaite.
...
La classe **CIM \_ SoftwareElementVersionCheck** possède les types de membres suivants :
...
La classe **CIM \_ SoftwareElementVersionCheck** possède ces méthodes.



| Méthode                                                                   | Description                                                   |
|:-------------------------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-softwareelementversioncheck.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ SoftwareElementVersionCheck** possède les propriétés suivantes.
...
Si la **valeur est true**, la condition est supposée exister dans l’environnement (par exemple, si un fichier se trouve sur un système, la méthode [**Invoke**](invoke-method-in-class-cim-softwareelementversioncheck.md) doit retourner la **valeur true**). Si la **valeur est false**, la condition ne doit pas exister (par exemple, si un fichier n’est pas sur un système, la méthode **Invoke** doit retourner **false**).
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ SoftwareElement**](cim-softwareelement.md).**Version**")
</dt> </dl>

Version minimale des éléments logiciels en cours de vérification.
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (256), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ SoftwareElement**](cim-softwareelement.md).**Name**»)
</dt> </dl>

Nom de l’élément logiciel en cours de vérification.
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ SoftwareElement**](cim-softwareelement.md).**SoftwareElementState**")
</dt> </dl>

État de l’élément logiciel en cours de vérification.
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ SoftwareElement**](cim-softwareelement.md).**TargetOperatingSystem**")
</dt> </dl>

Système d’exploitation cible de l’élément logiciel en cours de vérification.
...
Version maximale d’un élément logiciel en cours de vérification.
...
Cette propriété est héritée de la classe de [**\_ vérification CIM**](cim-check.md) .
