...
| Méthode                                                              | Description                                                                     |
|:--------------------------------------------------------------------|:--------------------------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-directoryspecification.md) | Évalue une vérification particulière. Cette méthode n’est pas implémentée par WMI.<br/> |
...
Qualificateurs : [**Mappingstrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Emplacement DMTF \| 001,2»)
</dt> </dl>
