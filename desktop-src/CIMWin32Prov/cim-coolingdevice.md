...
ms.locfileid: "119924889"
---
# <a name="cim_coolingdevice-class"></a>\_Classe CIM CoolingDevice

La classe **CIM \_ CoolingDevice** représente les fonctionnalités et la gestion des appareils de refroidissement.
...
La classe **CIM \_ CoolingDevice** possède les types de membres suivants :
...
La classe **CIM \_ CoolingDevice** possède ces méthodes.
...
| [**SetPowerState**](setpowerstate-method-in-class-cim-coolingdevice.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ CoolingDevice** possède les propriétés suivantes.
...
La classe **CIM \_ CoolingDevice** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées de **CIM \_ CoolingDevice**, consultez [classes Win32](win32-provider.md).
