...
---
# <a name="cim_diskettedrive-class-cimwin32-wmi-providers"></a>CIM_DisketteDrive, classe (fournisseurs WMI CIMWin32)

La classe **CIM \_ DisketteDrive** représente les fonctionnalités et la gestion d’un lecteur de disquette.
...
La classe **CIM \_ DisketteDrive** possède les types de membres suivants :
...
La classe **CIM \_ DisketteDrive** possède ces méthodes.
...
La classe **CIM \_ DisketteDrive** possède les propriétés suivantes.
...
Tableau de chaînes de forme libre qui fournissent des explications détaillées pour l’accès aux fonctionnalités d’appareil indiquées dans le tableau des **fonctionnalités** .
...
La classe **CIM \_ DisketteDrive** est dérivée de [**CIM \_ MediaAccessDevice**](cim-mediaaccessdevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées de **CIM \_ DisketteDrive**, consultez [classes Win32](win32-provider.md).
