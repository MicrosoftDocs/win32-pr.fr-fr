...
Représente une propriété d’appareil PnP de type **booléen**.
...
La classe **Win32 \_ PnPDevicePropertyBoolean** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PnPDevicePropertyBoolean** a ces propriétés.
