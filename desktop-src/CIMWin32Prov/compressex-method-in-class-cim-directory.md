...
ms.locfileid: "126917084"
---
# <a name="compressex-method-of-the-cim_directory-class"></a>Méthode CompressEx de la \_ classe de répertoire CIM

La méthode **CompressEx** compresse le fichier logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet. Cette méthode est une version étendue de la méthode [**Compress**](compress-method-in-class-cim-directory.md) et est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
...
Si la **valeur est true**, la méthode est également appliquée de manière récursive aux fichiers et aux répertoires dans le répertoire spécifié par l’instance de [**\_ répertoire CIM**](cim-directory.md) . Pour les instances de fichier, ce paramètre est ignoré.
...
[\_Répertoire CIM](compressex-method-in-class-cim-directory.md)
</dt> <dt>
