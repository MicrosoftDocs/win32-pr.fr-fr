...
ms.locfileid: "127225284"
---
# <a name="uncompress-method-of-the-cim_devicefile-class"></a>Méthode decompress de la \_ classe CIM DeviceFile

La méthode **decompress Décompresse** le fichier d’unité logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet. Cette méthode est héritée de la [**\_ LogicalFile CIM**](cim-logicalfile.md).
