...
ms.locfileid: "119438449"
---
# <a name="cim_keyboard-class"></a>\_Classe de clavier CIM

La classe de **\_ clavier CIM** représente les fonctionnalités et la gestion du périphérique logique du clavier.
...
La classe de **\_ clavier CIM** possède les types de membres suivants :
...
La classe de **\_ clavier CIM** présente ces méthodes.



| Méthode                                                              | Description                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-keyboard.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-keyboard.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe de **\_ clavier CIM** possède ces propriétés.
...
Chaîne de forme libre qui fournit des informations sur l’erreur enregistrée dans la propriété **LastErrorCode** et les actions correctives à entreprendre.
...
Chaîne de forme libre qui indique le format et la mise en page du clavier.
...
Entier qui indique si un mot de passe de niveau matériel est activé sur le clavier pour empêcher une entrée locale.
...
La classe de **\_ clavier CIM** est dérivée de la [**\_ UserDevice CIM**](cim-userdevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées du **\_ clavier CIM**, consultez [classes Win32](win32-provider.md).
