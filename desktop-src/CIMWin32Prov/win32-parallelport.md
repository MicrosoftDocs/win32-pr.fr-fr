...
ms.locfileid: "119972249"
---
# <a name="win32_parallelport-class"></a>\_Classe ParallelPort Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ ParallelPort** WMI représente les propriétés d’un port parallèle sur un système d’ordinateur exécutant Windows.
...
La classe **Win32 \_ ParallelPort** possède les types de membres suivants :
...
La classe **Win32 \_ ParallelPort** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                              |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ ParallelController**](cim-parallelcontroller.md).<br/> |
...
La classe **Win32 \_ ParallelPort** a ces propriétés.
...
Qualificateurs : [**arrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Ports parallèles DMTF \| 003,8 "), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Tableau des fonctionnalités du contrôleur parallèle.

Cette propriété est héritée de la [**\_ ParallelController CIM**](cim-parallelcontroller.md).
...
Qualificateurs : [**arrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ ParallelController**](cim-parallelcontroller.md).**Capacités**»)
</dt> </dl>

Tableau d’explications plus détaillées sur les fonctionnalités du contrôleur parallèle indiquées dans le tableau des **fonctionnalités** . Chaque entrée de ce tableau est liée à l’entrée dans le tableau de **fonctionnalités** qui se trouve dans le même index.
...
Identificateur du port parallèle.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Ports parallèles DMTF \| 003,7 ")
</dt> </dl>

Si la **valeur est true**, le port parallèle prend en charge DMA.
...
Si la **valeur est true**, l’erreur signalée dans **LastErrorCode** est effacée.
...
Plus d’informations sur l’erreur enregistrée dans **LastErrorCode**, ainsi que des informations sur les actions correctives qui peuvent être prises.
...
Si la **valeur est true**, le port parallèle a été détecté automatiquement par le système d’exploitation. Si la **valeur est false**, cela signifie que le port a été détecté par d’autres moyens (par exemple, s’il est ajouté manuellement par le biais du panneau de configuration).
...
Cette propriété est héritée [**du \_ contrôleur CIM**](cim-controller.md). Les valeurs sont répertoriées dans la liste suivante.
...
La classe **Win32 \_ ParallelPort** est dérivée de [**CIM \_ ParallelController**](cim-parallelcontroller.md).
