...
Le code de contrôle demandé ne peut pas être envoyé au service, car l’état du service (propriété **State** de la classe [**\_ BaseService Win32**](win32-baseservice.md) ) est égal à 0, 1 ou 2.
