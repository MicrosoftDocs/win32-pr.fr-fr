...
ms.locfileid: "127006874"
---
# <a name="stopservice-method-of-the-cim_bootservice-class"></a>Méthode StopService de la \_ classe CIM BootService

La méthode **StopService** arrête le service représenté par l’objet dérivé de [**CIM \_ BootService**](cim-bootservice.md). Cette méthode est héritée [**du \_ service CIM**](cim-service.md).
