---
description: la \_ classe WMI de MotherboardDevice Win32 représente un appareil qui contient les composants centraux du système d’Windows ordinateur.
...
ms.locfileid: "127123961"
---
# <a name="win32_motherboarddevice-class"></a>\_Classe MotherboardDevice Win32

la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ MotherboardDevice Win32** représente un appareil qui contient les composants centraux du système d’Windows ordinateur.
...
La classe **Win32 \_ MotherboardDevice** possède les types de membres suivants :
...
La classe **Win32 \_ MotherboardDevice** possède ces méthodes.
...
La classe **Win32 \_ MotherboardDevice** a ces propriétés.
...
Identificateur unique de cette carte mère.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ machine \\ \\ Hardware \\ \\ description \\ \\ System \\ \\ MultifunctionAdapter \| identifier")
</dt> </dl>

Type de bus principal de la carte mère.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ machine \\ \\ Hardware \\ \\ description \\ \\ System")
</dt> </dl>

Numéro de révision de la carte mère.
...
Type de bus secondaire de la carte mère.
...
La classe **Win32 \_ MotherboardDevice** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

## <a name="examples"></a>Exemples

Les exemples de code [JavaScript](https://Gallery.TechNet.Microsoft.Com/05bbadf8-1356-43a6-82fc-fcab40233fe5) et [PowerShell](https://Gallery.TechNet.Microsoft.Com/cb520044-836e-425c-8c12-a9586d1c0e6e) suivants récupèrent les informations de carte mère.

L’exemple de code VBScript suivant récupère des informations sur la carte mère.
