...
ms.locfileid: "119817559"
---
# <a name="cim_uninterruptiblepowersupply-class"></a>\_Classe CIM UninterruptiblePowerSupply

La classe **CIM \_ UninterruptiblePowerSupply** représente les fonctionnalités et la gestion d’un onduleur. Les propriétés de l’appareil UPS indiquent quand une alimentation entrante est réduite ou amplifiée, ainsi que les informations agrégées des piles, des générateurs, etc., qui composent l’appareil. Les composants individuels (par exemple, plusieurs batteries) peuvent également être modélisés indépendamment et associés à l’onduleur.
...
La classe **CIM \_ UninterruptiblePowerSupply** possède les types de membres suivants :
...
La classe **CIM \_ UninterruptiblePowerSupply** possède ces méthodes.



| Méthode                                                                                | Description                                                                                                                              |
|:--------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-uninterruptiblepowersupply.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-uninterruptiblepowersupply.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ UninterruptiblePowerSupply** possède les propriétés suivantes.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,15 ")
</dt> </dl>

La plage des tensions d’entrée est en cours d’utilisation. Si l’approvisionnement ne dessine pas de puissance, la valeur 6 (« aucune ») peut être spécifiée. Ces informations sont nécessaires dans le cas d’un UPS, une sous-classe de l' [**\_ alimentation CIM**](cim-powersupply.md).

Cette propriété est héritée de la [**\_ alimentation CIM**](cim-powersupply.md).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie de l’onduleur DMTF \| 001,4 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" pourcentage ")
</dt> </dl>

Pourcentage estimé du coût total restant pour un onduleur qui utilise la technologie de batterie.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie de l’onduleur DMTF \| 001,3 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" minutes ")
</dt> </dl>

Durée estimée, en minutes, jusqu’à épuisement de la batterie, du générateur ou d’une autre source d’alimentation dans les conditions de charge en cours si l’alimentation de l’utilitaire est désactivée, ou si elle est perdue et reste désactivée.
...
Si la **valeur est true**, l’alimentation est une alimentation de commutation (plutôt que linéaire).
...
Qualificateurs : [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (« Hertz »)
</dt> </dl>

Fréquence, en Hertz, à l’extrémité supérieure de la plage de fréquences d’entrée de l’alimentation 1. La valeur 0 (zéro) signifie DC.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,17 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>

Fréquence, en Hertz, à l’extrémité inférieure de la plage de fréquences d’entrée de l’alimentation 1. La valeur 0 (zéro) signifie DC.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageHigh"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

Si la tension, en millivolts, s’élève au-dessus de la valeur spécifiée par la propriété **Range1InputVoltageHigh** , l’onduleur compensera en découpant la tension. La valeur 0 (zéro) indique que la tension au niveau de laquelle la suppression se produit est inconnue.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range1InputVoltageLow"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

Si la tension, en millivolts, chute sous la valeur spécifiée par la propriété **Range1InputVoltageLow** , l’onduleur compensera en amplifiant la tension à l’aide de ses sources d’alimentation. La valeur 0 indique que la tension à laquelle l’augmentation se produit est inconnue.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,20 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>

Fréquence, en Hertz, à l’extrémité supérieure de la plage de fréquences d’entrée de l’alimentation 2. La valeur 0 (zéro) signifie DC.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,19 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" Hertz ")
</dt> </dl>

Fréquence, en Hertz, à l’extrémité inférieure de la plage de fréquences d’entrée de l’alimentation. 2. La valeur 0 signifie DC.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageHigh"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

Si la tension, en millivolts, s’élève au-dessus de la valeur spécifiée par la propriété **Range2InputVoltageHigh** , l’onduleur compensera en découpant la tension. La valeur 0 (zéro) indique que la tension au niveau de laquelle la suppression se produit est inconnue.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Range2InputVoltageLow"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("millivolts")
</dt> </dl>

Si la tension, en millivolts, chute sous la valeur spécifiée par la propriété **Range2InputVoltageLow** , l’onduleur compensera en amplifiant la tension à l’aide de ses sources d’alimentation. La valeur 0 (zéro) indique que la tension à laquelle l’augmentation se produit est inconnue.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. Batterie de l' \| onduleur DMTF \| 001,1»)
</dt> </dl>

Indication de la capacité restante sur les piles, le générateur ou autre source de l’onduleur.
...
Les minutes estimées restantes de l’exécution sont supérieures à l’état de faible consommation défini par l’onduleur (en général, deux minutes).

</dd> <dt>

<span id="Low"></span><span id="low"></span><span id="LOW"></span>

<span id="Low"></span><span id="low"></span><span id="LOW"></span>**Faible** (3)


</dt> <dd>

Les minutes estimées restantes du runtime sont inférieures ou égales à l’état de faible consommation défini par l’onduleur.

</dd> <dt>

<span id="Depleted"></span><span id="depleted"></span><span id="DEPLETED"></span>

<span id="Depleted"></span><span id="depleted"></span><span id="DEPLETED"></span>**Épuisé** (4)


</dt> <dd>

L’onduleur ne pourra pas supporter la charge actuelle lorsque la puissance de l’utilitaire est perdue (y compris la possibilité que la puissance de l’utilitaire soit actuellement absente).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie de l’onduleur DMTF \| 001,2 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" secondes ")
</dt> </dl>

Temps écoulé, en secondes, depuis la dernière commutation de l’onduleur sur la puissance de la batterie, le générateur ou autre source d’alimentation. Ou bien, le temps écoulé depuis le dernier redémarrage de l’onduleur, selon la valeur la moins élevée. Si l’onduleur est en ligne, la valeur 0 (zéro) est retournée.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,21 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliwatts ")
</dt> </dl>

Puissance de sortie totale de l’alimentation, en milliwatts. La valeur 0 (zéro) indique Unknown.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Alimentation DMTF \| 002,16 ")
</dt> </dl>

Type de basculement de plage d’entrée-tension implémenté dans le bloc d’alimentation.
...
La classe **CIM \_ UninterruptiblePowerSupply** est dérivée de la [**\_ alimentation CIM**](cim-powersupply.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ UninterruptiblePowerSupply**, consultez [classes Win32](win32-provider.md).
