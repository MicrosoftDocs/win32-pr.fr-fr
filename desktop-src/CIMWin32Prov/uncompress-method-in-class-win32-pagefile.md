...
---
# <a name="uncompress-method-of-the-win32_pagefile-class"></a>Méthode decompress de la \_ classe pagefile Win32

La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **décompression** décompresse le fichier d’échange logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet.
