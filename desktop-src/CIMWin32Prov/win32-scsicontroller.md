...
ms.locfileid: "127124229"
---
# <a name="win32_scsicontroller-class"></a>\_Classe SCSIController Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ SCSIController** WMI représente un contrôleur SCSI sur un système informatique exécutant Windows.
...
La classe **Win32 \_ SCSIController** possède les types de membres suivants :
...
La classe **Win32 \_ SCSIController** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                      |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ SCSIController**](cim-scsicontroller.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ SCSIController**](cim-scsicontroller.md).<br/> |
...
La classe **Win32 \_ SCSIController** a ces propriétés.
...
Nombre d’expirations de délai qui se sont produites après la valeur **TimeOfLastReset** .

Cette propriété est héritée de la [**\_ SCSIController CIM**](cim-scsicontroller.md).
...
Qualificateurs : [**clé**](../wmisdk/key-qualifier.md), [**remplacement**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ SCSI")
</dt> </dl>

Identificateur unique du contrôleur SCSI avec d’autres périphériques sur le système.
...
Qualificateurs : [**déconseillé**](../wmisdk/standard-wmi-qualifiers.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« Win32Registry \| matériel \\ \\ DeviceMap \\ \\ SCSI \| ScsiPort »)
</dt> </dl>

Ordre dans lequel les appareils sont répertoriés avec ce contrôleur SCSI.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ services \\ \\ Class \| PortDriver")
</dt> </dl>

Nom du fichier de pilote du contrôleur SCSI.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ enum \\ \\ root \| HWRevision")
</dt> </dl>

Numéro de version matérielle du contrôleur SCSI.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« Win32Registry \| Hardware \\ \\ DeviceMap \\ \\ SCSI \| ScsiPort »)
</dt> </dl>

Numéro d’index du contrôleur SCSI dans le registre système.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ enum \\ \\ root \| MFG")
</dt> </dl>

Nom du fabricant du contrôleur SCSI.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|contrôleur de Stockage DMTF \| 001,3»)
</dt> </dl>

Prise en charge du contrôleur SCSI pour la redondance ou la protection contre les défaillances de l’appareil.
...
**Protégé par le biais de SCC (commande du contrôleur SCSI-3)** (5)
...
**Protégé par le biais de SCC-2 (commande du contrôleur SCSI-3)** (6)
...
La classe **Win32 \_ SCSIController** est dérivée de [**CIM \_ SCSIController**](cim-scsicontroller.md).
