...
ms.locfileid: "126999473"
---
# <a name="win32_potsmodem-class"></a>\_Classe POTSModem Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ POTSModem** WMI représente les services et les caractéristiques d’un modem pots (Plain Old Telephone Service) sur un système informatique exécutant Windows.
...
La classe **Win32 \_ POTSModem** possède les types de membres suivants :
...
La classe **Win32 \_ POTSModem** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                            |
|:------------------|:---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ PotsModem**](cim-potsmodem.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ PotsModem**](cim-potsmodem.md).<br/> |
...
La classe **Win32 \_ POTSModem** a ces propriétés.
...
Paramètre de rappel ou de réponse automatique actuel pour le modem.

Cette propriété est héritée de la [**\_ PotsModem CIM**](cim-potsmodem.md).
...
**Réponse automatique avec appel arrière** (5)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| AttachedTo")
</dt> </dl>

Port auquel le modem POTS est attaché.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| BlindOff")
</dt> </dl>

Chaîne de commande utilisée pour détecter une tonalité avant la numérotation.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| BlindOn")
</dt> </dl>

Chaîne de commande utilisée pour indiquer si une tonalité est ou non.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| CompatibilityFlags")
</dt> </dl>

Tous les protocoles de connexion par modem avec lesquels ce périphérique modem est compatible.
...
Caractéristiques de compression des données du modem.
...
<span id="No_Compression"></span><span id="no_compression"></span><span id="NO_COMPRESSION"></span>**Aucune compression** (2)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("compression de la \| \\ \\ classe de contrôle CurrentControlSet System Win32Registry \\ \\ \\ \\ \| \_ ")
</dt> </dl>

Chaîne de commande utilisée pour désactiver la compression de données matérielles.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| compression \_ ")
</dt> </dl>

Chaîne de commande utilisée pour activer la compression de données matérielles.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| ConfigDialog")
</dt> </dl>

Chaîne d’initialisation du modem. Cette propriété est constituée de chaînes de commande d’autres propriétés de cette classe.
...
Tableau de pays/régions dans lesquels le modem peut fonctionner.
...
Pays/région pour lequel le modem est actuellement programmé. Lorsque plusieurs pays/régions sont pris en charge, cette propriété définit celle qui est actuellement sélectionnée pour être utilisée.
...
Cette propriété est héritée de [**CIM \_ LogicalDevice**](cim-logicalfile.md).
...
Liste des mots de passe actuellement définis pour le modem. Ce tableau peut être laissé vide pour des raisons de sécurité.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« \| structures de communication win32api \| [**DCB**](/windows/win32/api/winbase/ns-winbase-dcb)»)
</dt> </dl>

Contrôler les paramètres d’un appareil de communication série, dans ce cas, le périphérique du modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| default")
</dt> </dl>

Si la **valeur est true**, ce modem pots est le modem par défaut sur le système informatique exécutant Windows.
...
Identificateur unique de ce modem POTS provenant d’autres appareils sur le système.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| DevLoader")
</dt> </dl>

Nom du chargeur de l’appareil pour le modem. Un chargeur d’appareil charge et gère les pilotes de périphérique et les énumérateurs pour un appareil donné.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| DeviceType")
</dt> </dl>

Type physique du modem.

Les valeurs sont :

<dl> <dd>« Null modem »</dd> <dd>« Modem interne »</dd> <dd>« Modem externe »</dd> <dd>« Modem PCMCIA »</dd> <dd>Connue</dd> </dl>
...
Type de méthode de numérotation utilisé.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| DriverDate")
</dt> </dl>

Date du pilote de modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ classe \| ErrorControl \_ Forced")
</dt> </dl>

Chaîne de commande utilisée pour activer le contrôle de correction d’erreur lors de l’établissement d’une connexion. Cela augmente la fiabilité de la connexion.

Exemple : « + Q5S36 = 4S48 = 7 »
...
Caractéristiques de correction des erreurs du modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| ErrorControl \_ off")
</dt> </dl>

Chaîne de commande utilisée pour désactiver le contrôle d’erreur.

Exemple : « + Q6S36 = 3S48 = 128 »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| ErrorControl \_ on")
</dt> </dl>

Chaîne de commande utilisée pour activer le contrôle d’erreur.

Exemple : « + Q5S36 = 7S48 = 7 »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| FlowControl \_ Hard")
</dt> </dl>

Chaîne de commande utilisée pour activer le contrôle de workflow matériel. le contrôle de Flow est constitué de signaux envoyés entre des ordinateurs qui vérifient que les deux ordinateurs sont prêts à transmettre ou à recevoir des données.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| FlowControl \_ ")
</dt> </dl>

Chaîne de commande utilisée pour désactiver le contrôle de Flow. le contrôle de Flow est constitué de signaux envoyés entre des ordinateurs qui vérifient que les deux ordinateurs sont prêts à transmettre ou à recevoir des données.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| FlowControl \_ Soft")
</dt> </dl>

Chaîne de commande utilisée pour activer le contrôle de Workflow. le contrôle de Flow est constitué de signaux envoyés entre des ordinateurs qui vérifient que les deux ordinateurs sont prêts à transmettre ou à recevoir des données.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| InactivityScale")
</dt> </dl>

Multiplicateur utilisé avec la propriété **InactivityTimeout** pour calculer le délai d’expiration d’une connexion.
...
Limite de temps (en secondes) pour la déconnexion automatique de la ligne téléphonique, si aucune donnée n’est échangée. La valeur 0 (zéro) indique que cette fonctionnalité est présente mais pas activée.
...
Numéro d’index de ce modem POTS.
...
ID d’instance d’appareil pour ce modem POTS.

Exemple : « 1&08 »

**Windows Server 2012 r2, Windows 8.1, Windows Server 2012, Windows 8, Windows server 2008 r2, Windows 7, Windows server 2008 et Windows Vista :** cette propriété est disponible à partir de Windows Server 2016 et Windows 10.
...
Vitesse maximale de communication définissable pour l’accès au système téléphonique.
...
Vitesse maximale de communication définissable au port COM pour un modem externe. Entrez 0 (zéro) si ce n’est pas le cas.
...
Nombre de mots de passe définissables dans le modem lui-même. Si cette fonctionnalité n’est pas prise en charge, entrez 0 (zéro).
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| Model")
</dt> </dl>

Modèle de ce modem POTS.

Exemple : « Sportster 56K External »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| InfPath")
</dt> </dl>

Chemin du fichier. inf de ce modem. Ce fichier contient des informations d’initialisation pour le modem et son pilote.

exemple : « C : \\ Windows \\ INF »
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| InfSection")
</dt> </dl>

Nom de la section dans le fichier. inf du modem qui contient des informations sur le modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| \_ Bell")
</dt> </dl>

Chaîne de commande utilisée pour indiquer au modem d’utiliser des modulations de cloche pour 300 et 1200 bps.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| modulation \_ CCITT")
</dt> </dl>

Chaîne de commande utilisée pour indiquer au modem d’utiliser des modulations CCITT pour 300 et 1200 bps.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| PortSubClass"), **value** ("port parallèle", "port série", "modem")
</dt> </dl>

Définition du port utilisé pour ce modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| prefix")
</dt> </dl>

Préfixe de numérotation utilisé pour accéder à une ligne extérieure.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("propriétés de la \| \\ \\ classe de contrôle CurrentControlSet System Win32Registry \\ \\ \\ \\ \| ")
</dt> </dl>

Liste de toutes les propriétés (et leurs valeurs) pour ce modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| providerName")
</dt> </dl>

Chemin d’accès réseau à l’ordinateur qui fournit les services de modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| Pulse")
</dt> </dl>

Chaîne de commande utilisée pour indiquer au modem d’utiliser le mode impulsion pour la numérotation. La numérotation par impulsion est nécessaire pour les lignes téléphoniques qui ne peuvent pas gérer la numérotation par tonalité.
...
Qualificateurs : [**override**](../wmisdk/standard-qualifiers.md) (Reset), [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| Reset »)
</dt> </dl>

Chaîne de commande utilisée pour réinitialiser le modem pour l’appel suivant.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| ResponsesKeyName")
</dt> </dl>

Réponse : ce modem peut signaler au système d’exploitation pendant le processus de connexion. Les deux premiers caractères spécifient le type de réponse. Les deux deuxièmes caractères spécifient des informations sur la connexion établie. les deux deuxièmes caractères sont utilisés uniquement pour la progression de la négociation ou les codes de réponse Connecter. Les huit caractères suivants spécifient la vitesse de ligne modem à modem négociée en bits par seconde (BPS). Les caractères représentent un format d’entier long non signé 32 bits (octet et mot inversé). Les huit derniers caractères indiquent que le modem passe à une vitesse de port ou d’équipement de terminal de données (DTE) différente. En règle générale, ce champ n’est pas utilisé, car les modems effectuent des connexions à une vitesse de port verrouillé, quelle que soit la vitesse du modem à modem ou de l’équipement de communication de données (DCE).
...
Nombre d’anneaux avant que le modem ne réponde à un appel entrant.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerModeDial")
</dt> </dl>

Chaîne de commande utilisée pour activer le haut-parleur du modem après avoir composé un nombre et éteindre l’orateur lorsqu’une connexion a été établie.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerModeOff")
</dt> </dl>

Chaîne de commande utilisée pour désactiver le haut-parleur du modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerModeOn")
</dt> </dl>

Chaîne de commande utilisée pour activer le haut-parleur du modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerModeSetup")
</dt> </dl>

Chaîne de commande utilisée pour indiquer au modem d’allumer le haut-parleur (jusqu’à ce qu’une connexion soit établie).
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerVolume \_ High")
</dt> </dl>

Chaîne de commande utilisée pour définir le haut-parleur du modem sur le volume le plus élevé.
...
Décrit le niveau de volume des tonalités audibles du modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerVolume \_ Low")
</dt> </dl>

Chaîne de commande utilisée pour définir le haut-parleur du modem sur le volume le plus bas.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| SpeakerVolume \_ med")
</dt> </dl>

Chaîne de commande utilisée pour définir le haut-parleur du modem sur un volume moyen.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32 \_ API \| line Device structures \| LINEDEVCAPS \| dwStringFormat")
</dt> </dl>

Type de caractères utilisé pour le texte transmis par le modem.

Les valeurs sont :

<dl> <dd>"Format de chaîne ASCII"</dd> <dd>« Format de chaîne DBCS »</dd> <dd>« Format de chaîne UNICODE »</dd> </dl>

<dt>

<span id="ASCII_string_format"></span><span id="ascii_string_format"></span><span id="ASCII_STRING_FORMAT"></span>

**Format de chaîne ASCII** (« format de chaîne ASCII »)
...
**Format de chaîne DBCS** (« format de chaîne DBCS »)
...
**Format de chaîne Unicode** (« format de chaîne Unicode »)
...
Si la **valeur est true**, le modem prend en charge le rappel.
...
Si la **valeur est true**, synchrone, et asynchrone, la communication est prise en charge.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| Terminator")
</dt> </dl>

Chaîne qui marque la fin d’une chaîne de commande.
...
Date et heure de la dernière réinitialisation du modem.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| Tone")
</dt> </dl>

Chaîne de commande qui indique au modem d’utiliser le mode de tonalité pour la numérotation. La ligne téléphonique doit prendre en charge la numérotation par tonalité.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \| VoiceSwitchFeature")
</dt> </dl>

Chaînes de commande utilisées pour activer les fonctionnalités vocales d’un modem vocal.
...
La classe **Win32 \_ POTSModem** est dérivée de [**CIM \_ POTSModem**](cim-potsmodem.md).
