...
ms.locfileid: "127006980"
---
# <a name="pauseservice-method-of-the-win32_baseservice-class"></a>Méthode PauseService de la \_ classe Win32 BaseService

La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **PauseService** tente de placer le service référencé dans l’état suspendu.
