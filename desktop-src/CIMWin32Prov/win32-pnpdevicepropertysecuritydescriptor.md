...
---
# <a name="win32_pnpdevicepropertysecuritydescriptor-class"></a>\_Classe PnPDevicePropertySecurityDescriptor Win32

Représente une propriété d’appareil PnP de type [**Win32 \_ SecurityDescriptor**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor).
...
La classe **Win32 \_ PnPDevicePropertySecurityDescriptor** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PnPDevicePropertySecurityDescriptor** a ces propriétés.
...
Type de données : **[ **\_ SecurityDescriptor Win32**](/previous-versions/windows/desktop/secrcw32prov/win32-securitydescriptor)**
</dt> <dt>
...
Cette propriété est héritée de [**Win32 \_ PnPDeviceProperty**](win32-pnpdeviceproperty.md).
...
Valeur de la paire clé Name-Value qui identifie la propriété de **données** .
...
Nom de la paire de clés Name-Value qui identifie la propriété de **données** .
...
Type de la propriété de **données** .
...
**Inconnu-Vérifiez dans devpropdef. h** (4120)
