...
ms.locfileid: "119701009"
---
# <a name="reset-method-of-the-cim_storageextent-class"></a>Méthode Reset de la \_ classe CIM StorageExtent

La méthode **Reset** de la \_ classe CIM StorageExtent demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
