...
La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **EnableIPSec** active la sécurité du protocole Internet (IPSec) sur une carte réseau compatible TCP/IP.
...
*IPSecPermitTCPPorts* \[ dans\]
</dt> <dd>

Liste des ports auxquels accorder l’autorisation d’accès pour TCP. Une valeur numérique 0 (zéro) indique que l’autorisation d’accès est accordée pour tous les ports. Un tableau vide indique qu’aucun port ne doit recevoir l’autorisation d’accès.

</dd> <dt>

*IPSecPermitUDPPorts* \[ dans\]
</dt> <dd>

Liste des ports auxquels accorder l’autorisation d’accès pour UDP. Une valeur numérique 0 (zéro) indique que l’autorisation d’accès est accordée pour tous les ports. Un tableau vide indique qu’aucun port ne doit recevoir l’autorisation d’accès.

</dd> <dt>

*IPSecPermitIPProtocols* \[ dans\]
</dt> <dd>

Liste des protocoles autorisés à s’exécuter sur l’adresse IP. Une valeur numérique 0 (zéro) indique que l’autorisation d’accès est accordée pour tous les protocoles. Un tableau vide indique qu’aucun protocole ne dispose de l’autorisation d’accès.
