...
ms.locfileid: "119924909"
---
# <a name="cim_controller-class-cimwin32-wmi-providers"></a>CIM_Controller, classe (fournisseurs WMI CIMWin32)
...
La classe de **\_ contrôleur CIM** est une abstraction pour les appareils avec une pile de protocole unique, qui existe principalement pour la communication et le contrôle ou la réinitialisation des appareils en aval ([**CIM \_ ControlledBy**](cim-controlledby.md)).
...
La classe de **\_ contrôleur CIM** est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées du **\_ contrôleur CIM**, consultez [classes Win32](win32-provider.md).
