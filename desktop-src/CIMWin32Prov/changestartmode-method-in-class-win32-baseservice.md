...
La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **ChangeStartMode** modifie le mode de démarrage d’un objet de service dérivé de [**Win32 \_ BaseService**](win32-baseservice.md).
