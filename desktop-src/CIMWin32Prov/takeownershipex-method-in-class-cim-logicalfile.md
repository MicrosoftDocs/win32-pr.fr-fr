...
ms.locfileid: "126999478"
---
# <a name="takeownershipex-method-of-the-cim_logicalfile-class"></a>Méthode TakeOwnerShipEx de la \_ classe CIM LogicalFile

La méthode **TakeOwnerShipEx** obtient la propriété du fichier logique spécifié dans le chemin d’accès de l’objet. Cette méthode est une version étendue de la méthode [**TakeOwnership**](takeownership-method-in-class-cim-logicalfile.md) . Si le fichier logique est un répertoire, cette méthode agit de manière récursive, en prenant possession de tous les fichiers et sous-répertoires contenus dans le répertoire.
