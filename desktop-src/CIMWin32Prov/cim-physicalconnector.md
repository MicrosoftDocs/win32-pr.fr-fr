...
La classe **CIM \_ PhysicalConnector** représente tout élément physique utilisé pour se connecter à d’autres éléments. Tout objet qui peut se connecter et transmettre des signaux ou de la puissance entre deux ou plusieurs éléments physiques est un descendant (ou membre) de cette classe. Par exemple, les emplacements et les connecteurs D-Shell sont des types de connecteurs physiques.
...
La classe **CIM \_ PhysicalConnector** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ PhysicalConnector** possède les propriétés suivantes.
...
Type de connecteur physique. Un tableau est spécifié pour autoriser la description des combinaisons d’informations de connecteur. Par exemple, une entrée de tableau peut spécifier RS-232, une autre DB-25 et une troisième entrée peut définir le connecteur comme « mâle ».
...
**Connecteur de disquette sur carte** (91)
...
**2 broches en double en ligne** (92)
...
**SBus IEEE 1396-1993 32 bits** (99)
...
**SBus IEEE 1396-1993 64 bits** (100)
...
WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ PhysicalConnector**, consultez [classes Win32](win32-provider.md).
