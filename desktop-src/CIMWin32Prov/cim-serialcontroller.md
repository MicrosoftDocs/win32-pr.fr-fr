...
ms.locfileid: "119919909"
---
# <a name="cim_serialcontroller-class-cimwin32-wmi-providers"></a>CIM_SerialController, classe (fournisseurs WMI CIMWin32)

La classe **CIM \_ SerialController** représente les fonctionnalités et la gestion de l’unité logique de port série.
...
La classe **CIM \_ SerialController** possède les types de membres suivants :
...
La classe **CIM \_ SerialController** possède ces méthodes.



| Méthode                                                                      | Description                                                                                                                              |
|:----------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-serialcontroller.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-serialcontroller.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ SerialController** possède les propriétés suivantes.
...
Qualificateurs : [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Ports série DMTF \| 004,7 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ SerialController**.**CapabilityDescriptions**")
</dt> </dl>

Compatibilité au niveau du processeur pour le contrôleur série. Cette propriété décrit la mise en mémoire tampon et d’autres fonctionnalités du contrôleur série, qui peuvent être inhérentes au matériel de puce. Cette propriété est un entier énuméré.
...
Qualificateurs : [**arrayType**](/windows/desktop/WmiSdk/standard-qualifiers) ("Indexed"), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ SerialController**.**Capacités**»)
</dt> </dl>

Chaînes de forme libre qui fournissent des explications détaillées sur les fonctionnalités du contrôleur série indiquées dans le tableau des **fonctionnalités** .
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Ports série DMTF \| 004,6 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" bits par seconde ")
</dt> </dl>
...
La classe **CIM \_ SerialController** est dérivée [**du \_ contrôleur CIM**](cim-controller.md).

WMI n’implémente pas cette classe. Pour les classes WMI dérivées de **CIM \_ SerialController**, consultez [classes Win32](win32-provider.md).
