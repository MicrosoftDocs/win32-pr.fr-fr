...
---
# <a name="compressex-method-of-the-cim_logicalfile-class"></a>Méthode CompressEx de la \_ classe CIM LogicalFile

La méthode **CompressEx** compresse le fichier logique (ou le répertoire) spécifié dans le chemin d’accès de l’objet. Cette méthode est une version étendue de la méthode [**Compress**](compress-method-in-class-cim-logicalfile.md) .
