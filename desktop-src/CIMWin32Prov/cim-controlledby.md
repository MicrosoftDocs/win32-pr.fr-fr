...
La **relation \_ ControlledBy CIM** indique quels appareils sont demandés par l’unité logique du contrôleur, ou accessibles via celui-ci.
...
[**\_ Contrôleur CIM**](cim-controller.md) qui représente le contrôleur.
...
[**\_ LogicalDevice CIM**](cim-logicaldevice.md) qui représente l’appareil contrôlé.
...
WMI n’implémente pas cette classe. Pour plus d’informations sur les classes dérivées de **CIM \_ ControlledBy**, consultez [classes Win32](win32-provider.md).
