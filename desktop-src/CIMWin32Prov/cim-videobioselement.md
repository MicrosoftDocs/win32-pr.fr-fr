...
La classe **CIM \_ VideoBIOSElement** représente le logiciel de bas niveau qui est chargé dans un stockage non volatile et utilisé pour configurer et accéder au contrôleur vidéo et à l’affichage d’un système informatique.
...
La classe **CIM \_ VideoBIOSElement** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ VideoBIOSElement** possède les propriétés suivantes.
...
Identificateur du fabricant de l’élément logiciel, par exemple une référence (SKU) ou un numéro de référence.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| Video BIOS \| 001,5 ")
</dt> </dl>

Si la **valeur est true**, le BIOS vidéo est occulté.
...
Édition de langue de l’élément logiciel. Les codes de langue définis dans ISO 639 doivent être utilisés. Lorsque l’élément logiciel représente une version multilingue ou internationale d’un produit, la chaîne « multilingue » doit être utilisée.
...
Fabricant de l’élément logiciel cette propriété est héritée de la [**\_ SoftwareElement CIM**](cim-softwareelement.md).
...
Identificateur de l’élément logiciel conçu pour être utilisé conjointement avec d’autres clés pour créer une représentation unique de la classe [**CIM \_ SoftwareElement**](cim-softwareelement.md) .
...
Environnement du système d’exploitation. La valeur de cette propriété ne garantit pas l’exécution binaire. La version du système d’exploitation doit être spécifiée à l’aide de la vérification de la version du système d’exploitation. L’architecture sur laquelle le système d’exploitation s’exécute est également obligatoire. La combinaison de ces constructions permet au fournisseur d’identifier clairement le niveau de système d’exploitation requis pour un élément logiciel particulier.
...
La classe **CIM \_ VideoBIOSElement** est dérivée de [**CIM \_ SoftwareElement**](cim-softwareelement.md).
