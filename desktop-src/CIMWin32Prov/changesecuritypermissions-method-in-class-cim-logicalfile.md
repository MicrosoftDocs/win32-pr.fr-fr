...
---
# <a name="changesecuritypermissions-method-of-the-cim_logicalfile-class"></a>Méthode ChangeSecurityPermissions de la \_ classe CIM LogicalFile
...
> [!Note]  
> Une liste de contrôle d’accès (ACL) **null** dans le [**\_ descripteur de sécurité**](/windows/desktop/api/winnt/ns-winnt-security_descriptor) accorde un accès illimité.
