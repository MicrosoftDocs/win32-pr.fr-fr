...
ms.locfileid: "119642899"
---
# <a name="win32_classiccomclass-class"></a>\_Classe ClassicCOMClass Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **Win32 \_ ClassicCOMClass** représente les propriétés d’un composant com.
...
La classe **Win32 \_ ClassicCOMClass** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ ClassicCOMClass** a ces propriétés.
...
Identificateur global unique (GUID) de cette classe COM.
...
Qualificateurs : [**fixed**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("Name"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("Win32Registry \| HKEY \_ local \_ machine \\ \\ Software \\ \\ classes \\ \\ CLSID \\ \\ {GUID} \[ default \] ")
</dt> </dl>

La propriété Name contient le nom explicite de la classe COM.
...
La classe **Win32 \_ ClassicCOMClass** est dérivée de [**Win32 \_ ComClass**](win32-comclass.md).
...
[**Win32, \_ classe**](win32-comclass.md)
</dt> <dt>
