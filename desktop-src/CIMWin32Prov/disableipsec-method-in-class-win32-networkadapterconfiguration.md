...
La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **DisableIPSec** est utilisée pour désactiver la sécurité du protocole Internet (IPSec) sur cette carte réseau compatible TCP/IP.
...
L’exemple VBScript suivant désactive la sécurité IP sur un ordinateur. Notez que l’appel réel à DisableIPSec est commenté, à des fins de sécurité.
