...
ms.locfileid: "119751959"
---
# <a name="stopservice-method-of-the-cim_service-class-sdoiash"></a>Méthode StopService de la classe CIM_Service (Sdoias. h)

La méthode **StopService** arrête le service représenté par l’objet dérivé du [**\_ service CIM**](cim-service.md).
...
[\_Service CIM](stopservice-method-in-class-cim-service.md)
</dt> <dt>
