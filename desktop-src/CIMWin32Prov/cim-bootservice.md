...
La classe **CIM \_ BootService** représente la fonctionnalité fournie par un périphérique ou un logiciel, ou par un réseau, pour charger un système d’exploitation sur un système informatique unitaire.
...
La classe **CIM \_ BootService** possède les types de membres suivants :
...
La classe **CIM \_ BootService** possède ces méthodes.



| Méthode                                                               | Description                                                               |
|:---------------------------------------------------------------------|:--------------------------------------------------------------------------|
| [**StartService**](startservice-method-in-class-cim-bootservice.md) | Met le service dans l’état Démarré. Non implémenté par WMI.<br/> |
| [**StopService**](stopservice-method-in-class-cim-bootservice.md)   | Met le service dans l’état arrêté. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ BootService** possède les propriétés suivantes.
...
La classe **CIM \_ BootService** est dérivée [**du \_ service CIM**](cim-service.md).
