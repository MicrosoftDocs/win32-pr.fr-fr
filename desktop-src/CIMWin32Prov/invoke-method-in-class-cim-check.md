...
ms.locfileid: "127006992"
---
# <a name="invoke-method-of-the-cim_check-class"></a>Méthode Invoke de la \_ classe de vérification CIM

La méthode **Invoke** de la classe de [**\_ vérification CIM**](cim-check.md) évalue une vérification particulière.

Pour plus d’informations sur la façon dont la méthode évalue un contrôle particulier dans un contexte CIM, consultez les sous-classes de [**\_ vérification CIM**](cim-check.md) non abstraites.
...
[**\_Vérification CIM**](invoke-method-in-class-cim-check.md)
</dt> <dt>
