...
ms.locfileid: "126917067"
---
# <a name="reset-method-of-the-cim_logicaldisk-class"></a>Méthode Reset de la \_ classe LOGICALDISK CIM

La méthode **Reset** de la \_ classe LogicalDisk CIM demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
[\_Disque logique CIM](reset-method-in-class-cim-logicaldisk.md)
</dt> <dt>
