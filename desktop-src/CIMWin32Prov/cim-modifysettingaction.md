...
La classe **CIM \_ ModifySettingAction** représente les informations pour la modification d’un fichier de paramètre spécifique, pour une entrée spécifique, avec une valeur spécifique.
...
La classe **CIM \_ ModifySettingAction** possède les types de membres suivants :
...
La classe **CIM \_ ModifySettingAction** possède ces méthodes.



| Méthode                                                           | Description                                                 |
|:-----------------------------------------------------------------|:------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-modifysettingaction.md) | Effectue une action spécifique. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ ModifySettingAction** possède les propriétés suivantes.
...
Type d’action à effectuer sur l’entrée de paramètre spécifiée. Les ajouts sont supposés respecter la casse ; Toutefois, les suppressions sont supposées ne pas respecter la casse.

<dt>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>

<span id="Create"></span><span id="create"></span><span id="CREATE"></span>**Créer** (0)


</dt> <dd>

Crée l’entrée spécifiée.

</dd> <dt>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>

<span id="Delete"></span><span id="delete"></span><span id="DELETE"></span>**Supprimer** (1)
...
Ajoute à la fin de l’entrée spécifiée.

</dd> <dt>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>

<span id="Remove"></span><span id="remove"></span><span id="REMOVE"></span>**Supprimer** (3)


</dt> <dd>

Supprime la valeur de l’entrée spécifiée.
...
Valeur à ajouter, à ajouter ou à remplacer le paramètre spécifié.
...
Nom de fichier de l’entrée de fichier de paramètres à modifier.
...
Clé de section de l’entrée de paramètre à modifier.
