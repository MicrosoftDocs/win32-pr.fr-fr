...
ms.locfileid: "119920359"
---
# <a name="cim_removefileaction-class"></a>\_Classe CIM RemoveFileAction

La **classe \_ RemoveFileAction CIM** désinstalle des fichiers.
...
La classe **CIM \_ RemoveFileAction** possède les types de membres suivants :
...
La classe **CIM \_ RemoveFileAction** possède ces méthodes.



| Méthode                                                        | Description                                                   |
|:--------------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-removefileaction.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ RemoveFileAction** possède les propriétés suivantes.
...
La classe **CIM \_ RemoveFileAction** est dérivée de [**CIM \_ FileAction**](cim-fileaction.md).
