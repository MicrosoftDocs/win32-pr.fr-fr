...
ms.locfileid: "119760399"
---
# <a name="interrogateservice-method-of-the-win32_baseservice-class"></a>Méthode InterrogateService de la \_ classe Win32 BaseService

La méthode de [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **InterrogateService** demande que le service met à jour son état avec Service Manager.
