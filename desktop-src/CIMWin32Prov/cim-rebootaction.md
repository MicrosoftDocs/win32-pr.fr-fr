...
ms.locfileid: "122883307"
---
# <a name="cim_rebootaction-class"></a>\_Classe CIM rebootaction

La classe **CIM \_ rebootaction** provoque un redémarrage du système à l’emplacement où l’élément logiciel est installé.
...
La classe **CIM \_ rebootaction** possède les types de membres suivants :
...
La classe **CIM \_ rebootaction** possède ces méthodes.



| Méthode                                                    | Description                                                   |
|:----------------------------------------------------------|:--------------------------------------------------------------|
| [**Appeler**](invoke-method-in-class-cim-rebootaction.md) | Effectue une action particulière. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ rebootaction** possède les propriétés suivantes.
