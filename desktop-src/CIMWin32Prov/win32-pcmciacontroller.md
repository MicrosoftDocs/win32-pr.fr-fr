...
ms.locfileid: "117834159"
---
# <a name="win32_pcmciacontroller-class"></a>\_Classe PCMCIAController Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PCMCIAController** WMI gère les fonctionnalités d’un appareil de contrôleur de carte réseau d’ordinateur personnel (PCMCIA).
...
La classe **Win32 \_ PCMCIAController** possède les types de membres suivants :
...
La classe **Win32 \_ PCMCIAController** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).<br/> |
...
La classe **Win32 \_ PCMCIAController** a ces propriétés.
...
Le contrôleur PCMCIA n’est pas disponible.
...
Qualificateurs : [**override**](../wmisdk/standard-qualifiers.md) ("DeviceID"), [**Key**](../wmisdk/key-qualifier.md), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("WMI")
</dt> </dl>

Identificateur unique de cet appareil avec les autres périphériques utilisant le BIOS Plug-and-Play. Cette propriété est dérivée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
...
Nom du fabricant du contrôleur PCMCIA.

Cette propriété est héritée de la [**\_ PCMCIAController CIM**](cim-pcmciacontroller.md).
...
Cette propriété est héritée [**du \_ contrôleur CIM**](cim-controller.md). Les valeurs sont indiquées dans la liste suivante.
...
La classe **Win32 \_ PCMCIAController** est dérivée de [**CIM \_ PCMCIAController**](cim-pcmciacontroller.md).
