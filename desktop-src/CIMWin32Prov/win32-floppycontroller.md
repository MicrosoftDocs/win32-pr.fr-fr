...
ms.locfileid: "119878659"
---
# <a name="win32_floppycontroller-class"></a>\_Classe FloppyController Win32

\[**Win32 \_ FloppyController** ne peut plus être utilisé à partir de Windows 10 et Windows Server 2016.\]

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ FloppyController Win32** représente les capacités et la capacité de gestion d’un contrôleur de lecteur de disquette.
...
La classe **Win32 \_ FloppyController** possède les types de membres suivants :
...
La classe **Win32 \_ FloppyController** possède ces méthodes.
...
La classe **Win32 \_ FloppyController** a ces propriétés.
...
Identificateur unique du contrôleur de disquette.
...
Nom du fabricant du contrôleur de disquette.
...
Nombre maximal d’entités directement adressables que ce contrôleur prend en charge. La valeur 0 (zéro) doit être utilisée si le nombre est inconnu.
...
Windows Identificateur d’appareil Plug-and-Play pour l’unité logique.
...
La classe **Win32 \_ FloppyController** est dérivée [**du \_ contrôleur CIM**](cim-controller.md) qui dérive de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
