...
ms.locfileid: "119751289"
---
# <a name="win32_heatpipe-class"></a>\_Classe Heatpipe Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **\_ Heatpipe** WMI représente les propriétés d’un appareil de refroidissement de caloduc.
...
La classe **Win32 \_ Heatpipe** possède les types de membres suivants :
...
La classe **Win32 \_ Heatpipe** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ Heatpipe**](cim-heatpipe.md) pour obtenir de la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ Heatpipe**](cim-heatpipe.md) pour obtenir de la documentation.<br/> |
...
La classe **Win32 \_ Heatpipe** a ces propriétés.
...
Si la **valeur est true**, le périphérique de refroidissement fournit un refroidissement actif non passif.
...
Identificateur unique du canal de chaleur.
...
Si la **valeur est true**, l’appareil peut être géré par l’alimentation mis en mode veille, et ainsi de suite. La propriété n’indique pas que les fonctionnalités de gestion de l’alimentation sont actuellement activées, uniquement si l’appareil logique est capable de gérer l’alimentation.
...
La classe **Win32 \_ Heatpipe** est dérivée de [**CIM \_ Heatpipe**](cim-heatpipe.md).
