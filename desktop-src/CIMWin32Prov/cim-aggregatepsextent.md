...
La classe **CIM \_ AggregatePSExtent** possède les types de membres suivants :
...
La classe **CIM \_ AggregatePSExtent** possède ces méthodes.



| Méthode                                                                       | Description                                                                                                                                |
|:-----------------------------------------------------------------------------|:-------------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-aggregatepsextent.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                                 |
| [**SetPowerState**](setpowerstate-method-in-class-cim-aggregatepsextent.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et le moment où l’appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ AggregatePSExtent** possède les propriétés suivantes.
...
La classe **CIM \_ AggregatePSExtent** est dérivée de [**CIM \_ StorageExtent**](cim-storageextent.md).
