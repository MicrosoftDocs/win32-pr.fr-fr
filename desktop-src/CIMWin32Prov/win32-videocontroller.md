...
ms.locfileid: "119079613"
---
# <a name="win32_videocontroller-class"></a>\_Classe VideoController Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ VideoController** WMI représente les capacités et la capacité de gestion du contrôleur vidéo sur un système informatique exécutant Windows.
...
La classe **Win32 \_ VideoController** possède les types de membres suivants :
...
La classe **Win32 \_ VideoController** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ PCVideoController**](cim-pcvideocontroller.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ PCVideoController**](cim-pcvideocontroller.md).<br/> |
...
La classe **Win32 \_ VideoController** a ces propriétés.
...
Qualificateurs : [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ VideoController**](cim-videocontroller.md).**CapabilityDescriptions**")
</dt> </dl>

Tableau de graphiques et de fonctionnalités 3D du contrôleur vidéo.

Cette propriété est héritée de la [**\_ VideoController CIM**](cim-videocontroller.md).
...
<span id="Graphics_Accelerator"></span><span id="graphics_accelerator"></span><span id="GRAPHICS_ACCELERATOR"></span>**Accélérateur graphique** (2)
...
<span id="3D_Accelerator"></span><span id="3d_accelerator"></span><span id="3D_ACCELERATOR"></span>**accélérateur 3D** (3)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry")
</dt> </dl>

Processeur général utilisé par ce contrôleur pour comparer les compatibilités avec le système.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HardwareInformation. DACType")
</dt> </dl>

Nom ou identificateur de la puce de conversion numérique-analogique (DAC). Le jeu de caractères de cette propriété est alphanumérique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HardwareInformation. MemorySize"), [**Units**](../wmisdk/standard-qualifiers.md) ("bytes")
</dt> </dl>

Taille de la mémoire de la carte vidéo.
...
Qualificateurs : [**arrayType**](../wmisdk/standard-qualifiers.md) ("Indexed"), [**ModelCorrespondence**](../wmisdk/standard-qualifiers.md) ("[**CIM \_ VideoController**](cim-videocontroller.md).**AcceleratorCapabilities**")
</dt> </dl>

Chaînes de forme libre fournissant des explications plus détaillées sur les fonctionnalités de l’accélérateur vidéo indiquées dans le tableau **AcceleratorCapabilities** . Notez que chaque entrée de ce tableau est liée à l’entrée dans le tableau **AcceleratorCapabilities** qui se trouve dans le même index.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , fonctions de contexte de périphérique \| [**GetDeviceCaps**](/windows/win32/api/wingdi/nf-wingdi-getdevicecaps)")
</dt> </dl>

Taille de la table des couleurs du système. L’appareil doit avoir une profondeur de couleur inférieure ou égale à 8 bits par pixel ; dans le cas contraire, cette propriété n’est pas définie.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,12 "), [**unités**](../wmisdk/standard-qualifiers.md) (" bits ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,11 "), [**unités**](../wmisdk/standard-qualifiers.md) (" pixels ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,14 ")
</dt> </dl>

Nombre de colonnes pour ce contrôleur vidéo (en mode caractère). Sinon, entrez 0 (zéro).
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,13 ")
</dt> </dl>

Nombre de lignes pour ce contrôleur vidéo (en mode caractère). Sinon, entrez 0 (zéro).
...
Qualificateurs : [**override**](../wmisdk/standard-qualifiers.md) ("CurrentRefreshRate"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| HardwareInformation."), [**Units**](../wmisdk/standard-qualifiers.md) ("Hertz")
</dt> </dl>

Fréquence à laquelle le contrôleur vidéo actualise l’image de l’analyse. La valeur 0 (zéro) indique que le taux par défaut est utilisé, tandis que 0xFFFFFFFF indique que le taux optimal est utilisé.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,8 ")
</dt> </dl>

Mode d’analyse en cours.
...
<span id="Interlaced"></span><span id="interlaced"></span><span id="INTERLACED"></span>**Entrelacé** (3)
...
<span id="Non_Interlaced"></span><span id="non_interlaced"></span><span id="NON_INTERLACED"></span>**Non entrelacé** (4)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,10 "), [**unités**](../wmisdk/standard-qualifiers.md) (" pixels ")
</dt> </dl>
...
Identificateur (propre au système informatique) de ce contrôleur vidéo.
...
Nombre actuel de stylets spécifiques à l’appareil. La valeur 0xffff signifie que l’appareil ne prend pas en charge les stylets.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| , fonctions de contexte de périphérique \| EnumDisplaySettings")
</dt> </dl>

Type de tramage du contrôleur vidéo. La propriété peut être l’une des valeurs prédéfinies, ou une valeur définie par le pilote supérieure ou égale à 256. Si le tramage d’art en ligne est choisi, le contrôleur utilise une méthode de tramage qui produit des bordures bien définies entre les mises à l’échelle en noir, blanc et gris. Le tramage en ligne n’est pas adapté aux images qui incluent des diplômes continus en intensité et en teinte, tels que des photographies numérisées.
...
**Tramage à l’aide d’un pinceau épais** (2)
...
**L’appareil n’effectue pas de mise à l’échelle en gris** (5)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ services \\ \\ Class \\ \\ ")
</dt> </dl>

Date et heure de la dernière modification du pilote vidéo actuellement installé.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) (« fonctions de la \| bibliothèque d’installation du fichier win32api \| GetFileVersionInfo »)
</dt> </dl>

Numéro de version du pilote vidéo.
...
Chaîne de forme libre fournissant plus d’informations sur l’erreur enregistrée dans la propriété **LastErrorCode** , ainsi que des informations sur toutes les actions correctives qui peuvent être prises.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| Printing and Print Spooler structures \| DEVMODE \| dmICMIntent")
</dt> </dl>

Valeur spécifique de l’une des trois méthodes ou intentions de correspondance de couleur possibles qui doit être utilisée par défaut. cette propriété est principalement utilisée pour les applications non ICM. ICM applications établissent des intentions à l’aide des fonctions ICM. Cette propriété peut être une valeur prédéfinie ou une valeur définie par le pilote supérieure ou égale à 256. La correspondance des couleurs basée sur la saturation est le choix le plus approprié pour les graphes professionnels lorsque le tramage n’est pas souhaité. La correspondance des couleurs basée sur le contraste est le choix le plus approprié pour les images numérisées ou photographiques lorsque le tramage est souhaité. La mise en correspondance des couleurs optimisée pour correspondre à la couleur exacte demandée est la plus appropriée pour une utilisation avec des logos d’entreprise ou d’autres images lorsqu’une correspondance de couleur exacte est souhaitée.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| Printing and Print Spooler structures \| DEVMODE \| dmICMMethod")
</dt> </dl>

Méthode de gestion de ICM. pour les applications non-ICM, cette propriété détermine si ICM est activé. pour les applications ICM, le système examine cette propriété pour déterminer comment gérer la prise en charge des ICM. Cette propriété peut être une valeur prédéfinie ou une valeur définie par le pilote supérieure ou égale à 256. La valeur détermine le système qui gère la correspondance des couleurs de l’image.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("Win32Registry \| System \\ \\ CurrentControlSet \\ \\ Control \\ \\ Class \\ \\ {4D36E968-E325-11CE-BFC1-08002BE10318} \\ \\ 0000")
</dt> </dl>

Chemin d’accès au fichier. inf de la carte vidéo.

exemple : « C : \\ Windows \\ SYSTEM32 \\ drivers »
...
Section du fichier. inf où se trouvent les informations de Windows vidéo.
...
Nom du pilote de périphérique d’affichage installé.
...
Qualificateurs : [**Units**](../wmisdk/standard-qualifiers.md) ("bytes")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,5 "), [**unités**](../wmisdk/standard-qualifiers.md) (" Hertz ")
</dt> </dl>

Taux d’actualisation maximal du contrôleur vidéo en Hertz.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,4 "), [**unités**](../wmisdk/standard-qualifiers.md) (" Hertz ")
</dt> </dl>

Fréquence d’actualisation minimale du contrôleur vidéo en Hertz.
...
Si la **valeur est true**, la mise à l’échelle grise est utilisée pour afficher les images.
...
Nombre actuel de plans de couleurs. Si cette valeur n’est pas applicable à la configuration vidéo actuelle, entrez 0 (zéro).

Cette propriété est héritée de la [**\_ PCVideoController CIM**](cim-pcvideocontroller.md).
...
Nombre d’entrées réservées dans la palette système. Le système d’exploitation peut réserver des entrées pour prendre en charge des couleurs standard pour les barres de tâches et d’autres éléments d’affichage du bureau. Cet index est valide uniquement si le pilote de périphérique définit le bit de **\_ palette RC** dans l’index RasterCaps et n’est disponible que si le pilote est compatible avec les Windows 16 bits. Si le système n’utilise pas de palette, **ReservedSystemPaletteEntries** n’est pas défini.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("win32api \| Printing and Print Spooler structures \| DEVMODE \| dmSpecVersion")
</dt> </dl>

Numéro de version de la spécification des données d’initialisation (sur laquelle la structure est basée).
...
Nombre actuel d’entrées d’index de couleur dans la palette système. Cet index est valide uniquement si le pilote de périphérique définit le bit de **\_ palette RC** dans l’index RasterCaps et n’est disponible que si le pilote est compatible avec les Windows 16 bits. Si le système n’utilise pas de palette, **SystemPaletteEntries** n’est pas défini.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,2 ")
</dt> </dl>

Type d’architecture vidéo.
...
**Mémoire tampon de trame linéaire** (12)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,6 ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Vidéo DMTF \| 003,3 ")
</dt> </dl>
...
Paramètres actuels de résolution, de couleur et de numérisation du contrôleur vidéo.

Exemple : « 1024 x 768 x 256 couleurs »
...
Chaîne de forme libre décrivant le processeur vidéo.
...
La classe **Win32 \_ VideoController** est dérivée de [**CIM \_ PCVideoController**](cim-pcvideocontroller.md).
...
L’exemple VBScript de la [liste des propriétés du contrôleur vidéo](https://Gallery.TechNet.Microsoft.Com/6c1a585c-742f-4f51-bb57-23838e8f011f) répertorie les propriétés du contrôleur vidéo.

L’exemple PowerShell suivant répertorie les propriétés du contrôleur vidéo.
