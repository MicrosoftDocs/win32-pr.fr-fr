...
ms.locfileid: "127225073"
---
# <a name="win32_portconnector-class"></a>\_Classe PortConnector Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ PortConnector** WMI représente des ports de connexion physiques, tels que DB-25 pin mâle, Centronics ou PS/2.
...
La classe **Win32 \_ PortConnector** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PortConnector** a ces propriétés.
...
Configuration du code confidentiel et utilisation des signaux d’un connecteur physique.
...
Qualificateurs : [**override**](../wmisdk/standard-qualifiers.md) ("ConnectorType"), [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 8 \| Internal/External Connector type")
</dt> </dl>

Tableau d’attributs physiques du connecteur utilisé par ce port.

Cette propriété est héritée de la [**\_ PhysicalConnector CIM**](cim-physicalconnector.md). La liste suivante répertorie les valeurs.
...
<span id="Male"></span><span id="male"></span><span id="MALE"></span>**Mâle** (2)
...
<span id="Female"></span><span id="female"></span><span id="FEMALE"></span>**Femme** (3)
...
<span id="Shielded"></span><span id="shielded"></span><span id="SHIELDED"></span>**Protégé** (4)
...
<span id="Unshielded"></span><span id="unshielded"></span><span id="UNSHIELDED"></span>**Unblindée** (5)
...
<span id="SCSI__A__High-Density__50_pins_"></span><span id="scsi__a__high-density__50_pins_"></span><span id="SCSI__A__HIGH-DENSITY__50_PINS_"></span>**SCSI (A) High-Density (50 broches)** (6)
...
<span id="SCSI__A__Low-Density__50_pins_"></span><span id="scsi__a__low-density__50_pins_"></span><span id="SCSI__A__LOW-DENSITY__50_PINS_"></span>**SCSI (A) Low-Density (pin 50)** (7)
...
<span id="SCSI__P__High-Density__68_pins_"></span><span id="scsi__p__high-density__68_pins_"></span><span id="SCSI__P__HIGH-DENSITY__68_PINS_"></span>**SCSI (P) High-Density (68 broches)** (8)
...
<span id="SCSI_SCA-I__80_pins_"></span><span id="scsi_sca-i__80_pins_"></span><span id="SCSI_SCA-I__80_PINS_"></span>**SCSI SCA-I (80 broches)** (9)
...
<span id="SCSI_SCA-II__80_pins_"></span><span id="scsi_sca-ii__80_pins_"></span><span id="SCSI_SCA-II__80_PINS_"></span>**SCSI SCA-II (80 broches)** (10)
...
<span id="SCSI_Fibre_Channel__DB-9__Copper_"></span><span id="scsi_fibre_channel__db-9__copper_"></span><span id="SCSI_FIBRE_CHANNEL__DB-9__COPPER_"></span>**Fibre Channel SCSI (DB-9, cuivre)** (11)
...
<span id="SCSI_Fibre_Channel_SCA-II__40_pins_"></span><span id="scsi_fibre_channel_sca-ii__40_pins_"></span><span id="SCSI_FIBRE_CHANNEL_SCA-II__40_PINS_"></span>**SCSI Fibre Channel SCA-II (40 broches)** (13)
...
<span id="SCSI_Fibre_Channel_SCA-II__20_pins_"></span><span id="scsi_fibre_channel_sca-ii__20_pins_"></span><span id="SCSI_FIBRE_CHANNEL_SCA-II__20_PINS_"></span>**SCSI Fibre Channel SCA-II (20 broches)** (14)
...
<span id="ATA_3-1_2_Inch__40_pins_"></span><span id="ata_3-1_2_inch__40_pins_"></span><span id="ATA_3-1_2_INCH__40_PINS_"></span>**ATA 3-1/2 pouces (40 broches)** (16)
...
<span id="ATA_2-1_2_Inch__44_pins_"></span><span id="ata_2-1_2_inch__44_pins_"></span><span id="ATA_2-1_2_INCH__44_PINS_"></span>**ATA 2-1/2 pouces (44 broches)** (17)
...
<span id="UTP_Category_3"></span><span id="utp_category_3"></span><span id="UTP_CATEGORY_3"></span>**UTP catégorie 3** (34)
...
<span id="UTP_Category_4"></span><span id="utp_category_4"></span><span id="UTP_CATEGORY_4"></span>**UTP catégorie 4** (35)
...
<span id="UTP_Category_5"></span><span id="utp_category_5"></span><span id="UTP_CATEGORY_5"></span>**UTP catégorie 5** (36)
...
<span id="Fiber_MIC"></span><span id="fiber_mic"></span><span id="FIBER_MIC"></span>**Fibre optique** (40)
...
<span id="Apple_GeoPort"></span><span id="apple_geoport"></span><span id="APPLE_GEOPORT"></span>**Port Apple** (42)
...
<span id="ZV_Port"></span><span id="zv_port"></span><span id="ZV_PORT"></span>**Port ZV** (51)
...
<span id="HIPPI"></span><span id="hippi"></span>**HIPPA** (55)
...
<span id="HSSDC__6_pins_"></span><span id="hssdc__6_pins_"></span><span id="HSSDC__6_PINS_"></span>**HSSDC (6 broches)** (56)
...
<span id="Infrared"></span><span id="infrared"></span><span id="INFRARED"></span>**Infrarouge** (62)
...
<span id="Mini-Centronics_Type-14"></span><span id="mini-centronics_type-14"></span><span id="MINI-CENTRONICS_TYPE-14"></span>**Type Mini-Centronics-14** (68)
...
<span id="Bus_Mouse"></span><span id="bus_mouse"></span><span id="BUS_MOUSE"></span>**Souris bus** (71)
...
<span id="Proprietary"></span><span id="proprietary"></span><span id="PROPRIETARY"></span>**Propriétaire** (76)
...
<span id="Proprietary_Processor_Card_Slot"></span><span id="proprietary_processor_card_slot"></span><span id="PROPRIETARY_PROCESSOR_CARD_SLOT"></span>**Emplacement de la carte de processeur propriétaire** (77)
...
<span id="Proprietary_Memory_Card_Slot"></span><span id="proprietary_memory_card_slot"></span><span id="PROPRIETARY_MEMORY_CARD_SLOT"></span>**Emplacement de carte mémoire propriétaire** (78)
...
<span id="Proprietary_I_O_Riser_Slot"></span><span id="proprietary_i_o_riser_slot"></span><span id="PROPRIETARY_I_O_RISER_SLOT"></span>**Emplacement de la carte de montage des e/s propriétaire** (79)
...
<span id="PCI-66MHZ"></span><span id="pci-66mhz"></span>**PCI-66 MHz** (80)
...
<span id="On_Board_Floppy"></span><span id="on_board_floppy"></span><span id="ON_BOARD_FLOPPY"></span>**Disquette sur carte** (89)
...
<span id="9_Pin_Dual_Inline__pin_10_cut_"></span><span id="9_pin_dual_inline__pin_10_cut_"></span><span id="9_PIN_DUAL_INLINE__PIN_10_CUT_"></span>**9 pin double inline (broche 10 coupées)** (90)
...
<span id="25_Pin_Dual_Inline__pin_26_cut_"></span><span id="25_pin_dual_inline__pin_26_cut_"></span><span id="25_PIN_DUAL_INLINE__PIN_26_CUT_"></span>**25 broches en ligne double (broche 26 coup)** (91)
...
<span id="50_Pin_Dual_Inline"></span><span id="50_pin_dual_inline"></span><span id="50_PIN_DUAL_INLINE"></span>**50 broche double Inline** (92)
...
<span id="68_Pin__Dual_Inline"></span><span id="68_pin__dual_inline"></span><span id="68_PIN__DUAL_INLINE"></span>**68 broche double Inline** (93)
...
<span id="On_Board_Sound_Input_from_CD-ROM"></span><span id="on_board_sound_input_from_cd-rom"></span><span id="ON_BOARD_SOUND_INPUT_FROM_CD-ROM"></span>**Entrée audio à la carte à partir du CD-ROM** (94)
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 8 \| External Reference désignateur")
</dt> </dl>

Indicateur de référence externe du port. Les indicateurs de référence externe sont des identificateurs qui déterminent le type et l’utilisation du port.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 8 \| Internal Reference désignateur")
</dt> </dl>

Indicateur de référence interne du port. Les indicateurs de référence internes sont spécifiques au fabricant et identifient l’emplacement du circuit ou l’utilisation du port.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("SMBIOS \| type 8 \| port type")
</dt> </dl>

Fonction du port. La liste suivante répertorie les valeurs.
...
**Port parallèle XT/AT compatible** (1)
...
**Port série à compatibilité XT/AT** (6)
...
**Port série 16550A compatible** (9)
...
Numéro alloué par le fabricant utilisé pour identifier un élément physique.
...
Numéro d’unité de conservation de stock pour un élément physique.
...
Identificateur unique d’une connexion de port sur le système informatique.

Cette propriété est héritée de la [**\_ PhysicalElement CIM**](cim-physicalelement.md).

Exemple : « connecteur de port 1 »
