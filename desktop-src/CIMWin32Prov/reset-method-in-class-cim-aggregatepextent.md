...
La méthode **Reset** de la \_ classe CIM AggregatePExtent demande une réinitialisation de l’unité logique. Cette méthode est héritée de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).
