...
| Méthode                                                           | Description                                                                                 |
|:-----------------------------------------------------------------|:--------------------------------------------------------------------------------------------|
| [**StartService**](startservice-method-in-class-cim-service.md) | Tente de mettre le service dans son état de démarrage. Non implémenté par WMI.<br/>     |
| [**StopService**](stopservice-method-in-class-cim-service.md)   | Méthode de classe qui place le service dans l’état arrêté. Non implémenté par WMI.<br/> |
...
WMI n’implémente pas cette classe. Pour les classes WMI dérivées du **\_ service CIM**, consultez [classes Win32](win32-provider.md).
