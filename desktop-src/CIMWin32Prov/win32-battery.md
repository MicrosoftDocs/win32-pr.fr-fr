...
ms.locfileid: "127230562"
---
# <a name="win32_battery-class"></a>\_Classe de batterie Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) de **\_ batterie Win32** représente une batterie connectée au système informatique.
...
La classe de **\_ batterie Win32** possède les types de membres suivants :
...
La classe de **\_ batterie Win32** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                          |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans la [**\_ batterie CIM**](cim-battery.md) pour la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans la [**\_ batterie CIM**](cim-battery.md) pour la documentation.<br/> |
...
La classe de **\_ batterie Win32** possède ces propriétés.
...
Qualificateurs : [**Deprecated**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("HKEY \_ local \_ machine \\ \\ System \\ \\ CurrentControlSet \\ \\ services \| recompresseur"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Temps nécessaire pour charger entièrement la batterie. Cette propriété n'est pas prise en charge. **BatteryRechargeTime** ne possède pas de propriété de remplacement et est désormais considéré comme obsolète.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,14 ")
</dt> </dl>

État de la batterie. La valeur 10 (non définie) n’est pas valide dans le schéma CIM, car dans DMI, elle indique qu’aucune batterie n’est installée. Dans ce cas, l’objet ne doit pas être instancié.
...
Le système a accès à AC et aucune batterie n’est en cours de déchargement. Toutefois, la batterie n’est pas nécessairement en charge.

</dd> <dt>

<span id="Fully_Charged"></span><span id="fully_charged"></span><span id="FULLY_CHARGED"></span>

<span id="Fully_Charged"></span><span id="fully_charged"></span><span id="FULLY_CHARGED"></span>**Entièrement facturée** (3)
...
<span id="Low"></span><span id="low"></span><span id="LOW"></span>**Faible** (4)
...
<span id="Charging"></span><span id="charging"></span><span id="CHARGING"></span>En **charge** (6)
...
<span id="Charging_and_High"></span><span id="charging_and_high"></span><span id="CHARGING_AND_HIGH"></span>En **charge et élevé** (7)
...
<span id="Charging_and_Low"></span><span id="charging_and_low"></span><span id="CHARGING_AND_LOW"></span>En **charge et bas** (8)
...
<span id="Charging_and_Critical"></span><span id="charging_and_critical"></span><span id="CHARGING_AND_CRITICAL"></span>En **charge et critique** (9)
...
<span id="Undefined"></span><span id="undefined"></span><span id="UNDEFINED"></span>**Non défini** (10)
...
<span id="Partially_Charged"></span><span id="partially_charged"></span><span id="PARTIALLY_CHARGED"></span>**Partiellement facturé** (11)
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,7 ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,8 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliwatts heure-heures ")
</dt> </dl>

Capacité de conception de la batterie en milliwatts heure-heures. Si la propriété n’est pas prise en charge, entrez 0 (zéro).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,9 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" millivolts ")
</dt> </dl>

Tension de conception de la batterie en millivolts. Si l’attribut n’est pas pris en charge, entrez 0 (zéro).
...
Chaîne de forme libre qui fournit plus d’informations sur l’erreur enregistrée dans la propriété **LastErrorCode** , ainsi que des informations sur les actions correctives qui peuvent être prises.
...
Qualificateurs : [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) ("pourcentage")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,15 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" minutes ")
</dt> </dl>
...
Qualificateurs : [**Deprecated**](/windows/desktop/WmiSdk/standard-wmi-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("HKEY \_ local \_ machine \\ \\ System \\ \\ CurrentControlSet \\ \\ services \| batterylife"), [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("minutes")
</dt> </dl>

Durée nécessaire pour vider complètement la batterie une fois qu’elle est entièrement chargée. Cette propriété n’est plus utilisée et est considérée comme obsolète.
...
Durée de vie prévue de la batterie en minutes, en supposant que la batterie est entièrement chargée. La propriété représente la durée de vie totale attendue de la batterie, pas sa durée de vie restante, qui est indiquée par la propriété **EstimatedRunTime** .
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,11 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" milliwatts heure-heures ")
</dt> </dl>

Capacité de charge totale de la batterie en milliwatts heure-heures. La comparaison de la valeur à la propriété **DesignCapacity** détermine le moment où la batterie doit être remplacée. La fin de vie d’une batterie se produit généralement lorsque la propriété **FullChargeCapacity** passe sous 80% de la propriété **DesignCapacity** . Si la propriété n’est pas prise en charge, entrez 0 (zéro).
...
Durée maximale, en minutes, pour le chargement complet de la batterie. La propriété représente le temps de rechargement d’une batterie entièrement épuisée, et non le temps de facturation restant actuel, qui est indiqué dans la propriété **TimeToFullCharge** .
...
Définit l’étiquette par laquelle l’objet est connu. Lorsqu’elle est sous-classée, la propriété peut être substituée pour être une propriété de clé.
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,10 ")
</dt> </dl>

Numéro de version de la spécification de données pris en charge par la batterie. Si la batterie ne prend pas en charge cette fonction, la valeur doit être laissée vide.
...
Qualificateurs : [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (« secondes »)
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Batterie portable DMTF \| 002,16 "), [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (" minutes ")
</dt> </dl>

Temps restant pour charger entièrement la batterie en quelques minutes à la vitesse de chargement et à l’utilisation actuelles.
...
La classe de **\_ batterie Win32** est dérivée de la [**\_ batterie CIM**](cim-battery.md) qui dérive de [**CIM \_ LogicalDevice**](cim-logicaldevice.md).

Windows Le serveur 2008 contient les pilotes de l’onduleur (APC) dans le système d’exploitation, ce qui vous permet de traiter l’onduleur comme une alimentation de batterie. Cela vous permet de surveiller l’état de l’onduleur à l’aide d’un script et de prendre les mesures nécessaires.

## <a name="examples"></a>Exemples

L’exemple de code [Toggle-Wireless.ps1](https://Gallery.TechNet.Microsoft.Com/Toggle-Wirelessps1-2d244a8f) PowerShell interroge la **\_ batterie Win32** pour déterminer s’il faut ou non basculer la connexion sans fil pour économiser de l’énergie.

L’exemple [List ups information](https://Gallery.TechNet.Microsoft.Com/7196121e-97de-4290-9939-26d0ce266270) perl répertorie des informations sur les sources d’alimentation sans coupure associées à un ordinateur.
