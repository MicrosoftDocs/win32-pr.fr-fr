...
ms.locfileid: "119878639"
---
# <a name="win32_keyboard-class"></a>\_Classe de clavier Win32

La [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) du **\_ clavier Win32** représente un clavier installé sur un système informatique exécutant Windows.
...
La classe de **\_ clavier Win32** possède les types de membres suivants :
...
La classe de **\_ clavier Win32** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                            |
|:------------------|:-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans le [**\_ clavier CIM**](cim-keyboard.md) pour obtenir de la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans le [**\_ clavier CIM**](cim-keyboard.md) pour obtenir de la documentation.<br/> |
...
La classe de **\_ clavier Win32** possède ces propriétés.
...
Qualificateurs : [**override**](/windows/desktop/WmiSdk/standard-qualifiers) ("DeviceID"), [**Key**](/windows/desktop/WmiSdk/key-qualifier)
</dt> </dl>
...
Informations supplémentaires sur l’erreur enregistrée dans **LastErrorCode**, et actions correctives qui peuvent être prises.
...
Chaîne de forme libre indiquant la disposition du clavier.

Cette propriété est héritée [**du \_ clavier CIM**](cim-keyboard.md).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. DMTF \| System Hardware Security \| 001,2»)
</dt> </dl>

État du mot de passe au niveau du matériel activé sur le clavier (valeur = 4), empêchant l’entrée locale.
...
La classe de **\_ clavier Win32** est dérivée du [**\_ clavier CIM**](cim-keyboard.md).

## <a name="examples"></a>Exemples

Le code PowerShell suivant détecte un clavier et une souris sans fil.
...
L’exemple VBScript suivant répertorie les propriétés du clavier.
