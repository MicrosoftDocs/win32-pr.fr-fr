...
Représente une propriété d’appareil PnP composée d’un tableau d’éléments **sint32** .
...
La classe **Win32 \_ PnPDevicePropertySint32Array** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PnPDevicePropertySint32Array** a ces propriétés.
...
Type de données : tableau **sint32**
</dt> <dt>
