...
---
# <a name="win32_pnpdevicepropertyuint8-class"></a>\_Classe PnPDevicePropertyUint8 Win32

Représente une propriété d’appareil PnP de type **Uint8**.
...
La classe **Win32 \_ PnPDevicePropertyUint8** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **Win32 \_ PnPDevicePropertyUint8** a ces propriétés.
