...
ms.locfileid: "119321229"
---
# <a name="cim_display-class-cimwin32-wmi-providers"></a>CIM_Display, classe (fournisseurs WMI CIMWin32)

La classe d' **\_ affichage CIM** est une classe parente permettant de regrouper divers périphériques d’affichage.
...
La classe d' **\_ affichage CIM** possède les types de membres suivants :
...
La classe d' **\_ affichage CIM** possède ces méthodes.
...
La classe d' **\_ affichage CIM** possède ces propriétés.
...
Chaîne de forme libre qui fournit des informations sur l’erreur enregistrée dans la propriété **LastErrorCode** actions correctives à effectuer.
...
La classe d' **\_ affichage CIM** est dérivée de la [**\_ UserDevice CIM**](cim-userdevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées de l' **\_ affichage CIM**, consultez [classes Win32](win32-provider.md).
