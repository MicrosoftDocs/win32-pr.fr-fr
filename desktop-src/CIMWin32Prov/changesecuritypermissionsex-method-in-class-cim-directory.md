...
ms.locfileid: "127296939"
---
# <a name="changesecuritypermissionsex-method-of-the-cim_directory-class"></a>Méthode ChangeSecurityPermissionsEx de la \_ classe de répertoire CIM
...
> [!Note]  
> Une ACL **null** dans la structure du [**\_ descripteur de sécurité**](/windows/desktop/api/winnt/ns-winnt-security_descriptor) accorde un accès illimité.
...
[\_Répertoire CIM](changesecuritypermissionsex-method-in-class-cim-directory.md)
</dt> <dt>
