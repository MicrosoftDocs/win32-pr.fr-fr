...
La classe **CIM \_ StorageRedundancyGroup** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ StorageRedundancyGroup** possède les propriétés suivantes.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Groupe de redondance DMTF \| 001,2 ")
</dt> </dl>

Algorithme utilisé pour la redondance et la reconstruction des données. La valeur 0 n’est pas valide dans le schéma CIM, car elle indique qu’il n’existe aucune redondance dans DMI. Dans ce cas, l’objet ne doit pas être instancié.
