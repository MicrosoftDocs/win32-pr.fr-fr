...
La méthode statique de la [classe WMI](/windows/desktop/WmiSdk/retrieving-a-class) **SetDefaultTTL** permet de définir la valeur de durée de vie (TTL) par défaut dans l’en-tête des paquets IP sortants.
...
Valeur de durée de vie définie dans l’en-tête des paquets IP sortants. La valeur par défaut est 32 ; Plage valide : 1-255
