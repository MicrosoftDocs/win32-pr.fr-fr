...
ms.locfileid: "126999400"
---
# <a name="win32_temperatureprobe-class"></a>\_Classe TemperatureProbe Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **\_ TemperatureProbe** WMI représente les propriétés d’un capteur de température (thermomètre électronique).

La plupart des informations fournies par la classe WMI **Win32 \_ TemperatureProbe** proviennent de SMBIOS. Les lectures en temps réel de la propriété **CurrentReading** ne peuvent pas être extraites des tables SMBIOS. Pour cette raison, les implémentations actuelles de WMI ne remplissent pas la propriété **CurrentReading** . La présence de la propriété **CurrentReading** est réservée à une utilisation ultérieure.
...
La classe **Win32 \_ TemperatureProbe** possède les types de membres suivants :
...
La classe **Win32 \_ TemperatureProbe** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                                                     |
|:------------------|:--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-temperaturesensor.md) dans [**CIM \_ capteur**](cim-temperaturesensor.md) pour obtenir de la documentation.<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-temperaturesensor.md) dans [**CIM \_ capteur**](cim-temperaturesensor.md) pour obtenir de la documentation.<br/> |
...
La classe **Win32 \_ TemperatureProbe** a ces propriétés.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,19 ")
</dt> </dl>

Précision du capteur pour la propriété mesurée. Sa valeur est enregistrée comme plus ou moins centièmes de pourcentage. La précision, la résolution et la tolérance sont utilisées pour calculer la valeur réelle de la propriété physique mesurée. La précision peut varier et varie selon que l’appareil est linéaire ou non sur sa plage dynamique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,5 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur actuelle indiquée par le capteur.

Les implémentations actuelles de WMI ne remplissent pas la propriété **CurrentReading** . La présence de la propriété **CurrentReading** est réservée à une utilisation ultérieure.
...
Identificateur unique de la sonde actuelle.
...
Plus d’informations sur l’erreur enregistrée dans **LastErrorCode**, ainsi que sur les actions correctives que vous pouvez effectuer.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,13 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur du seuil du capteur pour spécifier les plages (valeurs minimales et maximales) qui identifient les conditions de fonctionnement du capteur, qui peuvent être des conditions normales, non critiques, critiques ou irrécupérables. Si **CurrentReading** est compris entre **LowerThresholdCritical** et **LowerThresholdFatal**, l’état actuel est critique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,15 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur du seuil du capteur pour spécifier les plages (valeurs minimales et maximales) qui identifient les conditions de fonctionnement du capteur, qui peuvent être des conditions normales, non critiques, critiques ou irrécupérables. Si **CurrentReading** est en dessous de **LowerThresholdFatal**, l’état actuel est fatal.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,11 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur du seuil du capteur pour spécifier les plages (valeurs minimales et maximales) qui identifient les conditions de fonctionnement du capteur, qui peuvent être des conditions normales, non critiques, critiques ou irrécupérables. Si **CurrentReading** est compris entre **LowerThresholdNonCritical** et **UpperThresholdNonCritical**, le capteur signale une valeur normale. Si **CurrentReading** est compris entre **LowerThresholdNonCritical** et **LowerThresholdCritical**, l’état actuel n’est pas critique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,9 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,10 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,6 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Valeur normale ou attendue pour le capteur numérique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,7 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,8 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Aide pour l’utilisateur en ce qui concerne la plage minimale normale pour le capteur numérique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,17 "), [**unités**](../wmisdk/standard-qualifiers.md) (" centièmes de degrés centigrade ")
</dt> </dl>
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,18 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Tolérance du capteur pour la propriété mesurée. La tolérance, ainsi que la résolution et la précision, sont utilisées pour calculer la valeur réelle de la propriété physique mesurée. La tolérance peut varier selon que l’appareil est linéaire ou non sur sa plage dynamique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,14 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Les valeurs de seuil du capteur spécifient les plages (valeurs minimales et maximales) qui identifient les conditions de fonctionnement du capteur, qui peuvent être des conditions normales, non critiques, critiques ou irrécupérables. Si **CurrentReading** est compris entre **UpperThresholdCritical** et **UpperthresholdFatal**, l’état actuel est critique.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,16 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Les valeurs de seuil du capteur spécifient les plages (valeurs minimales et maximales) qui identifient les conditions de fonctionnement du capteur, qui peuvent être des conditions normales, non critiques, critiques ou irrécupérables. Si **CurrentReading** est au-dessus de **UpperthresholdFatal**, l’état actuel est fatal.
...
Qualificateurs : [**MappingStrings**](../wmisdk/standard-qualifiers.md) ("MIF. \|Sonde de température DMTF \| 001,12 "), [**unités**](../wmisdk/standard-qualifiers.md) (" dixièmes de degrés centigrade ")
</dt> </dl>

Les valeurs de seuil du capteur spécifient les plages (valeurs minimales et maximales) qui identifient les conditions de fonctionnement du capteur, qui peuvent être des conditions normales, non critiques, critiques ou irrécupérables. Si **CurrentReading** est compris entre **LowerThresholdNonCritical** et **UpperThresholdNonCritical**, le capteur signale une valeur normale. Si **CurrentReading** est compris entre **UpperThresholdNonCritical** et **UpperThresholdCritical**, l’état actuel n’est pas critique.
...
La classe **Win32 \_ TemperatureProbe** est dérivée de [**CIM \_ capteur**](cim-temperaturesensor.md).

## <a name="examples"></a>Exemples

L’exemple suivant retourne des données de sonde de température pour l’ordinateur local.
