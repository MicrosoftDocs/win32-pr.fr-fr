...
ms.locfileid: "126858040"
---
# <a name="win32_usbcontroller-class"></a>\_Classe USBController Win32

La [classe WMI](../wmisdk/retrieving-a-class.md) **Win32 \_ USBController** gère les fonctionnalités d’un contrôleur USB (Universal Serial Bus).
...
La classe **Win32 \_ USBController** possède les types de membres suivants :
...
La classe **Win32 \_ USBController** possède ces méthodes.



| Méthode            | Description                                                                                                                                                                                    |
|:------------------|:-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| **Réinitialiser**         | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**Reset**](reset-method-in-class-cim-controller.md) dans [**CIM \_ USBController**](cim-usbcontroller.md).<br/>                 |
| **SetPowerState** | Non implémenté. Pour implémenter cette méthode, consultez la méthode [**SetPowerState**](setpowerstate-method-in-class-cim-controller.md) dans [**CIM \_ USBController**](cim-usbcontroller.md).<br/> |
...
La classe **Win32 \_ USBController** a ces propriétés.
...
Identificateur unique du contrôleur USB.
...
Cette propriété est héritée de la [**\_ USBController CIM**](cim-usbcontroller.md).
...
Date et heure de la dernière réinitialisation du contrôleur. Cela peut signifier que le contrôleur a été mis hors tension ou réinitialisé.
...
La classe **Win32 \_ USBController** est dérivée de [**CIM \_ USBController**](cim-usbcontroller.md).

Vous pouvez utiliser la classe d’association [**Win32 \_ USBControllerDevice**](win32-usbcontrollerdevice.md) pour déterminer les périphériques logiques qui sont associés au contrôleur.

## <a name="examples"></a>Exemples

L’exemple PowerShell informations sur le [contrôleur USB](https://Gallery.TechNet.Microsoft.Com/fc2d92ce-a241-47bf-a5ea-3395d301559e) retourne des informations sur tous les contrôleurs USB détectés sur un ordinateur.

L’exemple VBScript suivant retourne des informations sur tous les contrôleurs USB détectés sur un ordinateur.
