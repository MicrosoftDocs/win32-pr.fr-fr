...
La classe **CIM \_ ApplicationSystem** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ ApplicationSystem** possède les propriétés suivantes.
...
La classe **CIM \_ ApplicationSystem** est dérivée [**du \_ système CIM**](cim-system.md).
