...
ms.locfileid: "126999468"
---
# <a name="win32_session-class"></a>\_Classe de session Win32

La classe de **\_ session Win32** définit des informations d’État sur l’interaction entre un utilisateur et une ressource, par exemple un système informatique ou une session terminal.
...
La classe **Win32 \_ session** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe de **\_ session Win32** possède ces propriétés.
...
La classe **Win32 \_ session** est dérivée de [**CIM \_ LogicalElement**](cim-logicalelement.md).
