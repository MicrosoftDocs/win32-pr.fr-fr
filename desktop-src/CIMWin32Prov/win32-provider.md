---
description: Microsoft&\# 160 ; le fournisseur Win32 récupère et met à jour les données relatives à Windows systèmes&\# 8212 ; des données telles que les paramètres actuels des variables d’environnement et les attributs d’un disque logique.
