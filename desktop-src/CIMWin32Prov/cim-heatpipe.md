...
ms.locfileid: "119923709"
---
# <a name="cim_heatpipe-class"></a>\_Classe CIM Heatpipe

La classe **CIM \_ Heatpipe** représente les fonctionnalités et la gestion d’un appareil de refroidissement de tuyauterie thermique.
...
La classe **CIM \_ Heatpipe** possède les types de membres suivants :
...
La classe **CIM \_ Heatpipe** possède ces méthodes.



| Méthode                                                              | Description                                                                                                                              |
|:--------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-heatpipe.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-heatpipe.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
...
La classe **CIM \_ Heatpipe** possède les propriétés suivantes.
...
La classe **CIM \_ Heatpipe** est dérivée de [**CIM \_ CoolingDevice**](cim-coolingdevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées de **CIM \_ Heatpipe**, consultez [classes Win32](win32-provider.md).
