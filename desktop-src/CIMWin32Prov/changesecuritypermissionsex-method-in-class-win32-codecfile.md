...
Si la **valeur est true**, les modifications de propriété sont appliquées de manière récursive aux fichiers et répertoires du répertoire que l’instance [**\_ LogicalFile CIM**](cim-logicalfile.md) spécifie. Pour les instances de fichier, le paramètre d’entrée *récursive* est ignoré.
