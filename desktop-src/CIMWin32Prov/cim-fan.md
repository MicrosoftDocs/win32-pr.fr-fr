...
ms.locfileid: "119923869"
---
# <a name="cim_fan-class"></a>\_Classe de ventilateur CIM

La classe de **\_ ventilateur CIM** représente les fonctionnalités et la gestion d’un appareil de refroidissement de ventilateur.
...
La classe de **\_ ventilateur CIM** possède les types de membres suivants :
...
La classe de **\_ ventilateur CIM** présente ces méthodes.



| Méthode                                                         | Description                                                                                                                              |
|:---------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------------------------------|
| [**Initialisation**](reset-method-in-class-cim-fan.md)                 | Demande la réinitialisation de l’unité logique. Non implémenté par WMI.<br/>                                                               |
| [**SetPowerState**](setpowerstate-method-in-class-cim-fan.md) | Définit l’état d’alimentation souhaité pour un périphérique logique et lorsqu’un appareil doit être placé dans cet État. Non implémenté par WMI.<br/> |
| [**SetSpeed**](setspeed-method-in-class-cim-fan.md)           | Définit la vitesse du ventilateur. Non implémenté par WMI.<br/>                                                                                   |
...
La classe de **\_ ventilateur CIM** possède ces propriétés.
...
La classe de **\_ ventilateur CIM** est dérivée de la [**\_ CoolingDevice CIM**](cim-coolingdevice.md).

WMI n’implémente pas cette classe. Pour les classes dérivées du **\_ ventilateur CIM**, consultez [classes Win32](win32-provider.md).
