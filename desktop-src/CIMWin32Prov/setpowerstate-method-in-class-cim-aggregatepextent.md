...
Pour plus d’informations sur l’utilisation de cette méthode avec C/C++, consultez [appel d’une méthode](/windows/desktop/WmiSdk/calling-a-method).
