...
La classe **CIM \_ ClusteringSAP** représente les points d’accès d’un service de clustering.
...
La classe **CIM \_ ClusteringSAP** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ ClusteringSAP** possède les propriétés suivantes.
