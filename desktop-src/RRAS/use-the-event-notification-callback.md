...
La procédure suivante décrit les étapes que le client doit utiliser pour recevoir des messages de notification de modification à partir du \_ rappel d’événement RTM \_ . L’exemple de code suivant montre comment implémenter la procédure.

**Comment récupérer les messages de notification de modification**

1.  Appelez [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) pour récupérer un ensemble de modifications.
2.  Traitez les modifications.
3.  Libérez les destinations à l’aide de [**RtmReleaseChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmreleasechangeddests).
4.  Répétez les étapes 1, 2 et 3 jusqu’à ce que [**RtmGetChangedDests**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetchangeddests) retourne erreur \_ \_ , plus aucun \_ élément.

L’exemple de code suivant montre comment traiter un rappel de [**\_ \_ rappel d’événement RTM**](/windows/win32/api/rtmv2/nc-rtmv2-_event_callback) reçu du gestionnaire de tables de routage.
