...
description: Windows NT 4,0 permet à une DLL de sécurité RAS tierce d’améliorer les fonctionnalités de sécurité RAS intégrées. Windows 95 ne fournit pas cette prise en charge.
