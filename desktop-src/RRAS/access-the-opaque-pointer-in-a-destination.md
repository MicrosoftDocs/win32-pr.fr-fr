---
title: Accéder au pointeur opaque dans une destination
description: L’exemple de code suivant montre comment accéder au pointeur opaque dans une destination.
...
ms.locfileid: "104029331"
---
# <a name="access-the-opaque-pointer-in-a-destination"></a><span data-ttu-id="ae3cf-103">Accéder au pointeur opaque dans une destination</span><span class="sxs-lookup"><span data-stu-id="ae3cf-103">Access the Opaque Pointer in a Destination</span></span>

<span data-ttu-id="ae3cf-104">L’exemple de code suivant montre comment accéder au pointeur opaque dans une destination.</span><span class="sxs-lookup"><span data-stu-id="ae3cf-104">The following sample code shows how to access the opaque pointer in a destination.</span></span>
