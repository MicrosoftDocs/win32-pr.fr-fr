...
ms.locfileid: "106511439"
---
# <a name="use-the-route-hold-down-state"></a><span data-ttu-id="05db5-103">Utiliser l’état de Hold-Down de l’itinéraire</span><span class="sxs-lookup"><span data-stu-id="05db5-103">Use the Route Hold-Down State</span></span>

<span data-ttu-id="05db5-104">L’exemple de code suivant montre comment marquer une destination pour l’état de blocage et comment créer une énumération de destination qui comprend des itinéraires qui sont dans l’état de blocage.</span><span class="sxs-lookup"><span data-stu-id="05db5-104">The following sample code shows how to mark a destination for the hold-down state, and how to create a destination enumeration that includes routes that are in the hold-down state.</span></span>
