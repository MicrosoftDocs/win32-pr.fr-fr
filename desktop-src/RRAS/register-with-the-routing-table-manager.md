---
title: S’inscrire auprès du gestionnaire de tables de routage
description: L’exemple de code suivant montre comment inscrire une nouvelle entité à l’aide du gestionnaire de tables de routage.
...
ms.locfileid: "104029008"
---
# <a name="register-with-the-routing-table-manager"></a><span data-ttu-id="18910-103">S’inscrire auprès du gestionnaire de tables de routage</span><span class="sxs-lookup"><span data-stu-id="18910-103">Register with the Routing Table Manager</span></span>

<span data-ttu-id="18910-104">L’exemple de code suivant montre comment inscrire une nouvelle entité à l’aide du gestionnaire de tables de routage.</span><span class="sxs-lookup"><span data-stu-id="18910-104">The following sample code shows how to register a new entity with the routing table manager.</span></span>
