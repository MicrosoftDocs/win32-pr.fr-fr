---
title: Obtenir et appeler les méthodes exportées pour un client
description: L’exemple de code suivant montre comment obtenir une liste des méthodes exportées par un client, et comment appeler une méthode pour ce client.
...
ms.locfileid: "104461983"
---
# <a name="obtain-and-call-the-exported-methods-for-a-client"></a><span data-ttu-id="712f9-103">Obtenir et appeler les méthodes exportées pour un client</span><span class="sxs-lookup"><span data-stu-id="712f9-103">Obtain and Call the Exported Methods for a Client</span></span>

<span data-ttu-id="712f9-104">L’exemple de code suivant montre comment obtenir une liste des méthodes exportées par un client, et comment appeler une méthode pour ce client.</span><span class="sxs-lookup"><span data-stu-id="712f9-104">The following sample code shows how to obtain a list of methods a client has exported, and how to invoke a method for that client.</span></span>
