...
ms.locfileid: "120035599"
---
# <a name="search-for-routes-using-a-prefix-tree"></a>Rechercher des itinéraires à l’aide d’une arborescence de préfixe

L’exemple de code suivant montre comment utiliser [**RtmGetMostSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetmostspecificdestination) et [**RtmGetLessSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetlessspecificdestination) pour remonter l’arborescence de préfixe dans la table de routage.
