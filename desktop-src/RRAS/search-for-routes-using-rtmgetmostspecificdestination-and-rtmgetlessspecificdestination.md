---
title: Rechercher des itinéraires à l’aide d’une arborescence de préfixe
description: L’exemple de code suivant montre comment utiliser RtmGetMostSpecificDestination et RtmGetLessSpecificDestination pour remonter l’arborescence de préfixe dans la table de routage.
...
ms.locfileid: "103839461"
---
# <a name="search-for-routes-using-a-prefix-tree"></a><span data-ttu-id="1de2d-103">Rechercher des itinéraires à l’aide d’une arborescence de préfixe</span><span class="sxs-lookup"><span data-stu-id="1de2d-103">Search for Routes Using a Prefix Tree</span></span>

<span data-ttu-id="1de2d-104">L’exemple de code suivant montre comment utiliser [**RtmGetMostSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetmostspecificdestination) et [**RtmGetLessSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetlessspecificdestination) pour remonter l’arborescence de préfixe dans la table de routage.</span><span class="sxs-lookup"><span data-stu-id="1de2d-104">The following sample code shows how to use [**RtmGetMostSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetmostspecificdestination) and [**RtmGetLessSpecificDestination**](/windows/desktop/api/Rtmv2/nf-rtmv2-rtmgetlessspecificdestination) to walk up the prefix tree in the routing table.</span></span>
