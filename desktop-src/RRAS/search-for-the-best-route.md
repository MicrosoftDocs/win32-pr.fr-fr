...
---
# <a name="search-for-the-best-route"></a><span data-ttu-id="bd7a1-103">Rechercher le meilleur itinéraire</span><span class="sxs-lookup"><span data-stu-id="bd7a1-103">Search For the Best Route</span></span>

<span data-ttu-id="bd7a1-104">L’exemple de code suivant montre comment rechercher le meilleur itinéraire dans la table de routage.</span><span class="sxs-lookup"><span data-stu-id="bd7a1-104">The following sample code shows how to search the routing table for the best route.</span></span>
