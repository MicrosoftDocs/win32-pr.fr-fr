---
title: Énumérer les entités inscrites
description: L’exemple de code suivant montre comment créer une énumération de clients inscrits et obtenir les informations du client à partir du gestionnaire de tables de routage.
...
ms.locfileid: "106509799"
---
# <a name="enumerate-the-registered-entities"></a><span data-ttu-id="c39f8-103">Énumérer les entités inscrites</span><span class="sxs-lookup"><span data-stu-id="c39f8-103">Enumerate the Registered Entities</span></span>

<span data-ttu-id="c39f8-104">L’exemple de code suivant montre comment créer une énumération de clients inscrits et obtenir les informations du client à partir du gestionnaire de tables de routage.</span><span class="sxs-lookup"><span data-stu-id="c39f8-104">The following sample code shows how to create an enumeration of registered clients and obtain the client information from the routing table manager.</span></span>
