...
ms.locfileid: "120074019"
---
# <a name="obtaining-the-mib-ii-interfaces-table"></a>Obtention de la table des interfaces MIB II

Le code suivant utilise [**MprAdminMIBEntryGet**](/windows/desktop/api/Mprapi/nf-mprapi-mpradminmibentryget) pour obtenir la table d’interfaces MIB II à partir de l’ordinateur local.
...
[**\_informations opaques MIB \_**](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_info)
</dt> <dt>

[**\_requête opaque \_ MIB**](/windows/desktop/api/iprtrmib/ns-iprtrmib-mib_opaque_query)
</dt> <dt>
