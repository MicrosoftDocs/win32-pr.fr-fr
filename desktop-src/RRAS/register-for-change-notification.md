...
description: L’exemple de code suivant montre comment s’inscrire pour les notifications de modification dans la table de routage. La rubrique \ 0034 ; Utilisez le rappel de notification d’événements \ 0034 ; montre comment utiliser ces notifications de modification.
...
ms.locfileid: "104029009"
---
# <a name="register-for-change-notification"></a><span data-ttu-id="1756e-104">Inscription à la notification de modification</span><span class="sxs-lookup"><span data-stu-id="1756e-104">Register For Change Notification</span></span>

<span data-ttu-id="1756e-105">L’exemple de code suivant montre comment s’inscrire pour les notifications de modification dans la table de routage.</span><span class="sxs-lookup"><span data-stu-id="1756e-105">The following sample code shows how to register for change notifications in the routing table.</span></span> <span data-ttu-id="1756e-106">La rubrique «[utiliser le rappel de notification d’événement](use-the-event-notification-callback.md)» montre comment utiliser ces notifications de modification.</span><span class="sxs-lookup"><span data-stu-id="1756e-106">The topic "[Use the Event Notification Callback](use-the-event-notification-callback.md)" demonstrates how to utilize those change notifications.</span></span>
