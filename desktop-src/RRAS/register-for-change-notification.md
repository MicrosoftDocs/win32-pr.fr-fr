...
---
# <a name="register-for-change-notification"></a>Inscription à la notification de modification

L’exemple de code suivant montre comment s’inscrire pour les notifications de modification dans la table de routage. La rubrique «[utiliser le rappel de notification d’événement](use-the-event-notification-callback.md)» montre comment utiliser ces notifications de modification.
