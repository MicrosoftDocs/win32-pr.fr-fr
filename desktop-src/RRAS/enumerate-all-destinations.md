---
title: Énumérer toutes les destinations
description: L’exemple de code suivant montre comment énumérer toutes les destinations dans la table de routage.
...
ms.locfileid: "104029264"
---
# <a name="enumerate-all-destinations"></a><span data-ttu-id="188f4-103">Énumérer toutes les destinations</span><span class="sxs-lookup"><span data-stu-id="188f4-103">Enumerate All Destinations</span></span>

<span data-ttu-id="188f4-104">L’exemple de code suivant montre comment énumérer toutes les destinations dans la table de routage.</span><span class="sxs-lookup"><span data-stu-id="188f4-104">The following sample code shows how to enumerate all destinations in the routing table.</span></span>
