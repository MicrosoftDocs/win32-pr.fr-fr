...
ms.locfileid: "120127859"
---
# <a name="enumerate-all-destinations"></a>Énumérer toutes les destinations

L’exemple de code suivant montre comment énumérer toutes les destinations dans la table de routage.
