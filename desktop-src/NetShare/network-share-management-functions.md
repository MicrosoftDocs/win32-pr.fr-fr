...
ms.locfileid: "119676569"
---
# <a name="network-share-management-functions"></a>Fonctions de gestion du partage réseau

Les fonctions de gestion de partage réseau peuvent être regroupées comme suit.
...
## <a name="session-functions"></a>Fonctions de session
...
## <a name="statistics-function"></a>Fonction Statistics
