...
ms.locfileid: "119682909"
---
# <a name="http-server-sample-application"></a>Exemple d’application de serveur HTTP

L’exemple d’application suivant montre comment utiliser l’API du serveur HTTP pour effectuer des tâches côté serveur. Le fichier « precomp. h » inclus dans le premier exemple inclut tous les en-têtes nécessaires pour exécuter les exemples, par exemple :
...
## <a name="main-and-preliminaries"></a>Main et préliminaires
...
## <a name="cleanup-the-http-server-api"></a>Nettoyer l’API du serveur HTTP
...
## <a name="receive-a-request"></a>Recevoir une demande
...
## <a name="send-an-http-response"></a>Envoyer une réponse HTTP
...
## <a name="send-an-http-post-response"></a>Envoyer une réponse HTTP Après
