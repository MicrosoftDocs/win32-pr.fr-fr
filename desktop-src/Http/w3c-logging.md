...
| Heure                             | time            | Heure, au format UTC (temps universel coordonné), à laquelle l’activité s’est produite.                                                             | API du serveur HTTP générée.     | \_heure du \_ champ du journal http \_           |
...
| Hôte                             | CS-hôte         | Nom de l’en-tête de l’hôte, le cas échéant.                                                                                                              | Hôte                           | \_hôte de \_ champ de journal http \_           |
