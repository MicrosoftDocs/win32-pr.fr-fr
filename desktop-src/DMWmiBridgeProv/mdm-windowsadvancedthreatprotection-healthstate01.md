...
description: la \_ classe WindowsAdvancedThreatProtection \_ HealthState01 MDM est utilisée pour déterminer l’état d’intégrité des points de terminaison de Windows Defender Protection avancée contre les menaces (émission).
...
la **classe \_ WindowsAdvancedThreatProtection \_ HealthState01 MDM** est utilisée pour déterminer l’état d’intégrité des points de terminaison de Windows Defender Protection avancée contre les menaces (émission).
