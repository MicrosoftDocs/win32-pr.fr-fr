...
---
# <a name="mdm_devdetail-class"></a>\_Classe DEVDETAIL MDM

\[Certaines informations relatives aux produits précommercialisés peuvent être substantiellement modifiées avant leur commercialisation. Microsoft ne donne aucune garantie, expresse ou implicite, concernant les informations fournies ici.\]

La classe **MDM \_ DevDetail** gère l’objet de gestion qui fournit des paramètres spécifiques au périphérique au serveur de DM OMA. Ces paramètres d’appareil ne sont pas envoyés automatiquement du client au serveur, mais ils peuvent être interrogés par des serveurs à l’aide de commandes de DM OMA.
...
La **classe \_ DevDetail MDM** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La **classe \_ DevDetail MDM** a ces propriétés.
...
Identifie le nom du nœud parent. Pour cette classe, la chaîne est « DevDetail ».
...
[FABRICANT](/windows/client-management/mdm/devdetail-csp#oem)
</dt> <dd> <dl> <dt>
