...
Le **\_ PassportForWork MDM** est utilisé pour approvisionner Windows Hello entreprise.
...
Spécifie l’ID de locataire sous la forme d’un identificateur global unique (GUID) sans accolades ({,}), qui sera utilisé dans le cadre de l’approvisionnement et de la gestion de Windows Hello entreprise.
