...
---
# <a name="display-functions-in-active-directory-domain-services"></a>Afficher les fonctions dans Active Directory Domain Services

Les fonctions suivantes fonctionnent avec les fonctionnalités d’affichage fournies dans Active Directory Domain Services :
