...
description: Cette rubrique contient un exemple de code qui montre comment ajouter un groupe ou un utilisateur de domaine à un groupe local sur un serveur membre ou sur un ordinateur qui exécute Windows NT Workstation ou Windows 2000 professionnel.
...
ms.locfileid: "103671322"
---
# <a name="example-code-for-adding-a-domain-user-or-group-to-a-local-group"></a><span data-ttu-id="cfbf2-104">Exemple de code pour l’ajout d’un groupe ou d’un utilisateur de domaine à un groupe local</span><span class="sxs-lookup"><span data-stu-id="cfbf2-104">Example Code for Adding a Domain User or Group to a Local Group</span></span>

<span data-ttu-id="cfbf2-105">L’exemple de code C++ suivant ajoute un utilisateur ou un groupe de domaine à un groupe local sur un serveur membre ou sur un ordinateur qui exécute Windows NT Workstation ou Windows 2000 professionnel.</span><span class="sxs-lookup"><span data-stu-id="cfbf2-105">The following C++ code example adds a domain user or group to a local group on a member server or a computer running on Windows NT Workstation or Windows 2000 Professional.</span></span>
