---
title: Exemple de code pour étendre le schéma par programme
description: Cette rubrique contient un exemple de code C++ qui étend par programmation le schéma Active Directory.
ms.assetid: e84678c5-ac12-424b-ba6c-c6cba23e4ff6
ms.tgt_platform: multiple
keywords:
- Exemple de code pour étendre le schéma Active Directory par programmation
...
---
# <a name="example-code-for-extending-the-schema-programmatically"></a><span data-ttu-id="c073b-105">Exemple de code pour étendre le schéma par programme</span><span class="sxs-lookup"><span data-stu-id="c073b-105">Example Code for Extending the Schema Programmatically</span></span>

<span data-ttu-id="c073b-106">Cette rubrique contient un exemple de code C++ qui étend par programmation le schéma Active Directory.</span><span class="sxs-lookup"><span data-stu-id="c073b-106">This topic includes a C++ code example that programmatically extends the Active Directory Schema.</span></span>
