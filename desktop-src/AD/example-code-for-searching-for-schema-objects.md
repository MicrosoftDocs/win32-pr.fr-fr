...
ms.locfileid: "118190259"
---
# <a name="example-code-for-searching-for-schema-objects"></a>Exemple de code pour la recherche d’objets de schéma

Cette rubrique contient un exemple de code utilisé pour rechercher des objets de schéma.

L’exemple de code C++ suivant montre comment rechercher des objets de schéma dont les bits sont définis dans l’attribut **systemFlags** .
...
L’exemple de code C et C++ suivant montre comment rechercher des objets de schéma répliqués dans le catalogue global.
...
L’exemple de code C et C++ suivant montre comment rechercher des objets de schéma indexés.
