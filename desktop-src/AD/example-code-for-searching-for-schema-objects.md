---
title: Exemple de code pour la recherche d’objets de schéma
description: Cette rubrique contient un exemple de code utilisé pour rechercher des objets de schéma.
ms.assetid: 539e0127-1355-4606-97bd-49dfafb25f8d
ms.tgt_platform: multiple
keywords:
- Exemple de code pour la recherche d’objets de schéma AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103939635"
---
# <a name="example-code-for-searching-for-schema-objects"></a><span data-ttu-id="12f4d-104">Exemple de code pour la recherche d’objets de schéma</span><span class="sxs-lookup"><span data-stu-id="12f4d-104">Example Code for Searching for Schema Objects</span></span>

<span data-ttu-id="12f4d-105">Cette rubrique contient un exemple de code utilisé pour rechercher des objets de schéma.</span><span class="sxs-lookup"><span data-stu-id="12f4d-105">This topic includes a code example used to search for schema objects.</span></span>

<span data-ttu-id="12f4d-106">L’exemple de code C++ suivant montre comment rechercher des objets de schéma dont les bits sont définis dans l’attribut **systemFlags** .</span><span class="sxs-lookup"><span data-stu-id="12f4d-106">The following C++ code example shows how to search for schema objects that have bits set in the **systemFlags** attribute.</span></span>
...
<span data-ttu-id="12f4d-107">L’exemple de code C et C++ suivant montre comment rechercher des objets de schéma répliqués dans le catalogue global.</span><span class="sxs-lookup"><span data-stu-id="12f4d-107">The following C and C++ code example shows how to search for schema objects replicated to the global catalog.</span></span>
...
<span data-ttu-id="12f4d-108">L’exemple de code C et C++ suivant montre comment rechercher des objets de schéma indexés.</span><span class="sxs-lookup"><span data-stu-id="12f4d-108">The following C and C++ code example shows how to search for indexed schema objects.</span></span>
