---
title: Exemple de code pour l’énumération des groupes locaux
description: Cette rubrique contient un exemple de code qui énumère tous les objets d’une classe spécifiée.
ms.assetid: d113d132-24cf-4319-826b-0d3d10e432f6
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, énumération de groupes locaux
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103724532"
---
# <a name="example-code-for-enumerating-local-groups"></a><span data-ttu-id="ce4c9-104">Exemple de code pour l’énumération des groupes locaux</span><span class="sxs-lookup"><span data-stu-id="ce4c9-104">Example Code for Enumerating Local Groups</span></span>

<span data-ttu-id="ce4c9-105">Cette rubrique contient un exemple de code qui énumère tous les objets d’une classe spécifiée.</span><span class="sxs-lookup"><span data-stu-id="ce4c9-105">This topic includes a code example that enumerates all objects of a specified class.</span></span>

<span data-ttu-id="ce4c9-106">L’exemple de code C++ suivant énumère tous les objets d’une classe spécifiée à l’aide de l’interface ADSI.</span><span class="sxs-lookup"><span data-stu-id="ce4c9-106">The following C++ code example enumerates all objects of a specified class using ADSI.</span></span>
...
<span data-ttu-id="ce4c9-107">L’exemple de code Visual Basic suivant énumère les groupes locaux à l’aide des interfaces [**IADsContainer**](/windows/desktop/api/iads/nn-iads-iadscontainer) et [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) .</span><span class="sxs-lookup"><span data-stu-id="ce4c9-107">The following Visual Basic code example enumerates local groups using the [**IADsContainer**](/windows/desktop/api/iads/nn-iads-iadscontainer) and [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) interfaces.</span></span>
