---
title: Exemple de code pour la vérification de l’appartenance à un groupe
description: L’exemple de code suivant vérifie l’appartenance absolue d’un objet en vérifiant de manière récursive qu’un objet est membre d’un groupe ou de tout groupe imbriqué dans ce groupe.
...
ms.locfileid: "103671318"
---
# <a name="example-code-for-checking-for-membership-in-a-group"></a><span data-ttu-id="289b3-104">Exemple de code pour la vérification de l’appartenance à un groupe</span><span class="sxs-lookup"><span data-stu-id="289b3-104">Example Code for Checking for Membership in a Group</span></span>

<span data-ttu-id="289b3-105">L’exemple de code suivant vérifie l’appartenance absolue d’un objet en vérifiant de manière récursive qu’un objet est membre d’un groupe ou de tout groupe imbriqué dans ce groupe.</span><span class="sxs-lookup"><span data-stu-id="289b3-105">The following code example verifies absolute membership of an object by recursively verifying that an object is a member of a group or any groups nested in that group.</span></span>
