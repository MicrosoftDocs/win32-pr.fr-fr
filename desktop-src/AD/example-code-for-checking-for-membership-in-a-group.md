...
L’exemple de code suivant vérifie l’appartenance absolue d’un objet en vérifiant de manière récursive qu’un objet est membre d’un groupe ou de tout groupe imbriqué dans ce groupe.
