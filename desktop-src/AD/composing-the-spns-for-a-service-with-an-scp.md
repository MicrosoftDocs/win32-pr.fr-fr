...
ms.locfileid: "104028505"
---
# <a name="composing-the-spns-for-a-service-with-an-scp"></a><span data-ttu-id="b38db-105">Composition des noms de principal du service pour un service avec SCP</span><span class="sxs-lookup"><span data-stu-id="b38db-105">Composing the SPNs for a Service with an SCP</span></span>

<span data-ttu-id="b38db-106">L’exemple de code suivant compose un SPN pour un service qui utilise un point de connexion de service (SCP).</span><span class="sxs-lookup"><span data-stu-id="b38db-106">The following code example composes an SPN for a service that uses a service connection point (SCP).</span></span> <span data-ttu-id="b38db-107">Le SPN retourné a le format suivant.</span><span class="sxs-lookup"><span data-stu-id="b38db-107">The returned SPN has the following format.</span></span>
...
<span data-ttu-id="b38db-108">« &lt; classe de service &gt; » et « &lt; nom &gt; du service » correspondent aux paramètres *pszDNofSCP* et *pszServiceClass* .</span><span class="sxs-lookup"><span data-stu-id="b38db-108">"&lt;service class&gt;" and "&lt;service name&gt;" correspond to the *pszDNofSCP* and *pszServiceClass* parameters.</span></span> <span data-ttu-id="b38db-109">&lt; &gt; la valeur par défaut « Host » est le nom DNS de l’ordinateur local.</span><span class="sxs-lookup"><span data-stu-id="b38db-109">"&lt;host&gt;" defaults to the DNS name of the local computer.</span></span>
