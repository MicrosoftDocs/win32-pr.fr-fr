...
keywords:
- Windows Inscription et résolution des sockets Active Directory, exemple de code, implémentation d’un service Winsock avec une publication RnR
...
ms.locfileid: "118693653"
---
# <a name="example-code-for-implementing-a-winsock-service-with-an-rnr-publication"></a>Exemple de code pour l’implémentation d’un service Winsock avec une publication RnR

L’exemple de code suivant implémente l’exemple de service Winsock avec la publication RnR.

Cet exemple utilise la fonction **serverRegister** définie dans l' [exemple de code pour la publication de la rubrique du point de connexion RNR](example-code-for-publishing-the-rnr-connection-point.md) et la fonction **serverUnregister** définie dans l' [exemple de code pour la suppression de la rubrique du point de connexion RNR](example-code-for-removing-the-rnr-connection-point.md) .
