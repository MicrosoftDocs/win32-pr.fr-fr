---
title: Exemple de code pour l’implémentation d’un service Winsock avec une publication RnR
description: L’exemple de code suivant implémente l’exemple de service Winsock avec la publication RnR.
ms.assetid: 8800ba76-f24c-4aa7-ba31-97eaf884130c
ms.tgt_platform: multiple
keywords:
- Inscription et résolution Windows Sockets Active Directory, exemple de code, implémentation d’un service Winsock avec une publication RnR
- Implémentation d’un service Winsock avec une publication RnR AD, exemple de code
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103671298"
---
# <a name="example-code-for-implementing-a-winsock-service-with-an-rnr-publication"></a><span data-ttu-id="b6f67-105">Exemple de code pour l’implémentation d’un service Winsock avec une publication RnR</span><span class="sxs-lookup"><span data-stu-id="b6f67-105">Example Code for Implementing a Winsock Service with an RnR Publication</span></span>

<span data-ttu-id="b6f67-106">L’exemple de code suivant implémente l’exemple de service Winsock avec la publication RnR.</span><span class="sxs-lookup"><span data-stu-id="b6f67-106">The following code example implements the example Winsock service with RnR publication.</span></span>

<span data-ttu-id="b6f67-107">Cet exemple utilise la fonction **serverRegister** définie dans l' [exemple de code pour la publication de la rubrique du point de connexion RNR](example-code-for-publishing-the-rnr-connection-point.md) et la fonction **serverUnregister** définie dans l' [exemple de code pour la suppression de la rubrique du point de connexion RNR](example-code-for-removing-the-rnr-connection-point.md) .</span><span class="sxs-lookup"><span data-stu-id="b6f67-107">This sample uses the **serverRegister** function defined in the [Example Code for Publishing the RnR Connection Point](example-code-for-publishing-the-rnr-connection-point.md) topic and the **serverUnregister** function defined in the [Example Code for Removing the RnR Connection Point](example-code-for-removing-the-rnr-connection-point.md) topic.</span></span>
