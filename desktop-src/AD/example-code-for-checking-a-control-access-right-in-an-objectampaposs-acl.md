...
L’exemple suivant peut être utilisé pour vérifier que l’utilisateur actuellement connecté dispose d’autorisations pour un droit d’accès de contrôle sur l’objet spécifié.
