...
---
# <a name="example-code-for-deleting-users-on-a-member-server-or-windows-2000-professional"></a>Exemple de code pour la suppression d’utilisateurs sur un serveur membre ou Windows 2000 professionnel
