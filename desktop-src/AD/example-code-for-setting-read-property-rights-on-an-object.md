...
---
# <a name="example-code-for-setting-read-property-rights-on-an-object"></a>Exemple de code pour définir des droits de propriété de lecture sur un objet

L’exemple de code suivant contient une fonction qui crée une entrée du contrôle d’accès (ACE) qui attribue l’accès en lecture à toutes les propriétés de l’objet au tiers de confiance spécifié.
