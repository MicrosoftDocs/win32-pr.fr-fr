---
title: Exemple de code pour définir des droits de propriété de lecture sur un objet
description: L’exemple de code suivant contient une fonction qui crée une entrée du contrôle d’accès (ACE) qui attribue l’accès en lecture à toutes les propriétés de l’objet au tiers de confiance spécifié.
ms.assetid: 343538d7-fef4-492d-a385-37433ce1250b
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, définition des droits de propriété de lecture sur un objet
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103671290"
---
# <a name="example-code-for-setting-read-property-rights-on-an-object"></a><span data-ttu-id="eabe4-104">Exemple de code pour définir des droits de propriété de lecture sur un objet</span><span class="sxs-lookup"><span data-stu-id="eabe4-104">Example Code for Setting Read Property Rights on an Object</span></span>

<span data-ttu-id="eabe4-105">L’exemple de code suivant contient une fonction qui crée une entrée du contrôle d’accès (ACE) qui attribue l’accès en lecture à toutes les propriétés de l’objet au tiers de confiance spécifié.</span><span class="sxs-lookup"><span data-stu-id="eabe4-105">The following code example contains a function that creates an ACE that assigns read access to all properties of the object to the specified trustee.</span></span>
