---
title: Exemple de code pour la création d’un utilisateur
description: Cette rubrique contient des exemples de code qui créent un utilisateur dans un domaine contrôlé par Active Directory Domain Services.
...
ms.locfileid: "104028618"
---
# <a name="example-code-for-creating-a-user"></a><span data-ttu-id="07b03-104">Exemple de code pour la création d’un utilisateur</span><span class="sxs-lookup"><span data-stu-id="07b03-104">Example Code for Creating a User</span></span>

<span data-ttu-id="07b03-105">Cette rubrique contient des exemples de code qui créent un utilisateur dans un domaine contrôlé par Active Directory Domain Services.</span><span class="sxs-lookup"><span data-stu-id="07b03-105">This topic includes code examples that create a user in a domain controlled by Active Directory Domain Services.</span></span>
