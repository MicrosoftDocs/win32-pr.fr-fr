...
ms.locfileid: "118962448"
---
# <a name="example-code-for-creating-a-class"></a>Exemple de code pour la création d’une classe

L’exemple de code C et C++ suivant montre comment créer un objet [**classSchema**](/windows/desktop/ADSchema/c-classschema) dans le cache ADSI.

L’exemple de fonction **CreateClass** montre comment créer l’objet [**classSchema**](/windows/desktop/ADSchema/c-classschema) et retourne un pointeur [**IADs**](/windows/desktop/api/iads/nn-iads-iads) vers le nouvel objet. Sachez que **CreateClass** n’appelle pas [**IADs :: setinfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) pour valider le nouvel objet **classSchema** dans le répertoire. L’appelant doit effectuer l’appel à l’aide du pointeur retourné.

L’exemple de code **BytesToVariantArray** suivant illustre une fonction utilitaire qui compresse une chaîne d’octets dans un tableau de variants.
