---
title: Script VB répertoriant tous les points de connexion de service
ms.assetid: 7a76f872-3e4e-4bb7-8f2d-e30b1246369f
ms.tgt_platform: multiple
description: 'En savoir plus sur : script VB répertoriant tous les points de connexion de service'
ms.topic: article
ms.date: 05/31/2018
topic_type:
- kbArticle
...
ms.locfileid: "104483001"
---
# <a name="vb-script-listing-all-service-connection-points"></a><span data-ttu-id="51160-103">Script VB répertoriant tous les points de connexion de service</span><span class="sxs-lookup"><span data-stu-id="51160-103">VB Script Listing all Service Connection Points</span></span>

<span data-ttu-id="51160-104">Les points de connexion de service peuvent être gérés à l’aide d’un script VB.</span><span class="sxs-lookup"><span data-stu-id="51160-104">Service Connection Points can be managed using VB Script.</span></span> <span data-ttu-id="51160-105">L’exemple de code suivant montre comment répertorier tous les points de connexion de service sur le nom de domaine fourni sur la ligne de commande :</span><span class="sxs-lookup"><span data-stu-id="51160-105">The following sample code shows how to list all Service Connection Points on the domain name provided on the command line:</span></span>
