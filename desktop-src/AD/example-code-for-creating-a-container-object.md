...
---
# <a name="example-code-for-creating-a-container-object"></a>Exemple de code pour la création d’un objet conteneur

L’exemple de code suivant crée deux objets. Tout d’abord, un objet conteneur et, deuxièmement, un objet de sous-conteneur. Une valeur pour l’objet de sous-conteneur est ajoutée à la propriété [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) de l’objet conteneur. L’exemple de code est lié à l’objet de sous-conteneur à l’aide de la liaison WKGUID et affiche son ADsPath. Il renomme ensuite l’objet de sous-conteneur et se lie de nouveau à l’aide de la même liaison WKGUID.
