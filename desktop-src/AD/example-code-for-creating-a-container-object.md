---
title: Exemple de code pour la création d’un objet conteneur
description: L’exemple de code suivant crée deux objets.
ms.assetid: bd9a8d62-c8e8-4ee5-86d8-bda5ddeb6e2c
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, création d’un objet conteneur
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103940827"
---
# <a name="example-code-for-creating-a-container-object"></a><span data-ttu-id="a24e2-104">Exemple de code pour la création d’un objet conteneur</span><span class="sxs-lookup"><span data-stu-id="a24e2-104">Example Code for Creating a Container Object</span></span>

<span data-ttu-id="a24e2-105">L’exemple de code suivant crée deux objets.</span><span class="sxs-lookup"><span data-stu-id="a24e2-105">The following code example creates two objects.</span></span> <span data-ttu-id="a24e2-106">Tout d’abord, un objet conteneur et, deuxièmement, un objet de sous-conteneur.</span><span class="sxs-lookup"><span data-stu-id="a24e2-106">First, a container object and, second, a sub-container object.</span></span> <span data-ttu-id="a24e2-107">Une valeur pour l’objet de sous-conteneur est ajoutée à la propriété [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) de l’objet conteneur.</span><span class="sxs-lookup"><span data-stu-id="a24e2-107">A value for the sub-container object is added to the [**otherWellKnownObjects**](/windows/desktop/ADSchema/a-otherwellknownobjects) property of the container object.</span></span> <span data-ttu-id="a24e2-108">L’exemple de code est lié à l’objet de sous-conteneur à l’aide de la liaison WKGUID et affiche son ADsPath.</span><span class="sxs-lookup"><span data-stu-id="a24e2-108">The code example binds to the sub-container object using the WKGUID binding and displays its ADsPath.</span></span> <span data-ttu-id="a24e2-109">Il renomme ensuite l’objet de sous-conteneur et se lie de nouveau à l’aide de la même liaison WKGUID.</span><span class="sxs-lookup"><span data-stu-id="a24e2-109">It then renames the sub-container object and binds again using the same WKGUID binding.</span></span>
