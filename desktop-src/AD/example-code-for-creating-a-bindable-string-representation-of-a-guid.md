...
---
# <a name="example-code-for-creating-a-bindable-string-representation-of-a-guid"></a><span data-ttu-id="b61a3-104">Exemple de code pour la création d’une représentation sous forme de chaîne pouvant être liée d’un GUID</span><span class="sxs-lookup"><span data-stu-id="b61a3-104">Example Code for Creating a Bindable String Representation of a GUID</span></span>

<span data-ttu-id="b61a3-105">L’exemple de code suivant peut être utilisé pour retourner une représentation sous forme de chaîne d’un GUID qui peut être utilisé pour effectuer une liaison à l’objet.</span><span class="sxs-lookup"><span data-stu-id="b61a3-105">The following code example can be used to return a string representation of a GUID that can be used to bind to the object.</span></span>
