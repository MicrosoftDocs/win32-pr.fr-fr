...
---
# <a name="example-code-for-removing-the-rnr-connection-point"></a><span data-ttu-id="2574f-106">Exemple de code pour la suppression du point de connexion RnR</span><span class="sxs-lookup"><span data-stu-id="2574f-106">Example Code for Removing the RnR Connection Point</span></span>

<span data-ttu-id="2574f-107">L’exemple de code suivant est utilisé par l’exemple de code du service Winsock pour annuler l’inscription du point de connexion RnR pour le service.</span><span class="sxs-lookup"><span data-stu-id="2574f-107">The following code example is used by the Winsock service code example to unregister the RnR connection point for the service.</span></span>
