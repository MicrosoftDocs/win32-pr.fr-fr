...
Dans Windows 2000, un domaine peut s’exécuter en deux modes d’opération : mixte et natif. Le mode mixte doit être utilisé pour inclure les contrôleurs de domaine exécutant Windows NT 4,0 dans un domaine Windows 2000. Le mode mixte ne prend pas en charge les groupes universels ni les groupes imbriqués. Si tous les contrôleurs de domaine du domaine exécutent Windows 2000, vous pouvez utiliser le mode natif.
