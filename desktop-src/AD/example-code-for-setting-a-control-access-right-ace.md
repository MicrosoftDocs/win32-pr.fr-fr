---
title: Exemple de code pour la définition d’un ACE droit d’accès au contrôle
description: L’exemple de code C/C++ suivant ajoute un ACE pour un droit d’accès de contrôle à la liste de contrôle d’accès d’un objet.
ms.assetid: 8fb5eb47-27ca-4e60-ad39-ca4392da4e7d
ms.tgt_platform: multiple
keywords:
- Exemple de code pour la définition d’une entrée de contrôle d’accès ACE Right Access
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104190760"
---
# <a name="example-code-for-setting-a-control-access-right-ace"></a><span data-ttu-id="37a59-104">Exemple de code pour la définition d’un ACE droit d’accès au contrôle</span><span class="sxs-lookup"><span data-stu-id="37a59-104">Example Code for Setting a Control Access Right ACE</span></span>

<span data-ttu-id="37a59-105">L’exemple de code C/C++ suivant ajoute un ACE pour un droit d’accès de contrôle à la liste de contrôle d’accès d’un objet.</span><span class="sxs-lookup"><span data-stu-id="37a59-105">The following C/C++ code example adds an ACE for a control access right to the ACL of an object.</span></span>
