...
---
# <a name="example-code-for-binding-to-well-known-objects"></a><span data-ttu-id="2aaa3-104">Exemple de code pour la liaison à des objets bien connus</span><span class="sxs-lookup"><span data-stu-id="2aaa3-104">Example Code for Binding to Well Known Objects</span></span>

<span data-ttu-id="2aaa3-105">L’exemple de code C++ suivant montre comment effectuer une liaison à un objet connu à l’aide de la chaîne de liaison WKGUID.</span><span class="sxs-lookup"><span data-stu-id="2aaa3-105">The following C++ code example shows how to bind to a well-known object using the WKGUID binding string.</span></span>
