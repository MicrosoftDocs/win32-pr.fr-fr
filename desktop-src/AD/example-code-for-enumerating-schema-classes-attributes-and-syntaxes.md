---
title: Exemple de code pour l’énumération des classes de schéma, des attributs et des syntaxes
description: Exemples de code qui énumèrent les classes de schéma, les attributs et les syntaxes.
ms.assetid: fca0b723-4582-4fe3-933d-b56c016fd324
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, énumération de classes de schéma, d’attributs et de syntaxes
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028613"
---
# <a name="example-code-for-enumerating-schema-classes-attributes-and-syntaxes"></a><span data-ttu-id="fc411-104">Exemple de code pour l’énumération des classes de schéma, des attributs et des syntaxes</span><span class="sxs-lookup"><span data-stu-id="fc411-104">Example Code for Enumerating Schema Classes, Attributes, and Syntaxes</span></span>

<span data-ttu-id="fc411-105">L’exemple C++ suivant montre comment énumérer les classes, les attributs et les syntaxes dans le schéma abstrait.</span><span class="sxs-lookup"><span data-stu-id="fc411-105">The following C++ example shows how to enumerate the classes, attributes, and syntaxes in the abstract schema.</span></span>
...
<span data-ttu-id="fc411-106">L’exemple de code Visual Basic suivant lit le schéma abstrait pour énumérer les classes d’objets structurelles, abstraites et auxiliaires.</span><span class="sxs-lookup"><span data-stu-id="fc411-106">The following Visual Basic code example reads the abstract schema to enumerate the structural, abstract, and auxiliary object classes.</span></span> <span data-ttu-id="fc411-107">L’exemple énumère ensuite les classes d’attributs à valeur unique et à valeurs multiples.</span><span class="sxs-lookup"><span data-stu-id="fc411-107">The example then enumerates the single-valued and multi-valued attribute classes.</span></span>
