---
title: Exemple de code pour l’utilisation du catalogue global pour rechercher des utilisateurs dans une forêt
description: Cette rubrique contient des exemples de code utilisés pour rechercher des utilisateurs dans une forêt.
...
---
# <a name="example-code-for-using-the-global-catalog-to-find-users-in-a-forest"></a><span data-ttu-id="49db4-104">Exemple de code pour l’utilisation du catalogue global pour rechercher des utilisateurs dans une forêt</span><span class="sxs-lookup"><span data-stu-id="49db4-104">Example Code for Using the Global Catalog to Find Users in a Forest</span></span>

<span data-ttu-id="49db4-105">Cette rubrique contient des exemples de code utilisés pour rechercher des utilisateurs dans une forêt.</span><span class="sxs-lookup"><span data-stu-id="49db4-105">This topic includes code examples used to search for users in a forest.</span></span>

<span data-ttu-id="49db4-106">L’exemple de code Visual Basic suivant montre comment utiliser ADSI pour rechercher des utilisateurs dans une forêt.</span><span class="sxs-lookup"><span data-stu-id="49db4-106">The following Visual Basic code example shows how to use ADSI to search for users in a forest.</span></span>
...
<span data-ttu-id="49db4-107">L’exemple de code C++ suivant utilise ADSI pour rechercher des utilisateurs dans une forêt.</span><span class="sxs-lookup"><span data-stu-id="49db4-107">The following C++ code example uses ADSI to search for users in a forest.</span></span>
