---
title: Exemple de code pour la vérification d’un droit d’accès aux contrôles dans une entrée du contrôle d’accès
description: L’exemple de code C++ suivant vérifie un droit d’accès au contrôle spécifié dans une entrée du contrôle d’accès de l’objet spécifié.
ms.assetid: 03a96c99-eefb-4de5-a4ab-526eca7875cc
ms.tgt_platform: multiple
keywords:
- Exemple de code pour la vérification d’un droit d’accès aux contrôles dans une entrée du contrôle d’accès
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028621"
---
# <a name="example-code-for-checking-for-a-control-access-right-in-an-ace"></a><span data-ttu-id="8b630-104">Exemple de code pour la vérification d’un droit d’accès aux contrôles dans une entrée du contrôle d’accès</span><span class="sxs-lookup"><span data-stu-id="8b630-104">Example Code for Checking for a Control Access Right in an ACE</span></span>

<span data-ttu-id="8b630-105">L’exemple de code C++ suivant vérifie un droit d’accès au contrôle spécifié dans une entrée du contrôle d’accès de l’objet spécifié.</span><span class="sxs-lookup"><span data-stu-id="8b630-105">The following C++ code example verifies a specified control access right in an ACE in the ACL of the specified object.</span></span>
