---
title: Exemple de code pour la création d’un descripteur de sécurité
description: Cette rubrique contient un exemple de code Visual Basic qui vous montre comment créer un objet de descripteur de sécurité pour un objet ADSI.
...
ms.locfileid: "104462031"
---
# <a name="example-code-for-creating-a-security-descriptor"></a><span data-ttu-id="5764a-104">Exemple de code pour la création d’un descripteur de sécurité</span><span class="sxs-lookup"><span data-stu-id="5764a-104">Example Code for Creating a Security Descriptor</span></span>

<span data-ttu-id="5764a-105">Cette rubrique contient un exemple de code Visual Basic qui vous montre comment créer un objet de descripteur de sécurité pour un objet ADSI.</span><span class="sxs-lookup"><span data-stu-id="5764a-105">This topic includes a Visual Basic code example that shows you how to create a security descriptor object for an ADSI object.</span></span>
