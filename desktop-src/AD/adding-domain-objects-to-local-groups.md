...
Lorsque vous gérez des groupes locaux de domaine sur un domaine Windows 2000 à l’aide d’ADSI, le fournisseur LDAP est normalement utilisé. Toutefois, lorsque vous gérez des groupes locaux sur des serveurs membres et un ordinateur exécutant Windows 2000 professionnel, le fournisseur Winnt doit être utilisé.

Seuls les groupes locaux peuvent être créés sur les serveurs membres et Windows 2000 professionnel. Toutefois, les groupes locaux peuvent contenir :
