...
ms.locfileid: "118693958"
---
# <a name="example-code-for-displaying-members-of-a-group"></a>Exemple de code pour afficher les membres d’un groupe

Cette rubrique contient des exemples de code qui affichent les membres d’un groupe.

L’exemple de code C++ suivant utilise les classes [**IADsGroup**](/windows/desktop/api/iads/nn-iads-iadsgroup) et [**IADsMembers**](/windows/desktop/api/iads/nn-iads-iadsmembers) pour afficher les membres d’un groupe.
...
l’exemple de code Visual Basic suivant utilise la classe [**IADs**](/windows/desktop/api/iads/nn-iads-iads) pour afficher les membres du groupe.
