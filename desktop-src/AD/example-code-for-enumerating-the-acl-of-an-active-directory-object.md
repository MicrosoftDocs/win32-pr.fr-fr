---
title: Exemple de code pour l’énumération de la liste de contrôle d’accès d’un objet dans Active Directory Domain Services
description: Les exemples de code suivants peuvent être utilisés pour énumérer la liste de contrôle d’accès (ACL) d’un objet dans Active Directory Domain Services.
ms.assetid: 3629ffde-c516-4566-8b40-a913b8355656
ms.tgt_platform: multiple
keywords:
- Exemple de code pour l’énumération de la liste de contrôle d’accès d’un objet Active Directory AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028612"
---
# <a name="example-code-for-enumerating-the-acl-of-an-object-in-active-directory-domain-services"></a><span data-ttu-id="f5042-104">Exemple de code pour l’énumération de la liste de contrôle d’accès d’un objet dans Active Directory Domain Services</span><span class="sxs-lookup"><span data-stu-id="f5042-104">Example Code for Enumerating the ACL of an Object in Active Directory Domain Services</span></span>

<span data-ttu-id="f5042-105">Les exemples de code suivants peuvent être utilisés pour énumérer la liste de contrôle d’accès (ACL) d’un objet dans Active Directory Domain Services.</span><span class="sxs-lookup"><span data-stu-id="f5042-105">The following code examples can be used to enumerate the access control list (ACL) of an object in Active Directory Domain Services.</span></span>

<span data-ttu-id="f5042-106">L’exemple de code suivant montre une fonction qui énumère les approbations d’un objet.</span><span class="sxs-lookup"><span data-stu-id="f5042-106">The following code example shows a function that enumerates the trustees of an object .</span></span>
...
<span data-ttu-id="f5042-107">L’exemple de code suivant montre une fonction qui énumère les approbations d’un objet.</span><span class="sxs-lookup"><span data-stu-id="f5042-107">The following code example shows a function that enumerates the trustees of an object.</span></span>
