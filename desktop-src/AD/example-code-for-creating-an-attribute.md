...
---
# <a name="example-code-for-creating-an-attribute"></a>Exemple de code pour la création d’un attribut

L’exemple de code suivant crée un objet [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) dans le conteneur de schéma.

La fonction **CreateAttribute** crée un objet [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) dans le conteneur de schéma, mais ne la valide pas dans le répertoire. Appelez la méthode [**IADs. setinfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) pour valider le nouvel objet **attributeSchema** dans le répertoire.

La fonction **BytesToVariantArray** est une fonction utilitaire qui compresse une chaîne d’octets dans un tableau de variants.
