---
title: Exemple de code pour la création d’un attribut
description: L’exemple de code suivant crée un objet attributeSchema dans le conteneur de schéma.
ms.assetid: 5f679a88-29d1-44ec-918b-091522188ae9
ms.tgt_platform: multiple
keywords:
- Exemple de code pour la création d’un attribut AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104462871"
---
# <a name="example-code-for-creating-an-attribute"></a><span data-ttu-id="a7a8d-104">Exemple de code pour la création d’un attribut</span><span class="sxs-lookup"><span data-stu-id="a7a8d-104">Example Code for Creating an Attribute</span></span>

<span data-ttu-id="a7a8d-105">L’exemple de code suivant crée un objet [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) dans le conteneur de schéma.</span><span class="sxs-lookup"><span data-stu-id="a7a8d-105">The following code example creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container.</span></span>

<span data-ttu-id="a7a8d-106">La fonction **CreateAttribute** crée un objet [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) dans le conteneur de schéma, mais ne la valide pas dans le répertoire.</span><span class="sxs-lookup"><span data-stu-id="a7a8d-106">The **CreateAttribute** function creates an [**attributeSchema**](/windows/desktop/ADSchema/c-attributeschema) object in the schema container, but does not commit it to the directory.</span></span> <span data-ttu-id="a7a8d-107">Appelez la méthode [**IADs. setinfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) pour valider le nouvel objet **attributeSchema** dans le répertoire.</span><span class="sxs-lookup"><span data-stu-id="a7a8d-107">Call the [**IADs.SetInfo**](/windows/desktop/api/iads/nf-iads-iads-setinfo) method to commit the new **attributeSchema** object to the directory.</span></span>

<span data-ttu-id="a7a8d-108">La fonction **BytesToVariantArray** est une fonction utilitaire qui compresse une chaîne d’octets dans un tableau de variants.</span><span class="sxs-lookup"><span data-stu-id="a7a8d-108">The **BytesToVariantArray** function is a utility function that packs an octet string into a variant array.</span></span>
