...
description: Pour plus d’informations sur les groupes dans Active Directory Domain Services, consultez Présentation des groupes.
...
Cette section contient des rubriques sur l’utilisation des groupes dans Active Directory Domain Services :

-   [Objets de groupe](group-objects.md)
-   [Utilisation des groupes de sécurité dans les Access Control](how-security-groups-are-used-in-access-control.md)
-   [Création de groupes dans un domaine](creating-groups-in-a-domain.md)
-   [Ajout de membres à des groupes dans un domaine](adding-members-to-groups-in-a-domain.md)
-   [Suppression de membres de groupes dans un domaine](removing-members-from-groups-in-a-domain.md)
-   [Imbrication d’un groupe dans un autre groupe](nesting-a-group-in-another-group.md)
-   [Détermination de l’appartenance d’un utilisateur ou d’un groupe à un groupe](determining-a-userampaposs-or-groupampaposs-membership-in-a-group.md)
-   [Énumération des groupes](enumerating-groups.md)
-   [Interrogation de groupes dans un domaine](querying-for-groups-in-a-domain.md)
-   [Modification de l’étendue ou du type d’un groupe](changing-a-groupampaposs-scope-or-type.md)
