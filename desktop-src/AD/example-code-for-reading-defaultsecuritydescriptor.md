---
title: Exemple de code pour la lecture de defaultSecurityDescriptor
description: L’exemple de code suivant lit le defaultSecurityDescriptor pour une classe d’objets spécifiée.
ms.assetid: 9462686d-654b-40bb-be10-80ca03790ad5
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, lecture defaultSecurityDescriptor
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103839326"
---
# <a name="example-code-for-reading-defaultsecuritydescriptor"></a><span data-ttu-id="b3c6f-104">Exemple de code pour la lecture de defaultSecurityDescriptor</span><span class="sxs-lookup"><span data-stu-id="b3c6f-104">Example Code for Reading defaultSecurityDescriptor</span></span>

<span data-ttu-id="b3c6f-105">L’exemple de code suivant lit le **defaultSecurityDescriptor** pour une classe d’objets spécifiée.</span><span class="sxs-lookup"><span data-stu-id="b3c6f-105">The following code example reads the **defaultSecurityDescriptor** for a specified object class.</span></span>
