...
---
# <a name="example-code-for-reading-defaultsecuritydescriptor"></a>Exemple de code pour la lecture de defaultSecurityDescriptor

L’exemple de code suivant lit le **defaultSecurityDescriptor** pour une classe d’objets spécifiée.
