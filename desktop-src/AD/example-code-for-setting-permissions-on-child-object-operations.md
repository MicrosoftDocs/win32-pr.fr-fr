---
title: Exemple de code pour la définition d’autorisations sur les opérations d’objets enfants
description: L’exemple de code C et C++ suivant crée une entrée du contrôle d’accès qui attribue des droits de création pour les objets utilisateur au tiers de confiance spécifié.
ms.assetid: 51010092-fa85-4f9c-8869-97fed30acc7f
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, définition d’autorisations sur des opérations d’objets enfants
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103839322"
---
# <a name="example-code-for-setting-permissions-on-child-object-operations"></a><span data-ttu-id="c4039-104">Exemple de code pour la définition d’autorisations sur les opérations d’objets enfants</span><span class="sxs-lookup"><span data-stu-id="c4039-104">Example Code for Setting Permissions on Child Object Operations</span></span>

<span data-ttu-id="c4039-105">L’exemple de code C et C++ suivant crée une entrée du contrôle d’accès qui attribue des droits de création pour les objets utilisateur au tiers de confiance spécifié.</span><span class="sxs-lookup"><span data-stu-id="c4039-105">The following C and C++ code example creates an ACE that assigns creation rights for user objects to the specified trustee.</span></span>
