...
ms.locfileid: "118190087"
---
# <a name="example-code-for-setting-permissions-on-child-object-operations"></a>Exemple de code pour la définition d’autorisations sur les opérations d’objets enfants

L’exemple de code C et C++ suivant crée une entrée du contrôle d’accès qui attribue des droits de création pour les objets utilisateur au tiers de confiance spécifié.
