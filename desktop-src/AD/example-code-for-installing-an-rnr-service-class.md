---
title: Exemple de code pour l’installation d’une classe de service RnR
description: Le programme suivant installe une classe de service RnR.
ms.assetid: 85605ecf-bc82-48ac-8b36-ee43862a3bc9
ms.tgt_platform: multiple
keywords:
- Inscription et résolution Windows Sockets Active Directory, exemple de code, installation d’une classe de service RnR
- Installation d’une classe de service RnR AD, exemple de code
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104190764"
---
# <a name="example-code-for-installing-an-rnr-service-class"></a><span data-ttu-id="d65b8-105">Exemple de code pour l’installation d’une classe de service RnR</span><span class="sxs-lookup"><span data-stu-id="d65b8-105">Example Code for Installing an RnR Service Class</span></span>

<span data-ttu-id="d65b8-106">Le programme suivant installe une classe de service RnR.</span><span class="sxs-lookup"><span data-stu-id="d65b8-106">The following program installs an RnR Service class.</span></span>
