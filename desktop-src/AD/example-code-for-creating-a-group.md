...
ms.locfileid: "118190812"
---
# <a name="example-code-for-creating-a-group"></a>Exemple de code pour la création d’un groupe

L’exemple de code C++ suivant contient une fonction qui crée un groupe avec uniquement les propriétés essentielles explicitement définies (**CN**, **samAccountType**, **GroupType**) et ne contenant aucun membre.
...
l’exemple de code Visual Basic suivant crée un groupe avec uniquement les propriétés essentielles explicitement définies (**cn**, **sAMAccountType**, **groupType**) et ne contenant aucun membre.
