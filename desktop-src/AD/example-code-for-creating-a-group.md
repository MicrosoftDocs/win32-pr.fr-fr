---
title: Exemple de code pour la création d’un groupe
description: Cette rubrique contient un exemple de code qui crée un groupe.
ms.assetid: f6bba6fc-fec2-4dd9-b7f2-da7782a6caa5
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, création d’un groupe
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104462034"
---
# <a name="example-code-for-creating-a-group"></a><span data-ttu-id="fa886-104">Exemple de code pour la création d’un groupe</span><span class="sxs-lookup"><span data-stu-id="fa886-104">Example Code for Creating a Group</span></span>

<span data-ttu-id="fa886-105">L’exemple de code C++ suivant contient une fonction qui crée un groupe avec uniquement les propriétés essentielles explicitement définies (**CN**, **samAccountType**, **GroupType**) et ne contenant aucun membre.</span><span class="sxs-lookup"><span data-stu-id="fa886-105">The following C++ code example contains a function that creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
...
<span data-ttu-id="fa886-106">L’exemple de code Visual Basic suivant crée un groupe avec uniquement les propriétés essentielles explicitement définies (**CN**, **samAccountType**, **GroupType**) et ne contenant aucun membre.</span><span class="sxs-lookup"><span data-stu-id="fa886-106">The following Visual Basic code example creates a group with only the essential properties explicitly set (**cn**, **sAMAccountType**, **groupType**) and containing no members.</span></span>
