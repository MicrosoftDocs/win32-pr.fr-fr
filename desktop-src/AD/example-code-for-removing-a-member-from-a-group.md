...
---
# <a name="example-code-for-removing-a-member-from-a-group"></a>Exemple de code pour la suppression d’un membre d’un groupe

L’exemple de code suivant contient une fonction qui supprime un membre d’un groupe.
