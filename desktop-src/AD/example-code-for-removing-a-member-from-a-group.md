---
title: Exemple de code pour la suppression d’un membre d’un groupe
description: L’exemple de code suivant contient une fonction qui supprime un membre d’un groupe.
ms.assetid: 8a9c65bb-1b61-432b-9ef4-1d257c501026
ms.tgt_platform: multiple
keywords:
- Active Directory exemples Active Directory, suppression d’un membre d’un groupe
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106509574"
---
# <a name="example-code-for-removing-a-member-from-a-group"></a><span data-ttu-id="6f0bd-104">Exemple de code pour la suppression d’un membre d’un groupe</span><span class="sxs-lookup"><span data-stu-id="6f0bd-104">Example Code for Removing a Member from a Group</span></span>

<span data-ttu-id="6f0bd-105">L’exemple de code suivant contient une fonction qui supprime un membre d’un groupe.</span><span class="sxs-lookup"><span data-stu-id="6f0bd-105">The following code example contains a function that removes a member from a group.</span></span>
