---
title: Exemple de code pour la création d’une partition d’annuaire d’applications
description: Cette rubrique contient des exemples de code qui créent une partition d’annuaire d’applications.
ms.assetid: dc538afc-8529-42cf-a276-a4579d555557
ms.tgt_platform: multiple
keywords:
- exemple de code pour la création d’une partition d’annuaire d’applications Active Directory
...
---
# <a name="example-code-for-creating-an-application-directory-partition"></a><span data-ttu-id="fabab-105">Exemple de code pour la création d’une partition d’annuaire d’applications</span><span class="sxs-lookup"><span data-stu-id="fabab-105">Example Code for Creating an Application Directory Partition</span></span>

<span data-ttu-id="fabab-106">L’exemple de code C++ suivant crée une nouvelle partition d’annuaire d’applications à l’aide d’ADSI.</span><span class="sxs-lookup"><span data-stu-id="fabab-106">The following C++ code example creates a new application directory partition using ADSI.</span></span>
...
<span data-ttu-id="fabab-107">L’exemple de code Visual Basic Scripting Edition suivant montre comment créer une nouvelle partition d’annuaire d’applications à l’aide d’ADSI.</span><span class="sxs-lookup"><span data-stu-id="fabab-107">The following Visual Basic Scripting Edition code example shows how to create a new application directory partition using ADSI.</span></span>
...
<span data-ttu-id="fabab-108">L’exemple de code Visual Basic .NET suivant montre comment créer une nouvelle partition d’annuaire d’applications à l’aide de [System. DirectoryServices](/dotnet/api/system.directoryservices).</span><span class="sxs-lookup"><span data-stu-id="fabab-108">The following Visual Basic .NET code example shows how to create a new application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span>
...
<span data-ttu-id="fabab-109">L’exemple de code C# suivant montre comment créer une nouvelle partition d’annuaire d’applications à l’aide de [System. DirectoryServices](/dotnet/api/system.directoryservices).</span><span class="sxs-lookup"><span data-stu-id="fabab-109">The following C# code example shows how to create a new application directory partition using [System.DirectoryServices](/dotnet/api/system.directoryservices).</span></span>
