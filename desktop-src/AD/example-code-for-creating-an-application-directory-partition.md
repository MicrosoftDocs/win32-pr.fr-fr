...
L’exemple de code C++ suivant crée une nouvelle partition d’annuaire d’applications à l’aide d’ADSI.
...
L’exemple de code C# suivant montre comment créer une nouvelle partition d’annuaire d’applications à l’aide de [System. DirectoryServices](/dotnet/api/system.directoryservices).
