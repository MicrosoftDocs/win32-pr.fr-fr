...
Cette rubrique contient un exemple de code qui lit la propriété **ntMixedDomain** d’un domaine et détermine le mode d’opération.

L’exemple de code C++ suivant lit la propriété **ntMixedDomain** d’un domaine et détermine le mode d’opération.
