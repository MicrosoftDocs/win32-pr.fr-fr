---
title: Exemple de code pour déterminer le mode d’opération
description: Cette rubrique contient un exemple de code qui lit la propriété ntMixedDomain d’un domaine et détermine le mode d’opération.
...
---
# <a name="example-code-for-determining-the-operation-mode"></a><span data-ttu-id="1e933-104">Exemple de code pour déterminer le mode d’opération</span><span class="sxs-lookup"><span data-stu-id="1e933-104">Example Code for Determining the Operation Mode</span></span>

<span data-ttu-id="1e933-105">Cette rubrique contient un exemple de code qui lit la propriété **ntMixedDomain** d’un domaine et détermine le mode d’opération.</span><span class="sxs-lookup"><span data-stu-id="1e933-105">This topic includes a code example that reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>

<span data-ttu-id="1e933-106">L’exemple de code C++ suivant lit la propriété **ntMixedDomain** d’un domaine et détermine le mode d’opération.</span><span class="sxs-lookup"><span data-stu-id="1e933-106">The following C++ code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
...
<span data-ttu-id="1e933-107">L’exemple de code Visual Basic suivant lit la propriété **ntMixedDomain** d’un domaine et détermine le mode d’opération.</span><span class="sxs-lookup"><span data-stu-id="1e933-107">The following Visual Basic code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
...
<span data-ttu-id="1e933-108">L’exemple de code Visual Basic Scripting Edition suivant lit la propriété **ntMixedDomain** d’un domaine et détermine le mode d’opération.</span><span class="sxs-lookup"><span data-stu-id="1e933-108">The following Visual Basic Scripting Edition code example reads the **ntMixedDomain** property of a domain and determines the operation mode.</span></span>
