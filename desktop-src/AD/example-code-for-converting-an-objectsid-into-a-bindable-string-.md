...
ms.locfileid: "118191089"
---
# <a name="example-code-for-converting-an-objectsid-into-a-bindable-string"></a>Exemple de code pour la conversion d’un objectSid en chaîne pouvant être liée

Cette rubrique contient un exemple de code qui convertit un **objectSID** en chaîne pouvant être liée pour ajouter un membre qui appartient à un domaine de niveau supérieur à un groupe dans un domaine de niveau supérieur.

L’exemple de code C++ suivant montre comment convertir un **objectSID** en chaîne pouvant être liée.
