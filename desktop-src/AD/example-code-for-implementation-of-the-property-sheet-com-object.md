---
title: Exemple de code pour l’implémentation de l’objet COM de la feuille de propriétés
description: L’exemple de code suivant peut être utilisé pour implémenter une extension de feuille de propriétés Active Directory.
ms.assetid: aeee870e-1a0e-437f-a724-0bbac30f5e34
ms.tgt_platform: multiple
keywords:
- Exemple de code pour l’implémentation de l’objet COM de la feuille de propriétés AD
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104462867"
---
# <a name="example-code-for-implementation-of-the-property-sheet-com-object"></a><span data-ttu-id="c3203-104">Exemple de code pour l’implémentation de l’objet COM de la feuille de propriétés</span><span class="sxs-lookup"><span data-stu-id="c3203-104">Example Code for Implementation of the Property Sheet COM Object</span></span>

<span data-ttu-id="c3203-105">L’exemple de code suivant peut être utilisé pour implémenter une extension de feuille de propriétés Active Directory.</span><span class="sxs-lookup"><span data-stu-id="c3203-105">The following code example can be used to implement an Active Directory property sheet extension.</span></span>

## <a name="ishellextinit-implementation"></a><span data-ttu-id="c3203-106">Implémentation de IShellExtInit</span><span class="sxs-lookup"><span data-stu-id="c3203-106">IShellExtInit Implementation</span></span>

<span data-ttu-id="c3203-107">L’exemple de code C++ suivant peut être utilisé pour implémenter les méthodes [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .</span><span class="sxs-lookup"><span data-stu-id="c3203-107">The following C++ code example can be used to implement the [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) methods.</span></span>
...
## <a name="ishellpropsheetext-implementation"></a><span data-ttu-id="c3203-108">Implémentation de IShellPropSheetExt</span><span class="sxs-lookup"><span data-stu-id="c3203-108">IShellPropSheetExt Implementation</span></span>

<span data-ttu-id="c3203-109">L’exemple de code C++ suivant peut être utilisé pour implémenter les méthodes [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) .</span><span class="sxs-lookup"><span data-stu-id="c3203-109">The following C++ code example can be used to implement the [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) methods.</span></span>
...
## <a name="miscellaneous-implementation"></a><span data-ttu-id="c3203-110">Implémentation diverse</span><span class="sxs-lookup"><span data-stu-id="c3203-110">Miscellaneous Implementation</span></span>

<span data-ttu-id="c3203-111">L’exemple de code C++ suivant peut être utilisé pour implémenter les méthodes et les fonctions utilitaires utilisées dans l’exemple de code précédent.</span><span class="sxs-lookup"><span data-stu-id="c3203-111">The following C++ code example can be used to implement the utility methods and functions used in the previous code example.</span></span>
