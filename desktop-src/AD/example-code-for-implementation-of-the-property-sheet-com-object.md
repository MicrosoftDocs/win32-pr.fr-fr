...
---
# <a name="example-code-for-implementation-of-the-property-sheet-com-object"></a>Exemple de code pour l’implémentation de l’objet COM de la feuille de propriétés

L’exemple de code suivant peut être utilisé pour implémenter une extension de feuille de propriétés Active Directory.

## <a name="ishellextinit-implementation"></a>Implémentation de IShellExtInit

L’exemple de code C++ suivant peut être utilisé pour implémenter les méthodes [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .
...
## <a name="ishellpropsheetext-implementation"></a>Implémentation de IShellPropSheetExt

L’exemple de code C++ suivant peut être utilisé pour implémenter les méthodes [**IShellPropSheetExt**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellpropsheetext) .
...
## <a name="miscellaneous-implementation"></a>Implémentation diverse

L’exemple de code C++ suivant peut être utilisé pour implémenter les méthodes et les fonctions utilitaires utilisées dans l’exemple de code précédent.
