---
title: Exemple de code pour la recherche de groupes dans un domaine
description: Cette rubrique contient un exemple de code qui effectue une recherche dans la sous-arborescence du conteneur spécifié pour tous les objets de groupe qui ont le type de groupe spécifié.
ms.assetid: 07b27324-4f59-42c2-a42f-8c2cef138928
ms.tgt_platform: multiple
keywords:
- Active Directory des exemples Active Directory, recherche de groupes dans un domaine
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103939636"
---
# <a name="example-code-for-searching-for-groups-in-a-domain"></a><span data-ttu-id="dc3e5-104">Exemple de code pour la recherche de groupes dans un domaine</span><span class="sxs-lookup"><span data-stu-id="dc3e5-104">Example Code for Searching for Groups in a Domain</span></span>

<span data-ttu-id="dc3e5-105">L’exemple de code C/C++ suivant recherche dans la sous-arborescence du conteneur spécifié tous les objets de groupe qui ont le type de groupe spécifié.</span><span class="sxs-lookup"><span data-stu-id="dc3e5-105">The following C/C++ code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
...
<span data-ttu-id="dc3e5-106">L’exemple de code Visual Basic suivant recherche dans la sous-arborescence du conteneur spécifié tous les objets de groupe qui ont le type de groupe spécifié.</span><span class="sxs-lookup"><span data-stu-id="dc3e5-106">The following Visual Basic code example searches the subtree of the specified container for all group objects that have the specified group type.</span></span>
