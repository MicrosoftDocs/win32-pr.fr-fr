---
title: Exemple de code pour la recherche d’utilisateurs
description: Les exemples de code suivants recherchent des utilisateurs dans le domaine du compte d’utilisateur sous lequel le processus appelant s’exécute. Exemple C++ ExampleVisual Basic
...
---
# <a name="example-code-for-searching-for-users"></a><span data-ttu-id="1c5a3-104">Exemple de code pour la recherche d’utilisateurs</span><span class="sxs-lookup"><span data-stu-id="1c5a3-104">Example Code for Searching for Users</span></span>

<span data-ttu-id="1c5a3-105">Les exemples de code suivants recherchent des utilisateurs dans le domaine du compte d’utilisateur sous lequel le processus appelant s’exécute.</span><span class="sxs-lookup"><span data-stu-id="1c5a3-105">The following code examples search for users in the domain of the user account under which the calling process is running.</span></span>

-   [<span data-ttu-id="1c5a3-106">Exemple C++</span><span class="sxs-lookup"><span data-stu-id="1c5a3-106">C++ Example</span></span>](#c-example)
-   [<span data-ttu-id="1c5a3-107">Exemple de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="1c5a3-107">Visual Basic Example</span></span>](#visual-basic-example)

## <a name="c-example"></a><span data-ttu-id="1c5a3-108">Exemple C++</span><span class="sxs-lookup"><span data-stu-id="1c5a3-108">C++ Example</span></span>

<span data-ttu-id="1c5a3-109">L’exemple de code C++ suivant recherche dans le domaine actuel tous les utilisateurs ou un utilisateur spécifique en fonction d’un filtre spécifié.</span><span class="sxs-lookup"><span data-stu-id="1c5a3-109">The following C++ code example searches the current domain for all users, or a specific user based on a specified filter.</span></span>
...
## <a name="visual-basic-example"></a><span data-ttu-id="1c5a3-110">Exemple de Visual Basic</span><span class="sxs-lookup"><span data-stu-id="1c5a3-110">Visual Basic Example</span></span>

<span data-ttu-id="1c5a3-111">L’exemple de code Visual Basic suivant recherche dans le domaine actuel les utilisateurs avec le nom de famille spécifié et retourne les attributs Name et [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) pour les objets trouvés.</span><span class="sxs-lookup"><span data-stu-id="1c5a3-111">The following Visual Basic code example searches the current domain for users with the specified surname and returns the name and [**distinguishedName**](/windows/desktop/ADSchema/a-distinguishedname) attributes for the objects that are found.</span></span> <span data-ttu-id="1c5a3-112">L’exemple de code suivant utilise ADO pour effectuer la recherche.</span><span class="sxs-lookup"><span data-stu-id="1c5a3-112">The following code example uses ADO to perform the search.</span></span>
