...
L’exemple de code suivant utilise les interfaces [**IADs**](/windows/desktop/api/iads/nn-iads-iads) pour énumérer les propriétés du descripteur de sécurité d’un objet d’annuaire, de la liste DACL et des ACE de la liste DACL.
