...
ms.locfileid: "118018716"
---
# <a name="display-structures-in-active-directory-domain-services"></a>Afficher les structures dans Active Directory Domain Services

Affichez les fonctions et les interfaces dans Active Directory Domain Services Utilisez les structures suivantes pour contenir des données d’affichage sur les éléments de l’interface utilisateur de l’annuaire :
