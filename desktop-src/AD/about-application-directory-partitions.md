...
-   Un réplica d’une partition d’annuaire d’applications peut être créé sur un système d’exploitation Windows Server 2003 et un contrôleur de domaine ultérieur dans une forêt Active Directory Domain Services.
...
-   Lors de la création d’un réplica de partition d’annuaire d’applications, le rôle Domain-Naming FSMO doit se trouver sur l’un des contrôleurs de domaine du système d’exploitation Windows Server 2003 et ultérieur. Une fois le réplica de partition d’annuaire d’applications créé, le rôle FSMO d’attribution de noms de domaine peut être attribué à un contrôleur de domaine Windows 2000.
...
-   Les partitions d’annuaire d’applications peuvent être nommées en tant que domaines standard, attachés n’importe où dans l’espace de noms Active Directory où un domaine peut et découvert à l’aide de DNS, même par les systèmes Windows 2000 de niveau supérieur.
