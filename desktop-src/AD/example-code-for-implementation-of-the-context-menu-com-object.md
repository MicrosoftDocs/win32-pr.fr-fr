...
---
# <a name="example-code-for-implementation-of-the-context-menu-com-object"></a>Exemple de code pour l’implémentation de l’objet COM du menu contextuel

L’exemple de code suivant peut être utilisé pour implémenter une extension de menu contextuel Active Directory. L’élément de menu contextuel unique affiche une boîte de message qui contient l’ADsPath de chaque élément sélectionné.

## <a name="ishellextinit-implementation"></a>Implémentation de IShellExtInit

L’exemple de code suivant peut être utilisé pour implémenter les méthodes [**IShellExtInit**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-ishellextinit) .
...
## <a name="icontextmenu-implementation"></a>Implémentation de IContextMenu

L’exemple de code suivant peut être utilisé pour implémenter les méthodes [**IContextMenu**](/windows/win32/api/shobjidl_core/nn-shobjidl_core-icontextmenu) .
