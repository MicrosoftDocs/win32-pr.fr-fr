...
---
# <a name="example-code-for-locating-a-service-using-an-rnr-query"></a><span data-ttu-id="3a195-106">Exemple de code pour la localisation d’un service à l’aide d’une requête RnR</span><span class="sxs-lookup"><span data-stu-id="3a195-106">Example Code for Locating a Service Using an RnR Query</span></span>

<span data-ttu-id="3a195-107">L’exemple de code suivant localise l’exemple de service Winsock et s’y connecte.</span><span class="sxs-lookup"><span data-stu-id="3a195-107">The following code example locates the example Winsock service and connects to it.</span></span>
