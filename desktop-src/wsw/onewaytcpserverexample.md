...
description: Cet exemple montre un serveur TCP qui accepte un canal et reçoit des messages unidirectionnels.
ms.assetid: a43fc6a8-f1ee-4f6b-9737-bfe340bb67f0
keywords:
- OneWayTcpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104197383"
---
# <a name="onewaytcpserverexample"></a><span data-ttu-id="8106d-106">OneWayTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="8106d-106">OneWayTcpServerExample</span></span>

<span data-ttu-id="8106d-107">Cet exemple montre un serveur TCP qui accepte un canal et reçoit des messages unidirectionnels.</span><span class="sxs-lookup"><span data-stu-id="8106d-107">This example shows a TCP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="8106d-108">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="8106d-108">OneWayTcpServer.cpp</span></span>](#onewaytcpservercpp)
-   [<span data-ttu-id="8106d-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="8106d-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="8106d-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="8106d-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpservercpp"></a><span data-ttu-id="8106d-111">OneWayTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="8106d-111">OneWayTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="8106d-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="8106d-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="8106d-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="8106d-113">Makefile</span></span>
