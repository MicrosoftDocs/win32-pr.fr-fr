...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice sur HTTP.
ms.assetid: 898bc206-ad64-461c-a734-c8791b6b106d
keywords:
- HttpCalculatorServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029875"
---
# <a name="httpcalculatorserviceexample"></a><span data-ttu-id="4a63f-106">HttpCalculatorServiceExample</span><span class="sxs-lookup"><span data-stu-id="4a63f-106">HttpCalculatorServiceExample</span></span>

<span data-ttu-id="4a63f-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice sur HTTP.</span><span class="sxs-lookup"><span data-stu-id="4a63f-107">This example shows how to use service host for hosting a calculator service over HTTP.</span></span>

-   [<span data-ttu-id="4a63f-108">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="4a63f-108">HttpCalculatorService.cpp</span></span>](#httpcalculatorservicecpp)
-   [<span data-ttu-id="4a63f-109">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="4a63f-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="4a63f-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4a63f-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicecpp"></a><span data-ttu-id="4a63f-111">HttpCalculatorService. cpp</span><span class="sxs-lookup"><span data-stu-id="4a63f-111">HttpCalculatorService.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="4a63f-112">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="4a63f-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4a63f-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4a63f-113">Makefile</span></span>
