...
ms.locfileid: "127523945"
---
# <a name="derivedtypeexample"></a>DerivedTypeExample

Cet exemple écrit et lit les types dérivés à l’aide des fonctions d’assistance C++ générées par Wsutil. Pour plus d’informations sur les descriptions de types dérivés, consultez [**\_ mappage de champs d' \_ attribut \_ \_ WS type**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .
...
[**\_mappage de \_ champs d’attribut de type WS \_ \_**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
