...
description: Cet exemple écrit et lit les types dérivés à l’aide des fonctions d’assistance C++ générées par Wsutil. \_ \_ \_ \_ Pour plus d’informations sur les descriptions de types dérivés, consultez mappage de champs d’attribut WS type.
ms.assetid: 279663c0-8797-4f87-aaec-8cb8d4046a05
keywords:
- DerivedTypeExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106527544"
---
# <a name="derivedtypeexample"></a><span data-ttu-id="02933-107">DerivedTypeExample</span><span class="sxs-lookup"><span data-stu-id="02933-107">DerivedTypeExample</span></span>

<span data-ttu-id="02933-108">Cet exemple écrit et lit les types dérivés à l’aide des fonctions d’assistance C++ générées par Wsutil.</span><span class="sxs-lookup"><span data-stu-id="02933-108">This example writes and reads derived types using Wsutil generated C++ helper functions.</span></span> <span data-ttu-id="02933-109">Pour plus d’informations sur les descriptions de types dérivés, consultez [**\_ mappage de champs d' \_ attribut \_ \_ WS type**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) .</span><span class="sxs-lookup"><span data-stu-id="02933-109">See [**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping) for more about derived type descriptions.</span></span>

-   [<span data-ttu-id="02933-110">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="02933-110">DerivedType.cpp</span></span>](#derivedtypecpp)
-   [<span data-ttu-id="02933-111">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="02933-111">DerivedType.xsd</span></span>](#derivedtypexsd)
-   [<span data-ttu-id="02933-112">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="02933-112">Related topics</span></span>](#related-topics)

## <a name="derivedtypecpp"></a><span data-ttu-id="02933-113">DerivedType. cpp</span><span class="sxs-lookup"><span data-stu-id="02933-113">DerivedType.cpp</span></span>
...
## <a name="derivedtypexsd"></a><span data-ttu-id="02933-114">DerivedType. xsd</span><span class="sxs-lookup"><span data-stu-id="02933-114">DerivedType.xsd</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="02933-115">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="02933-115">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="02933-116">**\_mappage de \_ champs d’attribut de type WS \_ \_**</span><span class="sxs-lookup"><span data-stu-id="02933-116">**WS\_TYPE\_ATTRIBUTE\_FIELD\_MAPPING**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_field_mapping)
</dt> </dl>
