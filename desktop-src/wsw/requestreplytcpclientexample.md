...
description: Cet exemple montre un client TCP qui envoie des messages de demande-réponse.
ms.assetid: 0d9b9581-3563-4fce-8790-af7ebb9e8175
keywords:
- RequestReplyTcpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103671025"
---
# <a name="requestreplytcpclientexample"></a><span data-ttu-id="20d10-106">RequestReplyTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="20d10-106">RequestReplyTcpClientExample</span></span>

<span data-ttu-id="20d10-107">Cet exemple montre un client TCP qui envoie des messages de demande-réponse.</span><span class="sxs-lookup"><span data-stu-id="20d10-107">This example shows a TCP client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="20d10-108">RequestReplyTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="20d10-108">RequestReplyTcpClient.cpp</span></span>](#requestreplytcpclientcpp)
-   [<span data-ttu-id="20d10-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="20d10-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="20d10-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="20d10-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpclientcpp"></a><span data-ttu-id="20d10-111">RequestReplyTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="20d10-111">RequestReplyTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="20d10-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="20d10-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="20d10-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="20d10-113">Makefile</span></span>
