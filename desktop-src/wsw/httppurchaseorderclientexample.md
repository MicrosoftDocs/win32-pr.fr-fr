...
description: Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service PurchaseOrder HTTP.
ms.assetid: e577b06c-28b1-4f8f-a6af-025b9672cf27
keywords:
- HttpPurchaseOrderClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029400"
---
# <a name="httppurchaseorderclientexample"></a><span data-ttu-id="4f910-106">HttpPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="4f910-106">HttpPurchaseOrderClientExample</span></span>

<span data-ttu-id="4f910-107">Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service PurchaseOrder HTTP.</span><span class="sxs-lookup"><span data-stu-id="4f910-107">This example show how to use the service proxy to talk to an HTTP based PurchaseOrder service.</span></span>

-   [<span data-ttu-id="4f910-108">HttpPurchaseOrderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4f910-108">HttpPurchaseOrderClient.cpp</span></span>](#httppurchaseorderclientcpp)
-   [<span data-ttu-id="4f910-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="4f910-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="4f910-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="4f910-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientcpp"></a><span data-ttu-id="4f910-111">HttpPurchaseOrderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4f910-111">HttpPurchaseOrderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="4f910-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="4f910-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4f910-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="4f910-113">Makefile</span></span>
