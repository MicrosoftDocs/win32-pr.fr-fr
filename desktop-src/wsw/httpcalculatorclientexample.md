...
description: Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP.
ms.assetid: dd97613d-3bb7-427c-a292-220d1efed96c
keywords:
- Services Web HttpCalculatorClientExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106512473"
---
# <a name="httpcalculatorclientexample"></a><span data-ttu-id="666e5-106">HttpCalculatorClientExample</span><span class="sxs-lookup"><span data-stu-id="666e5-106">HttpCalculatorClientExample</span></span>

<span data-ttu-id="666e5-107">Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP.</span><span class="sxs-lookup"><span data-stu-id="666e5-107">This example show how to use the service proxy to talk to an HTTP based calculator service.</span></span>

-   [<span data-ttu-id="666e5-108">HttpCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="666e5-108">HttpCalculatorClient.cpp</span></span>](#httpcalculatorclientcpp)
-   [<span data-ttu-id="666e5-109">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="666e5-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="666e5-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="666e5-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorclientcpp"></a><span data-ttu-id="666e5-111">HttpCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="666e5-111">HttpCalculatorClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="666e5-112">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="666e5-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="666e5-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="666e5-113">Makefile</span></span>
