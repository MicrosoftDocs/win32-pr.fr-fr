...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP, avec un nom d’utilisateur sur la sécurité SSL en mode mixte.
ms.assetid: 3dfedab1-d508-4cff-b179-591871078adb
keywords:
- HttpPurchaseOrderWithUserNameOverSslServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103674366"
---
# <a name="httppurchaseorderwithusernameoversslserviceexample"></a><span data-ttu-id="a204d-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="a204d-106">HttpPurchaseOrderWithUserNameOverSslServiceExample</span></span>

<span data-ttu-id="a204d-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP, avec un nom d’utilisateur sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="a204d-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="a204d-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="a204d-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="a204d-109">L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="a204d-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="a204d-110">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a204d-110">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>](#purchaseorderserviceusernameoversslcpp)
-   [<span data-ttu-id="a204d-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a204d-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a204d-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="a204d-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderserviceusernameoversslcpp"></a><span data-ttu-id="a204d-113">PurchaseOrderServiceUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a204d-113">PurchaseOrderServiceUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a204d-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a204d-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a204d-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="a204d-115">Makefile</span></span>
