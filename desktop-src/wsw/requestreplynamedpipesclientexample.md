...
description: Cet exemple montre un client de canal nommé qui envoie des messages de demande-réponse.
...
ms.locfileid: "104190713"
---
# <a name="requestreplynamedpipesclientexample"></a><span data-ttu-id="08ec0-103">RequestReplyNamedPipesClientExample</span><span class="sxs-lookup"><span data-stu-id="08ec0-103">RequestReplyNamedPipesClientExample</span></span>

<span data-ttu-id="08ec0-104">Cet exemple montre un client de canal nommé qui envoie des messages de demande-réponse.</span><span class="sxs-lookup"><span data-stu-id="08ec0-104">This example shows a named pipe client that sends request-reply messages.</span></span>

-   [<span data-ttu-id="08ec0-105">RequestReplyNamedPipesClient. cpp</span><span class="sxs-lookup"><span data-stu-id="08ec0-105">RequestReplyNamedPipesClient.cpp</span></span>](#requestreplynamedpipesclientcpp)
-   [<span data-ttu-id="08ec0-106">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="08ec0-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="08ec0-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="08ec0-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesclientcpp"></a><span data-ttu-id="08ec0-108">RequestReplyNamedPipesClient. cpp</span><span class="sxs-lookup"><span data-stu-id="08ec0-108">RequestReplyNamedPipesClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="08ec0-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="08ec0-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="08ec0-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="08ec0-110">Makefile</span></span>
