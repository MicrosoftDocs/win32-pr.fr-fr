...
description: Exemple d’application de service illustrant l’annulation de l’appel côté serveur.
ms.assetid: a0a862bc-521a-477a-854d-58642d497109
keywords:
- BlockingServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029289"
---
# <a name="blockingserviceexample"></a><span data-ttu-id="9eeab-106">BlockingServiceExample</span><span class="sxs-lookup"><span data-stu-id="9eeab-106">BlockingServiceExample</span></span>

<span data-ttu-id="9eeab-107">Exemple d’application de service illustrant l’annulation de l’appel côté serveur.</span><span class="sxs-lookup"><span data-stu-id="9eeab-107">Example service application demonstrating server side call cancellation.</span></span>

-   [<span data-ttu-id="9eeab-108">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="9eeab-108">CancellingService.cpp</span></span>](#cancellingservicecpp)
-   [<span data-ttu-id="9eeab-109">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="9eeab-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="9eeab-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9eeab-110">Makefile</span></span>](#makefile)

## <a name="cancellingservicecpp"></a><span data-ttu-id="9eeab-111">CancellingService. cpp</span><span class="sxs-lookup"><span data-stu-id="9eeab-111">CancellingService.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="9eeab-112">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="9eeab-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9eeab-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="9eeab-113">Makefile</span></span>
