...
description: Cet exemple montre un client HTTP qui demande-réponse à l’aide des API de streaming.
ms.assetid: dd391506-6f14-4d3a-bd65-96a338b3f7cd
keywords:
- StreamingHttpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106540757"
---
# <a name="streaminghttpclientexample"></a><span data-ttu-id="12654-106">StreamingHttpClientExample</span><span class="sxs-lookup"><span data-stu-id="12654-106">StreamingHttpClientExample</span></span>

<span data-ttu-id="12654-107">Cet exemple montre un client HTTP qui demande-réponse à l’aide des API de streaming.</span><span class="sxs-lookup"><span data-stu-id="12654-107">This example shows an HTTP client that does request-reply using the streaming APIs.</span></span>

-   [<span data-ttu-id="12654-108">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="12654-108">StreamingHttpClient.cpp</span></span>](#streaminghttpclientcpp)
-   [<span data-ttu-id="12654-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="12654-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="12654-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="12654-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpclientcpp"></a><span data-ttu-id="12654-111">StreamingHttpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="12654-111">StreamingHttpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="12654-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="12654-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="12654-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="12654-113">Makefile</span></span>
