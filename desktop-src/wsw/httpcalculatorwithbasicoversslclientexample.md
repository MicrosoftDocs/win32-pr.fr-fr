...
ms.locfileid: "117841563"
---
# <a name="httpcalculatorwithbasicoversslclientexample"></a>HttpCalculatorWithBasicOverSslClientExample

Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice, avec la sécurité de transport SSL et l’authentification de base d’en-tête HTTP. Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur. L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe fournie dans les en-têtes HTTP à l’aide du schéma de base.
