...
description: Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice, avec la sécurité de transport SSL et l’authentification de base d’en-tête HTTP.
ms.assetid: be1a44e6-642c-42fa-8b95-bd8c6f335696
keywords:
- HttpCalculatorWithBasicOverSslClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106512280"
---
# <a name="httpcalculatorwithbasicoversslclientexample"></a><span data-ttu-id="4f1d5-106">HttpCalculatorWithBasicOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="4f1d5-106">HttpCalculatorWithBasicOverSslClientExample</span></span>

<span data-ttu-id="4f1d5-107">Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice, avec la sécurité de transport SSL et l’authentification de base d’en-tête HTTP.</span><span class="sxs-lookup"><span data-stu-id="4f1d5-107">This example shows how to use the service proxy to talk to a calculator service, with SSL transport security and HTTP header basic authentication.</span></span> <span data-ttu-id="4f1d5-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="4f1d5-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="4f1d5-109">L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe fournie dans les en-têtes HTTP à l’aide du schéma de base.</span><span class="sxs-lookup"><span data-stu-id="4f1d5-109">Client authentication is provided by a username/password pair supplied in HTTP headers using the basic scheme.</span></span>

-   [<span data-ttu-id="4f1d5-110">HttpCalculatorWithBasicOverSslClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4f1d5-110">HttpCalculatorWithBasicOverSslClient.cpp</span></span>](#httpcalculatorwithbasicoversslclientcpp)
-   [<span data-ttu-id="4f1d5-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="4f1d5-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="4f1d5-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="4f1d5-112">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithbasicoversslclientcpp"></a><span data-ttu-id="4f1d5-113">HttpCalculatorWithBasicOverSslClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4f1d5-113">HttpCalculatorWithBasicOverSslClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="4f1d5-114">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="4f1d5-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4f1d5-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="4f1d5-115">Makefile</span></span>
