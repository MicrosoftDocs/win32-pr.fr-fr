...
description: Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages, avec la sécurité de transport SSL.
ms.assetid: 627b6ba8-3bb2-41f3-a456-a811eb3b8e3d
keywords:
- HttpServerWithSslExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104311281"
---
# <a name="httpserverwithsslexample"></a><span data-ttu-id="fd6be-106">HttpServerWithSslExample</span><span class="sxs-lookup"><span data-stu-id="fd6be-106">HttpServerWithSslExample</span></span>

<span data-ttu-id="fd6be-107">Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages, avec la sécurité de transport SSL.</span><span class="sxs-lookup"><span data-stu-id="fd6be-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="fd6be-108">HttpServerWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="fd6be-108">HttpServerWithSsl.cpp</span></span>](#httpserverwithsslcpp)
-   [<span data-ttu-id="fd6be-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="fd6be-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="fd6be-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="fd6be-110">Makefile</span></span>](#makefile)

## <a name="httpserverwithsslcpp"></a><span data-ttu-id="fd6be-111">HttpServerWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="fd6be-111">HttpServerWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="fd6be-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="fd6be-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="fd6be-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="fd6be-113">Makefile</span></span>
