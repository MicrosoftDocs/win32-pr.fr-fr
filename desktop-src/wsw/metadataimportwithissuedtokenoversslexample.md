...
description: Cet exemple illustre l’importation de métadonnées à partir d’un point de terminaison qui prend en charge l’utilisation d’un jeton émis obtenu à partir du service d’émission de jeton de sécurité (STS) qui utilise WsRequestSecurityToken et présenté au service à l’aide de la liaison de sécurité \_ \_ \_ de message de jeton WS XML avec liaison \_ \_ de \_ sécurité de transport WS SSL \_ \_ \_ . Pour plus d’informations, consultez Fédération.
ms.assetid: 31d1386a-1733-4e7a-add1-9050528075c8
keywords:
- API des services Web Windows MetadataImportWithIssuedTokenOverSslExample
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104379692"
---
# <a name="metadataimportwithissuedtokenoversslexample"></a><span data-ttu-id="6ab8a-107">MetadataImportWithIssuedTokenOverSslExample</span><span class="sxs-lookup"><span data-stu-id="6ab8a-107">MetadataImportWithIssuedTokenOverSslExample</span></span>

<span data-ttu-id="6ab8a-108">Cet exemple illustre l’importation de métadonnées à partir d’un point de terminaison qui prend en charge l’utilisation d’un jeton émis obtenu à partir du service d’émission de jeton de sécurité (STS) qui utilise [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) et présenté au service à l’aide de la liaison de sécurité de [**message de \_ \_ jeton \_ \_ \_ WS XML**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) avec liaison de [**sécurité de \_ \_ transport \_ \_ WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span><span class="sxs-lookup"><span data-stu-id="6ab8a-108">This example illustrates importing metadata from an endpoint that supports using an issued token that is obtained from the issuing security token service (STS) using [**WsRequestSecurityToken**](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken) and presented to the service using [**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) with [**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).</span></span> <span data-ttu-id="6ab8a-109">Pour plus d’informations, consultez [Fédération](federation.md) .</span><span class="sxs-lookup"><span data-stu-id="6ab8a-109">See [Federation](federation.md) for more information.</span></span>

## <a name="metadataimportwithissuedtokenoversslexamplecpp"></a><span data-ttu-id="6ab8a-110">MetadataImportWithIssuedTokenOverSslExample. cpp</span><span class="sxs-lookup"><span data-stu-id="6ab8a-110">MetadataImportWithIssuedTokenOverSslExample.cpp</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="6ab8a-111">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="6ab8a-111">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="6ab8a-112">**WsRequestSecurityToken**</span><span class="sxs-lookup"><span data-stu-id="6ab8a-112">**WsRequestSecurityToken**</span></span>](/windows/desktop/api/WebServices/nf-webservices-wsrequestsecuritytoken)
</dt> <dt>

[<span data-ttu-id="6ab8a-113">**\_liaison de \_ \_ sécurité de message de jeton XML \_ WS \_**</span><span class="sxs-lookup"><span data-stu-id="6ab8a-113">**WS\_XML\_TOKEN\_MESSAGE\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding)
</dt> <dt>

[<span data-ttu-id="6ab8a-114">**\_liaison de \_ sécurité de transport WS SSL \_ \_**</span><span class="sxs-lookup"><span data-stu-id="6ab8a-114">**WS\_SSL\_TRANSPORT\_SECURITY\_BINDING**</span></span>](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding)
</dt> <dt>

[<span data-ttu-id="6ab8a-115">Fédération</span><span class="sxs-lookup"><span data-stu-id="6ab8a-115">Federation</span></span>](federation.md)
</dt> </dl>
