...
description: Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service PurchaseOrder, avec la sécurité de transport SSL.
ms.assetid: afa73250-5f1c-4151-a2e0-4a5ccc91b63f
keywords:
- HttpPurchaseOrderWithSslClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106512677"
---
# <a name="httppurchaseorderwithsslclientexample"></a><span data-ttu-id="a1036-106">HttpPurchaseOrderWithSslClientExample</span><span class="sxs-lookup"><span data-stu-id="a1036-106">HttpPurchaseOrderWithSslClientExample</span></span>

<span data-ttu-id="a1036-107">Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service PurchaseOrder, avec la sécurité de transport SSL.</span><span class="sxs-lookup"><span data-stu-id="a1036-107">This example show how to use the service proxy to talk to a PurchaseOrder service, with SSL transport security.</span></span>

-   [<span data-ttu-id="a1036-108">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a1036-108">HttpPurchaseOrderClientWithSsl.cpp</span></span>](#httppurchaseorderclientwithsslcpp)
-   [<span data-ttu-id="a1036-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a1036-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="a1036-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="a1036-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderclientwithsslcpp"></a><span data-ttu-id="a1036-111">HttpPurchaseOrderClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="a1036-111">HttpPurchaseOrderClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="a1036-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="a1036-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="a1036-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="a1036-113">Makefile</span></span>
