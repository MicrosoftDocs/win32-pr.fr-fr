...
ms.locfileid: "118963148"
---
# <a name="httppurchaseorderwithsslclientexample"></a>HttpPurchaseOrderWithSslClientExample

Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service PurchaseOrder, avec la sécurité de transport SSL.
