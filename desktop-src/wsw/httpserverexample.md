...
description: consultez un exemple de serveur HTTP qui utilise l’API de Services Web Windows. Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages.
