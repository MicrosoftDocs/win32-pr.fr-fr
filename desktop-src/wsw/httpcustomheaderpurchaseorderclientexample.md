...
description: Cet exemple montre comment utiliser des en-têtes personnalisés avec le proxy de service.
ms.assetid: d56e68cd-c910-4f41-a672-c894ba134e3b
keywords:
- HttpCustomHeaderPurchaseOrderClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104380089"
---
# <a name="httpcustomheaderpurchaseorderclientexample"></a><span data-ttu-id="c9518-106">HttpCustomHeaderPurchaseOrderClientExample</span><span class="sxs-lookup"><span data-stu-id="c9518-106">HttpCustomHeaderPurchaseOrderClientExample</span></span>

<span data-ttu-id="c9518-107">Cet exemple montre comment utiliser des en-têtes personnalisés avec le proxy de service.</span><span class="sxs-lookup"><span data-stu-id="c9518-107">This examples shows how to use custom headers with service proxy.</span></span>

-   [<span data-ttu-id="c9518-108">HttpCustomHeaderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="c9518-108">HttpCustomHeaderClient.cpp</span></span>](#httpcustomheaderclientcpp)
-   [<span data-ttu-id="c9518-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="c9518-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="c9518-110">OrderSessionHeader. xsd</span><span class="sxs-lookup"><span data-stu-id="c9518-110">OrderSessionHeader.xsd</span></span>](#ordersessionheaderxsd)
-   [<span data-ttu-id="c9518-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="c9518-111">Makefile</span></span>](#makefile)

## <a name="httpcustomheaderclientcpp"></a><span data-ttu-id="c9518-112">HttpCustomHeaderClient. cpp</span><span class="sxs-lookup"><span data-stu-id="c9518-112">HttpCustomHeaderClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="c9518-113">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="c9518-113">PurchaseOrder.wsdl</span></span>
...
## <a name="ordersessionheaderxsd"></a><span data-ttu-id="c9518-114">OrderSessionHeader. xsd</span><span class="sxs-lookup"><span data-stu-id="c9518-114">OrderSessionHeader.xsd</span></span>
...
## <a name="makefile"></a><span data-ttu-id="c9518-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="c9518-115">Makefile</span></span>
