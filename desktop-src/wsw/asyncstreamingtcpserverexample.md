...
description: Cet exemple montre un serveur TCP qui reçoit des messages unidirectionnels en mode de diffusion en continu asynchrone.
ms.assetid: 8b79735b-f238-4d49-8977-2935fc208d48
keywords:
- AsyncStreamingTcpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="asyncstreamingtcpserverexample"></a><span data-ttu-id="87a01-106">AsyncStreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="87a01-106">AsyncStreamingTcpServerExample</span></span>

<span data-ttu-id="87a01-107">Cet exemple montre un serveur TCP qui reçoit des messages unidirectionnels en mode de diffusion en continu asynchrone.</span><span class="sxs-lookup"><span data-stu-id="87a01-107">This example shows a TCP server that receives one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="87a01-108">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="87a01-108">AsyncStreamingTcpServer.cpp</span></span>](#asyncstreamingtcpservercpp)
-   [<span data-ttu-id="87a01-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="87a01-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="87a01-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="87a01-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpservercpp"></a><span data-ttu-id="87a01-111">AsyncStreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="87a01-111">AsyncStreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="87a01-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="87a01-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="87a01-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="87a01-113">Makefile</span></span>
