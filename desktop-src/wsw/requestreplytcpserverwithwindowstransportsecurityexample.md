---
title: Exemple RequestReplyTcpServerWithWindowsTransportSecurity
description: Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond à des messages, avec la sécurité fournie par la sécurité de transport basée sur SSPI Windows.
ms.assetid: 690fa5cd-228b-4099-bd2b-cbf9c8d70c53
keywords:
- RequestReplyTcpServerWithWindowsTransportSecurityExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104101145"
---
# <a name="requestreplytcpserverwithwindowstransportsecurity-example"></a><span data-ttu-id="550b2-106">Exemple RequestReplyTcpServerWithWindowsTransportSecurity</span><span class="sxs-lookup"><span data-stu-id="550b2-106">RequestReplyTcpServerWithWindowsTransportSecurity example</span></span>

<span data-ttu-id="550b2-107">Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond à des messages, avec la sécurité fournie par la sécurité de transport basée sur SSPI Windows.</span><span class="sxs-lookup"><span data-stu-id="550b2-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with security provided by Windows SSPI-based transport security.</span></span>

-   [<span data-ttu-id="550b2-108">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="550b2-108">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplytcpserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="550b2-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="550b2-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="550b2-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="550b2-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="550b2-111">RequestReplyTcpServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="550b2-111">RequestReplyTcpServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="550b2-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="550b2-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="550b2-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="550b2-113">Makefile</span></span>
