...
Cet exemple illustre l’importation de métadonnées à partir d’un point de terminaison qui prend en charge la liaison de sécurité de [**\_ \_ message \_ \_ WS username**](/windows/desktop/api/WebServices/ns-webservices-ws_username_message_security_binding) avec la [**liaison de \_ sécurité de \_ transport \_ \_ WS SSL**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).
