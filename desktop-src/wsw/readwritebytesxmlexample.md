...
description: Cet exemple écrit des données binaires à l’aide de l’encodage MTOM et les lit à nouveau.
ms.assetid: 6b80846e-6959-4c38-bf1b-17827ecb9d1a
keywords:
- Services Web ReadWriteBytesXmlExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106510795"
---
# <a name="readwritebytesxmlexample"></a><span data-ttu-id="5b54d-106">ReadWriteBytesXmlExample</span><span class="sxs-lookup"><span data-stu-id="5b54d-106">ReadWriteBytesXmlExample</span></span>

<span data-ttu-id="5b54d-107">Cet exemple écrit des données binaires à l’aide de l’encodage MTOM et les lit à nouveau.</span><span class="sxs-lookup"><span data-stu-id="5b54d-107">This example writes binary data using the MTOM encoding and reads it back out.</span></span>

## <a name="readwritebytesxmlcpp"></a><span data-ttu-id="5b54d-108">ReadWriteBytesXml. cpp</span><span class="sxs-lookup"><span data-stu-id="5b54d-108">ReadWriteBytesXml.cpp</span></span>
