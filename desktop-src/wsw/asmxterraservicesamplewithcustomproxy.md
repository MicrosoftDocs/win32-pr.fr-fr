...
ms.locfileid: "119805839"
---
# <a name="asmxterraservicesamplewithcustomproxy"></a>AsmxTerraServiceSampleWithCustomProxy

Cet exemple montre un proxy de service communiquant avec un service ASMX TerraService à l’aide de la propriété de canal [**personnalisée du mode de \_ configuration du \_ proxy \_ \_ \_ WS http**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) .
...
[**\_ \_ \_ \_ mode personnalisé du paramètre proxy WS http \_**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
