...
description: Cet exemple montre un proxy de service communiquant avec un service ASMX TerraService à l’aide de la \_ \_ propriété de \_ \_ canal personnalisée du mode de configuration du proxy WS http \_ .
ms.assetid: 200dfcbc-ad16-4ac8-ab16-76291344a980
keywords:
- AsmxTerraServiceSampleWithCustomProxy-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104310298"
---
# <a name="asmxterraservicesamplewithcustomproxy"></a><span data-ttu-id="0ecbf-106">AsmxTerraServiceSampleWithCustomProxy</span><span class="sxs-lookup"><span data-stu-id="0ecbf-106">AsmxTerraServiceSampleWithCustomProxy</span></span>

<span data-ttu-id="0ecbf-107">Cet exemple montre un proxy de service communiquant avec un service ASMX TerraService à l’aide de la propriété de canal [**personnalisée du mode de \_ configuration du \_ proxy \_ \_ \_ WS http**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) .</span><span class="sxs-lookup"><span data-stu-id="0ecbf-107">This examples shows service proxy talking to a ASMX TerraService service using [**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode) channel property.</span></span>

-   [<span data-ttu-id="0ecbf-108">AsmxCustomProxyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="0ecbf-108">AsmxCustomProxyClient.cpp</span></span>](#asmxcustomproxyclientcpp)
-   [<span data-ttu-id="0ecbf-109">terraserviceusa. com. wsdl</span><span class="sxs-lookup"><span data-stu-id="0ecbf-109">terraserviceusa.com.wsdl</span></span>](#terraserviceusacomwsdl)
-   [<span data-ttu-id="0ecbf-110">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="0ecbf-110">Related topics</span></span>](#related-topics)

## <a name="asmxcustomproxyclientcpp"></a><span data-ttu-id="0ecbf-111">AsmxCustomProxyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="0ecbf-111">AsmxCustomProxyClient.cpp</span></span>
...
## <a name="terraserviceusacomwsdl"></a><span data-ttu-id="0ecbf-112">terraserviceusa. com. wsdl</span><span class="sxs-lookup"><span data-stu-id="0ecbf-112">terraserviceusa.com.wsdl</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="0ecbf-113">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="0ecbf-113">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="0ecbf-114">**\_ \_ \_ \_ mode personnalisé du paramètre proxy WS http \_**</span><span class="sxs-lookup"><span data-stu-id="0ecbf-114">**WS\_HTTP\_PROXY\_SETTING\_MODE\_CUSTOM**</span></span>](/windows/desktop/api/WebServices/ne-webservices-ws_http_proxy_setting_mode)
</dt> </dl>
