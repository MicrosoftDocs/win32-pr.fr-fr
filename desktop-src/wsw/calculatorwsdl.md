...
description: Il s’agit d’un exemple de WSDL/schéma pour les exemples de service de calculatrice.
ms.assetid: 6dbea7dc-2d5c-4e6d-9941-9a93943e1914
keywords:
- Services Web CalculatorWsdl pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103679510"
---
# <a name="calculatorwsdl"></a><span data-ttu-id="ef020-106">CalculatorWsdl</span><span class="sxs-lookup"><span data-stu-id="ef020-106">CalculatorWsdl</span></span>

<span data-ttu-id="ef020-107">Il s’agit d’un exemple de WSDL/schéma pour les exemples de service de calculatrice.</span><span class="sxs-lookup"><span data-stu-id="ef020-107">This is an example wsdl/schema for the calculator service samples.</span></span>

## <a name="calculatorwsdl"></a><span data-ttu-id="ef020-108">Calculatrice. wsdl</span><span class="sxs-lookup"><span data-stu-id="ef020-108">Calculator.wsdl</span></span>
