...
description: Cet exemple montre un client HTTP qui envoie des messages de demande-réponse, avec le nom d’utilisateur sur la sécurité SSL en mode mixte.
ms.assetid: aaaad584-d861-4abd-9d76-95aba5090676
keywords:
- HttpClientWithUsernameOverSslExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029401"
---
# <a name="httpclientwithusernameoversslexample"></a><span data-ttu-id="552cd-106">HttpClientWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="552cd-106">HttpClientWithUsernameOverSslExample</span></span>

<span data-ttu-id="552cd-107">Cet exemple montre un client HTTP qui envoie des messages de demande-réponse, avec le nom d’utilisateur sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="552cd-107">This example shows a HTTP client that sends request-reply messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="552cd-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="552cd-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="552cd-109">L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="552cd-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="552cd-110">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="552cd-110">HttpClientWithUsernameOverSsl.cpp</span></span>](#httpclientwithusernameoversslcpp)
-   [<span data-ttu-id="552cd-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="552cd-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="552cd-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="552cd-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithusernameoversslcpp"></a><span data-ttu-id="552cd-113">HttpClientWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="552cd-113">HttpClientWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="552cd-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="552cd-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="552cd-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="552cd-115">Makefile</span></span>
