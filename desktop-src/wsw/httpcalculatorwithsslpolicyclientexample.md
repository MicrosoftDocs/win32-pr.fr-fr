...
description: Cet exemple montre comment utiliser les routines d’assistance de la stratégie générée par Wsutil pour créer un proxy de service afin de communiquer avec un service de calculatrice, avec la sécurité de transport SSL.
ms.assetid: cf2455d4-0670-4ea2-8ee7-073698bfb765
keywords:
- HttpCalculatorWithSslPolicyClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103940033"
---
# <a name="httpcalculatorwithsslpolicyclientexample"></a><span data-ttu-id="841e7-106">HttpCalculatorWithSslPolicyClientExample</span><span class="sxs-lookup"><span data-stu-id="841e7-106">HttpCalculatorWithSslPolicyClientExample</span></span>

<span data-ttu-id="841e7-107">Cet exemple montre comment utiliser les routines d’assistance de la stratégie générée par Wsutil pour créer un proxy de service afin de communiquer avec un service de calculatrice, avec la sécurité de transport SSL.</span><span class="sxs-lookup"><span data-stu-id="841e7-107">This example shows how to use the wsutil generated policy helper routines to create service proxy to talk to a calculator service, with SSL transport security.</span></span> <span data-ttu-id="841e7-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="841e7-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span>

-   [<span data-ttu-id="841e7-109">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="841e7-109">HttpCalculatorWithSslPolicyClient.cpp</span></span>](#httpcalculatorwithsslpolicyclientcpp)
-   [<span data-ttu-id="841e7-110">CalculatorServiceWithPolicy. wsdl</span><span class="sxs-lookup"><span data-stu-id="841e7-110">CalculatorServiceWithPolicy.wsdl</span></span>](#calculatorservicewithpolicywsdl)
-   [<span data-ttu-id="841e7-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="841e7-111">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithsslpolicyclientcpp"></a><span data-ttu-id="841e7-112">HttpCalculatorWithSslPolicyClient. cpp</span><span class="sxs-lookup"><span data-stu-id="841e7-112">HttpCalculatorWithSslPolicyClient.cpp</span></span>
...
## <a name="calculatorservicewithpolicywsdl"></a><span data-ttu-id="841e7-113">CalculatorServiceWithPolicy. wsdl</span><span class="sxs-lookup"><span data-stu-id="841e7-113">CalculatorServiceWithPolicy.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="841e7-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="841e7-114">Makefile</span></span>
