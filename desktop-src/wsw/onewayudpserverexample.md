...
description: Cet exemple montre un serveur UDP qui accepte un canal et reçoit des messages unidirectionnels.
ms.assetid: 45317e45-03d5-4d17-89cd-9108f81490ff
keywords:
- OneWayUdpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103675445"
---
# <a name="onewayudpserverexample"></a><span data-ttu-id="58e18-106">OneWayUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="58e18-106">OneWayUdpServerExample</span></span>

<span data-ttu-id="58e18-107">Cet exemple montre un serveur UDP qui accepte un canal et reçoit des messages unidirectionnels.</span><span class="sxs-lookup"><span data-stu-id="58e18-107">This example shows a UDP server that accepts a channel and receives one-way messages.</span></span>

-   [<span data-ttu-id="58e18-108">OneWayUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="58e18-108">OneWayUdpServer.cpp</span></span>](#onewayudpservercpp)
-   [<span data-ttu-id="58e18-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="58e18-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="58e18-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="58e18-110">Makefile</span></span>](#makefile)

## <a name="onewayudpservercpp"></a><span data-ttu-id="58e18-111">OneWayUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="58e18-111">OneWayUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="58e18-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="58e18-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="58e18-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="58e18-113">Makefile</span></span>
