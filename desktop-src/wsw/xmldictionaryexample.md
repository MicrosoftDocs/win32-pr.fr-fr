...
description: Cet exemple écrit un document à l’aide d’un \_ dictionnaire WS XML \_ .
ms.assetid: d8185577-3483-4005-84e5-0b10a6698e79
keywords:
- XmlDictionaryExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104310573"
---
# <a name="xmldictionaryexample"></a><span data-ttu-id="292b8-106">XmlDictionaryExample</span><span class="sxs-lookup"><span data-stu-id="292b8-106">XmlDictionaryExample</span></span>

<span data-ttu-id="292b8-107">Cet exemple écrit un document à l’aide d’un \_ dictionnaire WS XML \_ .</span><span class="sxs-lookup"><span data-stu-id="292b8-107">This example writes a document using a WS\_XML\_DICTIONARY.</span></span>

-   [<span data-ttu-id="292b8-108">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="292b8-108">XmlDictionary.cpp</span></span>](#xmldictionarycpp)
-   [<span data-ttu-id="292b8-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="292b8-109">Makefile</span></span>](#makefile)

## <a name="xmldictionarycpp"></a><span data-ttu-id="292b8-110">XmlDictionary. cpp</span><span class="sxs-lookup"><span data-stu-id="292b8-110">XmlDictionary.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="292b8-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="292b8-111">Makefile</span></span>
