...
description: Cet exemple montre un serveur UDP qui écoute sur une adresse de multidiffusion et répond aux demandes envoyées à cette adresse.
ms.assetid: 9688756b-3c5e-42ca-a9da-f258d4be2360
keywords:
- MulticastUdpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106510805"
---
# <a name="multicastudpserverexample"></a><span data-ttu-id="89f07-106">MulticastUdpServerExample</span><span class="sxs-lookup"><span data-stu-id="89f07-106">MulticastUdpServerExample</span></span>

<span data-ttu-id="89f07-107">Cet exemple montre un serveur UDP qui écoute sur une adresse de multidiffusion et répond aux demandes envoyées à cette adresse.</span><span class="sxs-lookup"><span data-stu-id="89f07-107">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span>

-   [<span data-ttu-id="89f07-108">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="89f07-108">MulticastUdpServer.cpp</span></span>](#multicastudpservercpp)
-   [<span data-ttu-id="89f07-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="89f07-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="89f07-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="89f07-110">Makefile</span></span>](#makefile)

## <a name="multicastudpservercpp"></a><span data-ttu-id="89f07-111">MulticastUdpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="89f07-111">MulticastUdpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="89f07-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="89f07-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="89f07-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="89f07-113">Makefile</span></span>
