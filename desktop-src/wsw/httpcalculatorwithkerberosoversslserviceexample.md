...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice sur HTTP, avec Kerberos sur la sécurité SSL en mode mixte.
ms.assetid: a006ce15-9470-49f7-80d6-8d40ffec8651
keywords:
- HttpCalculatorWithKerberosOverSslServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104380424"
---
# <a name="httpcalculatorwithkerberosoversslserviceexample"></a><span data-ttu-id="95b20-106">HttpCalculatorWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="95b20-106">HttpCalculatorWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="95b20-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice sur HTTP, avec Kerberos sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="95b20-107">This example shows how to use service host for hosting a calculator service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="95b20-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="95b20-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="95b20-109">L’authentification du client est fournie par un ticket Kerberos APREQ dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="95b20-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="95b20-110">CalculatorServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="95b20-110">CalculatorServiceKerberosOverSsl.cpp</span></span>](#calculatorservicekerberosoversslcpp)
-   [<span data-ttu-id="95b20-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="95b20-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="95b20-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="95b20-112">Makefile</span></span>](#makefile)

## <a name="calculatorservicekerberosoversslcpp"></a><span data-ttu-id="95b20-113">CalculatorServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="95b20-113">CalculatorServiceKerberosOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="95b20-114">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="95b20-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="95b20-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="95b20-115">Makefile</span></span>
