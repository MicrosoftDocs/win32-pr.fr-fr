...
description: Cet exemple lit un attribut.
ms.assetid: e37946f0-66e0-4fb1-aeee-db4447ed4030
keywords:
- Services Web ReadAttributeExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028526"
---
# <a name="readattributeexample"></a><span data-ttu-id="83577-106">ReadAttributeExample</span><span class="sxs-lookup"><span data-stu-id="83577-106">ReadAttributeExample</span></span>

<span data-ttu-id="83577-107">Cet exemple lit un attribut.</span><span class="sxs-lookup"><span data-stu-id="83577-107">This example reads an attribute.</span></span>

## <a name="readattributecpp"></a><span data-ttu-id="83577-108">ReadAttribute. cpp</span><span class="sxs-lookup"><span data-stu-id="83577-108">ReadAttribute.cpp</span></span>
