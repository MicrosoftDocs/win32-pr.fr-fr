...
description: Cet exemple illustre l’utilisation des API de tampon XML.
ms.assetid: cf4530c7-48f4-4a76-bd3d-1f21b5469902
keywords:
- XmlBufferExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029275"
---
# <a name="xmlbufferexample"></a><span data-ttu-id="50e5e-106">XmlBufferExample</span><span class="sxs-lookup"><span data-stu-id="50e5e-106">XmlBufferExample</span></span>

<span data-ttu-id="50e5e-107">Cet exemple illustre l’utilisation des API de tampon XML.</span><span class="sxs-lookup"><span data-stu-id="50e5e-107">This example shows some use of the xml buffer APIs.</span></span>

## <a name="xmlbuffercpp"></a><span data-ttu-id="50e5e-108">XmlBuffer. cpp</span><span class="sxs-lookup"><span data-stu-id="50e5e-108">XmlBuffer.cpp</span></span>
