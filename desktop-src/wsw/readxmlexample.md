...
description: Cet exemple lit le nœud XML par nœud.
ms.assetid: 938825f6-43dd-4e24-a04d-c46290509a64
keywords:
- Services Web ReadXmlExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104190714"
---
# <a name="readxmlexample"></a><span data-ttu-id="180b0-106">ReadXmlExample</span><span class="sxs-lookup"><span data-stu-id="180b0-106">ReadXmlExample</span></span>

<span data-ttu-id="180b0-107">Cet exemple lit le nœud XML par nœud.</span><span class="sxs-lookup"><span data-stu-id="180b0-107">This example reads XML node by node.</span></span>

## <a name="readxmlcpp"></a><span data-ttu-id="180b0-108">ReadXml. cpp</span><span class="sxs-lookup"><span data-stu-id="180b0-108">ReadXml.cpp</span></span>
