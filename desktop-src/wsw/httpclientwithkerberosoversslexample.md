...
description: Cet exemple montre un client HTTP qui envoie des messages de demande-réponse, avec Kerberos sur la sécurité SSL en mode mixte.
ms.assetid: 48b20c9b-38e7-472c-9606-b454850e14c1
keywords:
- HttpClientWithKerberosOverSslExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029874"
---
# <a name="httpclientwithkerberosoversslexample"></a><span data-ttu-id="458a5-106">HttpClientWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="458a5-106">HttpClientWithKerberosOverSslExample</span></span>

<span data-ttu-id="458a5-107">Cet exemple montre un client HTTP qui envoie des messages de demande-réponse, avec Kerberos sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="458a5-107">This example shows a HTTP client that sends request-reply messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="458a5-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="458a5-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="458a5-109">L’authentification du client est fournie par un ticket Kerberos APREQ dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="458a5-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="458a5-110">HttpClientWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="458a5-110">HttpClientWithKerberosOverSsl.cpp</span></span>](#httpclientwithkerberosoversslcpp)
-   [<span data-ttu-id="458a5-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="458a5-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="458a5-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="458a5-112">Makefile</span></span>](#makefile)

## <a name="httpclientwithkerberosoversslcpp"></a><span data-ttu-id="458a5-113">HttpClientWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="458a5-113">HttpClientWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="458a5-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="458a5-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="458a5-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="458a5-115">Makefile</span></span>
