...
description: Application cliente pour communiquer avec un service de calculatrice de session.
ms.assetid: 0981474c-cb87-4069-ab84-7662776c182e
keywords:
- SessionfullCalculatorClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103673018"
---
# <a name="sessionfullcalculatorclientexample"></a><span data-ttu-id="85038-106">SessionfullCalculatorClientExample</span><span class="sxs-lookup"><span data-stu-id="85038-106">SessionfullCalculatorClientExample</span></span>

<span data-ttu-id="85038-107">Application cliente pour communiquer avec un service de calculatrice de session.</span><span class="sxs-lookup"><span data-stu-id="85038-107">Client application to talk to a sessionful calculator service.</span></span>

-   [<span data-ttu-id="85038-108">SessionfullCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="85038-108">SessionfullCalculatorClient.cpp</span></span>](#sessionfullcalculatorclientcpp)
-   [<span data-ttu-id="85038-109">SessionBasedCalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="85038-109">SessionBasedCalculatorService.wsdl</span></span>](#sessionbasedcalculatorservicewsdl)
-   [<span data-ttu-id="85038-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="85038-110">Makefile</span></span>](#makefile)

## <a name="sessionfullcalculatorclientcpp"></a><span data-ttu-id="85038-111">SessionfullCalculatorClient. cpp</span><span class="sxs-lookup"><span data-stu-id="85038-111">SessionfullCalculatorClient.cpp</span></span>
...
## <a name="sessionbasedcalculatorservicewsdl"></a><span data-ttu-id="85038-112">SessionBasedCalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="85038-112">SessionBasedCalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="85038-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="85038-113">Makefile</span></span>
