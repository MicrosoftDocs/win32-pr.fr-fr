...
description: Consultez l’exemple de demande et de réponse à un serveur TCP qui utilise l’API des services Web Windows (WWSAPI). Cet exemple accepte un canal et reçoit et répond aux messages.
ms.assetid: da9a507b-952d-4378-a37f-c2c4407335e8
keywords:
- RequestReplyTcpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "112404082"
---
# <a name="requestreplytcpserverexample"></a><span data-ttu-id="f1f41-107">RequestReplyTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="f1f41-107">RequestReplyTcpServerExample</span></span>

<span data-ttu-id="f1f41-108">Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages.</span><span class="sxs-lookup"><span data-stu-id="f1f41-108">This example shows a TCP server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="f1f41-109">RequestReplyTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="f1f41-109">RequestReplyTcpServer.cpp</span></span>](#requestreplytcpservercpp)
-   [<span data-ttu-id="f1f41-110">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="f1f41-110">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f1f41-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="f1f41-111">Makefile</span></span>](#makefile)

## <a name="requestreplytcpservercpp"></a><span data-ttu-id="f1f41-112">RequestReplyTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="f1f41-112">RequestReplyTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f1f41-113">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="f1f41-113">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f1f41-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="f1f41-114">Makefile</span></span>
