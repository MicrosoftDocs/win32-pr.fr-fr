...
description: Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages.
...
ms.locfileid: "106509584"
---
# <a name="requestreplytcpserverexample"></a><span data-ttu-id="bc3fc-106">RequestReplyTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="bc3fc-106">RequestReplyTcpServerExample</span></span>

<span data-ttu-id="bc3fc-107">Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages.</span><span class="sxs-lookup"><span data-stu-id="bc3fc-107">This example shows a TCP server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="bc3fc-108">RequestReplyTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="bc3fc-108">RequestReplyTcpServer.cpp</span></span>](#requestreplytcpservercpp)
-   [<span data-ttu-id="bc3fc-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="bc3fc-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="bc3fc-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="bc3fc-110">Makefile</span></span>](#makefile)

## <a name="requestreplytcpservercpp"></a><span data-ttu-id="bc3fc-111">RequestReplyTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="bc3fc-111">RequestReplyTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="bc3fc-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="bc3fc-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="bc3fc-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="bc3fc-113">Makefile</span></span>
