...
description: consultez l’exemple de demande et de réponse à un serveur TCP qui utilise l’API de Services Web Windows (WWSAPI). Cet exemple accepte un canal et reçoit et répond aux messages.
