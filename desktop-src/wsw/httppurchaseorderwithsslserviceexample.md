...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP, avec la sécurité de transport SSL.
ms.assetid: 814660d7-98d7-4038-8243-d2f37929d516
keywords:
- HttpPurchaseOrderWithSslServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103840342"
---
# <a name="httppurchaseorderwithsslserviceexample"></a><span data-ttu-id="2283c-106">HttpPurchaseOrderWithSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="2283c-106">HttpPurchaseOrderWithSslServiceExample</span></span>

<span data-ttu-id="2283c-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP, avec la sécurité de transport SSL.</span><span class="sxs-lookup"><span data-stu-id="2283c-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="2283c-108">HttpPurchaseOrderServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="2283c-108">HttpPurchaseOrderServiceWithSsl.cpp</span></span>](#httppurchaseorderservicewithsslcpp)
-   [<span data-ttu-id="2283c-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="2283c-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="2283c-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="2283c-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicewithsslcpp"></a><span data-ttu-id="2283c-111">HttpPurchaseOrderServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="2283c-111">HttpPurchaseOrderServiceWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="2283c-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="2283c-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="2283c-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="2283c-113">Makefile</span></span>
