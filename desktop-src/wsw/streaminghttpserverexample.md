...
description: Cet exemple montre un serveur HTTP qui accepte un canal et effectue le traitement des demandes-réponses de façon continue.
ms.assetid: c108a5b3-923c-439c-8d86-7003a76ff45d
keywords:
- StreamingHttpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103840922"
---
# <a name="streaminghttpserverexample"></a><span data-ttu-id="286ec-106">StreamingHttpServerExample</span><span class="sxs-lookup"><span data-stu-id="286ec-106">StreamingHttpServerExample</span></span>

<span data-ttu-id="286ec-107">Cet exemple montre un serveur HTTP qui accepte un canal et effectue le traitement des demandes-réponses de façon continue.</span><span class="sxs-lookup"><span data-stu-id="286ec-107">This example shows an HTTP server that accepts a channel, and does request-reply processing in a streaming fashion.</span></span>

-   [<span data-ttu-id="286ec-108">StreamingHttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="286ec-108">StreamingHttpServer.cpp</span></span>](#streaminghttpservercpp)
-   [<span data-ttu-id="286ec-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="286ec-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="286ec-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="286ec-110">Makefile</span></span>](#makefile)

## <a name="streaminghttpservercpp"></a><span data-ttu-id="286ec-111">StreamingHttpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="286ec-111">StreamingHttpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="286ec-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="286ec-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="286ec-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="286ec-113">Makefile</span></span>
