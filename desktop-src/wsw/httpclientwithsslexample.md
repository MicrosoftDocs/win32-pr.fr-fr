...
description: Cet exemple montre un client HTTP qui envoie des messages de demande-réponse, avec la sécurité de transport SSL.
ms.assetid: 0e73baee-a56d-446e-ae2e-a3aae31d8508
keywords:
- HttpClientWithSslExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103670926"
---
# <a name="httpclientwithsslexample"></a><span data-ttu-id="51329-106">HttpClientWithSslExample</span><span class="sxs-lookup"><span data-stu-id="51329-106">HttpClientWithSslExample</span></span>

<span data-ttu-id="51329-107">Cet exemple montre un client HTTP qui envoie des messages de demande-réponse, avec la sécurité de transport SSL.</span><span class="sxs-lookup"><span data-stu-id="51329-107">This example shows a HTTP client that sends request-reply messages, with SSL transport security.</span></span>

-   [<span data-ttu-id="51329-108">HttpClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="51329-108">HttpClientWithSsl.cpp</span></span>](#httpclientwithsslcpp)
-   [<span data-ttu-id="51329-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="51329-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="51329-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="51329-110">Makefile</span></span>](#makefile)

## <a name="httpclientwithsslcpp"></a><span data-ttu-id="51329-111">HttpClientWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="51329-111">HttpClientWithSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="51329-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="51329-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="51329-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="51329-113">Makefile</span></span>
