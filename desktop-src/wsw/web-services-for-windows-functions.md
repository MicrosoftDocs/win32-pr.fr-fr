---
title: Windows Fonctions des services Web
description: les fonctions de services web Windows prennent en charge le modèle de programmation basé sur une méthode de l’API des services web Windows.
