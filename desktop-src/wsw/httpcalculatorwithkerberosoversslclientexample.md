...
description: Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service de calculatrice, avec Kerberos sur la sécurité SSL en mode mixte.
ms.assetid: eb3ae71f-0bbb-42d7-af81-20c5dbb03c3f
keywords:
- HttpCalculatorWithKerberosOverSslClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104311458"
---
# <a name="httpcalculatorwithkerberosoversslclientexample"></a><span data-ttu-id="89746-106">HttpCalculatorWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="89746-106">HttpCalculatorWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="89746-107">Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service de calculatrice, avec Kerberos sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="89746-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="89746-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="89746-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="89746-109">L’authentification du client est fournie par un ticket Kerberos APREQ dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="89746-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="89746-110">CalculatorClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="89746-110">CalculatorClientKerberosOverSsl.cpp</span></span>](#calculatorclientkerberosoversslcpp)
-   [<span data-ttu-id="89746-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="89746-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="89746-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="89746-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientkerberosoversslcpp"></a><span data-ttu-id="89746-113">CalculatorClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="89746-113">CalculatorClientKerberosOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="89746-114">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="89746-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="89746-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="89746-115">Makefile</span></span>
