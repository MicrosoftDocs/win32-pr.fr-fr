...
description: Cet exemple montre comment ajouter et récupérer un en-tête personnalisé.
ms.assetid: 9c0cabee-4645-4b2d-a132-4494911f05b3
keywords:
- Services Web CustomHeaderExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106510642"
---
# <a name="customheaderexample"></a><span data-ttu-id="b65f6-106">CustomHeaderExample</span><span class="sxs-lookup"><span data-stu-id="b65f6-106">CustomHeaderExample</span></span>

<span data-ttu-id="b65f6-107">Cet exemple montre comment ajouter et récupérer un en-tête personnalisé.</span><span class="sxs-lookup"><span data-stu-id="b65f6-107">This example shows how to add and retrieve a custom header.</span></span>

-   [<span data-ttu-id="b65f6-108">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="b65f6-108">CustomHeader.cpp</span></span>](#customheadercpp)
-   [<span data-ttu-id="b65f6-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="b65f6-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="b65f6-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="b65f6-110">Makefile</span></span>](#makefile)

## <a name="customheadercpp"></a><span data-ttu-id="b65f6-111">CustomHeader. cpp</span><span class="sxs-lookup"><span data-stu-id="b65f6-111">CustomHeader.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="b65f6-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="b65f6-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="b65f6-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="b65f6-113">Makefile</span></span>
