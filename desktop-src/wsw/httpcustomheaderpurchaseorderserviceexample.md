...
description: passez en revue une Windows exemple C++ de l’API des Services Web (WWSAPI) d’un service de bon de commande sur des en-têtes personnalisés HTTP.
