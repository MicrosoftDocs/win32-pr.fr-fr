...
description: Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service de calculatrice, avec un nom d’utilisateur sur la sécurité SSL en mode mixte.
ms.assetid: 82f27502-0f18-4b30-9da1-9191e34366c6
keywords:
- HttpCalculatorWithUsernameOverSslClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106512435"
---
# <a name="httpcalculatorwithusernameoversslclientexample"></a><span data-ttu-id="d6377-106">HttpCalculatorWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="d6377-106">HttpCalculatorWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="d6377-107">Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service de calculatrice, avec un nom d’utilisateur sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="d6377-107">This example shows a HTTP client that uses service proxy to talk to a calculator service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="d6377-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="d6377-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="d6377-109">L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="d6377-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="d6377-110">CalculatorClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d6377-110">CalculatorClientUserNameOverSsl.cpp</span></span>](#calculatorclientusernameoversslcpp)
-   [<span data-ttu-id="d6377-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="d6377-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="d6377-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="d6377-112">Makefile</span></span>](#makefile)

## <a name="calculatorclientusernameoversslcpp"></a><span data-ttu-id="d6377-113">CalculatorClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="d6377-113">CalculatorClientUserNameOverSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="d6377-114">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="d6377-114">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d6377-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="d6377-115">Makefile</span></span>
