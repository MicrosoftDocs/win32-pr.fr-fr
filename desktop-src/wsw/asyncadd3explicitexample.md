...
description: Cet exemple illustre l’implémentation d’une fonction asynchrone complexe sans utiliser WsAsyncExecute.
ms.assetid: e60a4005-4849-4603-ae25-b88da8628f80
keywords:
- Services Web AsyncAdd3ExplicitExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104380028"
---
# <a name="asyncadd3explicitexample"></a><span data-ttu-id="2616e-106">AsyncAdd3ExplicitExample</span><span class="sxs-lookup"><span data-stu-id="2616e-106">AsyncAdd3ExplicitExample</span></span>

<span data-ttu-id="2616e-107">Cet exemple illustre l’implémentation d’une fonction asynchrone complexe sans utiliser [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span><span class="sxs-lookup"><span data-stu-id="2616e-107">This example illustrates implementing a complex asynchronous function without using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="2616e-108">L’exemple implémente une fonction asynchrone’AddThree’qui ajoute trois entiers ensemble en générant une fonction Add existante qui peut ajouter deux entiers de façon asynchrone.</span><span class="sxs-lookup"><span data-stu-id="2616e-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3explicitcpp"></a><span data-ttu-id="2616e-109">AsyncAdd3Explicit. cpp</span><span class="sxs-lookup"><span data-stu-id="2616e-109">AsyncAdd3Explicit.cpp</span></span>
