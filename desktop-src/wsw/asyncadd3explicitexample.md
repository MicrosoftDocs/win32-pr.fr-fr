...
ms.locfileid: "118963418"
---
# <a name="asyncadd3explicitexample"></a>AsyncAdd3ExplicitExample

Cet exemple illustre l’implémentation d’une fonction asynchrone complexe sans utiliser [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).

L’exemple implémente une fonction asynchrone’AddThree’qui ajoute trois entiers ensemble en générant une fonction Add existante qui peut ajouter deux entiers de façon asynchrone.
