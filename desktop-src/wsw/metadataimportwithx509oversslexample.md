...
Cet exemple illustre l’importation de métadonnées à partir d’un point de terminaison qui prend en charge l’utilisation d’un jeton x509 à l’aide d’une liaison de sécurité de [**\_ \_ message de jeton \_ \_ \_ XML WS**](/windows/desktop/api/WebServices/ns-webservices-ws_xml_token_message_security_binding) avec [**WS \_ SSL \_ transport \_ Security \_**](/windows/desktop/api/WebServices/ns-webservices-ws_ssl_transport_security_binding).
