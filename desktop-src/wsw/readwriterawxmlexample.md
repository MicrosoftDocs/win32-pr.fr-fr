...
description: Cet exemple montre la lecture et l’écriture de données XML à l’aide de l’encodage brut.
ms.assetid: e13e6add-f58b-468a-a472-f0aa29d030b3
keywords:
- API des services Web Windows ReadWriteRawXmlExample
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028525"
---
# <a name="readwriterawxmlexample"></a><span data-ttu-id="e7ec3-106">ReadWriteRawXmlExample</span><span class="sxs-lookup"><span data-stu-id="e7ec3-106">ReadWriteRawXmlExample</span></span>

<span data-ttu-id="e7ec3-107">Cet exemple montre la lecture et l’écriture de données XML à l’aide de l’encodage brut.</span><span class="sxs-lookup"><span data-stu-id="e7ec3-107">This example shows reading and writing of xml using the raw encoding.</span></span>

## <a name="readwriterawxmlcpp"></a><span data-ttu-id="e7ec3-108">ReadWriteRawXml. cpp</span><span class="sxs-lookup"><span data-stu-id="e7ec3-108">ReadWriteRawXml.cpp</span></span>
