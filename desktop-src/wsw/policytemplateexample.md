...
Cet exemple montre comment créer manuellement une description de stratégie et l’utiliser pour créer un proxy de service.

-   [Modèle policytemplate. cpp](#policytemplatecpp)
-   [Makefile](#makefile)

## <a name="policytemplatecpp"></a>Modèle policytemplate. cpp
