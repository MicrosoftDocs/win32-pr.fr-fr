...
description: Cet exemple montre comment créer manuellement une description de stratégie et l’utiliser pour créer un proxy de service.
ms.assetid: 1c7ff0fb-06a2-4285-bbc8-ea8f2d82b15b
keywords:
- PolicyTemplateExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029446"
---
# <a name="policytemplateexample"></a><span data-ttu-id="83c24-106">PolicyTemplateExample</span><span class="sxs-lookup"><span data-stu-id="83c24-106">PolicyTemplateExample</span></span>

<span data-ttu-id="83c24-107">Cet exemple montre comment créer manuellement une description de stratégie et l’utiliser pour créer un proxy de service.</span><span class="sxs-lookup"><span data-stu-id="83c24-107">This example illustrates how to manually create policy description and use it to create service proxy.</span></span>

-   [<span data-ttu-id="83c24-108">Modèle policytemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="83c24-108">PolicyTemplate.cpp</span></span>](#policytemplatecpp)
-   [<span data-ttu-id="83c24-109">Makefile</span><span class="sxs-lookup"><span data-stu-id="83c24-109">Makefile</span></span>](#makefile)

## <a name="policytemplatecpp"></a><span data-ttu-id="83c24-110">Modèle policytemplate. cpp</span><span class="sxs-lookup"><span data-stu-id="83c24-110">PolicyTemplate.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="83c24-111">Makefile</span><span class="sxs-lookup"><span data-stu-id="83c24-111">Makefile</span></span>
