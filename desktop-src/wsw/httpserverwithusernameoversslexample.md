...
description: Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages, avec le nom d’utilisateur sur la sécurité SSL en mode mixte.
ms.assetid: d70ae988-0d7c-4494-a54d-1cd73ab8a8ce
keywords:
- HttpServerWithUsernameOverSslExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106511244"
---
# <a name="httpserverwithusernameoversslexample"></a><span data-ttu-id="123e5-106">HttpServerWithUsernameOverSslExample</span><span class="sxs-lookup"><span data-stu-id="123e5-106">HttpServerWithUsernameOverSslExample</span></span>

<span data-ttu-id="123e5-107">Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages, avec le nom d’utilisateur sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="123e5-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="123e5-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="123e5-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="123e5-109">L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="123e5-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="123e5-110">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="123e5-110">HttpServerWithUsernameOverSsl.cpp</span></span>](#httpserverwithusernameoversslcpp)
-   [<span data-ttu-id="123e5-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="123e5-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="123e5-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="123e5-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithusernameoversslcpp"></a><span data-ttu-id="123e5-113">HttpServerWithUsernameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="123e5-113">HttpServerWithUsernameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="123e5-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="123e5-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="123e5-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="123e5-115">Makefile</span></span>
