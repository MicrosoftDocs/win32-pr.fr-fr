...
description: Cet exemple est le côté client qui envoie des requêtes HTTP brutes.
ms.assetid: bc9e108e-d4a0-4bdd-82c2-5486ea46364b
keywords:
- HttpRawClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103840341"
---
# <a name="httprawclientexample"></a><span data-ttu-id="f7736-106">HttpRawClientExample</span><span class="sxs-lookup"><span data-stu-id="f7736-106">HttpRawClientExample</span></span>

<span data-ttu-id="f7736-107">Cet exemple est le côté client qui envoie des requêtes HTTP brutes.</span><span class="sxs-lookup"><span data-stu-id="f7736-107">This example is the client side that sends raw HTTP requests.</span></span>

## <a name="httprawclientcpp"></a><span data-ttu-id="f7736-108">HttpRawClient. cpp</span><span class="sxs-lookup"><span data-stu-id="f7736-108">HttpRawClient.cpp</span></span>
