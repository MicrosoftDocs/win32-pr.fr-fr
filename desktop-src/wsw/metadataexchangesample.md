...
Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur TCP. Le service prend également en charge WS-MetadataExchange.
