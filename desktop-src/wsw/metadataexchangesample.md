...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur TCP. Le service prend également en charge WS-MetadataExchange.
ms.assetid: 8f14e6a8-ccb9-4556-b04f-df08c6c80adf
keywords:
- API des services Web Windows MetadataExchangeSample
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028792"
---
# <a name="metadataexchangesample"></a><span data-ttu-id="0aa62-107">MetadataExchangeSample</span><span class="sxs-lookup"><span data-stu-id="0aa62-107">MetadataExchangeSample</span></span>

<span data-ttu-id="0aa62-108">Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur TCP.</span><span class="sxs-lookup"><span data-stu-id="0aa62-108">This example shows how to use service host for hosting a PurchaseOrder service over TCP.</span></span> <span data-ttu-id="0aa62-109">Le service prend également en charge WS-MetadataExchange.</span><span class="sxs-lookup"><span data-stu-id="0aa62-109">The service also supports WS-MetadataExchange.</span></span>

-   [<span data-ttu-id="0aa62-110">MexService. cpp</span><span class="sxs-lookup"><span data-stu-id="0aa62-110">MexService.cpp</span></span>](#mexservicecpp)
-   [<span data-ttu-id="0aa62-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0aa62-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="0aa62-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="0aa62-112">Makefile</span></span>](#makefile)

## <a name="mexservicecpp"></a><span data-ttu-id="0aa62-113">MexService. cpp</span><span class="sxs-lookup"><span data-stu-id="0aa62-113">MexService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="0aa62-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="0aa62-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0aa62-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="0aa62-115">Makefile</span></span>
