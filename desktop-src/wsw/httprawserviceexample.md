...
description: Cet exemple montre comment utiliser l’hôte de service pour gérer les requêtes HTTP brutes (non-SOAP).
ms.assetid: fbe5ad9c-f3f4-40c2-86e0-03b945aab89f
keywords:
- HttpRawServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103674365"
---
# <a name="httprawserviceexample"></a><span data-ttu-id="d0e2d-106">HttpRawServiceExample</span><span class="sxs-lookup"><span data-stu-id="d0e2d-106">HttpRawServiceExample</span></span>

<span data-ttu-id="d0e2d-107">Cet exemple montre comment utiliser l’hôte de service pour gérer les requêtes HTTP brutes (non-SOAP).</span><span class="sxs-lookup"><span data-stu-id="d0e2d-107">This example shows how to use service host to handle raw (non-SOAP) HTTP requests.</span></span>

## <a name="httprawservicecpp"></a><span data-ttu-id="d0e2d-108">HttpRawService. cpp</span><span class="sxs-lookup"><span data-stu-id="d0e2d-108">HttpRawService.cpp</span></span>
