...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice sur HTTP, avec la sécurité de transport SSL.
ms.assetid: 15e61f32-73b5-4359-957d-9694fe947b1e
keywords:
- HttpCalculatorWithSslServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106513657"
---
# <a name="httpcalculatorwithsslserviceexample"></a><span data-ttu-id="97a5b-106">HttpCalculatorWithSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="97a5b-106">HttpCalculatorWithSslServiceExample</span></span>

<span data-ttu-id="97a5b-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice sur HTTP, avec la sécurité de transport SSL.</span><span class="sxs-lookup"><span data-stu-id="97a5b-107">This example shows how to use service host for hosting a calculator service over HTTP, with SSL transport security.</span></span>

-   [<span data-ttu-id="97a5b-108">HttpCalculatorServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="97a5b-108">HttpCalculatorServiceWithSsl.cpp</span></span>](#httpcalculatorservicewithsslcpp)
-   [<span data-ttu-id="97a5b-109">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="97a5b-109">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="97a5b-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="97a5b-110">Makefile</span></span>](#makefile)

## <a name="httpcalculatorservicewithsslcpp"></a><span data-ttu-id="97a5b-111">HttpCalculatorServiceWithSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="97a5b-111">HttpCalculatorServiceWithSsl.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="97a5b-112">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="97a5b-112">CalculatorService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="97a5b-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="97a5b-113">Makefile</span></span>
