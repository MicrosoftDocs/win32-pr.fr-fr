...
description: Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP, avec Kerberos sur la sécurité SSL en mode mixte.
ms.assetid: 9fbf5577-6a54-4ce1-ad44-80b9ee91c0d3
keywords:
- HttpPurchaseOrderWithKerberosOverSslServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106509201"
---
# <a name="httppurchaseorderwithkerberosoversslserviceexample"></a><span data-ttu-id="eb2c6-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span><span class="sxs-lookup"><span data-stu-id="eb2c6-106">HttpPurchaseOrderWithKerberosOverSslServiceExample</span></span>

<span data-ttu-id="eb2c6-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP, avec Kerberos sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="eb2c6-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="eb2c6-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="eb2c6-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="eb2c6-109">L’authentification du client est fournie par un ticket Kerberos APREQ dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="eb2c6-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="eb2c6-110">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="eb2c6-110">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>](#purchaseorderservicekerberosoversslcpp)
-   [<span data-ttu-id="eb2c6-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="eb2c6-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="eb2c6-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="eb2c6-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderservicekerberosoversslcpp"></a><span data-ttu-id="eb2c6-113">PurchaseOrderServiceKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="eb2c6-113">PurchaseOrderServiceKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="eb2c6-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="eb2c6-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="eb2c6-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="eb2c6-115">Makefile</span></span>
