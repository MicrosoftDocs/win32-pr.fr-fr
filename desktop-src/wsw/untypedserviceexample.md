...
Cet exemple montre comment implémenter un service non typé avec un modèle de service. Dans ce cas, le modèle de service fournit l’infrastructure de la plaque de chaudière.
