...
description: Cet exemple montre comment implémenter un service non typé avec un modèle de service. Dans ce cas, le modèle de service fournit l’infrastructure de la plaque de chaudière.
ms.assetid: 4235554e-19a8-4df7-97a5-2f7544a3c830
keywords:
- UnTypedServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104028885"
---
# <a name="untypedserviceexample"></a><span data-ttu-id="5a460-107">UnTypedServiceExample</span><span class="sxs-lookup"><span data-stu-id="5a460-107">UnTypedServiceExample</span></span>

<span data-ttu-id="5a460-108">Cet exemple montre comment implémenter un service non typé avec un modèle de service.</span><span class="sxs-lookup"><span data-stu-id="5a460-108">This sample shows how implement an untyped service with Service Model.</span></span> <span data-ttu-id="5a460-109">Dans ce cas, le modèle de service fournit l’infrastructure de la plaque de chaudière.</span><span class="sxs-lookup"><span data-stu-id="5a460-109">Service Model in this case provides the boiler plate infrastructure.</span></span>

-   [<span data-ttu-id="5a460-110">UnTypedService. cpp</span><span class="sxs-lookup"><span data-stu-id="5a460-110">UnTypedService.cpp</span></span>](#untypedservicecpp)
-   [<span data-ttu-id="5a460-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5a460-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="5a460-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="5a460-112">Makefile</span></span>](#makefile)

## <a name="untypedservicecpp"></a><span data-ttu-id="5a460-113">UnTypedService. cpp</span><span class="sxs-lookup"><span data-stu-id="5a460-113">UnTypedService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="5a460-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="5a460-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="5a460-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="5a460-115">Makefile</span></span>
