...
description: Cet exemple montre comment insérer un élément dans une mémoire tampon XML.
ms.assetid: 98fed487-77f8-4224-9a73-b20afcb01d47
keywords:
- InsertElementExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
---
# <a name="insertelementexample"></a><span data-ttu-id="7a138-106">InsertElementExample</span><span class="sxs-lookup"><span data-stu-id="7a138-106">InsertElementExample</span></span>

<span data-ttu-id="7a138-107">Cet exemple montre comment insérer un élément dans une mémoire tampon XML.</span><span class="sxs-lookup"><span data-stu-id="7a138-107">This example shows how to insert an element in an xml buffer.</span></span>

## <a name="insertelementcpp"></a><span data-ttu-id="7a138-108">InsertElement. cpp</span><span class="sxs-lookup"><span data-stu-id="7a138-108">InsertElement.cpp</span></span>
