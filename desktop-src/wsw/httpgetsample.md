...
---
# <a name="httpgetsample"></a><span data-ttu-id="d9fae-108">HttpGetSample</span><span class="sxs-lookup"><span data-stu-id="d9fae-108">HttpGetSample</span></span>

<span data-ttu-id="d9fae-109">Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP.</span><span class="sxs-lookup"><span data-stu-id="d9fae-109">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span> <span data-ttu-id="d9fae-110">Le service expose des métadonnées sur HTTP et WS-Metadata Exchange v 1.1.</span><span class="sxs-lookup"><span data-stu-id="d9fae-110">The service exposes metadata over HTTP GET and WS-Metadata Exchange v1.1.</span></span> <span data-ttu-id="d9fae-111">Le service montre également comment implémenter une page de couverture pour un service WWSAPI.</span><span class="sxs-lookup"><span data-stu-id="d9fae-111">The service also shows how to implement a cover page for a WWSAPI service.</span></span>

-   [<span data-ttu-id="d9fae-112">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="d9fae-112">HttpGetService.cpp</span></span>](#httpgetservicecpp)
-   [<span data-ttu-id="d9fae-113">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d9fae-113">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d9fae-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="d9fae-114">Makefile</span></span>](#makefile)

## <a name="httpgetservicecpp"></a><span data-ttu-id="d9fae-115">HttpGetService. cpp</span><span class="sxs-lookup"><span data-stu-id="d9fae-115">HttpGetService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d9fae-116">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d9fae-116">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d9fae-117">Makefile</span><span class="sxs-lookup"><span data-stu-id="d9fae-117">Makefile</span></span>
