...
description: Consultez un exemple C++ de l’API des services Web Windows (WWSAPI) sur l’utilisation de l’hôte de service pour l’hébergement d’un service de bon de commande sur HTTP.
ms.assetid: 03da84b6-082f-41cd-810d-b593a55fa563
keywords:
- HttpPurchaseOrderServiceExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "112404112"
---
# <a name="httppurchaseorderserviceexample"></a><span data-ttu-id="48f6a-106">HttpPurchaseOrderServiceExample</span><span class="sxs-lookup"><span data-stu-id="48f6a-106">HttpPurchaseOrderServiceExample</span></span>

<span data-ttu-id="48f6a-107">Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP.</span><span class="sxs-lookup"><span data-stu-id="48f6a-107">This example shows how to use service host for hosting a PurchaseOrder service over HTTP.</span></span>

-   [<span data-ttu-id="48f6a-108">HttpPurchaseOrderService. cpp</span><span class="sxs-lookup"><span data-stu-id="48f6a-108">HttpPurchaseOrderService.cpp</span></span>](#httppurchaseorderservicecpp)
-   [<span data-ttu-id="48f6a-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="48f6a-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="48f6a-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="48f6a-110">Makefile</span></span>](#makefile)

## <a name="httppurchaseorderservicecpp"></a><span data-ttu-id="48f6a-111">HttpPurchaseOrderService. cpp</span><span class="sxs-lookup"><span data-stu-id="48f6a-111">HttpPurchaseOrderService.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="48f6a-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="48f6a-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="48f6a-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="48f6a-113">Makefile</span></span>
