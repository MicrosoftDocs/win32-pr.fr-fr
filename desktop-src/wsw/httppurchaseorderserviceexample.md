...
description: passez en revue un Windows exemple C++ de l’API des Services Web (WWSAPI) sur l’utilisation de l’hôte de service pour l’hébergement d’un service de bon de commande sur HTTP.
...
ms.locfileid: "118963208"
---
# <a name="httppurchaseorderserviceexample"></a>HttpPurchaseOrderServiceExample

Cet exemple montre comment utiliser un hôte de service pour héberger un service PurchaseOrder sur HTTP.
