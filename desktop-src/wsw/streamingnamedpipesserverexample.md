...
ms.locfileid: "119083123"
---
# <a name="streamingnamedpipesserverexample"></a>StreamingNamedPipesServerExample

Cet exemple montre un client de canaux nommés qui accepte un canal et lit les messages unidirectionnels en mode de diffusion en continu.
