...
description: Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP à l’aide d’un canal personnalisé. Le canal utilise un encodeur personnalisé.
ms.assetid: cef3db1d-6362-4599-a4bf-f43079848691
keywords:
- HttpCalculatorWithEncodedChannelClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103940329"
---
# <a name="httpcalculatorwithencodedchannelclientexample"></a><span data-ttu-id="4d83f-107">HttpCalculatorWithEncodedChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="4d83f-107">HttpCalculatorWithEncodedChannelClientExample</span></span>

<span data-ttu-id="4d83f-108">Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP à l’aide d’un canal personnalisé.</span><span class="sxs-lookup"><span data-stu-id="4d83f-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="4d83f-109">Le canal utilise un encodeur personnalisé.</span><span class="sxs-lookup"><span data-stu-id="4d83f-109">The channel is uses a custom encoder.</span></span>

-   [<span data-ttu-id="4d83f-110">HttpCalculatorWithEncodedChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4d83f-110">HttpCalculatorWithEncodedChannelClient.cpp</span></span>](#httpcalculatorwithencodedchannelclientcpp)
-   [<span data-ttu-id="4d83f-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="4d83f-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="4d83f-112">EncodedChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="4d83f-112">EncodedChannel.cpp</span></span>](#encodedchannelcpp)
-   [<span data-ttu-id="4d83f-113">EncodedChannel. h</span><span class="sxs-lookup"><span data-stu-id="4d83f-113">EncodedChannel.h</span></span>](#encodedchannelh)
-   [<span data-ttu-id="4d83f-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="4d83f-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithencodedchannelclientcpp"></a><span data-ttu-id="4d83f-115">HttpCalculatorWithEncodedChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="4d83f-115">HttpCalculatorWithEncodedChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="4d83f-116">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="4d83f-116">CalculatorService.wsdl</span></span>
...
## <a name="encodedchannelcpp"></a><span data-ttu-id="4d83f-117">EncodedChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="4d83f-117">EncodedChannel.cpp</span></span>
...
## <a name="encodedchannelh"></a><span data-ttu-id="4d83f-118">EncodedChannel. h</span><span class="sxs-lookup"><span data-stu-id="4d83f-118">EncodedChannel.h</span></span>
...
## <a name="makefile"></a><span data-ttu-id="4d83f-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="4d83f-119">Makefile</span></span>
