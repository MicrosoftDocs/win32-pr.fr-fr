...
description: Cet exemple montre un client UDP qui envoie des messages unidirectionnels.
ms.assetid: 245876f7-dc79-4ecd-b510-cf5e60eaa9fc
keywords:
- OneWayUdpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103940262"
---
# <a name="onewayudpclientexample"></a><span data-ttu-id="9748e-106">OneWayUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="9748e-106">OneWayUdpClientExample</span></span>

<span data-ttu-id="9748e-107">Cet exemple montre un client UDP qui envoie des messages unidirectionnels.</span><span class="sxs-lookup"><span data-stu-id="9748e-107">This example shows a UDP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="9748e-108">OneWayUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9748e-108">OneWayUdpClient.cpp</span></span>](#onewayudpclientcpp)
-   [<span data-ttu-id="9748e-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="9748e-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9748e-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="9748e-110">Makefile</span></span>](#makefile)

## <a name="onewayudpclientcpp"></a><span data-ttu-id="9748e-111">OneWayUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="9748e-111">OneWayUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9748e-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="9748e-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9748e-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="9748e-113">Makefile</span></span>
