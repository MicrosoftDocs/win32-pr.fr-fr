...
description: Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service PurchaseOrder, avec Kerberos sur la sécurité SSL en mode mixte.
ms.assetid: 6756043c-ef4c-4fa6-a27b-7ecb900601f9
keywords:
- HttpPurchaseOrderWithKerberosOverSslClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104380088"
---
# <a name="httppurchaseorderwithkerberosoversslclientexample"></a><span data-ttu-id="40a92-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="40a92-106">HttpPurchaseOrderWithKerberosOverSslClientExample</span></span>

<span data-ttu-id="40a92-107">Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service PurchaseOrder, avec Kerberos sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="40a92-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="40a92-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="40a92-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="40a92-109">L’authentification du client est fournie par un ticket Kerberos APREQ dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="40a92-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="40a92-110">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="40a92-110">PurchaseOrderClientKerberosOverSsl.cpp</span></span>](#purchaseorderclientkerberosoversslcpp)
-   [<span data-ttu-id="40a92-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="40a92-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="40a92-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="40a92-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientkerberosoversslcpp"></a><span data-ttu-id="40a92-113">PurchaseOrderClientKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="40a92-113">PurchaseOrderClientKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="40a92-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="40a92-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="40a92-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="40a92-115">Makefile</span></span>
