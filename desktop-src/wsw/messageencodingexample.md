...
description: Cet exemple encode et décode un message.
ms.assetid: b1f0a1df-22be-4c86-9a7a-0a4d4f363206
keywords:
- Services Web MessageEncodingExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029277"
---
# <a name="messageencodingexample"></a><span data-ttu-id="842af-106">MessageEncodingExample</span><span class="sxs-lookup"><span data-stu-id="842af-106">MessageEncodingExample</span></span>

<span data-ttu-id="842af-107">Cet exemple encode et décode un message.</span><span class="sxs-lookup"><span data-stu-id="842af-107">This example encodes and decodes a message.</span></span>

-   [<span data-ttu-id="842af-108">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="842af-108">MessageEncoding.cpp</span></span>](#messageencodingcpp)
-   [<span data-ttu-id="842af-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="842af-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="842af-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="842af-110">Makefile</span></span>](#makefile)

## <a name="messageencodingcpp"></a><span data-ttu-id="842af-111">MessageEncoding. cpp</span><span class="sxs-lookup"><span data-stu-id="842af-111">MessageEncoding.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="842af-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="842af-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="842af-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="842af-113">Makefile</span></span>
