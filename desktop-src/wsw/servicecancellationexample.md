...
description: Exemple d’application cliente illustrant l’annulation du service.
ms.assetid: c9e727c8-5fa7-47b9-8624-18fe4de79026
keywords:
- ServiceCancellationExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103839061"
---
# <a name="servicecancellationexample"></a><span data-ttu-id="0bead-106">ServiceCancellationExample</span><span class="sxs-lookup"><span data-stu-id="0bead-106">ServiceCancellationExample</span></span>

<span data-ttu-id="0bead-107">Exemple d’application cliente illustrant l’annulation du service.</span><span class="sxs-lookup"><span data-stu-id="0bead-107">Example client application demonstrating service cancellation.</span></span>

-   [<span data-ttu-id="0bead-108">ServiceCancel. cpp</span><span class="sxs-lookup"><span data-stu-id="0bead-108">ServiceCancel.cpp</span></span>](#servicecancelcpp)
-   [<span data-ttu-id="0bead-109">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="0bead-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="0bead-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="0bead-110">Makefile</span></span>](#makefile)

## <a name="servicecancelcpp"></a><span data-ttu-id="0bead-111">ServiceCancel. cpp</span><span class="sxs-lookup"><span data-stu-id="0bead-111">ServiceCancel.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="0bead-112">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="0bead-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="0bead-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="0bead-113">Makefile</span></span>
