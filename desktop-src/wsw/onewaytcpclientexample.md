...
description: Cet exemple montre un client TCP qui envoie des messages unidirectionnels.
ms.assetid: c5e930b5-da13-459c-8a83-eeeb120a79ed
keywords:
- OneWayTcpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106511450"
---
# <a name="onewaytcpclientexample"></a><span data-ttu-id="f01d9-106">OneWayTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="f01d9-106">OneWayTcpClientExample</span></span>

<span data-ttu-id="f01d9-107">Cet exemple montre un client TCP qui envoie des messages unidirectionnels.</span><span class="sxs-lookup"><span data-stu-id="f01d9-107">This example shows a TCP client that sends a one-way messages.</span></span>

-   [<span data-ttu-id="f01d9-108">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="f01d9-108">OneWayTcpClient.cpp</span></span>](#onewaytcpclientcpp)
-   [<span data-ttu-id="f01d9-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="f01d9-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="f01d9-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="f01d9-110">Makefile</span></span>](#makefile)

## <a name="onewaytcpclientcpp"></a><span data-ttu-id="f01d9-111">OneWayTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="f01d9-111">OneWayTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="f01d9-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="f01d9-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="f01d9-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="f01d9-113">Makefile</span></span>
