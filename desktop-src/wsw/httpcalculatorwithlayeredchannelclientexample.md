...
description: Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP à l’aide d’un canal personnalisé. Le canal personnalisé est un canal superposé qui délègue simplement toutes les fonctionnalités au canal HTTP existant.
ms.assetid: 897673df-f3a3-4b38-8b79-c9f1119be6d5
keywords:
- HttpCalculatorWithLayeredChannelClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106540751"
---
# <a name="httpcalculatorwithlayeredchannelclientexample"></a><span data-ttu-id="cee4a-107">HttpCalculatorWithLayeredChannelClientExample</span><span class="sxs-lookup"><span data-stu-id="cee4a-107">HttpCalculatorWithLayeredChannelClientExample</span></span>

<span data-ttu-id="cee4a-108">Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP à l’aide d’un canal personnalisé.</span><span class="sxs-lookup"><span data-stu-id="cee4a-108">This example show how to use the service proxy to talk to an HTTP based calculator service using a custom channel.</span></span> <span data-ttu-id="cee4a-109">Le canal personnalisé est un canal superposé qui délègue simplement toutes les fonctionnalités au canal HTTP existant.</span><span class="sxs-lookup"><span data-stu-id="cee4a-109">The custom channel is a layered channel which simply delegates all functionality to the existing HTTP channel.</span></span>

-   [<span data-ttu-id="cee4a-110">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="cee4a-110">HttpCalculatorWithLayeredChannelClient.cpp</span></span>](#httpcalculatorwithlayeredchannelclientcpp)
-   [<span data-ttu-id="cee4a-111">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="cee4a-111">CalculatorService.wsdl</span></span>](#calculatorservicewsdl)
-   [<span data-ttu-id="cee4a-112">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="cee4a-112">LayeredChannel.h</span></span>](#layeredchannelh)
-   [<span data-ttu-id="cee4a-113">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="cee4a-113">LayeredChannel.cpp</span></span>](#layeredchannelcpp)
-   [<span data-ttu-id="cee4a-114">Makefile</span><span class="sxs-lookup"><span data-stu-id="cee4a-114">Makefile</span></span>](#makefile)

## <a name="httpcalculatorwithlayeredchannelclientcpp"></a><span data-ttu-id="cee4a-115">HttpCalculatorWithLayeredChannelClient. cpp</span><span class="sxs-lookup"><span data-stu-id="cee4a-115">HttpCalculatorWithLayeredChannelClient.cpp</span></span>
...
## <a name="calculatorservicewsdl"></a><span data-ttu-id="cee4a-116">CalculatorService. wsdl</span><span class="sxs-lookup"><span data-stu-id="cee4a-116">CalculatorService.wsdl</span></span>
...
## <a name="layeredchannelh"></a><span data-ttu-id="cee4a-117">LayeredChannel. h</span><span class="sxs-lookup"><span data-stu-id="cee4a-117">LayeredChannel.h</span></span>
...
## <a name="layeredchannelcpp"></a><span data-ttu-id="cee4a-118">LayeredChannel. cpp</span><span class="sxs-lookup"><span data-stu-id="cee4a-118">LayeredChannel.cpp</span></span>
...
## <a name="makefile"></a><span data-ttu-id="cee4a-119">Makefile</span><span class="sxs-lookup"><span data-stu-id="cee4a-119">Makefile</span></span>
