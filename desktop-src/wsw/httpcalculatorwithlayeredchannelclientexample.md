...
Cet exemple montre comment utiliser le proxy de service pour communiquer avec un service de calculatrice HTTP à l’aide d’un canal personnalisé. Le canal personnalisé est un canal superposé qui délègue simplement toutes les fonctionnalités au canal HTTP existant.
