...
description: Cet exemple montre un serveur de canaux nommés qui accepte un canal et reçoit et répond aux messages avec la sécurité fournie par la sécurité de transport Windows SSPI.
...
ms.locfileid: "104028520"
---
# <a name="requestreplynamedpipesserverwithwindowstransportsecurityexample"></a><span data-ttu-id="401a0-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span><span class="sxs-lookup"><span data-stu-id="401a0-103">RequestReplyNamedPipesServerWithWindowsTransportSecurityExample</span></span>

<span data-ttu-id="401a0-104">Cet exemple montre un serveur de canaux nommés qui accepte un canal et reçoit et répond aux messages avec la sécurité fournie par la sécurité de transport Windows SSPI.</span><span class="sxs-lookup"><span data-stu-id="401a0-104">This example shows a named pipes server that accepts a channel, and receives and replies to messages with security provided by Windows SSPI transport security.</span></span>

-   [<span data-ttu-id="401a0-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="401a0-105">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>](#requestreplynamedpipesserverwithwindowstransportsecuritycpp)
-   [<span data-ttu-id="401a0-106">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="401a0-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="401a0-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="401a0-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesserverwithwindowstransportsecuritycpp"></a><span data-ttu-id="401a0-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity. cpp</span><span class="sxs-lookup"><span data-stu-id="401a0-108">RequestReplyNamedPipesServerWithWindowsTransportSecurity.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="401a0-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="401a0-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="401a0-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="401a0-110">Makefile</span></span>
