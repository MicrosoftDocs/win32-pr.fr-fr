...
description: Cet exemple montre un client TCP qui envoie des messages unidirectionnels en mode de diffusion en continu.
ms.assetid: 29e9e08a-2cff-4467-b889-608a34d4b07e
keywords:
- StreamingTcpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029808"
---
# <a name="streamingtcpclientexample"></a><span data-ttu-id="205ed-106">StreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="205ed-106">StreamingTcpClientExample</span></span>

<span data-ttu-id="205ed-107">Cet exemple montre un client TCP qui envoie des messages unidirectionnels en mode de diffusion en continu.</span><span class="sxs-lookup"><span data-stu-id="205ed-107">This example shows a TCP client that sends one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="205ed-108">StreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="205ed-108">StreamingTcpClient.cpp</span></span>](#streamingtcpclientcpp)
-   [<span data-ttu-id="205ed-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="205ed-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="205ed-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="205ed-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpclientcpp"></a><span data-ttu-id="205ed-111">StreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="205ed-111">StreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="205ed-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="205ed-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="205ed-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="205ed-113">Makefile</span></span>
