...
ms.locfileid: "127411137"
---
# <a name="asyncadd3implicitexample"></a>AsyncAdd3ImplicitExample

Cet exemple illustre l’implémentation d’une fonction asynchrone complexe à l’aide de [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).
