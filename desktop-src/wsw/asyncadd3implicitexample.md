...
description: Cet exemple illustre l’implémentation d’une fonction asynchrone complexe à l’aide de WsAsyncExecute.
ms.assetid: f84de03f-ecfb-494e-9a1d-a96d399a41c0
keywords:
- Services Web AsyncAdd3ImplicitExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103673926"
---
# <a name="asyncadd3implicitexample"></a><span data-ttu-id="0d608-106">AsyncAdd3ImplicitExample</span><span class="sxs-lookup"><span data-stu-id="0d608-106">AsyncAdd3ImplicitExample</span></span>

<span data-ttu-id="0d608-107">Cet exemple illustre l’implémentation d’une fonction asynchrone complexe à l’aide de [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span><span class="sxs-lookup"><span data-stu-id="0d608-107">This example illustrates implementing a complex asynchronous function using [**WsAsyncExecute**](/windows/desktop/api/WebServices/nf-webservices-wsasyncexecute).</span></span>

<span data-ttu-id="0d608-108">L’exemple implémente une fonction asynchrone’AddThree’qui ajoute trois entiers ensemble en générant une fonction Add existante qui peut ajouter deux entiers de façon asynchrone.</span><span class="sxs-lookup"><span data-stu-id="0d608-108">The example implements an asynchronous function 'AddThree' which adds three integers together by building upon an existing Add function which can add two integers asynchronously.</span></span>

## <a name="asyncadd3implicitcpp"></a><span data-ttu-id="0d608-109">AsyncAdd3Implicit. cpp</span><span class="sxs-lookup"><span data-stu-id="0d608-109">AsyncAdd3Implicit.cpp</span></span>
