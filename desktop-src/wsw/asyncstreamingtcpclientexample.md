...
description: Cet exemple montre un client TCP qui envoie des messages unidirectionnels en mode de diffusion en continu asynchrone.
ms.assetid: b0040b3d-d830-421a-bbf1-afb0cac47599
keywords:
- AsyncStreamingTcpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104310290"
---
# <a name="asyncstreamingtcpclientexample"></a><span data-ttu-id="36b93-106">AsyncStreamingTcpClientExample</span><span class="sxs-lookup"><span data-stu-id="36b93-106">AsyncStreamingTcpClientExample</span></span>

<span data-ttu-id="36b93-107">Cet exemple montre un client TCP qui envoie des messages unidirectionnels en mode de diffusion en continu asynchrone.</span><span class="sxs-lookup"><span data-stu-id="36b93-107">This example shows a TCP client that sends one-way messages in an asynchronous streaming fashion.</span></span>

-   [<span data-ttu-id="36b93-108">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="36b93-108">AsyncStreamingTcpClient.cpp</span></span>](#asyncstreamingtcpclientcpp)
-   [<span data-ttu-id="36b93-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="36b93-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="36b93-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="36b93-110">Makefile</span></span>](#makefile)

## <a name="asyncstreamingtcpclientcpp"></a><span data-ttu-id="36b93-111">AsyncStreamingTcpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="36b93-111">AsyncStreamingTcpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="36b93-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="36b93-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="36b93-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="36b93-113">Makefile</span></span>
