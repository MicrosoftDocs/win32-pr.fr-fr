...
description: Cet exemple montre un serveur UDP qui écoute sur une adresse de multidiffusion et répond aux demandes envoyées à cette adresse. Cet exemple utilise IPv6.
ms.assetid: 9e2a254c-dbfc-4b73-a1a5-6a1db1ac5921
keywords:
- MulticastUdpServerExample6-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106543401"
---
# <a name="multicastudpserverexample6"></a><span data-ttu-id="d8914-107">MulticastUdpServerExample6</span><span class="sxs-lookup"><span data-stu-id="d8914-107">MulticastUdpServerExample6</span></span>

<span data-ttu-id="d8914-108">Cet exemple montre un serveur UDP qui écoute sur une adresse de multidiffusion et répond aux demandes envoyées à cette adresse.</span><span class="sxs-lookup"><span data-stu-id="d8914-108">This example shows a UDP server that listens on a multicast address and replies to requests sent to that address.</span></span> <span data-ttu-id="d8914-109">Cet exemple utilise IPv6.</span><span class="sxs-lookup"><span data-stu-id="d8914-109">This example uses IPv6.</span></span>

-   [<span data-ttu-id="d8914-110">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="d8914-110">MulticastUdpServer6.cpp</span></span>](#multicastudpserver6cpp)
-   [<span data-ttu-id="d8914-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d8914-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="d8914-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="d8914-112">Makefile</span></span>](#makefile)

## <a name="multicastudpserver6cpp"></a><span data-ttu-id="d8914-113">MulticastUdpServer6. cpp</span><span class="sxs-lookup"><span data-stu-id="d8914-113">MulticastUdpServer6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="d8914-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="d8914-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="d8914-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="d8914-115">Makefile</span></span>
