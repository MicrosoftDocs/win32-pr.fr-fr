...
description: Il s’agit de l’outil en ligne de commande qui pilote le service FileRep.
ms.assetid: e6273036-2e31-4cbb-b72b-8f4d3ade6336
keywords:
- FileRepToolExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104197100"
---
# <a name="filereptoolexample"></a><span data-ttu-id="8be2b-106">FileRepToolExample</span><span class="sxs-lookup"><span data-stu-id="8be2b-106">FileRepToolExample</span></span>

<span data-ttu-id="8be2b-107">Il s’agit de l’outil en ligne de commande qui pilote le [service FileRep](filerepserviceexample.md).</span><span class="sxs-lookup"><span data-stu-id="8be2b-107">This is the command line tool that drives the [FileRep service](filerepserviceexample.md).</span></span> <span data-ttu-id="8be2b-108">Une description plus détaillée de cet exemple est disponible ici.</span><span class="sxs-lookup"><span data-stu-id="8be2b-108">A more detailed description of this sample can be found there.</span></span>

<span data-ttu-id="8be2b-109">Les paramètres de ligne de commande sont les suivants :</span><span class="sxs-lookup"><span data-stu-id="8be2b-109">The command line parameters are as follows:</span></span>

<span data-ttu-id="8be2b-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[ /Encoding : <Binary/Text/MTOM>\] \[ /Sync\]</span><span class="sxs-lookup"><span data-stu-id="8be2b-110">WsFileRep.exe <Client Service Url> <Server Service Url> <Source File> <Destination File> \[/encoding:<binary/text/MTOM>\] \[/sync\]</span></span>

<span data-ttu-id="8be2b-111">URL du service client : obligatoire.</span><span class="sxs-lookup"><span data-stu-id="8be2b-111">Client Service Url: Mandatory.</span></span> <span data-ttu-id="8be2b-112">URL du service client.</span><span class="sxs-lookup"><span data-stu-id="8be2b-112">Url of the client service.</span></span>

<span data-ttu-id="8be2b-113">URL du service serveur : obligatoire.</span><span class="sxs-lookup"><span data-stu-id="8be2b-113">Server Service Url: Mandatory.</span></span> <span data-ttu-id="8be2b-114">URL du service serveur.</span><span class="sxs-lookup"><span data-stu-id="8be2b-114">Url of the server service.</span></span>

<span data-ttu-id="8be2b-115">Fichier source : obligatoire.</span><span class="sxs-lookup"><span data-stu-id="8be2b-115">Source File: Mandatory.</span></span> <span data-ttu-id="8be2b-116">Nom local complet du fichier source.</span><span class="sxs-lookup"><span data-stu-id="8be2b-116">Fully qualified local name of the source file.</span></span> <span data-ttu-id="8be2b-117">Le fichier se trouve sur l’ordinateur sur lequel s’exécute le service serveur.</span><span class="sxs-lookup"><span data-stu-id="8be2b-117">The file is located on the machine where the server service runs.</span></span>

<span data-ttu-id="8be2b-118">Fichier de destination : obligatoire.</span><span class="sxs-lookup"><span data-stu-id="8be2b-118">Destination file: Mandatory.</span></span> <span data-ttu-id="8be2b-119">Nom local complet du fichier de destination.</span><span class="sxs-lookup"><span data-stu-id="8be2b-119">Fully qualified local name of the destination file.</span></span> <span data-ttu-id="8be2b-120">Le fichier se trouve sur l’ordinateur sur lequel s’exécute le service client.</span><span class="sxs-lookup"><span data-stu-id="8be2b-120">The file will be located on the machine where the client service runs.</span></span>

<span data-ttu-id="8be2b-121">Encodage : facultatif.</span><span class="sxs-lookup"><span data-stu-id="8be2b-121">Encoding: Optional.</span></span> <span data-ttu-id="8be2b-122">Spécifie l’encodage de message pour les messages envoyés entre le client et les services serveur.</span><span class="sxs-lookup"><span data-stu-id="8be2b-122">Specifies the message encoding for the messages sent between the client and server services.</span></span> <span data-ttu-id="8be2b-123">L’encodage utilisé pour la communication entre l’outil en ligne de commande et le service client ne peut pas être modifié pour des raisons de simplicité.</span><span class="sxs-lookup"><span data-stu-id="8be2b-123">The encoding used for the communication between the command line tool and the client service cannot be changed for simplicity reasons.</span></span> <span data-ttu-id="8be2b-124">Les paramètres valides sont Binary, Text et MTOM.</span><span class="sxs-lookup"><span data-stu-id="8be2b-124">Valid parameters are binary, text and MTOM.</span></span> <span data-ttu-id="8be2b-125">Si le paramètre n’est pas spécifié, l’encodage par défaut pour le transport est utilisé.</span><span class="sxs-lookup"><span data-stu-id="8be2b-125">If the parameter is not specified the default encoding for transport is used.</span></span>

<span data-ttu-id="8be2b-126">Sync : facultatif.</span><span class="sxs-lookup"><span data-stu-id="8be2b-126">Sync: Optional.</span></span> <span data-ttu-id="8be2b-127">Lorsque cette valeur est définie, la requête se termine de façon synchrone.</span><span class="sxs-lookup"><span data-stu-id="8be2b-127">When set, the request completes synchronously.</span></span> <span data-ttu-id="8be2b-128">Dans le cas contraire, la demande se termine de façon asynchrone.</span><span class="sxs-lookup"><span data-stu-id="8be2b-128">Otherwise the request will complete asynchronously.</span></span>

-   [<span data-ttu-id="8be2b-129">Outil. cpp</span><span class="sxs-lookup"><span data-stu-id="8be2b-129">Tool.cpp</span></span>](#toolcpp)
-   [<span data-ttu-id="8be2b-130">Common. h</span><span class="sxs-lookup"><span data-stu-id="8be2b-130">common.h</span></span>](#commonh)
-   [<span data-ttu-id="8be2b-131">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="8be2b-131">Related topics</span></span>](#related-topics)

## <a name="toolcpp"></a><span data-ttu-id="8be2b-132">Outil. cpp</span><span class="sxs-lookup"><span data-stu-id="8be2b-132">Tool.cpp</span></span>
...
## <a name="commonh"></a><span data-ttu-id="8be2b-133">common.h</span><span class="sxs-lookup"><span data-stu-id="8be2b-133">common.h</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="8be2b-134">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="8be2b-134">Related topics</span></span>

<dl> <dt>

[<span data-ttu-id="8be2b-135">FileRepServiceExample</span><span class="sxs-lookup"><span data-stu-id="8be2b-135">FileRepServiceExample</span></span>](filerepserviceexample.md)
</dt> </dl>
