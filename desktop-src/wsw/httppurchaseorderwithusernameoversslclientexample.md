...
description: Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service PurchaseOrder, avec un nom d’utilisateur sur la sécurité SSL en mode mixte.
ms.assetid: 9874f00d-1efa-47ed-8029-f93962046789
keywords:
- HttpPurchaseOrderWithUsernameOverSslClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104197113"
---
# <a name="httppurchaseorderwithusernameoversslclientexample"></a><span data-ttu-id="9f157-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span><span class="sxs-lookup"><span data-stu-id="9f157-106">HttpPurchaseOrderWithUsernameOverSslClientExample</span></span>

<span data-ttu-id="9f157-107">Cet exemple montre un client HTTP qui utilise le proxy de service pour communiquer avec un service PurchaseOrder, avec un nom d’utilisateur sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="9f157-107">This example shows a HTTP client that uses service proxy to talk to a PurchaseOrder service, with username over SSL mixed-mode security.</span></span> <span data-ttu-id="9f157-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="9f157-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="9f157-109">L’authentification du client est fournie par une paire nom d’utilisateur/mot de passe dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="9f157-109">Client authentication is provided by a username/password pair in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="9f157-110">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="9f157-110">PurchaseOrderClientUserNameOverSsl.cpp</span></span>](#purchaseorderclientusernameoversslcpp)
-   [<span data-ttu-id="9f157-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="9f157-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="9f157-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="9f157-112">Makefile</span></span>](#makefile)

## <a name="purchaseorderclientusernameoversslcpp"></a><span data-ttu-id="9f157-113">PurchaseOrderClientUserNameOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="9f157-113">PurchaseOrderClientUserNameOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="9f157-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="9f157-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="9f157-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="9f157-115">Makefile</span></span>
