...
description: Cet exemple montre un client UDP qui effectue la multidiffusion d’une demande, puis attend les messages de réponse des serveurs à l’aide du protocole IPv6.
ms.assetid: bd19bd5f-0617-4524-aa48-3d0c28c97747
keywords:
- MulticastUdpClientExample6-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104309461"
---
# <a name="multicastudpclientexample6"></a><span data-ttu-id="72358-106">MulticastUdpClientExample6</span><span class="sxs-lookup"><span data-stu-id="72358-106">MulticastUdpClientExample6</span></span>

<span data-ttu-id="72358-107">Cet exemple montre un client UDP qui effectue la multidiffusion d’une demande, puis attend les messages de réponse des serveurs à l’aide du protocole IPv6.</span><span class="sxs-lookup"><span data-stu-id="72358-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers, using IPv6.</span></span>

-   [<span data-ttu-id="72358-108">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="72358-108">MulticastUdpClient6.cpp</span></span>](#multicastudpclient6cpp)
-   [<span data-ttu-id="72358-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="72358-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="72358-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="72358-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclient6cpp"></a><span data-ttu-id="72358-111">MulticastUdpClient6. cpp</span><span class="sxs-lookup"><span data-stu-id="72358-111">MulticastUdpClient6.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="72358-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="72358-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="72358-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="72358-113">Makefile</span></span>
