---
title: Exemple de fonction asynchrone
description: Cet exemple illustre l’implémentation et l’appel de fonctions asynchrones.
ms.assetid: e71bd231-c69c-409f-874c-a0798b844ee6
keywords:
- Services Web AsyncModelExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104310293"
---
# <a name="asynchronous-function-example"></a><span data-ttu-id="3c806-106">Exemple de fonction asynchrone</span><span class="sxs-lookup"><span data-stu-id="3c806-106">Asynchronous Function Example</span></span>

<span data-ttu-id="3c806-107">Cet exemple illustre l’implémentation et l’appel de fonctions asynchrones.</span><span class="sxs-lookup"><span data-stu-id="3c806-107">This example illustrates implementing and calling asynchronous functions.</span></span>

<span data-ttu-id="3c806-108">L’exemple se compose des éléments suivants :</span><span class="sxs-lookup"><span data-stu-id="3c806-108">The example consists of the following parts:</span></span>

-   <span data-ttu-id="3c806-109">La fonction Add, qui ajoute deux nombres de manière synchrone ou asynchrone.</span><span class="sxs-lookup"><span data-stu-id="3c806-109">The Add function which will add two numbers synchronously or asynchronously.</span></span> <span data-ttu-id="3c806-110">Il crée un thread en tant que détail d’implémentation pour le cas asynchrone.</span><span class="sxs-lookup"><span data-stu-id="3c806-110">It creates a thread as an implementation detail for the asynchronous case.</span></span>
-   <span data-ttu-id="3c806-111">La fonction CallAddSync appelle les fonctions Add de façon synchrone.</span><span class="sxs-lookup"><span data-stu-id="3c806-111">The CallAddSync function invokes the Add functions synchronously.</span></span>
-   <span data-ttu-id="3c806-112">La fonction CallAddAsync appelle les fonctions Add de manière asynchrone.</span><span class="sxs-lookup"><span data-stu-id="3c806-112">The CallAddAsync function invokes the Add functions asynchronously.</span></span>

## <a name="asyncmodelcpp"></a><span data-ttu-id="3c806-113">AsyncModel. cpp</span><span class="sxs-lookup"><span data-stu-id="3c806-113">AsyncModel.cpp</span></span>
