...
ms.locfileid: "119444759"
---
# <a name="asynchronous-function-example"></a>Exemple de fonction asynchrone

Cet exemple illustre l’implémentation et l’appel de fonctions asynchrones.

L’exemple se compose des éléments suivants :

-   La fonction Add, qui ajoute deux nombres de manière synchrone ou asynchrone. Il crée un thread en tant que détail d’implémentation pour le cas asynchrone.
-   La fonction CallAddSync appelle les fonctions Add de façon synchrone.
-   La fonction CallAddAsync appelle les fonctions Add de manière asynchrone.
