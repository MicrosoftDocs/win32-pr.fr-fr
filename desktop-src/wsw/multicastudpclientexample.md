...
description: Cet exemple montre un client UDP qui effectue la multidiffusion d’une demande, puis attend les messages de réponse des serveurs.
ms.assetid: 61ca7e05-1a60-43b2-9ff7-cb355fae2f77
keywords:
- MulticastUdpClientExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104190932"
---
# <a name="multicastudpclientexample"></a><span data-ttu-id="274bd-106">MulticastUdpClientExample</span><span class="sxs-lookup"><span data-stu-id="274bd-106">MulticastUdpClientExample</span></span>

<span data-ttu-id="274bd-107">Cet exemple montre un client UDP qui effectue la multidiffusion d’une demande, puis attend les messages de réponse des serveurs.</span><span class="sxs-lookup"><span data-stu-id="274bd-107">This example shows a UDP client that multicasts a request and then waits for reply messages from servers.</span></span>

-   [<span data-ttu-id="274bd-108">MulticastUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="274bd-108">MulticastUdpClient.cpp</span></span>](#multicastudpclientcpp)
-   [<span data-ttu-id="274bd-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="274bd-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="274bd-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="274bd-110">Makefile</span></span>](#makefile)

## <a name="multicastudpclientcpp"></a><span data-ttu-id="274bd-111">MulticastUdpClient. cpp</span><span class="sxs-lookup"><span data-stu-id="274bd-111">MulticastUdpClient.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="274bd-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="274bd-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="274bd-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="274bd-113">Makefile</span></span>
