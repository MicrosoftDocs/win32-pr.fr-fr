...
description: Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages, avec Kerberos sur la sécurité SSL en mode mixte.
ms.assetid: 2910f594-2f38-4c1e-bb47-89258b752572
keywords:
- HttpServerWithKerberosOverSslExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103940313"
---
# <a name="httpserverwithkerberosoversslexample"></a><span data-ttu-id="367bf-106">HttpServerWithKerberosOverSslExample</span><span class="sxs-lookup"><span data-stu-id="367bf-106">HttpServerWithKerberosOverSslExample</span></span>

<span data-ttu-id="367bf-107">Cet exemple montre un serveur TCP qui accepte un canal et reçoit et répond aux messages, avec Kerberos sur la sécurité SSL en mode mixte.</span><span class="sxs-lookup"><span data-stu-id="367bf-107">This example shows a TCP server that accepts a channel and receives and replies to messages, with kerberos over SSL mixed-mode security.</span></span> <span data-ttu-id="367bf-108">Dans cette configuration, la connexion de transport est protégée (signée, chiffrée) par SSL, ce qui permet également l’authentification du serveur.</span><span class="sxs-lookup"><span data-stu-id="367bf-108">In this setup, the transport connection is protected (signed, encrypted) by SSL which also provides server authentication.</span></span> <span data-ttu-id="367bf-109">L’authentification du client est fournie par un ticket Kerberos APREQ dans un en-tête de WS-Security dans le message.</span><span class="sxs-lookup"><span data-stu-id="367bf-109">Client authentication is provided by a kerberos APREQ ticket in a WS-Security header in the message.</span></span>

-   [<span data-ttu-id="367bf-110">HttpServerWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="367bf-110">HttpServerWithKerberosOverSsl.cpp</span></span>](#httpserverwithkerberosoversslcpp)
-   [<span data-ttu-id="367bf-111">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="367bf-111">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="367bf-112">Makefile</span><span class="sxs-lookup"><span data-stu-id="367bf-112">Makefile</span></span>](#makefile)

## <a name="httpserverwithkerberosoversslcpp"></a><span data-ttu-id="367bf-113">HttpServerWithKerberosOverSsl. cpp</span><span class="sxs-lookup"><span data-stu-id="367bf-113">HttpServerWithKerberosOverSsl.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="367bf-114">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="367bf-114">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="367bf-115">Makefile</span><span class="sxs-lookup"><span data-stu-id="367bf-115">Makefile</span></span>
