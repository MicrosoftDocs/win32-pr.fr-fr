...
description: Cet exemple transfère un message.
ms.assetid: bedaa7f3-2a43-45f4-a623-c0e41b5113a4
keywords:
- Services Web ForwardMessageExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104029387"
---
# <a name="forwardmessageexample"></a><span data-ttu-id="ca6b7-106">ForwardMessageExample</span><span class="sxs-lookup"><span data-stu-id="ca6b7-106">ForwardMessageExample</span></span>

<span data-ttu-id="ca6b7-107">Cet exemple transfère un message.</span><span class="sxs-lookup"><span data-stu-id="ca6b7-107">This example forwards a message.</span></span>

-   [<span data-ttu-id="ca6b7-108">ForwardMessage. cpp</span><span class="sxs-lookup"><span data-stu-id="ca6b7-108">ForwardMessage.cpp</span></span>](#forwardmessagecpp)
-   [<span data-ttu-id="ca6b7-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="ca6b7-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="ca6b7-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="ca6b7-110">Makefile</span></span>](#makefile)

## <a name="forwardmessagecpp"></a><span data-ttu-id="ca6b7-111">ForwardMessage. cpp</span><span class="sxs-lookup"><span data-stu-id="ca6b7-111">ForwardMessage.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="ca6b7-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="ca6b7-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="ca6b7-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="ca6b7-113">Makefile</span></span>
