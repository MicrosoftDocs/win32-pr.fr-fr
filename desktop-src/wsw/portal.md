...
ms.locfileid: "104190717"
---
# <a name="windows-web-services-api"></a>API des services Web Windows

## <a name="purpose"></a>Objectif

WWSAPI est une implémentation de code natif de SOAP qui fournit des fonctionnalités de communication réseau de base en prenant en charge un ensemble de WS- \* and. \* Famille de protocoles. WWSAPI est conçu pour être utilisé par les composants/applications qui appartiennent à l’une des catégories suivantes :

-   Autorisation du code natif
-   Exiger des dépendances minimales
-   Exiger un temps de démarrage minimal
-   Environnements à mémoire restreinte
