...
Cet exemple montre comment utiliser un hôte de service pour héberger un service de calculatrice avec un canal personnalisé et une implémentation d’écouteur qui se couche par-dessus HTTP.
