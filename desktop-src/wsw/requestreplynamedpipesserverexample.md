...
description: Cet exemple montre un serveur de canaux nommés qui accepte un canal et reçoit et répond aux messages.
...
ms.locfileid: "103671026"
---
# <a name="requestreplynamedpipesserverexample"></a><span data-ttu-id="3bcc3-103">RequestReplyNamedPipesServerExample</span><span class="sxs-lookup"><span data-stu-id="3bcc3-103">RequestReplyNamedPipesServerExample</span></span>

<span data-ttu-id="3bcc3-104">Cet exemple montre un serveur de canaux nommés qui accepte un canal et reçoit et répond aux messages.</span><span class="sxs-lookup"><span data-stu-id="3bcc3-104">This example shows a named pipes server that accepts a channel and receives and replies to messages.</span></span>

-   [<span data-ttu-id="3bcc3-105">RequestReplyNamedPipesServer. cpp</span><span class="sxs-lookup"><span data-stu-id="3bcc3-105">RequestReplyNamedPipesServer.cpp</span></span>](#requestreplynamedpipesservercpp)
-   [<span data-ttu-id="3bcc3-106">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="3bcc3-106">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="3bcc3-107">Makefile</span><span class="sxs-lookup"><span data-stu-id="3bcc3-107">Makefile</span></span>](#makefile)

## <a name="requestreplynamedpipesservercpp"></a><span data-ttu-id="3bcc3-108">RequestReplyNamedPipesServer. cpp</span><span class="sxs-lookup"><span data-stu-id="3bcc3-108">RequestReplyNamedPipesServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="3bcc3-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="3bcc3-109">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="3bcc3-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="3bcc3-110">Makefile</span></span>
