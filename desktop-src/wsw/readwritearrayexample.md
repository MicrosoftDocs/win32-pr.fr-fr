...
description: Cet exemple lit et écrit un tableau d’éléments.
ms.assetid: 3c4851b5-1c31-4de7-929e-03a8199b273a
keywords:
- Services Web ReadWriteArrayExample pour Windows
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106509162"
---
# <a name="readwritearrayexample"></a><span data-ttu-id="841ae-106">ReadWriteArrayExample</span><span class="sxs-lookup"><span data-stu-id="841ae-106">ReadWriteArrayExample</span></span>

<span data-ttu-id="841ae-107">Cet exemple lit et écrit un tableau d’éléments.</span><span class="sxs-lookup"><span data-stu-id="841ae-107">This example reads and writes an array of elements.</span></span>

## <a name="readwritearraycpp"></a><span data-ttu-id="841ae-108">ReadWriteArray. cpp</span><span class="sxs-lookup"><span data-stu-id="841ae-108">ReadWriteArray.cpp</span></span>
