...
description: Cet exemple montre un serveur TCP qui accepte un canal et lit les messages unidirectionnels en mode de diffusion en continu.
ms.assetid: 0b9c6fba-9dee-4409-b715-7827793a5522
keywords:
- StreamingTcpServerExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104379835"
---
# <a name="streamingtcpserverexample"></a><span data-ttu-id="636ac-106">StreamingTcpServerExample</span><span class="sxs-lookup"><span data-stu-id="636ac-106">StreamingTcpServerExample</span></span>

<span data-ttu-id="636ac-107">Cet exemple montre un serveur TCP qui accepte un canal et lit les messages unidirectionnels en mode de diffusion en continu.</span><span class="sxs-lookup"><span data-stu-id="636ac-107">This example shows a TCP server that accepts a channel, and reads one-way messages in a streaming fashion.</span></span>

-   [<span data-ttu-id="636ac-108">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="636ac-108">StreamingTcpServer.cpp</span></span>](#streamingtcpservercpp)
-   [<span data-ttu-id="636ac-109">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="636ac-109">PurchaseOrder.wsdl</span></span>](#purchaseorderwsdl)
-   [<span data-ttu-id="636ac-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="636ac-110">Makefile</span></span>](#makefile)

## <a name="streamingtcpservercpp"></a><span data-ttu-id="636ac-111">StreamingTcpServer. cpp</span><span class="sxs-lookup"><span data-stu-id="636ac-111">StreamingTcpServer.cpp</span></span>
...
## <a name="purchaseorderwsdl"></a><span data-ttu-id="636ac-112">PurchaseOrder. wsdl</span><span class="sxs-lookup"><span data-stu-id="636ac-112">PurchaseOrder.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="636ac-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="636ac-113">Makefile</span></span>
