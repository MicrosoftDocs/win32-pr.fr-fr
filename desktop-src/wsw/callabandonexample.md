...
description: Exemple d’application cliente illustrant l’abandon d’un appel.
ms.assetid: 71253dd6-4f59-4acd-b244-c721834ca381
keywords:
- CallAbandonExample-services Web natifs
- WWSAPI
- WWS
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "104379921"
---
# <a name="callabandonexample"></a><span data-ttu-id="372ed-106">CallAbandonExample</span><span class="sxs-lookup"><span data-stu-id="372ed-106">CallAbandonExample</span></span>

<span data-ttu-id="372ed-107">Exemple d’application cliente illustrant l’abandon d’un appel.</span><span class="sxs-lookup"><span data-stu-id="372ed-107">Example client application demonstrating abandoning a call.</span></span>

-   [<span data-ttu-id="372ed-108">AbandonCallClient. cpp</span><span class="sxs-lookup"><span data-stu-id="372ed-108">AbandonCallClient.cpp</span></span>](#abandoncallclientcpp)
-   [<span data-ttu-id="372ed-109">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="372ed-109">BlockUnBlockService.wsdl</span></span>](#blockunblockservicewsdl)
-   [<span data-ttu-id="372ed-110">Makefile</span><span class="sxs-lookup"><span data-stu-id="372ed-110">Makefile</span></span>](#makefile)

## <a name="abandoncallclientcpp"></a><span data-ttu-id="372ed-111">AbandonCallClient. cpp</span><span class="sxs-lookup"><span data-stu-id="372ed-111">AbandonCallClient.cpp</span></span>
...
## <a name="blockunblockservicewsdl"></a><span data-ttu-id="372ed-112">BlockUnBlockService. wsdl</span><span class="sxs-lookup"><span data-stu-id="372ed-112">BlockUnBlockService.wsdl</span></span>
...
## <a name="makefile"></a><span data-ttu-id="372ed-113">Makefile</span><span class="sxs-lookup"><span data-stu-id="372ed-113">Makefile</span></span>
