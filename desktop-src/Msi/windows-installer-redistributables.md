...
Windows Installer 4,5 et versions antérieures sont disponibles sous la forme d’un package de mise à jour logicielle redistribuable. Consultez la section [versions publiées de Windows Installer](released-versions-of-windows-installer.md) pour déterminer les produits livrés avec les versions de Windows Installer. Le package de mise à jour redistribuable pour une version est mis à disposition après la publication du produit livré avec une version de Windows Installer spécifique.

> [!NOTE]
> Il n’existe aucun redistribuable pour Windows Installer 5,0. Cette version est incluse avec le système d’exploitation dans les versions client et serveur de Windows 7, Windows Server 2008 R2 et versions ultérieures (y compris Windows 10).
...
Le Windows Installer 4,5 Redistributable pour les systèmes d’exploitation Windows XP et Windows Server 2003 peut être installé à l’aide de la syntaxe et des options de ligne de commande suivantes.
