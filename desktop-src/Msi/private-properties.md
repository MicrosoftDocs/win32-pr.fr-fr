...
Les propriétés privées décrivent généralement l’environnement d’exploitation. par exemple, si l’installation est exécutée sur une plateforme Windows, le programme d’installation définit la propriété [**WindowsFolder**](windowsfolder.md) sur la valeur spécifiée dans la table de propriétés.
