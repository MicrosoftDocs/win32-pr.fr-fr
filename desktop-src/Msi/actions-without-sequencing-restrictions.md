---
description: Le séquencement des actions suivantes est illimité. Ces actions peuvent être placées n’importe où dans la séquence d’action.
ms.assetid: 35ccfad2-b022-4446-8275-a3b26f4e4db2
title: Actions sans restrictions de séquencement
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106529801"
---
# <a name="actions-without-sequencing-restrictions"></a>Actions sans restrictions de séquencement

Le séquencement des actions suivantes est illimité. Ces actions peuvent être placées n’importe où dans la séquence d’action.
