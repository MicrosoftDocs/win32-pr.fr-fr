...
<span id="_msi_merge_using_windows_installer_gly"></span><span id="_MSI_MERGE_USING_WINDOWS_INSTALLER_GLY"></span>**fusion**
</dt> <dd>

Combine deux bases de données d’installation pour former une base de données unique. Pour plus d’informations, consultez [fusion de bases de données](merging-databases.md).

</dd> <dt>

<span id="_msi_merge_module_gly"></span><span id="_MSI_MERGE_MODULE_GLY"></span>**module de fusion**
</dt> <dd>

Base de données fusionnée avec un package d’installation pour fournir de nouveaux composants à une application. Les modules de fusion ne peuvent pas être installés seul. Pour plus d’informations, consultez [fusionner des modules](merge-modules.md).
