---
description: Windows Le programme d’installation peut rechercher un fichier ou un répertoire spécifique pendant une installation. Les recherches de fichiers ou de répertoires permettent de déterminer si un utilisateur a déjà installé une version d’une application.
...
Windows Le programme d’installation peut rechercher un fichier ou un répertoire spécifique pendant une installation. Les recherches de fichiers ou de répertoires permettent de déterminer si un utilisateur a déjà installé une version d’une application.
