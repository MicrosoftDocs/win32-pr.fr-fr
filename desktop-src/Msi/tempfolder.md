...
Les auteurs n’ont pas besoin de définir la propriété **TempFolder** . Windows Installer utilise la fonction [**GetTempPath**](/windows/win32/api/fileapi/nf-fileapi-gettemppatha) pour récupérer le chemin d’accès du répertoire désigné pour les fichiers temporaires et pour définir cette propriété.
