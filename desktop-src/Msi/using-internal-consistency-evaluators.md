...
3.  Fournissez le fichier. CUB et le fichier. msi à un outil de validation de package, tel que [Orca.exe](orca-exe.md) ou [Msival2.exe](msival2-exe.md).
