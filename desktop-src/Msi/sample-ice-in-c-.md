...
ms.locfileid: "127021254"
---
# <a name="sample-ice-in-c"></a>Exemple de code ICE en C++

Cet exemple de code provient d’une action personnalisée ICE ( [ICE01](ice01.md)). Il vérifie que le mécanisme de glace fonctionne en affichant l’heure. La glace publie un message indiquant l’heure à laquelle le programme d’installation a appelé la glace. Cette glace ne doit jamais retourner une erreur.
