...
Voir aussi [fichiers exécutables](executable-files.md).

## <a name="source"></a>Source

L’exécutable est généré à partir d’un fichier existant. Le champ source de la [table CustomAction](customaction-table.md) contient une clé de la [table de propriétés](property-table.md) pour une propriété qui contient le chemin d’accès complet au fichier exécutable.
