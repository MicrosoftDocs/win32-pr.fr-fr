...
Un outil de fusion évalue la table ModuleAdminUISequence, puis insère les actions calculées dans la [table AdminUISequence](adminuisequence-table.md) avec un numéro de séquence correct.

La table ModuleAdminUISequence contient les colonnes suivantes.
