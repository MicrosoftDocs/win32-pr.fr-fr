...
---
# <a name="mergedependencies-property"></a>Merge. Dependencies, propriété

La propriété **dépendances** en lecture seule de l’objet [**Merge**](merge-object.md) retourne une collection d’objets de [**dépendance**](dependency-object.md) qui énumère un ensemble de dépendances non satisfaites pour la base de données actuelle.
...
Un module n’a pas besoin d’être ouvert pour récupérer les informations de dépendance.

### <a name="c"></a>C++

Consultez la fonction [**obtenir des \_ dépendances**](/windows/win32/api/mergemod/nf-mergemod-imsmmerge-get_dependencies) .
