...
Cet exemple de code provient d’une action personnalisée ICE ( [ICE08](ice08.md)). La glace confirme que chaque composant de la [table de composants](component-table.md) a un [GUID](guid.md)unique. Aucune validation n’est effectuée si la table de composants n’existe pas.
