...
Une application qui a été installée à l’aide de l’Microsoft Windows Installer peut être mise à niveau en réinstallant un package d’installation mis à jour (fichier. msi) ou en appliquant un correctif Windows Installer (un fichier. msp) à l’application.
