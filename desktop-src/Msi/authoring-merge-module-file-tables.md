...
-   Les noms des fichiers dans MergeModule.CABinet doivent correspondre à la clé primaire de la table de [fichiers](file-table.md)du module de fusion.
