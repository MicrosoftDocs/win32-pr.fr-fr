...
-   Pour supprimer l’espace de stockage gaspillé et réduire la taille finale des fichiers. msi. Consultez [réduction de la taille d’un fichier. msi](reducing-the-size-of-an--msi-file.md).
