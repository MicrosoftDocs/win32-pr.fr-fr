...
Windows Le programme d’installation utilise [**IsValidCodePage**](/windows/desktop/api/winnls/nf-winnls-isvalidcodepage) pour déterminer si la page de codes est valide.
