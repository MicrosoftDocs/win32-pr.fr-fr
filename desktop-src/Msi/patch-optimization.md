...
Windows Installer pouvez optimiser la mise à jour corrective pour réduire le temps nécessaire à l’application des correctifs pour les applications installées.
