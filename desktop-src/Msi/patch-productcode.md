---
description: La propriété ProductCode de l’objet patch retourne le GUID ProductCode du produit.
ms.assetid: 11d81bc0-dac6-4135-9b60-31d39c3455da
title: Patch. ProductCode, propriété
ms.topic: reference
ms.date: 05/31/2018
topic_type:
- APIRef
...
ms.locfileid: "106535276"
---
# <a name="patchproductcode-property"></a>Patch. ProductCode, propriété

La propriété **ProductCode** de l’objet [**patch**](patch-object.md) retourne le GUID [**ProductCode**](productcode.md) du produit.
