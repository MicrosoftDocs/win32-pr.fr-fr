...
Windows Installer applique la mise à niveau si l’utilisateur a déjà installé les versions 1,0 à 1,4 (inclusives) de la langue anglaise MNP2000. Windows Installer migre tous les paramètres de fonctionnalité du produit d’origine vers le produit mis à niveau. Le programme d’installation supprime les fichiers appartenant aux produits originaux qui ne sont pas utilisés par la mise à niveau du produit.
