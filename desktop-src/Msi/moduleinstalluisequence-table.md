...
Un outil de fusion évalue la table ModuleInstallUISequence, puis insère les actions calculées dans la [table InstallUISequence](installuisequence-table.md) avec un numéro de séquence correct.
