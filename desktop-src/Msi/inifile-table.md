...
Clé du fichier. ini localisable dans la section.
...
|----------------------------------|-------------|---------|----------------------------------------------------------------------------------|
| **msidbIniFileActionAddLine**    | 0x000       | 0       | Crée ou met à jour une entrée. ini.                                                 |
| **msidbIniFileActionCreateLine** | 0x001       | 1       | Crée une entrée. ini uniquement si l’entrée n’existe pas déjà.                   |
...
Clé externe dans la première colonne de la [table de composants](component-table.md) référençant le composant qui contrôle l’installation de la valeur. ini.

</dd> </dl>

## <a name="remarks"></a>Notes

Les informations du fichier. ini sont écrites lorsque le composant correspondant a été sélectionné pour être installé en local ou exécuté à partir de la source.
