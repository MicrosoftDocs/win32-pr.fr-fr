...
les transformations d’Instance sont du code de produit : modification des transformations disponibles avec le programme d’installation exécuté sur Windows Server 2003 ou Windows XP. Pour plus d’informations, consultez [installation de plusieurs instances de produits et de correctifs](installing-multiple-instances-of-products-and-patches.md).
