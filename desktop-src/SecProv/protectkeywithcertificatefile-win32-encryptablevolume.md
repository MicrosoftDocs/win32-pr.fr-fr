...
La méthode **ProtectKeyWithCertificateFile** de la [**classe \_ EncryptableVolume Win32**](win32-encryptablevolume.md) valide l' [*identificateur d’objet*](../secgloss/o-gly.md) (EKU) d’utilisation améliorée de la clé du certificat fourni.
...
Chaîne qui spécifie l’emplacement et le nom du fichier. cer utilisé pour activer BitLocker. un certificat de chiffrement doit être exporté au format. cer [*Distinguished Encoding Rules*](../secgloss/d-gly.md) (DER) binaire encodé [*x. 509*](../secgloss/x-gly.md) ou Base-64 encodé x. 509. Le certificat de chiffrement peut être généré à partir de l’infrastructure PKI de Microsoft, d’une infrastructure à clé publique tierce ou auto-signé.
...
| <dl> <dt>**Erreur \_ FICHIER \_ \_ introuvable**</dt> <dt>0000000002 (0X2)</dt> </dl>                                | Le système ne peut pas trouver le fichier spécifié.<br/>                                                                                                                                                                                                                                          |
