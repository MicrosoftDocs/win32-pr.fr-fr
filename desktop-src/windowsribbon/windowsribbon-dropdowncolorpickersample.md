...
Cet exemple de code illustre le balisage et le code requis pour utiliser un contrôle DropDownColorPicker du ruban Windows.
...
-   Kit de développement logiciel (SDK) Windows (chemin d’installation standard) :% ProgramFiles% \\ Microsoft SDK \\ Windows \\ \[ numéro de version \] \\ exemples \\ WinUI \\ WindowsRibbon \\ DropDownColorPicker
