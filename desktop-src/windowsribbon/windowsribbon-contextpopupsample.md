...
cet exemple de code illustre le balisage et le code requis pour implémenter une application Windows Ribbon avec ContextPopups.
...
- Windows kit de développement logiciel (sdk) (chemin d’installation standard) :% ProgramFiles% \\ Microsoft sdk \\ Windows \\ \[ numéro de version \] \\ exemples \\ winui \\ WindowsRibbon \\ ContextPopup
