...
Cet exemple de code illustre le balisage et le code requis pour implémenter une application de ruban Windows avec ContextPopups.
...
-   Kit de développement logiciel (SDK) Windows (chemin d’installation standard) :% ProgramFiles% \\ Microsoft SDK \\ Windows \\ \[ numéro de version \] \\ exemples \\ WinUI \\ WindowsRibbon \\ ContextPopup
...
[Menu contextuel contexte](windowsribbon-controls-contextpopup.md)
</dt> </dl>
