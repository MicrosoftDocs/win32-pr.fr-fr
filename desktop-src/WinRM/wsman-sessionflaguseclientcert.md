...
ms.locfileid: "119997205"
---
# <a name="wsmansessionflaguseclientcertificate-method"></a>Méthode WSMan. SessionFlagUseClientCertificate

La méthode **WSMan. SessionFlagUseClientCertificate** retourne la valeur de l’indicateur d’authentification **WSManFlagUseClientCertificate** à utiliser dans le paramètre *Flags* de la méthode [**WSMan. CreateSession**](wsman-createsession.md) . Cette méthode fournit une syntaxe plus efficace pour l’utilisation de la constante afin que les scripts ne soient pas requis pour définir une valeur de constante. Pour plus d’informations sur l’appel de cette méthode, consultez [sessions, constantes](session-constants.md).

**WSManFlagUseClientCertificate** est une constante dans l’énumération **\_ \_ WSManAuthenticationFlags** . Pour plus d’informations, consultez [constantes d’authentification](authentication-constants.md).
