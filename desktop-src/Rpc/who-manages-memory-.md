...
-   [Pointeurs de niveau supérieur et incorporé](top-level-and-embedded-pointers.md)
-   [Attributs directionnels appliqués au paramètre](directional-attributes-applied-to-the-parameter.md)
-   [Attributs de longueur, de taille et d’orientation](length-size-and-directional-attributes.md)
