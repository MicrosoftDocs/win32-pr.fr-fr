...
Le tableau suivant fournit la traduction en secondes pour Windows 2000 et Windows XP. Les futures versions de Windows peuvent modifier le mappage entre le paramètre de délai d’attente et la valeur du délai d’attente, en secondes :
