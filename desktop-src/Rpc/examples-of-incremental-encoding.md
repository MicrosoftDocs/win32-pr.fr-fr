---
title: Exemples d’encodage incrémentiel
description: La section suivante fournit un exemple d’utilisation du handle de sérialisation de style incrémentiel pour l’encodage de type.
ms.assetid: c50c0de3-aabb-4166-93dc-67b0fee66635
keywords:
- Appel de procédure distante RPC, tâches, à l’aide de l’encodage incrémentiel
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103940311"
---
# <a name="examples-of-incremental-encoding"></a><span data-ttu-id="7cf9f-104">Exemples d’encodage incrémentiel</span><span class="sxs-lookup"><span data-stu-id="7cf9f-104">Examples of Incremental Encoding</span></span>

<span data-ttu-id="7cf9f-105">La section suivante fournit un exemple d’utilisation du handle de sérialisation de style incrémentiel pour l’encodage de type.</span><span class="sxs-lookup"><span data-stu-id="7cf9f-105">The following section provides an example of how to use the incremental style serializing handle for type encoding.</span></span>
...
<span data-ttu-id="7cf9f-106">L’extrait suivant représente les fragments d’application pertinents.</span><span class="sxs-lookup"><span data-stu-id="7cf9f-106">The following excerpt represents the relevant application fragments.</span></span>
