...
ms.locfileid: "120021410"
---
# <a name="examples-of-incremental-encoding"></a>Exemples d’encodage incrémentiel

La section suivante fournit un exemple d’utilisation du handle de sérialisation de style incrémentiel pour l’encodage de type.
