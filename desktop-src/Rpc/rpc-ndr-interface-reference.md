...
ms.locfileid: "120073349"
---
# <a name="rpc-ndr-interface-reference"></a>Référence de l’interface de NDR RPC

Le NDR Microsoft RPC prend actuellement en charge les fonctions et structures suivantes :

-   [**CStdStubBuffer \_ AddRef**](/windows/desktop/api/Rpcproxy/nf-rpcproxy-cstdstubbuffer_addref)
-   [**CStdStubBuffer \_ connecter**](/windows/desktop/api/Rpcproxy/nf-rpcproxy-cstdstubbuffer_connect)
...
-   [**Déconnexion CStdStubBuffer \_**](/windows/desktop/api/Rpcproxy/nf-rpcproxy-cstdstubbuffer_disconnect)
...
-   [**Proxy de la \_ version IUnknown \_**](/windows/desktop/api/unknwnbase/nf-unknwnbase-iunknown_queryinterface_proxy)
...
-   [**Version de NdrCStdStubBuffer \_**](/previous-versions/aa374242(v=vs.80))
-   [**Version de NdrCStdStubBuffer2 \_**](/previous-versions/aa374240(v=vs.80))
...
-   [**\_Description du stub MIDL \_**](/windows/desktop/api/Rpcndr/ns-rpcndr-midl_stub_desc)
-   [**\_message stub \_ MIDL**](/windows/desktop/api/Rpcndr/ns-rpcndr-midl_stub_message)
-   [**ProxyFileInfo**](/windows/win32/api/rpcproxy/ns-rpcproxy-proxyfileinfo)
-   [**\_message RPC**](/windows/desktop/api/RpcdceP/ns-rpcdcep-rpc_message)
