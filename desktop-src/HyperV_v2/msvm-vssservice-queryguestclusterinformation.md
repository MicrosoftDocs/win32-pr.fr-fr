...
---
# <a name="queryguestclusterinformation-method-of-the-msvm_vssservice-class"></a>Méthode QueryGuestClusterInformation de la \_ classe VssService MSVM

Interrogation des informations de cluster à partir de l’hôte Hyper-V vers l’invité.
...
*GuestClusterInformation* \[ à\]
</dt> <dd>

En cas de réussite, contient un [**\_ GuestClusterInformation MSVM**](msvm-guestclusterinformation.md) qui décrit le cluster invité.
