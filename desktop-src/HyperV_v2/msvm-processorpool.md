...
---
# <a name="msvm_processorpool-class"></a>MSVM \_ ProcessorPool, classe

Agrège les ressources du processeur qui peuvent être allouées à un ordinateur virtuel.
...
La classe **MSVM \_ ProcessorPool** possède les types de membres suivants :
...
La classe **MSVM \_ ProcessorPool** possède ces méthodes.



| Méthode                                                                          | Description                                           |
|:--------------------------------------------------------------------------------|:------------------------------------------------------|
| [**CalculatePossibleReserve**](calculatepossiblereserve-msvm-processorpool.md) | Utilisé pour rechercher la réserve de processeur réelle.<br/> |
...
La classe **MSVM \_ ProcessorPool** possède les propriétés suivantes.
...
Chaîne qui décrit le type de ressource lorsqu’une valeur bien définie n’est pas disponible et que **resourceType** a la valeur 0 (« other »). Cette propriété est héritée de [**CIM \_ ResourcePool**](/previous-versions//cc136903(v=vs.85))et a la valeur **null**.
...
L’accès à la classe **MSVM \_ ProcessorPool** peut être limité par le filtrage UAC. Pour plus d’informations, consultez [contrôle de compte d’utilisateur et WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
