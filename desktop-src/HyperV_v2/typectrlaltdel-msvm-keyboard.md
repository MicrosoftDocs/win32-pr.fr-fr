...
---
# <a name="typectrlaltdel-method-of-the-msvm_keyboard-class"></a>Méthode TypeCtrlAltDel de la \_ classe de clavier MSVM

Simule une séquence de touches Ctrl + Alt + Suppr.
...
Une valeur de retour de zéro indique une réussite. Une valeur différente de zéro indique un échec d’envoi.
