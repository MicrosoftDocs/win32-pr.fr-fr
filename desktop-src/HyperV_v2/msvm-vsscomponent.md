...
Représente l’état du service Service VSS (VSS), qui implémente le demandeur VSS dans le système d’exploitation invité.
...
La classe **MSVM \_ VssComponent** possède les types de membres suivants :
...
La classe **MSVM \_ VssComponent** possède ces méthodes.
...
La classe **MSVM \_ VssComponent** possède les propriétés suivantes.
...
Données supplémentaires, au-delà des informations d’ID d’appareil, qui peuvent être utilisées pour identifier un périphérique logique. Cette propriété est héritée de [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)et est toujours définie sur **null**.
...
Date ou heure de la dernière modification de l' **EnabledState** de l’élément. Cette propriété est héritée de [**CIM \_ EnabledLogicalElement**](/previous-versions//cc136818(v=vs.85))et est toujours définie sur **null**.
