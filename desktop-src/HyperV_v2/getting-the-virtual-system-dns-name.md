---
description: Les exemples C# et Visual Basic Scripting Edition (VBScript) suivants récupèrent le nom DNS de la machine virtuelle.
ms.assetid: 1E1F7E6F-5CF6-475F-8351-6A5F56B4FC8E
title: Obtention du nom DNS de la machine virtuelle
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103869298"
---
# <a name="getting-the-virtual-machine-dns-name"></a><span data-ttu-id="274a4-103">Obtention du nom DNS de la machine virtuelle</span><span class="sxs-lookup"><span data-stu-id="274a4-103">Getting the virtual machine DNS name</span></span>

<span data-ttu-id="274a4-104">Les exemples C# et Visual Basic Scripting Edition (VBScript) suivants récupèrent le nom DNS de la machine virtuelle.</span><span class="sxs-lookup"><span data-stu-id="274a4-104">The following C# and Visual Basic Scripting Edition (VBScript) samples retrieve the DNS name of the virtual machine.</span></span>

<span data-ttu-id="274a4-105">Pour exécuter cet exemple de code, vous devez installer les services d’intégration client et le système d’exploitation client doit être en cours d’exécution.</span><span class="sxs-lookup"><span data-stu-id="274a4-105">To run this sample code, you must install the client integration services and the client operating system must be running.</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="274a4-106">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="274a4-106">Related topics</span></span>

[<span data-ttu-id="274a4-107">Utilitaires courants pour les exemples de virtualisation (v2)</span><span class="sxs-lookup"><span data-stu-id="274a4-107">Common utilities for the virtualization samples (V2)</span></span>](common-utilities-for-the-virtualization-samples-v2.md)

[<span data-ttu-id="274a4-108">**MSVM \_ ComputerSystem**</span><span class="sxs-lookup"><span data-stu-id="274a4-108">**Msvm\_ComputerSystem**</span></span>](msvm-computersystem.md)

[<span data-ttu-id="274a4-109">**MSVM \_ KvpExchangeComponent**</span><span class="sxs-lookup"><span data-stu-id="274a4-109">**Msvm\_KvpExchangeComponent**</span></span>](msvm-kvpexchangecomponent.md)
