...
---
# <a name="destroysystem-method-of-the-msvm_virtualethernetswitchmanagementservice-class"></a>Méthode DestroySystem de la \_ classe VirtualEthernetSwitchManagementService MSVM

Détruit un commutateur virtuel.
...
Référence à une instance de la classe [**MSVM \_ VirtualEthernetSwitch**](msvm-virtualethernetswitch.md) qui représente le commutateur virtuel qui doit être détruit.
