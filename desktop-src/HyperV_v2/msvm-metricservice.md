...
Offre la possibilité de gérer les métriques.
...
La classe **MSVM \_ MetricService** possède les types de membres suivants :
...
La classe **MSVM \_ MetricService** possède ces méthodes.



| Méthode                                                                    | Description                                                                             |
|:--------------------------------------------------------------------------|:----------------------------------------------------------------------------------------|
| [**ControlMetrics**](controlmetrics-msvm-metricservice.md)               | Utilisé pour contrôler la collection de mesures pour un ou des éléments managés.<br/> |
| [**ControlMetricsByClass**](msvm-metricservice-controlmetricsbyclass.md) | Contrôle les métriques par classe.<br/>                                               |
| [**ControlSampleTimes**](msvm-metricservice-controlsampletimes.md)       | Définit les heures de l’exemple de contrôle.<br/>                                               |
| [**GetMetricValues**](msvm-metricservice-getmetricvalues.md)             | Récupère les valeurs de métriques.<br/>                                                 |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-metricservice.md) | Modifie les données de paramètre pour le service.<br/>                                   |
| [**RequestStateChange**](msvm-metricservice-requeststatechange.md)       | Demande un changement d’État.<br/>                                                     |
| [**ShowMetrics**](msvm-metricservice-showmetrics.md)                     | Affiche les métriques spécifiées.<br/>                                                 |
| [**ShowMetricsByClass**](msvm-metricservice-showmetricsbyclass.md)       | Affiche les métriques par classe.<br/>                                                  |
| [**StartService**](msvm-metricservice-startservice.md)                   | démarre le service.<br/>                                                          |
| [**StopService**](msvm-metricservice-stopservice.md)                     | arrête le service.<br/>                                                           |
...
La classe **MSVM \_ MetricService** possède les propriétés suivantes.
...
Brève description de l’objet. Cette propriété est héritée de [**CIM \_ propriété ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)et est toujours définie sur « Hyper-V Metric service ».
...
Nom de la classe ou de la sous-classe utilisée dans la création d’une instance. Cette propriété est héritée [**du \_ service CIM**](/windows/desktop/CIMWin32Prov/cim-service)et est toujours définie sur « MSVM \_ MetricService ».
...
Description de l'objet . Cette propriété est héritée de [**CIM \_ propriété ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)et est toujours définie sur « fournit la gestion WMI de métrique Hyper-V ».
...
Nom complet de l’objet. Cette propriété est héritée de [**CIM \_ propriété ManagedElement**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)et est toujours définie sur « Hyper-V Metric service ».
...
Étiquette par laquelle l’objet est connu. Cette propriété est héritée [**du \_ service CIM**](/windows/desktop/CIMWin32Prov/cim-service)et est toujours définie sur « metricsvc ».
