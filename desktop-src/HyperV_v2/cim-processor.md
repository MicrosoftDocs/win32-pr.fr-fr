...
ms.locfileid: "119981229"
---
# <a name="cim_processor-class-hyper-v-management"></a>Classe CIM_Processor (gestion Hyper-V)
...
La classe de **\_ processeur CIM** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe du **\_ processeur CIM** possède ces propriétés.
...
Qualificateurs : [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (« bits »), **punitif** (« bit »)
</dt> </dl>

Largeur d’adresse du processeur, en bits.
...
**UC désactivée par l’utilisateur** (2)
...
**Processeur désactivé par le BIOS (erreur de publication)** (3)
...
Qualificateurs : [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("mégahertz"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processeur DMTF \| 017,6 "), **punitif** (" Hertz \* 10 ^ 6 ")
</dt> </dl>

Vitesse actuelle, en MHz, du processeur.
...
Largeur des données du processeur, en bits.
...
Vitesse, en MHz, de l’interface de bus externe (également appelée bus frontal).
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processeur DMTF \| 017,3 "), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ processeur CIM**.**OtherFamilyDescription**")
</dt> </dl>

Type de la famille de processeurs.
...
**Famille de processeurs AMD Turion (TM) II Ultra Dual-Core mobile M** (56)
...
**Famille de processeurs AMD Turion (TM) II Dual-Core mobile M** (57)
...
**Famille de processeurs AMD Athlon (TM) II Dual-Core mobile M** (58)
...
**Processeur AMD Opteron (TM) 6100 Series** (59)
...
**Processeur AMD Opteron (TM) 4100 Series** (60)
...
**Famille Efficeon (TM) TM8000** (122)
...
**Famille de processeurs double cœur AMD Opteron (TM)** (135)
...
**Famille de processeurs AMD Opteron (TM) Quad Core** (138)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 3200** (161)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 5300** (163)
...
**Processeur double cœur Intel (r) Xeon (r)-série 5000** (165)
...
**Processeur double cœur Intel (r) Xeon (r) TBT** (167)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 5400** (169)
...
**Processeur quadruple cœur Intel (r) Xeon (r)** (170)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 7300** (173)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 7400** (174)
...
**Processeur Pentium (r) III avec technologie Intel (r) SpeedStep (TM)** (177)
...
**Famille de MP AMD Athlon (TM)** (183)
...
**Processeur Intel (r) Pentium (r) M** (185)
...
**Processeur Intel (r) Pentium (r) D** (187)
...
**Processeur Intel (r) Pentium (r) Extreme Edition** (188)
...
**Processeur Intel (R) Core (TM) 2 Extreme mobile** (195)
...
**Processeur double cœur Intel (r) Celeron (r)** (199)
...
**Processeur multicœur Intel (r) Xeon (r)** (214)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 3xxx** (216)
...
**Famille de processeurs Nano (TM)** (217)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 5xxx** (219)
...
**Processeur quadruple cœur Intel (r) Xeon (r)-série 7xxx** (222)
...
**Processeur multicœur Intel (r) Xeon (r)-série 7xxx** (223)
...
**Processeur multicœur Intel (r) Xeon (r)-série 3400** (224)
...
**Famille de processeurs AMD Opteron (TM) Quad-Core incorporée** (230)
...
**Famille de processeurs mobiles AMD Turion (TM) Dual-Core** (233)
...
**Réservé (à des fins d’affectation spéciale ultérieure)** (65534)
...
Qualificateurs : [**unités**](/windows/desktop/WmiSdk/standard-qualifiers) (« percent »), [**jauge**](/windows/desktop/WmiSdk/standard-qualifiers), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) («MIB. IETF \| Host-Resources-MIB. hrProcessorLoad "), **punitif** (" percent ")
</dt> </dl>

Le chargement du processeur, en moyenne au cours de la dernière minute, en pourcentage.
...
Qualificateurs : [**Units**](/windows/desktop/WmiSdk/standard-qualifiers) ("mégahertz"), [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processeur DMTF \| 017,5 "), **punitif** (" Hertz \* 10 ^ 6 ")
</dt> </dl>

Vitesse maximale, en MHz, du processeur.
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (64), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**\_ processeur CIM**.**Family**»)
</dt> </dl>

Type de la famille de processeurs lorsque la propriété **Family** est définie sur **other** (« 1 »). Cette chaîne doit être définie sur NULL lorsque la propriété Family a une valeur autre que **other**.
...
Rôle du processeur, par exemple « processeur central » ou « processeur mathématique ».
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) («**\_ processeur CIM**».**Family**»)
</dt> </dl>

Niveau de révision du processeur au sein de la famille de processeurs.
...
Identificateur global unique du processeur, au sein de la portée de la famille de processeurs.
...
Qualificateurs : [**MappingStrings**](/windows/desktop/WmiSdk/standard-qualifiers) ("MIF. \|Processeur DMTF \| 017,7 ")
</dt> </dl>

Informations sur le socket d’UC qui incluent des données sur la façon dont le processeur peut être mis à niveau.
