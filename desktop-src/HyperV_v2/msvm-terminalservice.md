...
ms.locfileid: "118146708"
---
# <a name="msvm_terminalservice-class"></a>MSVM \_ TerminalService, classe

Gère toutes les connexions de terminal distant à un hôte particulier. Le service utilise un port configurable pour initier toutes les connexions Terminal Server.
...
La classe **MSVM \_ TerminalService** possède les types de membres suivants :
...
La classe **MSVM \_ TerminalService** possède ces méthodes.



| Méthode                                                                                        | Description                                                                                                      |
|:----------------------------------------------------------------------------------------------|:-----------------------------------------------------------------------------------------------------------------|
| [**GetInteractiveSessionACL**](getinteractivesessionacl-msvm-terminalservice.md)             | Récupère la liste DACL actuelle qui contrôle l’accès à la session interactive d’un ordinateur virtuel.<br/>      |
| [**GrantInteractiveSessionAccess**](grantinteractivesessionaccess-msvm-terminalservice.md)   | Octroie l’accès à la session interactive de l’ordinateur virtuel à la liste de confiance spécifiée.<br/>    |
| [**ModifyServiceSettings**](modifyservicesettings-msvm-terminalservice.md)                   | Modifie les données de paramètre pour le service.<br/>                                                            |
| [**RequestStateChange**](msvm-terminalservice-requeststatechange.md)                         | Demande un changement d’État.<br/>                                                                              |
| [**RevokeInteractiveSessionAccess**](revokeinteractivesessionaccess-msvm-terminalservice.md) | Révoque l’accès à la session interactive de l’ordinateur virtuel à partir de la liste de confiance spécifiée.<br/> |
| [**StartService**](msvm-terminalservice-startservice.md)                                     | démarre le service.<br/>                                                                                   |
| [**StopService**](msvm-terminalservice-stopservice.md)                                       | arrête le service.<br/>                                                                                    |
...
La classe **MSVM \_ TerminalService** possède les propriétés suivantes.
...
L’accès à la classe **MSVM \_ TerminalService** peut être limité par le filtrage UAC. Pour plus d’informations, consultez [contrôle de compte d’utilisateur et WMI](/windows/desktop/WmiSdk/user-account-control-and-wmi).
