...
ms.locfileid: "119254499"
---
# <a name="clickbutton-method-of-the-msvm_ps2mouse-class"></a>Méthode ClickButton de la \_ classe Ps2Mouse MSVM

Simule un clic sur le bouton de périphérique spécifié. Cela équivaut à appeler [**SetButtonState**](setbuttonstate-msvm-syntheticmouse.md) deux fois, d’abord à appuyer sur le bouton, puis à le libérer.
