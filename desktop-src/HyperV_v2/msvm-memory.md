...
Représente la mémoire actuellement allouée à un ordinateur virtuel.
...
La classe de **\_ mémoire MSVM** a les types de membres suivants :
...
La classe de **\_ mémoire MSVM** possède ces méthodes.
...
La classe de **\_ mémoire MSVM** a ces propriétés.
...
Décrit les propriétés en lecture/écriture du média. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est définie sur 3 (lecture/écriture prise en charge) par défaut.
...
Cette propriété est héritée de [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)et est définie sur 6 (non applicable).
...
Cette propriété est héritée de la [**\_ mémoire CIM**](/windows/desktop/CIMWin32Prov/cim-memory), mais elle n’est pas utilisée.
...
Cette propriété est héritée de [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice).
...
Nombre maximal de blocs, de tailles de **bloc**, qui sont disponibles pour la consommation lors de la superposition des extensions de stockage à l’aide de l’Association BasedOn. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur **null**.
...
Type d’organisation de données utilisé. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur 2.
...
Nombre total de copies de données qui sont actuellement conservées. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur 1.
...
Valeur actuelle pour la réservation Delta. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur 0.
...
Adresse de fin du bloc de mémoire contigu. Étant donné que **la propriété de l’ordinateur de la** valeur est toujours 0, cette valeur reflète toujours la quantité totale de mémoire de l’ordinateur virtuel.
...
Chaîne qui décrit le type de détection d’erreurs et de correction pris en charge par cette extension de stockage. Cette propriété est héritée de la [**\_ mémoire CIM**](/windows/desktop/CIMWin32Prov/cim-memory)et est toujours définie sur **null**.
...
Cette propriété est héritée de [**CIM \_ LogicalDevice**](/windows/desktop/CIMWin32Prov/cim-logicaldevice)et est définie sur **null**.
...
Qualificateurs : **MaxLen** (1024), **override** ("Name")
</dt> </dl>

Étiquette par laquelle l’objet est connu. Lorsqu’elle est sous-classée, cette propriété peut être substituée pour être une propriété de clé. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur «*GUID*».
...
Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur 0.
...
**True** s’il n’existe aucun point de défaillance unique. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur **false**.
...
Valeur calculée qui représente la quantité totale de mémoire divisée par la taille de **bloc**. Cette propriété est héritée de la [**\_ StorageExtent CIM**](/windows/desktop/CIMWin32Prov/cim-storageextent).
...
Espace de noms de la propriété **Name** lorsque la propriété **NameFormat** contient la valeur 1 (Other "). Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur **null**.
...
Espace de noms de la propriété **Name** lorsque la propriété **NameNamespace** comprend la valeur 1 (other). Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur **null**.
...
Nombre de packages physiques qui peuvent échouer actuellement sans perte de données. Cette propriété est héritée de [**CIM \_ StorageExtent**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur 0.
...
**True** si le système conteneur ne peut pas créer ou supprimer cet élément opérationnel. Cette propriété est héritée de la [**\_ StorageExtent CIM**](/windows/desktop/CIMWin32Prov/cim-storageextent).
...
Chaîne qui décrit le média et son utilisation. Cette propriété est héritée de la [**\_ StorageExtent CIM**](/windows/desktop/CIMWin32Prov/cim-storageextent)et est toujours définie sur « mémoire système ».
...
Adresse de début référencée par une application ou un système d’exploitation et mappée par un contrôleur de mémoire pour cet objet mémoire. Cette propriété est héritée de la [**\_ mémoire CIM**](/windows/desktop/CIMWin32Prov/cim-memory)et est toujours définie sur 0.
...
Date ou heure de la dernière modification de l’état activé de l’élément. Cette propriété est héritée de la [**\_ EnabledLogicalElement CIM**](/previous-versions//cc136818(v=vs.85))et est toujours définie sur « null ».
...
Indique si la mémoire est volatile. Cette propriété est héritée de la [**\_ mémoire CIM**](/windows/desktop/CIMWin32Prov/cim-memory)et est toujours définie sur **true**.
...
[**\_Mémoire CIM**](/windows/desktop/CIMWin32Prov/cim-memory)
</dt> <dt>
