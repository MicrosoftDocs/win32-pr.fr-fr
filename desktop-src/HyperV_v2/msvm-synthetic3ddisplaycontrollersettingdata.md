...
Représente les paramètres d’un contrôleur d’affichage 3D synthétique pour un ordinateur virtuel. Cette classe est utilisée uniquement avec les ordinateurs virtuels qui utilisent RemoteFX.
...
La classe **MSVM \_ Synthetic3DDisplayControllerSettingData** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **MSVM \_ Synthetic3DDisplayControllerSettingData** possède les propriétés suivantes.
...
Une seule ressource hôte peut être affectée à chaque périphérique de l’ordinateur virtuel, de sorte que seul le premier élément de ce tableau peut être défini. Pour les appareils qui prennent en charge cette fonctionnalité, définissez le premier élément du tableau **HostResource** pour qu’il contienne une référence à la ressource hôte sous-jacente qui doit être affectée. Cette propriété est héritée de la [**\_ ResourceAllocationSettingData CIM**](/previous-versions/windows/desktop/clushyperv/cim-resourceallocationsettingdata).
...
Nombre maximal d’analyses disponibles pour le contrôleur d’affichage 3D. Le nombre minimal d’analyses est 1 et la valeur maximale dépend de la résolution d’écran maximale. Le tableau suivant définit le nombre maximal d’analyses autorisées pour différentes résolutions.
...
Spécifie la résolution d’écran maximale pour le contrôleur d’affichage 3D. Il doit s’agir de l’une des valeurs suivantes.
...
La résolution maximale est de 1024 768.
...
La résolution maximale est de 1280 1024.
...
La résolution maximale est de 1600 1200.
...
La résolution maximale est de 1920 1200.
...
La résolution maximale est de 2650 1600.
...
Nombre total de cœurs dans l’ordinateur virtuel. Cette propriété est héritée de la [**\_ ResourceAllocationSettingData CIM**](/previous-versions/windows/desktop/clushyperv/cim-resourceallocationsettingdata).
