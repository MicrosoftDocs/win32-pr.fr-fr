...
ms.locfileid: "119014657"
---
# <a name="cim_forwardingservice-class"></a>\_Classe CIM ForwardingService

Représente un service de transfert pour le trafic réseau. Le service traite les paquets reçus de points de terminaison de protocole en les ignorant ou en envoyant les paquets à d’autres points de terminaison de protocole.
...
La classe **CIM \_ ForwardingService** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ ForwardingService** possède les propriétés suivantes.
...
Qualificateurs : [**MaxLen**](/windows/desktop/WmiSdk/standard-qualifiers) (32), [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ForwardingService**.**ProtocolType**»)
</dt> </dl>

Définit le type de protocole à transférer lorsque la valeur de la propriété **ProtocolType** est 1 (autre).
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ ForwardingService**.**OtherProtocolType**")
</dt> </dl>

Type de protocole à transférer.
...
[**\_NetworkService CIM**](cim-networkservice.md)
</dt> </dl>
