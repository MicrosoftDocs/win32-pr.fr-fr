---
description: Les utilitaires suivants sont utilisés par certains des exemples de virtualisation C#.
ms.assetid: EB0F305D-806D-4ACB-8024-3A6FB125629D
title: Utilitaires courants pour les exemples de virtualisation (v2)
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "103866417"
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a><span data-ttu-id="427f0-103">Utilitaires courants pour les exemples de virtualisation (v2)</span><span class="sxs-lookup"><span data-stu-id="427f0-103">Common utilities for the virtualization samples (V2)</span></span>

<span data-ttu-id="427f0-104">Les utilitaires suivants sont utilisés par certains des exemples de virtualisation C#.</span><span class="sxs-lookup"><span data-stu-id="427f0-104">The following utilities are used by some of the C# virtualization samples.</span></span>
