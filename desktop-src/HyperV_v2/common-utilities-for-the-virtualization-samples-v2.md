...
---
# <a name="common-utilities-for-the-virtualization-samples-v2"></a>Utilitaires courants pour les exemples de virtualisation (v2)

Les utilitaires suivants sont utilisés par certains des exemples de virtualisation C#.
