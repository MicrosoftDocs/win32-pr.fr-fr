...
---
# <a name="msvm_lanendpoint-class"></a>MSVM \_ LANEndpoint, classe

Représente le point de connexion logique pour une carte réseau. Lorsque le point de terminaison de réseau local est connecté à un port de commutateur, la carte réseau connectée au point de terminaison de réseau local dispose d’une connectivité réseau.
...
La classe **MSVM \_ LANEndpoint** possède les types de membres suivants :
...
La classe **MSVM \_ LANEndpoint** possède ces méthodes.



| Méthode                                                            | Description                         |
|:------------------------------------------------------------------|:------------------------------------|
| [**RequestStateChange**](msvm-lanendpoint-requeststatechange.md) | Demande un changement d’État.<br/> |
...
La classe **MSVM \_ LANEndpoint** possède les propriétés suivantes.
...
Brève description de l’objet. Cette propriété est héritée de la [**\_ propriété ManagedElement CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)et est toujours définie sur « point de terminaison LAN ».
...
Cette propriété a la valeur **true** si le point de terminaison LAN est connecté à un port de commutateur.
...
Nom de la classe ou de la sous-classe utilisée dans la création d’une instance. Cette propriété est héritée de [**CIM \_ ServiceAccessPoint**](/windows/desktop/CIMWin32Prov/cim-serviceaccesspoint)et est toujours définie sur « MSVM \_ LANEndpoint ».
...
Description de l'objet . Cette propriété est héritée de la [**\_ propriété ManagedElement CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement)et est toujours définie sur « point de terminaison de réseau local virtuel Microsoft ».
...
Contient l’heuristique d’attribution de noms sélectionnée pour garantir que la valeur de la propriété **Name** est unique. Cette propriété est héritée de [**CIM \_ ProtocolEndpoint**](/previous-versions/windows/desktop/iscsitarg/cim-protocolendpoint)et est définie sur « Microsoft Virtual Device ID ».
...
<span id="Voice_Foreign_Exchange_Office"></span><span id="voice_foreign_exchange_office"></span><span id="VOICE_FOREIGN_EXCHANGE_OFFICE"></span>**Bureau étranger** à la voix (101)
</dt> <dt>

<span id="Voice_Foreign_Exchange_Service"></span><span id="voice_foreign_exchange_service"></span><span id="VOICE_FOREIGN_EXCHANGE_SERVICE"></span>**Service d’échange étranger vocal** (102)
</dt> <dt>
...
<span id="FAST_Channel"></span><span id="fast_channel"></span><span id="FAST_CHANNEL"></span>**Canal rapide** (125)
</dt> <dt>
