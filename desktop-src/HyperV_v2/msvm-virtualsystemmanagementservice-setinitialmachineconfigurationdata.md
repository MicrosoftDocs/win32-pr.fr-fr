...
---
# <a name="setinitialmachineconfigurationdata-method-of-the-msvm_virtualsystemmanagementservice-class"></a>Méthode SetInitialMachineConfigurationData de la \_ classe VirtualSystemManagementService MSVM

Définit les données de configuration initiales de l’ordinateur d’une machine virtuelle.
...
Référence au système d’ordinateur virtuel sur lequel les données IMC seront définies.
...
Données IMC à définir. Les quatre premiers octets doivent être la longueur du tableau par ordre de primauté des octets de poids fort (Big endian)
