...
ms.locfileid: "119790239"
---
# <a name="msvm_basemetricdefinition-class"></a>MSVM \_ BaseMetricDefinition, classe

Représente les aspects de définition d’une mesure. La classe **MSVM \_ BaseMetricDefinition** doit être associée à la [**\_ ManagedElements CIM**](/previous-versions/windows/desktop/iscsitarg/cim-managedelement) à laquelle elle s’applique.
