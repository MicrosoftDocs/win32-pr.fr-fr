...
---
# <a name="exporting-the-configuration-of-a-virtual-machine"></a><span data-ttu-id="ed99d-103">Exportation de la configuration d’une machine virtuelle</span><span class="sxs-lookup"><span data-stu-id="ed99d-103">Exporting the configuration of a virtual machine</span></span>

<span data-ttu-id="ed99d-104">Les exemples C# et Visual Basic Scripting Edition (VBScript) suivants montrent comment exporter la configuration d’un ordinateur virtuel.</span><span class="sxs-lookup"><span data-stu-id="ed99d-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting the configuration of a virtual machine.</span></span> <span data-ttu-id="ed99d-105">Vous trouverez des exemples qui illustrent l’exportation d’une machine virtuelle sur le [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) et l' [exportation d’une capture instantanée des rubriques relatives aux machines virtuelles](exporting-virtual-machines.md) .</span><span class="sxs-lookup"><span data-stu-id="ed99d-105">Samples that show exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) and [Exporting a snapshot of a virtual machine](exporting-virtual-machines.md) topics.</span></span>

<span data-ttu-id="ed99d-106">Les utilitaires C# référencés se trouvent dans [les utilitaires courants pour les exemples de virtualisation (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="ed99d-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="ed99d-107">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="ed99d-107">Related topics</span></span>

[<span data-ttu-id="ed99d-108">Exportation d’une capture instantanée d’un ordinateur virtuel</span><span class="sxs-lookup"><span data-stu-id="ed99d-108">Exporting a snapshot of a virtual machine</span></span>](exporting-virtual-machines.md)

[<span data-ttu-id="ed99d-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="ed99d-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
