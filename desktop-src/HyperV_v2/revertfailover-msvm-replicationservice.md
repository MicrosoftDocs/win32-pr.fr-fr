...
---
# <a name="revertfailover-method-of-the-msvm_replicationservice-class"></a>Méthode RevertFailover de la \_ classe ReplicationService MSVM

Restaure le basculement en cours pour un ordinateur virtuel en ignorant le disque de basculement actuel. Après cette opération, [**InitiateFailover**](initiatefailover-msvm-replicationservice.md) peut être appelé à nouveau.
...
Référence à une instance [**\_ ComputerSystem CIM**](/windows/desktop/CIMWin32Prov/cim-computersystem) qui représente l’ordinateur virtuel pour lequel annuler le basculement.
