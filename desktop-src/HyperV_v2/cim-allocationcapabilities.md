...
La classe **CIM \_ AllocationCapabilities** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ AllocationCapabilities** possède les propriétés suivantes.
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("[**CIM \_ ResourceAllocationSettingData**](cim-resourceallocationsettingdata.md).**ResourceType**»)
</dt> </dl>

Type de ressource pour ce paramètre d’allocation lorsque la propriété **resourceType** est définie sur « 1 » (autre).
...
Indique si la demande d’une ressource spécifique est prise en charge.
...
<span id="Specific"></span><span id="specific"></span><span id="SPECIFIC"></span>**Spécifique** (2)


</dt> <dd>

La demande peut inclure une demande de ressource spécifique.

</dd> <dt>

<span id="General"></span><span id="general"></span><span id="GENERAL"></span>

<span id="General"></span><span id="general"></span><span id="GENERAL"></span>**Général** (3)


</dt> <dd>

La demande n’inclut pas de ressource spécifique.

</dd> <dt>

<span id="Both"></span><span id="both"></span><span id="BOTH"></span>

<span id="Both"></span><span id="both"></span><span id="BOTH"></span>**Les deux** (4)


</dt> <dd>

Les requêtes spécifiques et générales sont prises en charge.
...
<span id="Vendor_Reserved"></span><span id="vendor_reserved"></span><span id="VENDOR_RESERVED"></span>**Fournisseur réservé** (0x8000.. 0xFFFF
...
Description d’un sous-type spécifique à l’implémentation pour cette ressource. Par exemple, cela peut être utilisé pour distinguer différents modèles du même type de ressource.
...
Qualificateurs : [**ModelCorrespondence**](/windows/desktop/WmiSdk/standard-qualifiers) ("**CIM \_ AllocationCapabilities**.**OtherResourceType**","[**CIM \_ ResourceAllocationSettingData**](cim-resourceallocationsettingdata.md).**ResourceType**»)
</dt> </dl>

Type de ressource affecté à ce paramètre d’allocation.
...
Indique comment l’accès à la ressource sous-jacente est accordé.

La quantité réelle est contrôlée par min, taille maximale, poids, etc.
...
Accès exclusif à la ressource sous-jacente.

</dd> <dt>

<span id="Shared"></span><span id="shared"></span><span id="SHARED"></span>

<span id="Shared"></span><span id="shared"></span><span id="SHARED"></span>**Partagé** (3)


</dt> <dd>

Utilisation partagée de la ressource sous-jacente.
...
États du système pris en charge lors de la création d’une ressource.
...
États du système pris en charge lorsqu’une ressource est supprimée.
