...
Représentation sous forme de chaîne de la classe [**MSVM \_ TerminalServiceSettingData**](msvm-terminalservicesettingdata.md) qui contient les données de paramètre modifiées pour le service.
