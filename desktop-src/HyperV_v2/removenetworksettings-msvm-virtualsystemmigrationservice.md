...
ms.locfileid: "119980079"
---
# <a name="removenetworksettings-method-of-the-msvm_virtualsystemmigrationservice-class"></a>Méthode RemoveNetworkSettings de la \_ classe VirtualSystemMigrationService MSVM

Supprime les sous-réseaux du réseau de migration du service de migration de système virtuel.
...
Tableau d’instances incorporées de la classe [**MSVM \_ VirtualSystemMigrationNetworkSettingData**](msvm-virtualsystemmigrationnetworksettingdata.md) qui représentent les sous-réseaux du réseau à supprimer.
