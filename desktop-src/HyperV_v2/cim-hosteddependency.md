...
La classe **CIM \_ HostedDependency** possède les types de membres suivants :

-   [Propriétés](#properties)

### <a name="properties"></a>Propriétés

La classe **CIM \_ HostedDependency** possède les propriétés suivantes.
