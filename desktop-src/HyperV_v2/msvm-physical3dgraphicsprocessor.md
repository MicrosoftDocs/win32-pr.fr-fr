...
Décrit l’unité de traitement graphique (GPU) 3D physique.
...
La classe **MSVM \_ Physical3dGraphicsProcessor** possède les types de membres suivants :
...
La classe **MSVM \_ Physical3dGraphicsProcessor** possède ces méthodes.
...
La classe **MSVM \_ Physical3dGraphicsProcessor** possède les propriétés suivantes.
...
Spécifie l’identificateur d’index d’adaptateur alloué à cet appareil.
...
Spécifie la quantité de mémoire vidéo, en octets, disponible pour le GPU.
...
Spécifie la quantité de mémoire système, en octets, dédiée au GPU.
...
Spécifie la quantité de mémoire vidéo, en octets, dédiée au GPU.
...
Spécifie la prise en charge de DirectX prise en charge par le GPU.
...
Spécifie la date de génération du pilote.
...
Spécifie la date et l’heure d’installation du pilote.
...
Spécifie le nom du fournisseur de pilotes.
...
Spécifie si l’adaptateur a été activé pour une utilisation avec RemoteFX.
...
Contient l’identificateur GPU de l’adaptateur.
...
Spécifie la résolution de nuanceur de pixels prise en charge par le GPU.
...
Spécifie la quantité de mémoire système partagée, en octets, disponible pour le GPU.
...
Spécifie la quantité totale de mémoire vidéo, en octets, présente sur le GPU.
