...
---
# <a name="setauthorizationentry-method-of-the-msvm_replicationservice-class"></a>Méthode SetAuthorizationEntry de la \_ classe ReplicationService MSVM

Définit l’entrée d’autorisation de réplication pour un ordinateur virtuel.
...
Référence à une instance [**\_ ComputerSystem CIM**](/windows/desktop/CIMWin32Prov/cim-computersystem) qui représente la machine virtuelle pour laquelle définir l’entrée d’autorisation.
...
Représentation sous forme de chaîne d’une instance de la classe [**MSVM \_ ReplicationAuthorizationSettingData**](msvm-replicationauthorizationsettingdata.md) qui définit l’entrée d’autorisation à utiliser pour l’ordinateur virtuel.
