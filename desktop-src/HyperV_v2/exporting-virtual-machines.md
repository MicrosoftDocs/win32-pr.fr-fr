...
---
# <a name="exporting-a-snapshot-of-a-virtual-machine"></a><span data-ttu-id="61d1c-103">Exportation d’une capture instantanée d’un ordinateur virtuel</span><span class="sxs-lookup"><span data-stu-id="61d1c-103">Exporting a snapshot of a virtual machine</span></span>

<span data-ttu-id="61d1c-104">Les exemples C# et Visual Basic Scripting Edition (VBScript) suivants illustrent l’exportation d’une capture instantanée d’un ordinateur virtuel.</span><span class="sxs-lookup"><span data-stu-id="61d1c-104">The following C# and Visual Basic Scripting Edition (VBScript) samples demonstrate exporting a snapshot of a virtual machine.</span></span> <span data-ttu-id="61d1c-105">Vous trouverez des exemples qui illustrent l’exportation d’une machine virtuelle dans la rubrique [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) .</span><span class="sxs-lookup"><span data-stu-id="61d1c-105">Samples that demonstrate exporting a virtual machine can be found on the [**ExportSystemDefinition**](exportsystemdefinition-msvm-virtualsystemmanagementservice.md) topic.</span></span>

<span data-ttu-id="61d1c-106">Les utilitaires C# référencés se trouvent dans [les utilitaires courants pour les exemples de virtualisation (v2)](common-utilities-for-the-virtualization-samples-v2.md).</span><span class="sxs-lookup"><span data-stu-id="61d1c-106">The referenced C# utilities can be found in [Common utilities for the virtualization samples (V2)](common-utilities-for-the-virtualization-samples-v2.md).</span></span>
...
## <a name="related-topics"></a><span data-ttu-id="61d1c-107">Rubriques connexes</span><span class="sxs-lookup"><span data-stu-id="61d1c-107">Related topics</span></span>

[<span data-ttu-id="61d1c-108">Exportation de la configuration d’une machine virtuelle</span><span class="sxs-lookup"><span data-stu-id="61d1c-108">Exporting the configuration of a virtual machine</span></span>](exporting-the-configuration-of-a-virtual-machine.md)

[<span data-ttu-id="61d1c-109">**ExportSystemDefinition**</span><span class="sxs-lookup"><span data-stu-id="61d1c-109">**ExportSystemDefinition**</span></span>](exportsystemdefinition-msvm-virtualsystemmanagementservice.md)
