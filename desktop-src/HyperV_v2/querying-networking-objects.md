---
description: L’exemple C# suivant récupère et affiche des informations sur les réseaux physiques et virtuels pour le commutateur spécifié.
ms.assetid: 679168E2-C79F-4A7A-8C04-A309315CA670
title: Interrogation d’objets de mise en réseau
ms.topic: article
ms.date: 05/31/2018
...
ms.locfileid: "106516858"
---
# <a name="querying-networking-objects"></a><span data-ttu-id="b6abf-103">Interrogation d’objets de mise en réseau</span><span class="sxs-lookup"><span data-stu-id="b6abf-103">Querying networking objects</span></span>

<span data-ttu-id="b6abf-104">L’exemple C# suivant récupère et affiche des informations sur les réseaux physiques et virtuels pour le commutateur spécifié.</span><span class="sxs-lookup"><span data-stu-id="b6abf-104">The following C# sample retrieves and displays physical and virtual network information for the specified switch.</span></span> <span data-ttu-id="b6abf-105">Ce code est extrait de l' [exemple de mise en réseau Hyper-V](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span><span class="sxs-lookup"><span data-stu-id="b6abf-105">This code is taken from the [Hyper-V networking sample](https://github.com/microsoft/Windows-classic-samples/tree/master/Samples/Hyper-V/Networking).</span></span>

<span data-ttu-id="b6abf-106">La syntaxe de la ligne de commande pour exécuter cet exemple est la suivante :</span><span class="sxs-lookup"><span data-stu-id="b6abf-106">The command-line syntax to run this sample is:</span></span>

<span data-ttu-id="b6abf-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span><span class="sxs-lookup"><span data-stu-id="b6abf-107">**NetworkingSamples.exe EnumerateSwitch** *SwitchName*</span></span>

<span data-ttu-id="b6abf-108">où *SwitchName* est le nom du commutateur pour lequel afficher les informations.</span><span class="sxs-lookup"><span data-stu-id="b6abf-108">where *SwitchName* is the name of the switch to display the information for.</span></span> <span data-ttu-id="b6abf-109">Le nom du commutateur est contenu dans la propriété [**MSVM \_ VirtualEthernetSwitch. ElementName**](msvm-virtualethernetswitch.md) .</span><span class="sxs-lookup"><span data-stu-id="b6abf-109">The switch name is contained in the [**Msvm\_VirtualEthernetSwitch.ElementName**](msvm-virtualethernetswitch.md) property.</span></span>
